...
⚠️ 31 passed with 0 failures, 438 warnings and 168 suggestions 
...
---
Response status code: 200 OK. Responded in 142.99637ms.
```json
{
...
---
Response status code: 200 OK. Responded in 151.53754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 310.574943ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2280/events/20280",
  "modified": 1658486342908,
  "data": {
    "@context": [
      "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 313.547968ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2281/events/20281",
  "modified": 1658486342909,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c511126c-5542-42ad-b2d3-d6317e349fd5
...
---
Response status code: 200 OK. Responded in 440.396769ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c511126c-5542-42ad-b2d3-d6317e349fd5",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2280%2Fevents%2F20280?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 22.628394ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2281%2Fevents%2F20281?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 21.792487ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c511126c-5542-42ad-b2d3-d6317e349fd5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eliseo_Dibbert75@gmail.com",
    "telephone": "(797) 745-8015",
    "givenName": "Medhurst",
    "familyName": "Marisol",
    "identifier": "cb73a760-0177-47f5-a1d4-ac03f718529f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 197.384989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 40.676248ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 36.045209ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c511126c-5542-42ad-b2d3-d6317e349fd5
...
---
Response status code: 201 Created. Responded in 93.183597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c511126c-5542-42ad-b2d3-d6317e349fd5",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c511126c-5542-42ad-b2d3-d6317e349fd5#/orderedItems/1199",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c511126c-5542-42ad-b2d3-d6317e349fd5#/orderedItems/1200",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c511126c-5542-42ad-b2d3-d6317e349fd5#/orderedItems/1201",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2281#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c511126c-5542-42ad-b2d3-d6317e349fd5/versions/e0636770-b3a8-4b48-a190-ca01cfc6e4f5",
  "payment": {
    "@type": "Payment",
    "identifier": "AXoLDp4An",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c511126c-5542-42ad-b2d3-d6317e349fd5&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c511126c-5542-42ad-b2d3-d6317e349fd5


---
Response status code: 200 OK. Responded in 8.420872ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'c511126c-5542-42ad-b2d3-d6317e349fd5' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 21.491784ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c511126c-5542-42ad-b2d3-d6317e349fd5&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c511126c-5542-42ad-b2d3-d6317e349fd5


---
Response status code: 200 OK. Responded in 2007.595484ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c511126c-5542-42ad-b2d3-d6317e349fd5",
  "modified": 637940831469837800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c511126c-5542-42ad-b2d3-d6317e349fd5",
    "identifier": "c511126c-5542-42ad-b2d3-d6317e349fd5",
...
---
Response status code: 200 OK. Responded in 8.351371ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c511126c-5542-42ad-b2d3-d6317e349fd5
...
---
Response status code: 201 Created. Responded in 335.800174ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c511126c-5542-42ad-b2d3-d6317e349fd5",
  "identifier": "c511126c-5542-42ad-b2d3-d6317e349fd5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 406.0978ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c511126c-5542-42ad-b2d3-d6317e349fd5",
  "modified": 637940831490886300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 28.56696ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.843462ms.
```json
{
  "data": {
    "@context": [
