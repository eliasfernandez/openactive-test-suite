...
⚠️ 48 passed with 0 failures, 127 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 25.176201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/208/events/2077"
}
```
...
---
Response status code: 200 OK. Responded in 24.488089ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/218/events/2176"
}
```
...
---
Response status code: 200 OK. Responded in 24.124584ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/82/facility-use-slots/811"
}
```
...
---
Response status code: 200 OK. Responded in 18.480594ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1933"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F208%2Fevents%2F2077?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.549684ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/208/events/2077",
    "startDate": "2022-07-31T15:12:11+00:00",
    "endDate": "2022-07-31T17:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F218%2Fevents%2F2176?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.998175ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/218/events/2176",
    "startDate": "2022-07-28T10:09:11+00:00",
    "endDate": "2022-07-28T11:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/218",
      "name": "Rubber Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/218#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F82%2Ffacility-use-slots%2F811?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.443266ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/82",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/82/facility-use-slots/811#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T22:31:11+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F194%2Ffacility-use-slots%2F1933?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.847657ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1933#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 6,
    "startDate": "2022-07-30T21:39:11+00:00",
    "endDate": "2022-07-31T01:07:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c00a5134-e932-4f6e-8d11-b41369960501
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/218#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/218/events/2176"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/82/facility-use-slots/811#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1933#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1933"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 31.929311ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c00a5134-e932-4f6e-8d11-b41369960501",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/218"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c00a5134-e932-4f6e-8d11-b41369960501
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maryjane.McGlynn52@hotmail.com",
    "telephone": "1-437-659-1523",
    "givenName": "Marquardt",
    "familyName": "Katlyn",
    "identifier": "35c1279d-c312-4a1e-80d9-78c2e641e144"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 58.743641ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c00a5134-e932-4f6e-8d11-b41369960501
...
---
Response status code: 409 Conflict. Responded in 46.048538ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c00a5134-e932-4f6e-8d11-b41369960501",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
