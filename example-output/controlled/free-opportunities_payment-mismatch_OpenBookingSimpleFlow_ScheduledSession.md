...
---
Response status code: 200 OK. Responded in 105.348858ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1117.332515ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2435/events/20435",
  "modified": 1658486672902,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2435/events/20435",
    "startDate": "2022-07-23T10:44:30+00:00",
    "endDate": "2022-07-23T11:44:30+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ac421c55-89ff-4f3a-b8fd-b0ae643bea91
...
---
Response status code: 200 OK. Responded in 247.630495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ac421c55-89ff-4f3a-b8fd-b0ae643bea91",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2435%2Fevents%2F20435?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 373.244309ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2435/events/20435",
  "modified": 1658486674053,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ac421c55-89ff-4f3a-b8fd-b0ae643bea91
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clemens92@gmail.com",
    "telephone": "860.775.5228 x209",
    "givenName": "Haley",
    "familyName": "Albertha",
    "identifier": "3d2c113c-6be9-4b48-8e1b-b72bc7d044a7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 557.721544ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:33+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.594692ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ac421c55-89ff-4f3a-b8fd-b0ae643bea91
...
---
Response status code: 400 Bad Request. Responded in 241.832244ms.
```json
{
  "@context": "https://openactive.io/",
