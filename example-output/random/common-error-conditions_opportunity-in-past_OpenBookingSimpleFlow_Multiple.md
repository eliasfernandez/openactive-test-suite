[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:39:19 GMT+0000 (Coordinated Universal Time)
...
Runs C1, C2 and B for an opportunity in the past, expecting an OpportunityOfferPairNotBookableError to be returned at C1, C2, and B
...
⚠️ 48 passed with 0 failures, 672 warnings and 174 suggestions 
...
---
Response status code: 200 OK. Responded in 31.867723ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/695/events/6944"
}
```
...
---
Response status code: 200 OK. Responded in 26.096848ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/387/events/3870"
}
```
...
---
Response status code: 200 OK. Responded in 24.267124ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/688/facility-use-slots/6871"
}
```
...
---
Response status code: 200 OK. Responded in 22.954107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/165/facility-use-slots/1645"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F695%2Fevents%2F6944?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 61.924277ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/695/events/6944",
    "startDate": "2022-07-20T15:59:11+00:00",
    "endDate": "2022-07-20T20:10:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT16H53M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F387%2Fevents%2F3870?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 61.341468ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/387/events/3870",
    "startDate": "2022-07-28T19:13:11+00:00",
    "endDate": "2022-07-29T00:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F688%2Ffacility-use-slots%2F6871?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 60.669958ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/688",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/688/facility-use-slots/6871#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT2H16M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-22T00:04:12+00:00",
    "endDate": "2022-07-22T05:34:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F165%2Ffacility-use-slots%2F1645?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 74.861081ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/165",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/165/facility-use-slots/1645#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-26T04:47:11+00:00",
    "endDate": "2022-07-26T07:30:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bb1feb56-a496-4c61-b347-5c8632109725
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/695/events/6944"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/387/events/3870"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/688/facility-use-slots/6871#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/688/facility-use-slots/6871"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/165/facility-use-slots/1645#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/165/facility-use-slots/1645"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 74.471176ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bb1feb56-a496-4c61-b347-5c8632109725",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/688"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-22T00:04:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/165"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-26T04:47:11+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bb1feb56-a496-4c61-b347-5c8632109725
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Margaretta41@gmail.com",
    "telephone": "464.709.4653 x2173",
    "givenName": "Stoltenberg",
    "familyName": "Bella",
    "identifier": "c8aa7375-c41a-4a49-aa26-5c03bfb28a38"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 71.462028ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bb1feb56-a496-4c61-b347-5c8632109725
...
---
Response status code: 409 Conflict. Responded in 62.514283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bb1feb56-a496-4c61-b347-5c8632109725",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
