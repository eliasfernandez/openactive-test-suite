...
⚠️ 50 passed with 0 failures, 716 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 30.411733ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1189"
}
```
...
---
Response status code: 200 OK. Responded in 28.645401ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/670/events/6693"
}
```
...
---
Response status code: 200 OK. Responded in 27.707285ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357"
}
```
...
---
Response status code: 200 OK. Responded in 26.644567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F119%2Fevents%2F1189?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.647961ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1189",
    "startDate": "2022-07-27T22:39:11+00:00",
    "endDate": "2022-07-28T02:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F670%2Fevents%2F6693?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.216954ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/670/events/6693",
    "startDate": "2022-07-22T20:43:11+00:00",
    "endDate": "2022-07-22T22:18:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/670",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/670#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P2DT13H30M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F636%2Ffacility-use-slots%2F6357?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.762046ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 4.54,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT15H58M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-29T05:34:12+00:00",
    "endDate": "2022-07-29T06:22:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F603%2Ffacility-use-slots%2F6023?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.340939ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT16H38M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-25T16:03:12+00:00",
    "endDate": "2022-07-25T21:45:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1189"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/670#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/670/events/6693"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1230.599493ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:40+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/670"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F119%2Fevents%2F1189?useCacheIfAvailable=true&expectedCapacity=18


---
Response status code: 200 OK. Responded in 321.801116ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1189",
  "modified": 1658487102942,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F670%2Fevents%2F6693?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 322.910635ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/670/events/6693",
  "modified": 1658487102943,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F636%2Ffacility-use-slots%2F6357?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 47.588816ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357",
  "modified": 1658487102669,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F603%2Ffacility-use-slots%2F6023?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 50.944374ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023",
  "modified": 1658487102673,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elta34@gmail.com",
    "telephone": "581-435-5774 x875",
    "givenName": "Hickle",
    "familyName": "Kelly",
    "identifier": "6f47cb2c-b4ce-405d-99d9-7a04abff91af"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1592.523097ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:43+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 36.463025ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.641711ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.953699ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.492192ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18
...
---
Response status code: 201 Created. Responded in 2092.684192ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3095",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/119#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3096",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/119#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3097",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/670#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3098",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3099",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/636/facility-use-slots/6357#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ee47b5f2-4e43-45c1-9c82-7d0cf21e1b18#/orderedItems/3100",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/603/facility-use-slots/6023#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 31.723243ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.916129ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.249518ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.756509ms.
```json
{
  "data": {
    "@context": [
