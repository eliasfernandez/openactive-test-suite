...
---
Response status code: 200 OK. Responded in 108.853827ms.
```json
{
...
---
Response status code: 200 OK. Responded in 321.536343ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2194/events/20194",
  "modified": 1658486221235,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e0ff572e-ea5c-4b74-944b-c739574c27dc
...
---
Response status code: 409 Conflict. Responded in 279.714526ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e0ff572e-ea5c-4b74-944b-c739574c27dc",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e0ff572e-ea5c-4b74-944b-c739574c27dc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bobbie_Bruen14@yahoo.com",
    "telephone": "261-903-2365",
    "givenName": "Emard",
    "familyName": "Vernon",
    "identifier": "5d074141-07d8-442c-aa02-7d3b67858549"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 50.958487ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e0ff572e-ea5c-4b74-944b-c739574c27dc
...
---
Response status code: 409 Conflict. Responded in 21.172161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e0ff572e-ea5c-4b74-944b-c739574c27dc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
