...
---
Response status code: 200 OK. Responded in 9.767248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F287%2Ffacility-use-slots%2F2863?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.068968ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-27T13:21:12+00:00",
    "endDate": "2022-07-27T15:43:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a20dbce7-aa64-4b80-affa-ee9528a57265
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 221.147759ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a20dbce7-aa64-4b80-affa-ee9528a57265",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F287%2Ffacility-use-slots%2F2863?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1013.888153ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863",
  "modified": 1658486346699,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a20dbce7-aa64-4b80-affa-ee9528a57265
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Riley_Simonis@yahoo.com",
    "telephone": "1-441-577-1548",
    "givenName": "Walker",
    "familyName": "Kimberly",
    "identifier": "1991a940-2b01-42f5-aec0-3f48739472c9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 75.5387ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.699175ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a20dbce7-aa64-4b80-affa-ee9528a57265
...
---
Response status code: 201 Created. Responded in 68.207383ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a20dbce7-aa64-4b80-affa-ee9528a57265",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a20dbce7-aa64-4b80-affa-ee9528a57265#/orderedItems/1059",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2863#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 22.282051ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/505aff85-4555-49e3-bb57-03e424bfdd4e
...
---
Response status code: 500 Internal Server Error. Responded in 26.303115ms.
```json
{
  "@context": "https://openactive.io/",
