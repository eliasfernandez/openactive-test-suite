[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:57 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 201 warnings and 52 suggestions 
...
---
Response status code: 200 OK. Responded in 20.025735ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/213/events/2129"
}
```
...
---
Response status code: 200 OK. Responded in 13.714898ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/148/facility-use-slots/1480"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F213%2Fevents%2F2129?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.051496ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/213/events/2129",
    "startDate": "2022-07-30T17:26:11+00:00",
    "endDate": "2022-07-30T20:02:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/213",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/213#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F148%2Ffacility-use-slots%2F1480?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.223778ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/148/facility-use-slots/1480#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-23T04:57:11+00:00",
    "endDate": "2022-07-23T10:02:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3cd1e2d8-c177-4ce2-a603-d512c6f2e5c4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/213#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/213/events/2129"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/148/facility-use-slots/1480#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/148/facility-use-slots/1480"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 947.460484ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3cd1e2d8-c177-4ce2-a603-d512c6f2e5c4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:06+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F213%2Fevents%2F2129?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 222.233128ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/213/events/2129",
  "modified": 1658486768170,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F148%2Ffacility-use-slots%2F1480?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 955.761164ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/148/facility-use-slots/1480",
  "modified": 1658486768905,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3cd1e2d8-c177-4ce2-a603-d512c6f2e5c4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amya.Baumbach@hotmail.com",
    "telephone": "1-392-458-8479",
    "givenName": "Miller",
    "familyName": "Clinton",
    "identifier": "6e9c6db4-0b3c-4f3e-9db1-3dc5d578193e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 510.9388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.56929ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 7.563068ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3cd1e2d8-c177-4ce2-a603-d512c6f2e5c4
...
---
Response status code: 400 Bad Request. Responded in 532.959862ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (1) does not match expected value (0)"
}
```
### Specs
