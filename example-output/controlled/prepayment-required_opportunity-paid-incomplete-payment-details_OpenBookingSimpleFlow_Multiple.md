...
---
Response status code: 200 OK. Responded in 23.164409ms.
```json
{
...
---
Response status code: 200 OK. Responded in 25.866833ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 510.936591ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2477/events/20477",
  "modified": 1658486777806,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2477/events/20477",
    "startDate": "2022-07-23T10:46:16+00:00",
    "endDate": "2022-07-23T11:46:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 737.922629ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2465/facility-use-slots/20465",
  "modified": 1658486778038,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ff17bc0-f4c9-48d9-a2bd-da633561128a
...
---
Response status code: 200 OK. Responded in 352.553768ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ff17bc0-f4c9-48d9-a2bd-da633561128a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2477%2Fevents%2F20477?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 462.877358ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2477/events/20477",
  "modified": 1658486779325,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2465%2Ffacility-use-slots%2F20465?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 588.78619ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2465/facility-use-slots/20465",
  "modified": 1658486779453,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ff17bc0-f4c9-48d9-a2bd-da633561128a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rey.Satterfield42@yahoo.com",
    "telephone": "1-844-994-3559",
    "givenName": "Runolfsson",
    "familyName": "Keely",
    "identifier": "e0f8523d-aa45-45ff-b231-a01653cbb157"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 526.663532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.931316ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.349411ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1ff17bc0-f4c9-48d9-a2bd-da633561128a
...
---
Response status code: 400 Bad Request. Responded in 1044.930988ms.
```json
{
  "@context": "https://openactive.io/",
