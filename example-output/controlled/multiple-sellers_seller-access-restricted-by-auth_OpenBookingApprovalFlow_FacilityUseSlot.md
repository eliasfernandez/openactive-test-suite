...
---
Response status code: 200 OK. Responded in 18.642829ms.
```json
{
...
---
Response status code: 200 OK. Responded in 760.337664ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2115/facility-use-slots/20115",
  "modified": 1658486127816,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:35:26+00:00",
    "endDate": "2022-07-23T11:35:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/021fd848-30e9-4cc1-ba3d-4512410f661a
...
---
Response status code: 401 Unauthorized. Responded in 237.100153ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/021fd848-30e9-4cc1-ba3d-4512410f661a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Christopher.Willms@gmail.com",
    "telephone": "(416) 725-4233 x218",
    "givenName": "Hansen",
    "familyName": "Skyla",
    "identifier": "d2f269d6-8b77-4ec8-94ce-12378a07e67d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 45.101314ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/021fd848-30e9-4cc1-ba3d-4512410f661a
...
---
Response status code: 401 Unauthorized. Responded in 229.428199ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
