...
---
Response status code: 200 OK. Responded in 341.279413ms.
```json
{
...
---
Response status code: 200 OK. Responded in 325.535069ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 373.181903ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 316.040082ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 759.96573ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2567/events/20567",
  "modified": 1658486964923,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2567/events/20567",
    "startDate": "2022-07-23T10:49:22+00:00",
    "endDate": "2022-07-23T11:49:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 758.761819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2566/events/20566",
...
---
Response status code: 200 OK. Responded in 1176.992033ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2555/facility-use-slots/20555",
  "modified": 1658486965340,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 457.648274ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2554/facility-use-slots/20554",
  "modified": 1658486964623,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1fe9994b-4b46-457b-b373-488288c4165c
...
---
Response status code: 400 Bad Request. Responded in 787.291179ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1fe9994b-4b46-457b-b373-488288c4165c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Felton70@hotmail.com",
    "telephone": "1-865-322-1970 x081",
    "givenName": "Satterfield",
    "familyName": "Cassandre",
    "identifier": "cc312b31-e26e-449f-bb4d-5bbeaa62c6ef"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 126.774056ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
