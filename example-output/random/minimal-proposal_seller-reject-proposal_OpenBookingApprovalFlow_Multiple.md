[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:33:53 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 754 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 23.540573ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13538"
}
```
...
---
Response status code: 200 OK. Responded in 18.375692ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 23.051265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 22.298754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1354%2Fevents%2F13538?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.48503ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13538",
    "startDate": "2022-07-27T08:56:11+00:00",
    "endDate": "2022-07-27T09:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 14.177925ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1578/events/15773",
    "startDate": "2022-07-27T14:32:11+00:00",
    "endDate": "2022-07-27T17:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT3H43M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 13.833319ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 6,
    "startDate": "2022-07-24T21:05:12+00:00",
    "endDate": "2022-07-25T02:01:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1581%2Ffacility-use-slots%2F15803?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.440913ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1581",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT18H56M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-30T21:09:12+00:00",
    "endDate": "2022-07-30T23:06:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b2bc5157-7c54-402a-b7f3-cbedf96679a2
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13538"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 97.06744ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b2bc5157-7c54-402a-b7f3-cbedf96679a2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:04+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1578"
        },
        "maximumAttendeeCapacity": 48,
        "remainingAttendeeCapacity": 48
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1581"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-30T21:09:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1354%2Fevents%2F13538?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 236.905558ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13538",
  "modified": 1658486046221,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1578%2Fevents%2F15773?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 237.980975ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1578/events/15773",
  "modified": 1658486046223,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1242%2Ffacility-use-slots%2F12417?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 349.88925ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1242/facility-use-slots/12417",
  "modified": 1658486046335,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1581%2Ffacility-use-slots%2F15803?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 349.564345ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b2bc5157-7c54-402a-b7f3-cbedf96679a2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mekhi48@gmail.com",
    "telephone": "(487) 778-7539 x1040",
    "givenName": "Simonis",
    "familyName": "Kitty",
    "identifier": "ffd7735e-b303-44b4-be0b-e8891b3a5728"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 127.235218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:06+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 19.461209ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.9074ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.408692ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.970285ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b2bc5157-7c54-402a-b7f3-cbedf96679a2
...
---
Response status code: 201 Created. Responded in 171.929529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b2bc5157-7c54-402a-b7f3-cbedf96679a2",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/289",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/290",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1578#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/291",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1242/facility-use-slots/12417#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/292",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1242/facility-use-slots/12417#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2#/orderedItems/293",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1581/facility-use-slots/15803#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b2bc5157-7c54-402a-b7f3-cbedf96679a2/versions/66137237-81b6-4f8c-b259-6a1ccc570361",
  "payment": {
    "@type": "Payment",
    "identifier": "fkmKhwUF2",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b2bc5157-7c54-402a-b7f3-cbedf96679a2&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b2bc5157-7c54-402a-b7f3-cbedf96679a2


---
Response status code: 200 OK. Responded in 3.638664ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828430714790&afterId=4bb624fe-64f3-4bf2-9ca0-d1f5937772c2",
  "message": "Listening for UUID: 'b2bc5157-7c54-402a-b7f3-cbedf96679a2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 209.143384ms.
### Specs
* ✅ should return 204 on success

## Order Proposals Feed (after test:SellerRejectOrderProposalSimulateAction)

### Orders (order-proposals) Feed collect for &#x27;b2bc5157-7c54-402a-b7f3-cbedf96679a2&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b2bc5157-7c54-402a-b7f3-cbedf96679a2


---
Response status code: 200 OK. Responded in 2166.016737ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b2bc5157-7c54-402a-b7f3-cbedf96679a2",
  "modified": 637940828485705200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b2bc5157-7c54-402a-b7f3-cbedf96679a2",
    "identifier": "b2bc5157-7c54-402a-b7f3-cbedf96679a2",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b2bc5157-7c54-402a-b7f3-cbedf96679a2
...
---
Response status code: 500 Internal Server Error. Responded in 19.393641ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 20.462659ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.145137ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.680728ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.249421ms.
```json
{
  "data": {
    "@context": [
