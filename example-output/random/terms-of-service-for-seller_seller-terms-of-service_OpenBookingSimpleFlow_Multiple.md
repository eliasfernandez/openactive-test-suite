...
⚠️ 44 passed with 0 failures, 608 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 26.093601ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/550/events/5499"
}
```
...
---
Response status code: 200 OK. Responded in 20.210011ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/250"
}
```
...
---
Response status code: 200 OK. Responded in 23.057255ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695"
}
```
...
---
Response status code: 200 OK. Responded in 22.250842ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F550%2Fevents%2F5499?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.799874ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/550/events/5499",
    "startDate": "2022-07-30T11:13:11+00:00",
    "endDate": "2022-07-30T15:08:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F250?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.421468ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/250",
    "startDate": "2022-07-23T08:50:11+00:00",
    "endDate": "2022-07-23T09:25:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F470%2Ffacility-use-slots%2F4695?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.137963ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 16.82,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT11H13M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-23T22:47:12+00:00",
    "endDate": "2022-07-24T01:45:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F615%2Ffacility-use-slots%2F6143?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.803958ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/615",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 3.62,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT17H21M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-28T18:21:12+00:00",
    "endDate": "2022-07-29T00:04:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/73afd07d-6cd0-47f3-a716-5c551fb6942c
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/550/events/5499"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/250"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 510.521847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/73afd07d-6cd0-47f3-a716-5c551fb6942c",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/615"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-28T18:21:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F550%2Fevents%2F5499?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 481.666803ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/550/events/5499",
  "modified": 1658486183363,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F250?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 482.439316ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/250",
  "modified": 1658486183365,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F470%2Ffacility-use-slots%2F4695?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 235.917426ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695",
  "modified": 1658486183119,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F615%2Ffacility-use-slots%2F6143?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 229.165322ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143",
  "modified": 1658486183121,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/73afd07d-6cd0-47f3-a716-5c551fb6942c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fernando.Nitzsche@hotmail.com",
    "telephone": "1-226-794-8569 x887",
    "givenName": "Feil",
    "familyName": "Jaime",
    "identifier": "5c1fa8ed-4224-44ca-a3af-f87740cc7da1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 310.835977ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.23437ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.510358ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.894131ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.527325ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c
...
---
Response status code: 201 Created. Responded in 125.637789ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/621",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/550#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/622",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/550#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/623",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/25#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/624",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/625",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4695#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73afd07d-6cd0-47f3-a716-5c551fb6942c#/orderedItems/626",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6143#/offers/0",
        "allowCustomerCancellationFullRefund": true,
