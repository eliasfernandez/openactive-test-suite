[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:44:54 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 512.107557ms.
```json
{
...
---
Response status code: 200 OK. Responded in 526.973983ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 942.497819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2450/events/20450",
  "modified": 1658486704181,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2450/events/20450",
    "startDate": "2022-07-23T10:45:01+00:00",
    "endDate": "2022-07-23T11:45:01+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1299.301936ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436",
  "modified": 1658486704541,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5b22dcbe-cac9-45ac-a0d8-614d394bdea9
...
---
Response status code: 200 OK. Responded in 327.410793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5b22dcbe-cac9-45ac-a0d8-614d394bdea9",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:03+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2450%2Fevents%2F20450?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 374.300623ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2450/events/20450",
  "modified": 1658486705555,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2436%2Ffacility-use-slots%2F20436?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 865.306611ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436",
  "modified": 1658486706047,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5b22dcbe-cac9-45ac-a0d8-614d394bdea9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shaylee.Gusikowski@yahoo.com",
    "telephone": "(283) 638-0980 x789",
    "givenName": "Upton",
    "familyName": "Jules",
    "identifier": "dafce225-d7e2-42e4-ac0d-813adab69122"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 217.071784ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.857072ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.954964ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5b22dcbe-cac9-45ac-a0d8-614d394bdea9
...
---
Response status code: 400 Bad Request. Responded in 261.556092ms.
```json
{
  "@context": "https://openactive.io/",
