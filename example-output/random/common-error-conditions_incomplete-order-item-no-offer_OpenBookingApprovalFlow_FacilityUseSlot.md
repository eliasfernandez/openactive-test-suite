...
⚠️ 13 passed with 0 failures, 16 warnings and 2 suggestions 
...
---
Response status code: 200 OK. Responded in 13.118509ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1813/facility-use-slots/18125"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1813%2Ffacility-use-slots%2F18125?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.918378ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1813/facility-use-slots/18125#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT11H58M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-23T03:46:12+00:00",
    "endDate": "2022-07-23T09:30:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4e1717e4-caff-48ea-bcb5-381a304390e0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1813/facility-use-slots/18125"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 489.713099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4e1717e4-caff-48ea-bcb5-381a304390e0",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4e1717e4-caff-48ea-bcb5-381a304390e0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tamia10@gmail.com",
    "telephone": "362-829-9739 x77040",
    "givenName": "Nienow",
    "familyName": "Charles",
    "identifier": "934f4889-f7ae-449c-96fa-dcddcdcafd98"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 16.078057ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4e1717e4-caff-48ea-bcb5-381a304390e0
...
---
Response status code: 409 Conflict. Responded in 41.407159ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4e1717e4-caff-48ea-bcb5-381a304390e0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
