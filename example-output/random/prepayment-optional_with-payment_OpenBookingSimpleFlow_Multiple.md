...
⚠️ 22 passed with 0 failures, 244 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 30.389033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4116"
}
```
...
---
Response status code: 200 OK. Responded in 33.936195ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F412%2Fevents%2F4116?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.794164ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4116",
    "startDate": "2022-07-28T10:33:11+00:00",
    "endDate": "2022-07-28T13:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/412",
      "name": "Rubber Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/412#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 6.79,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT17H30M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F438%2Ffacility-use-slots%2F4377?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.027052ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/438",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 15.3,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT17H57M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-23T03:27:12+00:00",
    "endDate": "2022-07-23T06:23:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a3942db0-9818-4130-b7b3-bd7adb688c6c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/412#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4116"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 771.093322ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a3942db0-9818-4130-b7b3-bd7adb688c6c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:29+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/412"
        },
        "maximumAttendeeCapacity": 37,
        "remainingAttendeeCapacity": 37
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/438"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-23T03:27:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F412%2Fevents%2F4116?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 422.0078ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4116",
  "modified": 1658487031634,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F438%2Ffacility-use-slots%2F4377?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 956.592674ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377",
  "modified": 1658487032170,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a3942db0-9818-4130-b7b3-bd7adb688c6c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Titus.Sauer98@gmail.com",
    "telephone": "(477) 226-8525",
    "givenName": "Kozey",
    "familyName": "Vaughn",
    "identifier": "36c9f467-78c6-4b35-be72-3f36711df476"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1251.517846ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 24.004321ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.210607ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a3942db0-9818-4130-b7b3-bd7adb688c6c
...
---
Response status code: 201 Created. Responded in 1094.260888ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a3942db0-9818-4130-b7b3-bd7adb688c6c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a3942db0-9818-4130-b7b3-bd7adb688c6c#/orderedItems/2928",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/412#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a3942db0-9818-4130-b7b3-bd7adb688c6c#/orderedItems/2929",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/438/facility-use-slots/4377#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 27.699173ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.961361ms.
```json
{
  "data": {
    "@context": [
