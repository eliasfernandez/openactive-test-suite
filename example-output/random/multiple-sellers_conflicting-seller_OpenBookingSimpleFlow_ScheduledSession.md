...
⚠️ 11 passed with 0 failures, 141 warnings and 48 suggestions 
...
---
Response status code: 200 OK. Responded in 84.034828ms.
```json
{
...
---
Response status code: 200 OK. Responded in 53.359443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1586"
}
```
...
---
Response status code: 200 OK. Responded in 52.002122ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/630/events/6300",
    "startDate": "2022-07-24T16:25:11+00:00",
    "endDate": "2022-07-24T18:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F159%2Fevents%2F1586?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 49.229778ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1586",
    "startDate": "2022-07-23T09:58:11+00:00",
    "endDate": "2022-07-23T12:57:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d89563dc-671c-4cc1-8b5d-799da0b981c8
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/159#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1586"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 500 Internal Server Error. Responded in 76.725217ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d89563dc-671c-4cc1-8b5d-799da0b981c8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ivory77@hotmail.com",
    "telephone": "1-544-615-0628",
    "givenName": "Roberts",
    "familyName": "Marjolaine",
    "identifier": "eadb4a88-7106-4c9a-95fb-d44ce7b8c4be"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 84.042727ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d89563dc-671c-4cc1-8b5d-799da0b981c8
...
---
Response status code: 500 Internal Server Error. Responded in 54.442259ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
