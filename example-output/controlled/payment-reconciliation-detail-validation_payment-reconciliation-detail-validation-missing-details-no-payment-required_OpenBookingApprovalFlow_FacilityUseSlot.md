...
---
Response status code: 200 OK. Responded in 15.859545ms.
```json
{
...
---
Response status code: 200 OK. Responded in 439.094204ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2550/facility-use-slots/20550",
  "modified": 1658486963083,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4737a1a0-2b07-4ec2-8fc1-5dc281529f14
...
---
Response status code: 400 Bad Request. Responded in 311.501841ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4737a1a0-2b07-4ec2-8fc1-5dc281529f14
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Abraham88@yahoo.com",
    "telephone": "428.438.5684",
    "givenName": "Mayer",
    "familyName": "Johanna",
    "identifier": "2873ed71-49e4-432b-92e4-789f7d1bfebc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 73.699872ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
