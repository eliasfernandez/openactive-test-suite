[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:51:27 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 819 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 29.354796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1417/events/14168"
}
```
...
---
Response status code: 200 OK. Responded in 27.990772ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1820/events/18193"
}
```
...
---
Response status code: 200 OK. Responded in 27.112258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710"
}
```
...
---
Response status code: 200 OK. Responded in 26.134742ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1417%2Fevents%2F14168?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 33.499666ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1417/events/14168",
    "startDate": "2022-07-30T03:20:11+00:00",
    "endDate": "2022-07-30T04:20:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1417",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1417#/offers/0",
          ...
          "price": 15.87,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT15H29M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1820%2Fevents%2F18193?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 33.082858ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1820/events/18193",
    "startDate": "2022-07-25T13:08:11+00:00",
    "endDate": "2022-07-25T17:57:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1471%2Ffacility-use-slots%2F14710?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.60085ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1471",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 0.08,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT6H41M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-22T13:04:12+00:00",
    "endDate": "2022-07-22T16:13:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1560%2Ffacility-use-slots%2F15600?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.149043ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1560",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT15H1M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-27T00:42:12+00:00",
    "endDate": "2022-07-27T05:22:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a1ff0ffb-936f-452f-ab44-1771bcd0bc40
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1417#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1417/events/14168"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1820/events/18193"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1270.394345ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:15+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1471"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-22T13:04:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1417%2Fevents%2F14168?useCacheIfAvailable=true&expectedCapacity=29


---
Response status code: 200 OK. Responded in 77.935115ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1820%2Fevents%2F18193?useCacheIfAvailable=true&expectedCapacity=13


---
Response status code: 200 OK. Responded in 77.113202ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1471%2Ffacility-use-slots%2F14710?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 237.658412ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710",
  "modified": 1658487138531,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1560%2Ffacility-use-slots%2F15600?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 238.962334ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600",
  "modified": 1658487138533,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a1ff0ffb-936f-452f-ab44-1771bcd0bc40
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jolie3@gmail.com",
    "telephone": "(338) 494-4839 x10278",
    "givenName": "Heathcote",
    "familyName": "Aniyah",
    "identifier": "7af2f7f8-73b8-4e73-81ca-22bfc73212af"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1637.916266ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:19+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 36.140302ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.323388ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.693377ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.345672ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a1ff0ffb-936f-452f-ab44-1771bcd0bc40
...
---
Response status code: 201 Created. Responded in 1362.089273ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3155",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1417#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3156",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1417#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3157",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1820#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3158",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1471/facility-use-slots/14710#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40#/orderedItems/3160",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1560/facility-use-slots/15600#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a1ff0ffb-936f-452f-ab44-1771bcd0bc40/versions/6fe6093c-9480-45a9-9904-64103a206e5f",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;a1ff0ffb-936f-452f-ab44-1771bcd0bc40&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a1ff0ffb-936f-452f-ab44-1771bcd0bc40


---
Response status code: 200 OK. Responded in 33.301655ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839348854220&afterId=0d3221cb-a612-40d9-9ae5-12f64af76052",
  "message": "Listening for UUID: 'a1ff0ffb-936f-452f-ab44-1771bcd0bc40' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.235087ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a1ff0ffb-936f-452f-ab44-1771bcd0bc40&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a1ff0ffb-936f-452f-ab44-1771bcd0bc40


---
Response status code: 200 OK. Responded in 2209.356263ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "modified": 637940839462084500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
    "identifier": "a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
...
---
Response status code: 200 OK. Responded in 12.887219ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839462084533&afterId=a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "message": "Listening for UUID: 'a1ff0ffb-936f-452f-ab44-1771bcd0bc40' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40
...
---
Response status code: 201 Created. Responded in 898.357627ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "identifier": "a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 11.056187ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a1ff0ffb-936f-452f-ab44-1771bcd0bc40",
  "modified": 637940839485665800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 50.637559ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 50.055648ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.58334ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.116433ms.
```json
{
  "data": {
    "@context": [
