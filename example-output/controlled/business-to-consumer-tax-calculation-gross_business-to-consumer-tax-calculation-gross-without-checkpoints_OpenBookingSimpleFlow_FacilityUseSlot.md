...
---
Response status code: 200 OK. Responded in 34.5312ms.
```json
{
...
---
Response status code: 200 OK. Responded in 462.821817ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2366/facility-use-slots/20366",
  "modified": 1658486541809,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:42:20+00:00",
    "endDate": "2022-07-23T11:42:20+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5b664977-d07e-4aa3-a7a9-0cf1ea8ee141
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maya_Emmerich@hotmail.com",
    "telephone": "(698) 652-4663 x609",
    "givenName": "Bergstrom",
    "familyName": "Arely",
    "identifier": "e5ef3c4a-a5bd-4b66-9f82-c950eb0fbf7f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 201 Created. Responded in 84.379932ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5b664977-d07e-4aa3-a7a9-0cf1ea8ee141",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5b664977-d07e-4aa3-a7a9-0cf1ea8ee141#/orderedItems/1854",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2366/facility-use-slots/20366#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2366%2Ffacility-use-slots%2F20366?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 646.546413ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2366/facility-use-slots/20366",
  "modified": 1658486543313,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
