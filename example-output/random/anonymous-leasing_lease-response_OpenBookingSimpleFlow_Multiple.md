...
⚠️ 28 passed with 0 failures, 335 warnings and 92 suggestions 
...
---
Response status code: 200 OK. Responded in 40.238114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4082"
}
```
...
---
Response status code: 200 OK. Responded in 38.782192ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1203"
}
```
...
---
Response status code: 200 OK. Responded in 37.546373ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/224/facility-use-slots/2235"
}
```
...
---
Response status code: 200 OK. Responded in 36.595658ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/258/facility-use-slots/2577"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4082?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.778539ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4082",
    "startDate": "2022-07-31T14:43:11+00:00",
    "endDate": "2022-07-31T17:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/409",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 18.35,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT16H"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1203?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.267031ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1203",
    "startDate": "2022-07-22T22:07:11+00:00",
    "endDate": "2022-07-22T23:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F224%2Ffacility-use-slots%2F2235?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.871325ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/224",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/224/facility-use-slots/2235#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T17:02:12+00:00",
    "endDate": "2022-07-29T19:49:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F258%2Ffacility-use-slots%2F2577?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.388118ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/258",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/258/facility-use-slots/2577#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 2,
    "startDate": "2022-07-27T18:16:12+00:00",
    "endDate": "2022-07-28T00:14:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/08f9ba39-59d7-43fb-941b-01aff88bcd63
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4082"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/121#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1203"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/224/facility-use-slots/2235#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/224/facility-use-slots/2235"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/258/facility-use-slots/2577#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/258/facility-use-slots/2577"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 473.74058ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/08f9ba39-59d7-43fb-941b-01aff88bcd63",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:34+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/224"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-29T17:02:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4082?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 810.884612ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4082",
  "modified": 1658486557353,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1203?useCacheIfAvailable=true&expectedCapacity=20


---
Response status code: 200 OK. Responded in 811.062718ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1203",
  "modified": 1658486557356,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F224%2Ffacility-use-slots%2F2235?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 855.8467ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/224/facility-use-slots/2235",
  "modified": 1658486557412,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F258%2Ffacility-use-slots%2F2577?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 851.113164ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/258/facility-use-slots/2577",
  "modified": 1658486557413,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
