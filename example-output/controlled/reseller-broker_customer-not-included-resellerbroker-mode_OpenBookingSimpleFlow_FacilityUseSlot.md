...
---
Response status code: 200 OK. Responded in 19.12067ms.
```json
{
...
---
Response status code: 200 OK. Responded in 628.894078ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410",
  "modified": 1658486651225,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:44:09+00:00",
    "endDate": "2022-07-23T11:44:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b7308195-4eb8-455c-87e7-7ae3afcb4571
...
---
Response status code: 200 OK. Responded in 374.497221ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b7308195-4eb8-455c-87e7-7ae3afcb4571",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:10+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2410%2Ffacility-use-slots%2F20410?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 711.671912ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410",
  "modified": 1658486652578,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b7308195-4eb8-455c-87e7-7ae3afcb4571
...
---
Response status code: 200 OK. Responded in 191.635099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:11+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.782767ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b7308195-4eb8-455c-87e7-7ae3afcb4571
...
---
Response status code: 201 Created. Responded in 95.052943ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b7308195-4eb8-455c-87e7-7ae3afcb4571",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b7308195-4eb8-455c-87e7-7ae3afcb4571#/orderedItems/2121",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 17.210153ms.
```json
{
  "data": {
    "@context": [
