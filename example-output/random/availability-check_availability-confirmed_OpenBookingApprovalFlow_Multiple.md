...
⚠️ 54 passed with 0 failures, 566 warnings and 156 suggestions 
...
---
Response status code: 200 OK. Responded in 32.945707ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10223"
}
```
...
---
Response status code: 200 OK. Responded in 32.772605ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11122"
}
```
...
---
Response status code: 200 OK. Responded in 32.714604ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1268/facility-use-slots/12678"
}
```
...
---
Response status code: 200 OK. Responded in 51.019185ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10717"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1023%2Fevents%2F10223?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 41.801544ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10223",
    "startDate": "2022-07-28T03:53:11+00:00",
    "endDate": "2022-07-28T05:53:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11122?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 41.364137ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11122",
    "startDate": "2022-07-30T14:28:11+00:00",
    "endDate": "2022-07-30T18:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1268%2Ffacility-use-slots%2F12678?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.319421ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1268",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1268/facility-use-slots/12678#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2022-07-23T05:13:12+00:00",
    "endDate": "2022-07-23T07:17:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1072%2Ffacility-use-slots%2F10717?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.025216ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1072",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10717#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-30T22:09:12+00:00",
    "endDate": "2022-07-31T01:15:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7114fa16-2617-452b-bc17-9fc43ffc3597
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10223"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11122"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1268/facility-use-slots/12678#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1268/facility-use-slots/12678"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10717#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10717"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 690.083227ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7114fa16-2617-452b-bc17-9fc43ffc3597",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:55+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1268"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-23T05:13:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1023%2Fevents%2F10223?useCacheIfAvailable=true&expectedCapacity=38


---
Response status code: 200 OK. Responded in 33.13351ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11122?useCacheIfAvailable=true&expectedCapacity=20


---
Response status code: 200 OK. Responded in 26.539109ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1268%2Ffacility-use-slots%2F12678?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 325.090507ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1268/facility-use-slots/12678",
  "modified": 1658486457403,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1072%2Ffacility-use-slots%2F10717?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 324.961205ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10717",
  "modified": 1658486457404,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7114fa16-2617-452b-bc17-9fc43ffc3597
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Odell_Marquardt@gmail.com",
    "telephone": "(817) 754-2354",
    "givenName": "Kovacek",
    "familyName": "Adeline",
    "identifier": "fb193b1b-e5c7-4acf-b295-b6539f39f635"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 482.738096ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:58+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 78.168496ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 77.582187ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 77.083679ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 60.570426ms.
```json
{
  "data": {
    "@context": [
