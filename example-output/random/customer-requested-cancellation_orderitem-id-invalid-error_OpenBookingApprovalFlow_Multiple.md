...
---
Response status code: 200 OK. Responded in 31.686587ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12703"
}
```
...
---
Response status code: 200 OK. Responded in 30.664472ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 29.712957ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373"
}
```
...
---
Response status code: 200 OK. Responded in 18.86689ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1271%2Fevents%2F12703?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.950323ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12703",
    "startDate": "2022-07-30T17:57:11+00:00",
    "endDate": "2022-07-30T19:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1271",
      "name": "Metal Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1271#/offers/0",
...
---
Response status code: 200 OK. Responded in 20.513416ms.
```json
{
  "data": {
    "@context": [
    ...
    "endDate": "2022-07-29T16:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1138%2Ffacility-use-slots%2F11373?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.069508ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1138",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-28T16:49:12+00:00",
    "endDate": "2022-07-28T18:27:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1737%2Ffacility-use-slots%2F17362?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.656203ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 12.46,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT1H56M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-22T19:03:12+00:00",
    "endDate": "2022-07-22T22:32:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1271#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12703"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 703.073015ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:21+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1271"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1138"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-28T16:49:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1271%2Fevents%2F12703?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 211.501753ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12703",
  "modified": 1658486482878,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1011%2Fevents%2F10106?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 211.768958ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1011/events/10106",
  "modified": 1658486482879,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1138%2Ffacility-use-slots%2F11373?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 461.653001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373",
  "modified": 1658486483129,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1737%2Ffacility-use-slots%2F17362?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 465.065654ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362",
  "modified": 1658486483133,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Idella_Conroy@yahoo.com",
    "telephone": "1-561-315-4615 x990",
    "givenName": "Cremin",
    "familyName": "Cierra",
    "identifier": "c1e23640-f871-414d-b570-b89f5b472bda"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 809.08112ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 21.512625ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.514934ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.24123ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.392817ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd
...
---
Response status code: 201 Created. Responded in 469.440091ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1480",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1271#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1481",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1271#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1482",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1011#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1483",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1484",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1138/facility-use-slots/11373#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1485",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17362#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd/versions/9d9106b8-5e4c-4064-ad37-710a8d61fcdc",
  "payment": {
    "@type": "Payment",
    "identifier": "E6nPxGSLk",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9e98edfd-37bf-4ddf-95e4-c76715b3b4fd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd


---
Response status code: 200 OK. Responded in 24.397568ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '9e98edfd-37bf-4ddf-95e4-c76715b3b4fd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.363587ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9e98edfd-37bf-4ddf-95e4-c76715b3b4fd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd


---
Response status code: 200 OK. Responded in 2506.631461ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  "modified": 637940832880319200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
    "identifier": "9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
...
---
Response status code: 200 OK. Responded in 11.636775ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832882102617&afterId=32ac083e-70d1-400b-ae25-0ae30cacadc6",
  "message": "Listening for UUID: '9e98edfd-37bf-4ddf-95e4-c76715b3b4fd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd
...
---
Response status code: 201 Created. Responded in 350.981574ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  "identifier": "9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 16.824559ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9e98edfd-37bf-4ddf-95e4-c76715b3b4fd",
  "modified": 637940832906531200
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 31.729888ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.17438ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.676372ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 36.869967ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e98edfd-37bf-4ddf-95e4-c76715b3b4fd#/orderedItems/1480-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 313.310017ms.
```json
{
  "@context": "https://openactive.io/",
