[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:51:03 GMT+0000 (Coordinated Universal Time)
...
⚠️ 26 passed with 0 failures, 353 warnings and 90 suggestions 
...
---
Response status code: 200 OK. Responded in 34.190504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5466"
}
```
...
---
Response status code: 200 OK. Responded in 34.346107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/622/events/6220"
}
```
...
---
Response status code: 200 OK. Responded in 28.941812ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/418/facility-use-slots/4174"
}
```
...
---
Response status code: 200 OK. Responded in 27.975095ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4705"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F547%2Fevents%2F5466?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.087332ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5466",
    "startDate": "2022-07-29T11:19:11+00:00",
    "endDate": "2022-07-29T12:08:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F622%2Fevents%2F6220?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.511122ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/622/events/6220",
    "startDate": "2022-07-31T13:55:11+00:00",
    "endDate": "2022-07-31T17:27:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/622",
      "name": "Granite Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/622#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT1H18M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F418%2Ffacility-use-slots%2F4174?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.916211ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/418",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/418/facility-use-slots/4174#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT2H57M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-31T15:00:12+00:00",
    "endDate": "2022-07-31T17:17:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F471%2Ffacility-use-slots%2F4705?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.071072ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4705#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT19H38M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-26T13:34:12+00:00",
    "endDate": "2022-07-26T15:18:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/528be237-e5bf-4983-9027-680386927461
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5466"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/622#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/622/events/6220"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/418/facility-use-slots/4174#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/418/facility-use-slots/4174"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4705#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4705"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-frzcOAonHm",
    "accountId": "invalid-LOgaNIt7P",
    "paymentProviderId": "invalid-dt6CZSrbPr"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 176.679522ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/528be237-e5bf-4983-9027-680386927461
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hazle38@gmail.com",
    "telephone": "428-609-5777",
    "givenName": "Ondricka",
    "familyName": "Dulce",
    "identifier": "45e56dd3-70ae-41cc-b94a-80c6c10ab8cf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-iyZ9xKxE8D",
    "accountId": "invalid-Ry5HrekIg",
    "paymentProviderId": "invalid-Em7qGFy5VO"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 49.738579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
