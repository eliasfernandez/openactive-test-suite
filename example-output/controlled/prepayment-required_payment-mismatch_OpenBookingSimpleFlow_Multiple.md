...
---
Response status code: 200 OK. Responded in 25.675144ms.
```json
{
...
---
Response status code: 200 OK. Responded in 36.575347ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 528.357525ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2466/events/20466",
  "modified": 1658486748808,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 322.023763ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2454/facility-use-slots/20454",
  "modified": 1658486748603,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d7df4e61-6600-4235-bde4-4c7ffe770ceb
...
---
Response status code: 200 OK. Responded in 707.828132ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d7df4e61-6600-4235-bde4-4c7ffe770ceb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2466%2Fevents%2F20466?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 529.078431ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2466/events/20466",
  "modified": 1658486750436,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2454%2Ffacility-use-slots%2F20454?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 643.938624ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2454/facility-use-slots/20454",
  "modified": 1658486750563,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d7df4e61-6600-4235-bde4-4c7ffe770ceb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Santina_Sawayn34@hotmail.com",
    "telephone": "(704) 354-0201",
    "givenName": "Runolfsson",
    "familyName": "Keely",
    "identifier": "705006bf-f877-4d55-a515-e7127d3f46f6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 352.167249ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.139116ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.799002ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d7df4e61-6600-4235-bde4-4c7ffe770ceb
...
---
Response status code: 400 Bad Request. Responded in 462.795201ms.
```json
{
  "@context": "https://openactive.io/",
