...
---
Response status code: 200 OK. Responded in 112.788404ms.
```json
{
...
---
Response status code: 200 OK. Responded in 644.425167ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2262/events/20262",
  "modified": 1658486313633,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2262/events/20262",
    "startDate": "2022-07-23T10:38:31+00:00",
    "endDate": "2022-07-23T11:38:31+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6
...
---
Response status code: 200 OK. Responded in 93.417249ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:32+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2262%2Fevents%2F20262?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 506.430061ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2262/events/20262",
  "modified": 1658486314544,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kayleigh.Kuvalis@yahoo.com",
    "telephone": "503-964-9966 x32369",
    "givenName": "Prohaska",
    "familyName": "Jana",
    "identifier": "ece151b2-b3f4-4c83-9643-ee01f4a8650f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 690.158233ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 61.504394ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6
...
---
Response status code: 201 Created. Responded in 93.473749ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6#/orderedItems/1089",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2262#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6/versions/6cc5c0ba-8dc2-4200-83ef-7165347718d1",
  "payment": {
    "@type": "Payment",
    "identifier": "EbkToHfas",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;deb89e9d-9386-4738-9dbe-4fa78ab2c4a6&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6


---
Response status code: 200 OK. Responded in 25.915207ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830901754563&afterId=67a9ecc5-d092-4ed7-a2ca-fd25dbb5fafd",
  "message": "Listening for UUID: 'deb89e9d-9386-4738-9dbe-4fa78ab2c4a6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 44.603158ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;deb89e9d-9386-4738-9dbe-4fa78ab2c4a6&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6


---
Response status code: 200 OK. Responded in 2336.782835ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "modified": 637940831150295900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
    "identifier": "deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
...
---
Response status code: 200 OK. Responded in 7.798063ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831150295906&afterId=deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "message": "Listening for UUID: 'deb89e9d-9386-4738-9dbe-4fa78ab2c4a6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6
...
---
Response status code: 201 Created. Responded in 81.07275ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "identifier": "deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1660.174954ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "deb89e9d-9386-4738-9dbe-4fa78ab2c4a6",
  "modified": 637940831174498400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.609643ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/1968d371-a2fc-45ba-93cc-d8b4acfc4acc
...
---
Response status code: 500 Internal Server Error. Responded in 14.200531ms.
```json
{
  "@context": "https://openactive.io/",
