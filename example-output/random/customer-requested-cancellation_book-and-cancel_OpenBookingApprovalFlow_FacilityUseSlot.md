[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:34:26 GMT+0000 (Coordinated Universal Time)
...
⚠️ 25 passed with 0 failures, 176 warnings and 20 suggestions 
...
---
Response status code: 200 OK. Responded in 11.296693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1660%2Ffacility-use-slots%2F16594?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2.994951ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1660",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT9H43M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-27T23:07:12+00:00",
    "endDate": "2022-07-28T04:52:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/095702c0-b5d7-47cb-b041-4a60f70119ec
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 106.244617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/095702c0-b5d7-47cb-b041-4a60f70119ec",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:18+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1660"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-27T23:07:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1660%2Ffacility-use-slots%2F16594?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 1023.871609ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594",
  "modified": 1658486121070,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/095702c0-b5d7-47cb-b041-4a60f70119ec
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Donato_Stiedemann50@hotmail.com",
    "telephone": "794-707-7794",
    "givenName": "Legros",
    "familyName": "Bernadine",
    "identifier": "f3bb89f0-9223-4c7a-90ce-0ad5f6bcd8fa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 50.716368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:20+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 51.742685ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/095702c0-b5d7-47cb-b041-4a60f70119ec
...
---
Response status code: 201 Created. Responded in 105.765109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/095702c0-b5d7-47cb-b041-4a60f70119ec",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/095702c0-b5d7-47cb-b041-4a60f70119ec#/orderedItems/495",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1660/facility-use-slots/16594#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/095702c0-b5d7-47cb-b041-4a60f70119ec/versions/21f6b1b5-b9e1-4d15-9bf0-69b8786e0eeb",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;095702c0-b5d7-47cb-b041-4a60f70119ec&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/095702c0-b5d7-47cb-b041-4a60f70119ec


---
Response status code: 200 OK. Responded in 3.51426ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829179475376&afterId=4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "message": "Listening for UUID: '095702c0-b5d7-47cb-b041-4a60f70119ec' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.960907ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;095702c0-b5d7-47cb-b041-4a60f70119ec&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/095702c0-b5d7-47cb-b041-4a60f70119ec


---
Response status code: 200 OK. Responded in 2309.670838ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "095702c0-b5d7-47cb-b041-4a60f70119ec",
  "modified": 637940829206530200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/095702c0-b5d7-47cb-b041-4a60f70119ec",
    "identifier": "095702c0-b5d7-47cb-b041-4a60f70119ec",
...
---
Response status code: 200 OK. Responded in 19.156897ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829207060130&afterId=4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "message": "Listening for UUID: '095702c0-b5d7-47cb-b041-4a60f70119ec' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/095702c0-b5d7-47cb-b041-4a60f70119ec
...
---
Response status code: 201 Created. Responded in 45.497604ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/095702c0-b5d7-47cb-b041-4a60f70119ec",
  "identifier": "095702c0-b5d7-47cb-b041-4a60f70119ec",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 770.914425ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "095702c0-b5d7-47cb-b041-4a60f70119ec",
  "modified": 637940829230589400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 16.448854ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;095702c0-b5d7-47cb-b041-4a60f70119ec&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/095702c0-b5d7-47cb-b041-4a60f70119ec


---
Response status code: 200 OK. Responded in 17.47967ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940829150973714&afterId=e5efbce0-e281-4dbd-a8e9-24e0370a530a",
  "message": "Listening for UUID: '095702c0-b5d7-47cb-b041-4a60f70119ec' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Request
PATCH https://localhost:5001/api/openbooking/orders/095702c0-b5d7-47cb-b041-4a60f70119ec
...
---
Response status code: 204 No Content. Responded in 42.088351ms.
...
---
Response status code: 204 No Content. Responded in 26.225948ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
* ✅ should return 204 on success
...
### Orders (orders) Feed collect for &#x27;095702c0-b5d7-47cb-b041-4a60f70119ec&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/095702c0-b5d7-47cb-b041-4a60f70119ec


---
Response status code: 200 OK. Responded in 2423.297723ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "095702c0-b5d7-47cb-b041-4a60f70119ec",
  "modified": 637940829252631200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
