...
⚠️ 13 passed with 0 failures, 147 warnings and 48 suggestions 
...
---
Response status code: 200 OK. Responded in 73.479562ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/805/events/8048"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F805%2Fevents%2F8048?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.866866ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/805/events/8048",
    "startDate": "2022-07-20T16:23:11+00:00",
    "endDate": "2022-07-20T18:35:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/805",
      "name": "Cotton Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/805#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "PT23H8M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5a1d4ba3-74fe-4591-b45f-175b95264011
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/805#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/805/events/8048"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 329.225731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5a1d4ba3-74fe-4591-b45f-175b95264011",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/805"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5a1d4ba3-74fe-4591-b45f-175b95264011
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mozelle_Emmerich58@hotmail.com",
    "telephone": "1-304-574-7348 x73820",
    "givenName": "Kris",
    "familyName": "Chris",
    "identifier": "c397396b-ea2f-4893-bbce-4d4ab24e3030"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 326.501329ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5a1d4ba3-74fe-4591-b45f-175b95264011
...
---
Response status code: 409 Conflict. Responded in 78.831246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5a1d4ba3-74fe-4591-b45f-175b95264011",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
