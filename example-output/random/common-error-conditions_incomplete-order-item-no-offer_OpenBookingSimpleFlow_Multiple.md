...
---
Response status code: 200 OK. Responded in 27.607843ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/635/events/6348"
}
```
...
---
Response status code: 200 OK. Responded in 26.220521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1208"
}
```
...
---
Response status code: 200 OK. Responded in 18.823202ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2435"
}
```
...
---
Response status code: 200 OK. Responded in 17.802886ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/302/facility-use-slots/3014"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F635%2Fevents%2F6348?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 46.614749ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/635/events/6348",
    "startDate": "2022-07-30T18:32:11+00:00",
    "endDate": "2022-07-30T23:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1208?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 46.151642ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1208",
    "startDate": "2022-07-22T19:19:11+00:00",
    "endDate": "2022-07-22T23:18:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F244%2Ffacility-use-slots%2F2435?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.633033ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0.47,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 7,
    "startDate": "2022-07-23T06:22:12+00:00",
    "endDate": "2022-07-23T10:11:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F302%2Ffacility-use-slots%2F3014?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.135625ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/302/facility-use-slots/3014#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 7,
    "startDate": "2022-07-23T06:52:12+00:00",
    "endDate": "2022-07-23T12:49:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/676481ac-c2b9-43d3-8f78-c927e1eda977
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/635/events/6348"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1208"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2435"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/302/facility-use-slots/3014#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/302/facility-use-slots/3014"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 53.463959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/676481ac-c2b9-43d3-8f78-c927e1eda977",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/676481ac-c2b9-43d3-8f78-c927e1eda977
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emerald6@hotmail.com",
    "telephone": "716-680-8594 x48657",
    "givenName": "Macejkovic",
    "familyName": "Wallace",
    "identifier": "a5fcd899-885d-4c4d-aee7-26b0a055a9ac"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 42.888889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/676481ac-c2b9-43d3-8f78-c927e1eda977
...
---
Response status code: 409 Conflict. Responded in 39.16763ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/676481ac-c2b9-43d3-8f78-c927e1eda977",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
