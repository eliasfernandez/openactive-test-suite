[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:44:28 GMT+0000 (Coordinated Universal Time)
...
⚠️ 9 passed with 0 failures, 91 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 6.551672ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1139/facility-use-slots/11385"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1139%2Ffacility-use-slots%2F11385?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.740798ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1139",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1139/facility-use-slots/11385#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-26T12:56:12+00:00",
    "endDate": "2022-07-26T13:47:12+00:00"
  }
}
```
### Specs
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/432e4919-b2fb-4dab-b50d-58aae28f674b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gaston_Purdy@hotmail.com",
    "telephone": "1-735-969-2522 x2888",
    "givenName": "Kirlin",
    "familyName": "Cordelia",
    "identifier": "d4343a2f-9f76-4cd6-bd5f-7a5854e7a8bc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1139/facility-use-slots/11385#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1139/facility-use-slots/11385"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 581.987455ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/432e4919-b2fb-4dab-b50d-58aae28f674b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/432e4919-b2fb-4dab-b50d-58aae28f674b#/orderedItems/2018",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1139/facility-use-slots/11385#/offers/0",
        "allowCustomerCancellationFullRefund": true,
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1139"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-26T12:56:12+00:00",
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/432e4919-b2fb-4dab-b50d-58aae28f674b/versions/a3581440-8ef5-4253-9871-3f11fce69daa",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;432e4919-b2fb-4dab-b50d-58aae28f674b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/432e4919-b2fb-4dab-b50d-58aae28f674b


---
Response status code: 200 OK. Responded in 85.977054ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834902424697&afterId=5dca0d35-5ed4-4522-a962-383f60d2ad4b",
  "message": "Listening for UUID: '432e4919-b2fb-4dab-b50d-58aae28f674b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 604.547547ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;432e4919-b2fb-4dab-b50d-58aae28f674b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/432e4919-b2fb-4dab-b50d-58aae28f674b


---
Response status code: 200 OK. Responded in 2126.591944ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "432e4919-b2fb-4dab-b50d-58aae28f674b",
  "modified": 637940834957285000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/432e4919-b2fb-4dab-b50d-58aae28f674b",
    "identifier": "432e4919-b2fb-4dab-b50d-58aae28f674b",
...
---
Response status code: 200 OK. Responded in 13.566256ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834957285026&afterId=432e4919-b2fb-4dab-b50d-58aae28f674b",
  "message": "Listening for UUID: '432e4919-b2fb-4dab-b50d-58aae28f674b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/432e4919-b2fb-4dab-b50d-58aae28f674b
...
---
Response status code: 201 Created. Responded in 142.392932ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/432e4919-b2fb-4dab-b50d-58aae28f674b",
  "identifier": "432e4919-b2fb-4dab-b50d-58aae28f674b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1086.793303ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "432e4919-b2fb-4dab-b50d-58aae28f674b",
  "modified": 637940834979390600
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1139%2Ffacility-use-slots%2F11385?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 14.099758ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 60.211329ms.
```json
{
  "@context": [
    "https://openactive.io/",
