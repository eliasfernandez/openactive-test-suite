...
---
Response status code: 200 OK. Responded in 114.275654ms.
```json
{
...
---
Response status code: 200 OK. Responded in 959.465009ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2311/events/20311",
  "modified": 1658486394813,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/51e2e142-041a-44ee-b270-95a6487f30b0
...
---
Response status code: 200 OK. Responded in 207.826135ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/51e2e142-041a-44ee-b270-95a6487f30b0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2311%2Fevents%2F20311?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 211.674767ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2311/events/20311",
  "modified": 1658486395832,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/51e2e142-041a-44ee-b270-95a6487f30b0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Raoul.Huel7@yahoo.com",
    "telephone": "725-587-2386",
    "givenName": "Runolfsson",
    "familyName": "Enola",
    "identifier": "e43492b9-5d39-4604-b632-dc2334420544"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 367.379966ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.592097ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/51e2e142-041a-44ee-b270-95a6487f30b0
...
---
Response status code: 201 Created. Responded in 156.153503ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/51e2e142-041a-44ee-b270-95a6487f30b0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/51e2e142-041a-44ee-b270-95a6487f30b0#/orderedItems/1380",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2311#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 5.256944ms.
```json
{
  "data": {
    "@context": [
