[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:22 GMT+0000 (Coordinated Universal Time)
...
⚠️ 16 passed with 0 failures, 165 warnings and 56 suggestions 
...
---
Response status code: 200 OK. Responded in 9.90224ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15385"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1539%2Fevents%2F15385?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.583188ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15385",
    "startDate": "2022-07-29T11:20:11+00:00",
    "endDate": "2022-07-29T16:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1539",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1539#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT19H1M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1539#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15385"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 156.604285ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1539"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1539%2Fevents%2F15385?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 615.422876ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15385",
  "modified": 1658486754354,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3
...
---
Response status code: 200 OK. Responded in 231.959806ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:53+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.210513ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3
...
---
Response status code: 201 Created. Responded in 277.052543ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3#/orderedItems/2170",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1539#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3/versions/0c10aa5a-3260-497d-9c51-fccf9bf22ca0",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3


---
Response status code: 200 OK. Responded in 29.382209ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940835456841604&afterId=37373ab9-36b0-44f5-ba89-80b181b40e2f",
  "message": "Listening for UUID: '8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 38.440797ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3


---
Response status code: 200 OK. Responded in 2500.834235ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "modified": 637940835557512800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
    "identifier": "8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
...
---
Response status code: 200 OK. Responded in 13.891388ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940835557512812&afterId=8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "message": "Listening for UUID: '8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3
...
---
Response status code: 201 Created. Responded in 154.586005ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "identifier": "8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1638.902955ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "8a7b1a99-dd6f-4ff7-9fb9-a6bdedaec3e3",
  "modified": 637940835583348400
}
```
### Specs
* ✅ should return 200 on success
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B))
...
---
Response status code: 200 OK. Responded in 5.696938ms.
```json
{
  "data": {
    "@context": [
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
