...
---
Response status code: 200 OK. Responded in 31.062982ms.
```json
{
...
---
Response status code: 200 OK. Responded in 276.227308ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2482/events/20482",
  "modified": 1658486790981,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2482/events/20482",
    "startDate": "2022-07-23T10:46:29+00:00",
    "endDate": "2022-07-23T11:46:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a053d8a2-48e9-46ae-ac37-02e0d15400d4
...
---
Response status code: 200 OK. Responded in 190.56123ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a053d8a2-48e9-46ae-ac37-02e0d15400d4",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2482%2Fevents%2F20482?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 446.286052ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2482/events/20482",
  "modified": 1658486792170,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a053d8a2-48e9-46ae-ac37-02e0d15400d4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rey_Jerde@hotmail.com",
    "telephone": "278-816-5282 x46387",
    "givenName": "Hegmann",
    "familyName": "Fabian",
    "identifier": "1dac9a88-5bc0-46ec-bf9b-d1c2d2d9dc55"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 233.102707ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.658568ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a053d8a2-48e9-46ae-ac37-02e0d15400d4
...
---
Response status code: 201 Created. Responded in 903.105031ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a053d8a2-48e9-46ae-ac37-02e0d15400d4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a053d8a2-48e9-46ae-ac37-02e0d15400d4#/orderedItems/2572",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2482#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 17.225555ms.
```json
{
  "data": {
    "@context": [
