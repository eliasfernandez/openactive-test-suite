...
---
Response status code: 200 OK. Responded in 263.632992ms.
```json
{
...
---
Response status code: 200 OK. Responded in 942.843552ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2527/facility-use-slots/20527",
  "modified": 1658486914834,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:48:32+00:00",
    "endDate": "2022-07-23T11:48:32+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7b754513-f408-4752-a3cf-27516fe4527e
...
---
Response status code: 200 OK. Responded in 963.383638ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7b754513-f408-4752-a3cf-27516fe4527e",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2527%2Ffacility-use-slots%2F20527?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 567.099444ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2527/facility-use-slots/20527",
  "modified": 1658486916667,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7b754513-f408-4752-a3cf-27516fe4527e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elna_King@yahoo.com",
    "telephone": "372.618.5778 x6868",
    "givenName": "Bednar",
    "familyName": "Juwan",
    "identifier": "aa6334d0-9035-472f-9bf2-0eb16d28dd52"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 693.285088ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.813471ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7b754513-f408-4752-a3cf-27516fe4527e
...
---
Response status code: 400 Bad Request. Responded in 565.558529ms.
```json
{
  "@context": "https://openactive.io/",
