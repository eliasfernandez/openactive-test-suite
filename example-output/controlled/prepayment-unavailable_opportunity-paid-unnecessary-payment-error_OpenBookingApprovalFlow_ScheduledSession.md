...
---
Response status code: 200 OK. Responded in 447.108186ms.
```json
{
...
---
Response status code: 200 OK. Responded in 480.261289ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2539/events/20539",
  "modified": 1658486911396,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2539/events/20539",
    "startDate": "2022-07-23T10:48:29+00:00",
    "endDate": "2022-07-23T11:48:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a4aeb4f7-2fe5-4987-a862-e02c711a1ba8
...
---
Response status code: 200 OK. Responded in 344.414048ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a4aeb4f7-2fe5-4987-a862-e02c711a1ba8",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2539%2Fevents%2F20539?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 544.541775ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2539/events/20539",
  "modified": 1658486912581,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a4aeb4f7-2fe5-4987-a862-e02c711a1ba8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cloyd.Swaniawski@gmail.com",
    "telephone": "(999) 614-6588 x3212",
    "givenName": "Watsica",
    "familyName": "Ova",
    "identifier": "9f923f98-79d5-4e62-b1ea-2f4d83a9aea5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 278.93243ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.813226ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a4aeb4f7-2fe5-4987-a862-e02c711a1ba8
...
---
Response status code: 400 Bad Request. Responded in 456.512641ms.
```json
{
  "@context": "https://openactive.io/",
