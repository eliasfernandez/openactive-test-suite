...
---
Response status code: 200 OK. Responded in 59.122074ms.
```json
{
...
---
Response status code: 200 OK. Responded in 499.812008ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264",
  "modified": 1658486316780,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264",
    "startDate": "2022-07-23T10:38:35+00:00",
    "endDate": "2022-07-23T11:38:35+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e2494e7c-cd07-46f2-bf2e-135b957fac5b
...
---
Response status code: 200 OK. Responded in 123.41959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e2494e7c-cd07-46f2-bf2e-135b957fac5b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2264%2Fevents%2F20264?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 634.581988ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264",
  "modified": 1658486317934,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e2494e7c-cd07-46f2-bf2e-135b957fac5b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maryam_Walsh68@yahoo.com",
    "telephone": "202-224-3110",
    "givenName": "Gerhold",
    "familyName": "Jett",
    "identifier": "c8e836e3-284d-48f1-bb7d-a02c3e506410"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 56.064749ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.072833ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e2494e7c-cd07-46f2-bf2e-135b957fac5b
...
---
Response status code: 201 Created. Responded in 75.876708ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e2494e7c-cd07-46f2-bf2e-135b957fac5b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e2494e7c-cd07-46f2-bf2e-135b957fac5b#/orderedItems/1094",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2264#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 22.058303ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/e2494e7c-cd07-46f2-bf2e-135b957fac5b
...
---
Response status code: 400 Bad Request. Responded in 15.493142ms.
```json
{
  "@context": "https://openactive.io/",
