...
---
Response status code: 200 OK. Responded in 260.734652ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1254.845023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 458.674339ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502",
  "modified": 1658486836853,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502",
    "startDate": "2022-07-23T10:47:14+00:00",
    "endDate": "2022-07-23T11:47:14+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1042.647308ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2490/facility-use-slots/20490",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f71c544f-4342-4ef2-a3d6-ad3a66fc4d15
...
---
Response status code: 200 OK. Responded in 361.961166ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f71c544f-4342-4ef2-a3d6-ad3a66fc4d15",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:16+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2502%2Fevents%2F20502?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 976.734714ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502",
  "modified": 1658486839135,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2490%2Ffacility-use-slots%2F20490?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 520.202294ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2490/facility-use-slots/20490",
  "modified": 1658486838685,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f71c544f-4342-4ef2-a3d6-ad3a66fc4d15
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Althea6@gmail.com",
    "telephone": "(914) 417-5827 x1021",
    "givenName": "Kihn",
    "familyName": "Olaf",
    "identifier": "7168038a-1b73-4b33-b8cf-54a158b5edf2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 724.625939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.623896ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.994791ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f71c544f-4342-4ef2-a3d6-ad3a66fc4d15
...
---
Response status code: 400 Bad Request. Responded in 955.795997ms.
```json
{
  "@context": "https://openactive.io/",
