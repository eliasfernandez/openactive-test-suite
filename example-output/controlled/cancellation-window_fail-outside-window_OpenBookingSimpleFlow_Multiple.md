[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:40:53 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 239.265646ms.
```json
{
...
---
Response status code: 200 OK. Responded in 95.040913ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 84.736025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 123.91916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 664.853486ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2348/events/20348",
  "modified": 1658486463984,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2348/events/20348",
    "startDate": "2022-07-23T10:41:02+00:00",
    "endDate": "2022-07-23T11:41:02+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 648.432145ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2345/events/20345",
  "modified": 1658486463968,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 304.835407ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333",
  "modified": 1658486463626,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 305.28571ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334",
  "modified": 1658486463628,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa
...
---
Response status code: 200 OK. Responded in 968.547116ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:04+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2348%2Fevents%2F20348?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 91.331893ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2345%2Fevents%2F20345?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 91.380394ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2333%2Ffacility-use-slots%2F20333?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 90.90509ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2334%2Ffacility-use-slots%2F20334?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 90.952891ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jocelyn.Towne54@yahoo.com",
    "telephone": "1-932-681-8198 x026",
    "givenName": "Nolan",
    "familyName": "Clara",
    "identifier": "27077680-12c5-4fd5-bbd7-e785e5d30f6f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 768.162675ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 71.252319ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 72.681232ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 71.599222ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 70.912716ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa
...
---
Response status code: 201 Created. Responded in 766.806863ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1652",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2348#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1653",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2348#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1654",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1655",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1656",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa#/orderedItems/1657",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 72.899825ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 55.205673ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.802861ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.049955ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/1c36cde8-9b65-4c3e-b8e5-0c19cb24f6fa
...
---
Response status code: 400 Bad Request. Responded in 21.842187ms.
```json
{
  "@context": "https://openactive.io/",
