...
⚠️ 22 passed with 0 failures, 251 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 20.530994ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/760/events/7591"
}
```
...
---
Response status code: 200 OK. Responded in 19.073965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F760%2Fevents%2F7591?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.722848ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/760/events/7591",
    "startDate": "2022-07-22T14:26:11+00:00",
    "endDate": "2022-07-22T18:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/760",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/760#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "PT17H10M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F176%2Ffacility-use-slots%2F1755?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.105737ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/176",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-29T23:22:11+00:00",
    "endDate": "2022-07-30T00:24:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/760#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/760/events/7591"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 428.32671ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:27+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/760"
        },
        "maximumAttendeeCapacity": 50,
        "remainingAttendeeCapacity": 50
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F760%2Fevents%2F7591?useCacheIfAvailable=true&expectedCapacity=49


---
Response status code: 200 OK. Responded in 209.73252ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/760/events/7591",
  "modified": 1658486969484,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F176%2Ffacility-use-slots%2F1755?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 833.379274ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755",
  "modified": 1658486970110,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Daphney_Cremin@yahoo.com",
    "telephone": "1-669-258-9705 x657",
    "givenName": "O'Connell",
    "familyName": "Grant",
    "identifier": "2fee8dc2-4761-4d2a-8790-4ccd18e6e77e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 670.003142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:29+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 64.206831ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 61.143472ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f
...
---
Response status code: 201 Created. Responded in 1141.363153ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f#/orderedItems/2759",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/760#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17dfb5d4-19e5-4263-8536-f0d4a2e0aa0f#/orderedItems/2760",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/176/facility-use-slots/1755#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 36.645999ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.562078ms.
```json
{
  "data": {
    "@context": [
