...
⚠️ 26 passed with 0 failures, 404 warnings and 108 suggestions 
...
---
Response status code: 200 OK. Responded in 49.25102ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4571"
}
```
...
---
Response status code: 200 OK. Responded in 53.439489ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 59.267887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5798"
}
```
...
---
Response status code: 200 OK. Responded in 51.334455ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/390/facility-use-slots/3900"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F458%2Fevents%2F4571?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.351289ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4571",
    "startDate": "2022-07-31T00:14:11+00:00",
    "endDate": "2022-07-31T03:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 22.891181ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001",
    "startDate": "2022-07-22T15:26:11+00:00",
    "endDate": "2022-07-22T17:30:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F580%2Ffacility-use-slots%2F5798?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.432873ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5798#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0.92,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT14H49M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-25T00:38:12+00:00",
    "endDate": "2022-07-25T03:58:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F390%2Ffacility-use-slots%2F3900?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.997466ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/390/facility-use-slots/3900#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT15M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-28T00:42:12+00:00",
    "endDate": "2022-07-28T03:48:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c3db4c73-72de-4d23-89e7-a32d80c3f82e
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4571"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/101#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5798#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5798"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/390/facility-use-slots/3900#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/390/facility-use-slots/3900"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 306.617898ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c3db4c73-72de-4d23-89e7-a32d80c3f82e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josiane68@hotmail.com",
    "telephone": "717-229-6626 x759",
    "givenName": "Vandervort",
    "familyName": "Johnny",
    "identifier": "5d021504-f420-419a-bcc7-24a01b4b8f87"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 957.853136ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
