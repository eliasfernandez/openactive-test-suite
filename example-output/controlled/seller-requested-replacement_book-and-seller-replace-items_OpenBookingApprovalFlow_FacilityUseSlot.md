...
---
Response status code: 200 OK. Responded in 16.422813ms.
```json
{
...
---
Response status code: 200 OK. Responded in 944.654165ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2076/facility-use-slots/20076",
  "modified": 1658486088840,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:34:46+00:00",
    "endDate": "2022-07-23T11:34:46+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/147676c2-88f1-444c-908a-80793a4a806c
...
---
Response status code: 200 OK. Responded in 45.674613ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/147676c2-88f1-444c-908a-80793a4a806c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2076%2Ffacility-use-slots%2F20076?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 870.368856ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2076/facility-use-slots/20076",
  "modified": 1658486090008,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/147676c2-88f1-444c-908a-80793a4a806c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hilda80@yahoo.com",
    "telephone": "311-273-3362 x2485",
    "givenName": "Haley",
    "familyName": "Eva",
    "identifier": "422d7502-13ed-4b7e-90ba-8be0fe040e61"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 94.354745ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.877833ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/147676c2-88f1-444c-908a-80793a4a806c
...
---
Response status code: 201 Created. Responded in 68.466069ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/147676c2-88f1-444c-908a-80793a4a806c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147676c2-88f1-444c-908a-80793a4a806c#/orderedItems/471",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2076/facility-use-slots/20076#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/147676c2-88f1-444c-908a-80793a4a806c/versions/5b4ead22-d1a0-4d8a-ac08-f22174d268d2",
  "payment": {
    "@type": "Payment",
    "identifier": "FUd8DZsY-",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;147676c2-88f1-444c-908a-80793a4a806c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/147676c2-88f1-444c-908a-80793a4a806c


---
Response status code: 200 OK. Responded in 3.311423ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828822974795&afterId=bbb0ed49-2446-4428-85b3-ed8225e876bd",
  "message": "Listening for UUID: '147676c2-88f1-444c-908a-80793a4a806c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 161.255104ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;147676c2-88f1-444c-908a-80793a4a806c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/147676c2-88f1-444c-908a-80793a4a806c


---
Response status code: 200 OK. Responded in 2292.474689ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "147676c2-88f1-444c-908a-80793a4a806c",
  "modified": 637940828897675400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/147676c2-88f1-444c-908a-80793a4a806c",
    "identifier": "147676c2-88f1-444c-908a-80793a4a806c",
...
---
Response status code: 200 OK. Responded in 13.445192ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828897675395&afterId=147676c2-88f1-444c-908a-80793a4a806c",
  "message": "Listening for UUID: '147676c2-88f1-444c-908a-80793a4a806c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/147676c2-88f1-444c-908a-80793a4a806c
...
---
Response status code: 201 Created. Responded in 65.188446ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/147676c2-88f1-444c-908a-80793a4a806c",
  "identifier": "147676c2-88f1-444c-908a-80793a4a806c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1399.397977ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "147676c2-88f1-444c-908a-80793a4a806c",
  "modified": 637940828922213800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.835333ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;147676c2-88f1-444c-908a-80793a4a806c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/147676c2-88f1-444c-908a-80793a4a806c


---
Response status code: 200 OK. Responded in 2.775919ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940828848089419&afterId=bbb0ed49-2446-4428-85b3-ed8225e876bd",
  "message": "Listening for UUID: '147676c2-88f1-444c-908a-80793a4a806c' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 20.202338ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:ReplacementSimulateAction)

### Orders (orders) Feed collect for &#x27;147676c2-88f1-444c-908a-80793a4a806c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/147676c2-88f1-444c-908a-80793a4a806c


---
Response status code: 200 OK. Responded in 2284.974709ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "147676c2-88f1-444c-908a-80793a4a806c",
  "modified": 637940828943025400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "orderedItem": [
      {
        ...
        "acceptedOffer": {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/20076#/offers/0",
          "price": 14.99,
          "priceCurrency": "GBP"
        },
        "accessCode": [
