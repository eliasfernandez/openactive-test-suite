...
---
Response status code: 200 OK. Responded in 78.49291ms.
```json
{
...
---
Response status code: 200 OK. Responded in 532.177213ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512",
  "modified": 1658486859758,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512",
    "startDate": "2022-07-23T10:47:38+00:00",
    "endDate": "2022-07-23T11:47:38+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dbc6e47f-deb7-4282-ab51-7fd6b77fd7a0
...
---
Response status code: 200 OK. Responded in 407.956989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dbc6e47f-deb7-4282-ab51-7fd6b77fd7a0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2512%2Fevents%2F20512?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 254.620103ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512",
  "modified": 1658486860690,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dbc6e47f-deb7-4282-ab51-7fd6b77fd7a0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Merle_Hoppe@yahoo.com",
    "telephone": "1-649-897-2326",
    "givenName": "Trantow",
    "familyName": "Ella",
    "identifier": "f2e22228-1a45-4290-a089-0b0f35ce77fd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 261.581265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.201937ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/dbc6e47f-deb7-4282-ab51-7fd6b77fd7a0
...
---
Response status code: 400 Bad Request. Responded in 1131.720234ms.
```json
{
  "@context": "https://openactive.io/",
