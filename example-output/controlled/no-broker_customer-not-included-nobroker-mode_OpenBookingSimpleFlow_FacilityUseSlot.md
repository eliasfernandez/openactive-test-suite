...
---
Response status code: 200 OK. Responded in 11.822095ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1054.595155ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2255/facility-use-slots/20255",
  "modified": 1658486317613,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/90c07493-49ed-4b1e-ad93-7544cfdc6001
...
---
Response status code: 200 OK. Responded in 68.64355ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/90c07493-49ed-4b1e-ad93-7544cfdc6001",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:36+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2255%2Ffacility-use-slots%2F20255?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1429.683063ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2255/facility-use-slots/20255",
  "modified": 1658486319357,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/90c07493-49ed-4b1e-ad93-7544cfdc6001
...
---
Response status code: 400 Bad Request. Responded in 33.466969ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 35.398984ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1001.849437ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2256/facility-use-slots/20256",
  "modified": 1658486320616,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:38:38+00:00",
    "endDate": "2022-07-23T11:38:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5df16969-a4bd-48f9-a555-ebe106a87463
...
---
Response status code: 200 OK. Responded in 48.91685ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5df16969-a4bd-48f9-a555-ebe106a87463",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2256%2Ffacility-use-slots%2F20256?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1219.383728ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2256/facility-use-slots/20256",
  "modified": 1658486322041,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5df16969-a4bd-48f9-a555-ebe106a87463
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josh85@yahoo.com",
    "telephone": "204-848-7740",
    "givenName": "Stokes",
    "familyName": "Ronaldo",
    "identifier": "441a3a5d-d749-48ed-a37d-57f15abed394"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 214.148471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.724954ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5df16969-a4bd-48f9-a555-ebe106a87463
...
---
Response status code: 400 Bad Request. Responded in 21.174495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
