...
⚠️ 18 passed with 0 failures, 140 warnings and 16 suggestions 
...
---
Response status code: 200 OK. Responded in 9.344257ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1539%2Ffacility-use-slots%2F15382?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.749203ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-31T08:58:12+00:00",
    "endDate": "2022-07-31T09:31:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/22c446f3-cf0c-4edb-a455-832f52d070c7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 184.348471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/22c446f3-cf0c-4edb-a455-832f52d070c7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:18+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1539%2Ffacility-use-slots%2F15382?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 913.345129ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382",
  "modified": 1658486600536,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/22c446f3-cf0c-4edb-a455-832f52d070c7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Naomi_Parker@yahoo.com",
    "telephone": "762-295-6747 x90745",
    "givenName": "Leannon",
    "familyName": "Maryjane",
    "identifier": "d713909a-0eab-4890-a126-1ede6dd980a5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 203.629102ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:19+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.719915ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/22c446f3-cf0c-4edb-a455-832f52d070c7
...
---
Response status code: 201 Created. Responded in 240.953529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/22c446f3-cf0c-4edb-a455-832f52d070c7",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/22c446f3-cf0c-4edb-a455-832f52d070c7#/orderedItems/1804",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1539/facility-use-slots/15382#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/22c446f3-cf0c-4edb-a455-832f52d070c7/versions/9b387a56-a41c-45b9-ac62-74c682962227",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;22c446f3-cf0c-4edb-a455-832f52d070c7&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/22c446f3-cf0c-4edb-a455-832f52d070c7


---
Response status code: 200 OK. Responded in 13.610374ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833960448361&afterId=d329eb83-f0f9-4f9b-91e8-7550b25b24d6",
  "message": "Listening for UUID: '22c446f3-cf0c-4edb-a455-832f52d070c7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.418379ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;22c446f3-cf0c-4edb-a455-832f52d070c7&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/22c446f3-cf0c-4edb-a455-832f52d070c7


---
Response status code: 200 OK. Responded in 2122.001181ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "22c446f3-cf0c-4edb-a455-832f52d070c7",
  "modified": 637940834005522700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/22c446f3-cf0c-4edb-a455-832f52d070c7",
    "identifier": "22c446f3-cf0c-4edb-a455-832f52d070c7",
...
---
Response status code: 200 OK. Responded in 17.364477ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834005522715&afterId=22c446f3-cf0c-4edb-a455-832f52d070c7",
  "message": "Listening for UUID: '22c446f3-cf0c-4edb-a455-832f52d070c7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/22c446f3-cf0c-4edb-a455-832f52d070c7
...
---
Response status code: 201 Created. Responded in 95.625731ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/22c446f3-cf0c-4edb-a455-832f52d070c7",
  "identifier": "22c446f3-cf0c-4edb-a455-832f52d070c7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 20.773791ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "22c446f3-cf0c-4edb-a455-832f52d070c7",
  "modified": 637940834027286900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 20.023169ms.
```json
{
  "data": {
    "@context": [
