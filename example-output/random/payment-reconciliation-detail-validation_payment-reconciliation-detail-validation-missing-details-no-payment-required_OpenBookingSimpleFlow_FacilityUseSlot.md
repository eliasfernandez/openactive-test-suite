...
---
Response status code: 200 OK. Responded in 13.141731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1505"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F151%2Ffacility-use-slots%2F1505?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.821479ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1505#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-29T08:14:11+00:00",
    "endDate": "2022-07-29T13:18:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9287727c-8363-4848-9e56-b412997c3565
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1505#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1505"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 59.591651ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9287727c-8363-4848-9e56-b412997c3565
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Malvina.Metz@hotmail.com",
    "telephone": "1-970-474-5685 x1384",
    "givenName": "Cruickshank",
    "familyName": "Kaya",
    "identifier": "8c9c4c5b-b8da-41a8-a265-092d41883c39"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 30.721041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
