...
---
Response status code: 200 OK. Responded in 4.94213ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16085"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1609%2Ffacility-use-slots%2F16085?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.837264ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16085#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT40M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-26T13:28:12+00:00",
    "endDate": "2022-07-26T13:59:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f89895b-dfba-45d3-9f65-a3a86110d4f9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16085#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16085"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 327.03301ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f89895b-dfba-45d3-9f65-a3a86110d4f9",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:28+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1609%2Ffacility-use-slots%2F16085?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 567.41924ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16085",
  "modified": 1658486670090,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f89895b-dfba-45d3-9f65-a3a86110d4f9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mandy.Bins@yahoo.com",
    "telephone": "423.850.4209 x50436",
    "givenName": "Morissette",
    "familyName": "Clark",
    "identifier": "c1dc2634-e3a3-4396-bbf4-49714c7fedd5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 470.647092ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.886055ms.
```json
{
  "data": {
    "@context": [
