[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:16 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 45.670114ms.
```json
{
...
---
Response status code: 200 OK. Responded in 122.125509ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 120.454694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 160.842661ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 303.99306ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2558/events/20558",
  "modified": 1658486959764,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 303.607157ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2559/events/20559",
...
---
Response status code: 200 OK. Responded in 753.682443ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545",
  "modified": 1658486960215,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 754.822554ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546",
  "modified": 1658486960217,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/00374914-78df-4afd-82ea-fed2bfba29a0
...
---
Response status code: 400 Bad Request. Responded in 93.19395ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/00374914-78df-4afd-82ea-fed2bfba29a0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kieran.Mueller@yahoo.com",
    "telephone": "804.838.4726 x23008",
    "givenName": "Brown",
    "familyName": "Mac",
    "identifier": "d312224c-1e95-441f-b69b-aa2f2911a22c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 87.870602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
