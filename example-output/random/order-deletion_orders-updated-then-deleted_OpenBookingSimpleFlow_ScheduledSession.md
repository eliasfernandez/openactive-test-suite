...
⚠️ 20 passed with 0 failures, 194 warnings and 68 suggestions 
...
---
Response status code: 200 OK. Responded in 78.548286ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/470/events/4700"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F470%2Fevents%2F4700?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.284622ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/470/events/4700",
    "startDate": "2022-07-23T16:48:11+00:00",
    "endDate": "2022-07-23T21:57:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/470",
      "name": "Metal Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/470#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 7.27,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT22H29M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fe652370-b7b7-4467-b562-a229af6bd518
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/470#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/470/events/4700"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 107.93443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fe652370-b7b7-4467-b562-a229af6bd518",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F470%2Fevents%2F4700?useCacheIfAvailable=true&expectedCapacity=43


---
Response status code: 200 OK. Responded in 830.922745ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/470/events/4700",
  "modified": 1658486166590,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fe652370-b7b7-4467-b562-a229af6bd518
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bernice36@gmail.com",
    "telephone": "1-519-962-8356 x34737",
    "givenName": "Medhurst",
    "familyName": "Kenton",
    "identifier": "2244a753-d0c4-413a-b96e-16e8cb699999"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 205.447101ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.082043ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518
...
---
Response status code: 201 Created. Responded in 53.325094ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518#/orderedItems/561",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/470#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 5.568894ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;fe652370-b7b7-4467-b562-a229af6bd518&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/fe652370-b7b7-4467-b562-a229af6bd518


---
Response status code: 200 OK. Responded in 12.400907ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940829587325007&afterId=05beb5ea-59af-4265-90ee-930f0c467721",
  "message": "Listening for UUID: 'fe652370-b7b7-4467-b562-a229af6bd518' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 68.487446ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;fe652370-b7b7-4467-b562-a229af6bd518&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/fe652370-b7b7-4467-b562-a229af6bd518


---
Response status code: 200 OK. Responded in 2344.644953ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "fe652370-b7b7-4467-b562-a229af6bd518",
  "modified": 637940829705443300,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518",
    "identifier": "fe652370-b7b7-4467-b562-a229af6bd518",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518#/orderedItems/561",
...
---
Response status code: 200 OK. Responded in 13.612328ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
DELETE https://localhost:5001/api/openbooking/orders/fe652370-b7b7-4467-b562-a229af6bd518
...
---
Response status code: 204 No Content. Responded in 83.496498ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
...
---
Response status code: 200 OK. Responded in 2165.976163ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "fe652370-b7b7-4467-b562-a229af6bd518",
  "modified": 637940829753321700
}
```
### Specs
* ✅ should return 200 on success
