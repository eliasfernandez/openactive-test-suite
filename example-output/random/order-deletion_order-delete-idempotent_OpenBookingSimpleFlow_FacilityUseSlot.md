...
---
Response status code: 200 OK. Responded in 10.346872ms.
```json
{
...
---
Response status code: 200 OK. Responded in 11.612004ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 9.27,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT1H45M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-24T00:44:12+00:00",
    "endDate": "2022-07-24T03:31:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/58c0dd6a-7ed4-4af2-92a2-40c6698080c3
...
---
Response status code: 200 OK. Responded in 503.529898ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/58c0dd6a-7ed4-4af2-92a2-40c6698080c3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:52+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F656%2Ffacility-use-slots%2F6553?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 1065.0723189999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6553",
  "modified": 1658486695462,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/58c0dd6a-7ed4-4af2-92a2-40c6698080c3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Keaton_Schneider@hotmail.com",
    "telephone": "338-967-8006",
    "givenName": "Herzog",
    "familyName": "Macy",
    "identifier": "e4688b9b-a311-4392-a1e9-26876133406e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 969.638217ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 66.946755ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/58c0dd6a-7ed4-4af2-92a2-40c6698080c3
...
---
Response status code: 201 Created. Responded in 222.336328ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/58c0dd6a-7ed4-4af2-92a2-40c6698080c3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/58c0dd6a-7ed4-4af2-92a2-40c6698080c3#/orderedItems/2020",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6553#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 3.860702ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/orders/58c0dd6a-7ed4-4af2-92a2-40c6698080c3
...
---
Response status code: 204 No Content. Responded in 131.586149ms.
...
---
Response status code: 204 No Content. Responded in 9.478248ms.
### Specs
