...
⚠️ 20 passed with 0 failures, 122 warnings and 14 suggestions 
...
---
Response status code: 200 OK. Responded in 11.908607ms.
```json
{
...
---
Response status code: 200 OK. Responded in 890.809326ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2043/facility-use-slots/20043",
  "modified": 1658486029938,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:33:48+00:00",
    "endDate": "2022-07-23T11:33:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4
...
---
Response status code: 200 OK. Responded in 85.46177ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:49+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2043%2Ffacility-use-slots%2F20043?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1078.350616ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2043/facility-use-slots/20043",
  "modified": 1658486031451,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gilbert19@hotmail.com",
    "telephone": "1-474-912-0194 x82750",
    "givenName": "Rau",
    "familyName": "Lennie",
    "identifier": "2dee285d-d117-4f7c-833e-3a1eceba5b34"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 326.874334ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:50+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.120042ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4
...
---
Response status code: 201 Created. Responded in 79.437323ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4#/orderedItems/280",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2043/facility-use-slots/20043#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4/versions/61309fcc-b160-4aee-be13-0866f15f0271",
  "payment": {
    "@type": "Payment",
    "identifier": "_wgTt7ZSo",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;d3508c1b-8f9a-4ea9-a4f2-4624e87037e4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4


---
Response status code: 200 OK. Responded in 4.258226ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828258511155&afterId=f304579b-8d37-43ac-af6f-a1175c72fc42",
  "message": "Listening for UUID: 'd3508c1b-8f9a-4ea9-a4f2-4624e87037e4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 36.36827ms.
### Specs
* ✅ should return 204 on success

## Order Proposals Feed (after test:SellerRejectOrderProposalSimulateAction)

### Orders (order-proposals) Feed collect for &#x27;d3508c1b-8f9a-4ea9-a4f2-4624e87037e4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4


---
Response status code: 200 OK. Responded in 2319.679286ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d3508c1b-8f9a-4ea9-a4f2-4624e87037e4",
  "modified": 637940828311909500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4",
    "identifier": "d3508c1b-8f9a-4ea9-a4f2-4624e87037e4",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d3508c1b-8f9a-4ea9-a4f2-4624e87037e4
...
---
Response status code: 500 Internal Server Error. Responded in 16.360116ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 5.430838ms.
```json
{
  "data": {
    "@context": [
