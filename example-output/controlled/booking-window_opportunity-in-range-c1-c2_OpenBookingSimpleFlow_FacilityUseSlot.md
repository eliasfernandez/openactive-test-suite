...
---
Response status code: 200 OK. Responded in 14.566032ms.
```json
{
...
---
Response status code: 200 OK. Responded in 760.539678ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503",
  "modified": 1658486864078,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/346a29f3-adfe-4f89-afb8-c4b27baea855
...
---
Response status code: 200 OK. Responded in 1627.830506ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/346a29f3-adfe-4f89-afb8-c4b27baea855",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2503%2Ffacility-use-slots%2F20503?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 732.742075ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503",
  "modified": 1658486866647,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/346a29f3-adfe-4f89-afb8-c4b27baea855
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cleve.Mills@hotmail.com",
    "telephone": "336-839-7165 x9225",
    "givenName": "O'Keefe",
    "familyName": "Marilyne",
    "identifier": "ef26c850-b7f8-489d-aa69-6c627aef4af3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1195.914294ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.614051ms.
```json
{
  "data": {
    "@context": [
