...
⚠️ 14 passed with 0 failures, 84 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 42.467886ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1526/facility-use-slots/15254"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1526%2Ffacility-use-slots%2F15254?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.659904ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1526",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1526/facility-use-slots/15254#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT22H27M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-30T09:42:12+00:00",
    "endDate": "2022-07-30T13:02:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fcaa7a4d-8e17-415c-b8ac-fb698f61bd5c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1526/facility-use-slots/15254#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1526/facility-use-slots/15254"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 383.475204ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fcaa7a4d-8e17-415c-b8ac-fb698f61bd5c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1526%2Ffacility-use-slots%2F15254?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 608.811465ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1526/facility-use-slots/15254",
  "modified": 1658486744910,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fcaa7a4d-8e17-415c-b8ac-fb698f61bd5c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josianne_Zieme@hotmail.com",
    "telephone": "421.577.2889 x081",
    "givenName": "Sipes",
    "familyName": "Andres",
    "identifier": "c443fb26-7990-44c7-818b-43642c8dc380"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 427.90154ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 7.590794ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/fcaa7a4d-8e17-415c-b8ac-fb698f61bd5c
...
---
Response status code: 204 No Content. Responded in 374.244668ms.
...
---
Response status code: 204 No Content. Responded in 10.406166ms.
### Specs
