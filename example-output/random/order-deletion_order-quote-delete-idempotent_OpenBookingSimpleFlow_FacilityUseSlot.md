...
---
Response status code: 200 OK. Responded in 12.373919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/380/facility-use-slots/3793"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F380%2Ffacility-use-slots%2F3793?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.980832ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/380/facility-use-slots/3793#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT5H14M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-28T22:05:12+00:00",
    "endDate": "2022-07-29T01:57:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/05e9ffd1-588c-4681-94d9-edbaf52ce14f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/380/facility-use-slots/3793#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/380/facility-use-slots/3793"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 207.890266ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/05e9ffd1-588c-4681-94d9-edbaf52ce14f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F380%2Ffacility-use-slots%2F3793?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 958.590643ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/380/facility-use-slots/3793",
  "modified": 1658486723561,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/05e9ffd1-588c-4681-94d9-edbaf52ce14f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Melyssa.Effertz@hotmail.com",
    "telephone": "(254) 340-8988 x4765",
    "givenName": "Gibson",
    "familyName": "Grayson",
    "identifier": "5b985a2e-f952-4661-9a68-d512adaf12c9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 385.039527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.586926ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/05e9ffd1-588c-4681-94d9-edbaf52ce14f
...
---
Response status code: 204 No Content. Responded in 274.505636ms.
...
---
Response status code: 204 No Content. Responded in 8.989078ms.
### Specs
