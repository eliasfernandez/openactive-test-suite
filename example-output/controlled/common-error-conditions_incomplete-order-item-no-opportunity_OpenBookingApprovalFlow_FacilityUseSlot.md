...
---
Response status code: 200 OK. Responded in 15.592834ms.
```json
{
...
---
Response status code: 200 OK. Responded in 709.322892ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2192/facility-use-slots/20192",
  "modified": 1658486226176,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:37:04+00:00",
    "endDate": "2022-07-23T11:37:04+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cdc40d4f-2aa2-42d8-8957-6feab097dc8a
...
---
Response status code: 409 Conflict. Responded in 363.068619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cdc40d4f-2aa2-42d8-8957-6feab097dc8a",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cdc40d4f-2aa2-42d8-8957-6feab097dc8a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vergie55@hotmail.com",
    "telephone": "937-873-6565 x41745",
    "givenName": "Leffler",
    "familyName": "Katlynn",
    "identifier": "c4fc6f2f-62a8-435c-96c0-6bf911940c1b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 31.175868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cdc40d4f-2aa2-42d8-8957-6feab097dc8a
...
---
Response status code: 409 Conflict. Responded in 18.086756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/cdc40d4f-2aa2-42d8-8957-6feab097dc8a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
