[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:18 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 53.211627ms.
```json
{
...
---
Response status code: 200 OK. Responded in 131.518855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 159.70008ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 85.587586ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 546.409781ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260",
  "modified": 1658486313168,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260",
    "startDate": "2022-07-21T10:38:31+00:00",
    "endDate": "2022-07-21T11:38:31+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 547.000286ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2261/events/20261",
  "modified": 1658486313169,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 509.895788ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252",
  "modified": 1658486313132,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 508.84688ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251",
  "modified": 1658486313131,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/27d0c3d9-831c-4aea-b868-06933c66db40
...
---
Response status code: 409 Conflict. Responded in 91.542434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/27d0c3d9-831c-4aea-b868-06933c66db40",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/27d0c3d9-831c-4aea-b868-06933c66db40
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Raleigh.Jacobs@yahoo.com",
    "telephone": "865.727.3040 x99364",
    "givenName": "Smitham",
    "familyName": "Reanna",
    "identifier": "05c99a12-40dd-4805-ae67-c15f4c2eed43"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 545.993878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/27d0c3d9-831c-4aea-b868-06933c66db40
...
---
Response status code: 409 Conflict. Responded in 42.529841ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/27d0c3d9-831c-4aea-b868-06933c66db40",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
