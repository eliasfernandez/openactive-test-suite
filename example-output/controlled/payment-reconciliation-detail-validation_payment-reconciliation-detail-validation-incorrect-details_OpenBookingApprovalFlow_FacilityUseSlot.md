...
---
Response status code: 200 OK. Responded in 676.77877ms.
```json
{
...
---
Response status code: 200 OK. Responded in 442.547935ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572",
  "modified": 1658487007378,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:50:05+00:00",
    "endDate": "2022-07-23T11:50:05+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/95b54f62-1ec0-4624-8cb5-2a89eb816272
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-TPqpsc9uqM",
    "accountId": "invalid-GNdekj_C5",
    "paymentProviderId": "invalid-xvSjLTHVll"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 301.944753ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/95b54f62-1ec0-4624-8cb5-2a89eb816272
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dimitri61@hotmail.com",
    "telephone": "295.564.1277",
    "givenName": "McKenzie",
    "familyName": "Ari",
    "identifier": "a711555f-4ef4-4e5d-9701-dcde5f2c74af"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-J7ZwPgOysM",
    "accountId": "invalid-2B6lTRLbNl",
    "paymentProviderId": "invalid-Ba1rH3UnHB"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 34.461814ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
