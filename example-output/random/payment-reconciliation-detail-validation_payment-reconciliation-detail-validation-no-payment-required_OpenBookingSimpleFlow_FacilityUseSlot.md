...
⚠️ 16 passed with 0 failures, 119 warnings and 14 suggestions 
...
---
Response status code: 200 OK. Responded in 6.464804ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F477%2Ffacility-use-slots%2F4766?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.594774ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/477",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT6H7M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-29T19:24:12+00:00",
    "endDate": "2022-07-29T23:39:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 250.19952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:04+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F477%2Ffacility-use-slots%2F4766?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 679.402317ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766",
  "modified": 1658487126458,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nikki.Shields18@gmail.com",
    "telephone": "1-925-776-6906 x15589",
    "givenName": "Funk",
    "familyName": "Rocio",
    "identifier": "4e043da5-bbfb-417b-8408-e2642b2bc794"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 444.816648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 17.053774ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415
...
---
Response status code: 201 Created. Responded in 351.919654ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e9aae763-c5cf-4fe2-adc9-9a6ace8a5415#/orderedItems/3113",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/477/facility-use-slots/4766#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 13.786922ms.
```json
{
  "data": {
    "@context": [
