...
---
Response status code: 200 OK. Responded in 13.892923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5882"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F589%2Ffacility-use-slots%2F5882?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.383471ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5882#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 10.5,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT13H23M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-27T09:22:12+00:00",
    "endDate": "2022-07-27T12:33:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5f85082d-6c9e-4ecd-b3a4-66aede61c3ee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5882#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5882"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-ItqQpGcVnJ",
    "accountId": "invalid-XBt9qKO45o",
    "paymentProviderId": "invalid-gzpdBGZIoo"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 110.111869ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5f85082d-6c9e-4ecd-b3a4-66aede61c3ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katharina81@hotmail.com",
    "telephone": "(215) 764-2760 x72838",
    "givenName": "Carroll",
    "familyName": "Jailyn",
    "identifier": "c2ed5daf-3496-49d5-a538-1ad6eb2af170"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-as6ZjU5k6m",
    "accountId": "invalid-8wdfPv2W-d",
    "paymentProviderId": "invalid-nZvLvHGovq"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 24.760097ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
