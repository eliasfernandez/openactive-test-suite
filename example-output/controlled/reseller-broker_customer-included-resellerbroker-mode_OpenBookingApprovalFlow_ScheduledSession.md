...
⚠️ 16 passed with 0 failures, 164 warnings and 56 suggestions 
...
---
Response status code: 200 OK. Responded in 32.451898ms.
```json
{
...
---
Response status code: 200 OK. Responded in 621.366714ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2458/events/20458",
  "modified": 1658486723220,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2458/events/20458",
    "startDate": "2022-07-23T10:45:21+00:00",
    "endDate": "2022-07-23T11:45:21+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc
...
---
Response status code: 200 OK. Responded in 178.980246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:22+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2458%2Fevents%2F20458?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 266.285149ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2458/events/20458",
  "modified": 1658486723930,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Efren.Emard29@hotmail.com",
    "telephone": "1-769-386-2909",
    "givenName": "Mayer",
    "familyName": "Casimir",
    "identifier": "e070b80e-030e-4079-98b3-2c1d45ad5d7c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 460.118832ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:23+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 31.991694ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc
...
---
Response status code: 201 Created. Responded in 483.577247ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc#/orderedItems/2358",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2458#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc/versions/37fe8ddb-49be-4b45-a9e4-db3e864d869e",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc


---
Response status code: 200 OK. Responded in 29.290169ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 22.173503ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc


---
Response status code: 200 OK. Responded in 2133.33362ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "modified": 637940835243901200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
    "identifier": "fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
...
---
Response status code: 200 OK. Responded in 27.891656ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940835243901179&afterId=fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "message": "Listening for UUID: 'fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc
...
---
Response status code: 201 Created. Responded in 145.893242ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "identifier": "fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 544.472855ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "fa33ebf4-ebae-4a0d-8399-95cdfe2bcbfc",
  "modified": 637940835266048500
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.881752ms.
```json
{
  "data": {
    "@context": [
