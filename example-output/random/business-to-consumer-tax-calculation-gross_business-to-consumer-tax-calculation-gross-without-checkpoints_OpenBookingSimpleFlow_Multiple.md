...
⚠️ 19 passed with 0 failures, 314 warnings and 84 suggestions 
...
---
Response status code: 200 OK. Responded in 20.006369ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1207"
}
```
...
---
Response status code: 200 OK. Responded in 19.055842ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1051"
}
```
...
---
Response status code: 200 OK. Responded in 18.364223ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913"
}
```
...
---
Response status code: 200 OK. Responded in 18.038314ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/708"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1207?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.198233ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1207",
    "startDate": "2022-07-29T07:57:11+00:00",
    "endDate": "2022-07-29T09:56:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F106%2Fevents%2F1051?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.905324ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1051",
    "startDate": "2022-07-31T14:02:11+00:00",
    "endDate": "2022-07-31T14:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3913?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.581315ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-26T03:16:12+00:00",
    "endDate": "2022-07-26T05:47:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F71%2Ffacility-use-slots%2F708?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.243606ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/708#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 15.99,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-23T12:53:11+00:00",
    "endDate": "2022-07-23T18:32:11+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Markus_Casper35@gmail.com",
    "telephone": "770-669-4795",
    "givenName": "Swaniawski",
    "familyName": "Estevan",
    "identifier": "e8b040a9-5a8f-4583-a6b2-d0e13bb9fb1d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1207"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1051"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/708#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/708"
    }
  ],
  "totalPaymentDue": {
    "@type": "PriceSpecification",
    "price": 80.46999999999998,
    "priceCurrency": "GBP"
  },
  "payment": {
    "@type": "Payment",
    "identifier": "rAcYEp7Sj",
...
---
Response status code: 201 Created. Responded in 661.916435ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1834",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/121#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1835",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/121#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1836",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/106#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1837",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1838",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3913#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd4d9ef9-9735-48ee-b6de-129c98685c80#/orderedItems/1839",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/708#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1207?useCacheIfAvailable=true&expectedCapacity=39


---
Response status code: 200 OK. Responded in 54.859961ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F106%2Fevents%2F1051?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 53.521523ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3913?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 52.561195ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F71%2Ffacility-use-slots%2F708?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 42.233802ms.
```json
{
  "data": {
    "@context": [
