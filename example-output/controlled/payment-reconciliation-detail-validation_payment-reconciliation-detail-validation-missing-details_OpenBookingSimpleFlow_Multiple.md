...
---
Response status code: 200 OK. Responded in 229.100986ms.
```json
{
...
---
Response status code: 200 OK. Responded in 212.305232ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 238.068467ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 325.920067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 208.890491ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2592/events/20592",
  "modified": 1658487016786,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2592/events/20592",
    "startDate": "2022-07-23T10:50:15+00:00",
    "endDate": "2022-07-23T11:50:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 206.811672ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2591/events/20591",
  "modified": 1658487016785,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 780.803942ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2578/facility-use-slots/20578",
  "modified": 1658487017359,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 780.59914ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2579/facility-use-slots/20579",
  "modified": 1658487017360,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7f06f417-234b-47e8-88e5-358cf264e11e
...
---
Response status code: 400 Bad Request. Responded in 113.309521ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7f06f417-234b-47e8-88e5-358cf264e11e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nikki.Leffler54@yahoo.com",
    "telephone": "966-321-7220 x753",
    "givenName": "Ritchie",
    "familyName": "Susie",
    "identifier": "5c4738ca-ffd7-4877-995c-2fb6d1226db3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 56.59581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
