...
⚠️ 55 passed with 0 failures, 885 warnings and 242 suggestions 
...
---
Response status code: 200 OK. Responded in 42.907862ms.
```json
{
...
---
Response status code: 200 OK. Responded in 33.484317ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/481/events/4807"
}
```
...
---
Response status code: 200 OK. Responded in 34.565033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150"
}
```
...
---
Response status code: 200 OK. Responded in 32.249998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313"
}
```
...
---
Response status code: 200 OK. Responded in 51.033287ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4478",
    "startDate": "2022-07-28T18:13:11+00:00",
    "endDate": "2022-07-28T19:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F481%2Fevents%2F4807?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 50.56008ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/481/events/4807",
    "startDate": "2022-07-23T10:41:11+00:00",
    "endDate": "2022-07-23T15:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/481",
      "name": "Fresh Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/481#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 1.33,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT5H14M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F615%2Ffacility-use-slots%2F6150?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 50.107273ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 3.02,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT17H40M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-28T15:41:12+00:00",
    "endDate": "2022-07-28T17:54:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F532%2Ffacility-use-slots%2F5313?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 49.692366ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 19.15,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT11H21M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-31T08:59:12+00:00",
    "endDate": "2022-07-31T12:14:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/861f0983-e72e-438b-a85a-9da63ab029b8
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/481#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/481/events/4807"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 308.074034ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/861f0983-e72e-438b-a85a-9da63ab029b8",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:44+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/481"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4478?useCacheIfAvailable=true&expectedCapacity=35


---
Response status code: 200 OK. Responded in 27.302811ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F481%2Fevents%2F4807?useCacheIfAvailable=true&expectedCapacity=14


---
Response status code: 200 OK. Responded in 29.778448ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F615%2Ffacility-use-slots%2F6150?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 124.054266ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150",
  "modified": 1658486446456,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F532%2Ffacility-use-slots%2F5313?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 124.590374ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313",
  "modified": 1658486446458,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/861f0983-e72e-438b-a85a-9da63ab029b8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Roberto80@hotmail.com",
    "telephone": "765-476-2583",
    "givenName": "Koelpin",
    "familyName": "Mohammad",
    "identifier": "159ad29f-0d9f-424c-a373-9f15f822c9ab"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 358.595693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 33.681506ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.024497ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.466989ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.019582ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8
...
---
Response status code: 201 Created. Responded in 403.083385ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1344",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1345",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1346",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/481#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1347",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1348",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6150#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1349",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5313#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 28.106632ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.432223ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.876814ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.410907ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/861f0983-e72e-438b-a85a-9da63ab029b8#/orderedItems/1344-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 23.744563ms.
```json
{
  "@context": "https://openactive.io/",
