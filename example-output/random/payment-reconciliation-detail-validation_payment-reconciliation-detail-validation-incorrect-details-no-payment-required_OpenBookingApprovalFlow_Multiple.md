...
---
Response status code: 200 OK. Responded in 55.500379ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1147/events/11468"
}
```
...
---
Response status code: 200 OK. Responded in 53.976952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1387/events/13863"
}
```
...
---
Response status code: 200 OK. Responded in 48.653458ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1540/facility-use-slots/15393"
}
```
...
---
Response status code: 200 OK. Responded in 47.63224ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1807/facility-use-slots/18064"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1147%2Fevents%2F11468?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 43.637469ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1147/events/11468",
    "startDate": "2022-07-26T23:24:11+00:00",
    "endDate": "2022-07-27T04:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1387%2Fevents%2F13863?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 43.134761ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1387/events/13863",
    "startDate": "2022-07-30T17:09:11+00:00",
    "endDate": "2022-07-30T21:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1540%2Ffacility-use-slots%2F15393?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 42.566551ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1540/facility-use-slots/15393#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT26M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-24T13:41:12+00:00",
    "endDate": "2022-07-24T19:05:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1807%2Ffacility-use-slots%2F18064?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.612016ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1807",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1807/facility-use-slots/18064#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT22H39M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-24T05:01:12+00:00",
    "endDate": "2022-07-24T06:15:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2a5938f2-3139-4ee4-93d8-a37c32be9bc9
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1147/events/11468"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1387/events/13863"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1540/facility-use-slots/15393#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1540/facility-use-slots/15393"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1807/facility-use-slots/18064#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1807/facility-use-slots/18064"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-yIRbVQn8Fr",
    "accountId": "invalid-cKscQBTiN",
    "paymentProviderId": "invalid-BCxhdHfDmc"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 293.939984ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2a5938f2-3139-4ee4-93d8-a37c32be9bc9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jody75@hotmail.com",
    "telephone": "525.631.4990",
    "givenName": "Rosenbaum",
    "familyName": "Kraig",
    "identifier": "19e895fa-0419-425f-9d92-2da4dee2a223"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-Td-KUQ_fTY",
    "accountId": "invalid-_aYDIuQoT",
    "paymentProviderId": "invalid-RUkKVX3JD4"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 71.46456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
