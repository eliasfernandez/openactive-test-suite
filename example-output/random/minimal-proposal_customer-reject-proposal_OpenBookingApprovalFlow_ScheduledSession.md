...
# minimal-proposal >> customer-reject-proposal (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 21 passed with 0 failures, 175 warnings and 58 suggestions 
...
---
Response status code: 200 OK. Responded in 47.454822ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15273"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1528%2Fevents%2F15273?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.448333ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15273",
    "startDate": "2022-07-27T09:46:11+00:00",
    "endDate": "2022-07-27T13:15:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT2H12M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4452d0f3-924e-4962-81e3-1b2b701f57ad
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15273"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 55.124356ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4452d0f3-924e-4962-81e3-1b2b701f57ad",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1528%2Fevents%2F15273?useCacheIfAvailable=true&expectedCapacity=28


---
Response status code: 200 OK. Responded in 708.897789ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15273",
  "modified": 1658486041219,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4452d0f3-924e-4962-81e3-1b2b701f57ad
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Celestino_Greenholt@gmail.com",
    "telephone": "795-258-3982",
    "givenName": "Torphy",
    "familyName": "Irwin",
    "identifier": "60efc83f-f4c2-4725-afe7-c2a261d9d6a3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 62.357681ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:00+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 12.974025ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4452d0f3-924e-4962-81e3-1b2b701f57ad
...
---
Response status code: 201 Created. Responded in 317.290101ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4452d0f3-924e-4962-81e3-1b2b701f57ad",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4452d0f3-924e-4962-81e3-1b2b701f57ad#/orderedItems/268",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1528#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4452d0f3-924e-4962-81e3-1b2b701f57ad/versions/c42cad16-ed1c-4a74-8e60-b25e4e916686",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;4452d0f3-924e-4962-81e3-1b2b701f57ad&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/4452d0f3-924e-4962-81e3-1b2b701f57ad


---
Response status code: 200 OK. Responded in 3.46766ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828356181536&afterId=b66be620-4c8b-4b14-b257-53ad475e46f0",
  "message": "Listening for UUID: '4452d0f3-924e-4962-81e3-1b2b701f57ad' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Proposal Request
PATCH https://localhost:5001/api/openbooking/order-proposals/4452d0f3-924e-4962-81e3-1b2b701f57ad
...
---
Response status code: 204 No Content. Responded in 35.73502ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;4452d0f3-924e-4962-81e3-1b2b701f57ad&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/4452d0f3-924e-4962-81e3-1b2b701f57ad


---
Response status code: 200 OK. Responded in 2432.628482ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4452d0f3-924e-4962-81e3-1b2b701f57ad",
  "modified": 637940828420303400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/4452d0f3-924e-4962-81e3-1b2b701f57ad",
    "identifier": "4452d0f3-924e-4962-81e3-1b2b701f57ad",
    "orderProposalStatus": "https://openactive.io/CustomerRejected",
    "orderedItem": [
      {
        "@type": "OrderItem",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4452d0f3-924e-4962-81e3-1b2b701f57ad
...
---
Response status code: 500 Internal Server Error. Responded in 19.112903ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 10.921073ms.
```json
{
  "data": {
    "@context": [
