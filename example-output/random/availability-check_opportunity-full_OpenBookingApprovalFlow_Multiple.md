...
⚠️ 40 passed with 0 failures, 583 warnings and 150 suggestions 
...
---
Response status code: 200 OK. Responded in 16.399379ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1718/events/17176"
}
```
...
---
Response status code: 200 OK. Responded in 15.576365ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1476/events/14753"
}
```
...
---
Response status code: 200 OK. Responded in 14.831053ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 14.08824ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16090"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1718%2Fevents%2F17176?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.19521ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1718/events/17176",
    "startDate": "2022-07-23T13:41:11+00:00",
    "endDate": "2022-07-23T18:55:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1718",
      "name": "Wooden Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1718#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "PT9H49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1476%2Fevents%2F14753?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.842303ms.
```json
{
  "data": {
    "@context": [
    ...
    "endDate": "2022-08-01T00:47:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1476",
      "name": "Steel Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1476#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT15H10M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 17.494698ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 0,
    "startDate": "2022-07-22T13:00:12+00:00",
    "endDate": "2022-07-22T16:24:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1609%2Ffacility-use-slots%2F16090?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.093391ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16090#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT23H14M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-31T04:21:12+00:00",
    "endDate": "2022-07-31T10:10:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3e1947f6-2f54-4c9e-84d0-5b4aa85f26a4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1718#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1718/events/17176"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1476#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1476/events/14753"
    },
    {
      "@type": "OrderItem",
      "position": 3,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16090#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1609/facility-use-slots/16090"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 63.621082ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3e1947f6-2f54-4c9e-84d0-5b4aa85f26a4",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1718"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1476"
        },
        "maximumAttendeeCapacity": 28,
        "remainingAttendeeCapacity": 28
      },
 ...
 * ⚠️ $.orderedItem[1].error[1].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[1].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3e1947f6-2f54-4c9e-84d0-5b4aa85f26a4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joyce.Satterfield21@yahoo.com",
    "telephone": "(326) 256-7366 x2124",
    "givenName": "Kemmer",
    "familyName": "Rafael",
    "identifier": "f8fa854b-8f2b-46f7-ba66-1280a86ea83d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 111.345793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
