...
---
Response status code: 200 OK. Responded in 23.477512ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1805.073707ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2495/facility-use-slots/20495",
  "modified": 1658486851093,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:28+00:00",
    "endDate": "2022-07-23T11:47:28+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4a3c778d-7a71-4b19-96a0-d90ad6d715ae
...
---
Response status code: 200 OK. Responded in 254.506799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4a3c778d-7a71-4b19-96a0-d90ad6d715ae",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2495%2Ffacility-use-slots%2F20495?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1016.436282ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2495/facility-use-slots/20495",
  "modified": 1658486852557,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4a3c778d-7a71-4b19-96a0-d90ad6d715ae
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ruben88@hotmail.com",
    "telephone": "996-835-7234",
    "givenName": "Balistreri",
    "familyName": "Leta",
    "identifier": "2be25aa5-a44e-4ba0-9363-b76dc40d9736"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 324.166128ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 6.083955ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4a3c778d-7a71-4b19-96a0-d90ad6d715ae
...
---
Response status code: 400 Bad Request. Responded in 505.767569ms.
```json
{
  "@context": "https://openactive.io/",
