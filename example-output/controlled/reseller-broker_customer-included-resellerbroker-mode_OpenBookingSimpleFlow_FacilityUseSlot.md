...
---
Response status code: 200 OK. Responded in 11.051801ms.
```json
{
...
---
Response status code: 200 OK. Responded in 498.601958ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2437/facility-use-slots/20437",
  "modified": 1658486706520,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f523f66c-132d-4874-880b-d4cadd681209
...
---
Response status code: 200 OK. Responded in 404.262296ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f523f66c-132d-4874-880b-d4cadd681209",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:05+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2437%2Ffacility-use-slots%2F20437?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 8.617279ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f523f66c-132d-4874-880b-d4cadd681209
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Arne_Kiehn@gmail.com",
    "telephone": "793-580-6653",
    "givenName": "Cruickshank",
    "familyName": "Jensen",
    "identifier": "b1731304-bd47-4714-b03a-0263d660f4c3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 202.023347ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.743344ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f523f66c-132d-4874-880b-d4cadd681209
...
---
Response status code: 201 Created. Responded in 129.073781ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f523f66c-132d-4874-880b-d4cadd681209",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f523f66c-132d-4874-880b-d4cadd681209#/orderedItems/2294",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2437/facility-use-slots/20437#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 8.891081ms.
```json
{
  "data": {
    "@context": [
