[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:36:51 GMT+0000 (Coordinated Universal Time)
...
⚠️ 48 passed with 0 failures, 115 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 257.020253ms.
```json
{
...
---
Response status code: 200 OK. Responded in 364.729072ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 253.404625ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 292.396822ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 539.845002ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2195/events/20195",
  "modified": 1658486222360,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2195/events/20195",
    "startDate": "2022-07-23T10:37:00+00:00",
    "endDate": "2022-07-23T11:37:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 585.191147ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2196/events/20196",
  "modified": 1658486222406,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 364.208468ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187",
  "modified": 1658486222186,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 363.510762ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d515b3b6-3489-45e0-8653-c594f11f6fba
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 409 Conflict. Responded in 41.583915ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d515b3b6-3489-45e0-8653-c594f11f6fba",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d515b3b6-3489-45e0-8653-c594f11f6fba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Billie70@hotmail.com",
    "telephone": "(376) 812-7793 x398",
    "givenName": "Becker",
    "familyName": "Edna",
    "identifier": "bb654c9e-3436-4ea0-9b7a-089946789c6b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 33.807457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d515b3b6-3489-45e0-8653-c594f11f6fba
...
---
Response status code: 409 Conflict. Responded in 31.55834ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d515b3b6-3489-45e0-8653-c594f11f6fba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
