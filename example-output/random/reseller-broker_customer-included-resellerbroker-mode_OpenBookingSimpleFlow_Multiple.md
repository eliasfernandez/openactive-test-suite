...
⚠️ 47 passed with 0 failures, 768 warnings and 208 suggestions 
...
---
Response status code: 200 OK. Responded in 41.163344ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4475"
}
```
...
---
Response status code: 200 OK. Responded in 40.079819ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/483"
}
```
...
---
Response status code: 200 OK. Responded in 35.453514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838"
}
```
...
---
Response status code: 200 OK. Responded in 39.979617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4475?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.228675ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4475",
    "startDate": "2022-07-26T07:13:11+00:00",
    "endDate": "2022-07-26T11:13:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F49%2Fevents%2F483?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 50.871167ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/483",
    "startDate": "2022-07-25T12:12:11+00:00",
    "endDate": "2022-07-25T16:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F384%2Ffacility-use-slots%2F3838?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 50.473958ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 9.99,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT22H12M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-22T19:17:12+00:00",
    "endDate": "2022-07-22T19:56:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F816%2Ffacility-use-slots%2F8153?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 50.10335ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/816",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 5.56,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT19H48M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-25T11:57:12+00:00",
    "endDate": "2022-07-25T16:50:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ddeadc0a-b87e-4ccd-819a-a74641b0a68a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4475"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/483"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 941.46225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ddeadc0a-b87e-4ccd-819a-a74641b0a68a",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/816"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-25T11:57:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4475?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 654.270591ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4475",
  "modified": 1658486807149,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F49%2Fevents%2F483?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 653.798682ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/483",
  "modified": 1658486807151,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F384%2Ffacility-use-slots%2F3838?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 953.453086ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838",
  "modified": 1658486807450,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F816%2Ffacility-use-slots%2F8153?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 955.847933ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153",
  "modified": 1658486807453,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ddeadc0a-b87e-4ccd-819a-a74641b0a68a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Luciano54@hotmail.com",
    "telephone": "1-201-641-6850",
    "givenName": "Ernser",
    "familyName": "Britney",
    "identifier": "7bb65fd1-c059-44c8-bb3c-39eeeb49cb54"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1285.756037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 104.334456ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 103.746742ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 103.252631ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 102.850722ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a
...
---
Response status code: 201 Created. Responded in 814.872587ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2341",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2342",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2343",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/49#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2344",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2345",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/384/facility-use-slots/3838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ddeadc0a-b87e-4ccd-819a-a74641b0a68a#/orderedItems/2346",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/816/facility-use-slots/8153#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 35.290147ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.854139ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 36.696173ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.8599ms.
```json
{
  "data": {
    "@context": [
