...
⚠️ 51 passed with 0 failures, 784 warnings and 208 suggestions 
...
---
Response status code: 200 OK. Responded in 48.058173ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3182"
}
```
...
---
Response status code: 200 OK. Responded in 46.62055ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/263/events/2628"
}
```
...
---
Response status code: 200 OK. Responded in 33.357036ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937"
}
```
...
---
Response status code: 200 OK. Responded in 38.803824ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3182?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 59.052849ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3182",
    "startDate": "2022-07-29T03:07:11+00:00",
    "endDate": "2022-07-29T06:07:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F263%2Fevents%2F2628?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 58.619242ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/263/events/2628",
    "startDate": "2022-07-31T02:30:11+00:00",
    "endDate": "2022-07-31T04:35:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/263",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/263#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F194%2Ffacility-use-slots%2F1937?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 58.141034ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/194",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-31T07:31:11+00:00",
    "endDate": "2022-07-31T13:25:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F108%2Ffacility-use-slots%2F1075?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 57.672426ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2022-07-25T23:50:11+00:00",
    "endDate": "2022-07-26T01:42:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b047cd13-9db1-4606-b0d1-69f1299e7b9f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3182"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/263#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/263/events/2628"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1088.725789ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b047cd13-9db1-4606-b0d1-69f1299e7b9f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:10+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/263"
        },
        "maximumAttendeeCapacity": 17,
        "remainingAttendeeCapacity": 17
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3182?useCacheIfAvailable=true&expectedCapacity=26


---
Response status code: 200 OK. Responded in 672.130695ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3182",
  "modified": 1658487133029,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F263%2Fevents%2F2628?useCacheIfAvailable=true&expectedCapacity=16


---
Response status code: 200 OK. Responded in 670.73307ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/263/events/2628",
  "modified": 1658487133030,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F194%2Ffacility-use-slots%2F1937?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 265.881935ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937",
  "modified": 1658487132626,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F108%2Ffacility-use-slots%2F1075?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 265.53813ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075",
  "modified": 1658487132627,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b047cd13-9db1-4606-b0d1-69f1299e7b9f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dejah73@yahoo.com",
    "telephone": "681-567-6439 x13360",
    "givenName": "Aufderhar",
    "familyName": "Jonathon",
    "identifier": "5dbe8a04-7b16-49ff-9837-419b376980a2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1192.677033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:13+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 122.854674ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 121.891057ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 106.842604ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 106.011389ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f
...
---
Response status code: 201 Created. Responded in 1836.903108ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3137",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/319#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3138",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/319#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3139",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/263#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3140",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3141",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/194/facility-use-slots/1937#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b047cd13-9db1-4606-b0d1-69f1299e7b9f#/orderedItems/3142",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/108/facility-use-slots/1075#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 34.895081ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.20027ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.729161ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.454057ms.
```json
{
  "data": {
    "@context": [
