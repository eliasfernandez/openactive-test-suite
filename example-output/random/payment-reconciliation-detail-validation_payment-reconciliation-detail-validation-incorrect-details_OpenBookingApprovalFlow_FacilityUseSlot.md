[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:52:03 GMT+0000 (Coordinated Universal Time)
...
⚠️ 6 passed with 0 failures, 50 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 13.078821ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1219/facility-use-slots/12186"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1219%2Ffacility-use-slots%2F12186?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.005436ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1219",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1219/facility-use-slots/12186#/offers/0",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-28T02:48:12+00:00",
    "endDate": "2022-07-28T07:46:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e4890cc9-c867-426f-adcb-1ce802c6d4f9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1219/facility-use-slots/12186#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1219/facility-use-slots/12186"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-YvSdzQb96F",
    "accountId": "invalid-GqdaiQJGn",
    "paymentProviderId": "invalid-Jv32RrUFWE"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 52.618388ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e4890cc9-c867-426f-adcb-1ce802c6d4f9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bennett92@yahoo.com",
    "telephone": "319.731.4960 x98444",
    "givenName": "O'Reilly",
    "familyName": "Brisa",
    "identifier": "2bb898c5-52d1-4533-a0ca-b6f3ca61fe53"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-PP0UZndoaF",
    "accountId": "invalid-iAte1khxCz",
    "paymentProviderId": "invalid-hsa2X7arpV"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 31.113226ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
