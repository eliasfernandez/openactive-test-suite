...
---
Response status code: 200 OK. Responded in 14.150826ms.
```json
{
...
---
Response status code: 200 OK. Responded in 648.552708ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457",
  "modified": 1658486757892,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 5,
    "startDate": "2022-07-23T10:45:56+00:00",
    "endDate": "2022-07-23T11:45:56+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d82dce84-c10f-4c95-91ff-415f4d0bf590
...
---
Response status code: 200 OK. Responded in 422.834986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d82dce84-c10f-4c95-91ff-415f4d0bf590",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:57+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d82dce84-c10f-4c95-91ff-415f4d0bf590
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emerald30@hotmail.com",
    "telephone": "458.932.2614 x406",
    "givenName": "Hartmann",
    "familyName": "Shaylee",
    "identifier": "a4d10709-f576-4674-bc2f-64d0ea78b1c9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 267.348894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2457%2Ffacility-use-slots%2F20457?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 703.615101ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457",
  "modified": 1658486759718,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 636.905906ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:59+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c0d0ee88-fcd8-450a-8ffa-825a9ffa6b63
...
---
Response status code: 409 Conflict. Responded in 522.100905ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c0d0ee88-fcd8-450a-8ffa-825a9ffa6b63",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:00+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c0d0ee88-fcd8-450a-8ffa-825a9ffa6b63
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clarissa_Hagenes80@yahoo.com",
    "telephone": "645.998.2623 x712",
    "givenName": "Hansen",
    "familyName": "Spencer",
    "identifier": "030b9cc3-acb3-431d-bf67-d1178e1a08c9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 904.170648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:01+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.105063ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3e382920-0039-48c2-a75d-c9d04e9493e0
...
---
Response status code: 200 OK. Responded in 366.059499ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3e382920-0039-48c2-a75d-c9d04e9493e0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:02+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3e382920-0039-48c2-a75d-c9d04e9493e0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Virginie.Padberg@gmail.com",
    "telephone": "(668) 751-9537",
    "givenName": "Adams",
    "familyName": "Art",
    "identifier": "5bb1c21f-2080-4997-95a3-a44bd9ceb74c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 728.341064ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2457%2Ffacility-use-slots%2F20457?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 89.248105ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9ff5a9be-a423-495f-a84f-fda7a3bdf849
...
---
Response status code: 409 Conflict. Responded in 394.194753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9ff5a9be-a423-495f-a84f-fda7a3bdf849",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:05+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9ff5a9be-a423-495f-a84f-fda7a3bdf849
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annette_Hintz36@yahoo.com",
    "telephone": "(384) 557-2355",
    "givenName": "Ondricka",
    "familyName": "Jeff",
    "identifier": "dc2f74b8-5168-4712-8d35-2568b5efe85f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 327.117948ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 29.284264ms.
```json
{
  "data": {
    "@context": [
