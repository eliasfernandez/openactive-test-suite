...
---
Response status code: 200 OK. Responded in 14.180921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2605/events/20605"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2605%2Fevents%2F20605?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 470.083227ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2605/events/20605",
  "modified": 1658487056332,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2605/events/20605",
    "startDate": "2022-07-23T10:50:54+00:00",
    "endDate": "2022-07-23T11:50:54+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2605",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2605#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1c3b3f00-1d02-42cb-89da-f51c1f1dd618
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2605#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2605/events/20605"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 212.39622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2605"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2605%2Fevents%2F20605?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 537.290964ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2605/events/20605",
  "modified": 1658487057221,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1c3b3f00-1d02-42cb-89da-f51c1f1dd618
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alec_Ryan85@yahoo.com",
    "telephone": "1-985-668-6341 x8325",
    "givenName": "Kilback",
    "familyName": "Triston",
    "identifier": "49826552-b41b-46c0-b84c-25cbe403c99e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 183.540879ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:56+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 20.13249ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1c3b3f00-1d02-42cb-89da-f51c1f1dd618
...
---
Response status code: 201 Created. Responded in 165.355306ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c3b3f00-1d02-42cb-89da-f51c1f1dd618#/orderedItems/3223",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2605#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1c3b3f00-1d02-42cb-89da-f51c1f1dd618/versions/e7a26ccc-ae79-4451-9af5-a88666bd73e0",
  "payment": {
    "@type": "Payment",
    "identifier": "uGtIEhZWx",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;1c3b3f00-1d02-42cb-89da-f51c1f1dd618&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/1c3b3f00-1d02-42cb-89da-f51c1f1dd618


---
Response status code: 200 OK. Responded in 5.169734ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838434483599&afterId=f59b4939-9f94-4300-941e-db08ebe75546",
  "message": "Listening for UUID: '1c3b3f00-1d02-42cb-89da-f51c1f1dd618' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 25.496267ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;1c3b3f00-1d02-42cb-89da-f51c1f1dd618&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/1c3b3f00-1d02-42cb-89da-f51c1f1dd618


---
Response status code: 200 OK. Responded in 2401.643661ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  "modified": 637940838568199400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
    "identifier": "1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
...
---
Response status code: 200 OK. Responded in 4.899732ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1c3b3f00-1d02-42cb-89da-f51c1f1dd618
...
---
Response status code: 201 Created. Responded in 158.972143ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  "identifier": "1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1438.142437ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "1c3b3f00-1d02-42cb-89da-f51c1f1dd618",
  "modified": 637940838592914400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.372135ms.
```json
{
  "data": {
    "@context": [
