...
⚠️ 9 passed with 0 failures, 110 warnings and 38 suggestions 
...
---
Response status code: 200 OK. Responded in 5.034139ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11125"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11125?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.371087ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11125",
    "startDate": "2022-07-30T04:52:11+00:00",
    "endDate": "2022-07-30T07:50:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f619d5df-db43-4f20-b5e1-f723023e5339
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marjorie.Bartell4@yahoo.com",
    "telephone": "627-507-1734",
    "givenName": "Kilback",
    "familyName": "Vernon",
    "identifier": "a69bbab6-8e2d-4b68-983d-babc2dabcef0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11125"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 142.539742ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f619d5df-db43-4f20-b5e1-f723023e5339",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f619d5df-db43-4f20-b5e1-f723023e5339#/orderedItems/1846",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1113#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f619d5df-db43-4f20-b5e1-f723023e5339/versions/3deb7e1e-2ea1-47b4-a2ec-8ad18894a4fa",
  "payment": {
    "@type": "Payment",
    "identifier": "zdAzZ-iXg",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;f619d5df-db43-4f20-b5e1-f723023e5339&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f619d5df-db43-4f20-b5e1-f723023e5339


---
Response status code: 200 OK. Responded in 34.859964ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'f619d5df-db43-4f20-b5e1-f723023e5339' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 28.024375ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;f619d5df-db43-4f20-b5e1-f723023e5339&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f619d5df-db43-4f20-b5e1-f723023e5339


---
Response status code: 200 OK. Responded in 2157.334462ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f619d5df-db43-4f20-b5e1-f723023e5339",
  "modified": 637940834204264400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f619d5df-db43-4f20-b5e1-f723023e5339",
    "identifier": "f619d5df-db43-4f20-b5e1-f723023e5339",
...
---
Response status code: 200 OK. Responded in 14.852011ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834204264479&afterId=f619d5df-db43-4f20-b5e1-f723023e5339",
  "message": "Listening for UUID: 'f619d5df-db43-4f20-b5e1-f723023e5339' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f619d5df-db43-4f20-b5e1-f723023e5339
...
---
Response status code: 201 Created. Responded in 180.218284ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f619d5df-db43-4f20-b5e1-f723023e5339",
  "identifier": "f619d5df-db43-4f20-b5e1-f723023e5339",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 577.44317ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f619d5df-db43-4f20-b5e1-f723023e5339",
  "modified": 637940834226674300
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11125?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 5.869363ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 205.531784ms.
```json
{
  "@context": [
    "https://openactive.io/",
