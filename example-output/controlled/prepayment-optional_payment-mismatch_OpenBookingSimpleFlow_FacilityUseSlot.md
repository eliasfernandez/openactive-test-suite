...
---
Response status code: 200 OK. Responded in 35.599826ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1455.12855ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488",
  "modified": 1658486832903,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:10+00:00",
    "endDate": "2022-07-23T11:47:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3cae0c2e-94c8-43ff-9988-a413fcf28c46
...
---
Response status code: 200 OK. Responded in 270.541141ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3cae0c2e-94c8-43ff-9988-a413fcf28c46",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:11+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2488%2Ffacility-use-slots%2F20488?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 407.998082ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488",
  "modified": 1658486833666,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3cae0c2e-94c8-43ff-9988-a413fcf28c46
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Juanita_Murray@hotmail.com",
    "telephone": "877-548-1001",
    "givenName": "Lowe",
    "familyName": "Deborah",
    "identifier": "b98a43d4-efa8-4acd-8080-1b23b0897d3e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 901.241433ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:13+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.356829ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3cae0c2e-94c8-43ff-9988-a413fcf28c46
...
---
Response status code: 400 Bad Request. Responded in 270.773543ms.
```json
{
  "@context": "https://openactive.io/",
