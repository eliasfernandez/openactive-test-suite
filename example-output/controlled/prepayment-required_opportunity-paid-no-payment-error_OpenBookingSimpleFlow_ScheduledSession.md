...
---
Response status code: 200 OK. Responded in 601.210715ms.
```json
{
...
---
Response status code: 200 OK. Responded in 888.076099ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2493/events/20493",
  "modified": 1658486818193,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2493/events/20493",
    "startDate": "2022-07-23T10:46:56+00:00",
    "endDate": "2022-07-23T11:46:56+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5730a8e0-b346-4203-b218-0ecc4e015d7a
...
---
Response status code: 200 OK. Responded in 312.053911ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5730a8e0-b346-4203-b218-0ecc4e015d7a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2493%2Fevents%2F20493?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 356.453511ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2493/events/20493",
  "modified": 1658486819241,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5730a8e0-b346-4203-b218-0ecc4e015d7a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anastasia.Huels@yahoo.com",
    "telephone": "713.375.6617",
    "givenName": "Haley",
    "familyName": "Angela",
    "identifier": "aa574e5f-9886-496b-8338-503371ebc2d5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 208.313176ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:58+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 5.179947ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5730a8e0-b346-4203-b218-0ecc4e015d7a
...
---
Response status code: 400 Bad Request. Responded in 395.624563ms.
```json
{
  "@context": "https://openactive.io/",
