...
---
Response status code: 200 OK. Responded in 48.516039ms.
```json
{
...
---
Response status code: 200 OK. Responded in 745.983255ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2547/events/20547",
  "modified": 1658486928673,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2547/events/20547",
    "startDate": "2022-07-23T10:48:46+00:00",
    "endDate": "2022-07-23T11:48:46+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/196bd2ee-0476-4775-80b7-d4710f0a872e
...
---
Response status code: 200 OK. Responded in 150.16546ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/196bd2ee-0476-4775-80b7-d4710f0a872e",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2547%2Fevents%2F20547?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 594.556587ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2547/events/20547",
  "modified": 1658486929688,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/196bd2ee-0476-4775-80b7-d4710f0a872e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clarabelle.Bogan@hotmail.com",
    "telephone": "1-850-210-7424",
    "givenName": "Skiles",
    "familyName": "Hertha",
    "identifier": "ef4ffbb2-fe97-4edc-a984-ebc8fd53324f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 444.161424ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 49.105644ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/196bd2ee-0476-4775-80b7-d4710f0a872e
...
---
Response status code: 201 Created. Responded in 333.851025ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/196bd2ee-0476-4775-80b7-d4710f0a872e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/196bd2ee-0476-4775-80b7-d4710f0a872e#/orderedItems/2947",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2547#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 4.40714ms.
```json
{
  "data": {
    "@context": [
