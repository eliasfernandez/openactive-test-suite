[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:50:11 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 22.003998ms.
```json
{
...
---
Response status code: 200 OK. Responded in 730.687682ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2580/facility-use-slots/20580",
  "modified": 1658487020039,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3f616118-e5e9-4895-91b8-775a3dfe388a
...
---
Response status code: 400 Bad Request. Responded in 43.608893ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3f616118-e5e9-4895-91b8-775a3dfe388a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Meredith.Kertzmann71@hotmail.com",
    "telephone": "231.932.2769 x3227",
    "givenName": "Herzog",
    "familyName": "Garnett",
    "identifier": "cba6f81e-932f-4c98-8a5d-740553ff5871"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 44.3932ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
