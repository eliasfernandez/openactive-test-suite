...
⚠️ 26 passed with 0 failures, 182 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 116.134157ms.
```json
{
...
---
Response status code: 200 OK. Responded in 428.4588ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2003/events/20003",
  "modified": 1658485959280,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2003/events/20003",
    "startDate": "2022-07-23T10:32:37+00:00",
    "endDate": "2022-07-23T11:32:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/73747c79-8a87-45d4-bab6-22d2b804f985
...
---
Response status code: 200 OK. Responded in 462.334209ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/73747c79-8a87-45d4-bab6-22d2b804f985",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2003%2Fevents%2F20003?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 212.588935ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2003/events/20003",
  "modified": 1658485960768,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/73747c79-8a87-45d4-bab6-22d2b804f985
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shaina_Olson76@yahoo.com",
    "telephone": "549-543-8481",
    "givenName": "Ziemann",
    "familyName": "Kenyatta",
    "identifier": "83516f22-6593-4e1f-b4be-afe24c637b01"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 128.188567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 29.734371ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985
...
---
Response status code: 201 Created. Responded in 131.198894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73747c79-8a87-45d4-bab6-22d2b804f985#/orderedItems/8",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2003#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985/versions/4e073b2d-b8bb-4ebd-a781-e7492d475dab",
  "payment": {
    "@type": "Payment",
    "identifier": "GdvGAQM2J",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;73747c79-8a87-45d4-bab6-22d2b804f985&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/73747c79-8a87-45d4-bab6-22d2b804f985


---
Response status code: 200 OK. Responded in 3.913636ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '73747c79-8a87-45d4-bab6-22d2b804f985' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 38.198148ms.
### Specs
* ✅ should return 204 on success

## Order Feed Update (after Simulate Seller Amendment)

### Orders (order-proposals) Feed collect for &#x27;73747c79-8a87-45d4-bab6-22d2b804f985&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/73747c79-8a87-45d4-bab6-22d2b804f985


---
Response status code: 200 OK. Responded in 2365.064629ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "73747c79-8a87-45d4-bab6-22d2b804f985",
  "modified": 637940827606374100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985",
    "identifier": "73747c79-8a87-45d4-bab6-22d2b804f985",
    "orderProposalStatus": "https://openactive.io/AwaitingSellerConfirmation",
    "orderedItem": [
      {
        "@type": "OrderItem",
    ...
    "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985/versions/8ed4537d-6af8-41f3-900e-12ea50fc630d",
    "totalPaymentDue": {
      "@type": "PriceSpecification",
      "openBookingPrepayment": "https://openactive.io/Required",
      "price": 10,
...
---
Response status code: 200 OK. Responded in 66.821708ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940827606374171&afterId=73747c79-8a87-45d4-bab6-22d2b804f985",
  "message": "Listening for UUID: '73747c79-8a87-45d4-bab6-22d2b804f985' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 50.419459ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2465.283242ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "73747c79-8a87-45d4-bab6-22d2b804f985",
  "modified": 637940827631365200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/73747c79-8a87-45d4-bab6-22d2b804f985",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/73747c79-8a87-45d4-bab6-22d2b804f985
...
---
Response status code: 500 Internal Server Error. Responded in 37.061338ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 201 Created. Responded in 53.548188ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/73747c79-8a87-45d4-bab6-22d2b804f985",
  "identifier": "73747c79-8a87-45d4-bab6-22d2b804f985",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 3.764834ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 4.978445ms.
```json
{
  "data": {
    "@context": [
