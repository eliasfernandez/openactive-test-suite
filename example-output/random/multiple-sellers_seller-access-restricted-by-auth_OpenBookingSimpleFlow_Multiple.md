...
⚠️ 27 passed with 0 failures, 345 warnings and 90 suggestions 
...
---
Response status code: 200 OK. Responded in 46.876736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/602"
}
```
...
---
Response status code: 200 OK. Responded in 38.917911ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/571/events/5710"
}
```
...
---
Response status code: 200 OK. Responded in 39.644722ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/409/facility-use-slots/4084"
}
```
...
---
Response status code: 200 OK. Responded in 45.826219ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/313/facility-use-slots/3128"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F61%2Fevents%2F602?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.702625ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/602",
    "startDate": "2022-07-23T17:31:11+00:00",
    "endDate": "2022-07-23T18:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F571%2Fevents%2F5710?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.284519ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/571/events/5710",
    "startDate": "2022-08-01T04:07:11+00:00",
    "endDate": "2022-08-01T09:27:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/571",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/571#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F409%2Ffacility-use-slots%2F4084?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.869912ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/409/facility-use-slots/4084#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT3H8M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-30T23:05:12+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F313%2Ffacility-use-slots%2F3128?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.505606ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/313",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/313/facility-use-slots/3128#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-26T16:06:12+00:00",
    "endDate": "2022-07-26T21:09:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a240020c-4319-4d83-b1f5-b256a668d6ae
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/602"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/571#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/571/events/5710"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/409/facility-use-slots/4084#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/409/facility-use-slots/4084"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/313/facility-use-slots/3128#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/313/facility-use-slots/3128"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 401 Unauthorized. Responded in 42.114414ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a240020c-4319-4d83-b1f5-b256a668d6ae
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josiane.Bogan92@hotmail.com",
    "telephone": "787-774-3289",
    "givenName": "D'Amore",
    "familyName": "Julio",
    "identifier": "9c663ca3-ecec-4039-a714-dd81e4c3abda"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 24.068009ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a240020c-4319-4d83-b1f5-b256a668d6ae
...
---
Response status code: 401 Unauthorized. Responded in 25.084016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
