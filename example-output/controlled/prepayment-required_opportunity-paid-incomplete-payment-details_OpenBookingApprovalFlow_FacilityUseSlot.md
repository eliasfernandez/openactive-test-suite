...
---
Response status code: 200 OK. Responded in 15.909245ms.
```json
{
...
---
Response status code: 200 OK. Responded in 773.554524ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2466/facility-use-slots/20466",
  "modified": 1658486785937,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:46:24+00:00",
    "endDate": "2022-07-23T11:46:24+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/770ec654-b6c9-4497-8cad-6562cf0ef056
...
---
Response status code: 200 OK. Responded in 630.831228ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/770ec654-b6c9-4497-8cad-6562cf0ef056",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2466%2Ffacility-use-slots%2F20466?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 784.830526ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2466/facility-use-slots/20466",
  "modified": 1658486787590,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/770ec654-b6c9-4497-8cad-6562cf0ef056
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jailyn.Durgan@hotmail.com",
    "telephone": "745.311.4968 x410",
    "givenName": "Roob",
    "familyName": "Corine",
    "identifier": "39bb95b5-a3f6-4472-9982-e5a6bb729aab"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 496.362807ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 7.117265ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/770ec654-b6c9-4497-8cad-6562cf0ef056
...
---
Response status code: 400 Bad Request. Responded in 228.404273ms.
```json
{
  "@context": "https://openactive.io/",
