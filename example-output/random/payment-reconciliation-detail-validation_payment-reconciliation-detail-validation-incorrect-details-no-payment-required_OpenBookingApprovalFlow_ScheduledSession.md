...
⚠️ 6 passed with 0 failures, 71 warnings and 24 suggestions 
...
---
Response status code: 200 OK. Responded in 6.613817ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1222/events/12217"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1222%2Fevents%2F12217?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.982788ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1222/events/12217",
    "startDate": "2022-07-22T20:18:11+00:00",
    "endDate": "2022-07-22T23:57:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8e96f677-2a8f-4984-a37b-732859477f0b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1222/events/12217"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-ppIy7DeIeL",
    "accountId": "invalid-RQNRjmDbA",
    "paymentProviderId": "invalid-NYMx_WuMlo"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 119.425906ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8e96f677-2a8f-4984-a37b-732859477f0b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lowell.Greenholt0@yahoo.com",
    "telephone": "1-825-709-2874",
    "givenName": "Feeney",
    "familyName": "Travon",
    "identifier": "b2562ae2-4751-4bda-a033-95e834082d20"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-yh_gnT7KZM",
    "accountId": "invalid-ilZ4-nnl1",
    "paymentProviderId": "invalid-6u7k8fWawj"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 25.000341ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
