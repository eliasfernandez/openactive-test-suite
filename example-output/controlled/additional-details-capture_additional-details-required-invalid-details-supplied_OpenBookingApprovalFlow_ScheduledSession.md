...
---
Response status code: 200 OK. Responded in 19.326652ms.
```json
{
...
---
Response status code: 200 OK. Responded in 385.791119ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2159/events/20159",
  "modified": 1658486179958,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/193834ca-abb6-44ac-8c36-251354f853db
...
---
Response status code: 200 OK. Responded in 89.813103ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/193834ca-abb6-44ac-8c36-251354f853db",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2159%2Fevents%2F20159?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 302.86057ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2159/events/20159",
  "modified": 1658486180597,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/193834ca-abb6-44ac-8c36-251354f853db
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adolf_Witting@yahoo.com",
    "telephone": "229.945.8697 x64705",
    "givenName": "Rohan",
    "familyName": "Jeramy",
    "identifier": "1328d3a6-acfa-4abe-a0d0-c95c520cf2e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 24.150689ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/193834ca-abb6-44ac-8c36-251354f853db
...
---
Response status code: 409 Conflict. Responded in 87.678587ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/193834ca-abb6-44ac-8c36-251354f853db",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
