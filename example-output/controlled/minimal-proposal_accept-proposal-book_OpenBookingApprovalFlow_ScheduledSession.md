[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:34:04 GMT+0000 (Coordinated Universal Time)
...
⚠️ 22 passed with 0 failures, 156 warnings and 56 suggestions 
...
---
Response status code: 200 OK. Responded in 87.416531ms.
```json
{
...
---
Response status code: 200 OK. Responded in 879.012635ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2059/events/20059",
  "modified": 1658486047225,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2059/events/20059",
    "startDate": "2022-07-23T10:34:05+00:00",
    "endDate": "2022-07-23T11:34:05+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/75e5e66e-bd1d-4b55-af9b-e44a3329b983
...
---
Response status code: 200 OK. Responded in 141.104897ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2059%2Fevents%2F20059?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 357.291171ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2059/events/20059",
  "modified": 1658486048513,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/75e5e66e-bd1d-4b55-af9b-e44a3329b983
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Skylar.Schuppe59@yahoo.com",
    "telephone": "769.614.4136",
    "givenName": "Wiegand",
    "familyName": "Jasmin",
    "identifier": "d2dbef9b-61d9-41fc-808c-66d4e165cbe0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 213.415457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.995871ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/75e5e66e-bd1d-4b55-af9b-e44a3329b983
...
---
Response status code: 201 Created. Responded in 41.639965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75e5e66e-bd1d-4b55-af9b-e44a3329b983#/orderedItems/349",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2059#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/75e5e66e-bd1d-4b55-af9b-e44a3329b983/versions/68b2817a-b7eb-4698-90be-33ca95c58981",
  "payment": {
    "@type": "Payment",
    "identifier": "2cQ8rbKSF",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;75e5e66e-bd1d-4b55-af9b-e44a3329b983&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/75e5e66e-bd1d-4b55-af9b-e44a3329b983


---
Response status code: 200 OK. Responded in 24.395855ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828391208261&afterId=9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
  "message": "Listening for UUID: '75e5e66e-bd1d-4b55-af9b-e44a3329b983' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 19.769125ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;75e5e66e-bd1d-4b55-af9b-e44a3329b983&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/75e5e66e-bd1d-4b55-af9b-e44a3329b983


---
Response status code: 200 OK. Responded in 2148.203255ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "modified": 637940828485152100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/75e5e66e-bd1d-4b55-af9b-e44a3329b983",
    "identifier": "75e5e66e-bd1d-4b55-af9b-e44a3329b983",
...
---
Response status code: 200 OK. Responded in 4.180827ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828485152082&afterId=75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "message": "Listening for UUID: '75e5e66e-bd1d-4b55-af9b-e44a3329b983' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/75e5e66e-bd1d-4b55-af9b-e44a3329b983
...
---
Response status code: 201 Created. Responded in 27.940477ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "identifier": "75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 869.898929ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "modified": 637940828506992400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.110032ms.
```json
{
  "data": {
    "@context": [
