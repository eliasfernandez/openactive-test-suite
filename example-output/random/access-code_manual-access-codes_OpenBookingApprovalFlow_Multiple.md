...
⚠️ 52 passed with 0 failures, 809 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 23.367661ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1024/events/10231"
}
```
...
---
Response status code: 200 OK. Responded in 22.178642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10746"
}
```
...
---
Response status code: 200 OK. Responded in 21.140226ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180"
}
```
...
---
Response status code: 200 OK. Responded in 20.295813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1024%2Fevents%2F10231?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.171881ms.
```json
{
  "data": {
    "@context": [
    ...
    "endDate": "2022-07-27T06:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1075%2Fevents%2F10746?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.726373ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10746",
    "startDate": "2022-07-27T23:24:11+00:00",
    "endDate": "2022-07-28T04:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1418%2Ffacility-use-slots%2F14180?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.298767ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 17.94,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT20H30M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-22T22:04:12+00:00",
    "endDate": "2022-07-23T02:02:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1121%2Ffacility-use-slots%2F11204?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.927161ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1121",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-26T06:19:12+00:00",
    "endDate": "2022-07-26T12:16:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1b708fc9-af90-4719-ab50-708e904263cb
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1024/events/10231"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10746"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 333.847551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1b708fc9-af90-4719-ab50-708e904263cb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1024%2Fevents%2F10231?useCacheIfAvailable=true&expectedCapacity=30


---
Response status code: 200 OK. Responded in 46.969325ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1024/events/10231",
  "modified": 1658486440687,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1075%2Fevents%2F10746?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 46.498418ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10746",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1418%2Ffacility-use-slots%2F14180?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 455.593129ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180",
  "modified": 1658486441096,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1121%2Ffacility-use-slots%2F11204?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 456.32164ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204",
  "modified": 1658486441099,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1b708fc9-af90-4719-ab50-708e904263cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerrod_Cummerata48@gmail.com",
    "telephone": "1-877-448-9556",
    "givenName": "Botsford",
    "familyName": "Eva",
    "identifier": "09698e02-66db-4587-a890-407d01e3fe2d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 430.065234ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 89.614983ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 88.882671ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 89.175676ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 88.818671ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1b708fc9-af90-4719-ab50-708e904263cb
...
---
Response status code: 201 Created. Responded in 406.374013ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1b708fc9-af90-4719-ab50-708e904263cb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1314",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1024#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1315",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1024#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1316",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1075#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1317",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1318",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1418/facility-use-slots/14180#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb#/orderedItems/1319",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1121/facility-use-slots/11204#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1b708fc9-af90-4719-ab50-708e904263cb/versions/72ea2701-78db-4b5b-9076-9e9cb9427281",
  "payment": {
    "@type": "Payment",
    "identifier": "35rWGgu3f",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;1b708fc9-af90-4719-ab50-708e904263cb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/1b708fc9-af90-4719-ab50-708e904263cb


---
Response status code: 200 OK. Responded in 3.853758ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '1b708fc9-af90-4719-ab50-708e904263cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 18.032471ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;1b708fc9-af90-4719-ab50-708e904263cb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/1b708fc9-af90-4719-ab50-708e904263cb


---
Response status code: 200 OK. Responded in 2133.500789ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "1b708fc9-af90-4719-ab50-708e904263cb",
  "modified": 637940832440932400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/1b708fc9-af90-4719-ab50-708e904263cb",
    "identifier": "1b708fc9-af90-4719-ab50-708e904263cb",
...
---
Response status code: 200 OK. Responded in 41.161719ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832440932366&afterId=1b708fc9-af90-4719-ab50-708e904263cb",
  "message": "Listening for UUID: '1b708fc9-af90-4719-ab50-708e904263cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb
...
---
Response status code: 201 Created. Responded in 232.495797ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1b708fc9-af90-4719-ab50-708e904263cb",
  "identifier": "1b708fc9-af90-4719-ab50-708e904263cb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 48.390045ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "1b708fc9-af90-4719-ab50-708e904263cb",
  "modified": 637940832463492600
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 16.372052ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.658541ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.092633ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.652426ms.
```json
{
  "data": {
    "@context": [
