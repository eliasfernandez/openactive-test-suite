[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:43:45 GMT+0000 (Coordinated Universal Time)
...
⚠️ 54 passed with 0 failures, 892 warnings and 232 suggestions 
...
---
Response status code: 200 OK. Responded in 30.529078ms.
```json
{
...
---
Response status code: 200 OK. Responded in 28.554128ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14469"
}
```
...
---
Response status code: 200 OK. Responded in 26.965387ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882"
}
```
...
---
Response status code: 200 OK. Responded in 28.078915ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773"
}
```
...
---
Response status code: 200 OK. Responded in 21.19304ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12556",
    "startDate": "2022-07-30T14:43:11+00:00",
    "endDate": "2022-07-30T17:55:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1447%2Fevents%2F14469?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.505823ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14469",
    "startDate": "2022-07-27T04:28:11+00:00",
    "endDate": "2022-07-27T09:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT6H54M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1189%2Ffacility-use-slots%2F11882?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.828605ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1189",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2022-07-27T13:33:12+00:00",
    "endDate": "2022-07-27T14:56:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1078%2Ffacility-use-slots%2F10773?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.172789ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-25T10:29:12+00:00",
    "endDate": "2022-07-25T14:49:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dd96b751-ce93-4d6b-875a-770182ceeffd
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14469"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 628.891333ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dd96b751-ce93-4d6b-875a-770182ceeffd",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12556?useCacheIfAvailable=true&expectedCapacity=13


---
Response status code: 200 OK. Responded in 29.81746ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1447%2Fevents%2F14469?useCacheIfAvailable=true&expectedCapacity=35


---
Response status code: 200 OK. Responded in 28.396724ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1189%2Ffacility-use-slots%2F11882?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 711.609442ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882",
  "modified": 1658486690801,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1078%2Ffacility-use-slots%2F10773?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 694.984918ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773",
  "modified": 1658486690802,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dd96b751-ce93-4d6b-875a-770182ceeffd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lee_Grady@gmail.com",
    "telephone": "560-949-1831",
    "givenName": "Gorczany",
    "familyName": "Aliyah",
    "identifier": "675dfaa0-6d18-44ae-9190-791b5b04b8e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 565.805831ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 52.012363ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.296645ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.824976ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.855156ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/dd96b751-ce93-4d6b-875a-770182ceeffd
...
---
Response status code: 201 Created. Responded in 380.689978ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/dd96b751-ce93-4d6b-875a-770182ceeffd",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2012",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2013",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2014",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1447#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2015",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2016",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd#/orderedItems/2017",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/dd96b751-ce93-4d6b-875a-770182ceeffd/versions/e7480892-ca25-4da1-9d02-6253987634bc",
  "payment": {
    "@type": "Payment",
    "identifier": "i4BrPM2Uw",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;dd96b751-ce93-4d6b-875a-770182ceeffd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/dd96b751-ce93-4d6b-875a-770182ceeffd


---
Response status code: 200 OK. Responded in 87.825302ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'dd96b751-ce93-4d6b-875a-770182ceeffd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 374.586019ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;dd96b751-ce93-4d6b-875a-770182ceeffd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/dd96b751-ce93-4d6b-875a-770182ceeffd


---
Response status code: 200 OK. Responded in 2231.099883ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "dd96b751-ce93-4d6b-875a-770182ceeffd",
  "modified": 637940834955969000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/dd96b751-ce93-4d6b-875a-770182ceeffd",
    "identifier": "dd96b751-ce93-4d6b-875a-770182ceeffd",
...
---
Response status code: 200 OK. Responded in 27.790128ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd
...
---
Response status code: 201 Created. Responded in 465.953914ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/dd96b751-ce93-4d6b-875a-770182ceeffd",
  "identifier": "dd96b751-ce93-4d6b-875a-770182ceeffd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 19.463095ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "dd96b751-ce93-4d6b-875a-770182ceeffd",
  "modified": 637940834981171700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 58.822694ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.392555ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 48.383929ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 47.700512ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;dd96b751-ce93-4d6b-875a-770182ceeffd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/dd96b751-ce93-4d6b-875a-770182ceeffd


---
Response status code: 200 OK. Responded in 42.438678ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940834830536775&afterId=c619c6d8-e951-445a-b921-32988f56b813",
  "message": "Listening for UUID: 'dd96b751-ce93-4d6b-875a-770182ceeffd' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 40.359025ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:CustomerNoticeSimulateAction)

### Orders (orders) Feed collect for &#x27;dd96b751-ce93-4d6b-875a-770182ceeffd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/dd96b751-ce93-4d6b-875a-770182ceeffd


---
Response status code: 200 OK. Responded in 2052.147633ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "dd96b751-ce93-4d6b-875a-770182ceeffd",
  "modified": 637940835068141000,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "orderedItem": [
      {
        ...
        "customerNotice": "customer notice message: rfqrncgwjl",
        "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1078/facility-use-slots/10773",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "customerNotice": "customer notice message: ccpwkurgmd",
        "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "customerNotice": "customer notice message: bjrppqbujx",
        "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1189/facility-use-slots/11882",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "customerNotice": "customer notice message: ovoxvsjftr",
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12556",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "accessChannel": {
          ...
          "name": "Zoom Video Chat",
          "description": "Please log into Zoom a few minutes before the event",
          "accessCode": "1926826575",
          "accessId": "0275307703",
          "url": "http://jensen.info/"
        },
        "accessCode": [
          {
            "@type": "PropertyValue",
        ...
        "customerNotice": "customer notice message: zfgmgrukbf",
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12556",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "customerNotice": "customer notice message: empsojrecz",
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14469",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      }
    ],
