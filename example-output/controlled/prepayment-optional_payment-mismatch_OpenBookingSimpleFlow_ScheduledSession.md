...
---
Response status code: 200 OK. Responded in 238.091977ms.
```json
{
...
---
Response status code: 200 OK. Responded in 635.750912ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2498/events/20498",
  "modified": 1658486827201,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2498/events/20498",
    "startDate": "2022-07-23T10:47:05+00:00",
    "endDate": "2022-07-23T11:47:05+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2d929650-0592-4065-9888-638bf30bcac6
...
---
Response status code: 200 OK. Responded in 462.592229ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2d929650-0592-4065-9888-638bf30bcac6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:06+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2498%2Fevents%2F20498?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 201.517642ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2498/events/20498",
  "modified": 1658486828456,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2d929650-0592-4065-9888-638bf30bcac6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Piper.Ziemann@yahoo.com",
    "telephone": "(853) 447-8383 x966",
    "givenName": "Heathcote",
    "familyName": "Brennan",
    "identifier": "3b43321f-d040-4087-8786-d2fef7a4089e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 994.990796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:08+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 23.398614ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2d929650-0592-4065-9888-638bf30bcac6
...
---
Response status code: 400 Bad Request. Responded in 1233.809879ms.
```json
{
  "@context": "https://openactive.io/",
