...
---
Response status code: 200 OK. Responded in 1003.976953ms.
```json
{
...
---
Response status code: 200 OK. Responded in 675.317057ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585",
  "modified": 1658487005584,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585",
    "startDate": "2022-07-23T10:50:02+00:00",
    "endDate": "2022-07-23T11:50:02+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/58993f69-66c6-4ea3-b300-1bc0bddf930b
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-0Qgk5IXidj",
    "accountId": "invalid-fOs7voL75",
    "paymentProviderId": "invalid-iKOKOXWmJV"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 368.903163ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/58993f69-66c6-4ea3-b300-1bc0bddf930b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elmore69@yahoo.com",
    "telephone": "1-318-970-0856",
    "givenName": "Fritsch",
    "familyName": "Hilario",
    "identifier": "232c9cb2-9c1c-4d1e-8a9d-22a617418a1d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-f1jVFx8nFU",
    "accountId": "invalid-mMdBF9bq9",
    "paymentProviderId": "invalid-9ekiFPcoSc"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 33.452905ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
