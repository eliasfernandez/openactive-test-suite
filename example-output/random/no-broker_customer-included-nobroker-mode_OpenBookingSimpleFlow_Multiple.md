...
⚠️ 47 passed with 0 failures, 706 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 25.877529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/494/events/4932"
}
```
...
---
Response status code: 200 OK. Responded in 24.352492ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4118"
}
```
...
---
Response status code: 200 OK. Responded in 26.834753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587"
}
```
...
---
Response status code: 200 OK. Responded in 30.967953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F494%2Fevents%2F4932?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.178831ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/494/events/4932",
    "startDate": "2022-07-26T18:02:11+00:00",
    "endDate": "2022-07-26T19:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/494",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/494#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 15.45,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT23H47M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F412%2Fevents%2F4118?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 33.456613ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4118",
    "startDate": "2022-07-29T06:03:11+00:00",
    "endDate": "2022-07-29T07:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F559%2Ffacility-use-slots%2F5587?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.776097ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/559",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT14H44M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-24T06:37:12+00:00",
    "endDate": "2022-07-24T08:32:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F358%2Ffacility-use-slots%2F3575?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.234184ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 12.13,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT16H7M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-31T13:50:12+00:00",
    "endDate": "2022-07-31T17:34:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f50ff54-570c-4247-b65c-f5f993b89a20
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/494#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/494/events/4932"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/412/events/4118"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 791.063832ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f50ff54-570c-4247-b65c-f5f993b89a20",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/494"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/559"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-24T06:37:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F494%2Fevents%2F4932?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 36.714197ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F412%2Fevents%2F4118?useCacheIfAvailable=true&expectedCapacity=26


---
Response status code: 200 OK. Responded in 35.551472ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F559%2Ffacility-use-slots%2F5587?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 166.353214ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587",
  "modified": 1658486764705,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F358%2Ffacility-use-slots%2F3575?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 163.40835ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575",
  "modified": 1658486764707,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f50ff54-570c-4247-b65c-f5f993b89a20
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Octavia_Stanton@hotmail.com",
    "telephone": "538.831.1302 x011",
    "givenName": "Langosh",
    "familyName": "Nona",
    "identifier": "65bbe3dd-3c58-47cd-938a-8caf930286cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 846.578892ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 41.216096ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 40.643483ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 39.832565ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 40.621383ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20
...
---
Response status code: 201 Created. Responded in 593.543795ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2198",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/494#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2199",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/494#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2200",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/412#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2201",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2202",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/559/facility-use-slots/5587#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f50ff54-570c-4247-b65c-f5f993b89a20#/orderedItems/2203",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/358/facility-use-slots/3575#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 25.749409ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.643983ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.703961ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.133347ms.
```json
{
  "data": {
    "@context": [
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
