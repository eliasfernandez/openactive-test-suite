...
---
Response status code: 200 OK. Responded in 347.628083ms.
```json
{
...
---
Response status code: 200 OK. Responded in 747.714331ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2415/facility-use-slots/20415",
  "modified": 1658486655296,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1285e49a-5978-4065-a0e4-32fdafb587b3
...
---
Response status code: 200 OK. Responded in 366.782953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1285e49a-5978-4065-a0e4-32fdafb587b3",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2415%2Ffacility-use-slots%2F20415?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 1457.760305ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2415/facility-use-slots/20415",
  "modified": 1658486657447,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/38993084-4df4-4192-b7b0-e679b16c41c3
...
---
Response status code: 409 Conflict. Responded in 493.473567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/38993084-4df4-4192-b7b0-e679b16c41c3",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 16.578447ms.
```json
{
  "data": {
    "@context": [
