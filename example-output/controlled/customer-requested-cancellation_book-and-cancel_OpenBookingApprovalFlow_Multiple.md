[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:34:05 GMT+0000 (Coordinated Universal Time)
...
⚠️ 70 passed with 0 failures, 1054 warnings and 276 suggestions 
...
---
Response status code: 200 OK. Responded in 34.971242ms.
```json
{
...
---
Response status code: 200 OK. Responded in 44.263106ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 45.323014ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 122.453248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 469.751555ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2093/events/20093",
  "modified": 1658486100220,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2093/events/20093",
    "startDate": "2022-07-23T10:34:58+00:00",
    "endDate": "2022-07-23T11:34:58+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 469.327152ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2094/events/20094",
  "modified": 1658486100221,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1019.681366ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2091/facility-use-slots/20091",
  "modified": 1658486100771,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1020.484171ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092",
  "modified": 1658486100773,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/20fe7402-a479-4142-b2f7-bef2fe93816d
...
---
Response status code: 200 OK. Responded in 193.089238ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/20fe7402-a479-4142-b2f7-bef2fe93816d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:00+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2093%2Fevents%2F20093?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 83.654879ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2093/events/20093",
  "modified": 1658486102030,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2094%2Fevents%2F20094?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 83.032276ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2094/events/20094",
  "modified": 1658486102031,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2091%2Ffacility-use-slots%2F20091?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 798.858835ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2091/facility-use-slots/20091",
  "modified": 1658486102750,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2092%2Ffacility-use-slots%2F20092?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 800.060944ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092",
  "modified": 1658486102752,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/20fe7402-a479-4142-b2f7-bef2fe93816d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ava10@yahoo.com",
    "telephone": "293-804-7515 x89908",
    "givenName": "Hintz",
    "familyName": "Brandi",
    "identifier": "48249a85-20e6-4329-932b-81c42f97a050"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 634.417297ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:03+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 6.710856ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 7.15226ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 7.389462ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 7.669064ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/20fe7402-a479-4142-b2f7-bef2fe93816d
...
---
Response status code: 201 Created. Responded in 103.847367ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/20fe7402-a479-4142-b2f7-bef2fe93816d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/515",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2093#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/516",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2093#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/517",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2094#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/518",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2091/facility-use-slots/20091#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/519",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2091/facility-use-slots/20091#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d#/orderedItems/520",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/20fe7402-a479-4142-b2f7-bef2fe93816d/versions/56def941-45d2-4db0-8c42-41a46dd6619a",
  "payment": {
    "@type": "Payment",
    "identifier": "B8rXA3Efz",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;20fe7402-a479-4142-b2f7-bef2fe93816d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/20fe7402-a479-4142-b2f7-bef2fe93816d


---
Response status code: 200 OK. Responded in 3.56703ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828932541419&afterId=74f9791a-c486-4af2-a7a4-ad1eb0c923a9",
  "message": "Listening for UUID: '20fe7402-a479-4142-b2f7-bef2fe93816d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 16.221736ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;20fe7402-a479-4142-b2f7-bef2fe93816d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/20fe7402-a479-4142-b2f7-bef2fe93816d


---
Response status code: 200 OK. Responded in 2351.955537ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "20fe7402-a479-4142-b2f7-bef2fe93816d",
  "modified": 637940829041534000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/20fe7402-a479-4142-b2f7-bef2fe93816d",
    "identifier": "20fe7402-a479-4142-b2f7-bef2fe93816d",
...
---
Response status code: 200 OK. Responded in 11.814099ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829045169725&afterId=4d55e7c7-40a5-4370-a119-14042f66739e",
  "message": "Listening for UUID: '20fe7402-a479-4142-b2f7-bef2fe93816d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d
...
---
Response status code: 201 Created. Responded in 122.659824ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d",
  "identifier": "20fe7402-a479-4142-b2f7-bef2fe93816d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 3.350523ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "20fe7402-a479-4142-b2f7-bef2fe93816d",
  "modified": 637940829066266000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.500892ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.493079ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.996776ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.576972ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;20fe7402-a479-4142-b2f7-bef2fe93816d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/20fe7402-a479-4142-b2f7-bef2fe93816d


---
Response status code: 200 OK. Responded in 3.390423ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940828953706038&afterId=74f9791a-c486-4af2-a7a4-ad1eb0c923a9",
  "message": "Listening for UUID: '20fe7402-a479-4142-b2f7-bef2fe93816d' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Request
PATCH https://localhost:5001/api/openbooking/orders/20fe7402-a479-4142-b2f7-bef2fe93816d
...
---
Response status code: 204 No Content. Responded in 164.651028ms.
...
---
Response status code: 204 No Content. Responded in 12.178892ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
* ✅ should return 204 on success
...
### Orders (orders) Feed collect for &#x27;20fe7402-a479-4142-b2f7-bef2fe93816d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/20fe7402-a479-4142-b2f7-bef2fe93816d


---
Response status code: 200 OK. Responded in 2488.099347ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "20fe7402-a479-4142-b2f7-bef2fe93816d",
  "modified": 637940829131209200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
