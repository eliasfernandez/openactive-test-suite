[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:34 GMT+0000 (Coordinated Universal Time)
...
⚠️ 48 passed with 0 failures, 606 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 38.331745ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1573/events/15728"
}
```
...
---
Response status code: 200 OK. Responded in 37.189126ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1208/events/12072"
}
```
...
---
Response status code: 200 OK. Responded in 35.881203ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1643/events/16423"
}
```
...
---
Response status code: 200 OK. Responded in 34.915187ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11583"
}
```
...
---
Response status code: 200 OK. Responded in 34.264276ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1451/facility-use-slots/14506"
}
```
...
---
Response status code: 200 OK. Responded in 35.420896ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11956"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1573%2Fevents%2F15728?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 36.142708ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1573/events/15728",
    "startDate": "2022-07-23T00:57:11+00:00",
    "endDate": "2022-07-23T03:38:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 2.25,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT20H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1208%2Fevents%2F12072?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.525598ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1208/events/12072",
    "startDate": "2022-07-26T15:02:11+00:00",
    "endDate": "2022-07-26T17:18:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1208",
      "name": "Metal Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1208#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1643%2Fevents%2F16423?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.983989ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1643/events/16423",
    "startDate": "2022-07-26T23:55:11+00:00",
    "endDate": "2022-07-27T01:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT4H45M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1159%2Ffacility-use-slots%2F11583?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.47098ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11583#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 6,
    "startDate": "2022-07-28T07:03:12+00:00",
    "endDate": "2022-07-28T11:38:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 4 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1451%2Ffacility-use-slots%2F14506?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.891571ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1451",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1451/facility-use-slots/14506#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 12.02,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT5H41M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-25T06:13:12+00:00",
    "endDate": "2022-07-25T11:12:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1196%2Ffacility-use-slots%2F11956?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.437863ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11956#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 8,
    "startDate": "2022-07-24T11:51:12+00:00",
    "endDate": "2022-07-24T14:57:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8b939c93-612d-4f4f-9869-b6b4c3ab83ad
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1573/events/15728"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1208#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1208/events/12072"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1643#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1643/events/16423"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11583#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11583"
    },
    {
      "@type": "OrderItem",
      "position": 4,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1451/facility-use-slots/14506#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1451/facility-use-slots/14506"
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11956#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11956"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 90.529123ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8b939c93-612d-4f4f-9869-b6b4c3ab83ad",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1643"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1451"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-25T06:13:12+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8b939c93-612d-4f4f-9869-b6b4c3ab83ad
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ayla.Lakin73@hotmail.com",
    "telephone": "(472) 939-9057",
    "givenName": "Weber",
    "familyName": "Waino",
    "identifier": "5f6ea94d-ddd4-47f3-979f-33644aab9f40"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 64.097678ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8b939c93-612d-4f4f-9869-b6b4c3ab83ad
...
---
Response status code: 409 Conflict. Responded in 158.326264ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/8b939c93-612d-4f4f-9869-b6b4c3ab83ad",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
