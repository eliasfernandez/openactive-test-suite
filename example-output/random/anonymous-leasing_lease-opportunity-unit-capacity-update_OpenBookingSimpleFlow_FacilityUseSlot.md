[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:26 GMT+0000 (Coordinated Universal Time)
...
⚠️ 11 passed with 0 failures, 86 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 13.290945ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3401"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F341%2Ffacility-use-slots%2F3401?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.105006ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3401#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 5.76,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT19H11M"
      }
    ],
    "remainingUses": 1,
    "startDate": "2022-07-25T03:53:12+00:00",
    "endDate": "2022-07-25T06:49:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/83a82299-db5e-44dc-a7b2-3f4e5ad54819
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3401#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3401"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 301.169086ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/83a82299-db5e-44dc-a7b2-3f4e5ad54819",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F341%2Ffacility-use-slots%2F3401?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 1563.5845ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3401",
  "modified": 1658486733926,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/047b9046-d26b-4db6-9204-3cb7283a5986
...
---
Response status code: 409 Conflict. Responded in 251.399799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/047b9046-d26b-4db6-9204-3cb7283a5986",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 33.311048ms.
```json
{
  "data": {
    "@context": [
