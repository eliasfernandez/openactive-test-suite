...
⚠️ 49 passed with 0 failures, 750 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 29.783779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/657/events/6564"
}
```
...
---
Response status code: 200 OK. Responded in 31.516107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/299/events/2984"
}
```
...
---
Response status code: 200 OK. Responded in 30.643393ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888"
}
```
...
---
Response status code: 200 OK. Responded in 21.684448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F657%2Fevents%2F6564?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.71933ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/657/events/6564",
    "startDate": "2022-07-27T05:40:11+00:00",
    "endDate": "2022-07-27T09:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F299%2Fevents%2F2984?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.315923ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/299/events/2984",
    "startDate": "2022-07-22T19:46:11+00:00",
    "endDate": "2022-07-22T23:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F389%2Ffacility-use-slots%2F3888?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.909117ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/389",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT8H26M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-08-01T09:21:12+00:00",
    "endDate": "2022-08-01T12:28:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F232?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.471081ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T18:32:11+00:00",
    "endDate": "2022-07-28T19:57:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0a06920d-00f5-4b59-af67-4265d5da1874
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/657/events/6564"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/299/events/2984"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 281.648627ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0a06920d-00f5-4b59-af67-4265d5da1874",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:03+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/389"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-08-01T09:21:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F657%2Fevents%2F6564?useCacheIfAvailable=true&expectedCapacity=15


---
Response status code: 200 OK. Responded in 30.910397ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/657/events/6564",
  "modified": 1658486225744,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F299%2Fevents%2F2984?useCacheIfAvailable=true&expectedCapacity=48


---
Response status code: 200 OK. Responded in 30.265487ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/299/events/2984",
  "modified": 1658486225747,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F389%2Ffacility-use-slots%2F3888?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 753.613015ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888",
  "modified": 1658486226480,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F232?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 754.412627ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232",
  "modified": 1658486226483,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0a06920d-00f5-4b59-af67-4265d5da1874
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shany24@gmail.com",
    "telephone": "304.246.2060",
    "givenName": "Lueilwitz",
    "familyName": "Kavon",
    "identifier": "b8291bdb-4815-48e5-91da-3a73e9376538"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 221.436739ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.670421ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.917609ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.3181ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.805192ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874
...
---
Response status code: 201 Created. Responded in 242.490665ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/768",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/657#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/769",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/657#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/770",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/299#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/771",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/772",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/389/facility-use-slots/3888#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0a06920d-00f5-4b59-af67-4265d5da1874#/orderedItems/773",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/232#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 22.621167ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.939156ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.365346ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.686752ms.
```json
{
  "data": {
    "@context": [
