...
⚠️ 14 passed with 0 failures, 119 warnings and 14 suggestions 
...
---
Response status code: 200 OK. Responded in 4.614574ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F641%2Ffacility-use-slots%2F6405?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.388154ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 9.51,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT12H17M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-23T06:46:12+00:00",
    "endDate": "2022-07-23T07:54:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/83f360fa-04e0-4a20-9903-19d86fa3ca0a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 55.350589ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/83f360fa-04e0-4a20-9903-19d86fa3ca0a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F641%2Ffacility-use-slots%2F6405?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 747.676019ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405",
  "modified": 1658486221305,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/83f360fa-04e0-4a20-9903-19d86fa3ca0a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Daisy_Spencer@hotmail.com",
    "telephone": "(350) 406-3945 x072",
    "givenName": "Rau",
    "familyName": "Roselyn",
    "identifier": "154d4c61-9ad4-470b-b265-9bb6777b943f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 49.273692ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.79687ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/83f360fa-04e0-4a20-9903-19d86fa3ca0a
...
---
Response status code: 201 Created. Responded in 78.178857ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/83f360fa-04e0-4a20-9903-19d86fa3ca0a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83f360fa-04e0-4a20-9903-19d86fa3ca0a#/orderedItems/729",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/641/facility-use-slots/6405#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 17.496582ms.
```json
{
  "data": {
    "@context": [
