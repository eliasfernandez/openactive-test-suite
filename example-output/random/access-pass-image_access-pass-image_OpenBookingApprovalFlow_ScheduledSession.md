[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:42:01 GMT+0000 (Coordinated Universal Time)
...
⚠️ 17 passed with 0 failures, 156 warnings and 56 suggestions 
...
---
Response status code: 200 OK. Responded in 9.718145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1504/events/15039"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1504%2Fevents%2F15039?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.001664ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1504/events/15039",
    "startDate": "2022-07-31T11:00:11+00:00",
    "endDate": "2022-07-31T14:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1504",
      "name": "Steel Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1504#/offers/0",
          ...
          "price": 6.4,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT15H16M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d151dab6-6db9-4c1e-a96d-1055797d927a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1504#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1504/events/15039"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 329.069794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d151dab6-6db9-4c1e-a96d-1055797d927a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:25+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1504"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1504%2Fevents%2F15039?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 735.471138ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1504/events/15039",
  "modified": 1658486547364,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d151dab6-6db9-4c1e-a96d-1055797d927a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Norbert.Olson@yahoo.com",
    "telephone": "805-993-6962 x3909",
    "givenName": "Pfannerstill",
    "familyName": "Harrison",
    "identifier": "e5cdb445-e350-49ae-a532-0b0afa8b4e1c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 229.739316ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:26+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 8.462429ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d151dab6-6db9-4c1e-a96d-1055797d927a
...
---
Response status code: 201 Created. Responded in 246.46656ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d151dab6-6db9-4c1e-a96d-1055797d927a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d151dab6-6db9-4c1e-a96d-1055797d927a#/orderedItems/1653",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1504#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d151dab6-6db9-4c1e-a96d-1055797d927a/versions/339dce95-cfdf-4ccf-aa81-432bbc7468b4",
  "payment": {
    "@type": "Payment",
    "identifier": "5YjJ32gah",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;d151dab6-6db9-4c1e-a96d-1055797d927a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d151dab6-6db9-4c1e-a96d-1055797d927a


---
Response status code: 200 OK. Responded in 4.077962ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833238522765&afterId=acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "message": "Listening for UUID: 'd151dab6-6db9-4c1e-a96d-1055797d927a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 15.387335ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;d151dab6-6db9-4c1e-a96d-1055797d927a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d151dab6-6db9-4c1e-a96d-1055797d927a


---
Response status code: 200 OK. Responded in 2112.005824ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d151dab6-6db9-4c1e-a96d-1055797d927a",
  "modified": 637940833475642500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d151dab6-6db9-4c1e-a96d-1055797d927a",
    "identifier": "d151dab6-6db9-4c1e-a96d-1055797d927a",
...
---
Response status code: 200 OK. Responded in 10.801865ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833475642537&afterId=d151dab6-6db9-4c1e-a96d-1055797d927a",
  "message": "Listening for UUID: 'd151dab6-6db9-4c1e-a96d-1055797d927a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/d151dab6-6db9-4c1e-a96d-1055797d927a
...
---
Response status code: 201 Created. Responded in 93.630529ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d151dab6-6db9-4c1e-a96d-1055797d927a",
  "identifier": "d151dab6-6db9-4c1e-a96d-1055797d927a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 937.347402ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "d151dab6-6db9-4c1e-a96d-1055797d927a",
  "modified": 637940833497554200
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 19.084491ms.
```json
{
  "data": {
    "@context": [
