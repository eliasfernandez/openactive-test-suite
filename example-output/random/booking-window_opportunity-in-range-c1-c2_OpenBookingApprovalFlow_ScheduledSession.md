...
⚠️ 10 passed with 0 failures, 124 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 17.996806ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1664/events/16634"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1664%2Fevents%2F16634?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.088007ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1664/events/16634",
    "startDate": "2022-07-23T00:02:11+00:00",
    "endDate": "2022-07-23T00:43:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1664",
      "name": "Plastic Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1664#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P2DT22H34M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/53048cca-ccb5-408c-aedb-2ce74e1b620f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1664#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1664/events/16634"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 359.666116ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/53048cca-ccb5-408c-aedb-2ce74e1b620f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1664"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1664%2Fevents%2F16634?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 486.072666ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1664/events/16634",
  "modified": 1658486984693,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/53048cca-ccb5-408c-aedb-2ce74e1b620f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ova_Anderson@hotmail.com",
    "telephone": "1-925-329-8811",
    "givenName": "Wisoky",
    "familyName": "Vergie",
    "identifier": "f336ac16-8e79-4b1f-afab-84d301b6358c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 279.191148ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:44+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 23.881206ms.
```json
{
  "data": {
    "@context": [
