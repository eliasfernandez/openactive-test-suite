[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:58 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 848 warnings and 222 suggestions 
...
---
Response status code: 200 OK. Responded in 32.205408ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/488"
}
```
...
---
Response status code: 200 OK. Responded in 31.228793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6447"
}
```
...
---
Response status code: 200 OK. Responded in 30.341579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005"
}
```
...
---
Response status code: 200 OK. Responded in 21.200835ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F49%2Fevents%2F488?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 70.697615ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/488",
    "startDate": "2022-07-30T02:22:11+00:00",
    "endDate": "2022-07-30T07:16:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F645%2Fevents%2F6447?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 70.376711ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6447",
    "startDate": "2022-07-31T11:24:11+00:00",
    "endDate": "2022-07-31T12:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/645",
      "name": "Metal Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/645#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT16H39M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F401%2Ffacility-use-slots%2F4005?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 69.994204ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/401",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT6H46M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-27T22:26:12+00:00",
    "endDate": "2022-07-28T03:59:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F129%2Ffacility-use-slots%2F1284?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 64.188312ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/129",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 15.23,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-24T21:07:11+00:00",
    "endDate": "2022-07-25T02:36:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2331c5f0-a547-4071-aa75-afc4428e53c2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/49#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/488"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/645#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6447"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 781.836335ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2331c5f0-a547-4071-aa75-afc4428e53c2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:09+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/645"
        },
        "maximumAttendeeCapacity": 44,
        "remainingAttendeeCapacity": 44
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/401"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-27T22:26:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F49%2Fevents%2F488?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 24.949194ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F645%2Fevents%2F6447?useCacheIfAvailable=true&expectedCapacity=43


---
Response status code: 200 OK. Responded in 24.491387ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F401%2Ffacility-use-slots%2F4005?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 601.400488ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005",
  "modified": 1658486352359,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F129%2Ffacility-use-slots%2F1284?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 606.716372ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284",
  "modified": 1658486352379,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2331c5f0-a547-4071-aa75-afc4428e53c2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cheyenne_Jones23@hotmail.com",
    "telephone": "614.404.9474 x143",
    "givenName": "Klein",
    "familyName": "Karlie",
    "identifier": "c6b609c5-66e3-4b68-9e26-9020b1c888cd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 319.717444ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:12+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 29.934372ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.305763ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.762354ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.047859ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2
...
---
Response status code: 201 Created. Responded in 307.545263ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1079",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/49#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1080",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/49#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1081",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/645#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1082",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1083",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4005#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2331c5f0-a547-4071-aa75-afc4428e53c2#/orderedItems/1084",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/129/facility-use-slots/1284#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 25.767608ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.144298ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.65359ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.263983ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f0e3c245-951d-409a-9495-86c794b14d9e
...
---
Response status code: 500 Internal Server Error. Responded in 344.012812ms.
```json
{
  "@context": "https://openactive.io/",
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using random Order UUID) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using random Order UUID) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using random Order UUID) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using random Order UUID) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using random Order UUID) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
