...
---
Response status code: 200 OK. Responded in 61.732717ms.
```json
{
...
---
Response status code: 200 OK. Responded in 435.058548ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2318/events/20318",
  "modified": 1658486414210,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2318/events/20318",
    "startDate": "2022-07-23T10:40:12+00:00",
    "endDate": "2022-07-23T11:40:12+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b
...
---
Response status code: 200 OK. Responded in 224.016178ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:13+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2318%2Fevents%2F20318?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 313.70833ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2318/events/20318",
  "modified": 1658486415385,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ian_Schneider@yahoo.com",
    "telephone": "277-468-8162",
    "givenName": "Dooley",
    "familyName": "Mallory",
    "identifier": "b065ebd6-a9d9-4db4-bce9-31506f082c14"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 162.822265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 35.979002ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b
...
---
Response status code: 201 Created. Responded in 224.569794ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b#/orderedItems/1455",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2318#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.02166ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/4f6847e3-cdf2-4220-a4c5-e7529d4c4a7b
...
---
Response status code: 204 No Content. Responded in 32.322973ms.
### Specs
