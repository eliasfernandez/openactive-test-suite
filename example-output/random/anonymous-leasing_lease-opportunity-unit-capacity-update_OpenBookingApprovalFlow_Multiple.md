[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:27 GMT+0000 (Coordinated Universal Time)
...
⚠️ 17 passed with 0 failures, 204 warnings and 52 suggestions 
...
---
Response status code: 200 OK. Responded in 19.427296ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1619/events/16190"
}
```
...
---
Response status code: 200 OK. Responded in 18.046961ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1185/facility-use-slots/11845"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1619%2Fevents%2F16190?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.476882ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1619/events/16190",
    "startDate": "2022-07-29T08:11:11+00:00",
    "endDate": "2022-07-29T09:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1185%2Ffacility-use-slots%2F11845?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.464774ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1185",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1185/facility-use-slots/11845#/offers/0",
    ...
    "remainingUses": 1,
    "startDate": "2022-07-31T13:25:12+00:00",
    "endDate": "2022-07-31T18:18:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9926713d-5770-43af-8517-c309631045d7
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1619/events/16190"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1185/facility-use-slots/11845#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1185/facility-use-slots/11845"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 282.522523ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9926713d-5770-43af-8517-c309631045d7",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1619"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1
      },
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1619%2Fevents%2F16190?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 372.897834ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1619/events/16190",
  "modified": 1658486745622,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1185%2Ffacility-use-slots%2F11845?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 1453.573161ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1185/facility-use-slots/11845",
  "modified": 1658486746707,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a817f81c-3033-48d0-8812-c662d4ed28ce
...
---
Response status code: 409 Conflict. Responded in 267.674443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a817f81c-3033-48d0-8812-c662d4ed28ce",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 90.259676ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.758051ms.
```json
{
  "data": {
    "@context": [
