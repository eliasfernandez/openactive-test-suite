...
---
Response status code: 200 OK. Responded in 52.373775ms.
```json
{
...
---
Response status code: 200 OK. Responded in 68.492821ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1324.504114ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2540/events/20540",
  "modified": 1658486915999,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2540/events/20540",
    "startDate": "2022-07-23T10:48:33+00:00",
    "endDate": "2022-07-23T11:48:33+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1250.490043ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2528/facility-use-slots/20528",
  "modified": 1658486915925,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79a6cf2f-6718-4ee0-b23e-9405bd583e6b
...
---
Response status code: 200 OK. Responded in 792.669989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79a6cf2f-6718-4ee0-b23e-9405bd583e6b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2540%2Fevents%2F20540?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 893.982909ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2540/events/20540",
  "modified": 1658486918087,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2528%2Ffacility-use-slots%2F20528?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1541.6802830000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2528/facility-use-slots/20528",
  "modified": 1658486918743,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79a6cf2f-6718-4ee0-b23e-9405bd583e6b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lester10@hotmail.com",
    "telephone": "(534) 283-1571 x78671",
    "givenName": "Mraz",
    "familyName": "Edison",
    "identifier": "95d305bb-78a7-4550-b26e-b1e8bb4d1994"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 658.646875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 29.457567ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.764861ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79a6cf2f-6718-4ee0-b23e-9405bd583e6b
...
---
Response status code: 201 Created. Responded in 576.480178ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/79a6cf2f-6718-4ee0-b23e-9405bd583e6b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79a6cf2f-6718-4ee0-b23e-9405bd583e6b#/orderedItems/2917",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2540#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79a6cf2f-6718-4ee0-b23e-9405bd583e6b#/orderedItems/2918",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2528/facility-use-slots/20528#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 22.739321ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.221516ms.
```json
{
  "data": {
    "@context": [
