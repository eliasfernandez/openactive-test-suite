...
---
Response status code: 200 OK. Responded in 23.441613ms.
```json
{
...
---
Response status code: 200 OK. Responded in 406.326197ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2024/facility-use-slots/20024",
  "modified": 1658485996581,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:33:15+00:00",
    "endDate": "2022-07-23T11:33:15+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6efbe7ec-771f-479d-8db5-113ab9f2bb05
...
---
Response status code: 200 OK. Responded in 59.737944ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2024%2Ffacility-use-slots%2F20024?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 995.464657ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2024/facility-use-slots/20024",
  "modified": 1658485997780,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 17.185856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 737.666312ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2027/facility-use-slots/20027",
  "modified": 1658485998606,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 40.664769ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2027%2Ffacility-use-slots%2F20027?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 487.205132ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2027/facility-use-slots/20027",
  "modified": 1658485999297,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6efbe7ec-771f-479d-8db5-113ab9f2bb05
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Florian_Lemke1@hotmail.com",
    "telephone": "598-734-0403 x7204",
    "givenName": "Schmitt",
    "familyName": "Eloy",
    "identifier": "6f6bc0f0-8edf-44fa-a9d4-7ddf989297da"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 75.672788ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 3.064328ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6efbe7ec-771f-479d-8db5-113ab9f2bb05
...
---
Response status code: 201 Created. Responded in 43.823697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6efbe7ec-771f-479d-8db5-113ab9f2bb05#/orderedItems/163",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2027/facility-use-slots/20027#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6efbe7ec-771f-479d-8db5-113ab9f2bb05/versions/fee67789-f634-42e4-9189-d4608e320b45",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;6efbe7ec-771f-479d-8db5-113ab9f2bb05&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/6efbe7ec-771f-479d-8db5-113ab9f2bb05


---
Response status code: 200 OK. Responded in 21.994599ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '6efbe7ec-771f-479d-8db5-113ab9f2bb05' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 14.792534ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C1 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;6efbe7ec-771f-479d-8db5-113ab9f2bb05&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/6efbe7ec-771f-479d-8db5-113ab9f2bb05


---
Response status code: 200 OK. Responded in 2501.569588ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "modified": 637940827987599000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/6efbe7ec-771f-479d-8db5-113ab9f2bb05",
    "identifier": "6efbe7ec-771f-479d-8db5-113ab9f2bb05",
...
---
Response status code: 200 OK. Responded in 3.27233ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940827987598966&afterId=6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "message": "Listening for UUID: '6efbe7ec-771f-479d-8db5-113ab9f2bb05' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/6efbe7ec-771f-479d-8db5-113ab9f2bb05
...
---
Response status code: 201 Created. Responded in 38.114545ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "identifier": "6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1401.121907ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "6efbe7ec-771f-479d-8db5-113ab9f2bb05",
  "modified": 637940828013286900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 132.605302ms.
```json
{
  "data": {
    "@context": [
