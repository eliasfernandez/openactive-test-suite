...
---
Response status code: 200 OK. Responded in 13.039616ms.
```json
{
...
---
Response status code: 200 OK. Responded in 959.799788ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2439/events/20439",
  "modified": 1658486683629,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2439/events/20439",
    "startDate": "2022-07-23T10:44:41+00:00",
    "endDate": "2022-07-23T11:44:41+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/49eb1add-4f52-4d16-9dd2-23fc6bb96388
...
---
Response status code: 200 OK. Responded in 379.041092ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/49eb1add-4f52-4d16-9dd2-23fc6bb96388",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2439%2Fevents%2F20439?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 870.735891ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2439/events/20439",
  "modified": 1658486685097,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/49eb1add-4f52-4d16-9dd2-23fc6bb96388
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Abbie.Yundt41@hotmail.com",
    "telephone": "1-461-771-7871 x76308",
    "givenName": "Smith",
    "familyName": "Francesco",
    "identifier": "215ee4a1-acd0-4eab-b3e1-6c576e296622"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 276.751276ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:44+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 40.857966ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/49eb1add-4f52-4d16-9dd2-23fc6bb96388
...
---
Response status code: 400 Bad Request. Responded in 929.444416ms.
```json
{
  "@context": "https://openactive.io/",
