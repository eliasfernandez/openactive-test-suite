[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:05 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 21.614114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10348"
}
```
...
---
Response status code: 200 OK. Responded in 20.604195ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1429/facility-use-slots/14285"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1035%2Fevents%2F10348?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.755626ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10348",
    "startDate": "2022-07-22T12:57:11+00:00",
    "endDate": "2022-07-22T14:40:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1429%2Ffacility-use-slots%2F14285?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.249716ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1429",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1429/facility-use-slots/14285#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 17.75,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT3H8M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-26T16:08:12+00:00",
    "endDate": "2022-07-26T21:48:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5530ea84-7c1a-4f19-a205-4823fb486dd4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1035#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10348"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1429/facility-use-slots/14285#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1429/facility-use-slots/14285"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 871.2864ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5530ea84-7c1a-4f19-a205-4823fb486dd4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:28+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1429"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-26T16:08:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1035%2Fevents%2F10348?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 751.2793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10348",
  "modified": 1658486970736,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1429%2Ffacility-use-slots%2F14285?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 677.416584ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1429/facility-use-slots/14285",
  "modified": 1658486970661,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5530ea84-7c1a-4f19-a205-4823fb486dd4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jesus_Metz0@yahoo.com",
    "telephone": "(272) 364-0008 x45403",
    "givenName": "Graham",
    "familyName": "Leland",
    "identifier": "96019e43-ca24-4cdf-be7c-10c2f439c0c2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 692.457873ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.519855ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.925724ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5530ea84-7c1a-4f19-a205-4823fb486dd4
...
---
Response status code: 400 Bad Request. Responded in 1082.152065ms.
```json
{
  "@context": "https://openactive.io/",
