...
---
Response status code: 200 OK. Responded in 15.183435ms.
```json
{
...
---
Response status code: 200 OK. Responded in 605.509148ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2418/events/20418",
  "modified": 1658486636089,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2418/events/20418",
    "startDate": "2022-07-23T10:43:54+00:00",
    "endDate": "2022-07-23T11:43:54+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/491dbe0b-5e49-4fa1-84a4-6837d3ec73ea
...
---
Response status code: 200 OK. Responded in 214.576795ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/491dbe0b-5e49-4fa1-84a4-6837d3ec73ea",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2418%2Fevents%2F20418?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 123.433791ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2418/events/20418",
  "modified": 1658486636730,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/491dbe0b-5e49-4fa1-84a4-6837d3ec73ea
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nikolas_Pouros68@hotmail.com",
    "telephone": "634.691.7524",
    "givenName": "Fisher",
    "familyName": "Zula",
    "identifier": "e5d44f7b-2abf-43e0-ac1a-963cc0239a0f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 383.343986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.936344ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/491dbe0b-5e49-4fa1-84a4-6837d3ec73ea
...
---
Response status code: 204 No Content. Responded in 155.339472ms.
...
---
Response status code: 204 No Content. Responded in 11.376901ms.
### Specs
