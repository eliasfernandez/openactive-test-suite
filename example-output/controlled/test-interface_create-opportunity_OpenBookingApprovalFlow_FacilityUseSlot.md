...
---
Response status code: 200 OK. Responded in 17.162056ms.
```json
{
...
---
Response status code: 200 OK. Responded in 911.611251ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494",
  "modified": 1658486849127,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:27+00:00",
    "endDate": "2022-07-23T11:47:27+00:00"
  }
}
```
### Specs
