[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:39:52 GMT+0000 (Coordinated Universal Time)
...
⚠️ 50 passed with 0 failures, 729 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 434.837795ms.
```json
{
...
---
Response status code: 200 OK. Responded in 396.862872ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 393.962147ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 434.169388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 952.992197ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2317/events/20317",
  "modified": 1658486405689,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2317/events/20317",
    "startDate": "2022-07-23T10:40:03+00:00",
    "endDate": "2022-07-23T11:40:03+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 951.629685ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2316/events/20316",
...
---
Response status code: 200 OK. Responded in 507.612513ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2304/facility-use-slots/20304",
  "modified": 1658486405246,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 509.169326ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2305/facility-use-slots/20305",
  "modified": 1658486405250,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/24dfc898-ef67-472f-86c3-d793dddcc8df
...
---
Response status code: 200 OK. Responded in 460.574813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/24dfc898-ef67-472f-86c3-d793dddcc8df",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:05+00:00"
  },
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2317%2Fevents%2F20317?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 77.472958ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2316%2Fevents%2F20316?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 76.817752ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2304%2Ffacility-use-slots%2F20304?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 1065.460221ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2304/facility-use-slots/20304",
  "modified": 1658486408245,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2305%2Ffacility-use-slots%2F20305?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1065.2498190000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2305/facility-use-slots/20305",
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/24dfc898-ef67-472f-86c3-d793dddcc8df
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ali20@hotmail.com",
    "telephone": "353.431.1198",
    "givenName": "Pfeffer",
    "familyName": "Kelley",
    "identifier": "3d6190d0-9256-48a3-84cf-fd70ab3c1b3c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 439.354384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:08+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2)
...
---
Response status code: 200 OK. Responded in 83.026796ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 82.31489ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 81.719485ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 81.231681ms.
```json
{
  "data": {
    "@context": [
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df
...
---
Response status code: 201 Created. Responded in 496.273761ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1447",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2317#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1448",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2317#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1449",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2316#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1450",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2304/facility-use-slots/20304#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1451",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2304/facility-use-slots/20304#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24dfc898-ef67-472f-86c3-d793dddcc8df#/orderedItems/1452",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2305/facility-use-slots/20305#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B)
...
---
Response status code: 200 OK. Responded in 57.987089ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 57.696586ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 56.450376ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.288849ms.
```json
{
  "data": {
    "@context": [
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
