[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:03 GMT+0000 (Coordinated Universal Time)
...
⚠️ 16 passed with 0 failures, 144 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 39.22856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13793"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1380%2Fevents%2F13793?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.502044ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13793",
    "startDate": "2022-07-23T05:23:11+00:00",
    "endDate": "2022-07-23T08:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13793"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 97.294238ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:04+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1380%2Fevents%2F13793?useCacheIfAvailable=true&expectedCapacity=45


---
Response status code: 200 OK. Responded in 491.060267ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13793",
  "modified": 1658486106370,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Darius.Hahn71@gmail.com",
    "telephone": "1-355-593-6544",
    "givenName": "Kunze",
    "familyName": "Raoul",
    "identifier": "ab3bfbef-36ea-4a23-a6e0-34e4dc3530eb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 47.436399ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:05+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.220471ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597
...
---
Response status code: 201 Created. Responded in 73.974364ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597#/orderedItems/445",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1380#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597/versions/5cd2a424-ae4e-49ad-952d-c8bdcab5b81f",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1c1e7ab9-4bf3-4a2d-bc91-036a6fe2d597
...
---
Response status code: 500 Internal Server Error. Responded in 34.610292ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 103.057061ms.
```json
{
  "data": {
    "@context": [
