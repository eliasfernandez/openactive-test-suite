...
---
Response status code: 200 OK. Responded in 14.520899ms.
```json
{
...
---
Response status code: 200 OK. Responded in 533.429051ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2078/facility-use-slots/20078",
  "modified": 1658486090010,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dbcec1c7-db0c-461b-847b-c2219dba8331
...
---
Response status code: 409 Conflict. Responded in 41.446384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dbcec1c7-db0c-461b-847b-c2219dba8331",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2078"
        },
        "maximumUses": 0,
        "remainingUses": 0,
        "startDate": "2022-07-23T10:34:48+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dbcec1c7-db0c-461b-847b-c2219dba8331
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nedra54@gmail.com",
    "telephone": "1-212-851-7604",
    "givenName": "Swaniawski",
    "familyName": "Juliet",
    "identifier": "8c4c9487-231a-44b1-acf5-6fbd3784f683"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 37.211255ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
