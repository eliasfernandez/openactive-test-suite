...
⚠️ 50 passed with 0 failures, 705 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 37.755974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1569"
}
```
...
---
Response status code: 200 OK. Responded in 36.632755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 38.252484ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446"
}
```
...
---
Response status code: 200 OK. Responded in 37.414069ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1569?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.853054ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1569",
    "startDate": "2022-07-27T12:12:11+00:00",
    "endDate": "2022-07-27T14:07:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 19.281944ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/316/events/3155",
    "startDate": "2022-07-22T17:10:11+00:00",
    "endDate": "2022-07-22T22:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F245%2Ffacility-use-slots%2F2446?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.842736ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/245",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-29T05:02:12+00:00",
    "endDate": "2022-07-29T08:36:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F205%2Ffacility-use-slots%2F2048?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.46363ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/205",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 14.1,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-24T23:19:11+00:00",
    "endDate": "2022-07-25T05:12:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/86ecc6c9-64ee-4465-a12c-39741cb2c912
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/157#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1569"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 706.748729ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/86ecc6c9-64ee-4465-a12c-39741cb2c912",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:55+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/245"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-29T05:02:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/205"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-24T23:19:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1569?useCacheIfAvailable=true&expectedCapacity=16


---
Response status code: 200 OK. Responded in 36.570953ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F316%2Fevents%2F3155?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 23.826626ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F245%2Ffacility-use-slots%2F2446?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 145.544901ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446",
  "modified": 1658487058051,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F205%2Ffacility-use-slots%2F2048?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 145.415698ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048",
  "modified": 1658487058052,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/86ecc6c9-64ee-4465-a12c-39741cb2c912
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eddie.Yundt3@hotmail.com",
    "telephone": "648-461-0302 x4325",
    "givenName": "Emard",
    "familyName": "Gaylord",
    "identifier": "7026541c-3a55-40aa-997d-ad72697ed7cf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 899.717577ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:57+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 25.927264ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.426354ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.3529ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.163196ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912
...
---
Response status code: 201 Created. Responded in 2590.397951ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/2999",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/3000",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/3001",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/316#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/3002",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/3003",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2446#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/86ecc6c9-64ee-4465-a12c-39741cb2c912#/orderedItems/3004",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/205/facility-use-slots/2048#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 98.47914ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 97.828528ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 77.587571ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 77.143063ms.
```json
{
  "data": {
    "@context": [
