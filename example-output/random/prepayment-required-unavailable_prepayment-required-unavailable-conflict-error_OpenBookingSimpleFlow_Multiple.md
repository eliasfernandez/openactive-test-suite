...
⚠️ 48 passed with 0 failures, 624 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 36.508574ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/55/events/547"
}
```
...
---
Response status code: 200 OK. Responded in 33.334923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/380/events/3799"
}
```
...
---
Response status code: 200 OK. Responded in 31.8248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 30.804984ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2315"
}
```
...
---
Response status code: 200 OK. Responded in 23.202465ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/480/facility-use-slots/4800"
}
```
...
---
Response status code: 200 OK. Responded in 22.27755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2852"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F55%2Fevents%2F547?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 52.411123ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/55/events/547",
    "startDate": "2022-07-28T22:51:11+00:00",
    "endDate": "2022-07-29T01:31:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F380%2Fevents%2F3799?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.959616ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/380/events/3799",
    "startDate": "2022-07-24T03:35:11+00:00",
    "endDate": "2022-07-24T08:16:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/380",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/380#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 7.99,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT10M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 51.476508ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/550/events/5500",
    "startDate": "2022-07-23T12:13:11+00:00",
    "endDate": "2022-07-23T13:03:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F232%2Ffacility-use-slots%2F2315?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.000001ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2315#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 1.69,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 7,
    "startDate": "2022-07-24T08:24:12+00:00",
    "endDate": "2022-07-24T13:28:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 4 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F480%2Ffacility-use-slots%2F4800?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 68.870181ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/480",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/480/facility-use-slots/4800#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 7.3,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT3H7M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-22T23:10:12+00:00",
    "endDate": "2022-07-23T03:08:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F286%2Ffacility-use-slots%2F2852?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 68.455275ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/286",
      "name": "Fresh Running Hall",
      "facilityType": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2852#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-31T01:00:12+00:00",
    "endDate": "2022-07-31T03:10:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1edfe57b-f559-4f79-ac47-f8e51ff28a6b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/55#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/55/events/547"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/380#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/380/events/3799"
    },
    {
      "@type": "OrderItem",
      "position": 2,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2315#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2315"
    },
    {
      "@type": "OrderItem",
      "position": 4,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/480/facility-use-slots/4800#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/480/facility-use-slots/4800"
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2852#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2852"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 156.69676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1edfe57b-f559-4f79-ac47-f8e51ff28a6b",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/380"
        },
        "maximumAttendeeCapacity": 39,
        "remainingAttendeeCapacity": 39
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/480"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-22T23:10:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/286"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-31T01:00:12+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1edfe57b-f559-4f79-ac47-f8e51ff28a6b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Isom.Swift@yahoo.com",
    "telephone": "1-480-447-0844 x5301",
    "givenName": "Boyle",
    "familyName": "Constantin",
    "identifier": "20bbcb21-c94b-427e-8dd7-6bd471f9cf66"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 117.644748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1edfe57b-f559-4f79-ac47-f8e51ff28a6b
...
---
Response status code: 409 Conflict. Responded in 47.608288ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1edfe57b-f559-4f79-ac47-f8e51ff28a6b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
