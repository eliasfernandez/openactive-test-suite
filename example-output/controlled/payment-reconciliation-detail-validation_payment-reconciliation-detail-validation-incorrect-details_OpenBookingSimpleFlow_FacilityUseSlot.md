...
---
Response status code: 200 OK. Responded in 55.685306ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1038.466036ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567",
  "modified": 1658487000057,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:49:58+00:00",
    "endDate": "2022-07-23T11:49:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d064da31-9628-40fb-9653-dcb4a44b8b65
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-J7ns-XmVBS",
    "accountId": "invalid-j4RgDB9An",
    "paymentProviderId": "invalid-VATldtJY_M"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 25.102928ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d064da31-9628-40fb-9653-dcb4a44b8b65
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Weldon_Willms@yahoo.com",
    "telephone": "(233) 686-7130 x788",
    "givenName": "Kub",
    "familyName": "Camron",
    "identifier": "8069e30e-168d-4986-b335-79eec629f00d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-gOI1vTVKI6",
    "accountId": "invalid-u8_Ph0l3j5",
    "paymentProviderId": "invalid-Bf0lbUiQji"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 28.867762ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
