...
---
Response status code: 200 OK. Responded in 382.719176ms.
```json
{
...
---
Response status code: 200 OK. Responded in 868.935138ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2271/facility-use-slots/20271",
  "modified": 1658486345411,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:03+00:00",
    "endDate": "2022-07-23T11:39:03+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ab27bacd-9acd-44c7-b6b0-acbce5ffe557
...
---
Response status code: 200 OK. Responded in 80.536989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:04+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2271%2Ffacility-use-slots%2F20271?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 811.935649ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2271/facility-use-slots/20271",
  "modified": 1658486346533,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ab27bacd-9acd-44c7-b6b0-acbce5ffe557
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kameron.Bashirian@gmail.com",
    "telephone": "463-518-4469",
    "givenName": "Fay",
    "familyName": "May",
    "identifier": "30880c6d-0d7b-4e9c-a080-52da0582f529"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 215.530244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:05+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 20.327474ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ab27bacd-9acd-44c7-b6b0-acbce5ffe557
...
---
Response status code: 201 Created. Responded in 281.045706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ab27bacd-9acd-44c7-b6b0-acbce5ffe557#/orderedItems/1198",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2271/facility-use-slots/20271#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/ab27bacd-9acd-44c7-b6b0-acbce5ffe557/versions/8d642217-07a9-48d4-ac31-bb766db05e6d",
  "payment": {
    "@type": "Payment",
    "identifier": "nr03fvbkF",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;ab27bacd-9acd-44c7-b6b0-acbce5ffe557&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/ab27bacd-9acd-44c7-b6b0-acbce5ffe557


---
Response status code: 200 OK. Responded in 13.167212ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831406034063&afterId=5041ab64-5ced-48be-a6d4-beb674c5b66c",
  "message": "Listening for UUID: 'ab27bacd-9acd-44c7-b6b0-acbce5ffe557' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 41.247353ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;ab27bacd-9acd-44c7-b6b0-acbce5ffe557&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/ab27bacd-9acd-44c7-b6b0-acbce5ffe557


---
Response status code: 200 OK. Responded in 2439.40838ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  "modified": 637940831465527000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
    "identifier": "ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
...
---
Response status code: 200 OK. Responded in 32.322677ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831469837847&afterId=c511126c-5542-42ad-b2d3-d6317e349fd5",
  "message": "Listening for UUID: 'ab27bacd-9acd-44c7-b6b0-acbce5ffe557' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/ab27bacd-9acd-44c7-b6b0-acbce5ffe557
...
---
Response status code: 201 Created. Responded in 109.168634ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  "identifier": "ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1060.243519ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "ab27bacd-9acd-44c7-b6b0-acbce5ffe557",
  "modified": 637940831490802000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 19.114174ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/ab27bacd-9acd-44c7-b6b0-acbce5ffe557
...
---
Response status code: 400 Bad Request. Responded in 23.828517ms.
```json
{
  "@context": "https://openactive.io/",
