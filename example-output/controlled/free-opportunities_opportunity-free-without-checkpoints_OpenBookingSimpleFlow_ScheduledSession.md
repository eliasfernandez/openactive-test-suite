...
---
Response status code: 200 OK. Responded in 199.707485ms.
```json
{
...
---
Response status code: 200 OK. Responded in 727.711306ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2400/events/20400",
  "modified": 1658486598041,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bfc5ba46-116a-4c2b-8429-ba262a1c8ab0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Pedro.McCullough@yahoo.com",
    "telephone": "1-353-372-1354",
    "givenName": "Kuhlman",
    "familyName": "Duane",
    "identifier": "45722074-4708-4b5f-a67f-48f696c30bb0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 201 Created. Responded in 186.681069ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bfc5ba46-116a-4c2b-8429-ba262a1c8ab0",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bfc5ba46-116a-4c2b-8429-ba262a1c8ab0#/orderedItems/1971",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2400#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2400%2Fevents%2F20400?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 41.876675ms.
```json
{
  "data": {
    "@context": [
