...
---
Response status code: 200 OK. Responded in 537.553688ms.
```json
{
...
---
Response status code: 200 OK. Responded in 661.754218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 619.379733ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 536.697481ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 399.741036ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2431/events/20431",
  "modified": 1658486667797,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 399.10613ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432",
...
---
Response status code: 200 OK. Responded in 878.898393ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420",
  "modified": 1658486668275,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 877.866584ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2419/facility-use-slots/20419",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8d118c17-e6f6-4275-becb-cb239ca22564
...
---
Response status code: 200 OK. Responded in 498.918038ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8d118c17-e6f6-4275-becb-cb239ca22564",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2431%2Fevents%2F20431?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 496.436315ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2431/events/20431",
  "modified": 1658486670236,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2432%2Fevents%2F20432?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 499.909146ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432",
  "modified": 1658486670241,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2420%2Ffacility-use-slots%2F20420?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 187.539606ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420",
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2419%2Ffacility-use-slots%2F20419?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 85.78208ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2419/facility-use-slots/20419",
  "modified": 1658486669931,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8d118c17-e6f6-4275-becb-cb239ca22564
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Manuela48@yahoo.com",
    "telephone": "1-930-805-4932 x17203",
    "givenName": "Spencer",
    "familyName": "Alisha",
    "identifier": "b3655b4d-d634-4404-b67f-865dff21cfce"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 780.029894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 129.989253ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 129.158945ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 128.523839ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 128.005835ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564
...
---
Response status code: 201 Created. Responded in 1200.789944ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2187",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2431#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2188",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2431#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2189",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2432#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2190",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2191",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8d118c17-e6f6-4275-becb-cb239ca22564#/orderedItems/2192",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2419/facility-use-slots/20419#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 31.048575ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.304269ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.662972ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.273069ms.
```json
{
  "data": {
    "@context": [
