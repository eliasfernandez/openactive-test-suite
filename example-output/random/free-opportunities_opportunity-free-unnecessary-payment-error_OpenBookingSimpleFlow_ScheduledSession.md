...
---
Response status code: 200 OK. Responded in 60.821086ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/91/events/905"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F91%2Fevents%2F905?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 38.649618ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/91/events/905",
    "startDate": "2022-07-28T01:51:11+00:00",
    "endDate": "2022-07-28T04:14:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/91",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/91#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b462e598-e5ef-4889-8aed-c5782e098d2e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/91#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/91/events/905"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 259.492573ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b462e598-e5ef-4889-8aed-c5782e098d2e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:26+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F91%2Fevents%2F905?useCacheIfAvailable=true&expectedCapacity=45


---
Response status code: 200 OK. Responded in 898.709652ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/91/events/905",
  "modified": 1658486788818,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b462e598-e5ef-4889-8aed-c5782e098d2e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jacey.Crona19@gmail.com",
    "telephone": "(344) 919-3911 x63419",
    "givenName": "Price",
    "familyName": "Dwight",
    "identifier": "e80f85fb-2466-4bc5-b574-0c19b5f0bba2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 263.809269ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 22.544302ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b462e598-e5ef-4889-8aed-c5782e098d2e
...
---
Response status code: 400 Bad Request. Responded in 255.838493ms.
```json
{
  "@context": "https://openactive.io/",
