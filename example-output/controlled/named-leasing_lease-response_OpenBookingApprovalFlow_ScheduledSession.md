...
---
Response status code: 200 OK. Responded in 25.954332ms.
```json
{
...
---
Response status code: 200 OK. Responded in 992.886877ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2399/events/20399",
  "modified": 1658486595826,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2399/events/20399",
    "startDate": "2022-07-23T10:43:13+00:00",
    "endDate": "2022-07-23T11:43:13+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/acda5640-593a-48e6-a288-8f036fedbdd0
...
---
Response status code: 200 OK. Responded in 281.910221ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/acda5640-593a-48e6-a288-8f036fedbdd0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:15+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2399%2Fevents%2F20399?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 771.337096ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2399/events/20399",
  "modified": 1658486597227,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/acda5640-593a-48e6-a288-8f036fedbdd0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anais49@hotmail.com",
    "telephone": "403.378.5829 x7477",
    "givenName": "Bradtke",
    "familyName": "Friedrich",
    "identifier": "255cbc48-b339-4878-809f-48dd93da8e09"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 261.179135ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:16+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.484629ms.
```json
{
  "data": {
    "@context": [
