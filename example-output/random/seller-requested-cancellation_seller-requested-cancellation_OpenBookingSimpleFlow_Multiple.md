...
⚠️ 56 passed with 0 failures, 916 warnings and 242 suggestions 
...
---
Response status code: 200 OK. Responded in 38.49768ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4089"
}
```
...
---
Response status code: 200 OK. Responded in 36.918456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/546/events/5459"
}
```
...
---
Response status code: 200 OK. Responded in 35.612836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237"
}
```
...
---
Response status code: 200 OK. Responded in 34.635021ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4089?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.967021ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4089",
    "startDate": "2022-07-25T09:41:11+00:00",
    "endDate": "2022-07-25T10:55:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F546%2Fevents%2F5459?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.334911ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/546/events/5459",
    "startDate": "2022-07-28T21:45:11+00:00",
    "endDate": "2022-07-29T01:03:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F237?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.764703ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/24",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-24T11:49:11+00:00",
    "endDate": "2022-07-24T17:42:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F370%2Ffacility-use-slots%2F3695?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.260995ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 18.47,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT19H22M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-31T10:40:12+00:00",
    "endDate": "2022-07-31T16:01:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a2c975c1-be00-4bde-94ff-0e76204c30a5
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4089"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/546/events/5459"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 359.544111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a2c975c1-be00-4bde-94ff-0e76204c30a5",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4089?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 76.489751ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F546%2Fevents%2F5459?useCacheIfAvailable=true&expectedCapacity=21


---
Response status code: 200 OK. Responded in 67.386814ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F237?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 291.505987ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237",
  "modified": 1658486529838,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F370%2Ffacility-use-slots%2F3695?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 292.773006ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695",
  "modified": 1658486529839,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a2c975c1-be00-4bde-94ff-0e76204c30a5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Oliver_Nicolas@gmail.com",
    "telephone": "972-314-4690",
    "givenName": "Champlin",
    "familyName": "Mckenna",
    "identifier": "253adb52-9b36-4ecd-94fa-db7a27abf501"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 554.885979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:11+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 24.072167ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.949251ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.000275ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.442066ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5
...
---
Response status code: 201 Created. Responded in 518.96343ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1621",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1622",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1623",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/546#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1624",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1625",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/237#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1626",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3695#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 26.574896ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.51458ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.606166ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.094058ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;a2c975c1-be00-4bde-94ff-0e76204c30a5&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/a2c975c1-be00-4bde-94ff-0e76204c30a5


---
Response status code: 200 OK. Responded in 8.483726ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940833332827566&afterId=acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "message": "Listening for UUID: 'a2c975c1-be00-4bde-94ff-0e76204c30a5' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 312.895054ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;a2c975c1-be00-4bde-94ff-0e76204c30a5&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/a2c975c1-be00-4bde-94ff-0e76204c30a5


---
Response status code: 200 OK. Responded in 2048.775971ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a2c975c1-be00-4bde-94ff-0e76204c30a5",
  "modified": 637940833449570300,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5",
    "identifier": "a2c975c1-be00-4bde-94ff-0e76204c30a5",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/a2c975c1-be00-4bde-94ff-0e76204c30a5#/orderedItems/1624",
