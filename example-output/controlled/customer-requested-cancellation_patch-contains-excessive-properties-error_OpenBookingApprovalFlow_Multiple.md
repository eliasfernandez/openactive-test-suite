[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:35 GMT+0000 (Coordinated Universal Time)
...
⚠️ 59 passed with 0 failures, 929 warnings and 246 suggestions 
...
---
Response status code: 200 OK. Responded in 55.842808ms.
```json
{
...
---
Response status code: 200 OK. Responded in 55.051902ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 69.296932ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 67.777218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1276.020426ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289",
  "modified": 1658486353932,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289",
    "startDate": "2022-07-23T10:39:11+00:00",
    "endDate": "2022-07-23T11:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1275.575922ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2290/events/20290",
  "modified": 1658486353933,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 504.123793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2278/facility-use-slots/20278",
  "modified": 1658486353162,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 503.207785ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2277/facility-use-slots/20277",
  "modified": 1658486353159,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a
...
---
Response status code: 200 OK. Responded in 326.727477ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:13+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2289%2Fevents%2F20289?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 30.943082ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2290%2Fevents%2F20290?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 30.70638ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2278%2Ffacility-use-slots%2F20278?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 550.133013ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2278/facility-use-slots/20278",
  "modified": 1658486355993,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2277%2Ffacility-use-slots%2F20277?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 546.696481ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2277/facility-use-slots/20277",
  "modified": 1658486355994,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alexys.Cole@gmail.com",
    "telephone": "1-397-467-3174",
    "givenName": "Schuster",
    "familyName": "Leonor",
    "identifier": "4a8ee0ed-3c51-42e2-b3b4-ef2bd5bc907d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 382.931189ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:15+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 32.381795ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.017191ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.400913ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.159811ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a
...
---
Response status code: 201 Created. Responded in 864.799515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1245",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2289#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1246",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2289#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1247",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2290#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1248",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2278/facility-use-slots/20278#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1249",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2278/facility-use-slots/20278#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a#/orderedItems/1250",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2277/facility-use-slots/20277#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a/versions/9ae9b954-767f-4173-ae59-7573c660bc39",
  "payment": {
    "@type": "Payment",
    "identifier": "BnrciOqxt",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a


---
Response status code: 200 OK. Responded in 11.570695ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831490886261&afterId=c511126c-5542-42ad-b2d3-d6317e349fd5",
  "message": "Listening for UUID: '1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 19.722962ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a


---
Response status code: 200 OK. Responded in 2156.52788ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "modified": 637940831578271500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
    "identifier": "1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
...
---
Response status code: 200 OK. Responded in 10.44949ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831578271501&afterId=1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "message": "Listening for UUID: '1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a
...
---
Response status code: 201 Created. Responded in 363.639905ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "identifier": "1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 8.425372ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a",
  "modified": 637940831601207300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 24.886713ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.522109ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.093306ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.703803ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/1b3bdfa6-2586-4d5f-91e0-2c81ae5e063a
...
---
Response status code: 400 Bad Request. Responded in 51.166237ms.
```json
{
  "@context": "https://openactive.io/",
