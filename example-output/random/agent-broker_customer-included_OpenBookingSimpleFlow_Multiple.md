[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:48:00 GMT+0000 (Coordinated Universal Time)
...
⚠️ 47 passed with 0 failures, 715 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 38.133585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/248/events/2475"
}
```
...
---
Response status code: 200 OK. Responded in 34.438109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/591"
}
```
...
---
Response status code: 200 OK. Responded in 28.722192ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807"
}
```
...
---
Response status code: 200 OK. Responded in 28.827994ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F248%2Fevents%2F2475?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.739565ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/248/events/2475",
    "startDate": "2022-07-25T11:43:11+00:00",
    "endDate": "2022-07-25T15:56:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/248",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/248#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F591?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.914648ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/591",
    "startDate": "2022-07-30T16:42:11+00:00",
    "endDate": "2022-07-30T20:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F381%2Ffacility-use-slots%2F3807?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.788346ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 16.93,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT20H9M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-28T21:06:12+00:00",
    "endDate": "2022-07-29T01:34:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F703%2Ffacility-use-slots%2F7021?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.269753ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/703",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT7H39M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-24T07:53:12+00:00",
    "endDate": "2022-07-24T11:06:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/36036199-720d-4a8b-bf89-ef86dc3dc7b6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/248#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/248/events/2475"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/60#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/591"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 845.2032ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/36036199-720d-4a8b-bf89-ef86dc3dc7b6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:14+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/248"
        },
        "maximumAttendeeCapacity": 46,
        "remainingAttendeeCapacity": 46
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/703"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-24T07:53:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F248%2Fevents%2F2475?useCacheIfAvailable=true&expectedCapacity=44


---
Response status code: 200 OK. Responded in 684.240686ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/248/events/2475",
  "modified": 1658486897015,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F591?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 678.890476ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/591",
  "modified": 1658486897017,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F381%2Ffacility-use-slots%2F3807?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 221.293055ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807",
  "modified": 1658486896559,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F703%2Ffacility-use-slots%2F7021?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 234.197421ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021",
  "modified": 1658486896573,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/36036199-720d-4a8b-bf89-ef86dc3dc7b6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Myah53@gmail.com",
    "telephone": "1-882-833-8421 x80966",
    "givenName": "Jaskolski",
    "familyName": "Leon",
    "identifier": "10ce7e5d-961c-43b9-a4ee-c48f346f4c49"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 670.254498ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 24.345101ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.523963ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.978031ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.40572ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6
...
---
Response status code: 201 Created. Responded in 787.555148ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2601",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/248#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2602",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/248#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2603",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/60#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2604",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2605",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3807#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36036199-720d-4a8b-bf89-ef86dc3dc7b6#/orderedItems/2606",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/703/facility-use-slots/7021#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 51.185784ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 46.001085ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 45.163069ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 44.604658ms.
```json
{
  "data": {
    "@context": [
