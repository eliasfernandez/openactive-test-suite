...
⚠️ 60 passed with 0 failures, 936 warnings and 242 suggestions 
...
---
Response status code: 200 OK. Responded in 64.563468ms.
```json
{
...
---
Response status code: 200 OK. Responded in 60.4226ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 64.259964ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347"
}
```
...
---
Response status code: 200 OK. Responded in 50.218831ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646"
}
```
...
---
Response status code: 200 OK. Responded in 14.826245ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1574",
    "startDate": "2022-07-28T09:35:11+00:00",
    "endDate": "2022-07-28T12:37:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 15.279753ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2618",
    "startDate": "2022-07-31T13:14:11+00:00",
    "endDate": "2022-07-31T14:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F535%2Ffacility-use-slots%2F5347?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.819279ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/535",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT2H53M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-30T15:49:12+00:00",
    "endDate": "2022-07-30T16:47:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F365%2Ffacility-use-slots%2F3646?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.126683ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 18.15,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT17H1M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-24T20:21:12+00:00",
    "endDate": "2022-07-25T01:59:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/99dc61c5-e42e-4a35-b633-644a051064a9
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 423.057602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/99dc61c5-e42e-4a35-b633-644a051064a9",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F158%2Fevents%2F1574?useCacheIfAvailable=true&expectedCapacity=25


---
Response status code: 200 OK. Responded in 462.570456ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1574",
  "modified": 1658486190372,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F262%2Fevents%2F2618?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 461.388236ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2618",
  "modified": 1658486190373,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F535%2Ffacility-use-slots%2F5347?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 935.471983ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347",
  "modified": 1658486190849,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F365%2Ffacility-use-slots%2F3646?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 935.90879ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646",
  "modified": 1658486190850,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/99dc61c5-e42e-4a35-b633-644a051064a9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maiya27@hotmail.com",
    "telephone": "(801) 907-2071 x0445",
    "givenName": "Koss",
    "familyName": "Veda",
    "identifier": "5b8652f0-89af-43af-ab4e-410c0b4ff112"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 173.600574ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:31+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 43.022012ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 41.807592ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 36.845009ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.574007ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9
...
---
Response status code: 201 Created. Responded in 255.135423ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/654",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/158#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/655",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/158#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/656",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/262#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/657",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/658",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/535/facility-use-slots/5347#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/659",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3646#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 32.041227ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.194813ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.097361ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.579153ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;99dc61c5-e42e-4a35-b633-644a051064a9&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/99dc61c5-e42e-4a35-b633-644a051064a9


---
Response status code: 200 OK. Responded in 8.141234ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940829893298268&afterId=7d409e63-f529-49cb-a3eb-99aaa2be12de",
  "message": "Listening for UUID: '99dc61c5-e42e-4a35-b633-644a051064a9' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 241.812913ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;99dc61c5-e42e-4a35-b633-644a051064a9&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/99dc61c5-e42e-4a35-b633-644a051064a9


---
Response status code: 200 OK. Responded in 2466.557244ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "99dc61c5-e42e-4a35-b633-644a051064a9",
  "modified": 637940830023894400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9",
    "identifier": "99dc61c5-e42e-4a35-b633-644a051064a9",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9#/orderedItems/659",
...
---
Response status code: 200 OK. Responded in 43.157507ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940830092908717&afterId=5a94bab9-84a9-48d3-b5d4-93f1b55501f4",
  "message": "Listening for UUID: '99dc61c5-e42e-4a35-b633-644a051064a9' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/99dc61c5-e42e-4a35-b633-644a051064a9
...
---
Response status code: 204 No Content. Responded in 86.358113ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
...
---
Response status code: 200 OK. Responded in 1979.726398ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "99dc61c5-e42e-4a35-b633-644a051064a9",
  "modified": 637940830115717200
}
```
### Specs
* ✅ should return 200 on success
