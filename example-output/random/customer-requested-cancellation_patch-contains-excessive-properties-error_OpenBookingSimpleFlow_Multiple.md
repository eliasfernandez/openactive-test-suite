[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:39:33 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 884 warnings and 242 suggestions 
...
---
Response status code: 200 OK. Responded in 56.821018ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/371/events/3708"
}
```
...
---
Response status code: 200 OK. Responded in 55.155094ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4886"
}
```
...
---
Response status code: 200 OK. Responded in 44.804345ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432"
}
```
...
---
Response status code: 200 OK. Responded in 43.676929ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F371%2Fevents%2F3708?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.380094ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/371/events/3708",
    "startDate": "2022-07-29T00:50:11+00:00",
    "endDate": "2022-07-29T04:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/371",
      "name": "Wooden Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/371#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 6.2,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT8H12M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4886?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.741585ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4886",
    "startDate": "2022-07-26T03:55:11+00:00",
    "endDate": "2022-07-26T04:33:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/489",
      "name": "Wooden Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 4.45,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT13H3M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F544%2Ffacility-use-slots%2F5432?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.158276ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/544",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-24T02:28:12+00:00",
    "endDate": "2022-07-24T04:06:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F485%2Ffacility-use-slots%2F4846?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.647569ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/485",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT17H13M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-29T19:14:12+00:00",
    "endDate": "2022-07-29T22:29:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/371#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/371/events/3708"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4886"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 502.588563ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:44+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/371"
        },
        "maximumAttendeeCapacity": 23,
        "remainingAttendeeCapacity": 23
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/489"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/544"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-24T02:28:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/485"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-29T19:14:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F371%2Fevents%2F3708?useCacheIfAvailable=true&expectedCapacity=21


---
Response status code: 200 OK. Responded in 92.099641ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/371/events/3708",
  "modified": 1658486386976,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4886?useCacheIfAvailable=true&expectedCapacity=41


---
Response status code: 200 OK. Responded in 92.210842ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4886",
  "modified": 1658486386978,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F544%2Ffacility-use-slots%2F5432?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 114.092785ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432",
  "modified": 1658486387001,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F485%2Ffacility-use-slots%2F4846?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 113.271772ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846",
  "modified": 1658486387003,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Evangeline_Crona@gmail.com",
    "telephone": "(805) 755-5850",
    "givenName": "Schmidt",
    "familyName": "Ellie",
    "identifier": "adbc2b5f-7342-4610-9f87-3e2cd75b79c4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 401.58657ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 32.0451ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.891783ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.057569ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.086988ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f
...
---
Response status code: 201 Created. Responded in 545.118111ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1156",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/371#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1157",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/371#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1158",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1160",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/544/facility-use-slots/5432#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f#/orderedItems/1161",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/485/facility-use-slots/4846#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 38.960204ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.765099ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.818585ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.307977ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/41f2c2dd-b2f3-4018-b5ad-5d7d82a5692f
...
---
Response status code: 400 Bad Request. Responded in 15.329637ms.
```json
{
  "@context": "https://openactive.io/",
