...
⚠️ 93 passed with 0 failures, 1196 warnings and 318 suggestions 
...
---
Response status code: 200 OK. Responded in 23.865402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1287/events/12864"
}
```
...
---
Response status code: 200 OK. Responded in 21.806667ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10350"
}
```
...
---
Response status code: 200 OK. Responded in 22.953486ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1396/facility-use-slots/13959"
}
```
...
---
Response status code: 200 OK. Responded in 18.654014ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1153/facility-use-slots/11525"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1287%2Fevents%2F12864?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.908834ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1287/events/12864",
    "startDate": "2022-07-28T08:23:11+00:00",
    "endDate": "2022-07-28T12:31:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1035%2Fevents%2F10350?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.857434ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10350",
    "startDate": "2022-07-30T14:14:11+00:00",
    "endDate": "2022-07-30T19:30:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1396%2Ffacility-use-slots%2F13959?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.425327ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1396",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1396/facility-use-slots/13959#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT9H42M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-27T06:42:12+00:00",
    "endDate": "2022-07-27T07:29:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1153%2Ffacility-use-slots%2F11525?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.98452ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1153/facility-use-slots/11525#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 4,
    "startDate": "2022-08-01T05:17:12+00:00",
    "endDate": "2022-08-01T09:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3417a7c7-5ef1-4951-8466-43fc398ba903
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1287/events/12864"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1035/events/10350"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1396/facility-use-slots/13959#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1396/facility-use-slots/13959"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1153/facility-use-slots/11525#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1153/facility-use-slots/11525"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 400 Bad Request. Responded in 34.725285ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 30.758418ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1543/events/15429"
}
```
...
---
Response status code: 200 OK. Responded in 29.330594ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10444"
}
```
...
---
Response status code: 200 OK. Responded in 28.211875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16567"
}
```
...
---
Response status code: 200 OK. Responded in 15.346358ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1614/facility-use-slots/16140"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1543%2Fevents%2F15429?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.338026ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1543/events/15429",
    "startDate": "2022-07-25T22:00:11+00:00",
    "endDate": "2022-07-26T03:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1543",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1543#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1045%2Fevents%2F10444?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.03342ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10444",
    "startDate": "2022-07-26T03:00:11+00:00",
    "endDate": "2022-07-26T04:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1657%2Ffacility-use-slots%2F16567?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.284758ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16567#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 19.02,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT21H48M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-24T13:45:12+00:00",
    "endDate": "2022-07-24T16:08:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1614%2Ffacility-use-slots%2F16140?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.112855ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1614/facility-use-slots/16140#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 1.62,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT11H55M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-08-01T06:00:12+00:00",
    "endDate": "2022-08-01T08:56:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d31e6cec-6b96-4ac4-a322-2e01092c1045
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1543#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1543/events/15429"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10444"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16567#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16567"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1614/facility-use-slots/16140#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1614/facility-use-slots/16140"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 207.509991ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d31e6cec-6b96-4ac4-a322-2e01092c1045",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:00+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1543%2Fevents%2F15429?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 176.071762ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1543/events/15429",
  "modified": 1658486163013,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1045%2Fevents%2F10444?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 176.391567ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10444",
  "modified": 1658486163016,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1657%2Ffacility-use-slots%2F16567?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 671.502034ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16567",
  "modified": 1658486163520,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1614%2Ffacility-use-slots%2F16140?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 673.145857ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1614/facility-use-slots/16140",
  "modified": 1658486163522,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d31e6cec-6b96-4ac4-a322-2e01092c1045
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shayne_Feeney21@gmail.com",
    "telephone": "1-231-627-1114",
    "givenName": "Ferry",
    "familyName": "Vincent",
    "identifier": "12f7fbe7-4f1f-4e41-8cef-b8acf1e2b20f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 10.825063ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
---
Response status code: 200 OK. Responded in 16.995657ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12100"
}
```
...
---
Response status code: 200 OK. Responded in 15.657036ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1078/events/10774"
}
```
...
---
Response status code: 200 OK. Responded in 14.535719ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 13.681406ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11176"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1210%2Fevents%2F12100?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.31754ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12100",
    "startDate": "2022-07-24T05:12:11+00:00",
    "endDate": "2022-07-24T07:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1078%2Fevents%2F10774?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.848033ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1078/events/10774",
    "startDate": "2022-07-26T11:50:11+00:00",
    "endDate": "2022-07-26T16:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1078",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1078#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
...
---
Response status code: 200 OK. Responded in 9.89515ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT23H21M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-26T20:06:12+00:00",
    "endDate": "2022-07-27T00:18:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1118%2Ffacility-use-slots%2F11176?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.461543ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11176#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 4,
    "startDate": "2022-07-27T11:16:12+00:00",
    "endDate": "2022-07-27T16:32:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5fbc918b-39c4-42af-b0b3-66749efa5aba
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12100"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1078#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1078/events/10774"
    },
    {
      "@type": "OrderItem",
      "position": 3,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11176#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11176"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 102.540248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5fbc918b-39c4-42af-b0b3-66749efa5aba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:05+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1078"
        },
        "maximumAttendeeCapacity": 23,
        "remainingAttendeeCapacity": 23
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1210%2Fevents%2F12100?useCacheIfAvailable=true&expectedCapacity=18


---
Response status code: 200 OK. Responded in 149.346455ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12100",
  "modified": 1658486167339,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1078%2Fevents%2F10774?useCacheIfAvailable=true&expectedCapacity=22


---
Response status code: 200 OK. Responded in 128.777344ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1078/events/10774",
  "modified": 1658486167343,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1607%2Ffacility-use-slots%2F16065?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 922.946035ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1607/facility-use-slots/16065",
  "modified": 1658486168137,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1118%2Ffacility-use-slots%2F11176?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 924.447357ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11176",
  "modified": 1658486168140,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5fbc918b-39c4-42af-b0b3-66749efa5aba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dorcas_Kirlin88@yahoo.com",
    "telephone": "(401) 200-0465 x23058",
    "givenName": "Quigley",
    "familyName": "Amely",
    "identifier": "65893970-3d06-4a30-88ee-b84f9853cd48"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 188.793265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 32.649147ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.63613ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.886317ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.46001ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5fbc918b-39c4-42af-b0b3-66749efa5aba
...
---
Response status code: 400 Bad Request. Responded in 61.177524ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
