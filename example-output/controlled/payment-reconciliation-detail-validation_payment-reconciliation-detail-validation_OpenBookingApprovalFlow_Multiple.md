[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:50:23 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 816 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 25.685866ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2606/events/20606"
}
```
...
---
Response status code: 200 OK. Responded in 141.825617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2607/events/20607"
}
```
...
---
Response status code: 200 OK. Responded in 49.872323ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595"
}
```
...
---
Response status code: 200 OK. Responded in 24.632959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2606%2Fevents%2F20606?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 455.168942ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2606/events/20606",
  "modified": 1658487070157,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2606/events/20606",
    "startDate": "2022-07-23T10:51:08+00:00",
    "endDate": "2022-07-23T11:51:08+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2606",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2606#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2607%2Fevents%2F20607?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 454.247135ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2607/events/20607",
  "modified": 1658487070158,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2607",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2607#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2595%2Ffacility-use-slots%2F20595?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 292.276588ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595",
  "modified": 1658487069997,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2595",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2594%2Ffacility-use-slots%2F20594?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 291.184381ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594",
  "modified": 1658487069995,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2594",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e7c938d7-9d7f-448a-9d0e-51a48746be96
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2606#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2606/events/20606"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2607#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2607/events/20607"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 761.760222ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:09+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2606"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2607"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2606%2Fevents%2F20606?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 477.517786ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2606/events/20606",
  "modified": 1658487071888,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2607%2Fevents%2F20607?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 478.750493ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2607/events/20607",
  "modified": 1658487071890,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2595%2Ffacility-use-slots%2F20595?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 666.411506ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595",
  "modified": 1658487072077,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2594%2Ffacility-use-slots%2F20594?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 666.050603ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594",
  "modified": 1658487072078,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e7c938d7-9d7f-448a-9d0e-51a48746be96
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shanie_Armstrong1@hotmail.com",
    "telephone": "222-730-2027",
    "givenName": "O'Reilly",
    "familyName": "Annamarie",
    "identifier": "c9968787-5164-4161-ae79-8752e3f28a3e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 717.274151ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:11+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.086392ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.472688ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.176785ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.016685ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e7c938d7-9d7f-448a-9d0e-51a48746be96
...
---
Response status code: 201 Created. Responded in 877.903417ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/e7c938d7-9d7f-448a-9d0e-51a48746be96",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3239",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2606#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3240",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2606#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3241",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2607#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3242",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3243",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2595/facility-use-slots/20595#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96#/orderedItems/3244",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2594/facility-use-slots/20594#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/e7c938d7-9d7f-448a-9d0e-51a48746be96/versions/85d55dd8-d893-4b32-8949-b26eedcdb2c0",
  "payment": {
    "@type": "Payment",
    "identifier": "fepWj6gbU",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;e7c938d7-9d7f-448a-9d0e-51a48746be96&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/e7c938d7-9d7f-448a-9d0e-51a48746be96


---
Response status code: 200 OK. Responded in 4.66933ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838664942965&afterId=92864327-0aba-4d77-9441-d8ce2a8d0360",
  "message": "Listening for UUID: 'e7c938d7-9d7f-448a-9d0e-51a48746be96' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 14.510994ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;e7c938d7-9d7f-448a-9d0e-51a48746be96&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/e7c938d7-9d7f-448a-9d0e-51a48746be96


---
Response status code: 200 OK. Responded in 2319.966609ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "modified": 637940838736296200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/e7c938d7-9d7f-448a-9d0e-51a48746be96",
    "identifier": "e7c938d7-9d7f-448a-9d0e-51a48746be96",
...
---
Response status code: 200 OK. Responded in 4.939832ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838736296241&afterId=e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "message": "Listening for UUID: 'e7c938d7-9d7f-448a-9d0e-51a48746be96' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96
...
---
Response status code: 201 Created. Responded in 443.397487ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "identifier": "e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 4.843232ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "e7c938d7-9d7f-448a-9d0e-51a48746be96",
  "modified": 637940838760316000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 10.895971ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.455369ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.273267ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.088566ms.
```json
{
  "data": {
    "@context": [
