[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:44:02 GMT+0000 (Coordinated Universal Time)
...
⚠️ 47 passed with 0 failures, 721 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 300.565966ms.
```json
{
...
---
Response status code: 200 OK. Responded in 357.45037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 296.696332ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 350.586209ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 318.029121ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2426/events/20426",
  "modified": 1658486654865,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2426/events/20426",
    "startDate": "2022-07-23T10:44:13+00:00",
    "endDate": "2022-07-23T11:44:13+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 317.225213ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2427/events/20427",
...
---
Response status code: 200 OK. Responded in 730.375878ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2413/facility-use-slots/20413",
  "modified": 1658486655281,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 736.598032ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2414/facility-use-slots/20414",
  "modified": 1658486655288,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8216409e-9533-440e-98b0-c6c249453b71
...
---
Response status code: 200 OK. Responded in 1017.673405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8216409e-9533-440e-98b0-c6c249453b71",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:15+00:00"
  },
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2426%2Fevents%2F20426?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 30.583471ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2427%2Fevents%2F20427?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 29.795564ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2413%2Ffacility-use-slots%2F20413?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 306.891415ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2413/facility-use-slots/20413",
  "modified": 1658486658141,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2414%2Ffacility-use-slots%2F20414?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 306.21761ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2414/facility-use-slots/20414",
  "modified": 1658486658142,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8216409e-9533-440e-98b0-c6c249453b71
...
---
Response status code: 200 OK. Responded in 983.749705ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2)
...
---
Response status code: 200 OK. Responded in 43.845788ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 42.842579ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 42.187573ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 41.709669ms.
```json
{
  "data": {
    "@context": [
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71
...
---
Response status code: 201 Created. Responded in 898.112047ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2158",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2426#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2426#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2160",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2427#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2161",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2413/facility-use-slots/20413#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2162",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2413/facility-use-slots/20413#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8216409e-9533-440e-98b0-c6c249453b71#/orderedItems/2163",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2414/facility-use-slots/20414#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B)
...
---
Response status code: 200 OK. Responded in 27.872754ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.073546ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.497941ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.047637ms.
```json
{
  "data": {
    "@context": [
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
