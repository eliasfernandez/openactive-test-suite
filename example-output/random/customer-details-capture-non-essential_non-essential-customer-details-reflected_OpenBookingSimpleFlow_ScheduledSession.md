...
⚠️ 14 passed with 0 failures, 144 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 61.901813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/600/events/5995"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F600%2Fevents%2F5995?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.324633ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/600/events/5995",
    "startDate": "2022-07-30T00:32:11+00:00",
    "endDate": "2022-07-30T02:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/600",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/600#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT10H42M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/600#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/600/events/5995"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 51.211638ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:55+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F600%2Fevents%2F5995?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 356.344231ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/600/events/5995",
  "modified": 1658486217029,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kenny.Pollich@hotmail.com",
    "telephone": "634.586.1529",
    "givenName": "Monahan",
    "familyName": "Verdie",
    "identifier": "2576ebde-ad88-4e46-8005-1adbe99264e2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 188.278281ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 42.539096ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a
...
---
Response status code: 201 Created. Responded in 56.970433ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/73b35ff0-dfb1-4512-a2a7-e0809bd99a9a#/orderedItems/718",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/600#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 10.317265ms.
```json
{
  "data": {
    "@context": [
