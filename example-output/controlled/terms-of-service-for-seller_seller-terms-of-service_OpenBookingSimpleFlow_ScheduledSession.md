[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:35 GMT+0000 (Coordinated Universal Time)
...
⚠️ 14 passed with 0 failures, 115 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 74.547371ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1140.6157680000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2128/events/20128",
  "modified": 1658486138422,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2128/events/20128",
    "startDate": "2022-07-23T10:35:36+00:00",
    "endDate": "2022-07-23T11:35:36+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb
...
---
Response status code: 200 OK. Responded in 61.484754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:37+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2128%2Fevents%2F20128?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 878.256479ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2128/events/20128",
  "modified": 1658486139683,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kennedy46@gmail.com",
    "telephone": "534.647.3102 x44111",
    "givenName": "Bayer",
    "familyName": "Macie",
    "identifier": "ea41af61-47a5-469b-9e48-2d4dccde2645"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 48.594943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:38+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 3.734027ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb
...
---
Response status code: 201 Created. Responded in 87.356018ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c245e0a0-aa1c-43a1-92cc-fae59dc3b3cb#/orderedItems/581",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2128#/offers/0",
        "allowCustomerCancellationFullRefund": true,
