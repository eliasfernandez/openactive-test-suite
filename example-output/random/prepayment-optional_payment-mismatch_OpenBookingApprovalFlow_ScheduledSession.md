...
---
Response status code: 200 OK. Responded in 5.165192ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1550/events/15499"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1550%2Fevents%2F15499?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.46672ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1550/events/15499",
    "startDate": "2022-07-27T10:46:11+00:00",
    "endDate": "2022-07-27T13:14:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1550",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1550#/offers/0",
          ...
          "price": 13.62,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT19H11M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/14ac9eec-66f5-4daf-8ace-cbe261e50e0e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1550#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1550/events/15499"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 484.451853ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/14ac9eec-66f5-4daf-8ace-cbe261e50e0e",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1550"
        },
        "maximumAttendeeCapacity": 13,
        "remainingAttendeeCapacity": 13
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1550%2Fevents%2F15499?useCacheIfAvailable=true&expectedCapacity=12


---
Response status code: 200 OK. Responded in 297.163046ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1550/events/15499",
  "modified": 1658486943827,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/14ac9eec-66f5-4daf-8ace-cbe261e50e0e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Litzy_Johns@hotmail.com",
    "telephone": "1-822-219-3765",
    "givenName": "Morissette",
    "familyName": "Ahmed",
    "identifier": "c8234a21-9d27-4fe2-9b73-ca28ffe57f2a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 476.819719ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 23.20711ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/14ac9eec-66f5-4daf-8ace-cbe261e50e0e
...
---
Response status code: 400 Bad Request. Responded in 803.142451ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (14.62) does not match expected value (13.62)"
}
```
### Specs
