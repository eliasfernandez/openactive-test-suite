...
⚠️ 11 passed with 0 failures, 135 warnings and 48 suggestions 
...
---
Response status code: 200 OK. Responded in 80.768174ms.
```json
{
...
---
Response status code: 200 OK. Responded in 55.650065ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 1429.713235ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2254/events/20254",
  "modified": 1658486308362,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2254/events/20254",
    "startDate": "2022-07-23T10:38:25+00:00",
    "endDate": "2022-07-23T11:38:25+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1428.769927ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2255/events/20255",
  "modified": 1658486308363,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/15de2d58-454b-4e16-9107-db5739cd68d7
...
---
Response status code: 500 Internal Server Error. Responded in 48.114302ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/15de2d58-454b-4e16-9107-db5739cd68d7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aryanna50@hotmail.com",
    "telephone": "888.854.1784 x1033",
    "givenName": "Sporer",
    "familyName": "April",
    "identifier": "0cc6e5d7-f263-40a3-9c51-609428e65999"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 32.609472ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/15de2d58-454b-4e16-9107-db5739cd68d7
...
---
Response status code: 500 Internal Server Error. Responded in 54.199152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
