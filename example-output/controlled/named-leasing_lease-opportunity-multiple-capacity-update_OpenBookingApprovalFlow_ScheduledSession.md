...
---
Response status code: 200 OK. Responded in 21.229502ms.
```json
{
...
---
Response status code: 200 OK. Responded in 600.723513ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2468/events/20468",
  "modified": 1658486751085,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2468/events/20468",
    "startDate": "2022-07-23T10:45:49+00:00",
    "endDate": "2022-07-23T11:45:49+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6c51de7c-59f9-448f-81f2-b90bbd4382a5
...
---
Response status code: 200 OK. Responded in 372.072439ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6c51de7c-59f9-448f-81f2-b90bbd4382a5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:50+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6c51de7c-59f9-448f-81f2-b90bbd4382a5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Flavie14@gmail.com",
    "telephone": "798.389.2311 x302",
    "givenName": "Shields",
    "familyName": "Lexi",
    "identifier": "62b89ee5-c3e0-4be9-966a-b61d2e91f5b8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 463.138705ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2468%2Fevents%2F20468?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 7.83217ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 297.492064ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:51+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b031ddc5-2a6a-4faa-85b1-9b4f9d85e83f
...
---
Response status code: 409 Conflict. Responded in 204.476231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b031ddc5-2a6a-4faa-85b1-9b4f9d85e83f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b031ddc5-2a6a-4faa-85b1-9b4f9d85e83f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Claud_Jones63@yahoo.com",
    "telephone": "727.247.7729 x94187",
    "givenName": "Durgan",
    "familyName": "Mohammad",
    "identifier": "a2b5842e-41db-47d4-8a05-3a22e2367cf9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 461.410432ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.202847ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3153f4af-7535-427f-9f49-084e2a93290c
...
---
Response status code: 200 OK. Responded in 179.243405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3153f4af-7535-427f-9f49-084e2a93290c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:54+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3153f4af-7535-427f-9f49-084e2a93290c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tyrique_Wilkinson30@hotmail.com",
    "telephone": "(534) 866-1289 x65422",
    "givenName": "O'Reilly",
    "familyName": "Dario",
    "identifier": "5132d165-b85d-4745-af96-0b51d67b227b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 149.990843ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:55+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2468%2Fevents%2F20468?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 373.685346ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2468/events/20468",
  "modified": 1658486756697,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8c8ff425-a844-41d4-9a0f-19f31d8adba8
...
---
Response status code: 409 Conflict. Responded in 115.02623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8c8ff425-a844-41d4-9a0f-19f31d8adba8",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:55+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8c8ff425-a844-41d4-9a0f-19f31d8adba8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clark_Russel77@hotmail.com",
    "telephone": "(500) 318-8716",
    "givenName": "Berge",
    "familyName": "Colton",
    "identifier": "2511e35f-96e7-44d9-a688-b3dc9c7f72ab"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 81.951734ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:56+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 10.05339ms.
```json
{
  "data": {
    "@context": [
