...
⚠️ 15 passed with 0 failures, 119 warnings and 14 suggestions 
...
---
Response status code: 200 OK. Responded in 5.630022ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F363%2Ffacility-use-slots%2F3622?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.028231ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/363",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0.56,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT21H28M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-23T23:39:12+00:00",
    "endDate": "2022-07-24T04:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d68f6cb6-f35f-471a-b240-355905c61a9b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 449.552767ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d68f6cb6-f35f-471a-b240-355905c61a9b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F363%2Ffacility-use-slots%2F3622?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 1491.567154ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622",
  "modified": 1658486771363,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d68f6cb6-f35f-471a-b240-355905c61a9b
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "46e9d243-3bee-41a4-93a9-2dbe041fc6d0",
...
---
Response status code: 200 OK. Responded in 359.072731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.742827ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d68f6cb6-f35f-471a-b240-355905c61a9b
...
---
Response status code: 201 Created. Responded in 298.880673ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d68f6cb6-f35f-471a-b240-355905c61a9b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d68f6cb6-f35f-471a-b240-355905c61a9b#/orderedItems/2209",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/363/facility-use-slots/3622#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 13.97353ms.
```json
{
  "data": {
    "@context": [
