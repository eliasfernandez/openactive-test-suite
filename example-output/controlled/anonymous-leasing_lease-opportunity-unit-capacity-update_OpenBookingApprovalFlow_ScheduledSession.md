...
---
Response status code: 200 OK. Responded in 112.554096ms.
```json
{
...
---
Response status code: 200 OK. Responded in 504.356163ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2430/events/20430",
  "modified": 1658486662901,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/24518386-15cb-4f4e-bb71-6588dbe698a0
...
---
Response status code: 200 OK. Responded in 266.316856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/24518386-15cb-4f4e-bb71-6588dbe698a0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2430%2Fevents%2F20430?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 689.647402ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2430/events/20430",
  "modified": 1658486664066,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9506b037-a1ed-4730-a477-0630b766704d
...
---
Response status code: 409 Conflict. Responded in 409.594697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9506b037-a1ed-4730-a477-0630b766704d",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 13.380622ms.
```json
{
  "data": {
    "@context": [
