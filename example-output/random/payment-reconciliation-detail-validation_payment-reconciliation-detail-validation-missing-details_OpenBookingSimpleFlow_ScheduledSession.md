...
---
Response status code: 200 OK. Responded in 53.646093ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5557"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F556%2Fevents%2F5557?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.242953ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5557",
    "startDate": "2022-07-30T06:20:11+00:00",
    "endDate": "2022-07-30T08:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 19.54,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT19H25M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9e4ba0c8-948a-4641-b99a-12bb10c17a06
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5557"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 246.862809ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9e4ba0c8-948a-4641-b99a-12bb10c17a06
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Faustino57@hotmail.com",
    "telephone": "1-912-985-0209 x774",
    "givenName": "Kemmer",
    "familyName": "Mozelle",
    "identifier": "16fc6758-f3d0-4572-99d6-bfa7de5293f5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 33.374955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
