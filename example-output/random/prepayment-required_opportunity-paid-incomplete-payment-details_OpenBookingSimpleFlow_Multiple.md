[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:47 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 195 warnings and 52 suggestions 
...
---
Response status code: 200 OK. Responded in 17.19726ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4577"
}
```
...
---
Response status code: 200 OK. Responded in 22.058761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4691"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F458%2Fevents%2F4577?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.362338ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4577",
    "startDate": "2022-07-23T05:11:11+00:00",
    "endDate": "2022-07-23T08:47:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/458",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/458#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 12.99,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F470%2Ffacility-use-slots%2F4691?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.575521ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/470",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4691#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 5.09,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT7H46M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-31T23:11:12+00:00",
    "endDate": "2022-08-01T01:30:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6ab807a4-a7f6-4d6f-a0fa-9e9cc996fc65
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/458#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4577"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4691#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4691"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 463.57139ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6ab807a4-a7f6-4d6f-a0fa-9e9cc996fc65",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/458"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/470"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-31T23:11:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F458%2Fevents%2F4577?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 385.13005ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4577",
  "modified": 1658486880058,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F470%2Ffacility-use-slots%2F4691?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 284.562848ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/470/facility-use-slots/4691",
  "modified": 1658486879955,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6ab807a4-a7f6-4d6f-a0fa-9e9cc996fc65
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josiane.MacGyver@yahoo.com",
    "telephone": "694.242.1838",
    "givenName": "Bayer",
    "familyName": "Margaret",
    "identifier": "bbe49864-6e41-424f-82b0-4bdfbf4060cf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 507.491408ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 25.722438ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.931221ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6ab807a4-a7f6-4d6f-a0fa-9e9cc996fc65
...
---
Response status code: 400 Bad Request. Responded in 593.66381ms.
```json
{
  "@context": "https://openactive.io/",
