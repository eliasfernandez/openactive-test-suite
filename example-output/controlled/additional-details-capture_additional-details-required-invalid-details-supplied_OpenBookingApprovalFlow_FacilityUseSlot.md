...
---
Response status code: 200 OK. Responded in 24.534692ms.
```json
{
...
---
Response status code: 200 OK. Responded in 629.665928ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2155/facility-use-slots/20155",
  "modified": 1658486181886,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/25034f3e-12ee-4b2d-ad49-1c672f0cd08c
...
---
Response status code: 200 OK. Responded in 140.045295ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/25034f3e-12ee-4b2d-ad49-1c672f0cd08c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2155%2Ffacility-use-slots%2F20155?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 587.880868ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2155/facility-use-slots/20155",
  "modified": 1658486182903,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/25034f3e-12ee-4b2d-ad49-1c672f0cd08c
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "(438) 225-2313",
    "givenName": "O'Hara",
    "familyName": "Ruby",
    "identifier": "8ce02c6b-7b4e-4e2c-a65f-10717e7623cf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 61.505351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/25034f3e-12ee-4b2d-ad49-1c672f0cd08c
...
---
Response status code: 409 Conflict. Responded in 27.764303ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/25034f3e-12ee-4b2d-ad49-1c672f0cd08c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
