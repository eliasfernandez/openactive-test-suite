...
⚠️ 26 passed with 0 failures, 335 warnings and 90 suggestions 
...
---
Response status code: 200 OK. Responded in 652.546148ms.
```json
{
...
---
Response status code: 200 OK. Responded in 691.802206ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 650.711431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 750.58154ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 342.424017ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2587/events/20587",
  "modified": 1658487009147,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2587/events/20587",
    "startDate": "2022-07-23T10:50:07+00:00",
    "endDate": "2022-07-23T11:50:07+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 342.073114ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2588/events/20588",
  "modified": 1658487009148,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 534.753868ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2573/facility-use-slots/20573",
  "modified": 1658487009341,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 533.445456ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2574/facility-use-slots/20574",
  "modified": 1658487009343,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/233b42f5-7ff1-43f9-9517-263f5f24e4b3
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-ElZRglEqql",
    "accountId": "invalid-CT_-YXZbp",
    "paymentProviderId": "invalid-MZPGxkEtKs"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 74.060874ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/233b42f5-7ff1-43f9-9517-263f5f24e4b3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Melba_Torphy80@hotmail.com",
    "telephone": "821-703-1430 x9957",
    "givenName": "Weber",
    "familyName": "Gideon",
    "identifier": "3c691864-f0ca-4878-a85d-a05ba6ad347a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-5s7kRMcFhg",
    "accountId": "invalid-9Dd15rsi0",
    "paymentProviderId": "invalid-2YTB4qHBTA"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 104.503351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
