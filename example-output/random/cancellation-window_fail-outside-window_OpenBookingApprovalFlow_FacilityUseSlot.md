...
---
Response status code: 200 OK. Responded in 6.543865ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1773%2Ffacility-use-slots%2F17724?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.599416ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1773",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT20H4M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-22T20:59:12+00:00",
    "endDate": "2022-07-23T00:14:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 163.965739ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:55+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1773"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-22T20:59:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1773%2Ffacility-use-slots%2F17724?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 485.970567ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724",
  "modified": 1658486577469,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Harold_Bahringer@hotmail.com",
    "telephone": "(807) 894-4569 x7599",
    "givenName": "Johnson",
    "familyName": "Amely",
    "identifier": "7633b5a9-dd6a-4475-ab7d-5ba636493e18"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 135.86793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 33.868255ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5
...
---
Response status code: 201 Created. Responded in 173.029368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5#/orderedItems/1726",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1773/facility-use-slots/17724#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5/versions/2f474a6b-a08f-40bf-8572-e418818426fd",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5


---
Response status code: 200 OK. Responded in 17.126732ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833729044007&afterId=df3441ed-6836-411c-84e2-f97dd88135ef",
  "message": "Listening for UUID: 'f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 171.969741ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5


---
Response status code: 200 OK. Responded in 2164.805958ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "modified": 637940833772836900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
    "identifier": "f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
...
---
Response status code: 200 OK. Responded in 15.651845ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833772836821&afterId=f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "message": "Listening for UUID: 'f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5
...
---
Response status code: 201 Created. Responded in 266.933717ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "identifier": "f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 655.269017ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5",
  "modified": 637940833798033900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 6.588814ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f8d62d1f-3d54-4ef6-8ad2-1aeb50b251c5
...
---
Response status code: 400 Bad Request. Responded in 16.685895ms.
```json
{
  "@context": "https://openactive.io/",
