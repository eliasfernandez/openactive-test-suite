[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:39:50 GMT+0000 (Coordinated Universal Time)
...
⚠️ 48 passed with 0 failures, 705 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 158.720548ms.
```json
{
...
---
Response status code: 200 OK. Responded in 107.639015ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 74.12013ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 175.40529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 290.70497ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2315/events/20315",
  "modified": 1658486402295,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2315/events/20315",
    "startDate": "2022-07-23T10:40:00+00:00",
    "endDate": "2022-07-23T11:40:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 281.945795ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2314/events/20314",
  "modified": 1658486402294,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1581.1160340000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2302/facility-use-slots/20302",
  "modified": 1658486403593,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1580.856831ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2303/facility-use-slots/20303",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bd5260d6-a9aa-4cef-82c6-5d468511afaa
...
---
Response status code: 200 OK. Responded in 420.208571ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bd5260d6-a9aa-4cef-82c6-5d468511afaa",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2315%2Fevents%2F20315?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 469.314887ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2315/events/20315",
  "modified": 1658486405688,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2314%2Fevents%2F20314?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 464.837649ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2314/events/20314",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2302%2Ffacility-use-slots%2F20302?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 23.861803ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2302/facility-use-slots/20302",
  "modified": 1658486405245,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2303%2Ffacility-use-slots%2F20303?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 23.505299ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2303/facility-use-slots/20303",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bd5260d6-a9aa-4cef-82c6-5d468511afaa
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Willis59@gmail.com",
    "telephone": "521-433-3329",
    "givenName": "Kub",
    "familyName": "Lloyd",
    "identifier": "9d37124a-76ab-46fa-b18c-2a037373df28"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 684.555416ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 40.795247ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.997736ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.474531ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.030728ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa
...
---
Response status code: 201 Created. Responded in 652.107067ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1435",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2315#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1436",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2315#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1437",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2314#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1438",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2302/facility-use-slots/20302#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1439",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2302/facility-use-slots/20302#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd5260d6-a9aa-4cef-82c6-5d468511afaa#/orderedItems/1440",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2303/facility-use-slots/20303#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.818733ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.481031ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.261329ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.152727ms.
```json
{
  "data": {
    "@context": [
