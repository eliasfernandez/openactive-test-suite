...
⚠️ 15 passed with 0 failures, 152 warnings and 54 suggestions 
...
---
Response status code: 200 OK. Responded in 74.34553ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7206"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F721%2Fevents%2F7206?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.149988ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7206",
    "startDate": "2022-07-22T21:15:11+00:00",
    "endDate": "2022-07-23T00:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/721",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/721#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 3.68,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT16H1M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6dc7bab2-c772-4c4f-b94b-69831e46690c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/721#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7206"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 461.218094ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6dc7bab2-c772-4c4f-b94b-69831e46690c",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/721"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6dc7bab2-c772-4c4f-b94b-69831e46690c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Reina.Gorczany91@yahoo.com",
    "telephone": "937.759.4110 x5770",
    "givenName": "Purdy",
    "familyName": "Simone",
    "identifier": "16cf52ce-6caa-44af-8aff-f433aa5ca9cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 861.382233ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:15+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F721%2Fevents%2F7206?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 20.306418ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 404.374824ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a8774898-454f-4f59-98b7-75da6383e8f4
...
---
Response status code: 409 Conflict. Responded in 649.527071ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a8774898-454f-4f59-98b7-75da6383e8f4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:16+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a8774898-454f-4f59-98b7-75da6383e8f4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Isobel_McGlynn46@gmail.com",
    "telephone": "599.358.4947",
    "givenName": "Corkery",
    "familyName": "Dejuan",
    "identifier": "7960914b-a6c3-421c-bd81-1d514ad726f3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 244.900241ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 44.563217ms.
```json
{
  "data": {
    "@context": [
