[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:40 GMT+0000 (Coordinated Universal Time)
...
⚠️ 40 passed with 0 failures, 571 warnings and 150 suggestions 
...
---
Response status code: 200 OK. Responded in 25.711594ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/684/events/6833"
}
```
...
---
Response status code: 200 OK. Responded in 24.600977ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4908"
}
```
...
---
Response status code: 200 OK. Responded in 23.696764ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/892/facility-use-slots/8917"
}
```
...
---
Response status code: 200 OK. Responded in 18.788289ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/468/facility-use-slots/4680"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F684%2Fevents%2F6833?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.251558ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/684/events/6833",
    "startDate": "2022-07-28T04:24:11+00:00",
    "endDate": "2022-07-28T08:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/684",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/684#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P2DT4H21M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F491%2Fevents%2F4908?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.852951ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4908",
    "startDate": "2022-07-29T12:13:11+00:00",
    "endDate": "2022-07-29T16:12:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/491",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/491#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT8H24M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F892%2Ffacility-use-slots%2F8917?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.444345ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/892",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/892/facility-use-slots/8917#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT5H49M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-29T17:42:12+00:00",
    "endDate": "2022-07-29T22:36:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F468%2Ffacility-use-slots%2F4680?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.039139ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/468/facility-use-slots/4680#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-25T20:09:12+00:00",
    "endDate": "2022-07-26T01:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cb2bfe21-360d-484c-b983-06ab1bb67662
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/684#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/684/events/6833"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/491#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4908"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/892/facility-use-slots/8917#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/892/facility-use-slots/8917"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/468/facility-use-slots/4680#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/468/facility-use-slots/4680"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 292.211084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cb2bfe21-360d-484c-b983-06ab1bb67662",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/684"
        },
        "maximumAttendeeCapacity": 20,
        "remainingAttendeeCapacity": 20
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/491"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/892"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-29T17:42:12+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cb2bfe21-360d-484c-b983-06ab1bb67662
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vilma44@gmail.com",
    "telephone": "1-498-918-8779 x7359",
    "givenName": "Rogahn",
    "familyName": "Evan",
    "identifier": "ad39d3aa-eed1-4115-b024-260fca9cec61"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 75.730162ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
