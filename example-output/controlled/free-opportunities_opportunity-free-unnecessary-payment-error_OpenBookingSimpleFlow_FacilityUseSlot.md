...
---
Response status code: 200 OK. Responded in 67.721676ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1273.931538ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435",
  "modified": 1658486700331,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:44:58+00:00",
    "endDate": "2022-07-23T11:44:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f644e15e-9d9f-4cc5-bac8-b94746ef51ba
...
---
Response status code: 200 OK. Responded in 493.6781ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f644e15e-9d9f-4cc5-bac8-b94746ef51ba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2435%2Ffacility-use-slots%2F20435?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 768.112735ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435",
  "modified": 1658486701965,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f644e15e-9d9f-4cc5-bac8-b94746ef51ba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dax_Hoeger41@yahoo.com",
    "telephone": "753.775.1010 x7311",
    "givenName": "Hane",
    "familyName": "Brooke",
    "identifier": "40e28806-608d-4d82-a003-ea04f9cee28f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 294.826908ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:01+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.808926ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f644e15e-9d9f-4cc5-bac8-b94746ef51ba
...
---
Response status code: 400 Bad Request. Responded in 165.69941ms.
```json
{
  "@context": "https://openactive.io/",
