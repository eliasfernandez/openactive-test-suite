...
---
Response status code: 200 OK. Responded in 23.511265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F365%2Ffacility-use-slots%2F3642?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.741853ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/365",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642#/offers/0",
        ...
        "price": 15.44,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT8H41M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-24T05:09:12+00:00",
    "endDate": "2022-07-24T06:58:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7155eb77-54cb-4734-a866-8ffe3c23809e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 527.493993ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7155eb77-54cb-4734-a866-8ffe3c23809e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:26+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/365"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-24T05:09:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F365%2Ffacility-use-slots%2F3642?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 872.132797ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642",
  "modified": 1658486968895,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7155eb77-54cb-4734-a866-8ffe3c23809e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Darius_Rice@hotmail.com",
    "telephone": "1-249-929-7478 x639",
    "givenName": "Will",
    "familyName": "Eldora",
    "identifier": "2c0029c3-2716-4403-af07-bead847c498d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 538.630624ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.346318ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7155eb77-54cb-4734-a866-8ffe3c23809e
...
---
Response status code: 201 Created. Responded in 435.156841ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7155eb77-54cb-4734-a866-8ffe3c23809e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7155eb77-54cb-4734-a866-8ffe3c23809e#/orderedItems/2753",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/365/facility-use-slots/3642#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 15.14589ms.
```json
{
  "data": {
    "@context": [
