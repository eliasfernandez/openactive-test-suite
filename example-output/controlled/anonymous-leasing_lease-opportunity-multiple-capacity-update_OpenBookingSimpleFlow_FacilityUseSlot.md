...
⚠️ 31 passed with 0 failures, 338 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 1277.581721ms.
```json
{
...
---
Response status code: 200 OK. Responded in 645.366865ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2393/facility-use-slots/20393",
  "modified": 1658486608971,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 5,
    "startDate": "2022-07-23T10:43:26+00:00",
    "endDate": "2022-07-23T11:43:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9226c04a-f68f-4de7-82a4-9939513595ec
...
---
Response status code: 200 OK. Responded in 347.410149ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9226c04a-f68f-4de7-82a4-9939513595ec",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2393%2Ffacility-use-slots%2F20393?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 955.710088ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2393/facility-use-slots/20393",
  "modified": 1658486610657,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/977b7cf3-0ce3-468c-856a-c2f7e3bb1158
...
---
Response status code: 409 Conflict. Responded in 348.752761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/977b7cf3-0ce3-468c-856a-c2f7e3bb1158",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:30+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 38.521438ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7b16b397-4946-4fb0-b99c-1e081eb5de0b
...
---
Response status code: 200 OK. Responded in 325.577257ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7b16b397-4946-4fb0-b99c-1e081eb5de0b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:30+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2393%2Ffacility-use-slots%2F20393?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 1300.355114ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2393/facility-use-slots/20393",
  "modified": 1658486613581,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0666624b-29ad-438b-bab9-8550b65b1f8e
...
---
Response status code: 409 Conflict. Responded in 247.379471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0666624b-29ad-438b-bab9-8550b65b1f8e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:32+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 36.49252ms.
```json
{
  "data": {
    "@context": [
