...
---
Response status code: 200 OK. Responded in 68.577961ms.
```json
{
...
---
Response status code: 200 OK. Responded in 87.632418ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 76.055922ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 98.694208ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 424.772976ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230",
  "modified": 1658486264940,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 424.755177ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2231/events/20231",
  "modified": 1658486264942,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 437.31158ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223",
  "modified": 1658486264955,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 441.941817ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2224/facility-use-slots/20224",
  "modified": 1658486264956,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6713b5a3-e6a5-4318-b6e5-105b398ca704
...
---
Response status code: 200 OK. Responded in 564.330219ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2230%2Fevents%2F20230?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 542.611642ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230",
  "modified": 1658486266559,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2231%2Fevents%2F20231?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 546.406572ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2231/events/20231",
  "modified": 1658486266564,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2223%2Ffacility-use-slots%2F20223?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 438.64699ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223",
  "modified": 1658486266457,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2224%2Ffacility-use-slots%2F20224?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 439.451197ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2224/facility-use-slots/20224",
  "modified": 1658486266459,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6713b5a3-e6a5-4318-b6e5-105b398ca704
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hobart_Jacobi@yahoo.com",
    "telephone": "(206) 405-5090",
    "givenName": "Shields",
    "familyName": "Alvah",
    "identifier": "b6d787b4-dd66-4660-b373-07b867c4725e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 273.985943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 50.417413ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.669706ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.032001ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.704224ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6713b5a3-e6a5-4318-b6e5-105b398ca704
...
---
Response status code: 201 Created. Responded in 356.147815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6713b5a3-e6a5-4318-b6e5-105b398ca704",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1000",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2230#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1001",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2230#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1002",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2231#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1003",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1004",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704#/orderedItems/1005",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2224/facility-use-slots/20224#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6713b5a3-e6a5-4318-b6e5-105b398ca704/versions/055cf581-1b86-4f7b-9dd9-5d28f290971d",
  "payment": {
    "@type": "Payment",
    "identifier": "WhcMLJu8_",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;6713b5a3-e6a5-4318-b6e5-105b398ca704&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/6713b5a3-e6a5-4318-b6e5-105b398ca704


---
Response status code: 200 OK. Responded in 12.036198ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830651437373&afterId=9f81984b-20ff-4c02-8b05-465027804736",
  "message": "Listening for UUID: '6713b5a3-e6a5-4318-b6e5-105b398ca704' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 10.518386ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;6713b5a3-e6a5-4318-b6e5-105b398ca704&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/6713b5a3-e6a5-4318-b6e5-105b398ca704


---
Response status code: 200 OK. Responded in 2371.296909ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "modified": 637940830677626000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/6713b5a3-e6a5-4318-b6e5-105b398ca704",
    "identifier": "6713b5a3-e6a5-4318-b6e5-105b398ca704",
...
---
Response status code: 200 OK. Responded in 6.03375ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704
...
---
Response status code: 201 Created. Responded in 150.20853ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "identifier": "6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 51.252706ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "modified": 637940830702957700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 93.849244ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 83.161859ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 62.199193ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.47045ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;6713b5a3-e6a5-4318-b6e5-105b398ca704&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/6713b5a3-e6a5-4318-b6e5-105b398ca704


---
Response status code: 200 OK. Responded in 10.064679ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '6713b5a3-e6a5-4318-b6e5-105b398ca704' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 278.237805ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessCodeUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;6713b5a3-e6a5-4318-b6e5-105b398ca704&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/6713b5a3-e6a5-4318-b6e5-105b398ca704


---
Response status code: 200 OK. Responded in 2059.084246ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6713b5a3-e6a5-4318-b6e5-105b398ca704",
  "modified": 637940830768686200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
