...
---
Response status code: 200 OK. Responded in 43.050124ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/452/events/4511"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F452%2Fevents%2F4511?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.325808ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/452/events/4511",
    "startDate": "2022-07-27T09:04:11+00:00",
    "endDate": "2022-07-27T14:25:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 1.68,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT22H20M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/138d5360-dc80-4e90-9960-f64e2ccb68e4
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/452/events/4511"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 318.671356ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/138d5360-dc80-4e90-9960-f64e2ccb68e4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:27+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F452%2Fevents%2F4511?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 170.80937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/452/events/4511",
  "modified": 1658487089425,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/138d5360-dc80-4e90-9960-f64e2ccb68e4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Leopoldo76@gmail.com",
    "telephone": "1-520-794-3863 x8652",
    "givenName": "Rolfson",
    "familyName": "Braxton",
    "identifier": "40358713-945e-4087-92d9-822a9a0ab14d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 835.068335ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:29+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 41.366595ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/138d5360-dc80-4e90-9960-f64e2ccb68e4
...
---
Response status code: 201 Created. Responded in 465.967831ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/138d5360-dc80-4e90-9960-f64e2ccb68e4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138d5360-dc80-4e90-9960-f64e2ccb68e4#/orderedItems/3026",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/452#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 10.31178ms.
```json
{
  "data": {
    "@context": [
