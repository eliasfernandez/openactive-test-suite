[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:42:47 GMT+0000 (Coordinated Universal Time)
...
⚠️ 49 passed with 0 failures, 731 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 30.133261ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/769"
}
```
...
---
Response status code: 200 OK. Responded in 29.900755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/597"
}
```
...
---
Response status code: 200 OK. Responded in 30.367566ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555"
}
```
...
---
Response status code: 200 OK. Responded in 39.930808ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F769?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.890525ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/769",
    "startDate": "2022-07-27T14:50:11+00:00",
    "endDate": "2022-07-27T17:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F597?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.927251ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/597",
    "startDate": "2022-07-31T00:04:11+00:00",
    "endDate": "2022-07-31T05:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F656%2Ffacility-use-slots%2F6555?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.670845ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT14H4M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-23T22:44:12+00:00",
    "endDate": "2022-07-24T00:27:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F374%2Ffacility-use-slots%2F3733?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.974453ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT13H41M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-23T22:59:12+00:00",
    "endDate": "2022-07-24T03:38:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/29be1eca-758b-47ea-ae27-226fbb3cbaa6
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/769"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/597"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 586.190796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/29be1eca-758b-47ea-ae27-226fbb3cbaa6",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/656"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-23T22:44:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F769?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 353.671793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/769",
  "modified": 1658486580014,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F597?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 353.080195ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/597",
  "modified": 1658486580015,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F656%2Ffacility-use-slots%2F6555?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 881.972378ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555",
  "modified": 1658486580554,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F374%2Ffacility-use-slots%2F3733?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 883.212859ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733",
  "modified": 1658486580556,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/29be1eca-758b-47ea-ae27-226fbb3cbaa6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Willis_Grady71@yahoo.com",
    "telephone": "1-931-361-9126 x37164",
    "givenName": "Farrell",
    "familyName": "Justice",
    "identifier": "979cf81d-ac71-413c-bbd0-166af91708df"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 390.872222ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:01+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 50.062185ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.610263ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.33295ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.007431ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6
...
---
Response status code: 201 Created. Responded in 999.508311ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1767",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/77#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1768",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/77#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1769",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/60#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1770",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1771",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/656/facility-use-slots/6555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29be1eca-758b-47ea-ae27-226fbb3cbaa6#/orderedItems/1772",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3733#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 31.801914ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.172403ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.669296ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.103386ms.
```json
{
  "data": {
    "@context": [
