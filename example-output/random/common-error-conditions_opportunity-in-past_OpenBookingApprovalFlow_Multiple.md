...
⚠️ 48 passed with 0 failures, 627 warnings and 168 suggestions 
...
---
Response status code: 200 OK. Responded in 21.690941ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1680/events/16797"
}
```
...
---
Response status code: 200 OK. Responded in 18.289987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10554"
}
```
...
---
Response status code: 200 OK. Responded in 19.321904ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1799/facility-use-slots/17985"
}
```
...
---
Response status code: 200 OK. Responded in 27.223328ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1485/facility-use-slots/14846"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1680%2Fevents%2F16797?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.693246ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1680/events/16797",
    "startDate": "2022-07-20T13:18:11+00:00",
    "endDate": "2022-07-20T14:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1680",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1680#/offers/0",
          ...
          "price": 6.05,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT4H37M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1056%2Fevents%2F10554?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.795932ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10554",
    "startDate": "2022-07-25T21:56:11+00:00",
    "endDate": "2022-07-26T03:03:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1799%2Ffacility-use-slots%2F17985?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.01012ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1799/facility-use-slots/17985#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT38M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-21T10:14:12+00:00",
    "endDate": "2022-07-21T14:06:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1485%2Ffacility-use-slots%2F14846?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.048705ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1485/facility-use-slots/14846#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT5H29M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-23T14:06:12+00:00",
    "endDate": "2022-07-23T18:55:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0f0d4f99-ab78-4578-a91d-425860241bbc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1680#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1680/events/16797"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10554"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1799/facility-use-slots/17985#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1799/facility-use-slots/17985"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1485/facility-use-slots/14846#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1485/facility-use-slots/14846"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 112.044462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0f0d4f99-ab78-4578-a91d-425860241bbc",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1680"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0f0d4f99-ab78-4578-a91d-425860241bbc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elfrieda89@yahoo.com",
    "telephone": "405.885.7166 x13465",
    "givenName": "Boyle",
    "familyName": "Eino",
    "identifier": "ed0809e1-e197-4ad8-a8d0-a27e002a0520"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 50.928933ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0f0d4f99-ab78-4578-a91d-425860241bbc
...
---
Response status code: 409 Conflict. Responded in 182.358125ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/0f0d4f99-ab78-4578-a91d-425860241bbc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
