...
---
Response status code: 200 OK. Responded in 23.126709ms.
```json
{
...
---
Response status code: 200 OK. Responded in 659.977869ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2520/facility-use-slots/20520",
  "modified": 1658486895813,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:48:14+00:00",
    "endDate": "2022-07-23T11:48:14+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fea49c15-6850-45d5-9203-51391c38d3a3
...
---
Response status code: 200 OK. Responded in 299.221606ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fea49c15-6850-45d5-9203-51391c38d3a3",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2520%2Ffacility-use-slots%2F20520?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1145.308979ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2520/facility-use-slots/20520",
  "modified": 1658486897387,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fea49c15-6850-45d5-9203-51391c38d3a3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Catharine_Reichert48@hotmail.com",
    "telephone": "239.583.2768 x002",
    "givenName": "Hahn",
    "familyName": "Sigrid",
    "identifier": "69a6dfa6-b253-403f-a249-49b9dbad581c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 340.035383ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 23.15041ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fea49c15-6850-45d5-9203-51391c38d3a3
...
---
Response status code: 400 Bad Request. Responded in 858.799288ms.
```json
{
  "@context": "https://openactive.io/",
