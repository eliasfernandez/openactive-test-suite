...
---
Response status code: 200 OK. Responded in 39.156556ms.
```json
{
...
---
Response status code: 200 OK. Responded in 761.927119ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2468/facility-use-slots/20468",
  "modified": 1658486790099,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:46:28+00:00",
    "endDate": "2022-07-23T11:46:28+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/674c3e25-c03c-47f1-bece-c097bde18c97
...
---
Response status code: 200 OK. Responded in 430.652611ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/674c3e25-c03c-47f1-bece-c097bde18c97",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2468%2Ffacility-use-slots%2F20468?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 769.723089ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2468/facility-use-slots/20468",
  "modified": 1658486791509,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/674c3e25-c03c-47f1-bece-c097bde18c97
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "1-310-239-1785 x917",
    "givenName": "Terry",
    "familyName": "Stephan",
    "identifier": "09c4e320-9966-4cf9-8bd8-a458cb8590e4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 263.866796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.293475ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/674c3e25-c03c-47f1-bece-c097bde18c97
...
---
Response status code: 201 Created. Responded in 674.444202ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/674c3e25-c03c-47f1-bece-c097bde18c97",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/674c3e25-c03c-47f1-bece-c097bde18c97#/orderedItems/2571",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2468/facility-use-slots/20468#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 37.119834ms.
```json
{
  "data": {
    "@context": [
