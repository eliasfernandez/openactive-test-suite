...
---
Response status code: 200 OK. Responded in 12.292917ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14095"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1410%2Ffacility-use-slots%2F14095?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.183979ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14095#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT4H14M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-30T01:40:12+00:00",
    "endDate": "2022-07-30T02:54:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/686f7c5d-d242-4ea9-ac0b-805883e94285
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14095#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14095"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 33.220886ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/686f7c5d-d242-4ea9-ac0b-805883e94285
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Torey.Pfeffer69@yahoo.com",
    "telephone": "745-286-0006 x3309",
    "givenName": "Rosenbaum",
    "familyName": "Geraldine",
    "identifier": "f106c865-32d4-4093-bddf-93d8dda83a0e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 38.921986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
