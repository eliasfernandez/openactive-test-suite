...
---
Response status code: 200 OK. Responded in 49.82375ms.
```json
{
...
---
Response status code: 200 OK. Responded in 419.561494ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2530/events/20530",
  "modified": 1658486892364,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/42e2bc80-05a4-4eff-8f93-cdd96fd71417
...
---
Response status code: 200 OK. Responded in 468.592239ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/42e2bc80-05a4-4eff-8f93-cdd96fd71417",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2530%2Fevents%2F20530?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 241.532085ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2530/events/20530",
  "modified": 1658486893481,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/42e2bc80-05a4-4eff-8f93-cdd96fd71417
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Salvatore.Metz94@hotmail.com",
    "telephone": "804.674.2130 x3634",
    "givenName": "Hammes",
    "familyName": "Jerry",
    "identifier": "fc71b297-0fd3-44a0-88fb-ad7e2ac88ffd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 521.360515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.576168ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/42e2bc80-05a4-4eff-8f93-cdd96fd71417
...
---
Response status code: 400 Bad Request. Responded in 691.108751ms.
```json
{
  "@context": "https://openactive.io/",
