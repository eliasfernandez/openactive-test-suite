...
---
Response status code: 200 OK. Responded in 11.707242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F98%2Ffacility-use-slots%2F980?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.735277ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/98",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2022-07-28T15:03:11+00:00",
    "endDate": "2022-07-28T16:28:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 985.621254ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F98%2Ffacility-use-slots%2F980?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 916.932036ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980",
  "modified": 1658486890748,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Camille_Olson6@yahoo.com",
    "telephone": "1-678-360-8896",
    "givenName": "Funk",
    "familyName": "Betsy",
    "identifier": "cbeeb661-59a4-45f7-9e65-3fe8da071456"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 286.706121ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 21.821651ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95
...
---
Response status code: 201 Created. Responded in 525.151345ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c9fbb54-323b-4bfb-9f31-7d196fcd9c95#/orderedItems/2572",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/98/facility-use-slots/980#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 33.900897ms.
```json
{
  "data": {
    "@context": [
