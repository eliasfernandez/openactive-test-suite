...
⚠️ 18 passed with 0 failures, 191 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 7.092815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10450"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1045%2Fevents%2F10450?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.862027ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10450",
    "startDate": "2022-07-31T06:43:11+00:00",
    "endDate": "2022-07-31T09:25:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1045",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1045#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7d8c5ddd-1893-41bf-8a6c-cd803258d187
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1045#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10450"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 81.497021ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1045"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1045%2Fevents%2F10450?useCacheIfAvailable=true&expectedCapacity=37


---
Response status code: 200 OK. Responded in 102.103855ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1045/events/10450",
  "modified": 1658486239142,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7d8c5ddd-1893-41bf-8a6c-cd803258d187
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bettye.Rogahn@yahoo.com",
    "telephone": "755.593.6431 x476",
    "givenName": "Kuphal",
    "familyName": "Reed",
    "identifier": "210b6f39-6d5a-46d1-bb1a-8ae16055bc8e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 105.989918ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:18+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 41.540973ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7d8c5ddd-1893-41bf-8a6c-cd803258d187
...
---
Response status code: 201 Created. Responded in 46.83936ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d8c5ddd-1893-41bf-8a6c-cd803258d187#/orderedItems/787",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1045#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/7d8c5ddd-1893-41bf-8a6c-cd803258d187/versions/b78bee6b-41f4-4cfe-ab06-e927592b838e",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;7d8c5ddd-1893-41bf-8a6c-cd803258d187&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/7d8c5ddd-1893-41bf-8a6c-cd803258d187


---
Response status code: 200 OK. Responded in 3.71146ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830331307208&afterId=bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "message": "Listening for UUID: '7d8c5ddd-1893-41bf-8a6c-cd803258d187' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 29.139272ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;7d8c5ddd-1893-41bf-8a6c-cd803258d187&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/7d8c5ddd-1893-41bf-8a6c-cd803258d187


---
Response status code: 200 OK. Responded in 2158.579994ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "modified": 637940830398006100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/7d8c5ddd-1893-41bf-8a6c-cd803258d187",
    "identifier": "7d8c5ddd-1893-41bf-8a6c-cd803258d187",
...
---
Response status code: 200 OK. Responded in 14.073528ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7d8c5ddd-1893-41bf-8a6c-cd803258d187
...
---
Response status code: 201 Created. Responded in 73.021884ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "identifier": "7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 818.917197ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "modified": 637940830420508700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.417966ms.
```json
{
  "data": {
    "@context": [
