...
---
Response status code: 200 OK. Responded in 22.649306ms.
```json
{
...
---
Response status code: 200 OK. Responded in 509.582627ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544",
  "modified": 1658486958872,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/14e1360a-fc8f-4ff8-9408-5da458235879
...
---
Response status code: 400 Bad Request. Responded in 45.950117ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/14e1360a-fc8f-4ff8-9408-5da458235879
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sherman.Bogisich@gmail.com",
    "telephone": "(899) 258-7840 x8377",
    "givenName": "Champlin",
    "familyName": "Floyd",
    "identifier": "8acb8c8d-1c3a-4127-b881-7beda2eb126d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 45.06091ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
