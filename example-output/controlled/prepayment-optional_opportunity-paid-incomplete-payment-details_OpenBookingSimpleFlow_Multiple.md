...
---
Response status code: 200 OK. Responded in 468.754834ms.
```json
{
...
---
Response status code: 200 OK. Responded in 417.546072ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 830.450203ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2511/events/20511",
  "modified": 1658486854982,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2511/events/20511",
    "startDate": "2022-07-23T10:47:33+00:00",
    "endDate": "2022-07-23T11:47:33+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 729.643292ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2497/facility-use-slots/20497",
  "modified": 1658486854883,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aca65098-a21d-41aa-b4ae-2e15512639a6
...
---
Response status code: 200 OK. Responded in 782.530369ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aca65098-a21d-41aa-b4ae-2e15512639a6",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2511%2Fevents%2F20511?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 566.972927ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2511/events/20511",
  "modified": 1658486856994,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2497%2Ffacility-use-slots%2F20497?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 592.874761ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2497/facility-use-slots/20497",
  "modified": 1658486857021,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aca65098-a21d-41aa-b4ae-2e15512639a6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Antwon28@yahoo.com",
    "telephone": "(898) 785-0116",
    "givenName": "Leuschke",
    "familyName": "Jamie",
    "identifier": "765176b6-094f-4ba8-8143-6a1ae56797bd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 987.336229ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.660387ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.749879ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/aca65098-a21d-41aa-b4ae-2e15512639a6
...
---
Response status code: 400 Bad Request. Responded in 619.731705ms.
```json
{
  "@context": "https://openactive.io/",
