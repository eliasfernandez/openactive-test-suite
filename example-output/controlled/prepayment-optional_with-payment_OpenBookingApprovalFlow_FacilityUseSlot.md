...
---
Response status code: 200 OK. Responded in 520.729918ms.
```json
{
...
---
Response status code: 200 OK. Responded in 775.006422ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2536/facility-use-slots/20536",
  "modified": 1658486934584,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:48:52+00:00",
    "endDate": "2022-07-23T11:48:52+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1
...
---
Response status code: 200 OK. Responded in 479.283143ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2536%2Ffacility-use-slots%2F20536?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 558.218758ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2536/facility-use-slots/20536",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jacinthe_Rath@hotmail.com",
    "telephone": "317-690-3157 x47487",
    "givenName": "Satterfield",
    "familyName": "Marianne",
    "identifier": "9b7496e9-af73-4724-b9f7-eddd655d449c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 737.23428ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.53195ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1
...
---
Response status code: 201 Created. Responded in 368.41724ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1#/orderedItems/2967",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2536/facility-use-slots/20536#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1/versions/eb1fa6cf-8c84-413c-aba5-1452644727b0",
  "payment": {
    "@type": "Payment",
    "identifier": "T6Pua-JlW",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a6f39b36-aeb0-4193-aaa4-a026bf89c2d1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1


---
Response status code: 200 OK. Responded in 23.225811ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'a6f39b36-aeb0-4193-aaa4-a026bf89c2d1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 583.366489ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a6f39b36-aeb0-4193-aaa4-a026bf89c2d1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1


---
Response status code: 200 OK. Responded in 1709.103296ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "modified": 637940837362711400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
    "identifier": "a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
...
---
Response status code: 200 OK. Responded in 19.190074ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940837362711453&afterId=a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "message": "Listening for UUID: 'a6f39b36-aeb0-4193-aaa4-a026bf89c2d1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1
...
---
Response status code: 201 Created. Responded in 206.612373ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "identifier": "a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1330.7132649999999ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a6f39b36-aeb0-4193-aaa4-a026bf89c2d1",
  "modified": 637940837386208000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.826843ms.
```json
{
  "data": {
    "@context": [
