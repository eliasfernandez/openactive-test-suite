...
---
Response status code: 200 OK. Responded in 12.812635ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F352%2Ffacility-use-slots%2F3514?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.863907ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/352",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT11H52M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-27T23:53:12+00:00",
    "endDate": "2022-07-28T03:44:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6a48c800-c2f8-499a-aa4e-1bb8a9d62205
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514",
      "attendee": {
        "@type": "Person",
...
---
Response status code: 200 OK. Responded in 300.918815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6a48c800-c2f8-499a-aa4e-1bb8a9d62205",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F352%2Ffacility-use-slots%2F3514?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1569.805674ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514",
  "modified": 1658486823358,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6a48c800-c2f8-499a-aa4e-1bb8a9d62205
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Johann_Tromp@yahoo.com",
    "telephone": "1-865-204-8590 x201",
    "givenName": "Walter",
    "familyName": "Maynard",
    "identifier": "84592b40-c399-4133-b5a3-65352115d4d9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 185.938108ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.101769ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6a48c800-c2f8-499a-aa4e-1bb8a9d62205
...
---
Response status code: 201 Created. Responded in 433.128139ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6a48c800-c2f8-499a-aa4e-1bb8a9d62205",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6a48c800-c2f8-499a-aa4e-1bb8a9d62205#/orderedItems/2368",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/352/facility-use-slots/3514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 9.569714ms.
```json
{
  "data": {
    "@context": [
