...
---
Response status code: 200 OK. Responded in 13.463052ms.
```json
{
...
---
Response status code: 200 OK. Responded in 3.832372ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 5,
    "startDate": "2022-07-23T05:59:12+00:00",
    "endDate": "2022-07-23T06:59:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2e713559-6324-478b-8306-9e4efd84cecc
...
---
Response status code: 200 OK. Responded in 507.159391ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2e713559-6324-478b-8306-9e4efd84cecc",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1224%2Ffacility-use-slots%2F12239?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 1069.638831ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1224/facility-use-slots/12239",
  "modified": 1658486850253,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2e713559-6324-478b-8306-9e4efd84cecc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ruthe_Shields10@gmail.com",
    "telephone": "(972) 392-1536 x650",
    "givenName": "Homenick",
    "familyName": "Isabell",
    "identifier": "50ead88f-35e7-4851-8d32-aa8006ae346b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 663.620816ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:29+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 17.330072ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2e713559-6324-478b-8306-9e4efd84cecc
...
---
Response status code: 400 Bad Request. Responded in 297.964084ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (9.16) does not match expected value (8.16)"
}
```
### Specs
