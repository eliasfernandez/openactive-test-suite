...
⚠️ 26 passed with 0 failures, 183 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 146.238791ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12812"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1282%2Fevents%2F12812?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 38.235804ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12812",
    "startDate": "2022-07-24T19:26:11+00:00",
    "endDate": "2022-07-24T20:29:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9cb01f6b-c7a9-4d51-be82-1da464b99929
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12812"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 370.365515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:37:45+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1282%2Fevents%2F12812?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 3.972273ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9cb01f6b-c7a9-4d51-be82-1da464b99929
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gudrun87@yahoo.com",
    "telephone": "969-404-4165 x38319",
    "givenName": "Wiegand",
    "familyName": "Enrique",
    "identifier": "7a1d4f72-94b9-4646-b3a3-af6d42369fdb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 194.171474ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:37:46+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 10.527293ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929
...
---
Response status code: 201 Created. Responded in 386.276208ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9cb01f6b-c7a9-4d51-be82-1da464b99929#/orderedItems/10",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929/versions/94d83a65-fac9-4ce1-9cd8-3bd10bd2b183",
  "payment": {
    "@type": "Payment",
    "identifier": "7Hb8vAnzy",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9cb01f6b-c7a9-4d51-be82-1da464b99929&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9cb01f6b-c7a9-4d51-be82-1da464b99929


---
Response status code: 200 OK. Responded in 13.348545ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '9cb01f6b-c7a9-4d51-be82-1da464b99929' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 722.444194ms.
### Specs
* ✅ should return 204 on success

## Order Feed Update (after Simulate Seller Amendment)

### Orders (order-proposals) Feed collect for &#x27;9cb01f6b-c7a9-4d51-be82-1da464b99929&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9cb01f6b-c7a9-4d51-be82-1da464b99929


---
Response status code: 200 OK. Responded in 2592.416595ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "modified": 637940827691129200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929",
    "identifier": "9cb01f6b-c7a9-4d51-be82-1da464b99929",
    "orderProposalStatus": "https://openactive.io/AwaitingSellerConfirmation",
    "orderedItem": [
      {
        "@type": "OrderItem",
    ...
    "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929/versions/24032ac2-59ee-4363-ae60-f5cd4d0c53d3",
    "totalPaymentDue": {
      "@type": "PriceSpecification",
      "openBookingPrepayment": "https://openactive.io/Required",
      "price": 13.42,
...
---
Response status code: 200 OK. Responded in 9.507797ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940827691129255&afterId=9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "message": "Listening for UUID: '9cb01f6b-c7a9-4d51-be82-1da464b99929' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 51.948079ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2078.9331ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "modified": 637940827718607400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9cb01f6b-c7a9-4d51-be82-1da464b99929",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9cb01f6b-c7a9-4d51-be82-1da464b99929
...
---
Response status code: 500 Internal Server Error. Responded in 94.360261ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 201 Created. Responded in 399.167895ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "identifier": "9cb01f6b-c7a9-4d51-be82-1da464b99929",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 8.141269ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.477608ms.
```json
{
  "data": {
    "@context": [
