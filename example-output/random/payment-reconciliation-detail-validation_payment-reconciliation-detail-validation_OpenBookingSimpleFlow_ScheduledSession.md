...
---
Response status code: 200 OK. Responded in 93.367564ms.
```json
{
...
---
Response status code: 200 OK. Responded in 11.067573ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4674",
    "startDate": "2022-07-23T05:14:11+00:00",
    "endDate": "2022-07-23T08:27:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c3127c5b-aa3a-497b-a114-6e37a9fe3c80
...
---
Response status code: 200 OK. Responded in 460.215717ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c3127c5b-aa3a-497b-a114-6e37a9fe3c80",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:36+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F468%2Fevents%2F4674?useCacheIfAvailable=true&expectedCapacity=20


---
Response status code: 200 OK. Responded in 637.844602ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4674",
  "modified": 1658487158911,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c3127c5b-aa3a-497b-a114-6e37a9fe3c80
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Verdie82@hotmail.com",
    "telephone": "(370) 627-4913",
    "givenName": "Kohler",
    "familyName": "Carole",
    "identifier": "ad565cb0-b135-4548-a091-da90e3da629b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 389.379706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 32.942117ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c3127c5b-aa3a-497b-a114-6e37a9fe3c80
...
---
Response status code: 201 Created. Responded in 596.680157ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c3127c5b-aa3a-497b-a114-6e37a9fe3c80",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3127c5b-aa3a-497b-a114-6e37a9fe3c80#/orderedItems/3179",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 18.471715ms.
```json
{
  "data": {
    "@context": [
