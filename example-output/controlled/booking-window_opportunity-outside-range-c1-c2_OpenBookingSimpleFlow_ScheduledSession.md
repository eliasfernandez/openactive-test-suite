...
---
Response status code: 200 OK. Responded in 34.101679ms.
```json
{
...
---
Response status code: 200 OK. Responded in 503.680223ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2232/events/20232",
  "modified": 1658486270192,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b1b6fca8-db93-41e8-b7ba-71a6e6741d6f
...
---
Response status code: 409 Conflict. Responded in 24.275399ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b1b6fca8-db93-41e8-b7ba-71a6e6741d6f",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b1b6fca8-db93-41e8-b7ba-71a6e6741d6f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brooke_Jakubowski25@hotmail.com",
    "telephone": "1-507-785-8074",
    "givenName": "Kutch",
    "familyName": "Archibald",
    "identifier": "d87df697-df41-4864-af28-ed6561ace777"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 26.495117ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
