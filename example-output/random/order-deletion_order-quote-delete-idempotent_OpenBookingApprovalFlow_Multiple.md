[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:17 GMT+0000 (Coordinated Universal Time)
...
⚠️ 44 passed with 0 failures, 530 warnings and 144 suggestions 
...
---
Response status code: 200 OK. Responded in 65.118465ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13064"
}
```
...
---
Response status code: 200 OK. Responded in 65.891285ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10557"
}
```
...
---
Response status code: 200 OK. Responded in 65.399172ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11171"
}
```
...
---
Response status code: 200 OK. Responded in 66.336996ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14382"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1307%2Fevents%2F13064?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.274416ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13064",
    "startDate": "2022-07-23T20:30:11+00:00",
    "endDate": "2022-07-24T00:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1056%2Fevents%2F10557?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.349792ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10557",
    "startDate": "2022-07-23T14:41:11+00:00",
    "endDate": "2022-07-23T20:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1056",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1056#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1118%2Ffacility-use-slots%2F11171?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.548195ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1118",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11171#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-26T22:56:12+00:00",
    "endDate": "2022-07-27T03:29:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1439%2Ffacility-use-slots%2F14382?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.914479ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14382#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT7H29M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-28T20:22:12+00:00",
    "endDate": "2022-07-28T23:42:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cddc5d89-22c8-4a9d-9221-7f518a33403d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13064"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1056#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10557"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11171#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11171"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14382#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14382"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1198.346765ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cddc5d89-22c8-4a9d-9221-7f518a33403d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:47+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1056"
        },
        "maximumAttendeeCapacity": 29,
        "remainingAttendeeCapacity": 29
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1307%2Fevents%2F13064?useCacheIfAvailable=true&expectedCapacity=30


---
Response status code: 200 OK. Responded in 38.800238ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1056%2Fevents%2F10557?useCacheIfAvailable=true&expectedCapacity=28


---
Response status code: 200 OK. Responded in 37.803014ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1118%2Ffacility-use-slots%2F11171?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 648.783182ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1118/facility-use-slots/11171",
  "modified": 1658486750711,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1439%2Ffacility-use-slots%2F14382?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 644.407776ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14382",
  "modified": 1658486750712,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cddc5d89-22c8-4a9d-9221-7f518a33403d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alvis_Cummerata@hotmail.com",
    "telephone": "818-703-4091 x533",
    "givenName": "Sauer",
    "familyName": "Garret",
    "identifier": "3e4da4c2-ec67-4201-ae4f-cf6a51797ea9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1386.097804ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:52+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 37.413604ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 39.058544ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 38.661635ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 38.324127ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/cddc5d89-22c8-4a9d-9221-7f518a33403d
...
---
Response status code: 204 No Content. Responded in 549.222384ms.
...
---
Response status code: 204 No Content. Responded in 17.637066ms.
### Specs
