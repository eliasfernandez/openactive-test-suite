...
⚠️ 9 passed with 0 failures, 118 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 150.43939ms.
```json
{
...
---
Response status code: 200 OK. Responded in 325.944779ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177",
  "modified": 1658486199227,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177",
    "startDate": "2022-07-23T10:36:37+00:00",
    "endDate": "2022-07-23T11:36:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/14af8912-2a33-4d63-b8df-de2a39285f97
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2177#/offers/0",
...
---
Response status code: 200 OK. Responded in 35.803868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/14af8912-2a33-4d63-b8df-de2a39285f97",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2177%2Fevents%2F20177?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 701.779638ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177",
  "modified": 1658486200112,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/14af8912-2a33-4d63-b8df-de2a39285f97
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jean.Erdman@yahoo.com",
    "telephone": "(893) 310-5989 x398",
    "givenName": "Jenkins",
    "familyName": "Casandra",
    "identifier": "58d26b8d-9b10-4147-891f-c1d1b15f43db"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 28.141318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/14af8912-2a33-4d63-b8df-de2a39285f97
...
---
Response status code: 409 Conflict. Responded in 98.992267ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/14af8912-2a33-4d63-b8df-de2a39285f97",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
