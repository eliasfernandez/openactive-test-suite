...
---
Response status code: 200 OK. Responded in 24.111917ms.
```json
{
...
---
Response status code: 200 OK. Responded in 850.527672ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491",
  "modified": 1658486812074,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491",
    "startDate": "2022-07-23T10:46:50+00:00",
    "endDate": "2022-07-23T11:46:50+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/68f656cc-a156-4a57-a444-be6a52c505e3
...
---
Response status code: 200 OK. Responded in 360.954856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/68f656cc-a156-4a57-a444-be6a52c505e3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:51+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/68f656cc-a156-4a57-a444-be6a52c505e3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jena.Lehner59@yahoo.com",
    "telephone": "(276) 584-8082 x9442",
    "givenName": "Schmidt",
    "familyName": "Cesar",
    "identifier": "348698d3-0271-41c2-930f-b88750a73405"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 568.78073ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2491%2Fevents%2F20491?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 164.13938ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491",
  "modified": 1658486813761,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 295.721467ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/130b3edf-8fff-4b00-bd3b-2de97b92d976
...
---
Response status code: 409 Conflict. Responded in 448.113642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/130b3edf-8fff-4b00-bd3b-2de97b92d976",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/130b3edf-8fff-4b00-bd3b-2de97b92d976
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dimitri_West@yahoo.com",
    "telephone": "447-732-7491 x23405",
    "givenName": "Torp",
    "familyName": "Geovanni",
    "identifier": "b8e0878d-04a8-43b5-b448-815e98adabe9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 141.980181ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 35.209117ms.
```json
{
  "data": {
    "@context": [
