[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:40:36 GMT+0000 (Coordinated Universal Time)
...
⚠️ 54 passed with 0 failures, 515 warnings and 138 suggestions 
...
---
Response status code: 200 OK. Responded in 18.737789ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2203"
}
```
...
---
Response status code: 200 OK. Responded in 18.549186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/269/events/2688"
}
```
...
---
Response status code: 200 OK. Responded in 20.10261ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2449"
}
```
...
---
Response status code: 200 OK. Responded in 20.76292ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5058"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F221%2Fevents%2F2203?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.180326ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2203",
    "startDate": "2022-07-23T20:28:11+00:00",
    "endDate": "2022-07-23T22:26:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/221",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/221#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F269%2Fevents%2F2688?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.79042ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/269/events/2688",
    "startDate": "2022-07-25T17:01:11+00:00",
    "endDate": "2022-07-25T23:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/269",
      "name": "Metal Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/269#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F245%2Ffacility-use-slots%2F2449?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.381014ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2449#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-27T10:17:12+00:00",
    "endDate": "2022-07-27T12:31:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F506%2Ffacility-use-slots%2F5058?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.227058ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5058#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 12.63,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT8H25M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-28T14:09:12+00:00",
    "endDate": "2022-07-28T19:57:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b5200c48-ce8a-41f6-be41-078b874f5dd0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/221#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2203"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/269#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/269/events/2688"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2449#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2449"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5058#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5058"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 568.897742ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b5200c48-ce8a-41f6-be41-078b874f5dd0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:42+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/269"
        },
        "maximumAttendeeCapacity": 43,
        "remainingAttendeeCapacity": 43
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F221%2Fevents%2F2203?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 166.703507ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2203",
  "modified": 1658486444579,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F269%2Fevents%2F2688?useCacheIfAvailable=true&expectedCapacity=42


---
Response status code: 200 OK. Responded in 167.294216ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/269/events/2688",
  "modified": 1658486444580,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F245%2Ffacility-use-slots%2F2449?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 792.51452ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/245/facility-use-slots/2449",
  "modified": 1658486445207,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F506%2Ffacility-use-slots%2F5058?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 796.45778ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5058",
  "modified": 1658486445208,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b5200c48-ce8a-41f6-be41-078b874f5dd0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vicky67@hotmail.com",
    "telephone": "1-243-888-8668 x94216",
    "givenName": "Bauch",
    "familyName": "Colby",
    "identifier": "2d4e687e-2148-40cd-b3ab-38bba62a73b6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 380.393222ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.387201ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.775492ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.275885ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.727476ms.
```json
{
  "data": {
    "@context": [
