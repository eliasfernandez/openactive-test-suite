...
---
Response status code: 200 OK. Responded in 14.096758ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1470/events/14693"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1470%2Fevents%2F14693?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.654977ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1470/events/14693",
    "startDate": "2022-07-29T13:34:11+00:00",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT20H52M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1470/events/14693"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 340.964858ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1470%2Fevents%2F14693?useCacheIfAvailable=true&expectedCapacity=46


---
Response status code: 200 OK. Responded in 929.846105ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1470/events/14693",
  "modified": 1658486826391,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Abby49@gmail.com",
    "telephone": "(689) 265-3282",
    "givenName": "Kling",
    "familyName": "Dock",
    "identifier": "ad4ef6d5-5c1a-4404-b797-f2ffd39c3784"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 433.951863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 15.083836ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d
...
---
Response status code: 201 Created. Responded in 637.763756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d#/orderedItems/2381",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1470#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d/versions/a6f58bb6-229d-4270-b490-fdbecdd4c294",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;30d25f91-43c2-4b3c-9149-36ccbd6a2a3d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d


---
Response status code: 200 OK. Responded in 50.70617ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836165925127&afterId=c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "message": "Listening for UUID: '30d25f91-43c2-4b3c-9149-36ccbd6a2a3d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 120.341239ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;30d25f91-43c2-4b3c-9149-36ccbd6a2a3d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d


---
Response status code: 200 OK. Responded in 2260.912405ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "modified": 637940836293849700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
    "identifier": "30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
...
---
Response status code: 200 OK. Responded in 32.70329ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836293849686&afterId=30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "message": "Listening for UUID: '30d25f91-43c2-4b3c-9149-36ccbd6a2a3d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d
...
---
Response status code: 201 Created. Responded in 249.400763ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "identifier": "30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 548.845981ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "30d25f91-43c2-4b3c-9149-36ccbd6a2a3d",
  "modified": 637940836318443000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.845323ms.
```json
{
  "data": {
    "@context": [
