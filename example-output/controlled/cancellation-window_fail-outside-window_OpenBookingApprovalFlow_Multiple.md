...
---
Response status code: 200 OK. Responded in 48.405416ms.
```json
{
...
---
Response status code: 200 OK. Responded in 120.515937ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 50.310933ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 41.237655ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 960.109762ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2363/events/20363",
  "modified": 1658486494140,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2363/events/20363",
    "startDate": "2022-07-23T10:41:32+00:00",
    "endDate": "2022-07-23T11:41:32+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 959.84616ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2364/events/20364",
  "modified": 1658486494142,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 388.284441ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2351/facility-use-slots/20351",
  "modified": 1658486493572,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 386.005721ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2350/facility-use-slots/20350",
  "modified": 1658486493571,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b815de18-542e-4957-8ab8-b54fae7a88ee
...
---
Response status code: 200 OK. Responded in 347.660992ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b815de18-542e-4957-8ab8-b54fae7a88ee",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:33+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2363%2Fevents%2F20363?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 21.914189ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2364%2Fevents%2F20364?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 16.26194ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2351%2Ffacility-use-slots%2F20351?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 14.933828ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2350%2Ffacility-use-slots%2F20350?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 14.415624ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b815de18-542e-4957-8ab8-b54fae7a88ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Yazmin.Keeling@yahoo.com",
    "telephone": "1-932-925-8772 x798",
    "givenName": "Haley",
    "familyName": "Jesus",
    "identifier": "7d0534e8-eac0-4ca4-9426-a8767492baa6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 547.91382ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 48.415517ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 46.818003ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 37.564723ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 36.466114ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b815de18-542e-4957-8ab8-b54fae7a88ee
...
---
Response status code: 201 Created. Responded in 840.422839ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b815de18-542e-4957-8ab8-b54fae7a88ee",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1736",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2363#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1737",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2363#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1738",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2364#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1739",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2351/facility-use-slots/20351#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1740",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2351/facility-use-slots/20351#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee#/orderedItems/1741",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2350/facility-use-slots/20350#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b815de18-542e-4957-8ab8-b54fae7a88ee/versions/622e7d69-c037-4254-9450-f9190e7e81d2",
  "payment": {
    "@type": "Payment",
    "identifier": "8_SGdESG9",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b815de18-542e-4957-8ab8-b54fae7a88ee&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b815de18-542e-4957-8ab8-b54fae7a88ee


---
Response status code: 200 OK. Responded in 23.023998ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832913314148&afterId=00d9161f-30af-49cc-a35a-a5ca2be7f187",
  "message": "Listening for UUID: 'b815de18-542e-4957-8ab8-b54fae7a88ee' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 30.16456ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b815de18-542e-4957-8ab8-b54fae7a88ee&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b815de18-542e-4957-8ab8-b54fae7a88ee


---
Response status code: 200 OK. Responded in 2366.825789ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b815de18-542e-4957-8ab8-b54fae7a88ee",
  "modified": 637940832977619300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b815de18-542e-4957-8ab8-b54fae7a88ee",
    "identifier": "b815de18-542e-4957-8ab8-b54fae7a88ee",
...
---
Response status code: 200 OK. Responded in 18.763562ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832980986270&afterId=860b620f-e42f-4b13-a66b-b71036794ea9",
  "message": "Listening for UUID: 'b815de18-542e-4957-8ab8-b54fae7a88ee' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee
...
---
Response status code: 201 Created. Responded in 466.892522ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee",
  "identifier": "b815de18-542e-4957-8ab8-b54fae7a88ee",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 12.384909ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b815de18-542e-4957-8ab8-b54fae7a88ee",
  "modified": 637940833003145600
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 19.511272ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.081759ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.144951ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.277222ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/b815de18-542e-4957-8ab8-b54fae7a88ee
...
---
Response status code: 400 Bad Request. Responded in 30.963772ms.
```json
{
  "@context": "https://openactive.io/",
