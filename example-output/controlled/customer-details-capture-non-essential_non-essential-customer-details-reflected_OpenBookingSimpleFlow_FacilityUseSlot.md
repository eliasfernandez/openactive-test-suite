...
---
Response status code: 200 OK. Responded in 16.898633ms.
```json
{
...
---
Response status code: 200 OK. Responded in 405.930976ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2148/facility-use-slots/20148",
  "modified": 1658486176352,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:36:14+00:00",
    "endDate": "2022-07-23T11:36:14+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/191d424a-8415-447e-ad5a-61ce543253ee
...
---
Response status code: 200 OK. Responded in 80.053027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/191d424a-8415-447e-ad5a-61ce543253ee",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:15+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2148%2Ffacility-use-slots%2F20148?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1075.340314ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2148/facility-use-slots/20148",
  "modified": 1658486177713,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/191d424a-8415-447e-ad5a-61ce543253ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Filomena24@hotmail.com",
    "telephone": "720.699.1087",
    "givenName": "Rolfson",
    "familyName": "Duane",
    "identifier": "cf0fbdf9-bd34-4bc6-a257-ec5fbe41d272"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 74.720084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 23.406283ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/191d424a-8415-447e-ad5a-61ce543253ee
...
---
Response status code: 201 Created. Responded in 111.952776ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/191d424a-8415-447e-ad5a-61ce543253ee",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/191d424a-8415-447e-ad5a-61ce543253ee#/orderedItems/722",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2148/facility-use-slots/20148#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 9.793377ms.
```json
{
  "data": {
    "@context": [
