...
⚠️ 19 passed with 0 failures, 187 warnings and 66 suggestions 
...
---
Response status code: 200 OK. Responded in 36.628809ms.
```json
{
...
---
Response status code: 200 OK. Responded in 823.672938ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332",
  "modified": 1658486433867,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332",
    "startDate": "2022-07-23T10:40:32+00:00",
    "endDate": "2022-07-23T11:40:32+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8539c46b-7565-4e68-b69a-e4fee828720e
...
---
Response status code: 200 OK. Responded in 416.401507ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8539c46b-7565-4e68-b69a-e4fee828720e",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2332%2Fevents%2F20332?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 492.468148ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8539c46b-7565-4e68-b69a-e4fee828720e
...
---
Response status code: 400 Bad Request. Responded in 109.018419ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 11.424496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 719.282959ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333",
  "modified": 1658486436026,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333",
    "startDate": "2022-07-23T10:40:34+00:00",
    "endDate": "2022-07-23T11:40:34+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6738de2e-f753-486d-85d9-dc26ef40aa67
...
---
Response status code: 200 OK. Responded in 116.468882ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6738de2e-f753-486d-85d9-dc26ef40aa67",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:35+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2333%2Fevents%2F20333?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 232.132855ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333",
  "modified": 1658486436585,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6738de2e-f753-486d-85d9-dc26ef40aa67
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nichole.Kuhn69@gmail.com",
    "telephone": "1-937-966-4841",
    "givenName": "Goyette",
    "familyName": "Mackenzie",
    "identifier": "6e970b42-6508-45b9-b701-bbf53caa7048"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 134.057529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 23.763ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6738de2e-f753-486d-85d9-dc26ef40aa67
...
---
Response status code: 400 Bad Request. Responded in 218.380539ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
