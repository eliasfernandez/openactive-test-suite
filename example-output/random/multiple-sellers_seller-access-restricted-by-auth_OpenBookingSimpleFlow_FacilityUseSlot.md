[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:40 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 4.958278ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5502"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F551%2Ffacility-use-slots%2F5502?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.239283ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5502#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT1H28M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-29T11:14:12+00:00",
    "endDate": "2022-07-29T13:30:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0d64a5c6-52fe-4378-86f5-79bb0e4ae154
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5502#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5502"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 401 Unauthorized. Responded in 25.535401ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0d64a5c6-52fe-4378-86f5-79bb0e4ae154
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tobin_Kuhic13@gmail.com",
    "telephone": "(739) 814-2146",
    "givenName": "Kemmer",
    "familyName": "Forest",
    "identifier": "83163112-caa0-4ef8-840a-44804d85484e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 20.718525ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0d64a5c6-52fe-4378-86f5-79bb0e4ae154
...
---
Response status code: 401 Unauthorized. Responded in 249.00371ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
