...
---
Response status code: 200 OK. Responded in 5.129779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F116%2Ffacility-use-slots%2F1157?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.686657ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/116",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-29T06:36:11+00:00",
    "endDate": "2022-07-29T07:38:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9d2129d6-a409-41af-904c-c2f8c7deeba9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 100.395844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9d2129d6-a409-41af-904c-c2f8c7deeba9",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F116%2Ffacility-use-slots%2F1157?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 497.59745ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157",
  "modified": 1658486471182,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9d2129d6-a409-41af-904c-c2f8c7deeba9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aliyah_Hintz@hotmail.com",
    "telephone": "1-642-948-0626",
    "givenName": "Goldner",
    "familyName": "Delmer",
    "identifier": "8298b00d-e231-4332-96be-752c1c3f69ca"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 116.956198ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 6.687603ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9d2129d6-a409-41af-904c-c2f8c7deeba9
...
---
Response status code: 201 Created. Responded in 150.949621ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9d2129d6-a409-41af-904c-c2f8c7deeba9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9d2129d6-a409-41af-904c-c2f8c7deeba9#/orderedItems/1408",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/116/facility-use-slots/1157#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 6.210496ms.
```json
{
  "data": {
    "@context": [
