...
⚠️ 17 passed with 0 failures, 164 warnings and 56 suggestions 
...
---
Response status code: 200 OK. Responded in 5.23168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1397/events/13964"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1397%2Fevents%2F13964?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.345259ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1397/events/13964",
    "startDate": "2022-07-31T13:34:11+00:00",
    "endDate": "2022-07-31T15:33:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1397/events/13964"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 192.545761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1397%2Fevents%2F13964?useCacheIfAvailable=true&expectedCapacity=46


---
Response status code: 200 OK. Responded in 214.193394ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1397/events/13964",
  "modified": 1658486479598,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "1-439-392-8267",
    "givenName": "Crona",
    "familyName": "Dejah",
    "identifier": "5ad234fb-9981-43a4-ab6e-bba24e7db8a5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 141.781881ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.677026ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba
...
---
Response status code: 201 Created. Responded in 132.531438ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba#/orderedItems/1443",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1397#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba/versions/8be579b9-cc6e-4be4-9ab4-0e0e75945db8",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba


---
Response status code: 200 OK. Responded in 11.206673ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832764825221&afterId=22c0b985-a68a-4570-a5e9-5b641e4ce080",
  "message": "Listening for UUID: '6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 15.287335ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba


---
Response status code: 200 OK. Responded in 2465.684726ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  "modified": 637940832794835200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
    "identifier": "6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
...
---
Response status code: 200 OK. Responded in 20.103809ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba
...
---
Response status code: 201 Created. Responded in 259.256388ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  "identifier": "6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 786.076773ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "6d5eae03-87a3-4611-a3f7-0f5a4f3e71ba",
  "modified": 637940832821627400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.032176ms.
```json
{
  "data": {
    "@context": [
