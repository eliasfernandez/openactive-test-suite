...
⚠️ 48 passed with 0 failures, 756 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 65.592203ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4124"
}
```
...
---
Response status code: 200 OK. Responded in 63.298368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/116/events/1156"
}
```
...
---
Response status code: 200 OK. Responded in 69.257159ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647"
}
```
...
---
Response status code: 200 OK. Responded in 68.297644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F413%2Fevents%2F4124?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.911712ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4124",
    "startDate": "2022-07-31T18:40:11+00:00",
    "endDate": "2022-07-31T22:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F116%2Fevents%2F1156?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.795594ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/116/events/1156",
    "startDate": "2022-07-31T21:08:11+00:00",
    "endDate": "2022-08-01T02:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F265%2Ffacility-use-slots%2F2647?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.233986ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/265",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2022-07-22T19:51:12+00:00",
    "endDate": "2022-07-23T01:49:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F341%2Ffacility-use-slots%2F3408?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.659778ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 3.36,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT2H10M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-29T19:51:12+00:00",
    "endDate": "2022-07-29T23:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4124"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/116/events/1156"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 502.196981ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F413%2Fevents%2F4124?useCacheIfAvailable=true&expectedCapacity=12


---
Response status code: 200 OK. Responded in 291.027071ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4124",
  "modified": 1658486467934,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F116%2Fevents%2F1156?useCacheIfAvailable=true&expectedCapacity=17


---
Response status code: 200 OK. Responded in 292.8598ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/116/events/1156",
  "modified": 1658486467942,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F265%2Ffacility-use-slots%2F2647?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 832.647098ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647",
  "modified": 1658486468481,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F341%2Ffacility-use-slots%2F3408?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 832.177391ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408",
  "modified": 1658486468482,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Myrtis_Turcotte@hotmail.com",
    "telephone": "843-307-5969",
    "givenName": "Nitzsche",
    "familyName": "Selina",
    "identifier": "d424c959-e439-4ff1-b2c8-70e7dcb1c6ce"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 542.257836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 24.153472ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.965453ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.898768ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.500361ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc
...
---
Response status code: 201 Created. Responded in 419.872154ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1409",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/413#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1410",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/413#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1411",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/116#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1412",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1413",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/265/facility-use-slots/2647#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e99f0ec3-1011-4a6c-bdc2-c2a1af6874cc#/orderedItems/1414",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3408#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 30.542969ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.799928ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.811513ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.236004ms.
```json
{
  "data": {
    "@context": [
