...
---
Response status code: 200 OK. Responded in 15.612133ms.
```json
{
...
---
Response status code: 200 OK. Responded in 332.313827ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2448/events/20448",
  "modified": 1658486697765,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7f8a32bf-0ea6-4677-9bb8-abf04915dea8
...
---
Response status code: 200 OK. Responded in 660.507019ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:57+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2448%2Fevents%2F20448?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 378.780422ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2448/events/20448",
  "modified": 1658486699140,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7f8a32bf-0ea6-4677-9bb8-abf04915dea8
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "13c1c7c0-de87-4ef9-bf25-886e3fdd01b6",
...
---
Response status code: 200 OK. Responded in 621.000184ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 27.869238ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7f8a32bf-0ea6-4677-9bb8-abf04915dea8
...
---
Response status code: 201 Created. Responded in 149.091869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7f8a32bf-0ea6-4677-9bb8-abf04915dea8#/orderedItems/2269",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/7f8a32bf-0ea6-4677-9bb8-abf04915dea8/versions/ed64dc67-415e-4a4e-a191-8dc14c1e6fea",
  "payment": {
    "@type": "Payment",
    "identifier": "XaFQBeeQ3",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;7f8a32bf-0ea6-4677-9bb8-abf04915dea8&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/7f8a32bf-0ea6-4677-9bb8-abf04915dea8


---
Response status code: 200 OK. Responded in 32.93028ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834936437839&afterId=ba2e9b63-f511-4c5e-b46e-eb58a6c16d2c",
  "message": "Listening for UUID: '7f8a32bf-0ea6-4677-9bb8-abf04915dea8' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 355.724026ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;7f8a32bf-0ea6-4677-9bb8-abf04915dea8&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/7f8a32bf-0ea6-4677-9bb8-abf04915dea8


---
Response status code: 200 OK. Responded in 2217.825669ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  "modified": 637940834996982900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
    "identifier": "7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
...
---
Response status code: 200 OK. Responded in 12.013102ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7f8a32bf-0ea6-4677-9bb8-abf04915dea8
...
---
Response status code: 201 Created. Responded in 356.496033ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  "identifier": "7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1065.28234ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "7f8a32bf-0ea6-4677-9bb8-abf04915dea8",
  "modified": 637940835025893100
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 8.282475ms.
```json
{
  "data": {
    "@context": [
