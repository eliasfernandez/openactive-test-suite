...
⚠️ 50 passed with 0 failures, 730 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 32.889206ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/255/events/2543"
}
```
...
---
Response status code: 200 OK. Responded in 27.26522ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/324/events/3240"
}
```
...
---
Response status code: 200 OK. Responded in 25.984299ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950"
}
```
...
---
Response status code: 200 OK. Responded in 24.988584ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F255%2Fevents%2F2543?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.21361ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/255/events/2543",
    "startDate": "2022-07-28T20:23:11+00:00",
    "endDate": "2022-07-28T23:26:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F324%2Fevents%2F3240?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.701703ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/324/events/3240",
    "startDate": "2022-07-22T16:34:11+00:00",
    "endDate": "2022-07-22T19:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/324",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/324#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F395%2Ffacility-use-slots%2F3950?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.194195ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/395",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-25T23:43:12+00:00",
    "endDate": "2022-07-26T03:41:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F84%2Ffacility-use-slots%2F837?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.698088ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 3.27,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-30T16:05:11+00:00",
    "endDate": "2022-07-30T20:08:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/255/events/2543"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/324#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/324/events/3240"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 663.5628ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:13+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/324"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/395"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-25T23:43:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F255%2Fevents%2F2543?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 461.037587ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/255/events/2543",
  "modified": 1658486475554,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F324%2Fevents%2F3240?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 460.189274ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/324/events/3240",
  "modified": 1658486475555,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F395%2Ffacility-use-slots%2F3950?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 599.912522ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950",
  "modified": 1658486475695,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F84%2Ffacility-use-slots%2F837?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 594.351537ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837",
  "modified": 1658486475697,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sid_Grimes@yahoo.com",
    "telephone": "463.312.8886",
    "givenName": "Waters",
    "familyName": "Makenna",
    "identifier": "268ff510-1cd1-4018-8688-229706ddbdd9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 216.47963ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:15+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 24.771181ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.672564ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.825251ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.323612ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238
...
---
Response status code: 201 Created. Responded in 773.243394ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1435",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/255#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1436",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/255#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1437",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/324#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1438",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1439",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/395/facility-use-slots/3950#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b1c505f-96d0-41ee-9fd4-dd1ff9ff6238#/orderedItems/1440",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/84/facility-use-slots/837#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 27.483315ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.354998ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.488785ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.941577ms.
```json
{
  "data": {
    "@context": [
