...
---
Response status code: 200 OK. Responded in 22.868196ms.
```json
{
...
---
Response status code: 200 OK. Responded in 561.873915ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2355/events/20355",
  "modified": 1658486477869,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2355/events/20355",
    "startDate": "2022-07-23T10:41:16+00:00",
    "endDate": "2022-07-23T11:41:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65
...
---
Response status code: 200 OK. Responded in 225.012728ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:17+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2355%2Fevents%2F20355?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 772.961924ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2355/events/20355",
  "modified": 1658486479132,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Preston_Jones@yahoo.com",
    "telephone": "666-823-2750",
    "givenName": "Sawayn",
    "familyName": "Maryse",
    "identifier": "f60b8c13-83f4-4c39-9e03-4c7995a583b6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 580.407774ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:18+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 5.189844ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65
...
---
Response status code: 201 Created. Responded in 106.448712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65#/orderedItems/1683",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2355#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65/versions/d62476fd-4430-46d5-ab62-58a21ff4ee6b",
  "payment": {
    "@type": "Payment",
    "identifier": "6dk7M-Oja",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65


---
Response status code: 200 OK. Responded in 5.248646ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832564136171&afterId=c8229dfa-8579-404a-a448-bf13ca39a2f1",
  "message": "Listening for UUID: '3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.758412ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65


---
Response status code: 200 OK. Responded in 2128.314904ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "modified": 637940832791236600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
    "identifier": "3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
...
---
Response status code: 200 OK. Responded in 11.298599ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832791236653&afterId=3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "message": "Listening for UUID: '3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65
...
---
Response status code: 201 Created. Responded in 112.160886ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "identifier": "3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 835.541743ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65",
  "modified": 637940832813199000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 9.871886ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/3980a9c7-bb2e-4658-9f16-ab2fd8a3bb65
...
---
Response status code: 400 Bad Request. Responded in 69.847014ms.
```json
{
  "@context": "https://openactive.io/",
