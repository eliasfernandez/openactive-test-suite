...
⚠️ 14 passed with 0 failures, 97 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 100.938505ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3046"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3046?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.5236ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3046",
    "startDate": "2022-07-22T19:42:11+00:00",
    "endDate": "2022-07-22T22:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8547bf9c-d2c0-480c-b362-d8e9b95a99c8
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3046"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 203.544654ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8547bf9c-d2c0-480c-b362-d8e9b95a99c8",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3046?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 516.912942ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3046",
  "modified": 1658486720395,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8547bf9c-d2c0-480c-b362-d8e9b95a99c8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Valerie.Vandervort17@hotmail.com",
    "telephone": "1-510-302-0600 x9601",
    "givenName": "Weissnat",
    "familyName": "Micaela",
    "identifier": "70aeb0e2-8fa6-4ca4-ab16-35e8f2e63726"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 363.76679ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 17.992264ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/8547bf9c-d2c0-480c-b362-d8e9b95a99c8
...
---
Response status code: 204 No Content. Responded in 744.254211ms.
...
---
Response status code: 204 No Content. Responded in 13.368146ms.
### Specs
