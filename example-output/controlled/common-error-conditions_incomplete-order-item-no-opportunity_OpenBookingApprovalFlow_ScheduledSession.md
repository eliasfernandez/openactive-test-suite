...
---
Response status code: 200 OK. Responded in 27.098332ms.
```json
{
...
---
Response status code: 200 OK. Responded in 502.937519ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2199/events/20199",
  "modified": 1658486225040,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2199/events/20199",
    "startDate": "2022-07-23T10:37:03+00:00",
    "endDate": "2022-07-23T11:37:03+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/08c2450b-0d14-41b8-9124-110aabeab748
...
---
Response status code: 409 Conflict. Responded in 218.823879ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/08c2450b-0d14-41b8-9124-110aabeab748",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/08c2450b-0d14-41b8-9124-110aabeab748
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Doug93@hotmail.com",
    "telephone": "(848) 626-0610 x173",
    "givenName": "Abshire",
    "familyName": "Eulalia",
    "identifier": "29b1e7eb-b5e9-494d-915b-e44a8a0f2113"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 45.39979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/08c2450b-0d14-41b8-9124-110aabeab748
...
---
Response status code: 409 Conflict. Responded in 14.377923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/08c2450b-0d14-41b8-9124-110aabeab748",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
