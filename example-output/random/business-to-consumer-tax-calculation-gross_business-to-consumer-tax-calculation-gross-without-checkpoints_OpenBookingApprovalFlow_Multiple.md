[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:43:26 GMT+0000 (Coordinated Universal Time)
...
⚠️ 24 passed with 0 failures, 519 warnings and 136 suggestions 
...
---
Response status code: 200 OK. Responded in 17.452785ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15336"
}
```
...
---
Response status code: 200 OK. Responded in 20.174961ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12553"
}
```
...
---
Response status code: 200 OK. Responded in 29.255614ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685"
}
```
...
---
Response status code: 200 OK. Responded in 28.870603ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11081"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15336?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.147688ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15336",
    "startDate": "2022-07-27T19:35:11+00:00",
    "endDate": "2022-07-27T23:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1534",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1534#/offers/0",
          ...
          "price": 10.48,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT14H40M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12553?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.324065ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12553",
    "startDate": "2022-07-26T04:12:11+00:00",
    "endDate": "2022-07-26T08:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1769%2Ffacility-use-slots%2F17685?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.681948ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1769",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685#/offers/0",
        ...
        "price": 4.4,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT22H39M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-22T14:36:12+00:00",
    "endDate": "2022-07-22T18:16:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11081?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.117332ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1109",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11081#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 5,
    "startDate": "2022-07-22T13:53:12+00:00",
    "endDate": "2022-07-22T18:14:12+00:00"
  }
}
```
### Specs
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alexandre_Strosin91@yahoo.com",
    "telephone": "(232) 790-9863 x15285",
    "givenName": "Halvorson",
    "familyName": "Emiliano",
    "identifier": "ff9c475c-d2fd-4972-8d34-c1124f331623"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1534#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15336"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12553"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11081#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11081"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 319.859301ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1872",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1534#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1873",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1534#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1874",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1875",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685#/offers/0",
        "allowCustomerCancellationFullRefund": false,
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1769"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-22T14:36:12+00:00",
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1876",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1769/facility-use-slots/17685#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e#/orderedItems/1877",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11081#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e/versions/618b5fc8-029f-417e-bd8d-92227dd3c402",
  "payment": {
    "@type": "Payment",
    "identifier": "3o6mN5BGv",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;ff1e5985-6516-4d5c-8f12-1e1d9095ee0e&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e


---
Response status code: 200 OK. Responded in 4.148815ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834304720490&afterId=77bd49d2-17e7-47bc-a488-2b27e8355457",
  "message": "Listening for UUID: 'ff1e5985-6516-4d5c-8f12-1e1d9095ee0e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 22.868637ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;ff1e5985-6516-4d5c-8f12-1e1d9095ee0e&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e


---
Response status code: 200 OK. Responded in 2314.411684ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  "modified": 637940834343803400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
    "identifier": "ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
...
---
Response status code: 200 OK. Responded in 4.134805ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834343803446&afterId=ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  "message": "Listening for UUID: 'ff1e5985-6516-4d5c-8f12-1e1d9095ee0e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e
...
---
Response status code: 201 Created. Responded in 179.941101ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  "identifier": "ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 18.173297ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "ff1e5985-6516-4d5c-8f12-1e1d9095ee0e",
  "modified": 637940834367700200
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15336?useCacheIfAvailable=true&expectedCapacity=40


---
Response status code: 200 OK. Responded in 34.614747ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12553?useCacheIfAvailable=true&expectedCapacity=48


---
Response status code: 200 OK. Responded in 33.567318ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1769%2Ffacility-use-slots%2F17685?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 32.824798ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11081?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 32.202281ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 132.341969ms.
```json
{
  "@context": [
    "https://openactive.io/",
