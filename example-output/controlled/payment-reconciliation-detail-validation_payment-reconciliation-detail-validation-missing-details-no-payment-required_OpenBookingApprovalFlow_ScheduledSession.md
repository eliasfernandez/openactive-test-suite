...
---
Response status code: 200 OK. Responded in 20.404986ms.
```json
{
...
---
Response status code: 200 OK. Responded in 875.310683ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2562/events/20562",
  "modified": 1658486962439,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2562/events/20562",
    "startDate": "2022-07-23T10:49:20+00:00",
    "endDate": "2022-07-23T11:49:20+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1eff6784-aeed-4172-a7a0-642073114ded
...
---
Response status code: 400 Bad Request. Responded in 15.726743ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1eff6784-aeed-4172-a7a0-642073114ded
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Devin72@gmail.com",
    "telephone": "912.833.1599",
    "givenName": "Weber",
    "familyName": "Amari",
    "identifier": "0327715c-7ae5-4bef-97c6-cd9a1f00def7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 16.950755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
