...
---
Response status code: 200 OK. Responded in 1148.466835ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1182.7572460000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566",
  "modified": 1658486996563,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:49:53+00:00",
    "endDate": "2022-07-23T11:49:53+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/151216fb-386a-424f-be06-e6d1498a6d16
...
---
Response status code: 200 OK. Responded in 545.507556ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/151216fb-386a-424f-be06-e6d1498a6d16",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:56+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2566%2Ffacility-use-slots%2F20566?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 938.214624ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566",
  "modified": 1658486998279,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/151216fb-386a-424f-be06-e6d1498a6d16
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eli52@yahoo.com",
    "telephone": "456-996-2290 x138",
    "givenName": "Schultz",
    "familyName": "Nathan",
    "identifier": "628e5daa-7881-4d33-a8b7-d8ed84185807"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 323.877142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:57+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 27.620751ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/151216fb-386a-424f-be06-e6d1498a6d16
...
---
Response status code: 201 Created. Responded in 312.983843ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/151216fb-386a-424f-be06-e6d1498a6d16",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/151216fb-386a-424f-be06-e6d1498a6d16#/orderedItems/3106",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 63.101873ms.
```json
{
  "data": {
    "@context": [
