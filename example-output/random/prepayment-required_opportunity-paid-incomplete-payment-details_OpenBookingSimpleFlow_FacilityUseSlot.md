...
---
Response status code: 200 OK. Responded in 11.829847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/396/facility-use-slots/3952"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F396%2Ffacility-use-slots%2F3952?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.882665ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/396/facility-use-slots/3952#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 12.35,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT14H53M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-27T02:14:12+00:00",
    "endDate": "2022-07-27T06:03:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fce19f9a-278d-47dd-8a36-30a74ff9fc65
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/396/facility-use-slots/3952#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/396/facility-use-slots/3952"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 599.114226ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fce19f9a-278d-47dd-8a36-30a74ff9fc65",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F396%2Ffacility-use-slots%2F3952?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 977.032523ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/396/facility-use-slots/3952",
  "modified": 1658486877331,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fce19f9a-278d-47dd-8a36-30a74ff9fc65
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mayra_Smith@yahoo.com",
    "telephone": "1-213-403-3027 x21709",
    "givenName": "Stokes",
    "familyName": "Malcolm",
    "identifier": "aa78f75e-ebcc-4db8-b48c-518dafb8264a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 298.945149ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:56+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.374984ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fce19f9a-278d-47dd-8a36-30a74ff9fc65
...
---
Response status code: 400 Bad Request. Responded in 507.653211ms.
```json
{
  "@context": "https://openactive.io/",
