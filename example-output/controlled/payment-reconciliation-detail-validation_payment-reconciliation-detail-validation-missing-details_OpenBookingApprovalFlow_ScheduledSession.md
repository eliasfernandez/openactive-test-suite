...
---
Response status code: 200 OK. Responded in 26.758941ms.
```json
{
...
---
Response status code: 200 OK. Responded in 444.792406ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2593/events/20593",
  "modified": 1658487019031,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2593/events/20593",
    "startDate": "2022-07-23T10:50:17+00:00",
    "endDate": "2022-07-23T11:50:17+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8002ab65-725b-460a-922a-d1ddf30a0b3b
...
---
Response status code: 400 Bad Request. Responded in 48.418836ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8002ab65-725b-460a-922a-d1ddf30a0b3b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Justen57@gmail.com",
    "telephone": "1-327-229-1522 x82862",
    "givenName": "Hoppe",
    "familyName": "Edna",
    "identifier": "d83262a8-1c5a-4f6d-bc17-cae89a498701"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 28.709959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
