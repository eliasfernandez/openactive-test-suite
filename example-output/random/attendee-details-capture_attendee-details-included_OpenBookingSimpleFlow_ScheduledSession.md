...
---
Response status code: 200 OK. Responded in 29.192756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/595/events/5946"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F595%2Fevents%2F5946?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.872954ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/595/events/5946",
    "startDate": "2022-07-23T20:54:11+00:00",
    "endDate": "2022-07-24T01:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/595",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/595#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT2H49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/595#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/595/events/5946",
      "attendee": {
        "@type": "Person",
...
---
Response status code: 200 OK. Responded in 454.238294ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/595"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F595%2Fevents%2F5946?useCacheIfAvailable=true&expectedCapacity=34


---
Response status code: 200 OK. Responded in 278.065041ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/595/events/5946",
  "modified": 1658486816860,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ken29@yahoo.com",
    "telephone": "776.783.1568 x997",
    "givenName": "Torphy",
    "familyName": "Alba",
    "identifier": "3e3b5af3-1d70-4e96-b734-1b03f3be1140"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 446.991631ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 19.352834ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f
...
---
Response status code: 201 Created. Responded in 258.091892ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1d3e3f73-7ba4-46ce-9d40-d9001593ea7f#/orderedItems/2352",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/595#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.555985ms.
```json
{
  "data": {
    "@context": [
