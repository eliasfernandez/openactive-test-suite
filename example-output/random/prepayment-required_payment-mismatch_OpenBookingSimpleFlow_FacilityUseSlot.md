...
---
Response status code: 200 OK. Responded in 17.36967ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4382"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F439%2Ffacility-use-slots%2F4382?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.911889ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4382#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 7.81,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT12H6M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-31T08:22:12+00:00",
    "endDate": "2022-07-31T11:52:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f8d9062-669e-473f-99de-3009830f239e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4382#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4382"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 225.050886ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f8d9062-669e-473f-99de-3009830f239e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:15+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F439%2Ffacility-use-slots%2F4382?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 626.025914ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4382",
  "modified": 1658486837644,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f8d9062-669e-473f-99de-3009830f239e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Antoinette.Emard99@gmail.com",
    "telephone": "(636) 829-7387",
    "givenName": "Schumm",
    "familyName": "Danial",
    "identifier": "d3112b01-4cab-46fd-861c-be52d171c544"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 496.153852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.67167ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2f8d9062-669e-473f-99de-3009830f239e
...
---
Response status code: 400 Bad Request. Responded in 508.31061ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (8.81) does not match expected value (7.81)"
}
```
### Specs
