...
⚠️ 13 passed with 0 failures, 136 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 157.800949ms.
```json
{
...
---
Response status code: 200 OK. Responded in 817.206085ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343",
  "modified": 1658486454885,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d259259f-4ead-4d0b-ba87-00db6aff429e
...
---
Response status code: 200 OK. Responded in 132.919536ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d259259f-4ead-4d0b-ba87-00db6aff429e",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2343%2Fevents%2F20343?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 724.298891ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343",
  "modified": 1658486456057,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d259259f-4ead-4d0b-ba87-00db6aff429e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ambrose_Carroll78@hotmail.com",
    "telephone": "1-920-474-8044 x13937",
    "givenName": "Kerluke",
    "familyName": "Alanis",
    "identifier": "94d23f9e-d112-4755-9281-58bdaf639440"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 230.637272ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.284922ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d259259f-4ead-4d0b-ba87-00db6aff429e
...
---
Response status code: 201 Created. Responded in 198.170994ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d259259f-4ead-4d0b-ba87-00db6aff429e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d259259f-4ead-4d0b-ba87-00db6aff429e#/orderedItems/1605",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2343#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 25.69282ms.
```json
{
  "data": {
    "@context": [
