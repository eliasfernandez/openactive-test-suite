...
⚠️ 51 passed with 0 failures, 752 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 34.270086ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1065/events/10648"
}
```
...
---
Response status code: 200 OK. Responded in 32.716359ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1462/events/14613"
}
```
...
---
Response status code: 200 OK. Responded in 28.510887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660"
}
```
...
---
Response status code: 200 OK. Responded in 27.761174ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1065%2Fevents%2F10648?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.203765ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1065/events/10648",
    "startDate": "2022-07-27T21:49:11+00:00",
    "endDate": "2022-07-27T23:32:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1065",
      "name": "Rubber Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1065#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1462%2Fevents%2F14613?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.652255ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1462/events/14613",
    "startDate": "2022-07-27T10:59:11+00:00",
    "endDate": "2022-07-27T16:40:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1462",
      "name": "Metal Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1462#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT5H20M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11660?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.133346ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 7,
    "startDate": "2022-07-31T18:22:12+00:00",
    "endDate": "2022-07-31T21:02:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1127%2Ffacility-use-slots%2F11264?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.020525ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264#/offers/0",
    ...
    "endDate": "2022-07-26T05:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b59287be-4ca2-4887-81a4-3b597ead67c7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1065#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1065/events/10648"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1462#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1462/events/14613"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 336.353947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b59287be-4ca2-4887-81a4-3b597ead67c7",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1462"
        },
        "maximumAttendeeCapacity": 31,
        "remainingAttendeeCapacity": 31
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1065%2Fevents%2F10648?useCacheIfAvailable=true&expectedCapacity=23


---
Response status code: 200 OK. Responded in 264.399917ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1065/events/10648",
  "modified": 1658486113505,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1462%2Fevents%2F14613?useCacheIfAvailable=true&expectedCapacity=30


---
Response status code: 200 OK. Responded in 265.250532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1462/events/14613",
  "modified": 1658486113507,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11660?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 87.484795ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660",
  "modified": 1658486113335,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1127%2Ffacility-use-slots%2F11264?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 93.02779ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264",
  "modified": 1658486113338,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b59287be-4ca2-4887-81a4-3b597ead67c7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adriana34@hotmail.com",
    "telephone": "779.366.9480 x8943",
    "givenName": "Hermiston",
    "familyName": "Mike",
    "identifier": "3705998d-1e89-49f0-858c-c69d2ef3208e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 317.916932ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:13+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 51.46298ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 50.476663ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.728051ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.241642ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b59287be-4ca2-4887-81a4-3b597ead67c7
...
---
Response status code: 201 Created. Responded in 164.773518ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b59287be-4ca2-4887-81a4-3b597ead67c7",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/477",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1065#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/478",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1065#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/479",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1462#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/480",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/481",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11660#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7#/orderedItems/482",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11264#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b59287be-4ca2-4887-81a4-3b597ead67c7/versions/1b996384-65a8-4dff-941b-70b91a81c477",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b59287be-4ca2-4887-81a4-3b597ead67c7
...
---
Response status code: 500 Internal Server Error. Responded in 19.655837ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 13.575232ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.380497ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.105492ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.44313ms.
```json
{
  "data": {
    "@context": [
