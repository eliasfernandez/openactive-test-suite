...
⚠️ 47 passed with 0 failures, 767 warnings and 208 suggestions 
...
---
Response status code: 200 OK. Responded in 36.359497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/567/events/5666"
}
```
...
---
Response status code: 200 OK. Responded in 35.278276ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1879"
}
```
...
---
Response status code: 200 OK. Responded in 34.396259ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390"
}
```
...
---
Response status code: 200 OK. Responded in 33.527743ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F567%2Fevents%2F5666?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.99696ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/567/events/5666",
    "startDate": "2022-07-23T04:07:11+00:00",
    "endDate": "2022-07-23T09:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 17.74,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT3H58M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F188%2Fevents%2F1879?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.612453ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1879",
    "startDate": "2022-07-25T10:09:11+00:00",
    "endDate": "2022-07-25T14:33:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F439%2Ffacility-use-slots%2F4390?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.250746ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT15H59M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-29T21:57:12+00:00",
    "endDate": "2022-07-30T00:16:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F247%2Ffacility-use-slots%2F2461?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.864238ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/247",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-29T16:43:12+00:00",
    "endDate": "2022-07-29T20:17:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6e18f16c-f514-4e73-98bb-83c6ca4952cc
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/567/events/5666"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1879"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1345.860185ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6e18f16c-f514-4e73-98bb-83c6ca4952cc",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F567%2Fevents%2F5666?useCacheIfAvailable=true&expectedCapacity=29


---
Response status code: 200 OK. Responded in 445.515003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/567/events/5666",
  "modified": 1658486975794,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F188%2Fevents%2F1879?useCacheIfAvailable=true&expectedCapacity=15


---
Response status code: 200 OK. Responded in 435.033802ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1879",
  "modified": 1658486975807,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F439%2Ffacility-use-slots%2F4390?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 654.42169ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390",
  "modified": 1658486976027,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F247%2Ffacility-use-slots%2F2461?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 654.46119ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461",
  "modified": 1658486976028,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6e18f16c-f514-4e73-98bb-83c6ca4952cc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dameon43@hotmail.com",
    "telephone": "342-685-5486",
    "givenName": "Vandervort",
    "familyName": "Kraig",
    "identifier": "16228a94-84f5-4f1c-8141-d1ef30503d61"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1971.173519ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 63.172774ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.192364ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.480086ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.020179ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc
...
---
Response status code: 201 Created. Responded in 835.933516ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2792",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/567#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2793",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/567#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2794",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/188#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2795",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2796",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/439/facility-use-slots/4390#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6e18f16c-f514-4e73-98bb-83c6ca4952cc#/orderedItems/2797",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/247/facility-use-slots/2461#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 54.426718ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.676866ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.136156ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 50.697848ms.
```json
{
  "data": {
    "@context": [
