...
---
Response status code: 200 OK. Responded in 44.79191ms.
```json
{
...
---
Response status code: 200 OK. Responded in 614.199814ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2526/facility-use-slots/20526",
  "modified": 1658486911858,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:48:30+00:00",
    "endDate": "2022-07-23T11:48:30+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/524797a8-8d80-46d1-91db-e2dbf09ce60f
...
---
Response status code: 200 OK. Responded in 309.776531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/524797a8-8d80-46d1-91db-e2dbf09ce60f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2526%2Ffacility-use-slots%2F20526?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 954.905372ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2526/facility-use-slots/20526",
  "modified": 1658486913356,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/524797a8-8d80-46d1-91db-e2dbf09ce60f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Muhammad_Bergnaum@hotmail.com",
    "telephone": "735-885-8410 x246",
    "givenName": "Sipes",
    "familyName": "Flo",
    "identifier": "adb9ea8c-1546-462d-bd73-f248205f1b40"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1064.093651ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.759142ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/524797a8-8d80-46d1-91db-e2dbf09ce60f
...
---
Response status code: 201 Created. Responded in 455.196528ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/524797a8-8d80-46d1-91db-e2dbf09ce60f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/524797a8-8d80-46d1-91db-e2dbf09ce60f#/orderedItems/2906",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2526/facility-use-slots/20526#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.357976ms.
```json
{
  "data": {
    "@context": [
