...
---
Response status code: 200 OK. Responded in 45.809502ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5807"
}
```
...
---
Response status code: 200 OK. Responded in 45.6822ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/203/events/2025"
}
```
...
---
Response status code: 200 OK. Responded in 44.928887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978"
}
```
...
---
Response status code: 200 OK. Responded in 44.839785ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F581%2Fevents%2F5807?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.403775ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5807",
    "startDate": "2022-07-24T17:10:11+00:00",
    "endDate": "2022-07-24T19:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 12.33,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT6H18M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F203%2Fevents%2F2025?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.015151ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/203/events/2025",
    "startDate": "2022-07-26T18:44:11+00:00",
    "endDate": "2022-07-26T21:56:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/203",
      "name": "Metal Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/203#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F598%2Ffacility-use-slots%2F5978?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.610943ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0.87,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT22H21M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-08-01T08:45:12+00:00",
    "endDate": "2022-08-01T12:14:12+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 19.876748ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 12.55,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT12H15M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-26T19:26:12+00:00",
    "endDate": "2022-07-26T20:28:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1bed281a-5610-466f-a9e8-093c7e21577d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5807"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/203#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/203/events/2025"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 1309.800773ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1bed281a-5610-466f-a9e8-093c7e21577d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:39+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/203"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F581%2Fevents%2F5807?useCacheIfAvailable=true&expectedCapacity=45


---
Response status code: 200 OK. Responded in 561.151318ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5807",
  "modified": 1658487102354,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F203%2Fevents%2F2025?useCacheIfAvailable=true&expectedCapacity=14


---
Response status code: 200 OK. Responded in 566.120904ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/203/events/2025",
  "modified": 1658487102357,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F598%2Ffacility-use-slots%2F5978?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 865.912942ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978",
  "modified": 1658487102661,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F507%2Ffacility-use-slots%2F5062?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 868.371384ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/507/facility-use-slots/5062",
  "modified": 1658487102664,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1bed281a-5610-466f-a9e8-093c7e21577d
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "5d83d499-75f7-44b6-aae4-225514f15d12",
...
---
Response status code: 200 OK. Responded in 1665.053939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 112.149422ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 117.618016ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 117.681417ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 88.704321ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d
...
---
Response status code: 201 Created. Responded in 2002.605325ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3089",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/581#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3090",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/581#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3091",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/203#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3092",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3093",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5978#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1bed281a-5610-466f-a9e8-093c7e21577d#/orderedItems/3094",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/507/facility-use-slots/5062#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 38.777174ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 38.177363ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 37.706756ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 37.252748ms.
```json
{
  "data": {
    "@context": [
