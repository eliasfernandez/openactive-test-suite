[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:41:07 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 178 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 8.990839ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1273/events/12727"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1273%2Fevents%2F12727?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.315651ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1273/events/12727",
    "startDate": "2022-07-23T20:32:11+00:00",
    "endDate": "2022-07-23T23:54:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a76ec687-35e8-4df5-b7a8-2d160b303254
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1273/events/12727"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 131.897828ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a76ec687-35e8-4df5-b7a8-2d160b303254",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:35+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1273%2Fevents%2F12727?useCacheIfAvailable=true&expectedCapacity=40


---
Response status code: 200 OK. Responded in 716.78072ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1273/events/12727",
  "modified": 1658486497188,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a76ec687-35e8-4df5-b7a8-2d160b303254
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jakayla.Weimann98@hotmail.com",
    "telephone": "(991) 443-9648 x62429",
    "givenName": "Upton",
    "familyName": "Felicity",
    "identifier": "6c5df543-d328-4dc9-9050-87f617efbaff"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 82.797773ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:36+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 7.106809ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a76ec687-35e8-4df5-b7a8-2d160b303254
...
---
Response status code: 201 Created. Responded in 299.739508ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a76ec687-35e8-4df5-b7a8-2d160b303254",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a76ec687-35e8-4df5-b7a8-2d160b303254#/orderedItems/1509",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1273#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a76ec687-35e8-4df5-b7a8-2d160b303254/versions/f0a92a69-0f0c-4c62-9752-edc15d02c698",
  "payment": {
    "@type": "Payment",
    "identifier": "CsVialQz4",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a76ec687-35e8-4df5-b7a8-2d160b303254&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a76ec687-35e8-4df5-b7a8-2d160b303254


---
Response status code: 200 OK. Responded in 17.095863ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832948649567&afterId=2c0e0f06-6071-4108-bf75-96970e03bb4f",
  "message": "Listening for UUID: 'a76ec687-35e8-4df5-b7a8-2d160b303254' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 13.930415ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a76ec687-35e8-4df5-b7a8-2d160b303254&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a76ec687-35e8-4df5-b7a8-2d160b303254


---
Response status code: 200 OK. Responded in 2352.154039ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a76ec687-35e8-4df5-b7a8-2d160b303254",
  "modified": 637940832980314800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a76ec687-35e8-4df5-b7a8-2d160b303254",
    "identifier": "a76ec687-35e8-4df5-b7a8-2d160b303254",
...
---
Response status code: 200 OK. Responded in 21.399828ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832982171641&afterId=182a1317-b9fa-4c72-900e-f79b4a6afb1b",
  "message": "Listening for UUID: 'a76ec687-35e8-4df5-b7a8-2d160b303254' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a76ec687-35e8-4df5-b7a8-2d160b303254
...
---
Response status code: 201 Created. Responded in 167.152867ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a76ec687-35e8-4df5-b7a8-2d160b303254",
  "identifier": "a76ec687-35e8-4df5-b7a8-2d160b303254",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2090.675014ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a76ec687-35e8-4df5-b7a8-2d160b303254",
  "modified": 637940833005168900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 7.574816ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/a76ec687-35e8-4df5-b7a8-2d160b303254
...
---
Response status code: 204 No Content. Responded in 65.651908ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
