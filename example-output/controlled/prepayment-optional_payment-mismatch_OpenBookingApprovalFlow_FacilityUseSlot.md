...
---
Response status code: 200 OK. Responded in 283.626881ms.
```json
{
...
---
Response status code: 200 OK. Responded in 661.951924ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2493/facility-use-slots/20493",
  "modified": 1658486847326,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:25+00:00",
    "endDate": "2022-07-23T11:47:25+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8efa977a-f815-49f6-9aab-a4e2d119bd45
...
---
Response status code: 200 OK. Responded in 395.6066ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8efa977a-f815-49f6-9aab-a4e2d119bd45",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2493%2Ffacility-use-slots%2F20493?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1209.576663ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2493/facility-use-slots/20493",
  "modified": 1658486849126,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8efa977a-f815-49f6-9aab-a4e2d119bd45
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tyshawn72@hotmail.com",
    "telephone": "(545) 694-3295",
    "givenName": "Thompson",
    "familyName": "Rylee",
    "identifier": "e369e2b1-6238-4295-bb2e-0f8fa6a04ede"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 362.117571ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:28+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 17.547859ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8efa977a-f815-49f6-9aab-a4e2d119bd45
...
---
Response status code: 400 Bad Request. Responded in 350.368866ms.
```json
{
  "@context": "https://openactive.io/",
