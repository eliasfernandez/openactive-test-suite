...
---
Response status code: 200 OK. Responded in 333.343502ms.
```json
{
...
---
Response status code: 200 OK. Responded in 437.962444ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2475/events/20475",
  "modified": 1658486770081,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79aa31d1-6c24-4c91-83dc-4948312da06c
...
---
Response status code: 200 OK. Responded in 269.262224ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79aa31d1-6c24-4c91-83dc-4948312da06c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2475%2Fevents%2F20475?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 445.594312ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2475/events/20475",
  "modified": 1658486771238,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79aa31d1-6c24-4c91-83dc-4948312da06c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joshuah_Jacobson@hotmail.com",
    "telephone": "1-841-257-8742 x668",
    "givenName": "Mertz",
    "familyName": "Pearl",
    "identifier": "e90dd6fa-044a-40ae-a8e7-7b9fc5c98eff"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 268.376916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 49.047242ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79aa31d1-6c24-4c91-83dc-4948312da06c
...
---
Response status code: 400 Bad Request. Responded in 1117.642664ms.
```json
{
  "@context": "https://openactive.io/",
