...
⚠️ 19 passed with 0 failures, 211 warnings and 74 suggestions 
...
---
Response status code: 200 OK. Responded in 4.678762ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12632"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1264%2Fevents%2F12632?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.074841ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12632",
    "startDate": "2022-07-26T13:41:11+00:00",
    "endDate": "2022-07-26T16:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1264",
      "name": "Rubber Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1264#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d3224a16-6d13-45e4-bc88-a9e0b92360a1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1264#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12632"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 117.984965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1264%2Fevents%2F12632?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 399.319495ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12632",
  "modified": 1658486366988,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d3224a16-6d13-45e4-bc88-a9e0b92360a1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Laura.Crona23@hotmail.com",
    "telephone": "(837) 509-1430",
    "givenName": "Mraz",
    "familyName": "Dustin",
    "identifier": "cb75dfae-5bf9-47be-ae00-0be2119fc49b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 163.184675ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:26+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 16.208956ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d3224a16-6d13-45e4-bc88-a9e0b92360a1
...
---
Response status code: 201 Created. Responded in 153.750726ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d3224a16-6d13-45e4-bc88-a9e0b92360a1#/orderedItems/1088",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1264#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d3224a16-6d13-45e4-bc88-a9e0b92360a1/versions/e6880541-8ef1-4fd4-91de-e6cccb9badf2",
  "payment": {
    "@type": "Payment",
    "identifier": "WD2gWzVed",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;d3224a16-6d13-45e4-bc88-a9e0b92360a1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d3224a16-6d13-45e4-bc88-a9e0b92360a1


---
Response status code: 200 OK. Responded in 14.868734ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831444105611&afterId=f02a3d42-113e-4da1-9533-797274cf7841",
  "message": "Listening for UUID: 'd3224a16-6d13-45e4-bc88-a9e0b92360a1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 30.954089ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;d3224a16-6d13-45e4-bc88-a9e0b92360a1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d3224a16-6d13-45e4-bc88-a9e0b92360a1


---
Response status code: 200 OK. Responded in 2088.514959ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "modified": 637940831684367500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d3224a16-6d13-45e4-bc88-a9e0b92360a1",
    "identifier": "d3224a16-6d13-45e4-bc88-a9e0b92360a1",
...
---
Response status code: 200 OK. Responded in 19.227702ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831684367491&afterId=d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "message": "Listening for UUID: 'd3224a16-6d13-45e4-bc88-a9e0b92360a1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/d3224a16-6d13-45e4-bc88-a9e0b92360a1
...
---
Response status code: 201 Created. Responded in 83.375711ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "identifier": "d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1177.253911ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "d3224a16-6d13-45e4-bc88-a9e0b92360a1",
  "modified": 637940831705923000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.251908ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/4ee9c08a-b7e3-4b8f-82fc-52d2eb5c62ca
...
---
Response status code: 500 Internal Server Error. Responded in 18.240987ms.
```json
{
  "@context": "https://openactive.io/",
