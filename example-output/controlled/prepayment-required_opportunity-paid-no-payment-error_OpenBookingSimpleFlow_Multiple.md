...
---
Response status code: 200 OK. Responded in 237.739741ms.
```json
{
...
---
Response status code: 200 OK. Responded in 261.543856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 335.131219ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495",
  "modified": 1658486824177,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495",
    "startDate": "2022-07-23T10:47:02+00:00",
    "endDate": "2022-07-23T11:47:02+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1197.600767ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2483/facility-use-slots/20483",
  "modified": 1658486825039,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7eba1cb1-8d44-4dec-b917-b7d4be303935
...
---
Response status code: 200 OK. Responded in 645.653702ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7eba1cb1-8d44-4dec-b917-b7d4be303935",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2495%2Fevents%2F20495?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 745.666817ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495",
  "modified": 1658486826779,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2483%2Ffacility-use-slots%2F20483?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 831.3474ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2483/facility-use-slots/20483",
  "modified": 1658486826866,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7eba1cb1-8d44-4dec-b917-b7d4be303935
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jamey_Ullrich94@gmail.com",
    "telephone": "1-512-667-5625 x1717",
    "givenName": "Runolfsson",
    "familyName": "Eliane",
    "identifier": "64b26919-d18e-4536-9da6-83271c4bbfa8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 469.532992ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 46.020821ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 37.18124ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7eba1cb1-8d44-4dec-b917-b7d4be303935
...
---
Response status code: 400 Bad Request. Responded in 989.663447ms.
```json
{
  "@context": "https://openactive.io/",
