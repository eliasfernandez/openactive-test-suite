...
---
Response status code: 200 OK. Responded in 78.762417ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1699.476865ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2492/facility-use-slots/20492",
  "modified": 1658486846894,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:24+00:00",
    "endDate": "2022-07-23T11:47:24+00:00"
  }
}
```
### Specs
