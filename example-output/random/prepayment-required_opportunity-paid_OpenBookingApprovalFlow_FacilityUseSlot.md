...
---
Response status code: 200 OK. Responded in 14.143693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1687%2Ffacility-use-slots%2F16868?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.086388ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1687",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868#/offers/0",
        ...
        "price": 15.95,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT21H24M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-23T10:09:12+00:00",
    "endDate": "2022-07-23T15:46:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/063fe0f7-ed6b-4c79-860b-9da90ff76adc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 648.785299ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:08+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1687"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-23T10:09:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1687%2Ffacility-use-slots%2F16868?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 694.012132ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868",
  "modified": 1658486890244,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/063fe0f7-ed6b-4c79-860b-9da90ff76adc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jadyn.Wunsch@hotmail.com",
    "telephone": "1-340-822-3922 x05722",
    "givenName": "Rempel",
    "familyName": "Keven",
    "identifier": "5df7fd7c-a695-42be-8427-b5fbe559febe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 371.172765ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:09+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 49.119315ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/063fe0f7-ed6b-4c79-860b-9da90ff76adc
...
---
Response status code: 201 Created. Responded in 428.517249ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/063fe0f7-ed6b-4c79-860b-9da90ff76adc#/orderedItems/2571",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1687/facility-use-slots/16868#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/063fe0f7-ed6b-4c79-860b-9da90ff76adc/versions/aefeaab7-1605-4ea1-863d-25649a39e674",
  "payment": {
    "@type": "Payment",
    "identifier": "P3wrJx53Z",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;063fe0f7-ed6b-4c79-860b-9da90ff76adc&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/063fe0f7-ed6b-4c79-860b-9da90ff76adc


---
Response status code: 200 OK. Responded in 27.532268ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836844658716&afterId=58aecb7a-ee2f-4015-9608-a583c76f6aa7",
  "message": "Listening for UUID: '063fe0f7-ed6b-4c79-860b-9da90ff76adc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 286.148909ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;063fe0f7-ed6b-4c79-860b-9da90ff76adc&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/063fe0f7-ed6b-4c79-860b-9da90ff76adc


---
Response status code: 200 OK. Responded in 2277.516199ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "modified": 637940836907082800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/063fe0f7-ed6b-4c79-860b-9da90ff76adc",
    "identifier": "063fe0f7-ed6b-4c79-860b-9da90ff76adc",
...
---
Response status code: 200 OK. Responded in 16.690944ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836907082704&afterId=063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "message": "Listening for UUID: '063fe0f7-ed6b-4c79-860b-9da90ff76adc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/063fe0f7-ed6b-4c79-860b-9da90ff76adc
...
---
Response status code: 201 Created. Responded in 148.370754ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "identifier": "063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 980.105677ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "063fe0f7-ed6b-4c79-860b-9da90ff76adc",
  "modified": 637940836933036800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.994003ms.
```json
{
  "data": {
    "@context": [
