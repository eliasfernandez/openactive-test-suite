...
⚠️ 27 passed with 0 failures, 351 warnings and 90 suggestions 
...
---
Response status code: 200 OK. Responded in 26.649241ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1431/events/14304"
}
```
...
---
Response status code: 200 OK. Responded in 25.712725ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1410/events/14098"
}
```
...
---
Response status code: 200 OK. Responded in 24.857412ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1548/facility-use-slots/15474"
}
```
...
---
Response status code: 200 OK. Responded in 38.488737ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1589/facility-use-slots/15888"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1431%2Fevents%2F14304?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.775245ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1431/events/14304",
    "startDate": "2022-07-29T22:22:11+00:00",
    "endDate": "2022-07-30T04:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1431",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1431#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1410%2Fevents%2F14098?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.375538ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1410/events/14098",
    "startDate": "2022-07-30T17:37:11+00:00",
    "endDate": "2022-07-30T20:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1410",
      "name": "Rubber Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1410#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          ...
          "price": 18.02,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT11H1M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1548%2Ffacility-use-slots%2F15474?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.974731ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1548",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1548/facility-use-slots/15474#/offers/0",
        ...
        "price": 12.85,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT7H10M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-28T00:52:12+00:00",
    "endDate": "2022-07-28T04:31:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1589%2Ffacility-use-slots%2F15888?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.586524ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1589",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1589/facility-use-slots/15888#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT13H19M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-23T06:48:12+00:00",
    "endDate": "2022-07-23T10:51:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2a736f14-e51d-4bac-915f-359ed079a477
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1431#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1431/events/14304"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1410#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1410/events/14098"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1548/facility-use-slots/15474#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1548/facility-use-slots/15474"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1589/facility-use-slots/15888#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1589/facility-use-slots/15888"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 401 Unauthorized. Responded in 118.750965ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2a736f14-e51d-4bac-915f-359ed079a477
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clara_MacGyver@hotmail.com",
    "telephone": "247-998-1826 x55266",
    "givenName": "Turner",
    "familyName": "Salvador",
    "identifier": "59a8cd2d-de01-45d9-b72e-4c24619714da"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 10.199869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2a736f14-e51d-4bac-915f-359ed079a477
...
---
Response status code: 401 Unauthorized. Responded in 49.905426ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
