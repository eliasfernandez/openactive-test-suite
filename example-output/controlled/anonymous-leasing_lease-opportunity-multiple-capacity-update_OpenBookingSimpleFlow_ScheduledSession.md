...
---
Response status code: 200 OK. Responded in 51.38396ms.
```json
{
...
---
Response status code: 200 OK. Responded in 666.697672ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2403/events/20403",
  "modified": 1658486603468,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2d8eed1d-e98a-4396-9983-6c97d7b9ed26
...
---
Response status code: 200 OK. Responded in 201.297004ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2d8eed1d-e98a-4396-9983-6c97d7b9ed26",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2403%2Fevents%2F20403?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 222.884397ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2403/events/20403",
  "modified": 1658486604577,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5170aa7d-880b-4c5e-a5b1-0eb6057564de
...
---
Response status code: 409 Conflict. Responded in 249.509935ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5170aa7d-880b-4c5e-a5b1-0eb6057564de",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 6.072654ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2eb07885-5936-4e30-b466-cec8c2c2c8d0
...
---
Response status code: 200 OK. Responded in 108.065768ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2eb07885-5936-4e30-b466-cec8c2c2c8d0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:24+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2403%2Fevents%2F20403?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 365.816777ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2403/events/20403",
  "modified": 1658486606397,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d8be4d2a-70dc-45aa-b8a9-8cf3059cfe6e
...
---
Response status code: 409 Conflict. Responded in 215.239528ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d8be4d2a-70dc-45aa-b8a9-8cf3059cfe6e",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 18.364065ms.
```json
{
  "data": {
    "@context": [
