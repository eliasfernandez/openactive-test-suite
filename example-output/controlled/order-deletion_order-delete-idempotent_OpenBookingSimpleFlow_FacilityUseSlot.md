...
---
Response status code: 200 OK. Responded in 30.320768ms.
```json
{
...
---
Response status code: 200 OK. Responded in 918.332504ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395",
  "modified": 1658486617870,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:43:35+00:00",
    "endDate": "2022-07-23T11:43:35+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7
...
---
Response status code: 200 OK. Responded in 247.943288ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2395%2Ffacility-use-slots%2F20395?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1260.222621ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395",
  "modified": 1658486619698,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Earnestine44@yahoo.com",
    "telephone": "336-373-2138",
    "givenName": "Veum",
    "familyName": "Trinity",
    "identifier": "8c7640c4-ed3b-406e-af65-b450ae06ab0a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 878.950956ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:39+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.500819ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7
...
---
Response status code: 201 Created. Responded in 229.490725ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7#/orderedItems/2031",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 10.068588ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/orders/d1565afe-b1ed-4b30-a1ec-4de9700cf3e7
...
---
Response status code: 204 No Content. Responded in 161.851628ms.
...
---
Response status code: 204 No Content. Responded in 11.514001ms.
### Specs
