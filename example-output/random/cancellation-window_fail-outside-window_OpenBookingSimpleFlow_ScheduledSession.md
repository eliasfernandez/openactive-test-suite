...
---
Response status code: 200 OK. Responded in 82.108554ms.
```json
{
...
---
Response status code: 200 OK. Responded in 18.668085ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4676",
    "startDate": "2022-07-23T22:25:11+00:00",
    "endDate": "2022-07-24T00:07:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 6.7,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT7H15M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d5763c01-94bc-4d68-8584-39b691c5cb55
...
---
Response status code: 200 OK. Responded in 166.88515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d5763c01-94bc-4d68-8584-39b691c5cb55",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:18+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F468%2Fevents%2F4676?useCacheIfAvailable=true&expectedCapacity=11


---
Response status code: 200 OK. Responded in 303.591166ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4676",
  "modified": 1658486539932,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d5763c01-94bc-4d68-8584-39b691c5cb55
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gaston17@gmail.com",
    "telephone": "(318) 905-8855",
    "givenName": "Schaden",
    "familyName": "Kylee",
    "identifier": "c7f540b6-3874-4afd-b1a4-1f5ee87db1e0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 288.897697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:19+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 20.168599ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d5763c01-94bc-4d68-8584-39b691c5cb55
...
---
Response status code: 201 Created. Responded in 133.434484ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d5763c01-94bc-4d68-8584-39b691c5cb55",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5763c01-94bc-4d68-8584-39b691c5cb55#/orderedItems/1635",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 47.613108ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/d5763c01-94bc-4d68-8584-39b691c5cb55
...
---
Response status code: 400 Bad Request. Responded in 25.014772ms.
```json
{
  "@context": "https://openactive.io/",
