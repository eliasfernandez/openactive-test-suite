...
⚠️ 15 passed with 0 failures, 148 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 20.028424ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/596"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F596?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.457304ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/596",
    "startDate": "2022-07-26T20:31:11+00:00",
    "endDate": "2022-07-27T02:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/596"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 34.194953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:30+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F596?useCacheIfAvailable=true&expectedCapacity=35


---
Response status code: 200 OK. Responded in 124.668815ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/596",
  "modified": 1658486251952,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kara_Von48@gmail.com",
    "telephone": "704.383.8334 x41921",
    "givenName": "Morar",
    "familyName": "Maddison",
    "identifier": "403c5eaf-0a0e-49f8-979a-a60a31e16306"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 64.858048ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:31+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 5.486889ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5
...
---
Response status code: 201 Created. Responded in 55.406496ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5#/orderedItems/830",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/60#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 11.80209ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5


---
Response status code: 200 OK. Responded in 11.094479ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940830394863331&afterId=bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "message": "Listening for UUID: 'f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 27.086737ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessCodeUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5


---
Response status code: 200 OK. Responded in 2091.479308ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5",
  "modified": 637940830533770200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5",
    "identifier": "f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/f1cef5ee-8d19-48d2-aa39-9c7d1178e7b5#/orderedItems/830",
