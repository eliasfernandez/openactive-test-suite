...
---
Response status code: 200 OK. Responded in 53.56248ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1516.951084ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2455/facility-use-slots/20455",
  "modified": 1658486756370,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:45:53+00:00",
    "endDate": "2022-07-23T11:45:53+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c551e4bc-538b-48a9-b1c7-64ec0ff63f31
...
---
Response status code: 200 OK. Responded in 350.465538ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c551e4bc-538b-48a9-b1c7-64ec0ff63f31",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2455%2Ffacility-use-slots%2F20455?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1031.170334ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2455/facility-use-slots/20455",
  "modified": 1658486757883,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c551e4bc-538b-48a9-b1c7-64ec0ff63f31
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mia61@yahoo.com",
    "telephone": "1-971-276-1416",
    "givenName": "Leffler",
    "familyName": "Andre",
    "identifier": "e3823567-8c57-4e42-8c14-2cb0fa525a6d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 601.90339ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.162809ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c551e4bc-538b-48a9-b1c7-64ec0ff63f31
...
---
Response status code: 400 Bad Request. Responded in 496.649448ms.
```json
{
  "@context": "https://openactive.io/",
