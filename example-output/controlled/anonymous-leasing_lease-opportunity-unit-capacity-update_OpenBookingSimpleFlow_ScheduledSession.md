...
---
Response status code: 200 OK. Responded in 43.611687ms.
```json
{
...
---
Response status code: 200 OK. Responded in 958.054397ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423",
  "modified": 1658486651701,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/61f8ef75-dde3-477a-9fa4-916209afa6e6
...
---
Response status code: 200 OK. Responded in 217.702731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/61f8ef75-dde3-477a-9fa4-916209afa6e6",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2423%2Fevents%2F20423?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 879.307999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423",
  "modified": 1658486653332,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5878c63a-a7fb-45e9-98c8-0aab42a4a413
...
---
Response status code: 409 Conflict. Responded in 459.628677ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5878c63a-a7fb-45e9-98c8-0aab42a4a413",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:12+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.440984ms.
```json
{
  "data": {
    "@context": [
