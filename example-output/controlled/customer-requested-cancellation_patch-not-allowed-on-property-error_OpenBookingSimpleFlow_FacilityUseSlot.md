...
---
Response status code: 200 OK. Responded in 301.427036ms.
```json
{
...
---
Response status code: 200 OK. Responded in 983.650901ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2279/facility-use-slots/20279",
  "modified": 1658486361069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:19+00:00",
    "endDate": "2022-07-23T11:39:19+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/96b8ff60-be53-4dbc-aeb8-85e568d01f41
...
---
Response status code: 200 OK. Responded in 84.269219ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/96b8ff60-be53-4dbc-aeb8-85e568d01f41",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:20+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2279%2Ffacility-use-slots%2F20279?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1258.471947ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2279/facility-use-slots/20279",
  "modified": 1658486362673,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/96b8ff60-be53-4dbc-aeb8-85e568d01f41
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dayne.Tillman80@yahoo.com",
    "telephone": "887-475-4993",
    "givenName": "Bogisich",
    "familyName": "Lilyan",
    "identifier": "ef2496da-5ee3-490a-97d6-ec0a021724c7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 148.068265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.922128ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/96b8ff60-be53-4dbc-aeb8-85e568d01f41
...
---
Response status code: 201 Created. Responded in 274.841847ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/96b8ff60-be53-4dbc-aeb8-85e568d01f41",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/96b8ff60-be53-4dbc-aeb8-85e568d01f41#/orderedItems/1262",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2279/facility-use-slots/20279#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 27.496834ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/96b8ff60-be53-4dbc-aeb8-85e568d01f41
...
---
Response status code: 400 Bad Request. Responded in 191.498535ms.
```json
{
  "@context": "https://openactive.io/",
