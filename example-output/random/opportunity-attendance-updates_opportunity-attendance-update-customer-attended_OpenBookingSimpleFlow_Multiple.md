...
---
Response status code: 200 OK. Responded in 25.139306ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5462"
}
```
...
---
Response status code: 200 OK. Responded in 24.915802ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2070"
}
```
...
---
Response status code: 200 OK. Responded in 25.133406ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889"
}
```
...
---
Response status code: 200 OK. Responded in 25.593413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F547%2Fevents%2F5462?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.91617ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5462",
    "startDate": "2022-07-23T03:14:11+00:00",
    "endDate": "2022-07-23T08:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/547",
      "name": "Wooden Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/547#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F207%2Fevents%2F2070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.361661ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2070",
    "startDate": "2022-07-23T11:46:11+00:00",
    "endDate": "2022-07-23T12:45:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/207",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/207#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F589%2Ffacility-use-slots%2F5889?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.813852ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/589",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 3.32,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT20H10M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-26T23:10:12+00:00",
    "endDate": "2022-07-27T02:49:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2%2Ffacility-use-slots%2F16?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.939971ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-24T14:22:11+00:00",
    "endDate": "2022-07-24T15:54:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/547#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5462"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/207#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2070"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 444.918983ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:13+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/547"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/207"
        },
        "maximumAttendeeCapacity": 21,
        "remainingAttendeeCapacity": 21
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/589"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-26T23:10:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F547%2Fevents%2F5462?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 292.719326ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/547/events/5462",
  "modified": 1658486595778,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F207%2Fevents%2F2070?useCacheIfAvailable=true&expectedCapacity=20


---
Response status code: 200 OK. Responded in 292.905829ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2070",
  "modified": 1658486595780,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F589%2Ffacility-use-slots%2F5889?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 849.254227ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889",
  "modified": 1658486596336,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2%2Ffacility-use-slots%2F16?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 849.960156ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16",
  "modified": 1658486596339,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Miguel_Wolff@yahoo.com",
    "telephone": "(243) 863-2236",
    "givenName": "Strosin",
    "familyName": "Kaci",
    "identifier": "aad831d2-aaf9-4b24-9c74-6b70cce4319c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 506.237428ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 27.463756ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.434718ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.550792ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.574421ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40
...
---
Response status code: 201 Created. Responded in 496.962772ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1805",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/547#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1806",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/547#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1807",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/207#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1808",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1809",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/589/facility-use-slots/5889#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1810",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2/facility-use-slots/16#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 39.458122ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 38.470394ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.826434ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.248717ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40


---
Response status code: 200 OK. Responded in 34.80899ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940833945584979&afterId=8e2cd437-8dda-40c9-8f42-167bab104f92",
  "message": "Listening for UUID: '5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 34.806489ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AttendeeAttendedSimulateAction)

### Orders (orders) Feed collect for &#x27;5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40


---
Response status code: 200 OK. Responded in 2024.253379ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40",
  "modified": 637940834098867100,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40",
    "identifier": "5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/5bcb2f4c-24d3-4bf8-8cbd-ef70396f3e40#/orderedItems/1810",
