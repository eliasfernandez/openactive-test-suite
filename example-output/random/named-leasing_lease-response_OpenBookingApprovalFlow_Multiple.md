...
⚠️ 41 passed with 0 failures, 563 warnings and 150 suggestions 
...
---
Response status code: 200 OK. Responded in 18.782394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14569"
}
```
...
---
Response status code: 200 OK. Responded in 19.499513ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15387"
}
```
...
---
Response status code: 200 OK. Responded in 20.09813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1195/facility-use-slots/11941"
}
```
...
---
Response status code: 200 OK. Responded in 20.731946ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11658"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1457%2Fevents%2F14569?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.258991ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14569",
    "startDate": "2022-07-30T12:10:11+00:00",
    "endDate": "2022-07-30T14:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT13H15M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1539%2Fevents%2F15387?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.865981ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15387",
    "startDate": "2022-07-26T05:05:11+00:00",
    "endDate": "2022-07-26T08:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1195%2Ffacility-use-slots%2F11941?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.514972ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1195",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1195/facility-use-slots/11941#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 5,
    "startDate": "2022-07-23T13:11:12+00:00",
    "endDate": "2022-07-23T18:32:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11658?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.820338ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11658#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-27T23:08:12+00:00",
    "endDate": "2022-07-28T01:14:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/99eac71f-14d7-4894-8847-c06e77a859bd
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14569"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15387"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1195/facility-use-slots/11941#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1195/facility-use-slots/11941"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11658#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11658"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 524.48311ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/99eac71f-14d7-4894-8847-c06e77a859bd",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:32+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1195"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-23T13:11:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1457%2Fevents%2F14569?useCacheIfAvailable=true&expectedCapacity=12


---
Response status code: 200 OK. Responded in 580.058673ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14569",
  "modified": 1658486674318,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1539%2Fevents%2F15387?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 580.545886ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1539/events/15387",
  "modified": 1658486674320,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1195%2Ffacility-use-slots%2F11941?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 542.443182ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1195/facility-use-slots/11941",
  "modified": 1658486674282,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11658?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 542.280578ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11658",
  "modified": 1658486674283,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/99eac71f-14d7-4894-8847-c06e77a859bd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adam.Lueilwitz42@yahoo.com",
    "telephone": "979-701-8923",
    "givenName": "Rohan",
    "familyName": "Dorothea",
    "identifier": "8b6ea4ed-dd53-499c-8bae-4bec6bbe67b7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 555.893302ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:35+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 12.427427ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.79511ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.295097ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.866985ms.
```json
{
  "data": {
    "@context": [
