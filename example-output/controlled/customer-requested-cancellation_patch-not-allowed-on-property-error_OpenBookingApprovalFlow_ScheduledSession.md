...
---
Response status code: 200 OK. Responded in 32.283169ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1055.502189ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2301/events/20301",
  "modified": 1658486378777,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2301/events/20301",
    "startDate": "2022-07-23T10:39:36+00:00",
    "endDate": "2022-07-23T11:39:36+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6
...
---
Response status code: 200 OK. Responded in 168.690405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2301%2Fevents%2F20301?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 243.281625ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2301/events/20301",
  "modified": 1658486379458,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Khalil.Kuhic58@yahoo.com",
    "telephone": "376-465-0150 x3080",
    "givenName": "Hammes",
    "familyName": "Veda",
    "identifier": "89c5a814-9532-4412-9242-bbcf795b949a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 124.367836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 37.944916ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6
...
---
Response status code: 201 Created. Responded in 281.191541ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6#/orderedItems/1326",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2301#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6/versions/bcfa10d9-c3d4-4987-9cd1-0f17e3f4dcbf",
  "payment": {
    "@type": "Payment",
    "identifier": "UYFLx2Sl2",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;6bdc46b4-e446-4bda-b10a-b5cfc15f00b6&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6


---
Response status code: 200 OK. Responded in 8.456871ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '6bdc46b4-e446-4bda-b10a-b5cfc15f00b6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 528.601301ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;6bdc46b4-e446-4bda-b10a-b5cfc15f00b6&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6


---
Response status code: 200 OK. Responded in 1799.313782ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  "modified": 637940831793898600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
    "identifier": "6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
...
---
Response status code: 200 OK. Responded in 63.976532ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6
...
---
Response status code: 201 Created. Responded in 123.829331ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  "identifier": "6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1729.305476ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "6bdc46b4-e446-4bda-b10a-b5cfc15f00b6",
  "modified": 637940831818526000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.227011ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/6bdc46b4-e446-4bda-b10a-b5cfc15f00b6
...
---
Response status code: 400 Bad Request. Responded in 8.991375ms.
```json
{
  "@context": "https://openactive.io/",
