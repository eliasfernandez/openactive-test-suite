...
---
Response status code: 200 OK. Responded in 67.827167ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4316"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F432%2Fevents%2F4316?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.575923ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4316",
    "startDate": "2022-07-29T05:40:11+00:00",
    "endDate": "2022-07-29T10:54:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/432",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/432#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b6d111a7-1b9d-462c-91c8-85c2e52a547b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/432#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4316"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 146.451603ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b6d111a7-1b9d-462c-91c8-85c2e52a547b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F432%2Fevents%2F4316?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 276.350745ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4316",
  "modified": 1658486375969,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b6d111a7-1b9d-462c-91c8-85c2e52a547b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Piper_Parisian92@hotmail.com",
    "telephone": "638.529.9016",
    "givenName": "Cronin",
    "familyName": "Ricardo",
    "identifier": "1dc8dfc5-b0e1-4eb6-8751-d257b3ea12a0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 80.629168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:35+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.685673ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b6d111a7-1b9d-462c-91c8-85c2e52a547b
...
---
Response status code: 201 Created. Responded in 53.885347ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b6d111a7-1b9d-462c-91c8-85c2e52a547b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b6d111a7-1b9d-462c-91c8-85c2e52a547b#/orderedItems/1096",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/432#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 5.021579ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/b6d111a7-1b9d-462c-91c8-85c2e52a547b
...
---
Response status code: 400 Bad Request. Responded in 93.300867ms.
```json
{
  "@context": "https://openactive.io/",
