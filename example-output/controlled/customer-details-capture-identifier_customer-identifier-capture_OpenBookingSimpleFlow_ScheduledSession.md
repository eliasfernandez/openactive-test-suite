...
⚠️ 14 passed with 0 failures, 136 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 177.555161ms.
```json
{
...
---
Response status code: 200 OK. Responded in 723.377918ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2360/events/20360",
  "modified": 1658486488273,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c6b07a4e-b657-4377-bae9-76d70aeab166
...
---
Response status code: 200 OK. Responded in 111.130757ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c6b07a4e-b657-4377-bae9-76d70aeab166",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2360%2Fevents%2F20360?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 443.533717ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2360/events/20360",
  "modified": 1658486489194,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c6b07a4e-b657-4377-bae9-76d70aeab166
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Else_Beahan81@gmail.com",
    "telephone": "727-347-3270",
    "givenName": "Stroman",
    "familyName": "Nova",
    "identifier": "b788b3b6-f4a8-4742-bc68-979f8d235594"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 76.718561ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.130874ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c6b07a4e-b657-4377-bae9-76d70aeab166
...
---
Response status code: 201 Created. Responded in 71.266213ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c6b07a4e-b657-4377-bae9-76d70aeab166",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c6b07a4e-b657-4377-bae9-76d70aeab166#/orderedItems/1701",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2360#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 11.899403ms.
```json
{
  "data": {
    "@context": [
