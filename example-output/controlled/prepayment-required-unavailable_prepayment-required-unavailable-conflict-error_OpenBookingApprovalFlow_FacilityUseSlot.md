...
---
Response status code: 200 OK. Responded in 60.828714ms.
```json
{
...
---
Response status code: 200 OK. Responded in 117.071099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 803.408104ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2102/facility-use-slots/20102",
  "modified": 1658486112485,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:35:10+00:00",
    "endDate": "2022-07-23T11:35:10+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 802.912101ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2103/facility-use-slots/20103",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dd0908c2-d241-432d-bead-983c89b534de
...
---
Response status code: 409 Conflict. Responded in 282.147933ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dd0908c2-d241-432d-bead-983c89b534de",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dd0908c2-d241-432d-bead-983c89b534de
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mekhi95@hotmail.com",
    "telephone": "970-483-7850 x432",
    "givenName": "McCullough",
    "familyName": "Craig",
    "identifier": "fdf993ea-2c16-49b5-bcfc-fe957e7038fa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 65.217347ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/dd0908c2-d241-432d-bead-983c89b534de
...
---
Response status code: 409 Conflict. Responded in 44.063602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/dd0908c2-d241-432d-bead-983c89b534de",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
