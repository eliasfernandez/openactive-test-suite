...
---
Response status code: 200 OK. Responded in 34.894812ms.
```json
{
...
---
Response status code: 200 OK. Responded in 746.985464ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463",
  "modified": 1658486736434,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/be40c8e4-854e-42ef-981c-2309e71f802c
...
---
Response status code: 200 OK. Responded in 2020.8619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/be40c8e4-854e-42ef-981c-2309e71f802c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2463%2Fevents%2F20463?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 449.385025ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463",
  "modified": 1658486739670,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/be40c8e4-854e-42ef-981c-2309e71f802c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aron_Mayert@gmail.com",
    "telephone": "620-968-2167",
    "givenName": "Corkery",
    "familyName": "Tatyana",
    "identifier": "b95f3746-a496-41e8-9289-4f63ed3422b3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1302.387565ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.031417ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/be40c8e4-854e-42ef-981c-2309e71f802c
...
---
Response status code: 400 Bad Request. Responded in 322.544489ms.
```json
{
  "@context": "https://openactive.io/",
