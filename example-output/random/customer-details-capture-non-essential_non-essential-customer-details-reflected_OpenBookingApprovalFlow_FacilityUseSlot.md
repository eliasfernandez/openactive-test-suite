...
---
Response status code: 200 OK. Responded in 15.324728ms.
```json
{
...
---
Response status code: 200 OK. Responded in 7.537212ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT19H10M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-28T09:57:12+00:00",
    "endDate": "2022-07-28T13:59:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60
...
---
Response status code: 200 OK. Responded in 106.299683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1488%2Ffacility-use-slots%2F14874?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1041.950319ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874",
  "modified": 1658486247449,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ada_Cormier@hotmail.com",
    "telephone": "1-362-548-6098 x1063",
    "givenName": "Wintheiser",
    "familyName": "Wilhelmine",
    "identifier": "0d7effca-69f8-4e0f-9177-31c55fa1cf36"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 580.311244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:27+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.72967ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60
...
---
Response status code: 201 Created. Responded in 87.305101ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60#/orderedItems/820",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60/versions/7cf17e8a-c397-44b3-8fa5-5bd7a1e57676",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60


---
Response status code: 200 OK. Responded in 6.867702ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830420508736&afterId=7d8c5ddd-1893-41bf-8a6c-cd803258d187",
  "message": "Listening for UUID: '47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 50.852357ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60


---
Response status code: 200 OK. Responded in 2045.718315ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  "modified": 637940830476037800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
    "identifier": "47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
...
---
Response status code: 200 OK. Responded in 14.24453ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60
...
---
Response status code: 201 Created. Responded in 67.01478ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  "identifier": "47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1068.811578ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "47c4feed-cadc-4a1e-a3a3-d3fdc5bd8f60",
  "modified": 637940830497316000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 23.661482ms.
```json
{
  "data": {
    "@context": [
