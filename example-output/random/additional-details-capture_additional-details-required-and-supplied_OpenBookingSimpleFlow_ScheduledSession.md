...
---
Response status code: 200 OK. Responded in 77.422491ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/676/events/6753"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F676%2Fevents%2F6753?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.179738ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/676/events/6753",
    "startDate": "2022-07-23T08:53:11+00:00",
    "endDate": "2022-07-23T09:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/676",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/676#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT20H30M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6b74c24b-9be3-4533-a878-a9a4865035f2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/676#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/676/events/6753"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 415.373597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6b74c24b-9be3-4533-a878-a9a4865035f2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:20+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/676"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F676%2Fevents%2F6753?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 526.251532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/676/events/6753",
  "modified": 1658486962742,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6b74c24b-9be3-4533-a878-a9a4865035f2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rudolph_Runolfsdottir@hotmail.com",
    "telephone": "688-540-7462 x13415",
    "givenName": "Bechtelar",
    "familyName": "Davin",
    "identifier": "7940c4e4-6869-43e4-a3e6-bb478cb1abe9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 324.726952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 44.14135ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6b74c24b-9be3-4533-a878-a9a4865035f2
...
---
Response status code: 201 Created. Responded in 391.949146ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6b74c24b-9be3-4533-a878-a9a4865035f2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6b74c24b-9be3-4533-a878-a9a4865035f2#/orderedItems/2740",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/676#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 44.904097ms.
```json
{
  "data": {
    "@context": [
