...
⚠️ 53 passed with 0 failures, 808 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 232.449601ms.
```json
{
...
---
Response status code: 200 OK. Responded in 182.843017ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 154.786699ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 166.873993ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 571.900431ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2185/events/20185",
  "modified": 1658486204887,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2185/events/20185",
    "startDate": "2022-07-23T10:36:43+00:00",
    "endDate": "2022-07-23T11:36:43+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 569.704714ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2184/events/20184",
  "modified": 1658486204885,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 437.389389ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2178/facility-use-slots/20178",
  "modified": 1658486204754,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 437.201088ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2179/facility-use-slots/20179",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/830080bf-dc43-4b99-a56f-432bb0d51558
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2178/facility-use-slots/20178"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 222.595025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/830080bf-dc43-4b99-a56f-432bb0d51558",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:44+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2185%2Fevents%2F20185?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 32.773854ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2185/events/20185",
  "modified": 1658486206295,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2184%2Fevents%2F20184?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 32.931455ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2184/events/20184",
  "modified": 1658486206296,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2178%2Ffacility-use-slots%2F20178?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 308.300089ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2178/facility-use-slots/20178",
  "modified": 1658486206573,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2179%2Ffacility-use-slots%2F20179?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 308.175488ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2179/facility-use-slots/20179",
  "modified": 1658486206574,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/830080bf-dc43-4b99-a56f-432bb0d51558
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sophia.Pollich15@yahoo.com",
    "telephone": "(275) 531-8250 x7622",
    "givenName": "Cartwright",
    "familyName": "Velva",
    "identifier": "723d7b68-c709-46b1-8c86-76ad97195993"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 368.312954ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.015051ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.288445ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.735341ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.196507ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/830080bf-dc43-4b99-a56f-432bb0d51558
...
---
Response status code: 201 Created. Responded in 618.696644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/830080bf-dc43-4b99-a56f-432bb0d51558",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/841",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2185#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/842",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2185#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/843",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2184#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/844",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2178/facility-use-slots/20178#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/845",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2178/facility-use-slots/20178#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558#/orderedItems/846",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2179/facility-use-slots/20179#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/830080bf-dc43-4b99-a56f-432bb0d51558/versions/851dd97c-6248-4db1-91ca-e72745fe9f67",
  "payment": {
    "@type": "Payment",
    "identifier": "0h7eGt-2O",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;830080bf-dc43-4b99-a56f-432bb0d51558&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/830080bf-dc43-4b99-a56f-432bb0d51558


---
Response status code: 200 OK. Responded in 3.796829ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830009504366&afterId=c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "message": "Listening for UUID: '830080bf-dc43-4b99-a56f-432bb0d51558' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 11.751889ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;830080bf-dc43-4b99-a56f-432bb0d51558&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/830080bf-dc43-4b99-a56f-432bb0d51558


---
Response status code: 200 OK. Responded in 2249.231984ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "830080bf-dc43-4b99-a56f-432bb0d51558",
  "modified": 637940830088286600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/830080bf-dc43-4b99-a56f-432bb0d51558",
    "identifier": "830080bf-dc43-4b99-a56f-432bb0d51558",
...
---
Response status code: 200 OK. Responded in 3.600127ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830088286548&afterId=830080bf-dc43-4b99-a56f-432bb0d51558",
  "message": "Listening for UUID: '830080bf-dc43-4b99-a56f-432bb0d51558' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558
...
---
Response status code: 201 Created. Responded in 221.468062ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/830080bf-dc43-4b99-a56f-432bb0d51558",
  "identifier": "830080bf-dc43-4b99-a56f-432bb0d51558",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 12.466417ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "830080bf-dc43-4b99-a56f-432bb0d51558",
  "modified": 637940830112358000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 10.286497ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.638691ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.052985ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.631982ms.
```json
{
  "data": {
    "@context": [
