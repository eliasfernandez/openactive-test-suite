...
⚠️ 15 passed with 0 failures, 157 warnings and 58 suggestions 
...
---
Response status code: 200 OK. Responded in 63.096558ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/358/events/3578"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F358%2Fevents%2F3578?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.345979ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/358/events/3578",
    "startDate": "2022-07-29T14:48:11+00:00",
    "endDate": "2022-07-29T15:21:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/358",
      "name": "Cotton Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/358#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 18.84,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT6H59M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/311f921f-7bb7-4229-ae90-82a01db8348e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/358#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/358/events/3578"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 187.990955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/311f921f-7bb7-4229-ae90-82a01db8348e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F358%2Fevents%2F3578?useCacheIfAvailable=true&expectedCapacity=21


---
Response status code: 200 OK. Responded in 500.118297ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/358/events/3578",
  "modified": 1658486341331,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/311f921f-7bb7-4229-ae90-82a01db8348e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annalise.Bechtelar26@gmail.com",
    "telephone": "547-208-1684 x72159",
    "givenName": "Hodkiewicz",
    "familyName": "Josue",
    "identifier": "2bcac19d-43e2-4dd2-b965-0e33f8b3ba22"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 165.796118ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 27.552419ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/311f921f-7bb7-4229-ae90-82a01db8348e
...
---
Response status code: 201 Created. Responded in 71.217482ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/311f921f-7bb7-4229-ae90-82a01db8348e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/311f921f-7bb7-4229-ae90-82a01db8348e#/orderedItems/1055",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/358#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.634098ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f2655dc3-4bc1-4559-b685-4a5afe32af82
...
---
Response status code: 500 Internal Server Error. Responded in 27.444017ms.
```json
{
  "@context": "https://openactive.io/",
