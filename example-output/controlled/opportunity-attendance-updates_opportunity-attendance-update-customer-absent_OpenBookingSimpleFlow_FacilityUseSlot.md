...
---
Response status code: 200 OK. Responded in 183.887089ms.
```json
{
...
---
Response status code: 200 OK. Responded in 979.221561ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2358/facility-use-slots/20358",
  "modified": 1658486519433,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:41:57+00:00",
    "endDate": "2022-07-23T11:41:57+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611
...
---
Response status code: 200 OK. Responded in 119.684634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2358%2Ffacility-use-slots%2F20358?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 688.189589ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2358/facility-use-slots/20358",
  "modified": 1658486520534,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "1-327-230-6448",
    "givenName": "Gorczany",
    "familyName": "Colleen",
    "identifier": "829a6977-3b4b-4e61-a9cf-d5a2b9ca40b8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 362.315746ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.609221ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611
...
---
Response status code: 201 Created. Responded in 204.891135ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611#/orderedItems/1798",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2358/facility-use-slots/20358#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.682377ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611


---
Response status code: 200 OK. Responded in 3.781034ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 22.526002ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AttendeeAbsentSimulateAction)

### Orders (orders) Feed collect for &#x27;44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611


---
Response status code: 200 OK. Responded in 2095.400767ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611",
  "modified": 637940833217346300,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611",
    "identifier": "44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/44ec0dc0-d8b7-48fb-ba0a-d7c28dd01611#/orderedItems/1798",
