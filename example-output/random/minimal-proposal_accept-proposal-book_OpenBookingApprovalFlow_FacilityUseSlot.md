...
⚠️ 22 passed with 0 failures, 140 warnings and 16 suggestions 
...
---
Response status code: 200 OK. Responded in 4.485277ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1051%2Ffacility-use-slots%2F10508?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.351757ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-31T12:21:12+00:00",
    "endDate": "2022-07-31T13:41:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/85a206db-ee38-420c-8d17-b25a769a851a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 45.717478ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/85a206db-ee38-420c-8d17-b25a769a851a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:40+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1051%2Ffacility-use-slots%2F10508?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 824.035836ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508",
  "modified": 1658486081994,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/85a206db-ee38-420c-8d17-b25a769a851a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Consuelo.Bogan74@yahoo.com",
    "telephone": "1-541-228-4761",
    "givenName": "Conn",
    "familyName": "Joelle",
    "identifier": "e9acc8c7-7630-4088-9d05-49bc40fec3b3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 90.036634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 6.956719ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/85a206db-ee38-420c-8d17-b25a769a851a
...
---
Response status code: 201 Created. Responded in 65.933323ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/85a206db-ee38-420c-8d17-b25a769a851a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/85a206db-ee38-420c-8d17-b25a769a851a#/orderedItems/382",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1051/facility-use-slots/10508#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/85a206db-ee38-420c-8d17-b25a769a851a/versions/1d4a75fe-bfd2-42ee-98f1-b69e5256ac0f",
  "payment": {
    "@type": "Payment",
    "identifier": "lpkrFQ2N9",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;85a206db-ee38-420c-8d17-b25a769a851a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/85a206db-ee38-420c-8d17-b25a769a851a


---
Response status code: 200 OK. Responded in 21.390564ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828786073328&afterId=9e5484b4-85f3-4a62-bd3e-3493249e66c3",
  "message": "Listening for UUID: '85a206db-ee38-420c-8d17-b25a769a851a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 18.144709ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;85a206db-ee38-420c-8d17-b25a769a851a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/85a206db-ee38-420c-8d17-b25a769a851a


---
Response status code: 200 OK. Responded in 2539.367657ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "85a206db-ee38-420c-8d17-b25a769a851a",
  "modified": 637940828816759900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/85a206db-ee38-420c-8d17-b25a769a851a",
    "identifier": "85a206db-ee38-420c-8d17-b25a769a851a",
...
---
Response status code: 200 OK. Responded in 21.442344ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828816759916&afterId=85a206db-ee38-420c-8d17-b25a769a851a",
  "message": "Listening for UUID: '85a206db-ee38-420c-8d17-b25a769a851a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/85a206db-ee38-420c-8d17-b25a769a851a
...
---
Response status code: 201 Created. Responded in 63.900628ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/85a206db-ee38-420c-8d17-b25a769a851a",
  "identifier": "85a206db-ee38-420c-8d17-b25a769a851a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 530.861239ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "85a206db-ee38-420c-8d17-b25a769a851a",
  "modified": 637940828842784300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.818693ms.
```json
{
  "data": {
    "@context": [
