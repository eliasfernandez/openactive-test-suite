...
---
Response status code: 200 OK. Responded in 68.345098ms.
```json
{
...
---
Response status code: 200 OK. Responded in 819.258477ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2154/events/20154",
  "modified": 1658486173099,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2154/events/20154",
    "startDate": "2022-07-23T10:36:11+00:00",
    "endDate": "2022-07-23T11:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9
...
---
Response status code: 200 OK. Responded in 39.380987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2154%2Fevents%2F20154?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 615.287889ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2154/events/20154",
  "modified": 1658486174161,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nikita59@hotmail.com",
    "telephone": "595.628.2689 x9137",
    "givenName": "Mayer",
    "familyName": "Juliana",
    "identifier": "e0ddc2c2-7c6b-45c4-9571-6b0328aa6ed5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 59.273032ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 7.473655ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9
...
---
Response status code: 201 Created. Responded in 41.379502ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4162c354-fe5c-4b3c-9bfd-9d7dff148ab9#/orderedItems/711",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2154#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 9.107472ms.
```json
{
  "data": {
    "@context": [
