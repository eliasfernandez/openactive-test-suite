...
---
Response status code: 200 OK. Responded in 11.600795ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11657?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.12647ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-26T05:17:12+00:00",
    "endDate": "2022-07-26T09:53:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 514.873854ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:23+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1166%2Ffacility-use-slots%2F11657?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 198.14073ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657",
  "modified": 1658487085822,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Arno.Russel@hotmail.com",
    "telephone": "1-864-793-1739",
    "givenName": "Kovacek",
    "familyName": "Junior",
    "identifier": "951d53f8-3e6c-4e55-b2e7-90ece9000500"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 599.518676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:24+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.184356ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d
...
---
Response status code: 201 Created. Responded in 367.210072ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d#/orderedItems/3016",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1166/facility-use-slots/11657#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d/versions/4c207f1b-f965-499c-85ad-b29d1979de0c",
  "payment": {
    "@type": "Payment",
    "identifier": "HmFEuzTmO",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d


---
Response status code: 200 OK. Responded in 12.347108ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838830027227&afterId=153de08a-e0cb-43b4-8f97-394757053572",
  "message": "Listening for UUID: '41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 24.762816ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d


---
Response status code: 200 OK. Responded in 2342.055562ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "modified": 637940838863484200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
    "identifier": "41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
...
---
Response status code: 200 OK. Responded in 9.632262ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838863484183&afterId=41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "message": "Listening for UUID: '41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d
...
---
Response status code: 201 Created. Responded in 905.848924ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "identifier": "41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 780.883806ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "41a5df1b-3c7f-4de2-9b35-27dc4c2e1c0d",
  "modified": 637940838893572600
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 15.293667ms.
```json
{
  "data": {
    "@context": [
