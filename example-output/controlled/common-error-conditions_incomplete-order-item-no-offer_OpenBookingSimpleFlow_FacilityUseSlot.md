...
---
Response status code: 200 OK. Responded in 32.438043ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1088.479107ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2182/facility-use-slots/20182",
  "modified": 1658486216173,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:36:54+00:00",
    "endDate": "2022-07-23T11:36:54+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ea22de5-764e-4b56-adbe-f8e3b230531a
...
---
Response status code: 409 Conflict. Responded in 15.481046ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ea22de5-764e-4b56-adbe-f8e3b230531a",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ea22de5-764e-4b56-adbe-f8e3b230531a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Asia63@hotmail.com",
    "telephone": "1-402-872-7025 x1617",
    "givenName": "Pagac",
    "familyName": "Meredith",
    "identifier": "b0a7bfdc-a8df-4726-a713-cf64933f7596"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 14.120733ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1ea22de5-764e-4b56-adbe-f8e3b230531a
...
---
Response status code: 409 Conflict. Responded in 13.79163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1ea22de5-764e-4b56-adbe-f8e3b230531a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
