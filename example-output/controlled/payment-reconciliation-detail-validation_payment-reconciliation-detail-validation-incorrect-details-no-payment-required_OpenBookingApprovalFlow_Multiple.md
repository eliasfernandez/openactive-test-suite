...
---
Response status code: 200 OK. Responded in 649.635424ms.
```json
{
...
---
Response status code: 200 OK. Responded in 729.586453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 709.839573ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 644.641579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 281.884271ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2568/events/20568",
  "modified": 1658486965278,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2568/events/20568",
    "startDate": "2022-07-23T10:49:23+00:00",
    "endDate": "2022-07-23T11:49:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 565.326356ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2569/events/20569",
  "modified": 1658486965561,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1000.516124ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557",
  "modified": 1658486965998,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 345.836054ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2556/facility-use-slots/20556",
  "modified": 1658486965352,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0f0f1f02-a525-42ac-9a9f-3829cff1a09c
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-Rah1qG5X6-",
    "accountId": "invalid-BN4LRGiLZ",
    "paymentProviderId": "invalid-r02t34wd1f"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 167.76303ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0f0f1f02-a525-42ac-9a9f-3829cff1a09c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Patsy54@gmail.com",
    "telephone": "1-518-501-8099",
    "givenName": "Schoen",
    "familyName": "Lulu",
    "identifier": "804e8651-5860-4265-be21-18cef451a6e6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-lOQTYlKLgh",
    "accountId": "invalid-u9IBBRLQM",
    "paymentProviderId": "invalid-glFEUa7g6u"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 120.662701ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
