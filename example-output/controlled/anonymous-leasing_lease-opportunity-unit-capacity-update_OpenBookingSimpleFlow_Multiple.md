[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:44:09 GMT+0000 (Coordinated Universal Time)
...
⚠️ 17 passed with 0 failures, 177 warnings and 46 suggestions 
...
---
Response status code: 200 OK. Responded in 565.270602ms.
```json
{
...
---
Response status code: 200 OK. Responded in 362.403107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 809.771166ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2429/events/20429",
  "modified": 1658486659607,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2429/events/20429",
    "startDate": "2022-07-23T10:44:17+00:00",
    "endDate": "2022-07-23T11:44:17+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 151.203638ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2416/facility-use-slots/20416",
  "modified": 1658486658950,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/46f7dbe9-94c9-4c0d-b6cc-71acf1130458
...
---
Response status code: 200 OK. Responded in 939.591914ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/46f7dbe9-94c9-4c0d-b6cc-71acf1130458",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:19+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2429%2Fevents%2F20429?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 547.317643ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2429/events/20429",
  "modified": 1658486661485,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2416%2Ffacility-use-slots%2F20416?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 172.742529ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2416/facility-use-slots/20416",
  "modified": 1658486661115,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7b7b8cf2-5575-42de-aefb-e56788f0fb37
...
---
Response status code: 409 Conflict. Responded in 257.939382ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7b7b8cf2-5575-42de-aefb-e56788f0fb37",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 19.752475ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.834766ms.
```json
{
  "data": {
    "@context": [
