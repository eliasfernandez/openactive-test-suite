...
---
Response status code: 200 OK. Responded in 46.759111ms.
```json
{
...
---
Response status code: 200 OK. Responded in 839.253676ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2345/facility-use-slots/20345",
  "modified": 1658486485332,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595
...
---
Response status code: 200 OK. Responded in 370.724958ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2345%2Ffacility-use-slots%2F20345?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1652.459222ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2345/facility-use-slots/20345",
  "modified": 1658486487664,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "1-515-571-9731",
    "givenName": "Rosenbaum",
    "familyName": "Demetris",
    "identifier": "f928bc9f-21e2-4658-af56-8e8834efa99d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 89.463387ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.921944ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595
...
---
Response status code: 201 Created. Responded in 146.084283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595#/orderedItems/1695",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2345/facility-use-slots/20345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595/versions/628e356e-f247-4236-918e-201689c7e791",
  "payment": {
    "@type": "Payment",
    "identifier": "SNfsaHj1l",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;2cfb6fbd-6eec-434f-82f7-c2b8ccb69595&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595


---
Response status code: 200 OK. Responded in 14.088821ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '2cfb6fbd-6eec-434f-82f7-c2b8ccb69595' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 92.435395ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;2cfb6fbd-6eec-434f-82f7-c2b8ccb69595&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595


---
Response status code: 200 OK. Responded in 1963.434996ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "modified": 637940832871386200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
    "identifier": "2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
...
---
Response status code: 200 OK. Responded in 5.678649ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832871386244&afterId=2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "message": "Listening for UUID: '2cfb6fbd-6eec-434f-82f7-c2b8ccb69595' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595
...
---
Response status code: 201 Created. Responded in 51.390743ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "identifier": "2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1149.690893ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "2cfb6fbd-6eec-434f-82f7-c2b8ccb69595",
  "modified": 637940832892337300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.935751ms.
```json
{
  "data": {
    "@context": [
