...
---
Response status code: 200 OK. Responded in 1158.655327ms.
```json
{
...
---
Response status code: 200 OK. Responded in 397.864015ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579",
  "modified": 1658486997741,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579",
    "startDate": "2022-07-23T10:49:55+00:00",
    "endDate": "2022-07-23T11:49:55+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b8ea48af-7dde-4e11-a83c-aff235be84de
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-TCA_LKH0sa",
    "accountId": "invalid-uL7Dg64-D",
    "paymentProviderId": "invalid-oSgmsAUFqD"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 222.202219ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b8ea48af-7dde-4e11-a83c-aff235be84de
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brenden_Anderson0@gmail.com",
    "telephone": "1-971-808-3752",
    "givenName": "Ledner",
    "familyName": "Mariela",
    "identifier": "4ca285d8-7b43-4332-a79f-0e36e3b3dc89"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-aXIls4zwfx",
    "accountId": "invalid-7xafmQGvg",
    "paymentProviderId": "invalid-ivTk7eTbGk"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 362.334192ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
