...
---
Response status code: 200 OK. Responded in 13.648426ms.
```json
{
...
---
Response status code: 200 OK. Responded in 946.858708ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2446/facility-use-slots/20446",
  "modified": 1658486728238,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:45:26+00:00",
    "endDate": "2022-07-23T11:45:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0c51256d-7e61-4876-ac54-a5ab2c6d49d1
...
---
Response status code: 200 OK. Responded in 456.145567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0c51256d-7e61-4876-ac54-a5ab2c6d49d1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2446%2Ffacility-use-slots%2F20446?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 720.416822ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2446/facility-use-slots/20446",
  "modified": 1658486729652,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0c51256d-7e61-4876-ac54-a5ab2c6d49d1
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "715-520-1823",
    "givenName": "Fisher",
    "familyName": "Leon",
    "identifier": "297f46bc-d280-416a-b9cb-a0f225be8167"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 283.840031ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 28.533755ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0c51256d-7e61-4876-ac54-a5ab2c6d49d1
...
---
Response status code: 201 Created. Responded in 249.734627ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0c51256d-7e61-4876-ac54-a5ab2c6d49d1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0c51256d-7e61-4876-ac54-a5ab2c6d49d1#/orderedItems/2371",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2446/facility-use-slots/20446#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 24.721421ms.
```json
{
  "data": {
    "@context": [
