...
⚠️ 10 passed with 0 failures, 84 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 17.183528ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/586/facility-use-slots/5853"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F586%2Ffacility-use-slots%2F5853?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.722304ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/586/facility-use-slots/5853#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-22T23:47:12+00:00",
    "endDate": "2022-07-23T04:07:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a5bdf5c4-66c6-4950-accf-84b4b76185f1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/586/facility-use-slots/5853#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/586/facility-use-slots/5853"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1031.22248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a5bdf5c4-66c6-4950-accf-84b4b76185f1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:32+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F586%2Ffacility-use-slots%2F5853?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1119.74657ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/586/facility-use-slots/5853",
  "modified": 1658486975288,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a5bdf5c4-66c6-4950-accf-84b4b76185f1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annette72@hotmail.com",
    "telephone": "995-673-8162 x017",
    "givenName": "Blanda",
    "familyName": "Rhett",
    "identifier": "3df2632c-70be-4dff-978d-db233da85c5b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 393.725514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.681856ms.
```json
{
  "data": {
    "@context": [
