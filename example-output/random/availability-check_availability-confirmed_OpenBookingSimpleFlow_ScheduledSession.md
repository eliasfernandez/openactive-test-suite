...
---
Response status code: 200 OK. Responded in 131.051622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/331/events/3306"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F331%2Fevents%2F3306?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 54.529041ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/331/events/3306",
    "startDate": "2022-07-28T04:56:11+00:00",
    "endDate": "2022-07-28T09:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e617e814-882d-414c-b913-afe99c313c14
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/331/events/3306"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 248.513134ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e617e814-882d-414c-b913-afe99c313c14",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:38+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F331%2Fevents%2F3306?useCacheIfAvailable=true&expectedCapacity=27


---
Response status code: 200 OK. Responded in 224.94107ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/331/events/3306",
  "modified": 1658486439430,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e617e814-882d-414c-b913-afe99c313c14
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Herta.Vandervort@yahoo.com",
    "telephone": "766-295-9682",
    "givenName": "Spinka",
    "familyName": "Camden",
    "identifier": "6c577185-09be-4093-94ee-3e5cabd7379b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 130.95352ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 15.642441ms.
```json
{
  "data": {
    "@context": [
