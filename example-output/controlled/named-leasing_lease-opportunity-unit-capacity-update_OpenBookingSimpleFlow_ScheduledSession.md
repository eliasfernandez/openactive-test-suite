...
---
Response status code: 200 OK. Responded in 59.405735ms.
```json
{
...
---
Response status code: 200 OK. Responded in 813.02602ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2485/events/20485",
  "modified": 1658486795879,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2485/events/20485",
    "startDate": "2022-07-23T10:46:34+00:00",
    "endDate": "2022-07-23T11:46:34+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/30153fc2-7125-4f7e-bc8c-3d3b2bb944eb
...
---
Response status code: 200 OK. Responded in 455.3516ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/30153fc2-7125-4f7e-bc8c-3d3b2bb944eb",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/30153fc2-7125-4f7e-bc8c-3d3b2bb944eb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jennie48@gmail.com",
    "telephone": "770-357-0270",
    "givenName": "Kunze",
    "familyName": "Michele",
    "identifier": "b24afb17-6849-40a4-87bb-2d66e2f0ef72"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 338.076744ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2485%2Fevents%2F20485?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 6.258056ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 533.292001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c96359f1-4892-448f-872d-45fe4cc4c03d
...
---
Response status code: 409 Conflict. Responded in 677.295398ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c96359f1-4892-448f-872d-45fe4cc4c03d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c96359f1-4892-448f-872d-45fe4cc4c03d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Justina_Marquardt78@gmail.com",
    "telephone": "(366) 471-8134 x7565",
    "givenName": "Labadie",
    "familyName": "Lorna",
    "identifier": "f18d0750-3059-48ff-a395-a217191d359a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 313.608623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 25.277228ms.
```json
{
  "data": {
    "@context": [
