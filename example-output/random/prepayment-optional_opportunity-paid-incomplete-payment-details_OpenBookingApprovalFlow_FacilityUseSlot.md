...
---
Response status code: 200 OK. Responded in 21.344632ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10761"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1077%2Ffacility-use-slots%2F10761?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.172074ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10761#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-26T09:25:12+00:00",
    "endDate": "2022-07-26T14:58:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a95286a8-03b7-46cf-bf29-ce2d2a6816dd
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10761#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10761"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 637.176497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a95286a8-03b7-46cf-bf29-ce2d2a6816dd",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1077%2Ffacility-use-slots%2F10761?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 1117.290754ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10761",
  "modified": 1658486967595,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a95286a8-03b7-46cf-bf29-ce2d2a6816dd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Deondre66@yahoo.com",
    "telephone": "1-986-840-6668 x45447",
    "givenName": "Schoen",
    "familyName": "Freida",
    "identifier": "b7bbce27-6558-4c80-8415-f37d1ad6ac1a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 494.933987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.51392ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a95286a8-03b7-46cf-bf29-ce2d2a6816dd
...
---
Response status code: 400 Bad Request. Responded in 323.160694ms.
```json
{
  "@context": "https://openactive.io/",
