...
---
Response status code: 200 OK. Responded in 7.685182ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1399/facility-use-slots/13983"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1399%2Ffacility-use-slots%2F13983?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.571532ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1399",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1399/facility-use-slots/13983#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H58M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-25T20:06:12+00:00",
    "endDate": "2022-07-25T20:47:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b8a8b33f-1488-49a1-8d02-685fc19b68da
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1399/facility-use-slots/13983#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1399/facility-use-slots/13983"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 106.322815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b8a8b33f-1488-49a1-8d02-685fc19b68da",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:15+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1399"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-25T20:06:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1399%2Ffacility-use-slots%2F13983?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 667.949202ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1399/facility-use-slots/13983",
  "modified": 1658486777021,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b8a8b33f-1488-49a1-8d02-685fc19b68da
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lizeth_Steuber@yahoo.com",
    "telephone": "858.515.7715 x49584",
    "givenName": "Lemke",
    "familyName": "Rhianna",
    "identifier": "92b2ebd0-fbd9-44af-85ff-e33be2459f4a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 512.071515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.812833ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b8a8b33f-1488-49a1-8d02-685fc19b68da
...
---
Response status code: 400 Bad Request. Responded in 377.87244ms.
```json
{
  "@context": "https://openactive.io/",
