...
---
Response status code: 200 OK. Responded in 32.930281ms.
```json
{
...
---
Response status code: 200 OK. Responded in 372.934088ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2344/events/20344",
  "modified": 1658486455149,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2344/events/20344",
    "startDate": "2022-07-23T10:40:53+00:00",
    "endDate": "2022-07-23T11:40:53+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9b7c0406-5261-465f-bab8-fe1985b30b24
...
---
Response status code: 200 OK. Responded in 93.056496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9b7c0406-5261-465f-bab8-fe1985b30b24",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:54+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2344%2Fevents%2F20344?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 440.119462ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2344/events/20344",
  "modified": 1658486456058,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9b7c0406-5261-465f-bab8-fe1985b30b24
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rahsaan_Labadie@hotmail.com",
    "telephone": "266.841.5444",
    "givenName": "White",
    "familyName": "Brooklyn",
    "identifier": "53eb9404-fc11-424a-9eed-1dabd6679ee5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 135.355258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.847484ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9b7c0406-5261-465f-bab8-fe1985b30b24
...
---
Response status code: 201 Created. Responded in 227.876449ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9b7c0406-5261-465f-bab8-fe1985b30b24",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9b7c0406-5261-465f-bab8-fe1985b30b24#/orderedItems/1604",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2344#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 28.505343ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/9b7c0406-5261-465f-bab8-fe1985b30b24
...
---
Response status code: 400 Bad Request. Responded in 37.523721ms.
```json
{
  "@context": "https://openactive.io/",
