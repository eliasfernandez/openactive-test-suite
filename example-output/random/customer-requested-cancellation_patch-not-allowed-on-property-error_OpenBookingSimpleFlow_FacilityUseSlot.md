...
---
Response status code: 200 OK. Responded in 34.220817ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F242%2Ffacility-use-slots%2F2414?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.145959ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-08-01T03:16:12+00:00",
    "endDate": "2022-08-01T06:29:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7d5df803-95d9-4f8d-8f03-fe4898ccd971
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 113.242711ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7d5df803-95d9-4f8d-8f03-fe4898ccd971",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/242"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-08-01T03:16:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F242%2Ffacility-use-slots%2F2414?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 1725.714882ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414",
  "modified": 1658486421707,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7d5df803-95d9-4f8d-8f03-fe4898ccd971
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katelin_Klocko97@yahoo.com",
    "telephone": "955.252.5613 x913",
    "givenName": "Hettinger",
    "familyName": "Terrance",
    "identifier": "c1ab88b1-f4fa-4a91-b082-b54203c16b31"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 155.47615ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.875673ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7d5df803-95d9-4f8d-8f03-fe4898ccd971
...
---
Response status code: 201 Created. Responded in 102.106143ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7d5df803-95d9-4f8d-8f03-fe4898ccd971",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d5df803-95d9-4f8d-8f03-fe4898ccd971#/orderedItems/1249",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/242/facility-use-slots/2414#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 11.697177ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/7d5df803-95d9-4f8d-8f03-fe4898ccd971
...
---
Response status code: 400 Bad Request. Responded in 34.615123ms.
```json
{
  "@context": "https://openactive.io/",
