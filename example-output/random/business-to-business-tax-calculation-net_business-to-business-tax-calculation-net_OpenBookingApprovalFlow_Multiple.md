...
⚠️ 54 passed with 0 failures, 835 warnings and 224 suggestions 
...
---
Response status code: 200 OK. Responded in 32.660644ms.
```json
{
...
---
Response status code: 200 OK. Responded in 31.49462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1366/events/13653"
}
```
...
---
Response status code: 200 OK. Responded in 31.208815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065"
}
```
...
---
Response status code: 200 OK. Responded in 39.406177ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862"
}
```
...
---
Response status code: 200 OK. Responded in 22.681947ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1648/events/16476",
    "startDate": "2022-07-31T13:42:11+00:00",
    "endDate": "2022-07-31T14:46:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 13.93,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT19H18M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1366%2Fevents%2F13653?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.094735ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1366/events/13653",
    "startDate": "2022-07-26T16:11:11+00:00",
    "endDate": "2022-07-26T17:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1366",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1366#/offers/0",
          ...
          "price": 1.06,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT23H54M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1507%2Ffacility-use-slots%2F15065?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.555125ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1507",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-24T06:45:12+00:00",
    "endDate": "2022-07-24T07:42:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1187%2Ffacility-use-slots%2F11862?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.100916ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1187",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 3,
    "startDate": "2022-07-23T09:48:12+00:00",
    "endDate": "2022-07-23T14:03:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1366#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1366/events/13653"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1384.604281ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1366"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1648%2Fevents%2F16476?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 223.502704ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1648/events/16476",
  "modified": 1658486807506,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1366%2Fevents%2F13653?useCacheIfAvailable=true&expectedCapacity=48


---
Response status code: 200 OK. Responded in 222.759489ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1366/events/13653",
  "modified": 1658486807507,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1507%2Ffacility-use-slots%2F15065?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 787.147709ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065",
  "modified": 1658486808073,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1187%2Ffacility-use-slots%2F11862?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 788.397634ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862",
  "modified": 1658486808076,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "e1d5616a-cbe1-4554-88f3-6ba839336fd7",
...
---
Response status code: 200 OK. Responded in 1069.087927ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 19.856952ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.054234ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.43582ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.910407ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868
...
---
Response status code: 201 Created. Responded in 1290.9726719999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2329",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1648#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2330",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1648#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2331",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2332",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2333",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1507/facility-use-slots/15065#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868#/orderedItems/2334",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1187/facility-use-slots/11862#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868/versions/81949c03-cbea-4e01-bd47-c33468782130",
  "payment": {
    "@type": "Payment",
    "identifier": "p1j-FwrlU",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c4ae602d-b22d-4d4a-9bd5-fbd5d1491868&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868


---
Response status code: 200 OK. Responded in 12.598183ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836040850570&afterId=1a56ac04-e6aa-4db0-a6f2-07e120e58784",
  "message": "Listening for UUID: 'c4ae602d-b22d-4d4a-9bd5-fbd5d1491868' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 311.306287ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c4ae602d-b22d-4d4a-9bd5-fbd5d1491868&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868


---
Response status code: 200 OK. Responded in 2139.015204ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "modified": 637940836140322200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
    "identifier": "c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
...
---
Response status code: 200 OK. Responded in 30.563186ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836140322146&afterId=c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "message": "Listening for UUID: 'c4ae602d-b22d-4d4a-9bd5-fbd5d1491868' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868
...
---
Response status code: 201 Created. Responded in 1031.385146ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "identifier": "c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 14.318619ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c4ae602d-b22d-4d4a-9bd5-fbd5d1491868",
  "modified": 637940836165925100
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 20.962567ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.251451ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.700339ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.202227ms.
```json
{
  "data": {
    "@context": [
