...
⚠️ 55 passed with 0 failures, 836 warnings and 222 suggestions 
...
---
Response status code: 200 OK. Responded in 44.514073ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/511"
}
```
...
---
Response status code: 200 OK. Responded in 42.835647ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/245"
}
```
...
---
Response status code: 200 OK. Responded in 25.679288ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881"
}
```
...
---
Response status code: 200 OK. Responded in 23.369954ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F52%2Fevents%2F511?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.734178ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/511",
    "startDate": "2022-07-26T18:38:11+00:00",
    "endDate": "2022-07-26T19:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F245?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.104968ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/245",
    "startDate": "2022-07-25T17:19:11+00:00",
    "endDate": "2022-07-25T18:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F489%2Ffacility-use-slots%2F4881?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.459058ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/489",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H14M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-28T23:53:12+00:00",
    "endDate": "2022-07-29T01:21:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F232%2Ffacility-use-slots%2F2311?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.92365ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/232",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 6,
    "startDate": "2022-07-31T02:24:12+00:00",
    "endDate": "2022-07-31T08:17:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/17631a56-57da-4e54-8774-89204e04fc37
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/52#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/511"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/245"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 281.425453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/17631a56-57da-4e54-8774-89204e04fc37",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:23+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/232"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-31T02:24:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F52%2Fevents%2F511?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 467.560967ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/511",
  "modified": 1658486425069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F245?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 467.747469ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/245",
  "modified": 1658486425071,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F489%2Ffacility-use-slots%2F4881?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 498.794438ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881",
  "modified": 1658486425103,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F232%2Ffacility-use-slots%2F2311?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 499.389247ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311",
  "modified": 1658486425105,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/17631a56-57da-4e54-8774-89204e04fc37
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lavern_Upton76@yahoo.com",
    "telephone": "811-516-5401 x394",
    "givenName": "Hermann",
    "familyName": "Darby",
    "identifier": "38f51192-f140-4b0a-b5a9-0cdb4a721bb8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 251.052794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:24+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 63.54866ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.128173ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 51.204274ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.347306ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37
...
---
Response status code: 201 Created. Responded in 274.304546ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1274",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/52#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1275",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/52#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1276",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/25#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1277",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1278",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/489/facility-use-slots/4881#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37#/orderedItems/1279",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/232/facility-use-slots/2311#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 18.082879ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.84076ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.912445ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.383038ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/17631a56-57da-4e54-8774-89204e04fc37
...
---
Response status code: 400 Bad Request. Responded in 68.379855ms.
```json
{
  "@context": "https://openactive.io/",
