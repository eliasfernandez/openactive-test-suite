...
---
Response status code: 200 OK. Responded in 67.425397ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/766"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F766?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.857674ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/766",
    "startDate": "2022-07-27T01:37:11+00:00",
    "endDate": "2022-07-27T04:38:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4cb7d55b-b994-4914-8980-428ec5e5a256
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/766"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 509.874568ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4cb7d55b-b994-4914-8980-428ec5e5a256",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F766?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 748.919009ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/766",
  "modified": 1658486761171,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4cb7d55b-b994-4914-8980-428ec5e5a256
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mia_Fisher50@yahoo.com",
    "telephone": "638.731.2748 x6054",
    "givenName": "Lowe",
    "familyName": "Neoma",
    "identifier": "d16962ef-42bf-4858-a944-f22f9e126982"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 383.181915ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 29.032706ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4cb7d55b-b994-4914-8980-428ec5e5a256
...
---
Response status code: 400 Bad Request. Responded in 720.702213ms.
```json
{
  "@context": "https://openactive.io/",
