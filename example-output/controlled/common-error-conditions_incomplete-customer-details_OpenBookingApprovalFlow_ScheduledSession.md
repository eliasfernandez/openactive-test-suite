...
---
Response status code: 200 OK. Responded in 11.225388ms.
```json
{
...
---
Response status code: 200 OK. Responded in 922.159672ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2138/events/20138",
  "modified": 1658486151298,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2138/events/20138",
    "startDate": "2022-07-23T10:35:49+00:00",
    "endDate": "2022-07-23T11:35:49+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1415daf3-d383-4f12-ad16-e08df06f8916
...
---
Response status code: 200 OK. Responded in 83.929306ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1415daf3-d383-4f12-ad16-e08df06f8916",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:50+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2138%2Fevents%2F20138?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 887.136324ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2138/events/20138",
  "modified": 1658486152509,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1415daf3-d383-4f12-ad16-e08df06f8916
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "telephone": "748.233.3496",
    "givenName": "Aufderhar",
    "familyName": "Pansy",
    "identifier": "47edb74a-873a-4208-b205-0ba960a340ca"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 24.84618ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 22.234461ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 996.524717ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141",
  "modified": 1658486153874,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aa023cf0-cdf5-459a-8042-ada971b33e74
...
---
Response status code: 200 OK. Responded in 117.004847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aa023cf0-cdf5-459a-8042-ada971b33e74",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:53+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2141%2Fevents%2F20141?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 802.355812ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141",
  "modified": 1658486155158,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aa023cf0-cdf5-459a-8042-ada971b33e74
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Geraldine.Schuppe29@gmail.com",
    "telephone": "(654) 687-4123",
    "givenName": "Langworth",
    "familyName": "Darian",
    "identifier": "cc535202-697b-42a1-ae17-e9d3b4f7d8f1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 56.493609ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.259932ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/aa023cf0-cdf5-459a-8042-ada971b33e74
...
---
Response status code: 400 Bad Request. Responded in 25.505685ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
