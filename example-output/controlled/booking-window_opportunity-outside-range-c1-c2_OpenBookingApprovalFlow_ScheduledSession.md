...
---
Response status code: 200 OK. Responded in 330.349018ms.
```json
{
...
---
Response status code: 200 OK. Responded in 536.202449ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2237/events/20237",
  "modified": 1658486278353,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2237/events/20237",
    "startDate": "2022-07-23T10:37:56+00:00",
    "endDate": "2022-07-23T11:37:56+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4872dace-9f29-4aef-b6ab-224d16f9c30d
...
---
Response status code: 409 Conflict. Responded in 36.056986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4872dace-9f29-4aef-b6ab-224d16f9c30d",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4872dace-9f29-4aef-b6ab-224d16f9c30d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Malinda.Mohr@gmail.com",
    "telephone": "569.726.9957 x019",
    "givenName": "Wisoky",
    "familyName": "Levi",
    "identifier": "3071ed54-1810-426e-9b79-41dbf3f5a0ba"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 19.061851ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
