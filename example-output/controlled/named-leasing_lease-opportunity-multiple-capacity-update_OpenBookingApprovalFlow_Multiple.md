...
⚠️ 63 passed with 0 failures, 1238 warnings and 330 suggestions 
...
---
Response status code: 200 OK. Responded in 50.190352ms.
```json
{
...
---
Response status code: 200 OK. Responded in 115.137838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 520.39129ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474",
  "modified": 1658486767809,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474",
    "startDate": "2022-07-23T10:46:06+00:00",
    "endDate": "2022-07-23T11:46:06+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 737.689948ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461",
  "modified": 1658486768028,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7c7dcdb3-e0d8-4b2c-8591-00af9104a997
...
---
Response status code: 200 OK. Responded in 652.641377ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7c7dcdb3-e0d8-4b2c-8591-00af9104a997",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:07+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7c7dcdb3-e0d8-4b2c-8591-00af9104a997
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kolby.Mraz@yahoo.com",
    "telephone": "330.467.1175 x53904",
    "givenName": "Hudson",
    "familyName": "Bradford",
    "identifier": "e53d5e3b-01a2-43ce-b859-c848a77ce219"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 641.674478ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2474%2Fevents%2F20474?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 30.501474ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2461%2Ffacility-use-slots%2F20461?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 21.174091ms.
```json
{
  "data": {
    "@context": [
...
## Lease 3 item(s) (success) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 532.973099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:09+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/472b708f-9c64-4b8c-a5d5-cdebf09dd909
...
---
Response status code: 409 Conflict. Responded in 772.807459ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/472b708f-9c64-4b8c-a5d5-cdebf09dd909",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:11+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/472b708f-9c64-4b8c-a5d5-cdebf09dd909
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Araceli_Pagac81@hotmail.com",
    "telephone": "1-428-213-7716",
    "givenName": "Emard",
    "familyName": "Gennaro",
    "identifier": "2c59d5dd-0612-4c80-9364-93cb1c159a71"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 1626.793848ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 26.852042ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.899441ms.
```json
{
  "data": {
    "@context": [
...
## Lease 10 item(s) (fail) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1e217a48-7b98-4ee7-89d1-36ef1a2913ce
...
---
Response status code: 200 OK. Responded in 755.78769ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1e217a48-7b98-4ee7-89d1-36ef1a2913ce",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:16+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1e217a48-7b98-4ee7-89d1-36ef1a2913ce
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gust_Vandervort@gmail.com",
    "telephone": "1-559-412-6522 x108",
    "givenName": "Klocko",
    "familyName": "Christine",
    "identifier": "4450a26a-056d-4c9a-b05a-881b87a406fb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 421.752689ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2474%2Fevents%2F20474?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 30.642475ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2461%2Ffacility-use-slots%2F20461?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 14.44723ms.
```json
{
  "data": {
    "@context": [
...
## Lease 2 item(s) (success) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79973631-154d-45da-be4e-5dc283780546
...
---
Response status code: 409 Conflict. Responded in 261.035645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79973631-154d-45da-be4e-5dc283780546",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:18+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79973631-154d-45da-be4e-5dc283780546
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Estevan.Little49@gmail.com",
    "telephone": "(382) 610-1035 x2605",
    "givenName": "Roob",
    "familyName": "Ahmed",
    "identifier": "aaff9554-8265-404e-ab44-554a1f2864a8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 701.625404ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:19+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 19.956579ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.100371ms.
```json
{
  "data": {
    "@context": [
...
## Lease 1 item(s) (fail) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
