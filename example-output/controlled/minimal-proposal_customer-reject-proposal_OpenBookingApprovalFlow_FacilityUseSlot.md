...
---
Response status code: 200 OK. Responded in 32.416692ms.
```json
{
...
---
Response status code: 200 OK. Responded in 398.094487ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/269ea85e-288c-48c2-9f0a-0a1136f03f08
...
---
Response status code: 200 OK. Responded in 40.03526ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/269ea85e-288c-48c2-9f0a-0a1136f03f08",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2047%2Ffacility-use-slots%2F20047?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1227.227458ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047",
  "modified": 1658486031450,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/269ea85e-288c-48c2-9f0a-0a1136f03f08
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tamara.Hauck18@hotmail.com",
    "telephone": "(907) 469-2919 x9328",
    "givenName": "Klocko",
    "familyName": "Nigel",
    "identifier": "15cd13e2-fa4f-472d-bb62-eaead6eff3b3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 239.493348ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 22.46581ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/269ea85e-288c-48c2-9f0a-0a1136f03f08
...
---
Response status code: 201 Created. Responded in 147.539242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/269ea85e-288c-48c2-9f0a-0a1136f03f08",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/269ea85e-288c-48c2-9f0a-0a1136f03f08#/orderedItems/281",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/269ea85e-288c-48c2-9f0a-0a1136f03f08/versions/3408b750-1c87-478c-9a11-fc9bffcd5cc2",
  "payment": {
    "@type": "Payment",
    "identifier": "l6TOXXQgu",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;269ea85e-288c-48c2-9f0a-0a1136f03f08&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/269ea85e-288c-48c2-9f0a-0a1136f03f08


---
Response status code: 200 OK. Responded in 11.399702ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '269ea85e-288c-48c2-9f0a-0a1136f03f08' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Proposal Request
PATCH https://localhost:5001/api/openbooking/order-proposals/269ea85e-288c-48c2-9f0a-0a1136f03f08
...
---
Response status code: 204 No Content. Responded in 23.443594ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;269ea85e-288c-48c2-9f0a-0a1136f03f08&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/269ea85e-288c-48c2-9f0a-0a1136f03f08


---
Response status code: 200 OK. Responded in 2239.319385ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "269ea85e-288c-48c2-9f0a-0a1136f03f08",
  "modified": 637940828312814300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/269ea85e-288c-48c2-9f0a-0a1136f03f08",
    "identifier": "269ea85e-288c-48c2-9f0a-0a1136f03f08",
    "orderProposalStatus": "https://openactive.io/CustomerRejected",
    "orderedItem": [
      {
        "@type": "OrderItem",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/269ea85e-288c-48c2-9f0a-0a1136f03f08
...
---
Response status code: 500 Internal Server Error. Responded in 33.183135ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 4.088229ms.
```json
{
  "data": {
    "@context": [
