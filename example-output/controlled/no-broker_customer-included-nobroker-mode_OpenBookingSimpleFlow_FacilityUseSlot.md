...
---
Response status code: 200 OK. Responded in 298.094438ms.
```json
{
...
---
Response status code: 200 OK. Responded in 691.075915ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2417/facility-use-slots/20417",
  "modified": 1658486663069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:44:21+00:00",
    "endDate": "2022-07-23T11:44:21+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/71574d39-2475-4c69-8989-c08ca96be2b7
...
---
Response status code: 200 OK. Responded in 263.38173ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/71574d39-2475-4c69-8989-c08ca96be2b7",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2417%2Ffacility-use-slots%2F20417?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1112.148241ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2417/facility-use-slots/20417",
  "modified": 1658486664666,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/71574d39-2475-4c69-8989-c08ca96be2b7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jakayla.Goldner82@gmail.com",
    "telephone": "1-792-524-4789 x991",
    "givenName": "Baumbach",
    "familyName": "Rosalee",
    "identifier": "bdeb78c4-b3c8-4daf-a026-90b2cfb800db"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 266.299522ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 30.308876ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/71574d39-2475-4c69-8989-c08ca96be2b7
...
---
Response status code: 201 Created. Responded in 246.518742ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/71574d39-2475-4c69-8989-c08ca96be2b7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/71574d39-2475-4c69-8989-c08ca96be2b7#/orderedItems/2167",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2417/facility-use-slots/20417#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.488578ms.
```json
{
  "data": {
    "@context": [
