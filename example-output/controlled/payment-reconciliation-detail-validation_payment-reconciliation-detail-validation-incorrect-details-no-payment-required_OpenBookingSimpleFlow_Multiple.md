[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:15 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 146.286228ms.
```json
{
...
---
Response status code: 200 OK. Responded in 233.261918ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 152.503385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 158.799542ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 217.138671ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2560/events/20560",
  "modified": 1658486959765,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2560/events/20560",
    "startDate": "2022-07-23T10:49:18+00:00",
    "endDate": "2022-07-23T11:49:18+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 216.341164ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2561/events/20561",
  "modified": 1658486959766,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 669.437079ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547",
  "modified": 1658486960220,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 669.425979ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2548/facility-use-slots/20548",
  "modified": 1658486960221,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ff5d3daf-18b4-4d28-b24c-53f0517d825c
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-Aga_M66UZW",
    "accountId": "invalid--HgJ2qToN",
    "paymentProviderId": "invalid-0-3oMid9gY"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 143.797112ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ff5d3daf-18b4-4d28-b24c-53f0517d825c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rosalinda.Waters81@gmail.com",
    "telephone": "988.772.5571 x6096",
    "givenName": "Cummings",
    "familyName": "Marques",
    "identifier": "61bf21eb-4603-4dc3-a297-c9509fa288af"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-C18KbqtXLd",
    "accountId": "invalid-2SY7Cfqez",
    "paymentProviderId": "invalid-3RWe2doMJj"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 160.828867ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
