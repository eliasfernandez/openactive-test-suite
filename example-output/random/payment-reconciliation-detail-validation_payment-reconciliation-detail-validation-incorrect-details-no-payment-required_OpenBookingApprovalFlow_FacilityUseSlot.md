...
---
Response status code: 200 OK. Responded in 11.434002ms.
```json
{
...
---
Response status code: 200 OK. Responded in 8.180044ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT3H12M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-30T16:27:12+00:00",
    "endDate": "2022-07-30T17:56:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/649021e9-8e3a-49d4-800d-3762b17fa594
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-Wpz26wlIGN",
    "accountId": "invalid-DUM_J1no6",
    "paymentProviderId": "invalid-hhrXdsPt4f"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 17.350606ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/649021e9-8e3a-49d4-800d-3762b17fa594
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Monica.OKon@yahoo.com",
    "telephone": "543.551.8891",
    "givenName": "Mueller",
    "familyName": "Gabriel",
    "identifier": "00c24f70-6dd3-4876-ad7f-3a99bf6ebd71"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-u3QgC1PNih",
    "accountId": "invalid-fODUdAdbmW",
    "paymentProviderId": "invalid-GDeHJDDSCL"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 16.670894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
