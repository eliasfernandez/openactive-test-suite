[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:46:33 GMT+0000 (Coordinated Universal Time)
...
⚠️ 51 passed with 0 failures, 817 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 54.229754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13536"
}
```
...
---
Response status code: 200 OK. Responded in 54.581561ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1053/events/10529"
}
```
...
---
Response status code: 200 OK. Responded in 60.259681ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246"
}
```
...
---
Response status code: 200 OK. Responded in 70.5207ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1354%2Fevents%2F13536?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.644833ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13536",
    "startDate": "2022-07-26T04:45:11+00:00",
    "endDate": "2022-07-26T07:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1354",
      "name": "Metal Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
          ...
          "price": 15.64,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT21H12M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1053%2Fevents%2F10529?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.176423ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1053/events/10529",
    "startDate": "2022-07-25T04:02:11+00:00",
    "endDate": "2022-07-25T05:03:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1825%2Ffacility-use-slots%2F18246?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.744014ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1825",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246#/offers/0",
        ...
        "price": 7.83,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT3H43M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-24T14:17:12+00:00",
    "endDate": "2022-07-24T16:41:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1085%2Ffacility-use-slots%2F10845?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.341805ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 8,
    "startDate": "2022-07-29T14:00:12+00:00",
    "endDate": "2022-07-29T17:38:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cc6a35f2-0293-4579-a362-5d838931de2f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1354/events/13536"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1053/events/10529"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 660.783266ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cc6a35f2-0293-4579-a362-5d838931de2f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:24+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1354"
        },
        "maximumAttendeeCapacity": 21,
        "remainingAttendeeCapacity": 21
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1825"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-24T14:17:12+00:00",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1354%2Fevents%2F13536?useCacheIfAvailable=true&expectedCapacity=19


---
Response status code: 200 OK. Responded in 42.347193ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1053%2Fevents%2F10529?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 41.784282ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1825%2Ffacility-use-slots%2F18246?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 235.379705ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246",
  "modified": 1658486846230,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1085%2Ffacility-use-slots%2F10845?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 228.206571ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845",
  "modified": 1658486846232,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cc6a35f2-0293-4579-a362-5d838931de2f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emilie57@yahoo.com",
    "telephone": "(746) 693-2606",
    "givenName": "Trantow",
    "familyName": "Marty",
    "identifier": "d84d62c7-23f3-453b-9820-1e4f782cd7ca"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 712.802639ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:26+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2)
...
---
Response status code: 200 OK. Responded in 15.707294ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.158584ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.670175ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.236166ms.
```json
{
  "data": {
    "@context": [
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cc6a35f2-0293-4579-a362-5d838931de2f
...
---
Response status code: 201 Created. Responded in 802.367789ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/cc6a35f2-0293-4579-a362-5d838931de2f",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2458",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2459",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1354#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2460",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2461",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2462",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1825/facility-use-slots/18246#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f#/orderedItems/2463",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10845#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/cc6a35f2-0293-4579-a362-5d838931de2f/versions/b8ea36d7-c801-45de-bd10-509d1d3e2d8a",
  "payment": {
    "@type": "Payment",
    "identifier": "wgKxxHg4z",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;cc6a35f2-0293-4579-a362-5d838931de2f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/cc6a35f2-0293-4579-a362-5d838931de2f


---
Response status code: 200 OK. Responded in 10.440923ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836401864042&afterId=170e5e3f-05dd-44ab-ba18-edba7c5de566",
  "message": "Listening for UUID: 'cc6a35f2-0293-4579-a362-5d838931de2f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 13.431687ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;cc6a35f2-0293-4579-a362-5d838931de2f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/cc6a35f2-0293-4579-a362-5d838931de2f


---
Response status code: 200 OK. Responded in 2356.2962509999998ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "cc6a35f2-0293-4579-a362-5d838931de2f",
  "modified": 637940836502889500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/cc6a35f2-0293-4579-a362-5d838931de2f",
    "identifier": "cc6a35f2-0293-4579-a362-5d838931de2f",
...
---
Response status code: 200 OK. Responded in 22.052068ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836502889513&afterId=cc6a35f2-0293-4579-a362-5d838931de2f",
  "message": "Listening for UUID: 'cc6a35f2-0293-4579-a362-5d838931de2f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f
...
---
Response status code: 201 Created. Responded in 1227.391229ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cc6a35f2-0293-4579-a362-5d838931de2f",
  "identifier": "cc6a35f2-0293-4579-a362-5d838931de2f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 4.355882ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "cc6a35f2-0293-4579-a362-5d838931de2f",
  "modified": 637940836531404300
}
```
### Specs
* ✅ should return 200 on success
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B))
...
---
Response status code: 200 OK. Responded in 20.379784ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.841174ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.422266ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.394065ms.
```json
{
  "data": {
    "@context": [
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
