[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:42:28 GMT+0000 (Coordinated Universal Time)
...
⚠️ 28 passed with 0 failures, 315 warnings and 84 suggestions 
...
---
Response status code: 200 OK. Responded in 30.563068ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15070"
}
```
...
---
Response status code: 200 OK. Responded in 29.224147ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1704/events/17037"
}
```
...
---
Response status code: 200 OK. Responded in 28.027029ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1320/facility-use-slots/13193"
}
```
...
---
Response status code: 200 OK. Responded in 27.108715ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1319/facility-use-slots/13181"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1507%2Fevents%2F15070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 47.275923ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15070",
    "startDate": "2022-07-24T12:10:11+00:00",
    "endDate": "2022-07-24T15:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1704%2Fevents%2F17037?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 48.280839ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1704/events/17037",
    "startDate": "2022-07-22T13:14:11+00:00",
    "endDate": "2022-07-22T17:26:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1704",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1704#/offers/0",
          ...
          "price": 10.42,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT2H23M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1320%2Ffacility-use-slots%2F13193?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 47.801832ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1320",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1320/facility-use-slots/13193#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2022-07-31T20:28:12+00:00",
    "endDate": "2022-07-31T23:37:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1319%2Ffacility-use-slots%2F13181?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 47.313624ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1319",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1319/facility-use-slots/13181#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 3,
    "startDate": "2022-08-01T09:29:12+00:00",
    "endDate": "2022-08-01T11:22:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7f93258e-aa14-4fc1-bac6-3d0290cc6c8a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15070"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1704#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1704/events/17037"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1320/facility-use-slots/13193#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1320/facility-use-slots/13193"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1319/facility-use-slots/13181#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1319/facility-use-slots/13181"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 553.412804ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7f93258e-aa14-4fc1-bac6-3d0290cc6c8a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:43+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1704"
        },
        "maximumAttendeeCapacity": 18,
        "remainingAttendeeCapacity": 18
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1320"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-31T20:28:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1507%2Fevents%2F15070?useCacheIfAvailable=true&expectedCapacity=43


---
Response status code: 200 OK. Responded in 34.200737ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15070",
  "modified": 1658486564982,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1704%2Fevents%2F17037?useCacheIfAvailable=true&expectedCapacity=17


---
Response status code: 200 OK. Responded in 35.595362ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1704/events/17037",
  "modified": 1658486564985,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1320%2Ffacility-use-slots%2F13193?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 268.5193ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1320/facility-use-slots/13193",
  "modified": 1658486565219,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1319%2Ffacility-use-slots%2F13181?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 274.016302ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1319/facility-use-slots/13181",
  "modified": 1658486565226,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
