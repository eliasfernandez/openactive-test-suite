...
---
Response status code: 200 OK. Responded in 30.570981ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/747/events/7462"
}
```
...
---
Response status code: 200 OK. Responded in 20.708061ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6637"
}
```
...
---
Response status code: 200 OK. Responded in 21.881987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142"
}
```
...
---
Response status code: 200 OK. Responded in 20.836464ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F747%2Fevents%2F7462?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.887565ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/747/events/7462",
    "startDate": "2022-07-23T12:27:11+00:00",
    "endDate": "2022-07-23T14:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/747",
      "name": "Frozen Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/747#/offers/0",
          ...
          "price": 19.99,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT13H49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F664%2Fevents%2F6637?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.167849ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6637",
    "startDate": "2022-07-30T15:58:11+00:00",
    "endDate": "2022-07-30T21:23:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F215%2Ffacility-use-slots%2F2142?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.503434ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/215",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingAttendeeDetails"
        ],
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T22:19:11+00:00",
    "endDate": "2022-07-29T23:02:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F58%2Ffacility-use-slots%2F571?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.90002ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-25T09:30:11+00:00",
    "endDate": "2022-07-25T14:47:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3b6b0819-9dcd-40d6-b454-5fda0fb66e90
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/747#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/747/events/7462",
      "attendee": {
        "@type": "Person",
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6637",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
...
---
Response status code: 200 OK. Responded in 1809.144056ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3b6b0819-9dcd-40d6-b454-5fda0fb66e90",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/747"
        },
        "maximumAttendeeCapacity": 31,
        "remainingAttendeeCapacity": 31
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/215"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-29T22:19:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F747%2Fevents%2F7462?useCacheIfAvailable=true&expectedCapacity=29


---
Response status code: 200 OK. Responded in 633.416865ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/747/events/7462",
  "modified": 1658486830850,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F664%2Fevents%2F6637?useCacheIfAvailable=true&expectedCapacity=17


---
Response status code: 200 OK. Responded in 626.351516ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6637",
  "modified": 1658486830855,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F215%2Ffacility-use-slots%2F2142?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1638.528273ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142",
  "modified": 1658486831873,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F58%2Ffacility-use-slots%2F571?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 1637.699056ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571",
  "modified": 1658486831874,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3b6b0819-9dcd-40d6-b454-5fda0fb66e90
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Meghan_Schneider82@yahoo.com",
    "telephone": "210-951-3118 x1099",
    "givenName": "Cremin",
    "familyName": "Brain",
    "identifier": "ab7c789c-fa6f-45b2-92b1-833ccaaadb24"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1076.793321ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 30.30254ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.729222ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.455294ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.72088ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90
...
---
Response status code: 201 Created. Responded in 760.79868ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2410",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/747#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2411",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/747#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2412",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/664#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2413",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2414",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/215/facility-use-slots/2142#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3b6b0819-9dcd-40d6-b454-5fda0fb66e90#/orderedItems/2415",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/58/facility-use-slots/571#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 81.868142ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 75.029795ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 70.04159ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.365075ms.
```json
{
  "data": {
    "@context": [
