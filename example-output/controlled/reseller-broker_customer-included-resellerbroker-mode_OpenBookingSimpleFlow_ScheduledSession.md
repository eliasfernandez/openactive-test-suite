...
---
Response status code: 200 OK. Responded in 37.70282ms.
```json
{
...
---
Response status code: 200 OK. Responded in 323.313151ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449",
  "modified": 1658486701947,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449",
    "startDate": "2022-07-23T10:45:00+00:00",
    "endDate": "2022-07-23T11:45:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e7bde031-d6a2-4a40-893d-2bdfbd2db831
...
---
Response status code: 200 OK. Responded in 273.240925ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e7bde031-d6a2-4a40-893d-2bdfbd2db831",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2449%2Fevents%2F20449?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 405.291048ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449",
  "modified": 1658486703075,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e7bde031-d6a2-4a40-893d-2bdfbd2db831
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Destin.Roob61@yahoo.com",
    "telephone": "600-762-4535 x41370",
    "givenName": "Heidenreich",
    "familyName": "Tad",
    "identifier": "f35a7cfd-3b0d-4073-bd38-2540e0214d18"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 368.182832ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 7.955868ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e7bde031-d6a2-4a40-893d-2bdfbd2db831
...
---
Response status code: 201 Created. Responded in 297.115228ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e7bde031-d6a2-4a40-893d-2bdfbd2db831",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7bde031-d6a2-4a40-893d-2bdfbd2db831#/orderedItems/2286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2449#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.807344ms.
```json
{
  "data": {
    "@context": [
