[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:34 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 16.500152ms.
```json
{
...
---
Response status code: 200 OK. Responded in 411.217686ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2257/facility-use-slots/20257",
  "modified": 1658486320628,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:38:39+00:00",
    "endDate": "2022-07-23T11:38:39+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0de06e02-5ec5-49d3-b95b-09a97db0adf2
...
---
Response status code: 200 OK. Responded in 364.384955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0de06e02-5ec5-49d3-b95b-09a97db0adf2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:39+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2257%2Ffacility-use-slots%2F20257?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 871.366323ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2257/facility-use-slots/20257",
  "modified": 1658486322042,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0de06e02-5ec5-49d3-b95b-09a97db0adf2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Christine39@yahoo.com",
    "telephone": "1-421-640-5530",
    "givenName": "Turner",
    "familyName": "Zander",
    "identifier": "eba92fef-6e19-43e8-b04d-67af84482db7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 202.810867ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:41+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.078538ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0de06e02-5ec5-49d3-b95b-09a97db0adf2
...
---
Response status code: 201 Created. Responded in 104.424161ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0de06e02-5ec5-49d3-b95b-09a97db0adf2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0de06e02-5ec5-49d3-b95b-09a97db0adf2#/orderedItems/1103",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2257/facility-use-slots/20257#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 3.991036ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/0de06e02-5ec5-49d3-b95b-09a97db0adf2
...
---
Response status code: 400 Bad Request. Responded in 15.438442ms.
```json
{
  "@context": "https://openactive.io/",
