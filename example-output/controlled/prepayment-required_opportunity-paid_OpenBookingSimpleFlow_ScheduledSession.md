...
---
Response status code: 200 OK. Responded in 161.696157ms.
```json
{
...
---
Response status code: 200 OK. Responded in 727.335355ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2471/events/20471",
  "modified": 1658486762028,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2471/events/20471",
    "startDate": "2022-07-23T10:46:00+00:00",
    "endDate": "2022-07-23T11:46:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aaad6c01-d38b-4c49-a221-e826648d26a2
...
---
Response status code: 200 OK. Responded in 357.230419ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aaad6c01-d38b-4c49-a221-e826648d26a2",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2471%2Fevents%2F20471?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 792.072538ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2471/events/20471",
  "modified": 1658486763517,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aaad6c01-d38b-4c49-a221-e826648d26a2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Stanley_Runolfsdottir96@yahoo.com",
    "telephone": "909.560.2982 x05878",
    "givenName": "Upton",
    "familyName": "Helen",
    "identifier": "df3c99c1-476d-4737-9d5e-3fdf3ed90ae8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 342.281684ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.018334ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/aaad6c01-d38b-4c49-a221-e826648d26a2
...
---
Response status code: 201 Created. Responded in 1055.526413ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/aaad6c01-d38b-4c49-a221-e826648d26a2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/aaad6c01-d38b-4c49-a221-e826648d26a2#/orderedItems/2491",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2471#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 31.934987ms.
```json
{
  "data": {
    "@context": [
