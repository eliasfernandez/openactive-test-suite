...
---
Response status code: 200 OK. Responded in 33.076695ms.
```json
{
...
---
Response status code: 200 OK. Responded in 43.220586ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 824.379254ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2462/events/20462",
  "modified": 1658486736433,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2462/events/20462",
    "startDate": "2022-07-23T10:45:34+00:00",
    "endDate": "2022-07-23T11:45:34+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 628.830607ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450",
  "modified": 1658486736239,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/db2ed5b6-e996-4925-b7a9-c870dbb54a09
...
---
Response status code: 200 OK. Responded in 956.348565ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/db2ed5b6-e996-4925-b7a9-c870dbb54a09",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:35+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/db2ed5b6-e996-4925-b7a9-c870dbb54a09
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerod.Zulauf@gmail.com",
    "telephone": "1-940-969-6674 x842",
    "givenName": "Stamm",
    "familyName": "Mckayla",
    "identifier": "399e1132-e54b-42a1-b92d-b088298dfa9d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1113.408873ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:38+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2462%2Fevents%2F20462?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 9.235282ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2450%2Ffacility-use-slots%2F20450?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 8.209273ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 846.451581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:39+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e83c5b12-3b7e-49ff-b3ec-e07b0abb8673
...
---
Response status code: 409 Conflict. Responded in 638.563919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e83c5b12-3b7e-49ff-b3ec-e07b0abb8673",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:40+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e83c5b12-3b7e-49ff-b3ec-e07b0abb8673
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katelyn52@hotmail.com",
    "telephone": "(272) 400-5032",
    "givenName": "Bartell",
    "familyName": "Lonnie",
    "identifier": "45a26d02-2bf3-44b6-8b0f-885b702cf126"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 517.694737ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 85.404312ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 84.391003ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f3997d7f-0e4d-4407-bea9-a0b1ec6421f9
...
---
Response status code: 200 OK. Responded in 934.949891ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f3997d7f-0e4d-4407-bea9-a0b1ec6421f9",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:44+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f3997d7f-0e4d-4407-bea9-a0b1ec6421f9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emanuel_Steuber76@gmail.com",
    "telephone": "639.657.5650",
    "givenName": "Gulgowski",
    "familyName": "Ramiro",
    "identifier": "9c68608a-b1ed-4e82-a9e7-9412382e9aa5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 969.037516ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:46+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2462%2Fevents%2F20462?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 51.042485ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2450%2Ffacility-use-slots%2F20450?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 43.178511ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/73c7f2a9-2488-4379-b538-d5c4c7c69844
...
---
Response status code: 409 Conflict. Responded in 859.08047ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/73c7f2a9-2488-4379-b538-d5c4c7c69844",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/73c7f2a9-2488-4379-b538-d5c4c7c69844
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joan_Quitzon@hotmail.com",
    "telephone": "607.973.9043 x853",
    "givenName": "Wuckert",
    "familyName": "Ulises",
    "identifier": "e350e478-0748-4d1a-b72a-cb1e4dbf9cad"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 600.056706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 21.826507ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.689959ms.
```json
{
  "data": {
    "@context": [
