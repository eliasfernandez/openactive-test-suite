[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:48 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 28.415687ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15337"
}
```
...
---
Response status code: 200 OK. Responded in 28.06368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1173/facility-use-slots/11728"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15337?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.98353ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15337",
    "startDate": "2022-07-29T12:55:11+00:00",
    "endDate": "2022-07-29T18:29:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1173%2Ffacility-use-slots%2F11728?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.788426ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1173",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1173/facility-use-slots/11728#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 5,
    "startDate": "2022-07-30T20:42:12+00:00",
    "endDate": "2022-07-31T02:19:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d1d7ad6a-a340-46f3-8408-8a0f317f4e6b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15337"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1173/facility-use-slots/11728#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1173/facility-use-slots/11728"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 503.960207ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d1d7ad6a-a340-46f3-8408-8a0f317f4e6b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:07+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1173"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-30T20:42:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15337?useCacheIfAvailable=true&expectedCapacity=16


---
Response status code: 200 OK. Responded in 381.297975ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15337",
  "modified": 1658486889766,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1173%2Ffacility-use-slots%2F11728?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 275.645192ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1173/facility-use-slots/11728",
  "modified": 1658486889663,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d1d7ad6a-a340-46f3-8408-8a0f317f4e6b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Abner.Hermiston7@gmail.com",
    "telephone": "755-468-2663",
    "givenName": "Gulgowski",
    "familyName": "King",
    "identifier": "513ef37e-4132-4eb1-986f-09da26f85c44"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 471.64634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.5482ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.560759ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d1d7ad6a-a340-46f3-8408-8a0f317f4e6b
...
---
Response status code: 400 Bad Request. Responded in 1492.296005ms.
```json
{
  "@context": "https://openactive.io/",
