...
---
Response status code: 200 OK. Responded in 789.660127ms.
```json
{
...
---
Response status code: 200 OK. Responded in 878.496894ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2189/events/20189",
  "modified": 1658486214413,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2189/events/20189",
    "startDate": "2022-07-23T10:36:52+00:00",
    "endDate": "2022-07-23T11:36:52+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7c50e97f-d885-46ed-b4ee-25032eaaf1f8
...
---
Response status code: 409 Conflict. Responded in 224.688986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7c50e97f-d885-46ed-b4ee-25032eaaf1f8",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7c50e97f-d885-46ed-b4ee-25032eaaf1f8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rosamond.Bradtke38@hotmail.com",
    "telephone": "582-417-6680 x89694",
    "givenName": "Kozey",
    "familyName": "Dejah",
    "identifier": "80b30978-6b52-4f63-9fbd-125127241220"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 26.6572ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7c50e97f-d885-46ed-b4ee-25032eaaf1f8
...
---
Response status code: 409 Conflict. Responded in 30.179727ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7c50e97f-d885-46ed-b4ee-25032eaaf1f8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
