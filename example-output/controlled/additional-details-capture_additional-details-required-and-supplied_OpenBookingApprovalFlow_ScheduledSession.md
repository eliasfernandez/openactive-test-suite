...
---
Response status code: 200 OK. Responded in 190.271321ms.
```json
{
...
---
Response status code: 200 OK. Responded in 547.189548ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2522/events/20522",
  "modified": 1658486877773,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2522/events/20522",
    "startDate": "2022-07-23T10:47:56+00:00",
    "endDate": "2022-07-23T11:47:56+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/42699577-2de5-4c06-adbf-a39016c89f0d
...
---
Response status code: 200 OK. Responded in 398.365903ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/42699577-2de5-4c06-adbf-a39016c89f0d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:57+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2522%2Fevents%2F20522?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 607.549495ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2522/events/20522",
  "modified": 1658486878963,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/42699577-2de5-4c06-adbf-a39016c89f0d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Minnie31@gmail.com",
    "telephone": "517.479.7332 x0985",
    "givenName": "Kihn",
    "familyName": "Claudie",
    "identifier": "a35587f0-bf08-4dff-8fb7-407b3cdce872"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 496.780893ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.639987ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/42699577-2de5-4c06-adbf-a39016c89f0d
...
---
Response status code: 201 Created. Responded in 241.412783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/42699577-2de5-4c06-adbf-a39016c89f0d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/42699577-2de5-4c06-adbf-a39016c89f0d#/orderedItems/2803",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2522#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/42699577-2de5-4c06-adbf-a39016c89f0d/versions/415715e9-1e83-41c7-a490-41746c143d1d",
  "payment": {
    "@type": "Payment",
    "identifier": "3va5F4g0Z",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;42699577-2de5-4c06-adbf-a39016c89f0d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/42699577-2de5-4c06-adbf-a39016c89f0d


---
Response status code: 200 OK. Responded in 4.297239ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836761029224&afterId=fa52de51-9d9f-4309-91c9-353c1483f3c1",
  "message": "Listening for UUID: '42699577-2de5-4c06-adbf-a39016c89f0d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 11.753706ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;42699577-2de5-4c06-adbf-a39016c89f0d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/42699577-2de5-4c06-adbf-a39016c89f0d


---
Response status code: 200 OK. Responded in 2455.955737ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "42699577-2de5-4c06-adbf-a39016c89f0d",
  "modified": 637940836790399100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/42699577-2de5-4c06-adbf-a39016c89f0d",
    "identifier": "42699577-2de5-4c06-adbf-a39016c89f0d",
...
---
Response status code: 200 OK. Responded in 4.439841ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836790399149&afterId=42699577-2de5-4c06-adbf-a39016c89f0d",
  "message": "Listening for UUID: '42699577-2de5-4c06-adbf-a39016c89f0d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/42699577-2de5-4c06-adbf-a39016c89f0d
...
---
Response status code: 201 Created. Responded in 884.861703ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/42699577-2de5-4c06-adbf-a39016c89f0d",
  "identifier": "42699577-2de5-4c06-adbf-a39016c89f0d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1220.366776ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "42699577-2de5-4c06-adbf-a39016c89f0d",
  "modified": 637940836822420000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.951828ms.
```json
{
  "data": {
    "@context": [
