...
⚠️ 51 passed with 0 failures, 913 warnings and 240 suggestions 
...
---
Response status code: 200 OK. Responded in 98.391853ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1085/events/10848"
}
```
...
---
Response status code: 200 OK. Responded in 97.347333ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1564/events/15632"
}
```
...
---
Response status code: 200 OK. Responded in 91.85413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838"
}
```
...
---
Response status code: 200 OK. Responded in 95.065991ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1085%2Fevents%2F10848?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 38.595527ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1085/events/10848",
    "startDate": "2022-07-31T22:29:11+00:00",
    "endDate": "2022-08-01T03:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1085",
      "name": "Rubber Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1085#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1564%2Fevents%2F15632?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 37.288702ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1564/events/15632",
    "startDate": "2022-07-30T01:19:11+00:00",
    "endDate": "2022-07-30T06:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1564",
      "name": "Rubber Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1564#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT13H47M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1184%2Ffacility-use-slots%2F11838?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 36.256783ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 3,
    "startDate": "2022-08-01T01:09:12+00:00",
    "endDate": "2022-08-01T06:34:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1634%2Ffacility-use-slots%2F16332?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.59767ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1634",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT2H51M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-26T06:44:12+00:00",
    "endDate": "2022-07-26T11:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b154d93c-1bc2-44f9-88ea-f22ad7655238
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1085#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1085/events/10848",
      "attendee": {
        "@type": "Person",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1564#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1564/events/15632",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
...
---
Response status code: 200 OK. Responded in 2749.742801ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b154d93c-1bc2-44f9-88ea-f22ad7655238",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1634"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-26T06:44:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1085%2Fevents%2F10848?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 422.663637ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1085/events/10848",
  "modified": 1658486870750,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1564%2Fevents%2F15632?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 422.083725ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1564/events/15632",
  "modified": 1658486870751,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1184%2Ffacility-use-slots%2F11838?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 928.011603ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838",
  "modified": 1658486871259,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1634%2Ffacility-use-slots%2F16332?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 929.421633ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332",
  "modified": 1658486871260,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b154d93c-1bc2-44f9-88ea-f22ad7655238
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josefa_Kuvalis56@hotmail.com",
    "telephone": "(608) 328-4837",
    "givenName": "Blanda",
    "familyName": "Kaya",
    "identifier": "2989bf8b-60d1-4319-86a3-945099869c42"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1843.546346ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.753351ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.33712ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.184097ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.538883ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b154d93c-1bc2-44f9-88ea-f22ad7655238
...
---
Response status code: 201 Created. Responded in 1476.946073ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b154d93c-1bc2-44f9-88ea-f22ad7655238",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2543",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1085#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2544",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1085#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2545",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1564#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2546",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2547",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11838#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238#/orderedItems/2548",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1634/facility-use-slots/16332#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b154d93c-1bc2-44f9-88ea-f22ad7655238/versions/c4f4a97d-8f82-4c8a-b10f-4c95bc53b627",
  "payment": {
    "@type": "Payment",
    "identifier": "ZC_sAyzvH",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b154d93c-1bc2-44f9-88ea-f22ad7655238&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b154d93c-1bc2-44f9-88ea-f22ad7655238


---
Response status code: 200 OK. Responded in 19.229002ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836602458092&afterId=44b92edb-1aaf-460e-b985-80bcd4294e18",
  "message": "Listening for UUID: 'b154d93c-1bc2-44f9-88ea-f22ad7655238' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 319.799384ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b154d93c-1bc2-44f9-88ea-f22ad7655238&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b154d93c-1bc2-44f9-88ea-f22ad7655238


---
Response status code: 200 OK. Responded in 2673.3330809999998ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b154d93c-1bc2-44f9-88ea-f22ad7655238",
  "modified": 637940836787677800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b154d93c-1bc2-44f9-88ea-f22ad7655238",
    "identifier": "b154d93c-1bc2-44f9-88ea-f22ad7655238",
...
---
Response status code: 200 OK. Responded in 17.945975ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238
...
---
Response status code: 201 Created. Responded in 1228.842386ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b154d93c-1bc2-44f9-88ea-f22ad7655238",
  "identifier": "b154d93c-1bc2-44f9-88ea-f22ad7655238",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 32.90748ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b154d93c-1bc2-44f9-88ea-f22ad7655238",
  "modified": 637940836816051200
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 20.582625ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.468702ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.767608ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.266198ms.
```json
{
  "data": {
    "@context": [
