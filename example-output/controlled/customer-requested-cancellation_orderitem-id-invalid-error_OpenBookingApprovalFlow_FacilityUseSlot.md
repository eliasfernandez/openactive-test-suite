...
---
Response status code: 200 OK. Responded in 17.354045ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1221.777842ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2295/facility-use-slots/20295",
  "modified": 1658486387845,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:45+00:00",
    "endDate": "2022-07-23T11:39:45+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cf8d39ad-acd0-4129-afd1-2ef8caef82c7
...
---
Response status code: 200 OK. Responded in 116.037072ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:46+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2295%2Ffacility-use-slots%2F20295?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1031.569647ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2295/facility-use-slots/20295",
  "modified": 1658486389229,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cf8d39ad-acd0-4129-afd1-2ef8caef82c7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emmitt_Hermiston@gmail.com",
    "telephone": "(599) 845-9548",
    "givenName": "Hammes",
    "familyName": "Vicente",
    "identifier": "55e6ccbf-8227-43b3-8aaa-0fa2c88e9459"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 140.76678ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 7.639164ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cf8d39ad-acd0-4129-afd1-2ef8caef82c7
...
---
Response status code: 201 Created. Responded in 230.23473ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cf8d39ad-acd0-4129-afd1-2ef8caef82c7#/orderedItems/1368",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2295/facility-use-slots/20295#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/cf8d39ad-acd0-4129-afd1-2ef8caef82c7/versions/2f64092c-5689-49cd-a745-dde8abe58bbb",
  "payment": {
    "@type": "Payment",
    "identifier": "DX4dmxjxN",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;cf8d39ad-acd0-4129-afd1-2ef8caef82c7&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/cf8d39ad-acd0-4129-afd1-2ef8caef82c7


---
Response status code: 200 OK. Responded in 12.420104ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831843924510&afterId=4d1e3dba-255b-458b-846e-2ddccd31bcac",
  "message": "Listening for UUID: 'cf8d39ad-acd0-4129-afd1-2ef8caef82c7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.117344ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;cf8d39ad-acd0-4129-afd1-2ef8caef82c7&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/cf8d39ad-acd0-4129-afd1-2ef8caef82c7


---
Response status code: 200 OK. Responded in 2241.199173ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "modified": 637940831891015400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
    "identifier": "cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
...
---
Response status code: 200 OK. Responded in 18.794757ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831891015401&afterId=cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "message": "Listening for UUID: 'cf8d39ad-acd0-4129-afd1-2ef8caef82c7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/cf8d39ad-acd0-4129-afd1-2ef8caef82c7
...
---
Response status code: 201 Created. Responded in 67.844467ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "identifier": "cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 992.133182ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "cf8d39ad-acd0-4129-afd1-2ef8caef82c7",
  "modified": 637940831913935000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 3.991534ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/cf8d39ad-acd0-4129-afd1-2ef8caef82c7
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cf8d39ad-acd0-4129-afd1-2ef8caef82c7#/orderedItems/1368-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 148.53124ms.
```json
{
  "@context": "https://openactive.io/",
