[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:42:14 GMT+0000 (Coordinated Universal Time)
...
⚠️ 24 passed with 0 failures, 507 warnings and 132 suggestions 
...
---
Response status code: 200 OK. Responded in 76.752086ms.
```json
{
...
---
Response status code: 200 OK. Responded in 161.24634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 182.212727ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 27.482246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 346.281792ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2387/events/20387",
  "modified": 1658486565785,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2387/events/20387",
    "startDate": "2022-07-23T10:42:44+00:00",
    "endDate": "2022-07-23T11:42:44+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 345.555785ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2388/events/20388",
  "modified": 1658486565786,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 635.05407ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2376/facility-use-slots/20376",
  "modified": 1658486566076,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 633.816459ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2375/facility-use-slots/20375",
  "modified": 1658486566075,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josefina70@yahoo.com",
    "telephone": "(887) 270-3378",
    "givenName": "Kling",
    "familyName": "Mercedes",
    "identifier": "ca7c9e16-4748-4ed0-8e8c-cbc279289817"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 201 Created. Responded in 425.409598ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1899",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2387#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1900",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2387#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1901",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2388#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1902",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2376/facility-use-slots/20376#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1903",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2376/facility-use-slots/20376#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771#/orderedItems/1904",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2375/facility-use-slots/20375#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771/versions/40ea2a39-84cc-410b-b645-c83ef2160355",
  "payment": {
    "@type": "Payment",
    "identifier": "3PNcz2HUS",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c7c247ed-0b7c-46b2-ac79-3ef9e65b9771&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771


---
Response status code: 200 OK. Responded in 3.624533ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833622909243&afterId=d49b7c95-6c8f-40ba-a9bf-353f234b554b",
  "message": "Listening for UUID: 'c7c247ed-0b7c-46b2-ac79-3ef9e65b9771' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.509212ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c7c247ed-0b7c-46b2-ac79-3ef9e65b9771&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771


---
Response status code: 200 OK. Responded in 2160.060291ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  "modified": 637940833662553700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
    "identifier": "c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
...
---
Response status code: 200 OK. Responded in 3.899634ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833662553748&afterId=c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  "message": "Listening for UUID: 'c7c247ed-0b7c-46b2-ac79-3ef9e65b9771' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771
...
---
Response status code: 201 Created. Responded in 315.892847ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  "identifier": "c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 4.121536ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c7c247ed-0b7c-46b2-ac79-3ef9e65b9771",
  "modified": 637940833684846500
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2387%2Fevents%2F20387?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 11.211597ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2388%2Fevents%2F20388?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 10.583092ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2376%2Ffacility-use-slots%2F20376?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 10.124588ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2375%2Ffacility-use-slots%2F20375?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 9.684585ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 106.108522ms.
```json
{
  "@context": [
    "https://openactive.io/",
