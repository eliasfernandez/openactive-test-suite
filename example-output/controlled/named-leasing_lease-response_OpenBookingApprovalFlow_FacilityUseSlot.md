...
---
Response status code: 200 OK. Responded in 71.024535ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1544.785911ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2387/facility-use-slots/20387",
  "modified": 1658486599550,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:43:16+00:00",
    "endDate": "2022-07-23T11:43:16+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0d1550fb-8f97-41fe-a56a-9be0cffc2c8c
...
---
Response status code: 200 OK. Responded in 1016.8156ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0d1550fb-8f97-41fe-a56a-9be0cffc2c8c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2387%2Ffacility-use-slots%2F20387?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 818.421532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2387/facility-use-slots/20387",
  "modified": 1658486601674,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0d1550fb-8f97-41fe-a56a-9be0cffc2c8c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Noemie10@yahoo.com",
    "telephone": "1-468-270-9246",
    "givenName": "Morissette",
    "familyName": "Pearline",
    "identifier": "1da0ce22-fd43-4732-8c22-f0b000a5418c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 298.580074ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:20+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.087081ms.
```json
{
  "data": {
    "@context": [
