...
---
Response status code: 200 OK. Responded in 223.759428ms.
```json
{
...
---
Response status code: 200 OK. Responded in 331.594758ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298",
  "modified": 1658486371805,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298",
    "startDate": "2022-07-23T10:39:30+00:00",
    "endDate": "2022-07-23T11:39:30+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c7be6793-7c57-4198-8a2b-7b6343b7392b
...
---
Response status code: 200 OK. Responded in 211.292521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c7be6793-7c57-4198-8a2b-7b6343b7392b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2298%2Fevents%2F20298?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 373.157316ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298",
  "modified": 1658486372871,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c7be6793-7c57-4198-8a2b-7b6343b7392b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cheyenne.Bechtelar@hotmail.com",
    "telephone": "(868) 799-4701 x708",
    "givenName": "Parker",
    "familyName": "Cortez",
    "identifier": "9ad49f93-2f1c-4f5d-9d62-aa28d9f4c122"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 106.148214ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 58.602405ms.
```json
{
  "data": {
    "@context": [
