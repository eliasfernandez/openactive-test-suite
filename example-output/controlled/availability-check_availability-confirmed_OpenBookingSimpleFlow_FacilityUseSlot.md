...
---
Response status code: 200 OK. Responded in 207.578189ms.
```json
{
...
---
Response status code: 200 OK. Responded in 708.556306ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2286/facility-use-slots/20286",
  "modified": 1658486374313,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:32+00:00",
    "endDate": "2022-07-23T11:39:32+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6af8653d-e5b6-44f0-9011-474f49635622
...
---
Response status code: 200 OK. Responded in 100.006462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6af8653d-e5b6-44f0-9011-474f49635622",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:33+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2286%2Ffacility-use-slots%2F20286?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1074.894965ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2286/facility-use-slots/20286",
  "modified": 1658486375717,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6af8653d-e5b6-44f0-9011-474f49635622
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Conner_Lindgren5@yahoo.com",
    "telephone": "(960) 527-9288",
    "givenName": "Mohr",
    "familyName": "Verla",
    "identifier": "7de0d74a-4654-47cc-aec4-4f5cc9e497fd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 122.889659ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.79654ms.
```json
{
  "data": {
    "@context": [
