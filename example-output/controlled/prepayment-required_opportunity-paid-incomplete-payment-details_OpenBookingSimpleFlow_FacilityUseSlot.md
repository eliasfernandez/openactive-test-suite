...
---
Response status code: 200 OK. Responded in 60.873148ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1115.367743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2463/facility-use-slots/20463",
  "modified": 1658486774223,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:46:12+00:00",
    "endDate": "2022-07-23T11:46:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4886be24-c57b-47a6-a436-1be5d35d8016
...
---
Response status code: 200 OK. Responded in 1689.647415ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4886be24-c57b-47a6-a436-1be5d35d8016",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2463%2Ffacility-use-slots%2F20463?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 204.32054ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2463/facility-use-slots/20463",
  "modified": 1658486776396,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4886be24-c57b-47a6-a436-1be5d35d8016
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaime_Koelpin@hotmail.com",
    "telephone": "754-979-0797 x8039",
    "givenName": "King",
    "familyName": "Elizabeth",
    "identifier": "96a02acd-6463-48f5-8142-0a1923e12d13"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 289.4702ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.343392ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4886be24-c57b-47a6-a436-1be5d35d8016
...
---
Response status code: 400 Bad Request. Responded in 333.180593ms.
```json
{
  "@context": "https://openactive.io/",
