...
⚠️ 11 passed with 0 failures, 84 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 9.054231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/167/facility-use-slots/1670"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F167%2Ffacility-use-slots%2F1670?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.475341ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/167",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/167/facility-use-slots/1670#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-25T11:26:11+00:00",
    "endDate": "2022-07-25T14:52:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9bdf2d72-1d41-4e55-9360-512357aa2ab1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/167/facility-use-slots/1670#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/167/facility-use-slots/1670"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 179.552485ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9bdf2d72-1d41-4e55-9360-512357aa2ab1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:14+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/167"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-25T11:26:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F167%2Ffacility-use-slots%2F1670?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 706.740744ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/167/facility-use-slots/1670",
  "modified": 1658486656904,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9bdf2d72-1d41-4e55-9360-512357aa2ab1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Agustina.Baumbach@hotmail.com",
    "telephone": "1-994-941-8909 x22188",
    "givenName": "McCullough",
    "familyName": "Horace",
    "identifier": "d0fa9284-0ff8-4c3a-91b9-d1044da3de68"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 160.040186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.105209ms.
```json
{
  "data": {
    "@context": [
