[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:52:35 GMT+0000 (Coordinated Universal Time)
...
⚠️ 51 passed with 0 failures, 713 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 40.918657ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/633/events/6323"
}
```
...
---
Response status code: 200 OK. Responded in 39.873841ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4122"
}
```
...
---
Response status code: 200 OK. Responded in 38.893525ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601"
}
```
...
---
Response status code: 200 OK. Responded in 46.389246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F633%2Fevents%2F6323?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.483751ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/633/events/6323",
    "startDate": "2022-07-28T22:20:11+00:00",
    "endDate": "2022-07-29T00:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/633",
      "name": "Soft Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/633#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 11.29,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT10H13M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F413%2Fevents%2F4122?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.060044ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4122",
    "startDate": "2022-07-28T08:27:11+00:00",
    "endDate": "2022-07-28T12:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/413",
      "name": "Metal Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/413#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT15H49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F361%2Ffacility-use-slots%2F3601?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.664138ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 12.01,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT17H38M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-31T22:39:12+00:00",
    "endDate": "2022-08-01T03:16:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F76%2Ffacility-use-slots%2F755?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.284631ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/76",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 7,
    "startDate": "2022-07-22T21:44:11+00:00",
    "endDate": "2022-07-22T23:02:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e810815a-e42e-4dbd-877f-648a8580323a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/633#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/633/events/6323"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/413#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4122"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1636.7809109999998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e810815a-e42e-4dbd-877f-648a8580323a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:48+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/633"
        },
        "maximumAttendeeCapacity": 24,
        "remainingAttendeeCapacity": 24
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/76"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-22T21:44:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F633%2Fevents%2F6323?useCacheIfAvailable=true&expectedCapacity=22


---
Response status code: 200 OK. Responded in 766.844199ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/633/events/6323",
  "modified": 1658487172487,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F413%2Fevents%2F4122?useCacheIfAvailable=true&expectedCapacity=28


---
Response status code: 200 OK. Responded in 768.369524ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/413/events/4122",
  "modified": 1658487172490,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F361%2Ffacility-use-slots%2F3601?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 587.856665ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601",
  "modified": 1658487172309,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F76%2Ffacility-use-slots%2F755?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 588.559877ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755",
  "modified": 1658487172313,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e810815a-e42e-4dbd-877f-648a8580323a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaycee_Skiles98@yahoo.com",
    "telephone": "863-266-2615 x868",
    "givenName": "Hagenes",
    "familyName": "Joannie",
    "identifier": "7d99a425-b211-49b1-981b-3323aa4cd258"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 707.801479ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:51+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 66.422424ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 65.834614ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 65.304605ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 64.869298ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a
...
---
Response status code: 201 Created. Responded in 843.918381ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3203",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/633#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3204",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/633#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3205",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/413#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3206",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3207",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3601#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e810815a-e42e-4dbd-877f-648a8580323a#/orderedItems/3208",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/76/facility-use-slots/755#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 46.937594ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 46.344184ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 45.924277ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 45.49647ms.
```json
{
  "data": {
    "@context": [
