[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:33:11 GMT+0000 (Coordinated Universal Time)
...
⚠️ 44 passed with 0 failures, 574 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 62.415437ms.
```json
{
...
---
Response status code: 200 OK. Responded in 75.967454ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 119.348127ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 763.031065ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2043/events/20043",
  "modified": 1658486015181,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2043/events/20043",
    "startDate": "2022-07-23T10:33:33+00:00",
    "endDate": "2022-07-23T11:33:33+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 762.250458ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044",
  "modified": 1658486015182,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 769.119517ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2045/events/20045",
  "modified": 1658486015183,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c
...
---
Response status code: 200 OK. Responded in 92.973925ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2043%2Fevents%2F20043?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 335.309886ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2043/events/20043",
  "modified": 1658486016306,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2044%2Fevents%2F20044?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 334.845682ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044",
  "modified": 1658486016307,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2045%2Fevents%2F20045?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 339.986022ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2045/events/20045",
  "modified": 1658486016308,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hubert.Maggio90@yahoo.com",
    "telephone": "447.350.0488 x76929",
    "givenName": "Grady",
    "familyName": "Loyal",
    "identifier": "011b8611-b4e9-4568-a243-fa89ed8b82ea"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 125.943471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:35+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 11.152686ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.640183ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.218679ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c
...
---
Response status code: 201 Created. Responded in 83.576644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c#/orderedItems/257",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2043#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c#/orderedItems/258",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2044#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c#/orderedItems/259",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2045#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c/versions/495ec009-5c8d-456e-8103-be4035d5a0b7",
  "payment": {
    "@type": "Payment",
    "identifier": "kMFboMywx",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;8c8a7cf0-f626-4632-9d35-a3e5cb027a7c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c


---
Response status code: 200 OK. Responded in 54.634521ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828139891265&afterId=d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "message": "Listening for UUID: '8c8a7cf0-f626-4632-9d35-a3e5cb027a7c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 32.135748ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;8c8a7cf0-f626-4632-9d35-a3e5cb027a7c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c


---
Response status code: 200 OK. Responded in 2052.037326ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "modified": 637940828169829400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
    "identifier": "8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
...
---
Response status code: 200 OK. Responded in 13.266002ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828169829370&afterId=8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "message": "Listening for UUID: '8c8a7cf0-f626-4632-9d35-a3e5cb027a7c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c
...
---
Response status code: 201 Created. Responded in 110.990356ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "identifier": "8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 16.473348ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "modified": 637940828191153900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 20.158882ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.673577ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.267073ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c
...
---
Response status code: 400 Bad Request. Responded in 29.896169ms.
```json
{
  "@context": "https://openactive.io/",
...
### Orders (orders) Feed listen for &#x27;8c8a7cf0-f626-4632-9d35-a3e5cb027a7c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c


---
Response status code: 200 OK. Responded in 12.956016ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940828090218856&afterId=d54da3b9-5a96-4f83-8888-5bc99202a794",
  "message": "Listening for UUID: '8c8a7cf0-f626-4632-9d35-a3e5cb027a7c' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 23.29921ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
...
### Orders (orders) Feed collect for &#x27;8c8a7cf0-f626-4632-9d35-a3e5cb027a7c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/8c8a7cf0-f626-4632-9d35-a3e5cb027a7c


---
Response status code: 200 OK. Responded in 2174.876096ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "8c8a7cf0-f626-4632-9d35-a3e5cb027a7c",
  "modified": 637940828244687100,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
