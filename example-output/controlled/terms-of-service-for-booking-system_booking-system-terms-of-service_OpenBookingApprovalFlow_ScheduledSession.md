...
---
Response status code: 200 OK. Responded in 32.785776ms.
```json
{
...
---
Response status code: 200 OK. Responded in 468.971954ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322",
  "modified": 1658486420517,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322",
    "startDate": "2022-07-23T10:40:19+00:00",
    "endDate": "2022-07-23T11:40:19+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/037b4885-8c58-451d-ad70-89dd4b4f1cd9
...
---
Response status code: 200 OK. Responded in 71.2039ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2322%2Fevents%2F20322?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 838.966574ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322",
  "modified": 1658486421537,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/037b4885-8c58-451d-ad70-89dd4b4f1cd9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Craig.Nolan@yahoo.com",
    "telephone": "701-535-3027 x5321",
    "givenName": "Wilkinson",
    "familyName": "Ottis",
    "identifier": "52ed9859-e105-4601-afd2-dfcd2be2ac09"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 101.052152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.65424ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/037b4885-8c58-451d-ad70-89dd4b4f1cd9
...
---
Response status code: 201 Created. Responded in 59.610402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/037b4885-8c58-451d-ad70-89dd4b4f1cd9#/orderedItems/1468",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2322#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/037b4885-8c58-451d-ad70-89dd4b4f1cd9/versions/0beecf8f-9a35-4ede-9d99-b3620b4c7263",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;037b4885-8c58-451d-ad70-89dd4b4f1cd9&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/037b4885-8c58-451d-ad70-89dd4b4f1cd9


---
Response status code: 200 OK. Responded in 4.191236ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832024681001&afterId=deac3231-812b-4c87-b655-2ba7b7d5312c",
  "message": "Listening for UUID: '037b4885-8c58-451d-ad70-89dd4b4f1cd9' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 11.885601ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;037b4885-8c58-451d-ad70-89dd4b4f1cd9&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/037b4885-8c58-451d-ad70-89dd4b4f1cd9


---
Response status code: 200 OK. Responded in 2209.848255ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  "modified": 637940832210736600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/037b4885-8c58-451d-ad70-89dd4b4f1cd9",
    "identifier": "037b4885-8c58-451d-ad70-89dd4b4f1cd9",
...
---
Response status code: 200 OK. Responded in 13.908028ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832212278349&afterId=30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "message": "Listening for UUID: '037b4885-8c58-451d-ad70-89dd4b4f1cd9' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/037b4885-8c58-451d-ad70-89dd4b4f1cd9
...
---
Response status code: 201 Created. Responded in 111.716724ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  "identifier": "037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1778.003091ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "037b4885-8c58-451d-ad70-89dd4b4f1cd9",
  "modified": 637940832233726000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 20.160685ms.
```json
{
  "data": {
    "@context": [
