...
---
Response status code: 200 OK. Responded in 21.111934ms.
```json
{
...
---
Response status code: 200 OK. Responded in 696.481127ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2059/facility-use-slots/20059",
  "modified": 1658486054534,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/28bd58bd-a9ca-43af-8392-3cdaa9909be0
...
---
Response status code: 200 OK. Responded in 111.857311ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2059%2Ffacility-use-slots%2F20059?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 577.569872ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2059/facility-use-slots/20059",
  "modified": 1658486055326,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/28bd58bd-a9ca-43af-8392-3cdaa9909be0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Constantin.Hamill19@gmail.com",
    "telephone": "780.258.4546 x73281",
    "givenName": "Beahan",
    "familyName": "Theresia",
    "identifier": "283895c9-d0c6-4f86-a72c-1815d6222db7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 104.632165ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 20.634432ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/28bd58bd-a9ca-43af-8392-3cdaa9909be0
...
---
Response status code: 201 Created. Responded in 123.582791ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/28bd58bd-a9ca-43af-8392-3cdaa9909be0#/orderedItems/358",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2059/facility-use-slots/20059#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/28bd58bd-a9ca-43af-8392-3cdaa9909be0/versions/a4adb22b-ed30-486a-978e-d94ad19ce668",
  "payment": {
    "@type": "Payment",
    "identifier": "T9QdkQAX0",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;28bd58bd-a9ca-43af-8392-3cdaa9909be0&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/28bd58bd-a9ca-43af-8392-3cdaa9909be0


---
Response status code: 200 OK. Responded in 3.248621ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '28bd58bd-a9ca-43af-8392-3cdaa9909be0' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 13.141584ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;28bd58bd-a9ca-43af-8392-3cdaa9909be0&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/28bd58bd-a9ca-43af-8392-3cdaa9909be0


---
Response status code: 200 OK. Responded in 2100.969553ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "modified": 637940828550716700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/28bd58bd-a9ca-43af-8392-3cdaa9909be0",
    "identifier": "28bd58bd-a9ca-43af-8392-3cdaa9909be0",
...
---
Response status code: 200 OK. Responded in 6.265641ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828550716629&afterId=28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "message": "Listening for UUID: '28bd58bd-a9ca-43af-8392-3cdaa9909be0' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/28bd58bd-a9ca-43af-8392-3cdaa9909be0
...
---
Response status code: 201 Created. Responded in 30.811598ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "identifier": "28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1530.343599ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "28bd58bd-a9ca-43af-8392-3cdaa9909be0",
  "modified": 637940828572171900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 3.536423ms.
```json
{
  "data": {
    "@context": [
