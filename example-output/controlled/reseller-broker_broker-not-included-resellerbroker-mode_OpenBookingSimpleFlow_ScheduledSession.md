...
⚠️ 23 passed with 0 failures, 241 warnings and 82 suggestions 
...
---
Response status code: 200 OK. Responded in 236.203128ms.
```json
{
...
---
Response status code: 200 OK. Responded in 875.445019ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2200/events/20200",
  "modified": 1658486226258,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/73bb8b15-3a74-45f3-8bb4-dae3f556ab25
...
---
Response status code: 400 Bad Request. Responded in 111.420157ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 120.276033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 361.289403ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/984a7639-f71b-4367-8b33-c72404afd73d
...
---
Response status code: 200 OK. Responded in 86.336041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/984a7639-f71b-4367-8b33-c72404afd73d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2204%2Fevents%2F20204?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1046.180886ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204",
  "modified": 1658486228647,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/984a7639-f71b-4367-8b33-c72404afd73d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Della_Rau19@yahoo.com",
    "telephone": "1-668-307-2829",
    "givenName": "Jacobson",
    "familyName": "Ewell",
    "identifier": "66a0d264-3d3d-495a-ae2c-05544241fa4c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 22.679795ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
---
Response status code: 200 OK. Responded in 88.027656ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 637.268173ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2206/events/20206",
  "modified": 1658486229530,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/242ee3d8-f4f8-40dd-a8a1-99e252f5fca5
...
---
Response status code: 200 OK. Responded in 366.981724ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/242ee3d8-f4f8-40dd-a8a1-99e252f5fca5",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2206%2Fevents%2F20206?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 369.924935ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2206/events/20206",
  "modified": 1658486230523,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/242ee3d8-f4f8-40dd-a8a1-99e252f5fca5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alvena.Strosin19@yahoo.com",
    "telephone": "1-391-415-9451",
    "givenName": "Kemmer",
    "familyName": "Laverna",
    "identifier": "47332c85-0d7e-4f21-a2db-f287df7a0497"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 251.80283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 17.300432ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/242ee3d8-f4f8-40dd-a8a1-99e252f5fca5
...
---
Response status code: 400 Bad Request. Responded in 42.627127ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
