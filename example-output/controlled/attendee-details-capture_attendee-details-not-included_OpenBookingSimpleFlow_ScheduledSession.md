...
---
Response status code: 200 OK. Responded in 187.502902ms.
```json
{
...
---
Response status code: 200 OK. Responded in 617.167613ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2169/events/20169",
  "modified": 1658486190553,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2169/events/20169",
    "startDate": "2022-07-23T10:36:28+00:00",
    "endDate": "2022-07-23T11:36:28+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/44be9d53-dab0-41b7-bb92-2a1d9d4cdb41
...
---
Response status code: 200 OK. Responded in 272.157434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/44be9d53-dab0-41b7-bb92-2a1d9d4cdb41",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2169%2Fevents%2F20169?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 305.365483ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2169/events/20169",
  "modified": 1658486191677,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/44be9d53-dab0-41b7-bb92-2a1d9d4cdb41
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alexandrine.Schowalter84@hotmail.com",
    "telephone": "906-709-3333 x2707",
    "givenName": "Balistreri",
    "familyName": "Maud",
    "identifier": "f5c11308-b3ae-41b6-b2b4-5b94ed18f771"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 202.409201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/44be9d53-dab0-41b7-bb92-2a1d9d4cdb41
...
---
Response status code: 409 Conflict. Responded in 19.270652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/44be9d53-dab0-41b7-bb92-2a1d9d4cdb41",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
