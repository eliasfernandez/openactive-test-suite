...
---
Response status code: 200 OK. Responded in 18.463558ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1377.589664ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280",
  "modified": 1658486362674,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:20+00:00",
    "endDate": "2022-07-23T11:39:20+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64
...
---
Response status code: 200 OK. Responded in 206.508863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:21+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2280%2Ffacility-use-slots%2F20280?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1194.442501ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280",
  "modified": 1658486364354,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "927-807-7518 x37693",
    "givenName": "Gibson",
    "familyName": "Elmer",
    "identifier": "b670aae6-0fcb-4780-bd91-bb1210087ff7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 315.607095ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.208836ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64
...
---
Response status code: 201 Created. Responded in 59.501408ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64#/orderedItems/1265",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.704034ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e18bbd7f-3ffb-46dd-8c14-b5ff42707e64#/orderedItems/1265-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 19.923771ms.
```json
{
  "@context": "https://openactive.io/",
