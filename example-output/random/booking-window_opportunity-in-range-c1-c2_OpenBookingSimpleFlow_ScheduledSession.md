...
⚠️ 10 passed with 0 failures, 118 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 169.33113ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4575"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F458%2Fevents%2F4575?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 81.951273ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4575",
    "startDate": "2022-08-01T00:01:11+00:00",
    "endDate": "2022-08-01T02:02:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4f180d36-a3bd-4c10-b6e8-b45940e14d1f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4575"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 686.442557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4f180d36-a3bd-4c10-b6e8-b45940e14d1f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F458%2Fevents%2F4575?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 983.305648ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/458/events/4575",
  "modified": 1658486970734,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4f180d36-a3bd-4c10-b6e8-b45940e14d1f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Julia.Dietrich43@hotmail.com",
    "telephone": "238.755.0034",
    "givenName": "Wilkinson",
    "familyName": "Kaitlyn",
    "identifier": "7949e749-838e-4429-b815-20ca79140ee4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 323.881308ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.144399ms.
```json
{
  "data": {
    "@context": [
