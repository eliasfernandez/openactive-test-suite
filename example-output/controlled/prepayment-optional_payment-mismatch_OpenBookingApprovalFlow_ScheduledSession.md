...
---
Response status code: 200 OK. Responded in 393.43388ms.
```json
{
...
---
Response status code: 200 OK. Responded in 847.35091ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504",
  "modified": 1658486842805,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504",
    "startDate": "2022-07-23T10:47:20+00:00",
    "endDate": "2022-07-23T11:47:20+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/39cd7eaf-8d2f-44a4-809c-d6a808c1133d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2504#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 361.859293ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/39cd7eaf-8d2f-44a4-809c-d6a808c1133d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:22+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2504%2Fevents%2F20504?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1039.839862ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504",
  "modified": 1658486844573,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/39cd7eaf-8d2f-44a4-809c-d6a808c1133d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerald34@gmail.com",
    "telephone": "(245) 801-5748 x51704",
    "givenName": "Fadel",
    "familyName": "Domingo",
    "identifier": "5408f036-32fa-428d-9f20-fd93926c700c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 488.682947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.228184ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/39cd7eaf-8d2f-44a4-809c-d6a808c1133d
...
---
Response status code: 400 Bad Request. Responded in 280.633353ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (11) does not match expected value (10)"
}
```
### Specs
