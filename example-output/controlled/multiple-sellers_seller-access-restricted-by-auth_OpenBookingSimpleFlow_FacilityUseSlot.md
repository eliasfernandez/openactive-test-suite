...
---
Response status code: 200 OK. Responded in 19.74565ms.
```json
{
...
---
Response status code: 200 OK. Responded in 932.942073ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2110/facility-use-slots/20110",
  "modified": 1658486122377,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5ee9f415-1a8d-4baf-a3b8-4369a4938789
...
---
Response status code: 401 Unauthorized. Responded in 41.742116ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5ee9f415-1a8d-4baf-a3b8-4369a4938789
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cheyanne.Lesch37@gmail.com",
    "telephone": "1-322-474-7635 x933",
    "givenName": "Pagac",
    "familyName": "Declan",
    "identifier": "cdd1e3ff-e06d-4779-bc30-2d8d46f04889"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 394.149589ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5ee9f415-1a8d-4baf-a3b8-4369a4938789
...
---
Response status code: 401 Unauthorized. Responded in 101.036666ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
