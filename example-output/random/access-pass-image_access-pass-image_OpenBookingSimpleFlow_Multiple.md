...
⚠️ 48 passed with 0 failures, 721 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 34.243415ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6634"
}
```
...
---
Response status code: 200 OK. Responded in 33.2326ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/534/events/5339"
}
```
...
---
Response status code: 200 OK. Responded in 32.327787ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234"
}
```
...
---
Response status code: 200 OK. Responded in 23.475954ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F664%2Fevents%2F6634?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.194634ms.
```json
{
  "data": {
    "@context": [
    ...
    "endDate": "2022-08-01T02:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F534%2Fevents%2F5339?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.777228ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/534/events/5339",
    "startDate": "2022-07-25T03:02:11+00:00",
    "endDate": "2022-07-25T06:32:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/534",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/534#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 6.41,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT7H57M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F234?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.387322ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-27T22:17:11+00:00",
    "endDate": "2022-07-28T02:42:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F556%2Ffacility-use-slots%2F5555?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.004816ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/556",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT10H44M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-28T11:41:12+00:00",
    "endDate": "2022-07-28T16:38:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2570b886-9f59-4a66-9529-a32925e7209d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/664/events/6634"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/534#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/534/events/5339"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1718.616813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2570b886-9f59-4a66-9529-a32925e7209d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:10+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/534"
        },
        "maximumAttendeeCapacity": 48,
        "remainingAttendeeCapacity": 48
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F664%2Fevents%2F6634?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 41.052627ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F534%2Fevents%2F5339?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 38.436488ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F24%2Ffacility-use-slots%2F234?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 835.907773ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234",
  "modified": 1658486534466,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F556%2Ffacility-use-slots%2F5555?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 835.598069ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555",
  "modified": 1658486534467,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2570b886-9f59-4a66-9529-a32925e7209d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dina.Wilderman53@hotmail.com",
    "telephone": "744.944.9934 x98274",
    "givenName": "Schmitt",
    "familyName": "Rex",
    "identifier": "ee7ab5e5-52d0-46b6-9e3b-9fb95c1821a4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 583.198912ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:14+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 49.941163ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.358555ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 48.874647ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 48.43584ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d
...
---
Response status code: 201 Created. Responded in 1095.965347ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1627",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/664#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1628",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/664#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1629",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/534#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1630",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1631",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/24/facility-use-slots/234#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2570b886-9f59-4a66-9529-a32925e7209d#/orderedItems/1632",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 13.700304ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.881506ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.842106ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.671348ms.
```json
{
  "data": {
    "@context": [
