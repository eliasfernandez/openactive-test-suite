...
---
Response status code: 200 OK. Responded in 32.729998ms.
```json
{
...
---
Response status code: 200 OK. Responded in 663.269343ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292",
  "modified": 1658486356460,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292",
    "startDate": "2022-07-23T10:39:14+00:00",
    "endDate": "2022-07-23T11:39:14+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1768aca1-7a86-4c2b-93a2-1336e90246a7
...
---
Response status code: 200 OK. Responded in 298.247917ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1768aca1-7a86-4c2b-93a2-1336e90246a7",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2292%2Fevents%2F20292?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 927.113406ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292",
  "modified": 1658486358148,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1768aca1-7a86-4c2b-93a2-1336e90246a7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Reyes.Reynolds1@yahoo.com",
    "telephone": "(919) 763-1423 x534",
    "givenName": "Jenkins",
    "familyName": "Earlene",
    "identifier": "3f4ef191-b3b8-4cc1-af90-5248e673634d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 431.788852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 15.79583ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1768aca1-7a86-4c2b-93a2-1336e90246a7
...
---
Response status code: 201 Created. Responded in 446.173871ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1768aca1-7a86-4c2b-93a2-1336e90246a7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1768aca1-7a86-4c2b-93a2-1336e90246a7#/orderedItems/1258",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2292#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 29.130649ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/1768aca1-7a86-4c2b-93a2-1336e90246a7
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1768aca1-7a86-4c2b-93a2-1336e90246a7#/orderedItems/1258-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 44.041677ms.
```json
{
  "@context": "https://openactive.io/",
