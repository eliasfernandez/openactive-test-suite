...
---
Response status code: 200 OK. Responded in 5.875892ms.
```json
{
...
---
Response status code: 200 OK. Responded in 11.763585ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 8,
    "startDate": "2022-07-28T06:52:12+00:00",
    "endDate": "2022-07-28T08:38:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ef8ac137-022c-4761-8f31-cd74e4c62d30
...
---
Response status code: 200 OK. Responded in 140.075402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ef8ac137-022c-4761-8f31-cd74e4c62d30",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F594%2Ffacility-use-slots%2F5932?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 996.704386ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932",
  "modified": 1658486380528,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ef8ac137-022c-4761-8f31-cd74e4c62d30
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dakota_Ruecker49@yahoo.com",
    "telephone": "385.430.6662",
    "givenName": "Kihn",
    "familyName": "Isaias",
    "identifier": "019d9e81-443c-47cd-8642-e1d3088c68c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 104.672007ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 21.775213ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ef8ac137-022c-4761-8f31-cd74e4c62d30
...
---
Response status code: 201 Created. Responded in 97.94211ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ef8ac137-022c-4761-8f31-cd74e4c62d30",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef8ac137-022c-4761-8f31-cd74e4c62d30#/orderedItems/1108",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 17.550952ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/ef8ac137-022c-4761-8f31-cd74e4c62d30
...
---
Response status code: 400 Bad Request. Responded in 28.806715ms.
```json
{
  "@context": "https://openactive.io/",
