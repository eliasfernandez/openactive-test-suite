...
---
Response status code: 200 OK. Responded in 302.691734ms.
```json
{
...
---
Response status code: 200 OK. Responded in 338.122955ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2510/events/20510",
  "modified": 1658486851917,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2510/events/20510",
    "startDate": "2022-07-23T10:47:30+00:00",
    "endDate": "2022-07-23T11:47:30+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b228783e-4195-4cd7-9b99-0e38ea01bbc4
...
---
Response status code: 200 OK. Responded in 377.782513ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b228783e-4195-4cd7-9b99-0e38ea01bbc4",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2510%2Fevents%2F20510?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 187.779696ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2510/events/20510",
  "modified": 1658486852897,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b228783e-4195-4cd7-9b99-0e38ea01bbc4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tristian36@gmail.com",
    "telephone": "996.877.7522",
    "givenName": "Waelchi",
    "familyName": "Enrico",
    "identifier": "910ac4f9-d6ab-4bc0-a741-9ff863e98512"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 212.722621ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.320347ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b228783e-4195-4cd7-9b99-0e38ea01bbc4
...
---
Response status code: 201 Created. Responded in 668.555439ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b228783e-4195-4cd7-9b99-0e38ea01bbc4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b228783e-4195-4cd7-9b99-0e38ea01bbc4#/orderedItems/2733",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2510#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 14.015727ms.
```json
{
  "data": {
    "@context": [
