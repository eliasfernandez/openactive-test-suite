...
---
Response status code: 200 OK. Responded in 249.971875ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1046.141723ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2589/events/20589",
  "modified": 1658487014525,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fe992a73-237b-4516-8f81-04ccad908ade
...
---
Response status code: 400 Bad Request. Responded in 169.101739ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fe992a73-237b-4516-8f81-04ccad908ade
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jarvis_Ledner@hotmail.com",
    "telephone": "865-992-1493",
    "givenName": "Reichert",
    "familyName": "Kaylin",
    "identifier": "12925b11-8b72-47c7-9320-2f68877f376e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 41.165375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
