[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:46:55 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 72.828557ms.
```json
{
...
---
Response status code: 200 OK. Responded in 66.372799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 412.187319ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503",
  "modified": 1658486837197,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503",
    "startDate": "2022-07-23T10:47:15+00:00",
    "endDate": "2022-07-23T11:47:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 647.727145ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491",
  "modified": 1658486837437,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2d760694-f19a-4ecb-9088-026bc164dbf6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2503#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503"
    },
    {
      "@type": "OrderItem",
      "position": 1,
...
---
Response status code: 200 OK. Responded in 721.063107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2d760694-f19a-4ecb-9088-026bc164dbf6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:17+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2503%2Fevents%2F20503?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 660.819463ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503",
  "modified": 1658486839144,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2491%2Ffacility-use-slots%2F20491?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 440.448775ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491",
  "modified": 1658486838923,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2d760694-f19a-4ecb-9088-026bc164dbf6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Margaretta.Murazik@gmail.com",
    "telephone": "1-558-619-7375 x9540",
    "givenName": "Boyer",
    "familyName": "Torrance",
    "identifier": "465dbbe6-c9d3-4c90-86f9-f11714e58315"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 726.017251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.982481ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.252574ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2d760694-f19a-4ecb-9088-026bc164dbf6
...
---
Response status code: 400 Bad Request. Responded in 429.009202ms.
```json
{
  "@context": "https://openactive.io/",
