...
---
Response status code: 200 OK. Responded in 223.274831ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1335.587947ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2418/facility-use-slots/20418",
  "modified": 1658486666421,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 1,
    "startDate": "2022-07-23T10:44:24+00:00",
    "endDate": "2022-07-23T11:44:24+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9931e069-d6a7-42dc-ad31-e601da6f32e1
...
---
Response status code: 200 OK. Responded in 750.105122ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9931e069-d6a7-42dc-ad31-e601da6f32e1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2418%2Ffacility-use-slots%2F20418?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 884.564044ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2418/facility-use-slots/20418",
  "modified": 1658486668274,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/95d9c546-f08b-4f17-a41b-392614be5451
...
---
Response status code: 409 Conflict. Responded in 113.492532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/95d9c546-f08b-4f17-a41b-392614be5451",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 20.720488ms.
```json
{
  "data": {
    "@context": [
