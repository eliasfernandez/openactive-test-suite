...
⚠️ 15 passed with 0 failures, 142 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 140.947168ms.
```json
{
...
---
Response status code: 200 OK. Responded in 613.184449ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2111/events/20111",
  "modified": 1658486121837,
  "data": {
    "@context": [
      "https://openactive.io/",
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2111/events/20111",
    "startDate": "2022-07-23T10:35:20+00:00",
    "endDate": "2022-07-23T11:35:20+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b
...
---
Response status code: 200 OK. Responded in 84.40644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:22+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2111%2Fevents%2F20111?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 207.270172ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2111/events/20111",
  "modified": 1658486123709,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rey.Mosciski87@yahoo.com",
    "telephone": "(281) 321-1695 x751",
    "givenName": "Ondricka",
    "familyName": "Adrianna",
    "identifier": "b5f0c077-e774-47fc-b4b3-e43fa5f3c936"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 154.247969ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 3.565127ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b
...
---
Response status code: 201 Created. Responded in 32.626947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b#/orderedItems/541",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2111#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 4.164332ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;55a76cfd-c00e-408a-bd02-8bfc6abd9a2b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b


---
Response status code: 200 OK. Responded in 8.59626ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '55a76cfd-c00e-408a-bd02-8bfc6abd9a2b' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 247.822912ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessChannelUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;55a76cfd-c00e-408a-bd02-8bfc6abd9a2b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b


---
Response status code: 200 OK. Responded in 2547.767868ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "55a76cfd-c00e-408a-bd02-8bfc6abd9a2b",
  "modified": 637940829251885800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b",
    "identifier": "55a76cfd-c00e-408a-bd02-8bfc6abd9a2b",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/55a76cfd-c00e-408a-bd02-8bfc6abd9a2b#/orderedItems/541",
