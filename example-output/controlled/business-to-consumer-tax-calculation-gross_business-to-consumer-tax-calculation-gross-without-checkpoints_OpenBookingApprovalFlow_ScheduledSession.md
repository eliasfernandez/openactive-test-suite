...
⚠️ 9 passed with 0 failures, 98 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 155.103462ms.
```json
{
...
---
Response status code: 200 OK. Responded in 256.697654ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2384/events/20384",
  "modified": 1658486552932,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2384/events/20384",
    "startDate": "2022-07-23T10:42:31+00:00",
    "endDate": "2022-07-23T11:42:31+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ffabd280-84cc-49f3-9da3-ed371319424a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Merlin79@hotmail.com",
    "telephone": "748-509-7140 x99600",
    "givenName": "Barton",
    "familyName": "Benedict",
    "identifier": "be1c5d2c-7761-4e8d-a686-9d5d92d614ac"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 201 Created. Responded in 162.692828ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/ffabd280-84cc-49f3-9da3-ed371319424a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffabd280-84cc-49f3-9da3-ed371319424a#/orderedItems/1873",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2384#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/ffabd280-84cc-49f3-9da3-ed371319424a/versions/c13e3483-7dde-430b-ac45-34434ca99c63",
  "payment": {
    "@type": "Payment",
    "identifier": "l71zP86BR",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;ffabd280-84cc-49f3-9da3-ed371319424a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/ffabd280-84cc-49f3-9da3-ed371319424a


---
Response status code: 200 OK. Responded in 10.130889ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'ffabd280-84cc-49f3-9da3-ed371319424a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 98.848468ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;ffabd280-84cc-49f3-9da3-ed371319424a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/ffabd280-84cc-49f3-9da3-ed371319424a


---
Response status code: 200 OK. Responded in 2270.500935ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ffabd280-84cc-49f3-9da3-ed371319424a",
  "modified": 637940833523817000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/ffabd280-84cc-49f3-9da3-ed371319424a",
    "identifier": "ffabd280-84cc-49f3-9da3-ed371319424a",
...
---
Response status code: 200 OK. Responded in 3.248129ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833523816970&afterId=ffabd280-84cc-49f3-9da3-ed371319424a",
  "message": "Listening for UUID: 'ffabd280-84cc-49f3-9da3-ed371319424a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/ffabd280-84cc-49f3-9da3-ed371319424a
...
---
Response status code: 201 Created. Responded in 59.821325ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ffabd280-84cc-49f3-9da3-ed371319424a",
  "identifier": "ffabd280-84cc-49f3-9da3-ed371319424a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1487.610361ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "ffabd280-84cc-49f3-9da3-ed371319424a",
  "modified": 637940833546996500
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2384%2Fevents%2F20384?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 7.126162ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 40.099152ms.
```json
{
  "@context": [
    "https://openactive.io/",
