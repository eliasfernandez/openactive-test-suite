...
---
Response status code: 200 OK. Responded in 30.996466ms.
```json
{
...
---
Response status code: 200 OK. Responded in 957.365704ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356",
  "modified": 1658486479125,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356",
    "startDate": "2022-07-23T10:41:17+00:00",
    "endDate": "2022-07-23T11:41:17+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/03fd6e4c-874b-4dd5-acdd-599770a8e1d8
...
---
Response status code: 200 OK. Responded in 151.240496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/03fd6e4c-874b-4dd5-acdd-599770a8e1d8",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2356%2Fevents%2F20356?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 692.969758ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356",
  "modified": 1658486480132,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
