...
---
Response status code: 200 OK. Responded in 19.115373ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1662.961668ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590",
  "modified": 1658487034142,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:50:31+00:00",
    "endDate": "2022-07-23T11:50:31+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f70f166-be02-42f2-a3a4-aafc68bda4fb
...
---
Response status code: 200 OK. Responded in 901.627322ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f70f166-be02-42f2-a3a4-aafc68bda4fb",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:33+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2590%2Ffacility-use-slots%2F20590?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 677.652849ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590",
  "modified": 1658487035987,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f70f166-be02-42f2-a3a4-aafc68bda4fb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Albert71@gmail.com",
    "telephone": "369.605.7483 x9967",
    "givenName": "Crist",
    "familyName": "Russel",
    "identifier": "a98525e2-b75e-4065-8864-b9703ee9cbd3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 463.392304ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 27.065246ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2f70f166-be02-42f2-a3a4-aafc68bda4fb
...
---
Response status code: 201 Created. Responded in 1564.8724ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2f70f166-be02-42f2-a3a4-aafc68bda4fb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2f70f166-be02-42f2-a3a4-aafc68bda4fb#/orderedItems/3196",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 26.103736ms.
```json
{
  "data": {
    "@context": [
