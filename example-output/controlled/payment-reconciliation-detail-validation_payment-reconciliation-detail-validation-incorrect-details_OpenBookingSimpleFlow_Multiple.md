[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:55 GMT+0000 (Coordinated Universal Time)
...
⚠️ 26 passed with 0 failures, 341 warnings and 90 suggestions 
...
---
Response status code: 200 OK. Responded in 149.952863ms.
```json
{
...
---
Response status code: 200 OK. Responded in 168.661632ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 151.140673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 207.180583ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1050.408576ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2580/events/20580",
  "modified": 1658487001702,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1049.960272ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2581/events/20581",
...
---
Response status code: 200 OK. Responded in 1012.618831ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568",
  "modified": 1658487001666,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1013.810743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569",
  "modified": 1658487001667,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7f01880e-1250-4470-a24d-ce750174f612
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-gj4DWciwsi",
    "accountId": "invalid-Kc2Q-nzxe",
    "paymentProviderId": "invalid-npwjdW8F8k"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 168.92824ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7f01880e-1250-4470-a24d-ce750174f612
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Thora.VonRueden38@yahoo.com",
    "telephone": "222-938-9459 x1969",
    "givenName": "Grady",
    "familyName": "Trever",
    "identifier": "d5dae3e7-e932-472f-a00b-a285cb7c0d45"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-4GD2JiFExu",
    "accountId": "invalid-nFNdvFroJm",
    "paymentProviderId": "invalid-7_JmgkDt0k"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 237.385865ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
