[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:36:10 GMT+0000 (Coordinated Universal Time)
...
⚠️ 49 passed with 0 failures, 705 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 40.87702ms.
```json
{
...
---
Response status code: 200 OK. Responded in 62.54349ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 48.016676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 47.419671ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 443.318769ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2157/events/20157",
  "modified": 1658486179677,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2157/events/20157",
    "startDate": "2022-07-23T10:36:18+00:00",
    "endDate": "2022-07-23T11:36:18+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 442.781465ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2158/events/20158",
...
---
Response status code: 200 OK. Responded in 631.088738ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2150/facility-use-slots/20150",
  "modified": 1658486179866,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 630.978338ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2151/facility-use-slots/20151",
  "modified": 1658486179867,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf
...
---
Response status code: 200 OK. Responded in 181.38972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:19+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2157%2Fevents%2F20157?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 36.350985ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2158%2Fevents%2F20158?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 35.585378ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2150%2Ffacility-use-slots%2F20150?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 269.226806ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2150/facility-use-slots/20150",
  "modified": 1658486181322,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2151%2Ffacility-use-slots%2F20151?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 262.116251ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2151/facility-use-slots/20151",
  "modified": 1658486181323,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Giles.Okuneva@gmail.com",
    "telephone": "790-425-5608 x6456",
    "givenName": "Boyer",
    "familyName": "Milton",
    "identifier": "77893a24-1940-4661-ad7a-7bba2d903474"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 258.027119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 12.602992ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.202489ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.483492ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.894895ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf
...
---
Response status code: 201 Created. Responded in 388.711049ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/746",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/747",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/748",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2158#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/749",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2150/facility-use-slots/20150#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/750",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2150/facility-use-slots/20150#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b47f9a92-0d7b-472e-b310-30c9f0fa9fdf#/orderedItems/751",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2151/facility-use-slots/20151#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 22.69797ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.946864ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.37806ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.952856ms.
```json
{
  "data": {
    "@context": [
