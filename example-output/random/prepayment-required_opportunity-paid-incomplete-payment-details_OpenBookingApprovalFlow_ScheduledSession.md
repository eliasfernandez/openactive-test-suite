...
---
Response status code: 200 OK. Responded in 11.084132ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12053"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1206%2Fevents%2F12053?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.197788ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12053",
    "startDate": "2022-07-23T10:45:11+00:00",
    "endDate": "2022-07-23T12:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aa93eb33-93f5-4157-a9fb-b5e3c4254939
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12053"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 178.697235ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aa93eb33-93f5-4157-a9fb-b5e3c4254939",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1206%2Fevents%2F12053?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 325.191098ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12053",
  "modified": 1658486884109,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aa93eb33-93f5-4157-a9fb-b5e3c4254939
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Natalie.Morar@gmail.com",
    "telephone": "890-863-4388",
    "givenName": "Beatty",
    "familyName": "Roderick",
    "identifier": "d23d3f9b-1234-4f01-8ea6-478596a1744f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 228.578612ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 34.393474ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/aa93eb33-93f5-4157-a9fb-b5e3c4254939
...
---
Response status code: 400 Bad Request. Responded in 202.823283ms.
```json
{
  "@context": "https://openactive.io/",
