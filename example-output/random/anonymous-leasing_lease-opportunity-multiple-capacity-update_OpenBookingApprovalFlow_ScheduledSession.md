...
⚠️ 31 passed with 0 failures, 347 warnings and 136 suggestions 
...
---
Response status code: 200 OK. Responded in 14.954386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1313/events/13122"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1313%2Fevents%2F13122?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.426215ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1313/events/13122",
    "startDate": "2022-07-25T04:31:11+00:00",
    "endDate": "2022-07-25T08:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f6a92f30-bd89-4566-a7fe-fc06ac788f36
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1313/events/13122"
    },
    {
      "@type": "OrderItem",
      "position": 1,
...
---
Response status code: 200 OK. Responded in 223.874581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f6a92f30-bd89-4566-a7fe-fc06ac788f36",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:07+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1313%2Fevents%2F13122?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 1107.86701ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1313/events/13122",
  "modified": 1658486710007,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/be9fed27-be2d-4b01-b7e4-1277268d0945
...
---
Response status code: 409 Conflict. Responded in 321.042091ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/be9fed27-be2d-4b01-b7e4-1277268d0945",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 33.052454ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c28825f2-a671-4730-a117-b8137e681a18
...
---
Response status code: 200 OK. Responded in 277.884776ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c28825f2-a671-4730-a117-b8137e681a18",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1313%2Fevents%2F13122?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 280.759951ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1313/events/13122",
  "modified": 1658486713002,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1432d73b-bc71-489e-8038-a338ce5e9d55
...
---
Response status code: 409 Conflict. Responded in 147.801717ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1432d73b-bc71-489e-8038-a338ce5e9d55",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 17.654256ms.
```json
{
  "data": {
    "@context": [
