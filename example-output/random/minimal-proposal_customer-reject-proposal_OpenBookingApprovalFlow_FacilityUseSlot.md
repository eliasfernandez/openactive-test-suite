...
# minimal-proposal >> customer-reject-proposal (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 21 passed with 0 failures, 122 warnings and 14 suggestions 
...
---
Response status code: 200 OK. Responded in 26.912027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1420%2Ffacility-use-slots%2F14198?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.245553ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT14H50M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-29T02:29:12+00:00",
    "endDate": "2022-07-29T04:14:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7872bfa6-39ab-44e5-a346-94e73a4414b2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 291.896431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7872bfa6-39ab-44e5-a346-94e73a4414b2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:05+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1420%2Ffacility-use-slots%2F14198?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1301.7849489999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198",
  "modified": 1658486048054,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7872bfa6-39ab-44e5-a346-94e73a4414b2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Beulah_Murray60@yahoo.com",
    "telephone": "895.293.2148 x8355",
    "givenName": "Zemlak",
    "familyName": "Loyal",
    "identifier": "83f6e9ca-1190-4cbf-a1bb-8d81b2079620"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 184.246623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.213867ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7872bfa6-39ab-44e5-a346-94e73a4414b2
...
---
Response status code: 201 Created. Responded in 38.41361ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/7872bfa6-39ab-44e5-a346-94e73a4414b2",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7872bfa6-39ab-44e5-a346-94e73a4414b2#/orderedItems/286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1420/facility-use-slots/14198#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/7872bfa6-39ab-44e5-a346-94e73a4414b2/versions/380a39d1-0ee4-4df7-a7a3-cfffa15d43a3",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;7872bfa6-39ab-44e5-a346-94e73a4414b2&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/7872bfa6-39ab-44e5-a346-94e73a4414b2


---
Response status code: 200 OK. Responded in 3.509755ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '7872bfa6-39ab-44e5-a346-94e73a4414b2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Proposal Request
PATCH https://localhost:5001/api/openbooking/order-proposals/7872bfa6-39ab-44e5-a346-94e73a4414b2
...
---
Response status code: 204 No Content. Responded in 16.058055ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;7872bfa6-39ab-44e5-a346-94e73a4414b2&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/7872bfa6-39ab-44e5-a346-94e73a4414b2


---
Response status code: 200 OK. Responded in 2215.642516ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7872bfa6-39ab-44e5-a346-94e73a4414b2",
  "modified": 637940828476817300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/7872bfa6-39ab-44e5-a346-94e73a4414b2",
    "identifier": "7872bfa6-39ab-44e5-a346-94e73a4414b2",
    "orderProposalStatus": "https://openactive.io/CustomerRejected",
    "orderedItem": [
      {
        "@type": "OrderItem",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7872bfa6-39ab-44e5-a346-94e73a4414b2
...
---
Response status code: 500 Internal Server Error. Responded in 14.19625ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 3.185656ms.
```json
{
  "data": {
    "@context": [
