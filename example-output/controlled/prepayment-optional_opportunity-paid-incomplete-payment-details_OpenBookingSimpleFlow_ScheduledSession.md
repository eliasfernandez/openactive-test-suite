...
---
Response status code: 200 OK. Responded in 236.041048ms.
```json
{
...
---
Response status code: 200 OK. Responded in 598.649647ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506",
  "modified": 1658486847046,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9efb6db5-1d01-4c30-a1a8-7e208e38f317
...
---
Response status code: 200 OK. Responded in 224.920147ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9efb6db5-1d01-4c30-a1a8-7e208e38f317",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2506%2Fevents%2F20506?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 433.765847ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506",
  "modified": 1658486848106,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9efb6db5-1d01-4c30-a1a8-7e208e38f317
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaclyn_Volkman54@yahoo.com",
    "telephone": "(602) 260-5890 x7881",
    "givenName": "Price",
    "familyName": "Abdullah",
    "identifier": "432ca1c4-ee20-4373-85af-dd699966c925"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 308.517305ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 42.966088ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9efb6db5-1d01-4c30-a1a8-7e208e38f317
...
---
Response status code: 400 Bad Request. Responded in 375.860795ms.
```json
{
  "@context": "https://openactive.io/",
