...
⚠️ 34 passed with 0 failures, 618 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 27.660953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/214/events/2136"
}
```
...
---
Response status code: 200 OK. Responded in 26.683737ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/671/events/6702"
}
```
...
---
Response status code: 200 OK. Responded in 25.819822ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4015"
}
```
...
---
Response status code: 200 OK. Responded in 24.993009ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2853"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F214%2Fevents%2F2136?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.964744ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/214/events/2136",
    "startDate": "2022-07-25T15:31:11+00:00",
    "endDate": "2022-07-25T19:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/214",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/214#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F671%2Fevents%2F6702?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.580138ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/671/events/6702",
    "startDate": "2022-07-23T14:26:11+00:00",
    "endDate": "2022-07-23T16:53:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/671",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/671#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.48,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT13H45M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F402%2Ffacility-use-slots%2F4015?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.247233ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4015#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT5H33M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-31T06:51:12+00:00",
    "endDate": "2022-07-31T07:39:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F286%2Ffacility-use-slots%2F2853?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.566337ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2853#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 8.96,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 2,
    "startDate": "2022-07-23T23:14:12+00:00",
    "endDate": "2022-07-24T03:36:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f1a4fb39-9423-4582-b9d8-70ff2c71970e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/214#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/214/events/2136"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/671#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/671/events/6702"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4015#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4015"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2853#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2853"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 330.910116ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f1a4fb39-9423-4582-b9d8-70ff2c71970e",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/214"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/671"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F214%2Fevents%2F2136?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 73.158798ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F671%2Fevents%2F6702?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 53.77458ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F402%2Ffacility-use-slots%2F4015?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 649.800434ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4015",
  "modified": 1658486217945,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F286%2Ffacility-use-slots%2F2853?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 649.421928ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2853",
  "modified": 1658486217947,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f1a4fb39-9423-4582-b9d8-70ff2c71970e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Giovanni.Berge40@hotmail.com",
    "telephone": "(218) 843-4915",
    "givenName": "Beatty",
    "familyName": "Granville",
    "identifier": "25afaf93-3896-4f0e-b7b5-eaf3e81f8ea5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 72.286362ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f1a4fb39-9423-4582-b9d8-70ff2c71970e
...
---
Response status code: 409 Conflict. Responded in 219.322026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f1a4fb39-9423-4582-b9d8-70ff2c71970e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
