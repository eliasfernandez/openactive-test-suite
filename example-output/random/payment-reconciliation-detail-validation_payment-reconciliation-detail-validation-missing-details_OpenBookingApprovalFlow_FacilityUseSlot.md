...
---
Response status code: 200 OK. Responded in 9.764753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16561"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1657%2Ffacility-use-slots%2F16561?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.660657ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16561#/offers/0",
        ...
        "price": 3.8,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT12H58M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-30T17:05:12+00:00",
    "endDate": "2022-07-30T18:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6eb1a93b-bb81-4260-a9e9-1a98777e0b3f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16561#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1657/facility-use-slots/16561"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 75.410082ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6eb1a93b-bb81-4260-a9e9-1a98777e0b3f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kamryn_Cruickshank@yahoo.com",
    "telephone": "1-476-819-9163 x5369",
    "givenName": "Metz",
    "familyName": "Sean",
    "identifier": "f4e6a1e4-3fbc-4bc0-ac1f-5f08070adce6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 16.660361ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
