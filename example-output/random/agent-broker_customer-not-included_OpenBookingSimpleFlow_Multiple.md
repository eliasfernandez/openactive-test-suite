...
⚠️ 74 passed with 0 failures, 964 warnings and 258 suggestions 
...
---
Response status code: 200 OK. Responded in 49.378554ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1878"
}
```
...
---
Response status code: 200 OK. Responded in 40.752422ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/580/events/5797"
}
```
...
---
Response status code: 200 OK. Responded in 39.440503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/347/facility-use-slots/3468"
}
```
...
---
Response status code: 200 OK. Responded in 38.64519ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/348/facility-use-slots/3472"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F188%2Fevents%2F1878?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.290317ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1878",
    "startDate": "2022-07-22T22:02:11+00:00",
    "endDate": "2022-07-22T22:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F580%2Fevents%2F5797?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.604506ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/580/events/5797",
    "startDate": "2022-07-26T06:16:11+00:00",
    "endDate": "2022-07-26T07:43:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/580",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/580#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT16H48M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F347%2Ffacility-use-slots%2F3468?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.962997ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/347/facility-use-slots/3468#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT8H19M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-24T16:19:12+00:00",
    "endDate": "2022-07-24T20:55:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F348%2Ffacility-use-slots%2F3472?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.421688ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/348",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/348/facility-use-slots/3472#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 9.95,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT4H7M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-30T08:31:12+00:00",
    "endDate": "2022-07-30T11:00:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7dad618c-8a35-410e-ab93-86ea60ddf917
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1878"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/580#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/580/events/5797"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/347/facility-use-slots/3468#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/347/facility-use-slots/3468"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/348/facility-use-slots/3472#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/348/facility-use-slots/3472"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 528.672374ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7dad618c-8a35-410e-ab93-86ea60ddf917",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/348"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-30T08:31:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F188%2Fevents%2F1878?useCacheIfAvailable=true&expectedCapacity=39


---
Response status code: 200 OK. Responded in 91.004595ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/188/events/1878",
  "modified": 1658486515820,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F580%2Fevents%2F5797?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 85.863416ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/580/events/5797",
  "modified": 1658486515821,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F347%2Ffacility-use-slots%2F3468?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 633.616012ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/347/facility-use-slots/3468",
  "modified": 1658486516371,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F348%2Ffacility-use-slots%2F3472?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 634.87313ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/348/facility-use-slots/3472",
  "modified": 1658486516373,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7dad618c-8a35-410e-ab93-86ea60ddf917
...
---
Response status code: 400 Bad Request. Responded in 50.527875ms.
```json
{
  "@context": "https://openactive.io/",
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 35.458444ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7207"
}
```
...
---
Response status code: 200 OK. Responded in 33.91412ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4473"
}
```
...
---
Response status code: 200 OK. Responded in 38.873396ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/535"
}
```
...
---
Response status code: 200 OK. Responded in 38.000683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5979"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F721%2Fevents%2F7207?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.728441ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7207",
    "startDate": "2022-07-24T02:00:11+00:00",
    "endDate": "2022-07-24T05:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4473?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.112931ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4473",
    "startDate": "2022-07-29T09:15:11+00:00",
    "endDate": "2022-07-29T10:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 1.89,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT17H59M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F54%2Ffacility-use-slots%2F535?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.558322ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/54",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/535#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 19.05,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 7,
    "startDate": "2022-07-22T20:11:11+00:00",
    "endDate": "2022-07-23T01:33:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F598%2Ffacility-use-slots%2F5979?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.042914ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5979#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 9.3,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT8H15M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-23T09:08:12+00:00",
    "endDate": "2022-07-23T13:45:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fcbd6ebb-314f-4a06-9e12-aea827f0e171
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/721/events/7207"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4473"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/535#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/535"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5979#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5979"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 396.457277ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fcbd6ebb-314f-4a06-9e12-aea827f0e171",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F721%2Fevents%2F7207?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 41.464336ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4473?useCacheIfAvailable=true&expectedCapacity=27


---
Response status code: 200 OK. Responded in 32.212994ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F54%2Ffacility-use-slots%2F535?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 347.451425ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/535",
  "modified": 1658486521221,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F598%2Ffacility-use-slots%2F5979?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 348.942248ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/598/facility-use-slots/5979",
  "modified": 1658486521223,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fcbd6ebb-314f-4a06-9e12-aea827f0e171
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alejandra68@hotmail.com",
    "telephone": "1-668-724-3641 x190",
    "givenName": "Bailey",
    "familyName": "Trevor",
    "identifier": "f96eed72-3c02-4ba7-b202-216953d2cd52"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 445.939335ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:01+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 60.115621ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 42.160246ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 41.230332ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 40.697524ms.
```json
{
  "data": {
    "@context": [
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fcbd6ebb-314f-4a06-9e12-aea827f0e171
...
---
Response status code: 400 Bad Request. Responded in 123.780663ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
