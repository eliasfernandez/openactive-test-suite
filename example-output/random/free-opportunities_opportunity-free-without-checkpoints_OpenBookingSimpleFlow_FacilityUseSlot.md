...
⚠️ 4 passed with 0 failures, 51 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 20.458039ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5796"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F580%2Ffacility-use-slots%2F5796?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.354352ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/580",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5796#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H52M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-28T09:15:12+00:00",
    "endDate": "2022-07-28T14:11:12+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cbbbf29f-ae56-45eb-b620-ad2536de1089
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Violet.Harber30@yahoo.com",
    "telephone": "955.523.3748 x21184",
    "givenName": "Thiel",
    "familyName": "Janessa",
    "identifier": "34e3f9d2-3583-4c27-abeb-227f5f0bacaf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5796#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5796"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 446.385153ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cbbbf29f-ae56-45eb-b620-ad2536de1089",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cbbbf29f-ae56-45eb-b620-ad2536de1089#/orderedItems/1971",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/580/facility-use-slots/5796#/offers/0",
        "allowCustomerCancellationFullRefund": false,
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/580"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-28T09:15:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F580%2Ffacility-use-slots%2F5796?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 29.396074ms.
```json
{
  "data": {
    "@context": [
