...
---
Response status code: 200 OK. Responded in 49.333649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4882"
}
```
...
---
Response status code: 200 OK. Responded in 48.86554ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/382/events/3818"
}
```
...
---
Response status code: 200 OK. Responded in 29.885174ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979"
}
```
...
---
Response status code: 200 OK. Responded in 30.205381ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4882?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.969407ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4882",
    "startDate": "2022-07-27T01:31:11+00:00",
    "endDate": "2022-07-27T07:13:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F382%2Fevents%2F3818?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.370696ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/382/events/3818",
    "startDate": "2022-07-29T02:01:11+00:00",
    "endDate": "2022-07-29T03:36:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/382",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/382#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F198%2Ffacility-use-slots%2F1979?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.820585ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 9.92,
    ...
    "remainingUses": 5,
    "startDate": "2022-07-24T12:42:11+00:00",
    "endDate": "2022-07-24T15:03:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F267%2Ffacility-use-slots%2F2666?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.942068ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/267",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2022-07-29T20:58:12+00:00",
    "endDate": "2022-07-30T00:23:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c9a43615-2181-47da-8362-be848ebe906a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4882"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/382#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/382/events/3818"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1294.164693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c9a43615-2181-47da-8362-be848ebe906a",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/382"
        },
        "maximumAttendeeCapacity": 18,
        "remainingAttendeeCapacity": 18
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/267"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-29T20:58:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4882?useCacheIfAvailable=true&expectedCapacity=44


---
Response status code: 200 OK. Responded in 459.189793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4882",
  "modified": 1658486907582,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F382%2Fevents%2F3818?useCacheIfAvailable=true&expectedCapacity=17


---
Response status code: 200 OK. Responded in 451.840659ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/382/events/3818",
  "modified": 1658486907584,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F198%2Ffacility-use-slots%2F1979?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1333.328621ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979",
  "modified": 1658486908471,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F267%2Ffacility-use-slots%2F2666?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 1337.6480099999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666",
  "modified": 1658486908472,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c9a43615-2181-47da-8362-be848ebe906a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Watson.Schaden@yahoo.com",
    "telephone": "(727) 390-5646 x943",
    "givenName": "Emmerich",
    "familyName": "Lionel",
    "identifier": "6f61a9c3-028f-41b4-a66c-137fa52fa661"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1612.570344ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 40.366014ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.19763ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.176509ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.968925ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a
...
---
Response status code: 201 Created. Responded in 822.928508ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2632",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2633",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2634",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/382#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2635",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2636",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/198/facility-use-slots/1979#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c9a43615-2181-47da-8362-be848ebe906a#/orderedItems/2637",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/267/facility-use-slots/2666#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 27.084979ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.049161ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.219447ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.607494ms.
```json
{
  "data": {
    "@context": [
