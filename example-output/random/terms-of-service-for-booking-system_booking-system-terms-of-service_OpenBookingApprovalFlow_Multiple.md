...
⚠️ 54 passed with 0 failures, 863 warnings and 232 suggestions 
...
---
Response status code: 200 OK. Responded in 32.046692ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12635"
}
```
...
---
Response status code: 200 OK. Responded in 31.560985ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10741"
}
```
...
---
Response status code: 200 OK. Responded in 27.112617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667"
}
```
...
---
Response status code: 200 OK. Responded in 29.030646ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1264%2Fevents%2F12635?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.715811ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12635",
    "startDate": "2022-07-24T05:02:11+00:00",
    "endDate": "2022-07-24T09:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1075%2Fevents%2F10741?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.048201ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10741",
    "startDate": "2022-07-25T19:49:11+00:00",
    "endDate": "2022-07-25T21:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1267%2Ffacility-use-slots%2F12667?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.437791ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-25T20:25:12+00:00",
    "endDate": "2022-07-26T00:59:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1125%2Ffacility-use-slots%2F11248?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.916283ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1125",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "endDate": "2022-07-27T22:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/17b45d96-5388-4f84-94d5-f1dd98bba246
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12635"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10741"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 284.728973ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/17b45d96-5388-4f84-94d5-f1dd98bba246",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:39+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1125"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-27T18:16:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1264%2Fevents%2F12635?useCacheIfAvailable=true&expectedCapacity=16


---
Response status code: 200 OK. Responded in 633.540532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1264/events/12635",
  "modified": 1658486502002,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1075%2Fevents%2F10741?useCacheIfAvailable=true&expectedCapacity=48


---
Response status code: 200 OK. Responded in 628.840159ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10741",
  "modified": 1658486502003,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1267%2Ffacility-use-slots%2F12667?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 242.881331ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667",
  "modified": 1658486501624,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1125%2Ffacility-use-slots%2F11248?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 243.47724ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248",
  "modified": 1658486501625,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/17b45d96-5388-4f84-94d5-f1dd98bba246
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Laurel_Prohaska@hotmail.com",
    "telephone": "243.972.2807",
    "givenName": "Bartoletti",
    "familyName": "Jett",
    "identifier": "1fb17bc6-5c71-4fef-be1b-4a37f23f9bb6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 429.971404ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:43+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 90.163184ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 73.006822ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 72.098708ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 71.5638ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/17b45d96-5388-4f84-94d5-f1dd98bba246
...
---
Response status code: 201 Created. Responded in 1135.3504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/17b45d96-5388-4f84-94d5-f1dd98bba246",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1526",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1264#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1527",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1264#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1528",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1075#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1529",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1530",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1267/facility-use-slots/12667#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246#/orderedItems/1531",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1125/facility-use-slots/11248#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/17b45d96-5388-4f84-94d5-f1dd98bba246/versions/6d541bfc-5dbf-4b2e-a22d-24b8025f7c9a",
  "payment": {
    "@type": "Payment",
    "identifier": "E7jhJldeu",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;17b45d96-5388-4f84-94d5-f1dd98bba246&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/17b45d96-5388-4f84-94d5-f1dd98bba246


---
Response status code: 200 OK. Responded in 4.58967ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '17b45d96-5388-4f84-94d5-f1dd98bba246' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 27.413819ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;17b45d96-5388-4f84-94d5-f1dd98bba246&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/17b45d96-5388-4f84-94d5-f1dd98bba246


---
Response status code: 200 OK. Responded in 2433.073358ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "17b45d96-5388-4f84-94d5-f1dd98bba246",
  "modified": 637940833075331200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/17b45d96-5388-4f84-94d5-f1dd98bba246",
    "identifier": "17b45d96-5388-4f84-94d5-f1dd98bba246",
...
---
Response status code: 200 OK. Responded in 17.907073ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246
...
---
Response status code: 201 Created. Responded in 554.588769ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/17b45d96-5388-4f84-94d5-f1dd98bba246",
  "identifier": "17b45d96-5388-4f84-94d5-f1dd98bba246",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 4.308266ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "17b45d96-5388-4f84-94d5-f1dd98bba246",
  "modified": 637940833101568400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 21.743733ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.85702ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.365112ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.822904ms.
```json
{
  "data": {
    "@context": [
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
