...
⚠️ 90 passed with 0 failures, 1250 warnings and 330 suggestions 
...
---
Response status code: 200 OK. Responded in 37.114237ms.
```json
{
...
---
Response status code: 200 OK. Responded in 68.132817ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 67.968416ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 66.515803ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1130.679154ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2035/events/20035",
  "modified": 1658486006088,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2035/events/20035",
    "startDate": "2022-07-23T10:33:23+00:00",
    "endDate": "2022-07-23T11:33:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1129.573944ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2036/events/20036",
  "modified": 1658486006089,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 527.281482ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2036/facility-use-slots/20036",
  "modified": 1658486005488,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 522.777741ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2035/facility-use-slots/20035",
  "modified": 1658486005484,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d5eaf26d-e9fd-476a-b533-1dfad2a129f6
...
---
Response status code: 200 OK. Responded in 353.078902ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2035%2Fevents%2F20035?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 373.380657ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2035/events/20035",
  "modified": 1658486007773,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2036%2Fevents%2F20036?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 373.267556ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2036/events/20036",
  "modified": 1658486007774,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2036%2Ffacility-use-slots%2F20036?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 196.810938ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2036/facility-use-slots/20036",
  "modified": 1658486007598,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2035%2Ffacility-use-slots%2F20035?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 199.817663ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2035/facility-use-slots/20035",
  "modified": 1658486007602,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 114.136182ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 111.57326ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 111.365258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 152.900916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1291.19561ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2042/events/20042",
  "modified": 1658486009673,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2042/events/20042",
    "startDate": "2022-07-23T10:33:27+00:00",
    "endDate": "2022-07-23T11:33:27+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1287.84228ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2041/events/20041",
  "modified": 1658486009672,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1104.736006ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2041/facility-use-slots/20041",
  "modified": 1658486009490,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1105.803615ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2042/facility-use-slots/20042",
  "modified": 1658486009491,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 169.349457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2042%2Fevents%2F20042?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 460.042958ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2042/events/20042",
  "modified": 1658486011362,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2041%2Fevents%2F20041?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 460.109559ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2041/events/20041",
  "modified": 1658486011363,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2041%2Ffacility-use-slots%2F20041?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 278.516796ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2041/facility-use-slots/20041",
  "modified": 1658486011180,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2042%2Ffacility-use-slots%2F20042?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 278.214693ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2042/facility-use-slots/20042",
  "modified": 1658486011181,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d5eaf26d-e9fd-476a-b533-1dfad2a129f6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Enos.Champlin@gmail.com",
    "telephone": "758.280.0058",
    "givenName": "Simonis",
    "familyName": "Alfredo",
    "identifier": "8708ef90-6288-4ec4-bd82-4387a016651f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 101.479073ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 40.256646ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 39.690741ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 47.072105ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 46.921103ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d5eaf26d-e9fd-476a-b533-1dfad2a129f6
...
---
Response status code: 201 Created. Responded in 74.32634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/245",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2042#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/246",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2042#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/247",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2041#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/248",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2041/facility-use-slots/20041#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/249",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2041/facility-use-slots/20041#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6#/orderedItems/250",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2042/facility-use-slots/20042#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d5eaf26d-e9fd-476a-b533-1dfad2a129f6/versions/efe17feb-50f2-475a-b797-5106ff719ebb",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;d5eaf26d-e9fd-476a-b533-1dfad2a129f6&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d5eaf26d-e9fd-476a-b533-1dfad2a129f6


---
Response status code: 200 OK. Responded in 10.587091ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'd5eaf26d-e9fd-476a-b533-1dfad2a129f6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.669009ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C1 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;d5eaf26d-e9fd-476a-b533-1dfad2a129f6&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d5eaf26d-e9fd-476a-b533-1dfad2a129f6


---
Response status code: 200 OK. Responded in 2074.330448ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "modified": 637940828117903100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
    "identifier": "d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
...
---
Response status code: 200 OK. Responded in 3.131627ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828117903146&afterId=d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "message": "Listening for UUID: 'd5eaf26d-e9fd-476a-b533-1dfad2a129f6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6
...
---
Response status code: 201 Created. Responded in 262.256556ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "identifier": "d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 9.595287ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "d5eaf26d-e9fd-476a-b533-1dfad2a129f6",
  "modified": 637940828139891300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 48.757042ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 48.293038ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 50.254956ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 49.906552ms.
```json
{
  "data": {
    "@context": [
