...
---
Response status code: 200 OK. Responded in 38.189275ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10769"
}
```
...
---
Response status code: 200 OK. Responded in 21.360521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15332"
}
```
...
---
Response status code: 200 OK. Responded in 20.554309ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434"
}
```
...
---
Response status code: 200 OK. Responded in 20.415107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1077%2Fevents%2F10769?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 44.962776ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10769",
    "startDate": "2022-07-31T03:55:11+00:00",
    "endDate": "2022-07-31T08:30:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15332?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.742788ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15332",
    "startDate": "2022-07-24T00:47:11+00:00",
    "endDate": "2022-07-24T05:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14434?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.17598ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T11:56:12+00:00",
    "endDate": "2022-07-28T17:52:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1000%2Ffacility-use-slots%2F9991?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 44.622571ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1000",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 6,
    "startDate": "2022-07-27T04:36:12+00:00",
    "endDate": "2022-07-27T07:28:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f8417103-d195-4e84-9657-8d85ccebf320
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10769"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15332"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 430.521231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f8417103-d195-4e84-9657-8d85ccebf320",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1077%2Fevents%2F10769?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 243.510051ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10769",
  "modified": 1658486452932,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1534%2Fevents%2F15332?useCacheIfAvailable=true&expectedCapacity=42


---
Response status code: 200 OK. Responded in 244.254462ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1534/events/15332",
  "modified": 1658486452934,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14434?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 122.293883ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434",
  "modified": 1658486452818,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1000%2Ffacility-use-slots%2F9991?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 122.806791ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991",
  "modified": 1658486452820,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f8417103-d195-4e84-9657-8d85ccebf320
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Caitlyn_Spinka@hotmail.com",
    "telephone": "480.275.9977",
    "givenName": "Hagenes",
    "familyName": "Adriel",
    "identifier": "d4a77abc-ba69-4a42-a503-f8ed94c623e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 369.890797ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:52+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 132.128035ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 118.856331ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 117.856315ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 117.300807ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f8417103-d195-4e84-9657-8d85ccebf320
...
---
Response status code: 201 Created. Responded in 623.449402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f8417103-d195-4e84-9657-8d85ccebf320",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1363",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1077#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1364",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1077#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1365",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1534#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1366",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1367",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14434#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320#/orderedItems/1368",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1000/facility-use-slots/9991#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f8417103-d195-4e84-9657-8d85ccebf320/versions/2ca1e9d4-0f91-4acb-a285-1544da14f421",
  "payment": {
    "@type": "Payment",
    "identifier": "J_eF7Qpa-",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;f8417103-d195-4e84-9657-8d85ccebf320&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f8417103-d195-4e84-9657-8d85ccebf320


---
Response status code: 200 OK. Responded in 11.03067ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832478751354&afterId=6f4d2466-1498-41e1-a96e-db9a73bb3bc6",
  "message": "Listening for UUID: 'f8417103-d195-4e84-9657-8d85ccebf320' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 19.840905ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;f8417103-d195-4e84-9657-8d85ccebf320&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f8417103-d195-4e84-9657-8d85ccebf320


---
Response status code: 200 OK. Responded in 2044.831092ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f8417103-d195-4e84-9657-8d85ccebf320",
  "modified": 637940832556681300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f8417103-d195-4e84-9657-8d85ccebf320",
    "identifier": "f8417103-d195-4e84-9657-8d85ccebf320",
...
---
Response status code: 200 OK. Responded in 13.872214ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832556681315&afterId=f8417103-d195-4e84-9657-8d85ccebf320",
  "message": "Listening for UUID: 'f8417103-d195-4e84-9657-8d85ccebf320' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320
...
---
Response status code: 201 Created. Responded in 309.629468ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320",
  "identifier": "f8417103-d195-4e84-9657-8d85ccebf320",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 34.67463ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f8417103-d195-4e84-9657-8d85ccebf320",
  "modified": 637940832579172100
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 44.458279ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.614967ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 44.47618ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.929672ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f8417103-d195-4e84-9657-8d85ccebf320
...
---
Response status code: 400 Bad Request. Responded in 66.69992ms.
```json
{
  "@context": "https://openactive.io/",
