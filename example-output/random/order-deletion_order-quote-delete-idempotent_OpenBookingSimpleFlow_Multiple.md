...
⚠️ 44 passed with 0 failures, 542 warnings and 144 suggestions 
...
---
Response status code: 200 OK. Responded in 94.91738ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4905"
}
```
...
---
Response status code: 200 OK. Responded in 81.566815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5039"
}
```
...
---
Response status code: 200 OK. Responded in 80.329791ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/462/facility-use-slots/4616"
}
```
...
---
Response status code: 200 OK. Responded in 82.001123ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/709"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F491%2Fevents%2F4905?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 60.532899ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4905",
    "startDate": "2022-07-26T22:14:11+00:00",
    "endDate": "2022-07-27T01:46:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F504%2Fevents%2F5039?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 59.662481ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5039",
    "startDate": "2022-07-25T15:29:11+00:00",
    "endDate": "2022-07-25T19:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F462%2Ffacility-use-slots%2F4616?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 58.945268ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/462",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/462/facility-use-slots/4616#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT21H52M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-26T05:09:12+00:00",
    "endDate": "2022-07-26T07:43:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F71%2Ffacility-use-slots%2F709?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 58.457458ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/709#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 8,
    "startDate": "2022-07-24T05:50:11+00:00",
    "endDate": "2022-07-24T08:03:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ef23af44-050d-4273-8da4-622c114bef8a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4905"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5039"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/462/facility-use-slots/4616#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/462/facility-use-slots/4616"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/709#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/709"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 898.784098ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ef23af44-050d-4273-8da4-622c114bef8a",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/462"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-26T05:09:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F491%2Fevents%2F4905?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 232.462625ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/491/events/4905",
  "modified": 1658486729846,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F504%2Fevents%2F5039?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 237.980869ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5039",
  "modified": 1658486729850,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F462%2Ffacility-use-slots%2F4616?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 733.065103ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/462/facility-use-slots/4616",
  "modified": 1658486730350,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F71%2Ffacility-use-slots%2F709?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 733.864923ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/71/facility-use-slots/709",
  "modified": 1658486730353,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ef23af44-050d-4273-8da4-622c114bef8a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amaya_OKon@hotmail.com",
    "telephone": "(440) 250-4393 x6993",
    "givenName": "Pfannerstill",
    "familyName": "Giovanna",
    "identifier": "b059a243-c413-4eec-a432-df8d16bf7058"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 424.431504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 70.250088ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.278263ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.021557ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 68.565945ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/ef23af44-050d-4273-8da4-622c114bef8a
...
---
Response status code: 204 No Content. Responded in 1117.158036ms.
...
---
Response status code: 204 No Content. Responded in 55.718318ms.
### Specs
