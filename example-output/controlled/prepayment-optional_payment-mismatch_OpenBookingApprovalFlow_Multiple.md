[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:05 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 53.313282ms.
```json
{
...
---
Response status code: 200 OK. Responded in 52.557875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1255.672743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2508/events/20508",
  "modified": 1658486851577,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2508/events/20508",
    "startDate": "2022-07-23T10:47:29+00:00",
    "endDate": "2022-07-23T11:47:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 772.726281ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2496/facility-use-slots/20496",
  "modified": 1658486851094,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7a9b02a9-41a6-4bc1-aad1-0996642a0e98
...
---
Response status code: 200 OK. Responded in 305.51376ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7a9b02a9-41a6-4bc1-aad1-0996642a0e98",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:30+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2508%2Fevents%2F20508?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 718.125188ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2508/events/20508",
  "modified": 1658486852888,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2496%2Ffacility-use-slots%2F20496?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 372.268963ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2496/facility-use-slots/20496",
  "modified": 1658486852558,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7a9b02a9-41a6-4bc1-aad1-0996642a0e98
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Audra_Willms@yahoo.com",
    "telephone": "(587) 469-4061 x9274",
    "givenName": "Dietrich",
    "familyName": "Kaleigh",
    "identifier": "ff0478a2-bf98-4844-957b-892a1a81deaa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 579.602736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.787116ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.21161ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7a9b02a9-41a6-4bc1-aad1-0996642a0e98
...
---
Response status code: 400 Bad Request. Responded in 951.584096ms.
```json
{
  "@context": "https://openactive.io/",
