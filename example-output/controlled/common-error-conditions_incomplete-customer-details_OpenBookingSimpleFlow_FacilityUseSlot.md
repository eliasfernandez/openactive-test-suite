...
---
Response status code: 200 OK. Responded in 11.805606ms.
```json
{
...
---
Response status code: 200 OK. Responded in 472.474153ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2123/facility-use-slots/20123",
  "modified": 1658486138149,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d701513f-2f08-4517-8655-6d77d59134f5
...
---
Response status code: 200 OK. Responded in 62.850065ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d701513f-2f08-4517-8655-6d77d59134f5",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2123%2Ffacility-use-slots%2F20123?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 647.791831ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2123/facility-use-slots/20123",
  "modified": 1658486139026,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d701513f-2f08-4517-8655-6d77d59134f5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "telephone": "591.846.3984 x70692",
    "givenName": "Gulgowski",
    "familyName": "Anastasia",
    "identifier": "5a337a94-642a-4641-b65d-1784361eeb39"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 11.368903ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 22.487802ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 858.507302ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2124/facility-use-slots/20124",
  "modified": 1658486139995,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:35:38+00:00",
    "endDate": "2022-07-23T11:35:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ee2db389-ce4b-40e6-9854-e9e7213d070b
...
---
Response status code: 200 OK. Responded in 157.577215ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ee2db389-ce4b-40e6-9854-e9e7213d070b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:39+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2124%2Ffacility-use-slots%2F20124?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 829.781668ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2124/facility-use-slots/20124",
  "modified": 1658486141140,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ee2db389-ce4b-40e6-9854-e9e7213d070b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elwyn64@gmail.com",
    "telephone": "(805) 660-6792 x1038",
    "givenName": "Langworth",
    "familyName": "Wendell",
    "identifier": "18268983-fa0b-477d-afa0-b788210b7ebc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 134.831054ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.236394ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ee2db389-ce4b-40e6-9854-e9e7213d070b
...
---
Response status code: 400 Bad Request. Responded in 34.483144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
