[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:48:28 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 174 warnings and 46 suggestions 
...
---
Response status code: 200 OK. Responded in 14.455756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/329/events/3285"
}
```
...
---
Response status code: 200 OK. Responded in 14.931864ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/211/facility-use-slots/2101"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F329%2Fevents%2F3285?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.791855ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/329/events/3285",
    "startDate": "2022-07-26T10:37:11+00:00",
    "endDate": "2022-07-26T16:27:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/329",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/329#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F211%2Ffacility-use-slots%2F2101?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.411913ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/211",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/211/facility-use-slots/2101#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-28T14:40:11+00:00",
    "endDate": "2022-07-28T19:28:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3c79ce4c-735f-469a-91d3-c490dfe37e69
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/329#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/329/events/3285"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/211/facility-use-slots/2101#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/211/facility-use-slots/2101"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 727.728076ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3c79ce4c-735f-469a-91d3-c490dfe37e69",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:39+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/329"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/211"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-28T14:40:11+00:00",
...
## Missing payment property at B >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F329%2Fevents%2F3285?useCacheIfAvailable=true&expectedCapacity=48


---
Response status code: 200 OK. Responded in 818.667304ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/329/events/3285",
  "modified": 1658486921781,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F211%2Ffacility-use-slots%2F2101?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 488.791777ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/211/facility-use-slots/2101",
  "modified": 1658486921473,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Missing payment property at B >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Missing payment property at B >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3c79ce4c-735f-469a-91d3-c490dfe37e69
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cecilia.Aufderhar91@yahoo.com",
    "telephone": "(672) 243-1209 x633",
    "givenName": "Kulas",
    "familyName": "Brandi",
    "identifier": "a6c531c2-1cae-44f3-98a8-3281e6b479f1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 791.117286ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
## Missing payment property at B >> Assert Opportunity Capacity (after C2)
...
---
Response status code: 200 OK. Responded in 15.137606ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.303289ms.
```json
{
  "data": {
    "@context": [
...
## Missing payment property at B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Missing payment property at B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3c79ce4c-735f-469a-91d3-c490dfe37e69
...
---
Response status code: 400 Bad Request. Responded in 351.770198ms.
```json
{
  "@context": "https://openactive.io/",
