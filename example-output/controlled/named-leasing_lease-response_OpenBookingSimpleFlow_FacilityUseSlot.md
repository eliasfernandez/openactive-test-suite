...
---
Response status code: 200 OK. Responded in 129.676719ms.
```json
{
...
---
Response status code: 200 OK. Responded in 787.196202ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2382/facility-use-slots/20382",
  "modified": 1658486586442,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:43:04+00:00",
    "endDate": "2022-07-23T11:43:04+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79b030af-12d2-4257-ae95-16fa09fe82ce
...
---
Response status code: 200 OK. Responded in 148.666997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79b030af-12d2-4257-ae95-16fa09fe82ce",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2382%2Ffacility-use-slots%2F20382?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1109.813435ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2382/facility-use-slots/20382",
  "modified": 1658486587893,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79b030af-12d2-4257-ae95-16fa09fe82ce
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alena.Wolf@yahoo.com",
    "telephone": "258-307-0080 x286",
    "givenName": "Cruickshank",
    "familyName": "Lisandro",
    "identifier": "58916599-68cd-43e9-b262-e7dbb61716f1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 166.012761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 5.068048ms.
```json
{
  "data": {
    "@context": [
