...
---
Response status code: 200 OK. Responded in 20.422248ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F249%2Ffacility-use-slots%2F2484?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.457378ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/249",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-25T18:20:12+00:00",
    "endDate": "2022-07-25T19:49:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/70e2f44f-cf00-4b87-bc50-95f606e25566
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 432.97218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/70e2f44f-cf00-4b87-bc50-95f606e25566",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:42+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/249"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-25T18:20:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F249%2Ffacility-use-slots%2F2484?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 1603.925369ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484",
  "modified": 1658487165604,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/70e2f44f-cf00-4b87-bc50-95f606e25566
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Keira.Macejkovic62@gmail.com",
    "telephone": "557-930-6485 x5363",
    "givenName": "Kshlerin",
    "familyName": "Lila",
    "identifier": "41db57de-03c9-4e58-882a-2babe8c56b07"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 599.827642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:44+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 16.012757ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/70e2f44f-cf00-4b87-bc50-95f606e25566
...
---
Response status code: 201 Created. Responded in 416.8394ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/70e2f44f-cf00-4b87-bc50-95f606e25566",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/70e2f44f-cf00-4b87-bc50-95f606e25566#/orderedItems/3184",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/249/facility-use-slots/2484#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 10.53577ms.
```json
{
  "data": {
    "@context": [
