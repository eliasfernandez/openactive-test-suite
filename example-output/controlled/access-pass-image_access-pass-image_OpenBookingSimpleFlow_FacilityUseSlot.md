...
---
Response status code: 200 OK. Responded in 35.638004ms.
```json
{
...
---
Response status code: 200 OK. Responded in 629.899887ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2332/facility-use-slots/20332",
  "modified": 1658486460111,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1dfff3b1-c485-423c-a295-4ccb83c8644a
...
---
Response status code: 200 OK. Responded in 173.317182ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1dfff3b1-c485-423c-a295-4ccb83c8644a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2332%2Ffacility-use-slots%2F20332?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 696.305355ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2332/facility-use-slots/20332",
  "modified": 1658486461198,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1dfff3b1-c485-423c-a295-4ccb83c8644a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mario_Flatley49@hotmail.com",
    "telephone": "(761) 275-7877",
    "givenName": "Halvorson",
    "familyName": "Marlee",
    "identifier": "b20616c5-fea1-406c-a13d-a8dd8423c31c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 140.693603ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 20.939279ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1dfff3b1-c485-423c-a295-4ccb83c8644a
...
---
Response status code: 201 Created. Responded in 237.36453ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1dfff3b1-c485-423c-a295-4ccb83c8644a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1dfff3b1-c485-423c-a295-4ccb83c8644a#/orderedItems/1614",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2332/facility-use-slots/20332#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 17.48085ms.
```json
{
  "data": {
    "@context": [
