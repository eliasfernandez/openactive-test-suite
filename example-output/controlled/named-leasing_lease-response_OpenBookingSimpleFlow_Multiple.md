[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:43:01 GMT+0000 (Coordinated Universal Time)
...
⚠️ 41 passed with 0 failures, 521 warnings and 138 suggestions 
...
---
Response status code: 200 OK. Responded in 105.983496ms.
```json
{
...
---
Response status code: 200 OK. Responded in 211.510889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 118.232611ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 133.411855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 803.158852ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2395/events/20395",
  "modified": 1658486589291,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2395/events/20395",
    "startDate": "2022-07-23T10:43:07+00:00",
    "endDate": "2022-07-23T11:43:07+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 797.217296ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2396/events/20396",
  "modified": 1658486589292,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 636.729487ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2383/facility-use-slots/20383",
  "modified": 1658486589132,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 636.185782ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2384/facility-use-slots/20384",
  "modified": 1658486589133,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/83216fa5-16e3-4e2b-8fa8-3fcd1617c067
...
---
Response status code: 200 OK. Responded in 508.653836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/83216fa5-16e3-4e2b-8fa8-3fcd1617c067",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:08+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2395%2Fevents%2F20395?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 435.842701ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2395/events/20395",
  "modified": 1658486591575,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2396%2Fevents%2F20396?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 426.623221ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2396/events/20396",
  "modified": 1658486591576,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2383%2Ffacility-use-slots%2F20383?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 1108.728789ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2383/facility-use-slots/20383",
  "modified": 1658486592259,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2384%2Ffacility-use-slots%2F20384?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1108.223285ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2384/facility-use-slots/20384",
  "modified": 1658486592260,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/83216fa5-16e3-4e2b-8fa8-3fcd1617c067
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Donna_Mills82@hotmail.com",
    "telephone": "(392) 704-2798 x55907",
    "givenName": "Gottlieb",
    "familyName": "Tevin",
    "identifier": "3a06e360-b418-4df0-a65a-e6420995487c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 831.314032ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 39.319851ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.740639ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.71263ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.064524ms.
```json
{
  "data": {
    "@context": [
