...
⚠️ 16 passed with 0 failures, 171 warnings and 58 suggestions 
...
---
Response status code: 200 OK. Responded in 57.870606ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5036"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F504%2Fevents%2F5036?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.308345ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5036",
    "startDate": "2022-07-28T08:56:11+00:00",
    "endDate": "2022-07-28T14:45:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e31932c4-1e54-4d95-bdd7-9b4345fe25bb
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5036"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 218.990706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e31932c4-1e54-4d95-bdd7-9b4345fe25bb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F504%2Fevents%2F5036?useCacheIfAvailable=true&expectedCapacity=44


---
Response status code: 200 OK. Responded in 306.038819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/504/events/5036",
  "modified": 1658487119349,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e31932c4-1e54-4d95-bdd7-9b4345fe25bb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Golden38@gmail.com",
    "telephone": "683.687.8437",
    "givenName": "Reynolds",
    "familyName": "Rachelle",
    "identifier": "37b079a3-9122-4c6c-aca8-716e2711e2fc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 321.150082ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:56:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 17.178498ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e31932c4-1e54-4d95-bdd7-9b4345fe25bb
...
---
Response status code: 201 Created. Responded in 613.584165ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e31932c4-1e54-4d95-bdd7-9b4345fe25bb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e31932c4-1e54-4d95-bdd7-9b4345fe25bb#/orderedItems/3108",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/504#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 13.579618ms.
```json
{
  "data": {
    "@context": [
