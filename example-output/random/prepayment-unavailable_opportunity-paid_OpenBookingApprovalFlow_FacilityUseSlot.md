...
---
Response status code: 200 OK. Responded in 6.283601ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1524%2Ffacility-use-slots%2F15238?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.291169ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1524",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-08-01T04:35:12+00:00",
    "endDate": "2022-08-01T08:26:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1036.079748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:06+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1524%2Ffacility-use-slots%2F15238?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 658.497781ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238",
  "modified": 1658487128148,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kiara.Pacocha71@hotmail.com",
    "telephone": "857-653-5717 x54028",
    "givenName": "Huels",
    "familyName": "Noemy",
    "identifier": "da6e8d48-0262-4d28-bddc-eaf01f8f1a59"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 550.486645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:57:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.639419ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea
...
---
Response status code: 201 Created. Responded in 503.878596ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea#/orderedItems/3115",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1524/facility-use-slots/15238#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea/versions/35afc6ad-f5d8-4aa0-b1ce-28674974a8a9",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea


---
Response status code: 200 OK. Responded in 20.379427ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839252717973&afterId=6c7122ea-5720-4211-bc5d-24d0a5d4cd4c",
  "message": "Listening for UUID: '9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 296.121759ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea


---
Response status code: 200 OK. Responded in 1928.0315759999999ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "modified": 637940839287051600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
    "identifier": "9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
...
---
Response status code: 200 OK. Responded in 64.777424ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839287051608&afterId=9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "message": "Listening for UUID: '9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea
...
---
Response status code: 201 Created. Responded in 550.728514ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "identifier": "9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 860.449825ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9d9fe3e0-cd62-4ddb-a5ee-14585fcb04ea",
  "modified": 637940839314038800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 6.723013ms.
```json
{
  "data": {
    "@context": [
