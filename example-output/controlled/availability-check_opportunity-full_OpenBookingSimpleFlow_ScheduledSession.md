...
⚠️ 10 passed with 0 failures, 101 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 26.216379ms.
```json
{
...
---
Response status code: 200 OK. Responded in 363.675389ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2079/events/20079",
  "modified": 1658486088543,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9cc46ae7-3541-42e2-a47a-64531d947d9f
...
---
Response status code: 409 Conflict. Responded in 79.098341ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9cc46ae7-3541-42e2-a47a-64531d947d9f",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9cc46ae7-3541-42e2-a47a-64531d947d9f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Zane.Kris@gmail.com",
    "telephone": "672.530.7665 x85970",
    "givenName": "Ondricka",
    "familyName": "Hallie",
    "identifier": "35ca7131-f2dd-492f-b10f-768c7321593b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 27.562788ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
