[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:08 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 10.224619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1103/events/11029"
}
```
...
---
Response status code: 200 OK. Responded in 7.632463ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1023/facility-use-slots/10227"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1103%2Fevents%2F11029?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.981171ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1103/events/11029",
    "startDate": "2022-07-31T02:39:11+00:00",
    "endDate": "2022-07-31T03:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1103",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1103#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1023%2Ffacility-use-slots%2F10227?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.364958ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1023",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1023/facility-use-slots/10227#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 7,
    "startDate": "2022-07-31T00:41:12+00:00",
    "endDate": "2022-07-31T04:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7892b345-1a4c-4f4f-a133-5346f68ef07b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1103#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1103/events/11029"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1023/facility-use-slots/10227#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1023/facility-use-slots/10227"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 271.058464ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7892b345-1a4c-4f4f-a133-5346f68ef07b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:31+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1103"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1103%2Fevents%2F11029?useCacheIfAvailable=true&expectedCapacity=29


---
Response status code: 200 OK. Responded in 578.234162ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1103/events/11029",
  "modified": 1658486852996,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1023%2Ffacility-use-slots%2F10227?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 556.524802ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1023/facility-use-slots/10227",
  "modified": 1658486852976,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7892b345-1a4c-4f4f-a133-5346f68ef07b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ike.Kiehn@gmail.com",
    "telephone": "381-480-8215 x59847",
    "givenName": "Tremblay",
    "familyName": "Blair",
    "identifier": "ac9b0dee-f692-4c41-b160-8e639cf2349e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 304.934667ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:32+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 15.954938ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.467107ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7892b345-1a4c-4f4f-a133-5346f68ef07b
...
---
Response status code: 400 Bad Request. Responded in 590.076613ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (2.33) does not match expected value (1.33)"
}
```
### Specs
