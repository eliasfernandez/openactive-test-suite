...
---
Response status code: 200 OK. Responded in 15.965133ms.
```json
{
...
---
Response status code: 200 OK. Responded in 460.249632ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305",
  "modified": 1658486381452,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305",
    "startDate": "2022-07-23T10:39:39+00:00",
    "endDate": "2022-07-23T11:39:39+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/700c72b4-453e-4a7b-9426-1634160afb55
...
---
Response status code: 200 OK. Responded in 133.32711ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/700c72b4-453e-4a7b-9426-1634160afb55",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2305%2Fevents%2F20305?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 722.360315ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305",
  "modified": 1658486382518,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/700c72b4-453e-4a7b-9426-1634160afb55
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Delia.Bosco@yahoo.com",
    "telephone": "1-807-234-0052 x21966",
    "givenName": "Walter",
    "familyName": "Humberto",
    "identifier": "dafd4c7e-bafe-443b-be05-013769fa7616"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 243.432027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:41+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.110009ms.
```json
{
  "data": {
    "@context": [
