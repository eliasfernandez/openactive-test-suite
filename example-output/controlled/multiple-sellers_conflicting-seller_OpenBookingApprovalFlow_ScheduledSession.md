...
---
Response status code: 200 OK. Responded in 25.18301ms.
```json
{
...
---
Response status code: 200 OK. Responded in 51.758732ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 916.048496ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2257/events/20257",
  "modified": 1658486312001,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 915.581993ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2258/events/20258",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/28c66084-50e2-4625-a556-20ab679ba3d8
...
---
Response status code: 500 Internal Server Error. Responded in 61.987497ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/28c66084-50e2-4625-a556-20ab679ba3d8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Norma_Sawayn@hotmail.com",
    "telephone": "221.280.3173 x04903",
    "givenName": "Halvorson",
    "familyName": "Ferne",
    "identifier": "fbd09f6c-b94a-46cd-a505-c9f9ca54076c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 46.446673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/28c66084-50e2-4625-a556-20ab679ba3d8
...
---
Response status code: 500 Internal Server Error. Responded in 43.019245ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
