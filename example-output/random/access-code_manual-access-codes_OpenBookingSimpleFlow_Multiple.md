...
---
Response status code: 200 OK. Responded in 22.765256ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1566"
}
```
...
---
Response status code: 200 OK. Responded in 30.435676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3050"
}
```
...
---
Response status code: 200 OK. Responded in 29.37366ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690"
}
```
...
---
Response status code: 200 OK. Responded in 28.432445ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1566?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.092271ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1566",
    "startDate": "2022-07-22T17:21:11+00:00",
    "endDate": "2022-07-22T21:46:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3050?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.646564ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3050",
    "startDate": "2022-07-27T19:34:11+00:00",
    "endDate": "2022-07-27T23:38:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F469%2Ffacility-use-slots%2F4690?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.207257ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT17H55M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-31T18:53:12+00:00",
    "endDate": "2022-07-31T19:38:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F287%2Ffacility-use-slots%2F2870?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.784751ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-26T15:04:12+00:00",
    "endDate": "2022-07-26T19:53:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/78658b3c-fde1-4565-b871-91d1ac5346f1
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1566"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3050"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 402.788306ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/78658b3c-fde1-4565-b871-91d1ac5346f1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1566?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 314.94413ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1566",
  "modified": 1658486415860,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3050?useCacheIfAvailable=true&expectedCapacity=32


---
Response status code: 200 OK. Responded in 314.214518ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3050",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F469%2Ffacility-use-slots%2F4690?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 209.775684ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690",
  "modified": 1658486415767,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F287%2Ffacility-use-slots%2F2870?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 210.359493ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870",
  "modified": 1658486415770,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/78658b3c-fde1-4565-b871-91d1ac5346f1
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "370.614.8291",
    "givenName": "Moore",
    "familyName": "Bailey",
    "identifier": "472a9488-62f1-47e3-a075-4ea108d726b3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 312.910198ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 30.02397ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.192169ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.454558ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.94405ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1
...
---
Response status code: 201 Created. Responded in 548.559087ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1232",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1233",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/157#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1234",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1235",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1236",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4690#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/78658b3c-fde1-4565-b871-91d1ac5346f1#/orderedItems/1237",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2870#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 9.88935ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.002336ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.475728ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.156723ms.
```json
{
  "data": {
    "@context": [
