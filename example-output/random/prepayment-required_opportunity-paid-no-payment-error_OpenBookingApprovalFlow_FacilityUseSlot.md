...
⚠️ 13 passed with 0 failures, 85 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 16.879136ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1387/facility-use-slots/13868"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1387%2Ffacility-use-slots%2F13868?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.57083ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1387",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1387/facility-use-slots/13868#/offers/0",
        ...
        "price": 5.12,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT6H31M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-23T16:45:12+00:00",
    "endDate": "2022-07-23T21:34:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c5b70079-6b01-4959-8ebc-7665fb364073
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1387/facility-use-slots/13868#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1387/facility-use-slots/13868"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1216.963771ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c5b70079-6b01-4959-8ebc-7665fb364073",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:49+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1387"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-23T16:45:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1387%2Ffacility-use-slots%2F13868?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 754.785453ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1387/facility-use-slots/13868",
  "modified": 1658486931887,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c5b70079-6b01-4959-8ebc-7665fb364073
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ellis.Wilkinson@gmail.com",
    "telephone": "535-486-9997",
    "givenName": "Jakubowski",
    "familyName": "Rosario",
    "identifier": "1727b9f6-d2a4-4f11-a68b-93e9d1dc098f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 309.868143ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.988571ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c5b70079-6b01-4959-8ebc-7665fb364073
...
---
Response status code: 400 Bad Request. Responded in 411.833558ms.
```json
{
  "@context": "https://openactive.io/",
