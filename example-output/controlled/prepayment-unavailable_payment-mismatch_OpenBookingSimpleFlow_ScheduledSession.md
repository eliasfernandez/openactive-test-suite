[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:52 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 153.433388ms.
```json
{
...
---
Response status code: 200 OK. Responded in 390.977437ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521",
  "modified": 1658486875363,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521",
    "startDate": "2022-07-23T10:47:53+00:00",
    "endDate": "2022-07-23T11:47:53+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5906a4b1-75b0-4fa6-bf3f-e58283e8951b
...
---
Response status code: 200 OK. Responded in 1492.459899ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5906a4b1-75b0-4fa6-bf3f-e58283e8951b",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2521%2Fevents%2F20521?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 315.276851ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521",
  "modified": 1658486877772,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5906a4b1-75b0-4fa6-bf3f-e58283e8951b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Danial89@gmail.com",
    "telephone": "664-935-2687",
    "givenName": "Smitham",
    "familyName": "Hulda",
    "identifier": "798152a4-ccc6-44e8-8932-509f847be8bb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 277.757112ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 28.397457ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5906a4b1-75b0-4fa6-bf3f-e58283e8951b
...
---
Response status code: 400 Bad Request. Responded in 136.897638ms.
```json
{
  "@context": "https://openactive.io/",
