...
⚠️ 29 passed with 0 failures, 206 warnings and 24 suggestions 
...
---
Response status code: 200 OK. Responded in 14.162629ms.
```json
{
...
---
Response status code: 200 OK. Responded in 544.442853ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2022/facility-use-slots/20022",
  "modified": 1658485996163,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:33:14+00:00",
    "endDate": "2022-07-23T11:33:14+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4197ef84-c73d-4093-bdc8-132a23fd554b
...
---
Response status code: 200 OK. Responded in 31.309385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4197ef84-c73d-4093-bdc8-132a23fd554b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:15+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2022%2Ffacility-use-slots%2F20022?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 967.401001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2022/facility-use-slots/20022",
  "modified": 1658485997248,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4197ef84-c73d-4093-bdc8-132a23fd554b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Breanne_Ondricka79@hotmail.com",
    "telephone": "756.384.8415",
    "givenName": "Waters",
    "familyName": "Flossie",
    "identifier": "c2f65af5-e3ae-4290-9beb-57fe00705126"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 190.748136ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.201011ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.029919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 401.549653ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2026/facility-use-slots/20026",
  "modified": 1658485998159,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:33:16+00:00",
    "endDate": "2022-07-23T11:33:16+00:00"
  }
}
```
### Specs
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaleel51@hotmail.com",
    "telephone": "856-963-4449 x824",
    "givenName": "Huel",
    "familyName": "Jean",
    "identifier": "5e846975-7b63-4455-8ad7-2a01bf2edb20"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 72.53756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:17+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2026%2Ffacility-use-slots%2F20026?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 564.197433ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2026/facility-use-slots/20026",
  "modified": 1658485998973,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4197ef84-c73d-4093-bdc8-132a23fd554b
...
---
Response status code: 201 Created. Responded in 51.835671ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4197ef84-c73d-4093-bdc8-132a23fd554b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4197ef84-c73d-4093-bdc8-132a23fd554b#/orderedItems/159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2026/facility-use-slots/20026#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4197ef84-c73d-4093-bdc8-132a23fd554b/versions/ad14cd57-3c5a-4965-8823-565bde9fdd37",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;4197ef84-c73d-4093-bdc8-132a23fd554b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/4197ef84-c73d-4093-bdc8-132a23fd554b


---
Response status code: 200 OK. Responded in 12.618815ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940827929169930&afterId=b89520fd-8da0-4f2b-a9cd-a75653450f06",
  "message": "Listening for UUID: '4197ef84-c73d-4093-bdc8-132a23fd554b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 11.433404ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;4197ef84-c73d-4093-bdc8-132a23fd554b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/4197ef84-c73d-4093-bdc8-132a23fd554b


---
Response status code: 200 OK. Responded in 2018.176912ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4197ef84-c73d-4093-bdc8-132a23fd554b",
  "modified": 637940827981817900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/4197ef84-c73d-4093-bdc8-132a23fd554b",
    "identifier": "4197ef84-c73d-4093-bdc8-132a23fd554b",
...
---
Response status code: 200 OK. Responded in 3.161929ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940827981817911&afterId=4197ef84-c73d-4093-bdc8-132a23fd554b",
  "message": "Listening for UUID: '4197ef84-c73d-4093-bdc8-132a23fd554b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/4197ef84-c73d-4093-bdc8-132a23fd554b
...
---
Response status code: 201 Created. Responded in 45.977617ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4197ef84-c73d-4093-bdc8-132a23fd554b",
  "identifier": "4197ef84-c73d-4093-bdc8-132a23fd554b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1306.943053ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "4197ef84-c73d-4093-bdc8-132a23fd554b",
  "modified": 637940828002671900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.059946ms.
```json
{
  "data": {
    "@context": [
