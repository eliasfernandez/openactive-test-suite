...
---
Response status code: 200 OK. Responded in 17.971212ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14568"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1457%2Ffacility-use-slots%2F14568?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.889158ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14568#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT13H53M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-24T14:38:12+00:00",
    "endDate": "2022-07-24T16:12:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f18abae3-62ce-4fe4-9bd1-0dbfb263c64a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14568#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14568"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 462.463408ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f18abae3-62ce-4fe4-9bd1-0dbfb263c64a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1457%2Ffacility-use-slots%2F14568?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 969.387937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14568",
  "modified": 1658486802674,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f18abae3-62ce-4fe4-9bd1-0dbfb263c64a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brant_Osinski@gmail.com",
    "telephone": "677-358-2126",
    "givenName": "Wehner",
    "familyName": "Christop",
    "identifier": "5d463627-7c4e-4aa5-b718-0a78a6ad2dc4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 257.189699ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.765793ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f18abae3-62ce-4fe4-9bd1-0dbfb263c64a
...
---
Response status code: 400 Bad Request. Responded in 309.899208ms.
```json
{
  "@context": "https://openactive.io/",
