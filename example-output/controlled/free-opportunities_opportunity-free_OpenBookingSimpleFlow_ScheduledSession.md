...
⚠️ 15 passed with 0 failures, 144 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 59.645139ms.
```json
{
...
---
Response status code: 200 OK. Responded in 617.507979ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2509/events/20509",
  "modified": 1658486851586,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/38e7faba-d6a5-435e-b10c-5461daecb2df
...
---
Response status code: 200 OK. Responded in 501.072027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/38e7faba-d6a5-435e-b10c-5461daecb2df",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2509%2Fevents%2F20509?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 478.498123ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2509/events/20509",
  "modified": 1658486852889,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/38e7faba-d6a5-435e-b10c-5461daecb2df
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dell_Franecki@yahoo.com",
    "telephone": "362-809-1428 x9759",
    "givenName": "Casper",
    "familyName": "Izaiah",
    "identifier": "d8923c09-3e05-4bf8-ba30-5b5db4567b7a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1005.833987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 56.611511ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/38e7faba-d6a5-435e-b10c-5461daecb2df
...
---
Response status code: 201 Created. Responded in 597.003394ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/38e7faba-d6a5-435e-b10c-5461daecb2df",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38e7faba-d6a5-435e-b10c-5461daecb2df#/orderedItems/2734",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2509#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 4.930745ms.
```json
{
  "data": {
    "@context": [
