...
---
Response status code: 200 OK. Responded in 12.258011ms.
```json
{
...
---
Response status code: 200 OK. Responded in 515.045759ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508",
  "modified": 1658486878973,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:57+00:00",
    "endDate": "2022-07-23T11:47:57+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/36c37038-bfd4-4a84-b7d6-53bc386487fb
...
---
Response status code: 200 OK. Responded in 147.817437ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/36c37038-bfd4-4a84-b7d6-53bc386487fb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2508%2Ffacility-use-slots%2F20508?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1186.637838ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508",
  "modified": 1658486880563,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/36c37038-bfd4-4a84-b7d6-53bc386487fb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anika_Bradtke11@yahoo.com",
    "telephone": "(516) 411-1108",
    "givenName": "Windler",
    "familyName": "Colin",
    "identifier": "917dcb9f-3de0-41b4-b938-b539a2fef550"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 485.301844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.303048ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/36c37038-bfd4-4a84-b7d6-53bc386487fb
...
---
Response status code: 400 Bad Request. Responded in 158.436151ms.
```json
{
  "@context": "https://openactive.io/",
