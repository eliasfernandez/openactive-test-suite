...
---
Response status code: 200 OK. Responded in 110.068476ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/564/events/5639"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F564%2Fevents%2F5639?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 118.948892ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/564/events/5639",
    "startDate": "2022-07-25T01:51:11+00:00",
    "endDate": "2022-07-25T07:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/564",
      "name": "Rubber Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/564#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 11.88,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT20H16M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/564#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/564/events/5639"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 609.703748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:03+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/564"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F564%2Fevents%2F5639?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 126.246842ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/564/events/5639",
  "modified": 1658486764719,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "62557f3f-573b-494e-93cb-e0b8099085b2",
...
---
Response status code: 200 OK. Responded in 227.82725ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:04+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 47.42193ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483
...
---
Response status code: 201 Created. Responded in 391.901514ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/aa64e0cd-4755-40f6-b4e2-c7acc6aa6483#/orderedItems/2195",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/564#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 9.289701ms.
```json
{
  "data": {
    "@context": [
