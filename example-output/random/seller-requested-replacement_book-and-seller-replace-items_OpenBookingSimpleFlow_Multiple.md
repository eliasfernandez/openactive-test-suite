...
# seller-requested-replacement >> book-and-seller-replace-items (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 50 passed with 0 failures, 775 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 21.507852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/507/events/5070"
}
```
...
---
Response status code: 200 OK. Responded in 20.240531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6311"
}
```
...
---
Response status code: 200 OK. Responded in 19.220315ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433"
}
```
...
---
Response status code: 200 OK. Responded in 18.384401ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F507%2Fevents%2F5070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.134846ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/507/events/5070",
    "startDate": "2022-07-23T08:48:11+00:00",
    "endDate": "2022-07-23T13:43:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/507",
      "name": "Rubber Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/507#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT15H12M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F632%2Fevents%2F6311?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.77024ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6311",
    "startDate": "2022-07-29T04:58:11+00:00",
    "endDate": "2022-07-29T10:35:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/632",
      "name": "Soft Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/632#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F244%2Ffacility-use-slots%2F2433?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.381634ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/244",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2022-07-25T17:17:12+00:00",
    "endDate": "2022-07-25T19:40:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F12%2Ffacility-use-slots%2F115?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.973727ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/12",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T09:36:11+00:00",
    "endDate": "2022-07-28T10:24:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c5eb1a3a-031f-459b-abb7-9942e31218c8
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/507#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/507/events/5070"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/632#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6311"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 202.089605ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c5eb1a3a-031f-459b-abb7-9942e31218c8",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:32+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/632"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/244"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-25T17:17:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F507%2Fevents%2F5070?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 416.920763ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/507/events/5070",
  "modified": 1658486074495,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F632%2Fevents%2F6311?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 416.293052ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6311",
  "modified": 1658486074496,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F244%2Ffacility-use-slots%2F2433?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 770.469223ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433",
  "modified": 1658486074851,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F12%2Ffacility-use-slots%2F115?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 770.166317ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115",
  "modified": 1658486074852,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c5eb1a3a-031f-459b-abb7-9942e31218c8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maryam7@hotmail.com",
    "telephone": "1-424-283-8289",
    "givenName": "Jones",
    "familyName": "Harrison",
    "identifier": "8129385f-5f6e-4cf9-af42-ef380999c163"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 468.667683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:35+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 10.879385ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.089872ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.467561ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.064754ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8
...
---
Response status code: 201 Created. Responded in 80.016963ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/373",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/507#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/374",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/507#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/375",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/632#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/376",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/377",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/244/facility-use-slots/2433#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/378",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/115#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 20.286546ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.737736ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.184526ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.315563ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;c5eb1a3a-031f-459b-abb7-9942e31218c8&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/c5eb1a3a-031f-459b-abb7-9942e31218c8


---
Response status code: 200 OK. Responded in 14.314844ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940828786541647&afterId=622895b7-2551-4ecc-a711-1b41f4898849",
  "message": "Listening for UUID: 'c5eb1a3a-031f-459b-abb7-9942e31218c8' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 54.879734ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:ReplacementSimulateAction)

### Orders (orders) Feed collect for &#x27;c5eb1a3a-031f-459b-abb7-9942e31218c8&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/c5eb1a3a-031f-459b-abb7-9942e31218c8


---
Response status code: 200 OK. Responded in 2025.055331ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c5eb1a3a-031f-459b-abb7-9942e31218c8",
  "modified": 637940828812731100,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8",
    "identifier": "c5eb1a3a-031f-459b-abb7-9942e31218c8",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/c5eb1a3a-031f-459b-abb7-9942e31218c8#/orderedItems/378",
      ...
      },
      {
        ...
        "acceptedOffer": {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/3#/offers/0",
          "price": 6.31,
          "priceCurrency": "GBP"
        },
        "accessChannel": {
        ...
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/3/events/21",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        "@type": "OrderItem",
