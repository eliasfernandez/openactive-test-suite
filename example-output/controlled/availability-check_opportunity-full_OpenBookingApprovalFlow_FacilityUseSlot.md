...
---
Response status code: 200 OK. Responded in 26.765883ms.
```json
{
...
---
Response status code: 200 OK. Responded in 463.059269ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2083/facility-use-slots/20083",
  "modified": 1658486094797,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 0,
    "startDate": "2022-07-23T10:34:53+00:00",
    "endDate": "2022-07-23T11:34:53+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/befa445f-3152-4276-95e5-45ac82dcc024
...
---
Response status code: 409 Conflict. Responded in 23.845463ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/befa445f-3152-4276-95e5-45ac82dcc024",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/befa445f-3152-4276-95e5-45ac82dcc024
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tyrel2@hotmail.com",
    "telephone": "435-306-3895 x2223",
    "givenName": "Dare",
    "familyName": "Kassandra",
    "identifier": "39f04503-b19f-434a-8f02-1caf151c3923"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 52.56816ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
