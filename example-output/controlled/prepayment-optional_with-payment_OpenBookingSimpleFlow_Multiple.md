...
---
Response status code: 200 OK. Responded in 619.197117ms.
```json
{
...
---
Response status code: 200 OK. Responded in 625.249471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 623.711757ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2541/events/20541",
  "modified": 1658486918088,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2541/events/20541",
    "startDate": "2022-07-23T10:48:36+00:00",
    "endDate": "2022-07-23T11:48:36+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1281.050419ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2529/facility-use-slots/20529",
  "modified": 1658486918745,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/00f9f830-fcea-4ec1-bc1a-c06de647ad72
...
---
Response status code: 200 OK. Responded in 416.650879ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/00f9f830-fcea-4ec1-bc1a-c06de647ad72",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2541%2Fevents%2F20541?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 326.34376ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2541/events/20541",
  "modified": 1658486919702,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2529%2Ffacility-use-slots%2F20529?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 120.281291ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2529/facility-use-slots/20529",
  "modified": 1658486919500,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/00f9f830-fcea-4ec1-bc1a-c06de647ad72
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Pierce26@hotmail.com",
    "telephone": "(228) 915-8155",
    "givenName": "Ledner",
    "familyName": "Halle",
    "identifier": "2a830341-b726-4d28-93ec-cbc23d32d02d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 552.138608ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.781605ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.698094ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/00f9f830-fcea-4ec1-bc1a-c06de647ad72
...
---
Response status code: 201 Created. Responded in 1184.355205ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/00f9f830-fcea-4ec1-bc1a-c06de647ad72",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/00f9f830-fcea-4ec1-bc1a-c06de647ad72#/orderedItems/2925",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2541#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/00f9f830-fcea-4ec1-bc1a-c06de647ad72#/orderedItems/2926",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2529/facility-use-slots/20529#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 21.283107ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.124447ms.
```json
{
  "data": {
    "@context": [
