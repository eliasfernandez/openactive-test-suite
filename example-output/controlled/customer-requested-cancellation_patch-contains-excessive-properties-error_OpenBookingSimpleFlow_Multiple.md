...
---
Response status code: 200 OK. Responded in 38.659856ms.
```json
{
...
---
Response status code: 200 OK. Responded in 45.648521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 31.367089ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 38.074351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1238.362485ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2270/events/20270",
  "modified": 1658486324767,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2270/events/20270",
    "startDate": "2022-07-23T10:38:42+00:00",
    "endDate": "2022-07-23T11:38:42+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1239.457793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2271/events/20271",
  "modified": 1658486324768,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 577.418517ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2261/facility-use-slots/20261",
  "modified": 1658486324124,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 577.255715ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2262/facility-use-slots/20262",
  "modified": 1658486324125,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/92c72d51-c931-4e2e-b7da-7b4ceb102ffc
...
---
Response status code: 200 OK. Responded in 387.237029ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/92c72d51-c931-4e2e-b7da-7b4ceb102ffc",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2270%2Fevents%2F20270?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 21.829577ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2271%2Fevents%2F20271?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 17.127939ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2261%2Ffacility-use-slots%2F20261?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 784.674641ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2261/facility-use-slots/20261",
  "modified": 1658486327344,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2262%2Ffacility-use-slots%2F20262?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 782.946427ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2262/facility-use-slots/20262",
  "modified": 1658486327345,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/92c72d51-c931-4e2e-b7da-7b4ceb102ffc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cristina_Champlin43@yahoo.com",
    "telephone": "1-676-407-1368 x811",
    "givenName": "Feil",
    "familyName": "Jeffry",
    "identifier": "bfb65eba-f707-46d4-b6a5-7a21631cd626"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 258.464394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 27.849126ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.259056ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.787552ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.353349ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc
...
---
Response status code: 201 Created. Responded in 378.442267ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1139",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2270#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1140",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2270#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1141",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2271#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1142",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2261/facility-use-slots/20261#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1143",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2261/facility-use-slots/20261#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc#/orderedItems/1144",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2262/facility-use-slots/20262#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 19.66036ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.244058ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.744878ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.358175ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/92c72d51-c931-4e2e-b7da-7b4ceb102ffc
...
---
Response status code: 400 Bad Request. Responded in 81.81237ms.
```json
{
  "@context": "https://openactive.io/",
