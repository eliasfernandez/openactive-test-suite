...
---
Response status code: 200 OK. Responded in 16.967943ms.
```json
{
...
---
Response status code: 200 OK. Responded in 652.277399ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2307/facility-use-slots/20307",
  "modified": 1658486421116,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/db67c982-9181-4198-8342-08139c9768e3
...
---
Response status code: 200 OK. Responded in 98.208528ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/db67c982-9181-4198-8342-08139c9768e3",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2307%2Ffacility-use-slots%2F20307?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1306.068812ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2307/facility-use-slots/20307",
  "modified": 1658486422644,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/db67c982-9181-4198-8342-08139c9768e3
...
---
Response status code: 400 Bad Request. Responded in 21.38878ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 163.378078ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 959.010106ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310",
  "modified": 1658486424009,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8f115534-6938-4b23-a2e8-690f8c95f184
...
---
Response status code: 200 OK. Responded in 138.333868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8f115534-6938-4b23-a2e8-690f8c95f184",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2310%2Ffacility-use-slots%2F20310?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1035.242986ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310",
  "modified": 1658486425356,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8f115534-6938-4b23-a2e8-690f8c95f184
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Betsy.Morar31@gmail.com",
    "telephone": "273-733-5956 x76584",
    "givenName": "Bosco",
    "familyName": "Jazmyn",
    "identifier": "f504d815-13f7-49cf-88d1-80aa6e782fb7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 136.620252ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.736007ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8f115534-6938-4b23-a2e8-690f8c95f184
...
---
Response status code: 400 Bad Request. Responded in 28.694863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
