...
⚠️ 79 passed with 0 failures, 1040 warnings and 276 suggestions 
...
---
Response status code: 200 OK. Responded in 8.000441ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3855"
}
```
...
---
Response status code: 200 OK. Responded in 7.682436ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1567"
}
```
...
---
Response status code: 200 OK. Responded in 7.495632ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4108"
}
```
...
---
Response status code: 200 OK. Responded in 8.947858ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/512/facility-use-slots/5114"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F386%2Fevents%2F3855?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.292593ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3855",
    "startDate": "2022-07-25T18:24:11+00:00",
    "endDate": "2022-07-25T23:07:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1567?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.193091ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1567",
    "startDate": "2022-07-30T23:32:11+00:00",
    "endDate": "2022-07-31T05:17:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F411%2Ffacility-use-slots%2F4108?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.163909ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4108#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 11.87,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT12H49M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-08-01T09:25:12+00:00",
    "endDate": "2022-08-01T10:23:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F512%2Ffacility-use-slots%2F5114?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.824703ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/512",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/512/facility-use-slots/5114#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 15.63,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT9H7M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-31T02:49:12+00:00",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8beaa9e6-d270-4500-b8d1-f919cd2eca6d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3855"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1567"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4108#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4108"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/512/facility-use-slots/5114#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/512/facility-use-slots/5114"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 124.48989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8beaa9e6-d270-4500-b8d1-f919cd2eca6d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F386%2Fevents%2F3855?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 767.5867ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3855",
  "modified": 1658486053830,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F157%2Fevents%2F1567?useCacheIfAvailable=true&expectedCapacity=24


---
Response status code: 200 OK. Responded in 756.135399ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1567",
  "modified": 1658486053832,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F411%2Ffacility-use-slots%2F4108?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 422.45733ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4108",
  "modified": 1658486053499,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F512%2Ffacility-use-slots%2F5114?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 423.911256ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/512/facility-use-slots/5114",
  "modified": 1658486053501,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 32.040764ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/857"
}
```
...
---
Response status code: 200 OK. Responded in 31.026145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/473/events/4725"
}
```
...
---
Response status code: 200 OK. Responded in 30.198831ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215"
}
```
...
---
Response status code: 200 OK. Responded in 21.354375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F86%2Fevents%2F857?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.732135ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/857",
    "startDate": "2022-07-23T14:44:11+00:00",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F473%2Fevents%2F4725?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.346328ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/473/events/4725",
    "startDate": "2022-07-28T09:48:11+00:00",
    "endDate": "2022-07-28T10:34:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F522%2Ffacility-use-slots%2F5215?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.623162ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT17H30M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-29T03:15:12+00:00",
    "endDate": "2022-07-29T06:36:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F749%2Ffacility-use-slots%2F7484?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.408942ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/749",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT5H30M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-23T21:33:12+00:00",
    "endDate": "2022-07-24T02:25:12+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8beaa9e6-d270-4500-b8d1-f919cd2eca6d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Patience32@gmail.com",
    "telephone": "1-610-565-1614 x59757",
    "givenName": "Nolan",
    "familyName": "Freda",
    "identifier": "7b41d3f9-4057-49fc-90e6-ba5b0aee62c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/857"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/473/events/4725"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 186.944988ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/749"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-23T21:33:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F86%2Fevents%2F857?useCacheIfAvailable=true&expectedCapacity=38


---
Response status code: 200 OK. Responded in 774.326509ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/857",
  "modified": 1658486059240,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F473%2Fevents%2F4725?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 774.887819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/473/events/4725",
  "modified": 1658486059241,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F522%2Ffacility-use-slots%2F5215?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 109.745531ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215",
  "modified": 1658486058568,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F749%2Ffacility-use-slots%2F7484?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 106.978381ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484",
  "modified": 1658486058579,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d
...
---
Response status code: 201 Created. Responded in 153.077964ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/338",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/86#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/339",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/86#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/340",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/473#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/341",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/342",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5215#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8beaa9e6-d270-4500-b8d1-f919cd2eca6d#/orderedItems/343",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/749/facility-use-slots/7484#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 27.604681ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.500361ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.739565ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.485661ms.
```json
{
  "data": {
    "@context": [
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after B) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
