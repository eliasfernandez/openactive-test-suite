...
⚠️ 24 passed with 0 failures, 525 warnings and 132 suggestions 
...
---
Response status code: 200 OK. Responded in 57.47636ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1160/events/11600"
}
```
...
---
Response status code: 200 OK. Responded in 55.52681ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1120/events/11193"
}
```
...
---
Response status code: 200 OK. Responded in 53.95657ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833"
}
```
...
---
Response status code: 200 OK. Responded in 52.910844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14328"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1160%2Fevents%2F11600?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.721806ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1160/events/11600",
    "startDate": "2022-07-26T15:01:11+00:00",
    "endDate": "2022-07-26T15:45:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1160",
      "name": "Rubber Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1160#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1120%2Fevents%2F11193?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.922185ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1120/events/11193",
    "startDate": "2022-08-01T10:25:11+00:00",
    "endDate": "2022-08-01T14:20:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1120",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1120#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1184%2Ffacility-use-slots%2F11833?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.235468ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-27T03:21:12+00:00",
    "endDate": "2022-07-27T06:50:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1433%2Ffacility-use-slots%2F14328?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.646453ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14328#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 8,
    "startDate": "2022-07-31T19:34:12+00:00",
    "endDate": "2022-08-01T01:03:12+00:00"
  }
}
```
### Specs
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Karianne67@hotmail.com",
    "telephone": "(819) 375-4564 x9449",
    "givenName": "Graham",
    "familyName": "Eldon",
    "identifier": "a45456e2-50db-4e31-8914-4ddab631e234"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1160#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1160/events/11600"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1120#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1120/events/11193"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14328#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14328"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 944.004076ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2045",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1160#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2046",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1160#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2047",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1120#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2048",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2049",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11833#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb#/orderedItems/2050",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14328#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb/versions/ebf2ff7c-82e0-4c45-94e3-8b29902c10ef",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb


---
Response status code: 200 OK. Responded in 9.768849ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834981171659&afterId=dd96b751-ce93-4d6b-875a-770182ceeffd",
  "message": "Listening for UUID: 'a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 772.003008ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb


---
Response status code: 200 OK. Responded in 1895.067519ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  "modified": 637940835066567800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
    "identifier": "a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
...
---
Response status code: 200 OK. Responded in 26.998397ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940835066567841&afterId=a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  "message": "Listening for UUID: 'a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb
...
---
Response status code: 201 Created. Responded in 827.545271ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  "identifier": "a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 20.92214ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a2e9aa9c-9257-49eb-adb5-5d91bb01f9eb",
  "modified": 637940835091561200
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1160%2Fevents%2F11600?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 45.413573ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1120%2Fevents%2F11193?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 44.189542ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1184%2Ffacility-use-slots%2F11833?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 43.327319ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1433%2Ffacility-use-slots%2F14328?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 42.694303ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 82.685734ms.
```json
{
  "@context": [
    "https://openactive.io/",
