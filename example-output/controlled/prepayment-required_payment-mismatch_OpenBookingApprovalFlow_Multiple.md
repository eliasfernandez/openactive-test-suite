[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:34 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 71.325139ms.
```json
{
...
---
Response status code: 200 OK. Responded in 143.742787ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 726.852109ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470",
  "modified": 1658486760257,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470",
    "startDate": "2022-07-23T10:45:58+00:00",
    "endDate": "2022-07-23T11:45:58+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 935.066879ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2458/facility-use-slots/20458",
  "modified": 1658486760467,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b36eb8d6-62ac-4900-bca9-1c0b26502c0d
...
---
Response status code: 200 OK. Responded in 337.609943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b36eb8d6-62ac-4900-bca9-1c0b26502c0d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2470%2Fevents%2F20470?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 429.066466ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470",
  "modified": 1658486761697,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2458%2Ffacility-use-slots%2F20458?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 352.85468ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2458/facility-use-slots/20458",
  "modified": 1658486761622,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b36eb8d6-62ac-4900-bca9-1c0b26502c0d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Parker.Brekke9@yahoo.com",
    "telephone": "647.288.5388 x85951",
    "givenName": "Armstrong",
    "familyName": "Rosario",
    "identifier": "aabbdf71-b4c1-472a-a444-3e7c35dfab78"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 486.863088ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.413585ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.567895ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b36eb8d6-62ac-4900-bca9-1c0b26502c0d
...
---
Response status code: 400 Bad Request. Responded in 360.791152ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (25.99) does not match expected value (24.99)"
}
```
### Specs
