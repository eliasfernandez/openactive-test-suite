...
---
Response status code: 200 OK. Responded in 11.296602ms.
```json
{
...
---
Response status code: 200 OK. Responded in 287.102297ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528",
  "modified": 1658486889127,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528",
    "startDate": "2022-07-23T10:48:07+00:00",
    "endDate": "2022-07-23T11:48:07+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a6f48d6d-5479-47f8-8356-3402602ed9dc
...
---
Response status code: 200 OK. Responded in 384.144974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a6f48d6d-5479-47f8-8356-3402602ed9dc",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2528%2Fevents%2F20528?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 341.094585ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528",
  "modified": 1658486890111,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a6f48d6d-5479-47f8-8356-3402602ed9dc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Moshe_Hane53@gmail.com",
    "telephone": "(911) 622-7296 x0772",
    "givenName": "Prohaska",
    "familyName": "Matteo",
    "identifier": "336a8a77-f72d-4eeb-912e-8db246fd87c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 398.383604ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.052109ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a6f48d6d-5479-47f8-8356-3402602ed9dc
...
---
Response status code: 400 Bad Request. Responded in 373.64208ms.
```json
{
  "@context": "https://openactive.io/",
