[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:43:15 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 325 warnings and 84 suggestions 
...
---
Response status code: 200 OK. Responded in 175.949577ms.
```json
{
...
---
Response status code: 200 OK. Responded in 97.199371ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 115.327833ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 142.995181ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 567.394683ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2405/events/20405",
  "modified": 1658486605301,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2405/events/20405",
    "startDate": "2022-07-23T10:43:23+00:00",
    "endDate": "2022-07-23T11:43:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 566.113572ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2404/events/20404",
...
---
Response status code: 200 OK. Responded in 1462.722704ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391",
  "modified": 1658486606195,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1463.255608ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392",
  "modified": 1658486606201,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marta.Block@gmail.com",
    "telephone": "557-875-0858 x8599",
    "givenName": "Walter",
    "familyName": "Maximo",
    "identifier": "336af60c-247f-4515-a122-894b695d81cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 201 Created. Responded in 1243.194129ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2004",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2405#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2005",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2405#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2006",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2404#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2007",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2008",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f25887c7-01dc-44b2-b48b-29f0ce0713ed#/orderedItems/2009",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2405%2Fevents%2F20405?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 62.526749ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2404%2Fevents%2F20404?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 45.746701ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2391%2Ffacility-use-slots%2F20391?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 45.117196ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2392%2Ffacility-use-slots%2F20392?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 38.76814ms.
```json
{
  "data": {
    "@context": [
