...
---
Response status code: 200 OK. Responded in 18.807871ms.
```json
{
...
---
Response status code: 200 OK. Responded in 443.82274ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2577/facility-use-slots/20577",
  "modified": 1658487015570,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/746b2617-1a87-4d36-8f3c-41fd2f0ebb70
...
---
Response status code: 400 Bad Request. Responded in 62.696971ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/746b2617-1a87-4d36-8f3c-41fd2f0ebb70
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eleanore9@hotmail.com",
    "telephone": "(462) 916-4372",
    "givenName": "Ebert",
    "familyName": "Bernadine",
    "identifier": "0e2397aa-0437-4501-bd34-03b2ec3c9cf7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 344.474136ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
