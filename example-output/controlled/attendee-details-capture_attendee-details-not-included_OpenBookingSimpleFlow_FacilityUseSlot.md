...
---
Response status code: 200 OK. Responded in 13.071404ms.
```json
{
...
---
Response status code: 200 OK. Responded in 539.536768ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2162/facility-use-slots/20162",
  "modified": 1658486192898,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:36:31+00:00",
    "endDate": "2022-07-23T11:36:31+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4c31e41e-a651-4d92-87fd-5f5a1a17fc1c
...
---
Response status code: 200 OK. Responded in 59.855773ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4c31e41e-a651-4d92-87fd-5f5a1a17fc1c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:32+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2162%2Ffacility-use-slots%2F20162?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 933.952289ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2162/facility-use-slots/20162",
  "modified": 1658486194074,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4c31e41e-a651-4d92-87fd-5f5a1a17fc1c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kiara_Dietrich78@yahoo.com",
    "telephone": "1-930-572-1213",
    "givenName": "Terry",
    "familyName": "Micheal",
    "identifier": "32883574-02a9-43e0-ad7e-437ec5dbf2d4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 28.109023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4c31e41e-a651-4d92-87fd-5f5a1a17fc1c
...
---
Response status code: 409 Conflict. Responded in 30.39204ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4c31e41e-a651-4d92-87fd-5f5a1a17fc1c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
