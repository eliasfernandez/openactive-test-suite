...
⚠️ 11 passed with 0 failures, 99 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 17.004733ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12532"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1254%2Fevents%2F12532?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.675872ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12532",
    "startDate": "2022-07-29T06:16:11+00:00",
    "endDate": "2022-07-29T10:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/174a240c-e6ea-45f5-b31f-a53be026e292
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12532"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 915.659785ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/174a240c-e6ea-45f5-b31f-a53be026e292",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1254%2Fevents%2F12532?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 360.628446ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12532",
  "modified": 1658486741076,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9d573f45-693e-4942-8126-c3e82d97d845
...
---
Response status code: 409 Conflict. Responded in 160.4583ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9d573f45-693e-4942-8126-c3e82d97d845",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 17.345951ms.
```json
{
  "data": {
    "@context": [
