...
---
Response status code: 200 OK. Responded in 11.653748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/839"
}
```
...
---
Response status code: 200 OK. Responded in 9.745308ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/109/facility-use-slots/1087"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F84%2Fevents%2F839?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 42.679408ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/839",
    "startDate": "2022-07-31T22:18:11+00:00",
    "endDate": "2022-07-31T23:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F109%2Ffacility-use-slots%2F1087?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 42.018593ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/109",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/109/facility-use-slots/1087#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 7.49,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-25T14:18:11+00:00",
    "endDate": "2022-07-25T18:53:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f4f934c-eb48-4980-ab64-3cc612a8eb1e
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/839"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/109/facility-use-slots/1087#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/109/facility-use-slots/1087"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 608.698145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f4f934c-eb48-4980-ab64-3cc612a8eb1e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:18+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F84%2Fevents%2F839?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 99.958626ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/839",
  "modified": 1658486840126,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F109%2Ffacility-use-slots%2F1087?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 1286.873468ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/109/facility-use-slots/1087",
  "modified": 1658486841313,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f4f934c-eb48-4980-ab64-3cc612a8eb1e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Darrion_Robel98@yahoo.com",
    "telephone": "741-311-9386 x67439",
    "givenName": "Prohaska",
    "familyName": "Frederik",
    "identifier": "6690e587-e022-42d0-8b4a-96bc92e346a3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 708.481168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 28.094798ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.637596ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2f4f934c-eb48-4980-ab64-3cc612a8eb1e
...
---
Response status code: 400 Bad Request. Responded in 1012.563935ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (20.84) does not match expected value (19.84)"
}
```
### Specs
