...
---
Response status code: 200 OK. Responded in 14.182102ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1106/events/11051"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1106%2Fevents%2F11051?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 48.794137ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1106/events/11051",
    "startDate": "2022-07-22T13:07:11+00:00",
    "endDate": "2022-07-22T19:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1106",
      "name": "Wooden Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1106#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6760cfbb-2d7f-4976-a5af-33868acc6987
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1106#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1106/events/11051"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 391.104119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6760cfbb-2d7f-4976-a5af-33868acc6987",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:23+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1106"
        },
        "maximumAttendeeCapacity": 17,
        "remainingAttendeeCapacity": 17
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1106%2Fevents%2F11051?useCacheIfAvailable=true&expectedCapacity=16


---
Response status code: 200 OK. Responded in 810.947776ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1106/events/11051",
  "modified": 1658486845983,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6760cfbb-2d7f-4976-a5af-33868acc6987
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nedra_Littel@gmail.com",
    "telephone": "1-693-633-4970",
    "givenName": "Wehner",
    "familyName": "Clarissa",
    "identifier": "f544768d-2d9e-4f0d-abbf-de8aadc2f818"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 288.5384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:25+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 11.998524ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6760cfbb-2d7f-4976-a5af-33868acc6987
...
---
Response status code: 400 Bad Request. Responded in 462.572457ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (7.51) does not match expected value (6.51)"
}
```
### Specs
