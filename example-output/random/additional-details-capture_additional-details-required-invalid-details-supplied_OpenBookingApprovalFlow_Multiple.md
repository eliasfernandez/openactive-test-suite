[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:36:46 GMT+0000 (Coordinated Universal Time)
...
⚠️ 34 passed with 0 failures, 669 warnings and 180 suggestions 
...
---
Response status code: 200 OK. Responded in 70.497294ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14272"
}
```
...
---
Response status code: 200 OK. Responded in 69.492779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1613/events/16125"
}
```
...
---
Response status code: 200 OK. Responded in 68.712267ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1011/facility-use-slots/10103"
}
```
...
---
Response status code: 200 OK. Responded in 67.928955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1110/facility-use-slots/11096"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1428%2Fevents%2F14272?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.904241ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14272",
    "startDate": "2022-07-25T10:16:11+00:00",
    "endDate": "2022-07-25T14:25:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT15H25M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1613%2Fevents%2F16125?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.425533ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1613/events/16125",
    "startDate": "2022-07-22T13:05:11+00:00",
    "endDate": "2022-07-22T18:15:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1011%2Ffacility-use-slots%2F10103?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.000226ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1011",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1011/facility-use-slots/10103#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingIntakeForm",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-23T04:34:12+00:00",
    "endDate": "2022-07-23T06:36:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1110%2Ffacility-use-slots%2F11096?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.658421ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1110",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1110/facility-use-slots/11096#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-26T18:51:12+00:00",
    "endDate": "2022-07-26T19:45:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/23ebff80-03cf-4712-90c0-3704e93161e6
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14272"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1613/events/16125"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1011/facility-use-slots/10103#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1011/facility-use-slots/10103"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1110/facility-use-slots/11096#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1110/facility-use-slots/11096"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 124.753538ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/23ebff80-03cf-4712-90c0-3704e93161e6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:08+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1428%2Fevents%2F14272?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 36.185962ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1613%2Fevents%2F16125?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 35.356449ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1011%2Ffacility-use-slots%2F10103?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 570.315957ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1011/facility-use-slots/10103",
  "modified": 1658486230561,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1110%2Ffacility-use-slots%2F11096?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 570.319956ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1110/facility-use-slots/11096",
  "modified": 1658486230562,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/23ebff80-03cf-4712-90c0-3704e93161e6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dora.Lesch@yahoo.com",
    "telephone": "966-228-1766 x600",
    "givenName": "Mosciski",
    "familyName": "Adolphus",
    "identifier": "1b099c57-9b06-4aa4-a695-c1c69797bc99"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 44.840096ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/23ebff80-03cf-4712-90c0-3704e93161e6
...
---
Response status code: 409 Conflict. Responded in 121.559673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/23ebff80-03cf-4712-90c0-3704e93161e6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
