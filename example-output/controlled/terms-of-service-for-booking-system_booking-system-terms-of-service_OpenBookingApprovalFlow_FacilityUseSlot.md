...
---
Response status code: 200 OK. Responded in 272.445397ms.
```json
{
...
---
Response status code: 200 OK. Responded in 898.008228ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2314/facility-use-slots/20314",
  "modified": 1658486428378,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:40:26+00:00",
    "endDate": "2022-07-23T11:40:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1
...
---
Response status code: 200 OK. Responded in 540.377752ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:27+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2314%2Ffacility-use-slots%2F20314?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 739.810005ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2314/facility-use-slots/20314",
  "modified": 1658486429867,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jovany21@gmail.com",
    "telephone": "1-598-599-1269 x212",
    "givenName": "Rippin",
    "familyName": "Dorthy",
    "identifier": "3fe2ef94-56e1-4dfe-a006-51c3b90034fa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 224.833191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:29+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.001052ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1
...
---
Response status code: 201 Created. Responded in 213.919399ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1#/orderedItems/1500",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2314/facility-use-slots/20314#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1/versions/ed79f085-79e7-4cb9-a741-fd8d119721af",
  "payment": {
    "@type": "Payment",
    "identifier": "WuqrPfw0Q",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c66e6dab-1b43-49b9-93f3-8c1e4ae997a1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1


---
Response status code: 200 OK. Responded in 15.729432ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832267986169&afterId=901c5bf0-6cc9-4f68-af75-88a98a130b5a",
  "message": "Listening for UUID: 'c66e6dab-1b43-49b9-93f3-8c1e4ae997a1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 268.048554ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;c66e6dab-1b43-49b9-93f3-8c1e4ae997a1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1


---
Response status code: 200 OK. Responded in 2057.159415ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  "modified": 637940832299967000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
    "identifier": "c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
...
---
Response status code: 200 OK. Responded in 7.685664ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832292685960&afterId=901c5bf0-6cc9-4f68-af75-88a98a130b5a",
  "message": "Listening for UUID: 'c66e6dab-1b43-49b9-93f3-8c1e4ae997a1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1
...
---
Response status code: 201 Created. Responded in 168.436319ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  "identifier": "c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1534.7776290000002ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c66e6dab-1b43-49b9-93f3-8c1e4ae997a1",
  "modified": 637940832321123700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 7.890766ms.
```json
{
  "data": {
    "@context": [
