...
---
Response status code: 200 OK. Responded in 66.060991ms.
```json
{
...
---
Response status code: 200 OK. Responded in 858.621682ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2425/facility-use-slots/20425",
  "modified": 1658486681721,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d760712d-f2f2-46ca-b993-e3bb56405e2f
...
---
Response status code: 200 OK. Responded in 219.901067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d760712d-f2f2-46ca-b993-e3bb56405e2f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:40+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2425%2Ffacility-use-slots%2F20425?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 876.092539ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2425/facility-use-slots/20425",
  "modified": 1658486683098,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d760712d-f2f2-46ca-b993-e3bb56405e2f
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "996adb94-d773-4e7a-8fca-fd0d781e56f0",
...
---
Response status code: 200 OK. Responded in 151.731158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.658042ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d760712d-f2f2-46ca-b993-e3bb56405e2f
...
---
Response status code: 201 Created. Responded in 175.907774ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d760712d-f2f2-46ca-b993-e3bb56405e2f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d760712d-f2f2-46ca-b993-e3bb56405e2f#/orderedItems/2211",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2425/facility-use-slots/20425#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 12.784714ms.
```json
{
  "data": {
    "@context": [
