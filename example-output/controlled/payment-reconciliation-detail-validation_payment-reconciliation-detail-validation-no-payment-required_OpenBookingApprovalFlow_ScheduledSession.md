...
---
Response status code: 200 OK. Responded in 17.771762ms.
```json
{
...
---
Response status code: 200 OK. Responded in 445.441755ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2590/events/20590",
  "modified": 1658487015772,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2590/events/20590",
    "startDate": "2022-07-23T10:50:14+00:00",
    "endDate": "2022-07-23T11:50:14+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb
...
---
Response status code: 200 OK. Responded in 250.752883ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2590%2Fevents%2F20590?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 497.98843ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2590/events/20590",
  "modified": 1658487016704,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aglae38@hotmail.com",
    "telephone": "971.489.0274 x8433",
    "givenName": "Renner",
    "familyName": "Ardith",
    "identifier": "92b342fa-2774-4c4e-b0f8-fe82f441f925"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 213.383823ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.066637ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb
...
---
Response status code: 201 Created. Responded in 187.922493ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb#/orderedItems/3139",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2590#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb/versions/77acefdc-70d0-4646-a313-6c7109637232",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;2539efc5-9b40-4a56-b0e5-132ad1a7c3cb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb


---
Response status code: 200 OK. Responded in 4.596241ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '2539efc5-9b40-4a56-b0e5-132ad1a7c3cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 53.065878ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;2539efc5-9b40-4a56-b0e5-132ad1a7c3cb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb


---
Response status code: 200 OK. Responded in 2134.373025ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "modified": 637940838165077900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
    "identifier": "2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
...
---
Response status code: 200 OK. Responded in 23.781914ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838165077875&afterId=2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "message": "Listening for UUID: '2539efc5-9b40-4a56-b0e5-132ad1a7c3cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb
...
---
Response status code: 201 Created. Responded in 240.488466ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "identifier": "2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1370.715147ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "2539efc5-9b40-4a56-b0e5-132ad1a7c3cb",
  "modified": 637940838187130900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.923844ms.
```json
{
  "data": {
    "@context": [
