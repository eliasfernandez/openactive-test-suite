...
⚠️ 25 passed with 0 failures, 219 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 4.786299ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4001"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F401%2Ffacility-use-slots%2F4001?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.056164ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4001#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT16H34M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-24T20:23:12+00:00",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/046b2b98-ee6e-4103-a87e-23da883035e1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4001#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4001"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 50.455148ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/046b2b98-ee6e-4103-a87e-23da883035e1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F401%2Ffacility-use-slots%2F4001?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 741.302704ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/401/facility-use-slots/4001",
  "modified": 1658485974143,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/046b2b98-ee6e-4103-a87e-23da883035e1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Buddy_Price@yahoo.com",
    "telephone": "(615) 755-0805",
    "givenName": "Kutch",
    "familyName": "Twila",
    "identifier": "f4bd8153-a846-4bfd-a8b0-ee79af715320"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 77.854818ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.207233ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.864342ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F45%2Ffacility-use-slots%2F443?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2.602454ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-08-01T04:15:11+00:00",
    "endDate": "2022-08-01T06:09:11+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 108.976664ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F45%2Ffacility-use-slots%2F443?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 536.645352ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443",
  "modified": 1658485975243,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 403.408083ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.726898ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/046b2b98-ee6e-4103-a87e-23da883035e1
...
---
Response status code: 201 Created. Responded in 60.674761ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/046b2b98-ee6e-4103-a87e-23da883035e1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/046b2b98-ee6e-4103-a87e-23da883035e1#/orderedItems/33",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/45/facility-use-slots/443#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 8.552759ms.
```json
{
  "data": {
    "@context": [
