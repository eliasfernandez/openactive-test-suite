...
⚠️ 51 passed with 0 failures, 879 warnings and 232 suggestions 
...
---
Response status code: 200 OK. Responded in 25.46013ms.
```json
{
...
---
Response status code: 200 OK. Responded in 24.593815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 23.748301ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583"
}
```
...
---
Response status code: 200 OK. Responded in 23.154391ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 48.776024ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1398/events/13971",
    "startDate": "2022-07-24T17:21:11+00:00",
    "endDate": "2022-07-24T22:31:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT7H21M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 49.033028ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1499/events/14986",
    "startDate": "2022-07-27T00:39:11+00:00",
    "endDate": "2022-07-27T05:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 19.34,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT17H24M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1059%2Ffacility-use-slots%2F10583?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.124963ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingIntakeForm"
    ...
    "remainingUses": 5,
    "startDate": "2022-07-25T11:52:12+00:00",
    "endDate": "2022-07-25T16:59:12+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 57.168567ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT11H21M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-27T01:20:12+00:00",
    "endDate": "2022-07-27T02:03:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/db69b9d1-4a16-48d4-a813-c45671d887bb
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 1175.849935ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/db69b9d1-4a16-48d4-a813-c45671d887bb",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:11+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1398%2Fevents%2F13971?useCacheIfAvailable=true&expectedCapacity=11


---
Response status code: 200 OK. Responded in 603.859608ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1398/events/13971",
  "modified": 1658487014411,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1499%2Fevents%2F14986?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 599.092819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1499/events/14986",
  "modified": 1658487014416,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1059%2Ffacility-use-slots%2F10583?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1306.218944ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583",
  "modified": 1658487015122,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1497%2Ffacility-use-slots%2F14969?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 1305.9706390000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1497/facility-use-slots/14969",
  "modified": 1658487015123,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/db69b9d1-4a16-48d4-a813-c45671d887bb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lillie16@hotmail.com",
    "telephone": "(768) 905-1291",
    "givenName": "Turcotte",
    "familyName": "Hardy",
    "identifier": "cef0677d-70b6-4864-a78e-3a0990658fac"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1095.946441ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:16+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.280895ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.684984ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.404879ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.163174ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/db69b9d1-4a16-48d4-a813-c45671d887bb
...
---
Response status code: 201 Created. Responded in 1228.9597899999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/db69b9d1-4a16-48d4-a813-c45671d887bb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2895",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1398#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2896",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1398#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2897",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1499#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2898",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2899",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1059/facility-use-slots/10583#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb#/orderedItems/2900",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1497/facility-use-slots/14969#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/db69b9d1-4a16-48d4-a813-c45671d887bb/versions/b34d1d8e-c18c-48ad-bd29-e8dd5ffdf1a1",
  "payment": {
    "@type": "Payment",
    "identifier": "VspW92CWD",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;db69b9d1-4a16-48d4-a813-c45671d887bb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/db69b9d1-4a16-48d4-a813-c45671d887bb


---
Response status code: 200 OK. Responded in 13.08081ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838062266811&afterId=94e5b32a-8fd5-4adc-aff6-25db1ce7ca94",
  "message": "Listening for UUID: 'db69b9d1-4a16-48d4-a813-c45671d887bb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 120.564432ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;db69b9d1-4a16-48d4-a813-c45671d887bb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/db69b9d1-4a16-48d4-a813-c45671d887bb


---
Response status code: 200 OK. Responded in 2335.480658ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "db69b9d1-4a16-48d4-a813-c45671d887bb",
  "modified": 637940838226102300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/db69b9d1-4a16-48d4-a813-c45671d887bb",
    "identifier": "db69b9d1-4a16-48d4-a813-c45671d887bb",
...
---
Response status code: 200 OK. Responded in 23.936242ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838226102218&afterId=db69b9d1-4a16-48d4-a813-c45671d887bb",
  "message": "Listening for UUID: 'db69b9d1-4a16-48d4-a813-c45671d887bb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb
...
---
Response status code: 201 Created. Responded in 2103.715788ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/db69b9d1-4a16-48d4-a813-c45671d887bb",
  "identifier": "db69b9d1-4a16-48d4-a813-c45671d887bb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 10.324981ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "db69b9d1-4a16-48d4-a813-c45671d887bb",
  "modified": 637940838251998700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 30.410333ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.946625ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.618919ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.252613ms.
```json
{
  "data": {
    "@context": [
