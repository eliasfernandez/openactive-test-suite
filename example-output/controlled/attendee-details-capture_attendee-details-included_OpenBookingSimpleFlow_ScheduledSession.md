...
---
Response status code: 200 OK. Responded in 43.779503ms.
```json
{
...
---
Response status code: 200 OK. Responded in 374.285742ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2459/events/20459",
  "modified": 1658486723466,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2459/events/20459",
    "startDate": "2022-07-23T10:45:22+00:00",
    "endDate": "2022-07-23T11:45:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3da4ac1b-bd5e-4238-b6b9-acf54210b73d
...
---
Response status code: 200 OK. Responded in 405.744831ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3da4ac1b-bd5e-4238-b6b9-acf54210b73d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2459%2Fevents%2F20459?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 130.751002ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2459/events/20459",
  "modified": 1658486724606,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3da4ac1b-bd5e-4238-b6b9-acf54210b73d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mathew_Marvin@yahoo.com",
    "telephone": "(247) 394-8330 x20740",
    "givenName": "Heidenreich",
    "familyName": "Carlo",
    "identifier": "c5fac6a7-68d2-401e-b3a6-399cddbec38f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 227.32779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 15.083438ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3da4ac1b-bd5e-4238-b6b9-acf54210b73d
...
---
Response status code: 201 Created. Responded in 347.858899ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3da4ac1b-bd5e-4238-b6b9-acf54210b73d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3da4ac1b-bd5e-4238-b6b9-acf54210b73d#/orderedItems/2359",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2459#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 7.566269ms.
```json
{
  "data": {
    "@context": [
