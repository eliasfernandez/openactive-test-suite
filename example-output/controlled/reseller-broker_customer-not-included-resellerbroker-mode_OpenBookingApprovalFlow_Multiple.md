...
---
Response status code: 200 OK. Responded in 148.357228ms.
```json
{
...
---
Response status code: 200 OK. Responded in 266.911088ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 135.429112ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 164.070668ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 659.079697ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2440/events/20440",
  "modified": 1658486683630,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 664.691747ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2441/events/20441",
  "modified": 1658486683636,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 137.247428ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2426/facility-use-slots/20426",
  "modified": 1658486683099,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 519.820751ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2427/facility-use-slots/20427",
  "modified": 1658486683484,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a102f82c-ad73-4c5a-8b61-fefb7f707156
...
---
Response status code: 200 OK. Responded in 646.356983ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a102f82c-ad73-4c5a-8b61-fefb7f707156",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:43+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2440%2Fevents%2F20440?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 154.846585ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2440/events/20440",
  "modified": 1658486685098,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2441%2Fevents%2F20441?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 154.988087ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2441/events/20441",
  "modified": 1658486685100,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2426%2Ffacility-use-slots%2F20426?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 307.318049ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2426/facility-use-slots/20426",
  "modified": 1658486685252,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2427%2Ffacility-use-slots%2F20427?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 317.204638ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2427/facility-use-slots/20427",
  "modified": 1658486685255,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a102f82c-ad73-4c5a-8b61-fefb7f707156
...
---
Response status code: 200 OK. Responded in 718.688931ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 67.434304ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 66.848198ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 66.289993ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 73.188455ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a102f82c-ad73-4c5a-8b61-fefb7f707156
...
---
Response status code: 201 Created. Responded in 620.964456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a102f82c-ad73-4c5a-8b61-fefb7f707156",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2232",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2440#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2233",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2440#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2234",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2441#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2235",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2426/facility-use-slots/20426#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2236",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2426/facility-use-slots/20426#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156#/orderedItems/2237",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2427/facility-use-slots/20427#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a102f82c-ad73-4c5a-8b61-fefb7f707156/versions/9a99f6e0-04ff-4ea8-8476-0ef1d4453c74",
  "payment": {
    "@type": "Payment",
    "identifier": "alDuf5MU_",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a102f82c-ad73-4c5a-8b61-fefb7f707156&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a102f82c-ad73-4c5a-8b61-fefb7f707156


---
Response status code: 200 OK. Responded in 21.696794ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834844887769&afterId=70489169-b0c0-4d64-84f9-822d50ef1805",
  "message": "Listening for UUID: 'a102f82c-ad73-4c5a-8b61-fefb7f707156' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 21.467793ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;a102f82c-ad73-4c5a-8b61-fefb7f707156&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a102f82c-ad73-4c5a-8b61-fefb7f707156


---
Response status code: 200 OK. Responded in 2182.57029ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a102f82c-ad73-4c5a-8b61-fefb7f707156",
  "modified": 637940834875071000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a102f82c-ad73-4c5a-8b61-fefb7f707156",
    "identifier": "a102f82c-ad73-4c5a-8b61-fefb7f707156",
...
---
Response status code: 200 OK. Responded in 3.918136ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156
...
---
Response status code: 201 Created. Responded in 1300.545373ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a102f82c-ad73-4c5a-8b61-fefb7f707156",
  "identifier": "a102f82c-ad73-4c5a-8b61-fefb7f707156",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 16.928944ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a102f82c-ad73-4c5a-8b61-fefb7f707156",
  "modified": 637940834898685600
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.042611ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.260804ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.648499ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.193796ms.
```json
{
  "data": {
    "@context": [
