...
---
Response status code: 200 OK. Responded in 74.081872ms.
```json
{
...
---
Response status code: 200 OK. Responded in 73.781369ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 93.006743ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 93.735249ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 927.186506ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2550/events/20550",
  "modified": 1658486940389,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2550/events/20550",
    "startDate": "2022-07-23T10:48:58+00:00",
    "endDate": "2022-07-23T11:48:58+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 926.765302ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2551/events/20551",
  "modified": 1658486940390,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1317.220743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2538/facility-use-slots/20538",
  "modified": 1658486940781,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1317.035041ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2539/facility-use-slots/20539",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/11bf75da-a145-47bd-ae1e-48167e7509ba
...
---
Response status code: 200 OK. Responded in 1078.624779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/11bf75da-a145-47bd-ae1e-48167e7509ba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:00+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2550%2Fevents%2F20550?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 385.459695ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2550/events/20550",
  "modified": 1658486943000,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2551%2Fevents%2F20551?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 384.976491ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2551/events/20551",
  "modified": 1658486943001,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2538%2Ffacility-use-slots%2F20538?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 304.223858ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2538/facility-use-slots/20538",
  "modified": 1658486942919,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2539%2Ffacility-use-slots%2F20539?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 303.861355ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2539/facility-use-slots/20539",
  "modified": 1658486942920,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/11bf75da-a145-47bd-ae1e-48167e7509ba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elza.Leuschke@yahoo.com",
    "telephone": "905.766.3400 x3932",
    "givenName": "Hills",
    "familyName": "Shaun",
    "identifier": "b718a8a4-8799-4997-bb3f-1d4aafdb3cbe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1684.3349779999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:03+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 31.593393ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.988088ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.489783ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.049978ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba
...
---
Response status code: 201 Created. Responded in 1007.459644ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/2995",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2550#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/2996",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2550#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/2997",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2551#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/2998",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2538/facility-use-slots/20538#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/2999",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2538/facility-use-slots/20538#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/11bf75da-a145-47bd-ae1e-48167e7509ba#/orderedItems/3000",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2539/facility-use-slots/20539#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 67.301124ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 66.718719ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 66.233814ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 66.193614ms.
```json
{
  "data": {
    "@context": [
