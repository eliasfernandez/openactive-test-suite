...
⚠️ 20 passed with 0 failures, 224 warnings and 74 suggestions 
...
---
Response status code: 200 OK. Responded in 14.47023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1224/events/12239"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1224%2Fevents%2F12239?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.391054ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1224/events/12239",
    "startDate": "2022-07-27T20:16:11+00:00",
    "endDate": "2022-07-27T21:08:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1224",
      "name": "Fresh Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1224#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/68f73610-26dc-47d5-9066-d462e8ebe4b1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1224#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1224/events/12239"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 84.107237ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1224%2Fevents%2F12239?useCacheIfAvailable=true&expectedCapacity=37


---
Response status code: 200 OK. Responded in 407.887982ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1224/events/12239",
  "modified": 1658486315185,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/68f73610-26dc-47d5-9066-d462e8ebe4b1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Loyce.Trantow@gmail.com",
    "telephone": "631.758.0024 x61975",
    "givenName": "Shields",
    "familyName": "Cielo",
    "identifier": "12b3cf2a-66b8-498f-8886-12bd1e479131"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 68.176586ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 35.583467ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/68f73610-26dc-47d5-9066-d462e8ebe4b1
...
---
Response status code: 201 Created. Responded in 193.770787ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/68f73610-26dc-47d5-9066-d462e8ebe4b1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68f73610-26dc-47d5-9066-d462e8ebe4b1#/orderedItems/996",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1224#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/68f73610-26dc-47d5-9066-d462e8ebe4b1/versions/2f9dfd99-3425-42ab-9f59-d53f0cc9caa7",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;68f73610-26dc-47d5-9066-d462e8ebe4b1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/68f73610-26dc-47d5-9066-d462e8ebe4b1


---
Response status code: 200 OK. Responded in 15.003739ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '68f73610-26dc-47d5-9066-d462e8ebe4b1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 22.034951ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;68f73610-26dc-47d5-9066-d462e8ebe4b1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/68f73610-26dc-47d5-9066-d462e8ebe4b1


---
Response status code: 200 OK. Responded in 2188.561867ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "modified": 637940831161962500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/68f73610-26dc-47d5-9066-d462e8ebe4b1",
    "identifier": "68f73610-26dc-47d5-9066-d462e8ebe4b1",
...
---
Response status code: 200 OK. Responded in 14.380829ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831161962528&afterId=68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "message": "Listening for UUID: '68f73610-26dc-47d5-9066-d462e8ebe4b1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/68f73610-26dc-47d5-9066-d462e8ebe4b1
...
---
Response status code: 201 Created. Responded in 65.92595ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "identifier": "68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 956.598741ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "modified": 637940831184553000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.545488ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;68f73610-26dc-47d5-9066-d462e8ebe4b1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/68f73610-26dc-47d5-9066-d462e8ebe4b1


---
Response status code: 200 OK. Responded in 41.43136ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '68f73610-26dc-47d5-9066-d462e8ebe4b1' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 88.906817ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;68f73610-26dc-47d5-9066-d462e8ebe4b1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/68f73610-26dc-47d5-9066-d462e8ebe4b1


---
Response status code: 200 OK. Responded in 2184.628123ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "68f73610-26dc-47d5-9066-d462e8ebe4b1",
  "modified": 637940831212453400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
