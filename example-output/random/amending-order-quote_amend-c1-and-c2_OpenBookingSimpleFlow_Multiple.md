...
⚠️ 100 passed with 0 failures, 1400 warnings and 376 suggestions 
...
---
Response status code: 200 OK. Responded in 27.463611ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/113/events/1125"
}
```
...
---
Response status code: 200 OK. Responded in 26.540594ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/706/events/7051"
}
```
...
---
Response status code: 200 OK. Responded in 13.562252ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4682"
}
```
...
---
Response status code: 200 OK. Responded in 13.034142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/756/facility-use-slots/7559"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F113%2Fevents%2F1125?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.475069ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/113/events/1125",
    "startDate": "2022-07-29T17:24:11+00:00",
    "endDate": "2022-07-29T23:06:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F706%2Fevents%2F7051?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.069762ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/706/events/7051",
    "startDate": "2022-07-22T16:59:11+00:00",
    "endDate": "2022-07-22T19:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/706",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/706#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F469%2Ffacility-use-slots%2F4682?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.701555ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/469",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4682#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT17H33M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-24T23:37:12+00:00",
    "endDate": "2022-07-25T03:53:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F756%2Ffacility-use-slots%2F7559?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.295573ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/756",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/756/facility-use-slots/7559#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT18H18M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-22T22:57:12+00:00",
    "endDate": "2022-07-23T01:23:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/df5b0d35-c49b-4cdb-9c17-a122f8440167
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/113/events/1125"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/706#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/706/events/7051"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4682#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4682"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/756/facility-use-slots/7559#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/756/facility-use-slots/7559"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 163.334527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/df5b0d35-c49b-4cdb-9c17-a122f8440167",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/469"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-24T23:37:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/756"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-22T22:57:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F113%2Fevents%2F1125?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 230.50147ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/113/events/1125",
  "modified": 1658485980395,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F706%2Fevents%2F7051?useCacheIfAvailable=true&expectedCapacity=45


---
Response status code: 200 OK. Responded in 232.936316ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/706/events/7051",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F469%2Ffacility-use-slots%2F4682?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 626.336205ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/469/facility-use-slots/4682",
  "modified": 1658485980792,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F756%2Ffacility-use-slots%2F7559?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 581.090266ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/756/facility-use-slots/7559",
  "modified": 1658485980795,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/df5b0d35-c49b-4cdb-9c17-a122f8440167
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jena_Bednar@yahoo.com",
    "telephone": "343.927.5806",
    "givenName": "Hand",
    "familyName": "Alisa",
    "identifier": "5286735d-ef37-43c7-9fc6-a9162396eb61"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 135.076402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:01+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 15.341584ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.945877ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.697973ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.470268ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 61.998048ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/19/events/182"
}
```
...
---
Response status code: 200 OK. Responded in 61.130933ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2068"
}
```
...
---
Response status code: 200 OK. Responded in 29.056638ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555"
}
```
...
---
Response status code: 200 OK. Responded in 18.929651ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F19%2Fevents%2F182?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.859861ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/19/events/182",
    "startDate": "2022-07-30T14:53:11+00:00",
    "endDate": "2022-07-30T19:57:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/19",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/19#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F207%2Fevents%2F2068?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.509054ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2068",
    "startDate": "2022-07-29T02:12:11+00:00",
    "endDate": "2022-07-29T05:31:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F456%2Ffacility-use-slots%2F4555?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.173048ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/456",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT20H24M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-26T07:29:12+00:00",
    "endDate": "2022-07-26T10:58:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F415%2Ffacility-use-slots%2F4148?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.908743ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/415",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 18.74,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT9H20M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-27T01:38:12+00:00",
    "endDate": "2022-07-27T06:34:12+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/19#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/19/events/182"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2068"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 127.059163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/415"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-27T01:38:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F19%2Fevents%2F182?useCacheIfAvailable=true&expectedCapacity=25


---
Response status code: 200 OK. Responded in 682.462895ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/19/events/182",
  "modified": 1658485988614,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F207%2Fevents%2F2068?useCacheIfAvailable=true&expectedCapacity=42


---
Response status code: 200 OK. Responded in 682.301792ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/207/events/2068",
  "modified": 1658485988615,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F456%2Ffacility-use-slots%2F4555?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 516.330004ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555",
  "modified": 1658485988448,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F415%2Ffacility-use-slots%2F4148?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 518.431344ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148",
  "modified": 1658485988450,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 77.538643ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 30.769872ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 30.241363ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.812155ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.473948ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167
...
---
Response status code: 201 Created. Responded in 142.842857ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/117",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/19#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/118",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/19#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/119",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/207#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/120",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/121",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/456/facility-use-slots/4555#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df5b0d35-c49b-4cdb-9c17-a122f8440167#/orderedItems/122",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/415/facility-use-slots/4148#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 24.569454ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.031744ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.596035ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.243429ms.
```json
{
  "data": {
    "@context": [
