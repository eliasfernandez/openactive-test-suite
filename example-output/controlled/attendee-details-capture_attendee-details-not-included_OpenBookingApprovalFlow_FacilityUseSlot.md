...
---
Response status code: 200 OK. Responded in 26.645406ms.
```json
{
...
---
Response status code: 200 OK. Responded in 524.699166ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2171/facility-use-slots/20171",
  "modified": 1658486201032,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:36:39+00:00",
    "endDate": "2022-07-23T11:36:39+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3f33e928-b3b1-402f-b2f3-752b7d71c069
...
---
Response status code: 200 OK. Responded in 51.287297ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3f33e928-b3b1-402f-b2f3-752b7d71c069",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:40+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2171%2Ffacility-use-slots%2F20171?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 475.819587ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2171/facility-use-slots/20171",
  "modified": 1658486201674,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3f33e928-b3b1-402f-b2f3-752b7d71c069
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Trinity_Schroeder52@hotmail.com",
    "telephone": "563.477.4984",
    "givenName": "Larson",
    "familyName": "Efrain",
    "identifier": "74e3ac47-492e-4ca7-8d6e-97524d21b78d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 51.787801ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3f33e928-b3b1-402f-b2f3-752b7d71c069
...
---
Response status code: 409 Conflict. Responded in 255.47818ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3f33e928-b3b1-402f-b2f3-752b7d71c069",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
