...
⚠️ 40 passed with 0 failures, 519 warnings and 138 suggestions 
...
---
Response status code: 200 OK. Responded in 240.322445ms.
```json
{
...
---
Response status code: 200 OK. Responded in 234.426004ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 203.225891ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 202.660187ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 683.139076ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2083/events/20083",
  "modified": 1658486091584,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 674.848219ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2082/events/20082",
  "modified": 1658486091576,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 588.234525ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2079/facility-use-slots/20079",
  "modified": 1658486091490,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 593.36456ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2080/facility-use-slots/20080",
  "modified": 1658486091496,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/91d2fea1-1d71-458e-bb3a-a4d971ab7241
...
---
Response status code: 409 Conflict. Responded in 34.882838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/91d2fea1-1d71-458e-bb3a-a4d971ab7241",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/91d2fea1-1d71-458e-bb3a-a4d971ab7241
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bartholome33@hotmail.com",
    "telephone": "926-911-4889",
    "givenName": "Moore",
    "familyName": "Frederick",
    "identifier": "9674f5ed-b072-4229-a79b-dcba9d4808e9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 43.000394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
