...
---
Response status code: 200 OK. Responded in 214.871617ms.
```json
{
...
---
Response status code: 200 OK. Responded in 333.372965ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2243/events/20243",
  "modified": 1658486290260,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2243/events/20243",
    "startDate": "2022-07-23T10:38:08+00:00",
    "endDate": "2022-07-23T11:38:08+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e2c2b6a9-2773-443e-9afa-047a1a8e888f
...
---
Response status code: 200 OK. Responded in 76.37321ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e2c2b6a9-2773-443e-9afa-047a1a8e888f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2243%2Fevents%2F20243?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 847.839177ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2243/events/20243",
  "modified": 1658486291398,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e2c2b6a9-2773-443e-9afa-047a1a8e888f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Columbus96@gmail.com",
    "telephone": "1-492-465-6055 x726",
    "givenName": "Gleichner",
    "familyName": "Earline",
    "identifier": "5d6d4895-a5b1-478a-b1ad-8bc52037f935"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 106.945555ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:10+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 4.413535ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e2c2b6a9-2773-443e-9afa-047a1a8e888f
...
---
Response status code: 201 Created. Responded in 95.340562ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e2c2b6a9-2773-443e-9afa-047a1a8e888f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e2c2b6a9-2773-443e-9afa-047a1a8e888f#/orderedItems/1049",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2243#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.00832ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f7fdbe11-0945-4697-bd13-4df4630468dd
...
---
Response status code: 500 Internal Server Error. Responded in 30.333043ms.
```json
{
  "@context": "https://openactive.io/",
