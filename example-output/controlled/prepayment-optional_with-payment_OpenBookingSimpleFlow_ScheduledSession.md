...
---
Response status code: 200 OK. Responded in 549.446321ms.
```json
{
...
---
Response status code: 200 OK. Responded in 557.273893ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2538/events/20538",
  "modified": 1658486905737,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2538/events/20538",
    "startDate": "2022-07-23T10:48:23+00:00",
    "endDate": "2022-07-23T11:48:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12
...
---
Response status code: 200 OK. Responded in 488.768967ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2538%2Fevents%2F20538?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 161.101473ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2538/events/20538",
  "modified": 1658486906844,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ian_Rosenbaum@yahoo.com",
    "telephone": "323-994-4833 x23656",
    "givenName": "Strosin",
    "familyName": "Desmond",
    "identifier": "061751d9-f45b-4664-8cbc-e98cb97ecfc8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1086.4381290000001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:26+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.058793ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12
...
---
Response status code: 201 Created. Responded in 268.048649ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1771c50-99cb-4c3a-beb0-1aff9fc4ee12#/orderedItems/2898",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2538#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 5.099947ms.
```json
{
  "data": {
    "@context": [
