...
---
Response status code: 200 OK. Responded in 13.776111ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1465.905288ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2243/facility-use-slots/20243",
  "modified": 1658486303071,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-21T10:38:20+00:00",
    "endDate": "2022-07-21T11:38:20+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e22f8490-e431-46f4-a14d-84b52da0b5bd
...
---
Response status code: 409 Conflict. Responded in 30.499445ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e22f8490-e431-46f4-a14d-84b52da0b5bd",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e22f8490-e431-46f4-a14d-84b52da0b5bd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alvena.Rowe@gmail.com",
    "telephone": "(975) 604-8987 x62793",
    "givenName": "Koch",
    "familyName": "Myron",
    "identifier": "5a08926c-f2fb-4ec8-b2c0-adc6c7586557"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 50.441306ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e22f8490-e431-46f4-a14d-84b52da0b5bd
...
---
Response status code: 409 Conflict. Responded in 27.731623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e22f8490-e431-46f4-a14d-84b52da0b5bd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
