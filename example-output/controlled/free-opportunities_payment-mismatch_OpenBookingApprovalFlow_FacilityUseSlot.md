...
---
Response status code: 200 OK. Responded in 584.307528ms.
```json
{
...
---
Response status code: 200 OK. Responded in 577.197964ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430",
  "modified": 1658486687829,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:44:45+00:00",
    "endDate": "2022-07-23T11:44:45+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/70ae3f61-c0fc-4bcd-badd-b374932d25fb
...
---
Response status code: 200 OK. Responded in 427.087023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/70ae3f61-c0fc-4bcd-badd-b374932d25fb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2430%2Ffacility-use-slots%2F20430?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 915.487918ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430",
  "modified": 1658486689327,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/70ae3f61-c0fc-4bcd-badd-b374932d25fb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Electa93@yahoo.com",
    "telephone": "(813) 968-1071 x0235",
    "givenName": "Abshire",
    "familyName": "Doug",
    "identifier": "9b8197e2-f4ff-416a-9aef-c6dfea4780db"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 243.868989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.077145ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/70ae3f61-c0fc-4bcd-badd-b374932d25fb
...
---
Response status code: 400 Bad Request. Responded in 238.521841ms.
```json
{
  "@context": "https://openactive.io/",
