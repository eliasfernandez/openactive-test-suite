...
---
Response status code: 200 OK. Responded in 86.218975ms.
```json
{
...
---
Response status code: 200 OK. Responded in 575.178767ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2480/events/20480",
  "modified": 1658486784196,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e758e389-114b-485a-8925-cf8267dd4b85
...
---
Response status code: 200 OK. Responded in 428.507191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e758e389-114b-485a-8925-cf8267dd4b85",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:23+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2480%2Fevents%2F20480?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 599.930447ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2480/events/20480",
  "modified": 1658486785654,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e758e389-114b-485a-8925-cf8267dd4b85
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Samson13@yahoo.com",
    "telephone": "387.396.0652 x305",
    "givenName": "Predovic",
    "familyName": "Ricardo",
    "identifier": "645a7956-b8b5-4d9f-8ff3-da31dc7d145f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 296.639193ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.383412ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e758e389-114b-485a-8925-cf8267dd4b85
...
---
Response status code: 201 Created. Responded in 545.491353ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e758e389-114b-485a-8925-cf8267dd4b85",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e758e389-114b-485a-8925-cf8267dd4b85#/orderedItems/2560",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2480#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 14.076128ms.
```json
{
  "data": {
    "@context": [
