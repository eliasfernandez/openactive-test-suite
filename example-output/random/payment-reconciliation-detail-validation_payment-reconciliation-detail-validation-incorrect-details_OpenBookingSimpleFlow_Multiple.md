...
⚠️ 26 passed with 0 failures, 362 warnings and 96 suggestions 
...
---
Response status code: 200 OK. Responded in 12.576902ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/825/events/8242"
}
```
...
---
Response status code: 200 OK. Responded in 12.656404ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/851"
}
```
...
---
Response status code: 200 OK. Responded in 12.525601ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/53/facility-use-slots/522"
}
```
...
---
Response status code: 200 OK. Responded in 12.644203ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/440/facility-use-slots/4397"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F825%2Fevents%2F8242?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.263954ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/825/events/8242",
    "startDate": "2022-07-23T10:48:11+00:00",
    "endDate": "2022-07-23T15:17:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/825",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/825#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 9.43,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT13H7M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F86%2Fevents%2F851?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.876948ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/851",
    "startDate": "2022-07-30T15:45:11+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F53%2Ffacility-use-slots%2F522?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.475442ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/53/facility-use-slots/522#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 1.11,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 5,
    "startDate": "2022-07-27T08:52:11+00:00",
    "endDate": "2022-07-27T11:44:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F440%2Ffacility-use-slots%2F4397?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.069035ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/440/facility-use-slots/4397#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 8.64,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT5H44M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-25T00:12:12+00:00",
    "endDate": "2022-07-25T02:49:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ddac934e-1b8f-4a86-b9f4-cccf10b8e6cc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/825#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/825/events/8242"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/851"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/53/facility-use-slots/522#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/53/facility-use-slots/522"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/440/facility-use-slots/4397#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/440/facility-use-slots/4397"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-w1bm4TjYwi",
    "accountId": "invalid-CjU-3ys-j",
    "paymentProviderId": "invalid-oXOkK2LVCJ"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 489.998873ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ddac934e-1b8f-4a86-b9f4-cccf10b8e6cc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jeromy98@hotmail.com",
    "telephone": "1-664-741-0971 x63580",
    "givenName": "Tromp",
    "familyName": "Aliyah",
    "identifier": "d3b2d714-729d-42ca-80b1-c4e1af6ffbdd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-siut_rrJeo",
    "accountId": "invalid-OeIeNU7j5",
    "paymentProviderId": "invalid-fh-Hg4jGot"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 120.420935ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
