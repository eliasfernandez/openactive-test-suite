[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:52:36 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 817 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 19.243016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1438/events/14380"
}
```
...
---
Response status code: 200 OK. Responded in 18.2955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1316/events/13153"
}
```
...
---
Response status code: 200 OK. Responded in 17.376486ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321"
}
```
...
---
Response status code: 200 OK. Responded in 16.522571ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1438%2Fevents%2F14380?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.299553ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1438/events/14380",
    "startDate": "2022-08-01T03:20:11+00:00",
    "endDate": "2022-08-01T08:39:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1438",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1438#/offers/0",
          ...
          "price": 9.68,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT17H56M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1316%2Fevents%2F13153?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.867662ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1316/events/13153",
    "startDate": "2022-07-28T15:08:11+00:00",
    "endDate": "2022-07-28T17:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1433%2Ffacility-use-slots%2F14321?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.606158ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 18.7,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT17H59M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-30T20:11:12+00:00",
    "endDate": "2022-07-30T23:54:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1018%2Ffacility-use-slots%2F10180?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.238951ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2022-07-30T08:54:12+00:00",
    "endDate": "2022-07-30T12:43:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7e6c5c3d-5e4f-4b80-bf69-6f01075625da
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1438#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1438/events/14380"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1316/events/13153"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 775.426832ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:58:12+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1438%2Fevents%2F14380?useCacheIfAvailable=true&expectedCapacity=37


---
Response status code: 200 OK. Responded in 588.510663ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1438/events/14380",
  "modified": 1658487194854,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1316%2Fevents%2F13153?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 589.093973ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1316/events/13153",
  "modified": 1658487194857,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1433%2Ffacility-use-slots%2F14321?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 446.349829ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321",
  "modified": 1658487194714,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1018%2Ffacility-use-slots%2F10180?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 447.140243ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180",
  "modified": 1658487194716,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7e6c5c3d-5e4f-4b80-bf69-6f01075625da
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ashtyn.Adams@yahoo.com",
    "telephone": "862.528.6230",
    "givenName": "Volkman",
    "familyName": "Rachel",
    "identifier": "ec64f397-abba-4665-9814-66665224e9d6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 760.237283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:58:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 11.906196ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.885879ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.640175ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.907479ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7e6c5c3d-5e4f-4b80-bf69-6f01075625da
...
---
Response status code: 201 Created. Responded in 697.070037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3239",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1438#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3240",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1438#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3241",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1316#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3242",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3243",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1433/facility-use-slots/14321#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da#/orderedItems/3244",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10180#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/7e6c5c3d-5e4f-4b80-bf69-6f01075625da/versions/4c33805f-da31-4bbd-bd36-1a1be7a6b11b",
  "payment": {
    "@type": "Payment",
    "identifier": "DV6HqeQni",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;7e6c5c3d-5e4f-4b80-bf69-6f01075625da&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/7e6c5c3d-5e4f-4b80-bf69-6f01075625da


---
Response status code: 200 OK. Responded in 4.634474ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839897381865&afterId=0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "message": "Listening for UUID: '7e6c5c3d-5e4f-4b80-bf69-6f01075625da' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 10.631569ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;7e6c5c3d-5e4f-4b80-bf69-6f01075625da&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/7e6c5c3d-5e4f-4b80-bf69-6f01075625da


---
Response status code: 200 OK. Responded in 2027.748599ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "modified": 637940839969575700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
    "identifier": "7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
...
---
Response status code: 200 OK. Responded in 5.02538ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839969575738&afterId=7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "message": "Listening for UUID: '7e6c5c3d-5e4f-4b80-bf69-6f01075625da' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da
...
---
Response status code: 201 Created. Responded in 413.947514ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "identifier": "7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 7.853526ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "7e6c5c3d-5e4f-4b80-bf69-6f01075625da",
  "modified": 637940839990637400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 22.901666ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.186971ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.032168ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.865665ms.
```json
{
  "data": {
    "@context": [
