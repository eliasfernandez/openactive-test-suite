[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:46:08 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 29.917772ms.
```json
{
...
---
Response status code: 200 OK. Responded in 76.681497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 808.37204ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2481/events/20481",
  "modified": 1658486789489,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2481/events/20481",
    "startDate": "2022-07-23T10:46:27+00:00",
    "endDate": "2022-07-23T11:46:27+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 743.584652ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2467/facility-use-slots/20467",
  "modified": 1658486789425,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/991ec47a-249a-4ec3-b979-1d82c6693a4d
...
---
Response status code: 200 OK. Responded in 587.398434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/991ec47a-249a-4ec3-b979-1d82c6693a4d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2481%2Fevents%2F20481?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 263.946296ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2481/events/20481",
  "modified": 1658486790832,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2467%2Ffacility-use-slots%2F20467?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 939.282329ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2467/facility-use-slots/20467",
  "modified": 1658486791508,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/991ec47a-249a-4ec3-b979-1d82c6693a4d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aliyah.Braun@gmail.com",
    "telephone": "640-992-4571",
    "givenName": "Dare",
    "familyName": "Nichole",
    "identifier": "40508a49-48aa-443f-ac24-3cf24f01de72"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 661.084503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:30+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 10.160392ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.613786ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/991ec47a-249a-4ec3-b979-1d82c6693a4d
...
---
Response status code: 400 Bad Request. Responded in 571.598447ms.
```json
{
  "@context": "https://openactive.io/",
