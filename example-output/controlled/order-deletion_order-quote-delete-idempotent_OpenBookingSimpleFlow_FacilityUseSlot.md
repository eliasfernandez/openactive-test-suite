...
---
Response status code: 200 OK. Responded in 17.258375ms.
```json
{
...
---
Response status code: 200 OK. Responded in 917.764532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399",
  "modified": 1658486626258,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:43:44+00:00",
    "endDate": "2022-07-23T11:43:44+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3c182295-d2c0-4724-82b0-ff4f190a4b07
...
---
Response status code: 200 OK. Responded in 197.67751ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3c182295-d2c0-4724-82b0-ff4f190a4b07",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2399%2Ffacility-use-slots%2F20399?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 985.514321ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399",
  "modified": 1658486627639,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3c182295-d2c0-4724-82b0-ff4f190a4b07
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Deon92@yahoo.com",
    "telephone": "1-551-874-4141",
    "givenName": "Veum",
    "familyName": "Meredith",
    "identifier": "2154a303-9940-4d3b-b370-ed06fcf90baa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 446.62288ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.387339ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/3c182295-d2c0-4724-82b0-ff4f190a4b07
...
---
Response status code: 204 No Content. Responded in 375.051802ms.
...
---
Response status code: 204 No Content. Responded in 10.699894ms.
### Specs
