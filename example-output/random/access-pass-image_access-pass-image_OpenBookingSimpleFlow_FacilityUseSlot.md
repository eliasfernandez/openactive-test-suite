...
---
Response status code: 200 OK. Responded in 6.008691ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F8%2Ffacility-use-slots%2F79?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.523389ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/8",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2022-07-25T16:29:11+00:00",
    "endDate": "2022-07-25T21:18:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 168.448236ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:05+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F8%2Ffacility-use-slots%2F79?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 971.648723ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79",
  "modified": 1658486528109,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaunita.Cummerata26@hotmail.com",
    "telephone": "567-328-5980",
    "givenName": "Brakus",
    "familyName": "Miller",
    "identifier": "be69f14b-4636-4ecf-bf45-e37b66061997"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 199.015195ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:07+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.853349ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6
...
---
Response status code: 201 Created. Responded in 529.044662ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c14efb80-fa22-46bb-9cc2-6f6ebdd4cca6#/orderedItems/1595",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/8/facility-use-slots/79#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 40.409308ms.
```json
{
  "data": {
    "@context": [
