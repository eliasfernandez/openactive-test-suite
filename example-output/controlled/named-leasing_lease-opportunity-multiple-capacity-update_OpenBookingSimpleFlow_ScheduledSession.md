[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:13 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 295.309342ms.
```json
{
...
---
Response status code: 200 OK. Responded in 577.368364ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457",
  "modified": 1658486716285,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457",
    "startDate": "2022-07-23T10:45:14+00:00",
    "endDate": "2022-07-23T11:45:14+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4f171cd7-9b6c-42e7-b030-4c89fdd38fda
...
---
Response status code: 200 OK. Responded in 406.001431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4f171cd7-9b6c-42e7-b030-4c89fdd38fda",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4f171cd7-9b6c-42e7-b030-4c89fdd38fda
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Allen.West@hotmail.com",
    "telephone": "552.244.6906 x6719",
    "givenName": "Hills",
    "familyName": "Idell",
    "identifier": "ca992ebe-813d-4e5f-8ffb-4a38b93d0397"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 645.605075ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2457%2Fevents%2F20457?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 24.717621ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 365.941573ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5f6f56a1-8c29-42a8-abe4-d907c0ef3a3d
...
---
Response status code: 409 Conflict. Responded in 1654.050317ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5f6f56a1-8c29-42a8-abe4-d907c0ef3a3d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5f6f56a1-8c29-42a8-abe4-d907c0ef3a3d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Moriah26@gmail.com",
    "telephone": "901-439-0487 x069",
    "givenName": "Marvin",
    "familyName": "Gabe",
    "identifier": "ba176901-7161-4e77-8409-25f40307f0e9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 296.307225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.437177ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d0822f16-e352-444f-9357-2fd5510fa853
...
---
Response status code: 200 OK. Responded in 455.288187ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d0822f16-e352-444f-9357-2fd5510fa853",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d0822f16-e352-444f-9357-2fd5510fa853
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Skye47@yahoo.com",
    "telephone": "(735) 242-1183",
    "givenName": "Lang",
    "familyName": "Vernie",
    "identifier": "bd414af4-e0ee-4bed-90ac-1633f39db2b8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 677.556631ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2457%2Fevents%2F20457?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 29.920275ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b51e6d11-eb55-41ee-be8a-d1d17bad8bfe
...
---
Response status code: 409 Conflict. Responded in 340.33443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b51e6d11-eb55-41ee-be8a-d1d17bad8bfe",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b51e6d11-eb55-41ee-be8a-d1d17bad8bfe
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Horacio.Rice@yahoo.com",
    "telephone": "436.705.1111 x23008",
    "givenName": "O'Connell",
    "familyName": "Walker",
    "identifier": "1b150c17-af0f-4409-b816-f5cb5ecf1367"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 238.790996ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.44055ms.
```json
{
  "data": {
    "@context": [
