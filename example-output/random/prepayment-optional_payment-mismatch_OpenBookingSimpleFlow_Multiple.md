...
---
Response status code: 200 OK. Responded in 27.979441ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4016"
}
```
...
---
Response status code: 200 OK. Responded in 22.192229ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/884"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F402%2Fevents%2F4016?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.895387ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4016",
    "startDate": "2022-07-31T12:37:11+00:00",
    "endDate": "2022-07-31T17:10:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F89%2Ffacility-use-slots%2F884?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 45.387977ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/884#/offers/0",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-29T10:20:11+00:00",
    "endDate": "2022-07-29T12:11:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/631fac3a-f5b2-4c34-b18d-628c1185c6c2
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4016"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/884#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/884"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 613.309452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/631fac3a-f5b2-4c34-b18d-628c1185c6c2",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F402%2Fevents%2F4016?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 87.687295ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4016",
  "modified": 1658486937687,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F89%2Ffacility-use-slots%2F884?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 838.309601ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/884",
  "modified": 1658486938444,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/631fac3a-f5b2-4c34-b18d-628c1185c6c2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Doris.Swift23@gmail.com",
    "telephone": "(457) 683-1513 x20791",
    "givenName": "Rutherford",
    "familyName": "Constantin",
    "identifier": "4f7b9343-30bf-4443-9488-9ee852a49d52"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1097.137903ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:58+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 15.716904ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 15.122092ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/631fac3a-f5b2-4c34-b18d-628c1185c6c2
...
---
Response status code: 400 Bad Request. Responded in 1906.258363ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (18.51) does not match expected value (17.51)"
}
```
### Specs
