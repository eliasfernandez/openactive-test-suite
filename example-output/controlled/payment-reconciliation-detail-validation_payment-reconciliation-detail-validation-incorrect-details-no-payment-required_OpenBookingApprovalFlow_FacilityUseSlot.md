...
---
Response status code: 200 OK. Responded in 25.921836ms.
```json
{
...
---
Response status code: 200 OK. Responded in 663.024146ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2553/facility-use-slots/20553",
  "modified": 1658486963565,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/afabfc2d-e072-4944-b00e-59509722f6e4
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-P-vCsvDxXP",
    "accountId": "invalid-giXiXUvWp",
    "paymentProviderId": "invalid-hBwAr__5wV"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 46.441424ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/afabfc2d-e072-4944-b00e-59509722f6e4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hester_McLaughlin58@hotmail.com",
    "telephone": "276-954-2146 x91965",
    "givenName": "Stamm",
    "familyName": "Joany",
    "identifier": "8fc7d9e3-fe32-4005-80b4-9e6c468338ad"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-UNtK2zvpeW",
    "accountId": "invalid-XKxzhk064p",
    "paymentProviderId": "invalid-tygfssHrPn"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 231.452411ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
