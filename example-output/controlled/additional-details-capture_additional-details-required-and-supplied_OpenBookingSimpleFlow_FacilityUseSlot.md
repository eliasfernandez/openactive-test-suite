...
---
Response status code: 200 OK. Responded in 12.318211ms.
```json
{
...
---
Response status code: 200 OK. Responded in 770.457968ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498",
  "modified": 1658486857613,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:35+00:00",
    "endDate": "2022-07-23T11:47:35+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/052d4540-ce40-4cc2-ae3b-4a486a4f04a0
...
---
Response status code: 200 OK. Responded in 755.327531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/052d4540-ce40-4cc2-ae3b-4a486a4f04a0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2498%2Ffacility-use-slots%2F20498?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 982.295483ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498",
  "modified": 1658486859604,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/052d4540-ce40-4cc2-ae3b-4a486a4f04a0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Geraldine79@yahoo.com",
    "telephone": "909.432.3022 x3377",
    "givenName": "Lesch",
    "familyName": "Kane",
    "identifier": "f19655ed-4353-4887-9aba-f2522befbc54"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1013.074962ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 24.992526ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/052d4540-ce40-4cc2-ae3b-4a486a4f04a0
...
---
Response status code: 201 Created. Responded in 285.31358ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/052d4540-ce40-4cc2-ae3b-4a486a4f04a0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/052d4540-ce40-4cc2-ae3b-4a486a4f04a0#/orderedItems/2744",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 5.201247ms.
```json
{
  "data": {
    "@context": [
