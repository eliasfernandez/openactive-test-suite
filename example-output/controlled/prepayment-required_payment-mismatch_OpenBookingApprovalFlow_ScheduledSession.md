...
---
Response status code: 200 OK. Responded in 271.788284ms.
```json
{
...
---
Response status code: 200 OK. Responded in 518.390396ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
  "modified": 1658486752692,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
    "startDate": "2022-07-23T10:45:50+00:00",
    "endDate": "2022-07-23T11:45:50+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/062fc828-aff6-4f6d-a015-3257e585139f
...
---
Response status code: 200 OK. Responded in 188.552889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/062fc828-aff6-4f6d-a015-3257e585139f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2469%2Fevents%2F20469?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 464.590161ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
  "modified": 1658486753595,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/062fc828-aff6-4f6d-a015-3257e585139f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Beau15@hotmail.com",
    "telephone": "928.778.9049",
    "givenName": "Farrell",
    "familyName": "Wilfredo",
    "identifier": "365ba2f6-6847-4aaa-8cd8-f15a0d8defe2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 345.826597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 16.375746ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/062fc828-aff6-4f6d-a015-3257e585139f
...
---
Response status code: 400 Bad Request. Responded in 450.936238ms.
```json
{
  "@context": "https://openactive.io/",
