...
---
Response status code: 200 OK. Responded in 109.979482ms.
```json
{
...
---
Response status code: 200 OK. Responded in 963.784937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2214/events/20214",
  "modified": 1658486244339,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d
...
---
Response status code: 200 OK. Responded in 201.072514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2214%2Fevents%2F20214?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 362.375408ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2214/events/20214",
  "modified": 1658486245169,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Colt88@gmail.com",
    "telephone": "(982) 760-5784 x860",
    "givenName": "Rogahn",
    "familyName": "Samanta",
    "identifier": "b7da35f2-a032-4c0d-9a09-695be9409d3d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 67.785444ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:24+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 38.023005ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d
...
---
Response status code: 201 Created. Responded in 41.147431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d#/orderedItems/927",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2214#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d/versions/54363fb9-b345-4242-a4b6-71816560c245",
  "payment": {
    "@type": "Payment",
    "identifier": "7APwtzx4l",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;70654ae7-d97a-4d91-8c5c-ca6b467c0b3d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d


---
Response status code: 200 OK. Responded in 3.921632ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830112358073&afterId=830080bf-dc43-4b99-a56f-432bb0d51558",
  "message": "Listening for UUID: '70654ae7-d97a-4d91-8c5c-ca6b467c0b3d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.895703ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;70654ae7-d97a-4d91-8c5c-ca6b467c0b3d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d


---
Response status code: 200 OK. Responded in 2061.684748ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "modified": 637940830447365100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
    "identifier": "70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
...
---
Response status code: 200 OK. Responded in 47.833682ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830447365125&afterId=70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "message": "Listening for UUID: '70654ae7-d97a-4d91-8c5c-ca6b467c0b3d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d
...
---
Response status code: 201 Created. Responded in 56.011547ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "identifier": "70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1110.5501610000001ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "modified": 637940830469135700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 5.407343ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;70654ae7-d97a-4d91-8c5c-ca6b467c0b3d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d


---
Response status code: 200 OK. Responded in 26.524111ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '70654ae7-d97a-4d91-8c5c-ca6b467c0b3d' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 20.272062ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessCodeUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;70654ae7-d97a-4d91-8c5c-ca6b467c0b3d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/70654ae7-d97a-4d91-8c5c-ca6b467c0b3d


---
Response status code: 200 OK. Responded in 2329.077786ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "70654ae7-d97a-4d91-8c5c-ca6b467c0b3d",
  "modified": 637940830495558700,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
