...
⚠️ 16 passed with 0 failures, 163 warnings and 58 suggestions 
...
---
Response status code: 200 OK. Responded in 45.618363ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/237/events/2362"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F237%2Fevents%2F2362?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.598722ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/237/events/2362",
    "startDate": "2022-07-29T04:56:11+00:00",
    "endDate": "2022-07-29T06:26:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/237/events/2362"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 252.419236ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:47+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F237%2Fevents%2F2362?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 366.023032ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/237/events/2362",
  "modified": 1658486688925,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Keely.Langosh48@gmail.com",
    "telephone": "1-385-823-1617 x0909",
    "givenName": "Berge",
    "familyName": "Noelia",
    "identifier": "3711c6f7-488d-48c3-810c-401cea876741"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 463.22071ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.141931ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56
...
---
Response status code: 201 Created. Responded in 284.234546ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56#/orderedItems/1999",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/237#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 4.248712ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/orders/df8345f1-4aa1-49fb-88eb-4b1d68ca0c56
...
---
Response status code: 204 No Content. Responded in 310.231932ms.
...
---
Response status code: 204 No Content. Responded in 15.886616ms.
### Specs
