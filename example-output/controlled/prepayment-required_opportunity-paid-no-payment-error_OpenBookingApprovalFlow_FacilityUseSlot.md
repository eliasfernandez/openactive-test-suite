...
---
Response status code: 200 OK. Responded in 38.239245ms.
```json
{
...
---
Response status code: 200 OK. Responded in 705.510567ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489",
  "modified": 1658486833665,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:11+00:00",
    "endDate": "2022-07-23T11:47:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b5c166f0-3783-4ef3-8f4b-a8a8683760d2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 337.608846ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b5c166f0-3783-4ef3-8f4b-a8a8683760d2",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2489%2Ffacility-use-slots%2F20489?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 962.607286ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489",
  "modified": 1658486835117,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b5c166f0-3783-4ef3-8f4b-a8a8683760d2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Enrico_Borer@yahoo.com",
    "telephone": "847.550.3234 x20945",
    "givenName": "Wiza",
    "familyName": "Mohamed",
    "identifier": "f3f58f40-9f62-4e99-b16d-90d35b010d83"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 382.749553ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.514795ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b5c166f0-3783-4ef3-8f4b-a8a8683760d2
...
---
Response status code: 400 Bad Request. Responded in 828.758378ms.
```json
{
  "@context": "https://openactive.io/",
