...
---
Response status code: 200 OK. Responded in 804.727244ms.
```json
{
...
---
Response status code: 200 OK. Responded in 774.311802ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2600/events/20600",
  "modified": 1658487026298,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2600/events/20600",
    "startDate": "2022-07-23T10:50:23+00:00",
    "endDate": "2022-07-23T11:50:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/eadb3800-1d6b-4c96-8048-4ba06d793d09
...
---
Response status code: 200 OK. Responded in 1932.591578ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/eadb3800-1d6b-4c96-8048-4ba06d793d09",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:27+00:00"
  },
...
---
Response status code: 200 OK. Responded in 832.778569ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2600/events/20600",
  "modified": 1658487029624,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/eadb3800-1d6b-4c96-8048-4ba06d793d09
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dena_Legros@yahoo.com",
    "telephone": "1-614-995-7345 x0737",
    "givenName": "Ruecker",
    "familyName": "Carmela",
    "identifier": "f55975e5-eecc-47de-837f-67cc8b7e8111"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 446.707878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:28+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 43.302547ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/eadb3800-1d6b-4c96-8048-4ba06d793d09
...
---
Response status code: 201 Created. Responded in 256.72413ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/eadb3800-1d6b-4c96-8048-4ba06d793d09",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/eadb3800-1d6b-4c96-8048-4ba06d793d09#/orderedItems/3181",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2600#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.870144ms.
```json
{
  "data": {
    "@context": [
