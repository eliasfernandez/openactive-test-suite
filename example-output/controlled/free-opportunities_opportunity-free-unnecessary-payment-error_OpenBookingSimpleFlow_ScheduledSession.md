...
---
Response status code: 200 OK. Responded in 76.489386ms.
```json
{
...
---
Response status code: 200 OK. Responded in 853.04279ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445",
  "modified": 1658486696651,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445",
    "startDate": "2022-07-23T10:44:54+00:00",
    "endDate": "2022-07-23T11:44:54+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b50b893e-2230-4d84-9207-e87d6a466df7
...
---
Response status code: 200 OK. Responded in 325.311568ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b50b893e-2230-4d84-9207-e87d6a466df7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:55+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2445%2Fevents%2F20445?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 367.470727ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445",
  "modified": 1658486697756,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b50b893e-2230-4d84-9207-e87d6a466df7
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "292-301-8984 x8461",
    "givenName": "Lindgren",
    "familyName": "Jerald",
    "identifier": "83703913-81ee-44ce-98ca-5f3930ad7d7f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 328.338293ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.454406ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b50b893e-2230-4d84-9207-e87d6a466df7
...
---
Response status code: 400 Bad Request. Responded in 383.12496ms.
```json
{
  "@context": "https://openactive.io/",
