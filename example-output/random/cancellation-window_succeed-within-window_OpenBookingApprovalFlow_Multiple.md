[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:41:08 GMT+0000 (Coordinated Universal Time)
...
⚠️ 59 passed with 0 failures, 987 warnings and 266 suggestions 
...
---
Response status code: 200 OK. Responded in 29.193446ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1239/events/12390"
}
```
...
---
Response status code: 200 OK. Responded in 28.195231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12540"
}
```
...
---
Response status code: 200 OK. Responded in 27.204916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467"
}
```
...
---
Response status code: 200 OK. Responded in 26.393103ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1239%2Fevents%2F12390?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.042406ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1239/events/12390",
    "startDate": "2022-08-01T08:44:11+00:00",
    "endDate": "2022-08-01T14:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1239",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1239#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1254%2Fevents%2F12540?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.514698ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12540",
    "startDate": "2022-07-29T12:10:11+00:00",
    "endDate": "2022-07-29T17:13:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1447%2Ffacility-use-slots%2F14467?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.149493ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 19.16,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT2H56M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-25T18:25:12+00:00",
    "endDate": "2022-07-25T19:05:12+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 18.764886ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 6,
    "startDate": "2022-07-25T19:10:12+00:00",
    "endDate": "2022-07-25T20:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/acd6b4aa-3690-47eb-aacb-8aad60bccc5d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1239#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1239/events/12390"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12540"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 605.659267ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:54+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1239%2Fevents%2F12390?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 76.137067ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1254%2Fevents%2F12540?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 75.71666ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1447%2Ffacility-use-slots%2F14467?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 332.7573ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467",
  "modified": 1658486516878,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1226%2Ffacility-use-slots%2F12257?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 333.718715ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1226/facility-use-slots/12257",
  "modified": 1658486516881,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/acd6b4aa-3690-47eb-aacb-8aad60bccc5d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anthony.Bode@yahoo.com",
    "telephone": "1-682-529-9772 x489",
    "givenName": "King",
    "familyName": "Kareem",
    "identifier": "0830cc9e-5210-4b8f-9661-085397fdcfc4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 756.8174ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:57+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.809227ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.214518ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.71131ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.274904ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/acd6b4aa-3690-47eb-aacb-8aad60bccc5d
...
---
Response status code: 201 Created. Responded in 509.624011ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1566",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1239#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1567",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1239#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1568",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1254#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1569",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1570",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1447/facility-use-slots/14467#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d#/orderedItems/1571",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1226/facility-use-slots/12257#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/acd6b4aa-3690-47eb-aacb-8aad60bccc5d/versions/8c8fb2f3-4d51-46e7-af4b-0e3188635bdf",
  "payment": {
    "@type": "Payment",
    "identifier": "9XM5DN4Q8",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;acd6b4aa-3690-47eb-aacb-8aad60bccc5d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/acd6b4aa-3690-47eb-aacb-8aad60bccc5d


---
Response status code: 200 OK. Responded in 19.209895ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833101568395&afterId=17b45d96-5388-4f84-94d5-f1dd98bba246",
  "message": "Listening for UUID: 'acd6b4aa-3690-47eb-aacb-8aad60bccc5d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 429.878589ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;acd6b4aa-3690-47eb-aacb-8aad60bccc5d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/acd6b4aa-3690-47eb-aacb-8aad60bccc5d


---
Response status code: 200 OK. Responded in 1761.258663ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "modified": 637940833213915100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
    "identifier": "acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
...
---
Response status code: 200 OK. Responded in 12.295785ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833213915089&afterId=acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "message": "Listening for UUID: 'acd6b4aa-3690-47eb-aacb-8aad60bccc5d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d
...
---
Response status code: 201 Created. Responded in 408.761952ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "identifier": "acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 17.199763ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "acd6b4aa-3690-47eb-aacb-8aad60bccc5d",
  "modified": 637940833238522800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 96.978382ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 96.453274ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 100.019728ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 99.673924ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/acd6b4aa-3690-47eb-aacb-8aad60bccc5d
...
---
Response status code: 204 No Content. Responded in 113.132929ms.
### Specs
* ✅ should return 204 on success
* ✅ noop

## Assert Opportunity Capacity (after Cancel OrderItem at Position 0)
### Specs
* ✅ should return 200 on success for request relevant to OrderItem 0
* ✅ should return 200 on success for request relevant to OrderItem 1
* ✅ should return 200 on success for request relevant to OrderItem 2
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
