[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:48 GMT+0000 (Coordinated Universal Time)
...
⚠️ 34 passed with 0 failures, 600 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 33.755133ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1734/events/17340"
}
```
...
---
Response status code: 200 OK. Responded in 32.531914ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1034/events/10335"
}
```
...
---
Response status code: 200 OK. Responded in 34.534145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17366"
}
```
...
---
Response status code: 200 OK. Responded in 33.688131ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1090/facility-use-slots/10898"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1734%2Fevents%2F17340?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.633972ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1734/events/17340",
    "startDate": "2022-07-23T12:12:11+00:00",
    "endDate": "2022-07-23T13:35:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1734",
      "name": "Wooden Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1734#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT18H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1034%2Fevents%2F10335?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.105464ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1034/events/10335",
    "startDate": "2022-07-31T15:56:11+00:00",
    "endDate": "2022-07-31T16:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1737%2Ffacility-use-slots%2F17366?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.543156ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1737",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingIntakeForm"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT22H41M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-22T13:51:12+00:00",
    "endDate": "2022-07-22T18:46:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1090%2Ffacility-use-slots%2F10898?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.076448ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1090/facility-use-slots/10898#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2022-08-01T01:29:12+00:00",
    "endDate": "2022-08-01T03:47:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/03c4f638-9d58-485a-8c4e-67ba68a9749d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1734#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1734/events/17340"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1034/events/10335"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17366#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17366"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1090/facility-use-slots/10898#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1090/facility-use-slots/10898"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 261.526026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/03c4f638-9d58-485a-8c4e-67ba68a9749d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:10+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1737"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2022-07-22T13:51:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1734%2Fevents%2F17340?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 180.366146ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1734/events/17340",
  "modified": 1658486352816,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1034%2Fevents%2F10335?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 180.746152ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1034/events/10335",
  "modified": 1658486352819,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1737%2Ffacility-use-slots%2F17366?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 178.551117ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1737/facility-use-slots/17366",
  "modified": 1658486352837,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1090%2Ffacility-use-slots%2F10898?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 179.502332ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1090/facility-use-slots/10898",
  "modified": 1658486352839,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/03c4f638-9d58-485a-8c4e-67ba68a9749d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tamara.Bernier@hotmail.com",
    "telephone": "(519) 324-3981 x926",
    "givenName": "Stracke",
    "familyName": "Bernhard",
    "identifier": "e850e084-1d9d-4d3c-b506-37b884965c36"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 402.325847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/03c4f638-9d58-485a-8c4e-67ba68a9749d
...
---
Response status code: 409 Conflict. Responded in 92.926869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/03c4f638-9d58-485a-8c4e-67ba68a9749d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
