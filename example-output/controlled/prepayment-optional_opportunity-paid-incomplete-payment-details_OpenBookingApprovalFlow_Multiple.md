[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:25 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 42.245685ms.
```json
{
...
---
Response status code: 200 OK. Responded in 48.477142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 691.830502ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517",
  "modified": 1658486867005,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517",
    "startDate": "2022-07-23T10:47:45+00:00",
    "endDate": "2022-07-23T11:47:45+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 425.96288ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505",
  "modified": 1658486866740,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bc4521e9-84ec-4f0a-995a-0ea048f665ea
...
---
Response status code: 200 OK. Responded in 1124.542544ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bc4521e9-84ec-4f0a-995a-0ea048f665ea",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2517%2Fevents%2F20517?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 125.759846ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517",
  "modified": 1658486868537,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2505%2Ffacility-use-slots%2F20505?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 594.440415ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505",
  "modified": 1658486869007,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bc4521e9-84ec-4f0a-995a-0ea048f665ea
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Einar.Olson55@hotmail.com",
    "telephone": "(353) 417-5325 x816",
    "givenName": "Towne",
    "familyName": "Betsy",
    "identifier": "29a90a88-922e-44c5-9bde-adeabdc4685d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1176.79312ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:48+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 36.621134ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.658125ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/bc4521e9-84ec-4f0a-995a-0ea048f665ea
...
---
Response status code: 400 Bad Request. Responded in 812.430401ms.
```json
{
  "@context": "https://openactive.io/",
