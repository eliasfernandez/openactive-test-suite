...
⚠️ 20 passed with 0 failures, 204 warnings and 24 suggestions 
...
---
Response status code: 200 OK. Responded in 13.478512ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/654/facility-use-slots/6531"
}
```
...
---
Response status code: 200 OK. Responded in 12.138391ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4019"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F654%2Ffacility-use-slots%2F6531?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.344562ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/654",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/654/facility-use-slots/6531#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 5.33,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT22H20M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-28T22:46:12+00:00",
    "endDate": "2022-07-29T01:13:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F402%2Ffacility-use-slots%2F4019?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.687752ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4019#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 15.46,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT4H26M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-25T13:51:12+00:00",
    "endDate": "2022-07-25T16:44:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/028845a4-b306-4ad8-a508-0514bbd814ab
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/654/facility-use-slots/6531#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/654/facility-use-slots/6531"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4019#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/402/facility-use-slots/4019"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 40.913143ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/028845a4-b306-4ad8-a508-0514bbd814ab",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/654"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-28T22:46:12+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/028845a4-b306-4ad8-a508-0514bbd814ab
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Wilber18@yahoo.com",
    "telephone": "1-455-542-4280 x43846",
    "givenName": "Schumm",
    "familyName": "Astrid",
    "identifier": "a170cac0-0091-4c76-bec6-b14da34604a6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 59.989642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/028845a4-b306-4ad8-a508-0514bbd814ab
...
---
Response status code: 409 Conflict. Responded in 70.874413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/028845a4-b306-4ad8-a508-0514bbd814ab",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
