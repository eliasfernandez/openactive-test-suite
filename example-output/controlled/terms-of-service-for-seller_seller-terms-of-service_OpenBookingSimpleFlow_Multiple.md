[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:36 GMT+0000 (Coordinated Universal Time)
...
⚠️ 44 passed with 0 failures, 594 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 48.260179ms.
```json
{
...
---
Response status code: 200 OK. Responded in 48.44838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 46.724066ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 46.919968ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 717.608827ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2136/events/20136",
  "modified": 1658486145994,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2136/events/20136",
    "startDate": "2022-07-23T10:35:44+00:00",
    "endDate": "2022-07-23T11:35:44+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 716.950022ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2137/events/20137",
...
---
Response status code: 200 OK. Responded in 372.257119ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2131/facility-use-slots/20131",
  "modified": 1658486145648,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 373.088825ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2132/facility-use-slots/20132",
  "modified": 1658486145651,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8478c1dc-abaa-4078-bb58-a900dcaf5717
...
---
Response status code: 200 OK. Responded in 126.212089ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8478c1dc-abaa-4078-bb58-a900dcaf5717",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:45+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2136%2Fevents%2F20136?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 382.739701ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2136/events/20136",
  "modified": 1658486147837,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2137%2Fevents%2F20137?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 382.356099ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2137/events/20137",
  "modified": 1658486147838,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2131%2Ffacility-use-slots%2F20131?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 451.44114ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2131/facility-use-slots/20131",
  "modified": 1658486147905,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2132%2Ffacility-use-slots%2F20132?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 451.119937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2132/facility-use-slots/20132",
  "modified": 1658486147906,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8478c1dc-abaa-4078-bb58-a900dcaf5717
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elwin_Ledner@yahoo.com",
    "telephone": "(915) 889-8708 x3333",
    "givenName": "Brakus",
    "familyName": "Brannon",
    "identifier": "5258dcd9-288e-4722-b4b2-d5a03b1d4a8a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 164.177688ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:47+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 86.418378ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 85.883073ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 85.42497ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 84.977566ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717
...
---
Response status code: 201 Created. Responded in 301.368463ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/632",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2136#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/633",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2136#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/634",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2137#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/635",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2131/facility-use-slots/20131#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/636",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2131/facility-use-slots/20131#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8478c1dc-abaa-4078-bb58-a900dcaf5717#/orderedItems/637",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2132/facility-use-slots/20132#/offers/0",
        "allowCustomerCancellationFullRefund": true,
