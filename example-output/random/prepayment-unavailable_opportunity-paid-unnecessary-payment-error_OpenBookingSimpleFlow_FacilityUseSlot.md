[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:59 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 9.391175ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/299/facility-use-slots/2989"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F299%2Ffacility-use-slots%2F2989?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.803946ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/299",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/299/facility-use-slots/2989#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T18:13:12+00:00",
    "endDate": "2022-07-28T20:45:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b13223c9-8b6d-4193-b8d3-60f3e4e75338
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/299/facility-use-slots/2989#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/299/facility-use-slots/2989"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 554.086247ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b13223c9-8b6d-4193-b8d3-60f3e4e75338",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F299%2Ffacility-use-slots%2F2989?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1293.917821ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/299/facility-use-slots/2989",
  "modified": 1658487005005,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b13223c9-8b6d-4193-b8d3-60f3e4e75338
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Harvey_Grant@yahoo.com",
    "telephone": "960.706.7232 x686",
    "givenName": "Glover",
    "familyName": "Enrico",
    "identifier": "7c665efc-8640-458f-bf6b-a6559f14db1a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 220.611125ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.640195ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b13223c9-8b6d-4193-b8d3-60f3e4e75338
...
---
Response status code: 400 Bad Request. Responded in 1039.763856ms.
```json
{
  "@context": "https://openactive.io/",
