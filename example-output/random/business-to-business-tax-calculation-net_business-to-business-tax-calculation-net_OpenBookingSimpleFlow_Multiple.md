[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:45:59 GMT+0000 (Coordinated Universal Time)
...
⚠️ 50 passed with 0 failures, 706 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 71.052581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/606"
}
```
...
---
Response status code: 200 OK. Responded in 69.73355ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/54/events/535"
}
```
...
---
Response status code: 200 OK. Responded in 60.480331ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302"
}
```
...
---
Response status code: 200 OK. Responded in 61.320351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F61%2Fevents%2F606?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.778381ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/606",
    "startDate": "2022-07-24T09:28:11+00:00",
    "endDate": "2022-07-24T15:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F54%2Fevents%2F535?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.049063ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/54/events/535",
    "startDate": "2022-07-27T21:07:11+00:00",
    "endDate": "2022-07-28T02:12:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F431%2Ffacility-use-slots%2F4302?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.452149ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/431",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.34,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT8H40M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-25T01:59:12+00:00",
    "endDate": "2022-07-25T03:55:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F645%2Ffacility-use-slots%2F6445?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.993438ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/645",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.81,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT20H56M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-23T02:35:12+00:00",
    "endDate": "2022-07-23T05:32:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/74426922-8201-4880-a62b-fddbfcfbba96
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/606"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/54#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/54/events/535"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 895.040875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/74426922-8201-4880-a62b-fddbfcfbba96",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:13+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F61%2Fevents%2F606?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 294.17786ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/606",
  "modified": 1658486776408,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F54%2Fevents%2F535?useCacheIfAvailable=true&expectedCapacity=18


---
Response status code: 200 OK. Responded in 293.399441ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/54/events/535",
  "modified": 1658486776409,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F431%2Ffacility-use-slots%2F4302?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 889.32764ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302",
  "modified": 1658486777013,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F645%2Ffacility-use-slots%2F6445?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 890.59247ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445",
  "modified": 1658486777015,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/74426922-8201-4880-a62b-fddbfcfbba96
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "eaef2423-a367-4025-a0b3-6c73475eb501",
...
---
Response status code: 200 OK. Responded in 893.734945ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.705048ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.806526ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.13751ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.621799ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96
...
---
Response status code: 201 Created. Responded in 763.311145ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2248",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/61#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2249",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/61#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2250",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/54#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2251",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2252",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/431/facility-use-slots/4302#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/74426922-8201-4880-a62b-fddbfcfbba96#/orderedItems/2253",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/645/facility-use-slots/6445#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 21.956888ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.14457ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.502856ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.088347ms.
```json
{
  "data": {
    "@context": [
