...
⚠️ 13 passed with 0 failures, 104 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 8.067791ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1603/events/16021"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1603%2Fevents%2F16021?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.950084ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1603/events/16021",
    "startDate": "2022-07-23T20:04:11+00:00",
    "endDate": "2022-07-24T00:33:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7ba8601a-27e9-4c5c-8d65-1b3adbd123d3
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1603/events/16021"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 218.676183ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7ba8601a-27e9-4c5c-8d65-1b3adbd123d3",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1603%2Fevents%2F16021?useCacheIfAvailable=true&expectedCapacity=41


---
Response status code: 200 OK. Responded in 1171.111907ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1603/events/16021",
  "modified": 1658486773390,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7ba8601a-27e9-4c5c-8d65-1b3adbd123d3
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "1-535-594-8413",
    "givenName": "Haag",
    "familyName": "Karina",
    "identifier": "dddd01bc-4320-4961-9f13-299584bfcea3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 255.009733ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.438036ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7ba8601a-27e9-4c5c-8d65-1b3adbd123d3
...
---
Response status code: 400 Bad Request. Responded in 555.025931ms.
```json
{
  "@context": "https://openactive.io/",
