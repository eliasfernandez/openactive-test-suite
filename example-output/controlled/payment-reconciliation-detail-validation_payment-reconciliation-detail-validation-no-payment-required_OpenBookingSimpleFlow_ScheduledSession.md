...
---
Response status code: 200 OK. Responded in 76.874714ms.
```json
{
...
---
Response status code: 200 OK. Responded in 318.389158ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2578/events/20578",
  "modified": 1658486987399,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2578/events/20578",
    "startDate": "2022-07-23T10:49:46+00:00",
    "endDate": "2022-07-23T11:49:46+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/118ac94f-e411-4467-8c48-b90e19a1e9e8
...
---
Response status code: 200 OK. Responded in 479.502854ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/118ac94f-e411-4467-8c48-b90e19a1e9e8",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2578%2Fevents%2F20578?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 327.383941ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2578/events/20578",
  "modified": 1658486988800,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/118ac94f-e411-4467-8c48-b90e19a1e9e8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mario.Shanahan14@hotmail.com",
    "telephone": "498.467.9196 x178",
    "givenName": "Heathcote",
    "familyName": "Irwin",
    "identifier": "beb2695f-7a97-4317-ae30-c3b51a371231"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 624.165798ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.837745ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/118ac94f-e411-4467-8c48-b90e19a1e9e8
...
---
Response status code: 201 Created. Responded in 1382.650144ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/118ac94f-e411-4467-8c48-b90e19a1e9e8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/118ac94f-e411-4467-8c48-b90e19a1e9e8#/orderedItems/3079",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2578#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 8.394176ms.
```json
{
  "data": {
    "@context": [
