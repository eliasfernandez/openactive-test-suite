...
---
Response status code: 200 OK. Responded in 5.059985ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11087?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.356556ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2022-07-25T12:42:12+00:00",
    "endDate": "2022-07-25T17:50:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0ec2ce4c-1dc1-466e-8557-c8353301aece
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 167.213914ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:58:06+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11087?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 457.744003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087",
  "modified": 1658487187680,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0ec2ce4c-1dc1-466e-8557-c8353301aece
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katherine_Kreiger48@gmail.com",
    "telephone": "(261) 274-3344 x7617",
    "givenName": "Donnelly",
    "familyName": "Ethel",
    "identifier": "66cb76f1-0b67-4717-8615-008c6775bcb7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 353.319947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.598778ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0ec2ce4c-1dc1-466e-8557-c8353301aece
...
---
Response status code: 201 Created. Responded in 168.519937ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/0ec2ce4c-1dc1-466e-8557-c8353301aece",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0ec2ce4c-1dc1-466e-8557-c8353301aece#/orderedItems/3226",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11087#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/0ec2ce4c-1dc1-466e-8557-c8353301aece/versions/63352b60-058f-4262-95ac-1b6785142829",
  "payment": {
    "@type": "Payment",
    "identifier": "jK5sD9441",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;0ec2ce4c-1dc1-466e-8557-c8353301aece&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/0ec2ce4c-1dc1-466e-8557-c8353301aece


---
Response status code: 200 OK. Responded in 4.122669ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940839830588212&afterId=7df17ae6-81b6-48e8-ae1f-c7599225e280",
  "message": "Listening for UUID: '0ec2ce4c-1dc1-466e-8557-c8353301aece' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 12.244106ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;0ec2ce4c-1dc1-466e-8557-c8353301aece&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/0ec2ce4c-1dc1-466e-8557-c8353301aece


---
Response status code: 200 OK. Responded in 2295.148636ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "modified": 637940839874048600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/0ec2ce4c-1dc1-466e-8557-c8353301aece",
    "identifier": "0ec2ce4c-1dc1-466e-8557-c8353301aece",
...
---
Response status code: 200 OK. Responded in 9.048548ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0ec2ce4c-1dc1-466e-8557-c8353301aece
...
---
Response status code: 201 Created. Responded in 99.414232ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "identifier": "0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1419.550609ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "0ec2ce4c-1dc1-466e-8557-c8353301aece",
  "modified": 637940839897381900
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 13.223917ms.
```json
{
  "data": {
    "@context": [
