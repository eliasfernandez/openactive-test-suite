...
⚠️ 55 passed with 0 failures, 948 warnings and 252 suggestions 
...
---
Response status code: 200 OK. Responded in 26.358292ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/737/events/7365"
}
```
...
---
Response status code: 200 OK. Responded in 23.113943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3189"
}
```
...
---
Response status code: 200 OK. Responded in 37.126653ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145"
}
```
...
---
Response status code: 200 OK. Responded in 28.078317ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F737%2Fevents%2F7365?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 74.068401ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/737/events/7365",
    "startDate": "2022-07-23T20:49:11+00:00",
    "endDate": "2022-07-23T23:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/737",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3189?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 73.450193ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3189",
    "startDate": "2022-07-25T16:48:11+00:00",
    "endDate": "2022-07-25T18:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F15%2Ffacility-use-slots%2F145?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 72.809482ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/15",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
    ...
    "remainingUses": 3,
    "startDate": "2022-07-23T07:16:11+00:00",
    "endDate": "2022-07-23T09:29:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F565%2Ffacility-use-slots%2F5648?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 72.221274ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT10H29M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-24T00:42:12+00:00",
    "endDate": "2022-07-24T02:45:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dd8fc447-1c86-49a5-876d-5560208047a6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/737#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/737/events/7365"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3189"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 597.350114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dd8fc447-1c86-49a5-876d-5560208047a6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:47:28+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/737"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/15"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-23T07:16:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F737%2Fevents%2F7365?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 339.344178ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/737/events/7365",
  "modified": 1658486550993,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3189?useCacheIfAvailable=true&expectedCapacity=32


---
Response status code: 200 OK. Responded in 339.055473ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3189",
  "modified": 1658486550995,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F15%2Ffacility-use-slots%2F145?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 811.788586ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145",
  "modified": 1658486551503,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F565%2Ffacility-use-slots%2F5648?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 804.445374ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648",
  "modified": 1658486551504,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dd8fc447-1c86-49a5-876d-5560208047a6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gertrude96@yahoo.com",
    "telephone": "215-589-3476 x392",
    "givenName": "Denesik",
    "familyName": "Gus",
    "identifier": "04b26c1c-7de8-488d-a61f-bf12ede85a7e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 418.839691ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 72.421805ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 70.958982ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.763365ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 69.132755ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6
...
---
Response status code: 201 Created. Responded in 266.073817ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1678",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/737#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1679",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/737#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1680",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/319#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1681",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1682",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/15/facility-use-slots/145#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6#/orderedItems/1683",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/565/facility-use-slots/5648#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 37.338572ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.787348ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.710931ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.116422ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/dd8fc447-1c86-49a5-876d-5560208047a6
...
---
Response status code: 400 Bad Request. Responded in 51.128952ms.
```json
{
  "@context": "https://openactive.io/",
