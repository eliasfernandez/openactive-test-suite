...
---
Response status code: 200 OK. Responded in 25.763732ms.
```json
{
...
---
Response status code: 200 OK. Responded in 746.402023ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480",
  "modified": 1658486820882,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ce2f5cad-9cd0-4723-857d-e6239e081034
...
---
Response status code: 200 OK. Responded in 179.86772ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ce2f5cad-9cd0-4723-857d-e6239e081034",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2480%2Ffacility-use-slots%2F20480?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 820.222688ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480",
  "modified": 1658486822046,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ce2f5cad-9cd0-4723-857d-e6239e081034
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Russ_Gorczany@gmail.com",
    "telephone": "710-273-1566",
    "givenName": "Prosacco",
    "familyName": "Delia",
    "identifier": "a26b192e-b1ff-4c0d-9d63-56a1041533be"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 419.581979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.835069ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ce2f5cad-9cd0-4723-857d-e6239e081034
...
---
Response status code: 400 Bad Request. Responded in 718.851675ms.
```json
{
  "@context": "https://openactive.io/",
