...
⚠️ 23 passed with 0 failures, 204 warnings and 72 suggestions 
...
---
Response status code: 200 OK. Responded in 103.82676ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1034.918479ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2061/events/20061",
  "modified": 1658486052103,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2061/events/20061",
    "startDate": "2022-07-23T10:34:10+00:00",
    "endDate": "2022-07-23T11:34:10+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3906a6e3-2e76-4208-bbf0-73a555223418
...
---
Response status code: 200 OK. Responded in 50.820023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3906a6e3-2e76-4208-bbf0-73a555223418",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2061%2Fevents%2F20061?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 901.310629ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2061/events/20061",
  "modified": 1658486053290,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 11.04447ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 925.599983ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2062/events/20062",
  "modified": 1658486054275,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2062/events/20062",
    "startDate": "2022-07-23T10:34:12+00:00",
    "endDate": "2022-07-23T11:34:12+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3906a6e3-2e76-4208-bbf0-73a555223418
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elisha_Medhurst70@gmail.com",
    "telephone": "704-518-1848 x75195",
    "givenName": "D'Amore",
    "familyName": "Lois",
    "identifier": "5bfd93b5-59e1-469d-be94-9130c746d83c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 219.607796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:13+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2062%2Fevents%2F20062?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 527.606154ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2062/events/20062",
  "modified": 1658486055208,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3906a6e3-2e76-4208-bbf0-73a555223418
...
---
Response status code: 201 Created. Responded in 71.654856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3906a6e3-2e76-4208-bbf0-73a555223418",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3906a6e3-2e76-4208-bbf0-73a555223418#/orderedItems/354",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2062#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3906a6e3-2e76-4208-bbf0-73a555223418/versions/4630b173-025a-44b0-9396-9e14ea535d67",
  "payment": {
    "@type": "Payment",
    "identifier": "KF7MHKJ2Q",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;3906a6e3-2e76-4208-bbf0-73a555223418&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3906a6e3-2e76-4208-bbf0-73a555223418


---
Response status code: 200 OK. Responded in 3.477722ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828506992419&afterId=75e5e66e-bd1d-4b55-af9b-e44a3329b983",
  "message": "Listening for UUID: '3906a6e3-2e76-4208-bbf0-73a555223418' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 91.540383ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3906a6e3-2e76-4208-bbf0-73a555223418&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3906a6e3-2e76-4208-bbf0-73a555223418


---
Response status code: 200 OK. Responded in 2065.258224ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3906a6e3-2e76-4208-bbf0-73a555223418",
  "modified": 637940828545667000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3906a6e3-2e76-4208-bbf0-73a555223418",
    "identifier": "3906a6e3-2e76-4208-bbf0-73a555223418",
...
---
Response status code: 200 OK. Responded in 4.68443ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828545666928&afterId=3906a6e3-2e76-4208-bbf0-73a555223418",
  "message": "Listening for UUID: '3906a6e3-2e76-4208-bbf0-73a555223418' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3906a6e3-2e76-4208-bbf0-73a555223418
...
---
Response status code: 201 Created. Responded in 25.918166ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3906a6e3-2e76-4208-bbf0-73a555223418",
  "identifier": "3906a6e3-2e76-4208-bbf0-73a555223418",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1862.522626ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3906a6e3-2e76-4208-bbf0-73a555223418",
  "modified": 637940828566754300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 10.130664ms.
```json
{
  "data": {
    "@context": [
