[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:52:20 GMT+0000 (Coordinated Universal Time)
...
⚠️ 26 passed with 0 failures, 377 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 34.915147ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11127"
}
```
...
---
Response status code: 200 OK. Responded in 35.135251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1506/events/15056"
}
```
...
---
Response status code: 200 OK. Responded in 35.175652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11954"
}
```
...
---
Response status code: 200 OK. Responded in 31.863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10720"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11127?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.084146ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11127",
    "startDate": "2022-07-28T17:20:11+00:00",
    "endDate": "2022-07-28T18:02:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1506%2Fevents%2F15056?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.714641ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1506/events/15056",
    "startDate": "2022-07-23T06:46:11+00:00",
    "endDate": "2022-07-23T09:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1196%2Ffacility-use-slots%2F11954?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.514137ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11954#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T18:50:12+00:00",
    "endDate": "2022-07-30T00:17:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1072%2Ffacility-use-slots%2F10720?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.312735ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10720#/offers/0",
    ...
    "remainingUses": 7,
    "startDate": "2022-07-26T17:54:12+00:00",
    "endDate": "2022-07-26T22:16:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/77121b3b-a200-40a6-9508-629ffc753c94
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11127"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1506/events/15056"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11954#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1196/facility-use-slots/11954"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10720#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1072/facility-use-slots/10720"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 513.863258ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/77121b3b-a200-40a6-9508-629ffc753c94
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Oma87@yahoo.com",
    "telephone": "(568) 541-1836 x1027",
    "givenName": "Connelly",
    "familyName": "Walton",
    "identifier": "fd109107-48c8-443b-a13a-4ba6611b4ed6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 256.260318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
