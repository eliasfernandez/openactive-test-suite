...
---
Response status code: 200 OK. Responded in 10.611984ms.
```json
{
...
---
Response status code: 200 OK. Responded in 483.547966ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2236/facility-use-slots/20236",
  "modified": 1658486289463,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:38:07+00:00",
    "endDate": "2022-07-23T11:38:07+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e66fada0-9a53-4c26-908a-99ba005e633d
...
---
Response status code: 200 OK. Responded in 176.084208ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e66fada0-9a53-4c26-908a-99ba005e633d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2236%2Ffacility-use-slots%2F20236?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 977.137712ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2236/facility-use-slots/20236",
  "modified": 1658486291040,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e66fada0-9a53-4c26-908a-99ba005e633d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aniyah_Kuhn@gmail.com",
    "telephone": "1-791-602-6126 x631",
    "givenName": "Little",
    "familyName": "Stacy",
    "identifier": "fd039264-2227-4399-9deb-adf9fe7774c1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 15.814826ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e66fada0-9a53-4c26-908a-99ba005e633d
...
---
Response status code: 409 Conflict. Responded in 28.555328ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e66fada0-9a53-4c26-908a-99ba005e633d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
