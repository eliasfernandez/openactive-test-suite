...
---
Response status code: 200 OK. Responded in 931.835543ms.
```json
{
...
---
Response status code: 200 OK. Responded in 738.915095ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2537/facility-use-slots/20537",
  "modified": 1658486934592,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/35fd373c-7a1e-4341-8f97-43b61c11c9f0
...
---
Response status code: 200 OK. Responded in 606.319394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/35fd373c-7a1e-4341-8f97-43b61c11c9f0",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2537%2Ffacility-use-slots%2F20537?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 359.034053ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2537/facility-use-slots/20537",
  "modified": 1658486935821,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/35fd373c-7a1e-4341-8f97-43b61c11c9f0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Isabel0@hotmail.com",
    "telephone": "1-595-915-8577 x75223",
    "givenName": "Beahan",
    "familyName": "Diego",
    "identifier": "f8afb398-a7d9-4ea4-b6ff-a0f744c99d70"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 958.97729ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:55+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 5.489649ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/35fd373c-7a1e-4341-8f97-43b61c11c9f0
...
---
Response status code: 201 Created. Responded in 1136.247802ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/35fd373c-7a1e-4341-8f97-43b61c11c9f0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35fd373c-7a1e-4341-8f97-43b61c11c9f0#/orderedItems/2974",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2537/facility-use-slots/20537#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 37.219638ms.
```json
{
  "data": {
    "@context": [
