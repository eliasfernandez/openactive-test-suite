[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:33:44 GMT+0000 (Coordinated Universal Time)
...
⚠️ 56 passed with 0 failures, 742 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 51.250863ms.
```json
{
...
---
Response status code: 200 OK. Responded in 162.03795ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 180.950985ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 89.424834ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 236.088676ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2050/events/20050",
  "modified": 1658486035077,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 741.435664ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2053/events/20053",
  "modified": 1658486035583,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1090.466741ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053",
  "modified": 1658486035933,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 303.538355ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052",
  "modified": 1658486035147,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4
...
---
Response status code: 200 OK. Responded in 182.223794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2050%2Fevents%2F20050?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 38.663674ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2053%2Fevents%2F20053?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 40.429487ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2053%2Ffacility-use-slots%2F20053?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 275.387355ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053",
  "modified": 1658486037699,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2052%2Ffacility-use-slots%2F20052?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 275.287354ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052",
  "modified": 1658486037700,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Glenda.Trantow88@hotmail.com",
    "telephone": "1-706-520-8455",
    "givenName": "Runolfsson",
    "familyName": "Gabrielle",
    "identifier": "055c0024-1775-4f03-a727-1a6296ad3090"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 115.54202ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:57+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 45.806325ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 41.635895ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 41.112592ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 40.694189ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4
...
---
Response status code: 201 Created. Responded in 255.317411ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/323",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2050#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/324",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2050#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/325",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/326",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/327",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4#/orderedItems/328",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4/versions/7cdf8b0c-e9ed-46cd-9861-b68f7201bb29",
  "payment": {
    "@type": "Payment",
    "identifier": "ssKpjd1BN",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4


---
Response status code: 200 OK. Responded in 3.37812ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Proposal Request
PATCH https://localhost:5001/api/openbooking/order-proposals/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4
...
---
Response status code: 204 No Content. Responded in 87.600632ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4


---
Response status code: 200 OK. Responded in 2088.082574ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
  "modified": 637940828391208300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
    "identifier": "9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4",
    "orderProposalStatus": "https://openactive.io/CustomerRejected",
    "orderedItem": [
      {
        "@type": "OrderItem",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9a0adad2-e5d4-44fd-bcca-f1a6bfa5add4
...
---
Response status code: 500 Internal Server Error. Responded in 42.947261ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 25.046452ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.066346ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.663444ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.287341ms.
```json
{
  "data": {
    "@context": [
