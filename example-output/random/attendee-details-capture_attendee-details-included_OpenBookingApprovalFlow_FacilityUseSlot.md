...
---
Response status code: 200 OK. Responded in 17.011361ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1631%2Ffacility-use-slots%2F16304?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.74514ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1631",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT22H38M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-08-01T09:10:12+00:00",
    "endDate": "2022-08-01T13:12:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/44b92edb-1aaf-460e-b985-80bcd4294e18
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304",
      "attendee": {
        "@type": "Person",
...
---
Response status code: 200 OK. Responded in 601.576058ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/44b92edb-1aaf-460e-b985-80bcd4294e18",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1631"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-08-01T09:10:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1631%2Ffacility-use-slots%2F16304?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 445.448146ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304",
  "modified": 1658486857480,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/44b92edb-1aaf-460e-b985-80bcd4294e18
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fatima.Hills@gmail.com",
    "telephone": "865.543.2861 x3055",
    "givenName": "Okuneva",
    "familyName": "Frank",
    "identifier": "479c00aa-a401-495f-8a20-9db8f4c274e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 335.25341ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.04287ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/44b92edb-1aaf-460e-b985-80bcd4294e18
...
---
Response status code: 201 Created. Responded in 457.040393ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/44b92edb-1aaf-460e-b985-80bcd4294e18",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/44b92edb-1aaf-460e-b985-80bcd4294e18#/orderedItems/2484",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1631/facility-use-slots/16304#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/44b92edb-1aaf-460e-b985-80bcd4294e18/versions/dc467e57-10c5-4fb3-9f30-85732c3c402c",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;44b92edb-1aaf-460e-b985-80bcd4294e18&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/44b92edb-1aaf-460e-b985-80bcd4294e18


---
Response status code: 200 OK. Responded in 15.450728ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836531404257&afterId=cc6a35f2-0293-4579-a362-5d838931de2f",
  "message": "Listening for UUID: '44b92edb-1aaf-460e-b985-80bcd4294e18' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 156.55502ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;44b92edb-1aaf-460e-b985-80bcd4294e18&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/44b92edb-1aaf-460e-b985-80bcd4294e18


---
Response status code: 200 OK. Responded in 2271.980423ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "44b92edb-1aaf-460e-b985-80bcd4294e18",
  "modified": 637940836576356900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/44b92edb-1aaf-460e-b985-80bcd4294e18",
    "identifier": "44b92edb-1aaf-460e-b985-80bcd4294e18",
...
---
Response status code: 200 OK. Responded in 18.366846ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940836576356928&afterId=44b92edb-1aaf-460e-b985-80bcd4294e18",
  "message": "Listening for UUID: '44b92edb-1aaf-460e-b985-80bcd4294e18' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/44b92edb-1aaf-460e-b985-80bcd4294e18
...
---
Response status code: 201 Created. Responded in 286.441994ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/44b92edb-1aaf-460e-b985-80bcd4294e18",
  "identifier": "44b92edb-1aaf-460e-b985-80bcd4294e18",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 733.473614ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "44b92edb-1aaf-460e-b985-80bcd4294e18",
  "modified": 637940836602458100
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 6.052614ms.
```json
{
  "data": {
    "@context": [
