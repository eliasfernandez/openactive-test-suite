...
---
Response status code: 200 OK. Responded in 16.674241ms.
```json
{
...
---
Response status code: 200 OK. Responded in 484.481985ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2320/events/20320",
  "modified": 1658486418072,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2320/events/20320",
    "startDate": "2022-07-23T10:40:16+00:00",
    "endDate": "2022-07-23T11:40:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9
...
---
Response status code: 200 OK. Responded in 183.154645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:17+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2320%2Fevents%2F20320?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 389.543585ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2320/events/20320",
  "modified": 1658486418916,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Margarita.Runolfsdottir@gmail.com",
    "telephone": "954-688-7982",
    "givenName": "Luettgen",
    "familyName": "Katarina",
    "identifier": "21fd5e9b-9139-4514-a143-a0d6f2ce9397"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 95.138303ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 22.638491ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9
...
---
Response status code: 201 Created. Responded in 171.402645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9#/orderedItems/1460",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2320#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9/versions/aa75a703-2664-4d94-9eb6-0b245747dd07",
  "payment": {
    "@type": "Payment",
    "identifier": "xcI7AvBfg",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9


---
Response status code: 200 OK. Responded in 13.04451ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 136.441151ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9


---
Response status code: 200 OK. Responded in 2116.905149ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "modified": 637940832189472100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
    "identifier": "30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
...
---
Response status code: 200 OK. Responded in 10.561289ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9
...
---
Response status code: 201 Created. Responded in 46.546293ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "identifier": "30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1166.477359ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "30f9cfaf-cc8c-4940-bb76-5246f3c1d2b9",
  "modified": 637940832212278400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 10.591697ms.
```json
{
  "data": {
    "@context": [
