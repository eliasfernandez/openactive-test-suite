[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:34 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 7.285136ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1291/facility-use-slots/12902"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1291%2Ffacility-use-slots%2F12902?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.628868ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1291/facility-use-slots/12902#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T08:43:12+00:00",
    "endDate": "2022-07-29T12:28:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b853679f-c556-4a6e-8bf7-3adb60bdc6cb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1291/facility-use-slots/12902#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1291/facility-use-slots/12902"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 427.301879ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b853679f-c556-4a6e-8bf7-3adb60bdc6cb",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1291%2Ffacility-use-slots%2F12902?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 508.706899ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1291/facility-use-slots/12902",
  "modified": 1658487001957,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b853679f-c556-4a6e-8bf7-3adb60bdc6cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Enrico_Streich@yahoo.com",
    "telephone": "1-571-498-5386",
    "givenName": "Rolfson",
    "familyName": "Kara",
    "identifier": "3ce86742-1138-4d79-81f0-bbf224f5d096"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 409.587848ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:01+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 11.505015ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b853679f-c556-4a6e-8bf7-3adb60bdc6cb
...
---
Response status code: 400 Bad Request. Responded in 582.637879ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (18.01) does not match expected value (17.01)"
}
```
### Specs
