...
---
Response status code: 200 OK. Responded in 42.764889ms.
```json
{
...
---
Response status code: 200 OK. Responded in 539.045395ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2557/events/20557",
  "modified": 1658486957685,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2557/events/20557",
    "startDate": "2022-07-23T10:49:16+00:00",
    "endDate": "2022-07-23T11:49:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/45f7f110-be93-4754-8089-af680d5c0af2
...
---
Response status code: 400 Bad Request. Responded in 237.365756ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/45f7f110-be93-4754-8089-af680d5c0af2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Frederick63@hotmail.com",
    "telephone": "1-932-262-3200",
    "givenName": "Greenfelder",
    "familyName": "Toy",
    "identifier": "fb59d625-d05d-43db-847f-c47e658e9c7c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 39.119856ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
