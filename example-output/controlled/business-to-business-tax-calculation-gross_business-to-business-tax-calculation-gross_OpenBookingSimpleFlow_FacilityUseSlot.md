...
---
Response status code: 200 OK. Responded in 1185.575065ms.
```json
{
...
---
Response status code: 200 OK. Responded in 737.936801ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2560/facility-use-slots/20560",
  "modified": 1658486979999,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:49:37+00:00",
    "endDate": "2022-07-23T11:49:37+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e29daf17-dbbb-4550-8921-14a10e929be0
...
---
Response status code: 200 OK. Responded in 383.392881ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e29daf17-dbbb-4550-8921-14a10e929be0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:39+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2560%2Ffacility-use-slots%2F20560?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 710.644553ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2560/facility-use-slots/20560",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e29daf17-dbbb-4550-8921-14a10e929be0
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "bc7a51b2-0679-4967-ab54-b79601475d20",
...
---
Response status code: 200 OK. Responded in 594.72ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 68.734924ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e29daf17-dbbb-4550-8921-14a10e929be0
...
---
Response status code: 201 Created. Responded in 563.321815ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e29daf17-dbbb-4550-8921-14a10e929be0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e29daf17-dbbb-4550-8921-14a10e929be0#/orderedItems/3062",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2560/facility-use-slots/20560#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 25.549037ms.
```json
{
  "data": {
    "@context": [
