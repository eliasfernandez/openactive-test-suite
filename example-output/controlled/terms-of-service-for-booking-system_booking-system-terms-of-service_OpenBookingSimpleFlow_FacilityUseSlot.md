...
---
Response status code: 200 OK. Responded in 486.690462ms.
```json
{
...
---
Response status code: 200 OK. Responded in 686.605216ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2301/facility-use-slots/20301",
  "modified": 1658486400507,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:58+00:00",
    "endDate": "2022-07-23T11:39:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/29b56e20-3b42-4353-ab4c-df56b00a4842
...
---
Response status code: 200 OK. Responded in 261.725124ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/29b56e20-3b42-4353-ab4c-df56b00a4842",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2301%2Ffacility-use-slots%2F20301?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 723.208245ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2301/facility-use-slots/20301",
  "modified": 1658486401708,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/29b56e20-3b42-4353-ab4c-df56b00a4842
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joesph36@hotmail.com",
    "telephone": "321.717.6807 x20322",
    "givenName": "Goodwin",
    "familyName": "Carmelo",
    "identifier": "0da90f3d-747b-41f3-a324-bd90a3beb516"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 116.746292ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.875818ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/29b56e20-3b42-4353-ab4c-df56b00a4842
...
---
Response status code: 201 Created. Responded in 276.160146ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/29b56e20-3b42-4353-ab4c-df56b00a4842",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29b56e20-3b42-4353-ab4c-df56b00a4842#/orderedItems/1416",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2301/facility-use-slots/20301#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 10.803392ms.
```json
{
  "data": {
    "@context": [
