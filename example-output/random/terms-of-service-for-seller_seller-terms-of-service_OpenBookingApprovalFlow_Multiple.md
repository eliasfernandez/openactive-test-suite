[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:36:12 GMT+0000 (Coordinated Universal Time)
...
⚠️ 44 passed with 0 failures, 630 warnings and 174 suggestions 
...
---
Response status code: 200 OK. Responded in 32.765539ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1181/events/11807"
}
```
...
---
Response status code: 200 OK. Responded in 26.945443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1729/events/17286"
}
```
...
---
Response status code: 200 OK. Responded in 26.087029ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401"
}
```
...
---
Response status code: 200 OK. Responded in 25.284816ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1181%2Fevents%2F11807?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.520484ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1181/events/11807",
    "startDate": "2022-07-29T06:55:11+00:00",
    "endDate": "2022-07-29T11:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1181",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1181#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1729%2Fevents%2F17286?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.195579ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1729/events/17286",
    "startDate": "2022-07-26T02:29:11+00:00",
    "endDate": "2022-07-26T05:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1441%2Ffacility-use-slots%2F14401?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 36.783206ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 15.2,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT12H28M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-08-01T08:00:12+00:00",
    "endDate": "2022-08-01T11:35:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14433?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 37.303814ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT6H1M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-27T07:50:12+00:00",
    "endDate": "2022-07-27T13:23:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/944be117-40a7-4964-b2b8-034582559942
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1181#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1181/events/11807"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1729/events/17286"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 164.1144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/944be117-40a7-4964-b2b8-034582559942",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:37+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1181"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1181%2Fevents%2F11807?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 34.504168ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1181/events/11807",
  "modified": 1658486199315,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1729%2Fevents%2F17286?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 35.940291ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1729/events/17286",
  "modified": 1658486199316,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1441%2Ffacility-use-slots%2F14401?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 1264.021898ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401",
  "modified": 1658486200546,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14433?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1265.7118249999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433",
  "modified": 1658486200548,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C1) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/944be117-40a7-4964-b2b8-034582559942
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Destin.Weissnat@gmail.com",
    "telephone": "1-446-539-6943",
    "givenName": "Medhurst",
    "familyName": "Kamren",
    "identifier": "919be8e7-7dd1-499a-8f86-ef1c3e8e4563"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 443.570579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:42+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2)
...
---
Response status code: 200 OK. Responded in 17.788357ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.236148ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.804142ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.405936ms.
```json
{
  "data": {
    "@context": [
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/944be117-40a7-4964-b2b8-034582559942
...
---
Response status code: 201 Created. Responded in 318.268487ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/944be117-40a7-4964-b2b8-034582559942",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/695",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1181#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/696",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1181#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/697",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1729#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/698",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/699",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14401#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/944be117-40a7-4964-b2b8-034582559942#/orderedItems/700",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14433#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/944be117-40a7-4964-b2b8-034582559942/versions/c804be8d-0c35-42d5-b7f6-57658077405a",
  "payment": {
    "@type": "Payment",
    "identifier": "P33Il8zip",
    "name": "AcmeBroker Points",
