...
⚠️ 27 passed with 0 failures, 465 warnings and 174 suggestions 
...
---
Response status code: 200 OK. Responded in 23.246663ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4081"
}
```
...
---
Response status code: 200 OK. Responded in 16.623659ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3621"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4081?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.906076ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4081",
    "startDate": "2022-07-31T00:08:11+00:00",
    "endDate": "2022-07-31T01:40:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F363%2Fevents%2F3621?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.13278ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3621",
    "startDate": "2022-07-31T12:07:11+00:00",
      ...
      "offers": [
        {
          ...
          "price": 11.01,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT18H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e9921b2e-5452-43ac-84db-8df9d575b634
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4081"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3621"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 281.635098ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e9921b2e-5452-43ac-84db-8df9d575b634",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:52+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4081?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 567.294357ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4081",
  "modified": 1658486394801,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F363%2Fevents%2F3621?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 568.520576ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3621",
  "modified": 1658486394811,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e9921b2e-5452-43ac-84db-8df9d575b634
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "292-430-0105",
    "givenName": "Runolfsson",
    "familyName": "Gordon",
    "identifier": "ba500ffd-f81c-43b8-94e3-396c7c2bc649"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 157.572144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:55+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 63.548585ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 62.712072ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e9921b2e-5452-43ac-84db-8df9d575b634
...
---
Response status code: 201 Created. Responded in 185.585279ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e9921b2e-5452-43ac-84db-8df9d575b634",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e9921b2e-5452-43ac-84db-8df9d575b634#/orderedItems/1172",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e9921b2e-5452-43ac-84db-8df9d575b634#/orderedItems/1173",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e9921b2e-5452-43ac-84db-8df9d575b634#/orderedItems/1174",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/363#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 22.998557ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.067942ms.
```json
{
  "data": {
    "@context": [
