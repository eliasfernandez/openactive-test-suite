...
⚠️ 55 passed with 0 failures, 816 warnings and 222 suggestions 
...
---
Response status code: 200 OK. Responded in 199.420403ms.
```json
{
...
---
Response status code: 200 OK. Responded in 197.245585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 197.078483ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 195.376168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 524.392378ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295",
  "modified": 1658486365374,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295",
    "startDate": "2022-07-23T10:39:23+00:00",
    "endDate": "2022-07-23T11:39:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 522.938865ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2294/events/20294",
  "modified": 1658486365373,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1237.179666ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282",
  "modified": 1658486366088,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1236.146256ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41
...
---
Response status code: 200 OK. Responded in 409.400496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:25+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2295%2Fevents%2F20295?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 301.574075ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295",
  "modified": 1658486367700,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2294%2Fevents%2F20294?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 300.281864ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2294/events/20294",
  "modified": 1658486367701,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2282%2Ffacility-use-slots%2F20282?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 425.505733ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282",
  "modified": 1658486367828,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2281%2Ffacility-use-slots%2F20281?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 428.56956ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281",
  "modified": 1658486367840,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Madelynn42@yahoo.com",
    "telephone": "1-242-899-7375",
    "givenName": "Sporer",
    "familyName": "Garrison",
    "identifier": "07cbd5fb-93a1-416a-b5d9-0b8c6b779ee5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 918.94532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 26.559829ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.808822ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.222017ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.779613ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41
...
---
Response status code: 201 Created. Responded in 365.849753ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2295#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1287",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2295#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2294#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1289",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1290",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41#/orderedItems/1291",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 14.874124ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.147818ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.618814ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.18271ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/9c581dfa-ad14-4bd3-9a30-c9bf4f3b9f41
...
---
Response status code: 400 Bad Request. Responded in 85.789114ms.
```json
{
  "@context": "https://openactive.io/",
