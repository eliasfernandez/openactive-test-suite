...
---
Response status code: 200 OK. Responded in 53.479859ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4315"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F432%2Fevents%2F4315?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.971792ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4315",
    "startDate": "2022-07-26T13:21:11+00:00",
    "endDate": "2022-07-26T15:29:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1e3feb32-a686-4f27-a278-49dbcadd221a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/432/events/4315"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-E9_XClwRVR",
    "accountId": "invalid-OKMell0yr",
    "paymentProviderId": "invalid-M7cSAGcwip"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 28.193953ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1e3feb32-a686-4f27-a278-49dbcadd221a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Reece.Huel43@yahoo.com",
    "telephone": "460-564-8502",
    "givenName": "Murray",
    "familyName": "Vidal",
    "identifier": "b888ae0c-5f03-4588-9f99-f003046c34e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-GWM5h9pkF5",
    "accountId": "invalid-k_SQeiwIbo",
    "paymentProviderId": "invalid-hZVFgERj8y"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 27.595743ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
