...
---
Response status code: 200 OK. Responded in 151.000066ms.
```json
{
...
---
Response status code: 200 OK. Responded in 521.628624ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2509/facility-use-slots/20509",
  "modified": 1658486880564,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:47:58+00:00",
    "endDate": "2022-07-23T11:47:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ecce4c56-4109-4c34-b663-4b794f46bc68
...
---
Response status code: 200 OK. Responded in 297.573025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ecce4c56-4109-4c34-b663-4b794f46bc68",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2509%2Ffacility-use-slots%2F20509?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 853.448115ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2509/facility-use-slots/20509",
  "modified": 1658486881878,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ecce4c56-4109-4c34-b663-4b794f46bc68
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shawn45@hotmail.com",
    "telephone": "(698) 852-9205 x2333",
    "givenName": "Hansen",
    "familyName": "Lonny",
    "identifier": "abbcbf90-bab4-43a8-b019-ca04f1f2cc02"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 293.379187ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:01+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.235484ms.
```json
{
  "data": {
    "@context": [
