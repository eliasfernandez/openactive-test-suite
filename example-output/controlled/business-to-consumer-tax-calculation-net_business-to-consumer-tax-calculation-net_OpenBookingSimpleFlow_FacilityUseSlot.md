...
---
Response status code: 200 OK. Responded in 414.762655ms.
```json
{
...
---
Response status code: 200 OK. Responded in 827.857995ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2532/facility-use-slots/20532",
  "modified": 1658486928124,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:48:45+00:00",
    "endDate": "2022-07-23T11:48:45+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/43779084-25f0-40f1-b9f0-812d945dc862
...
---
Response status code: 200 OK. Responded in 263.632487ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/43779084-25f0-40f1-b9f0-812d945dc862",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:47+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2532%2Ffacility-use-slots%2F20532?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 676.936633ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2532/facility-use-slots/20532",
  "modified": 1658486929246,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/43779084-25f0-40f1-b9f0-812d945dc862
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fay.Lindgren58@gmail.com",
    "telephone": "996.475.2861 x03661",
    "givenName": "Langworth",
    "familyName": "Jaiden",
    "identifier": "c5b08b74-be77-4478-86c9-2b721da95d0a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 157.81613ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 11.996109ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/43779084-25f0-40f1-b9f0-812d945dc862
...
---
Response status code: 201 Created. Responded in 356.926034ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/43779084-25f0-40f1-b9f0-812d945dc862",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43779084-25f0-40f1-b9f0-812d945dc862#/orderedItems/2945",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2532/facility-use-slots/20532#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 56.723114ms.
```json
{
  "data": {
    "@context": [
