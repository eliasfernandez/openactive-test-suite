...
---
Response status code: 200 OK. Responded in 46.11238ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1187"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F119%2Fevents%2F1187?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.840755ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1187",
    "startDate": "2022-07-28T17:16:11+00:00",
    "endDate": "2022-07-28T22:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/96ef27ea-b9d9-4ec9-b393-d3f31deea20b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/119#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1187"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 389.128027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/96ef27ea-b9d9-4ec9-b393-d3f31deea20b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:35+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F119%2Fevents%2F1187?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 458.175244ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1187",
  "modified": 1658486977653,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/96ef27ea-b9d9-4ec9-b393-d3f31deea20b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jedediah_McClure9@gmail.com",
    "telephone": "1-448-442-2697 x71597",
    "givenName": "Schmeler",
    "familyName": "Emily",
    "identifier": "65cdfc5c-f364-4f75-b4d8-1a80e05aafa0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1835.086322ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:38+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 10.640403ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/96ef27ea-b9d9-4ec9-b393-d3f31deea20b
...
---
Response status code: 400 Bad Request. Responded in 1319.973147ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (16.99) does not match expected value (15.99)"
}
```
### Specs
