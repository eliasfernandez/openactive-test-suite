...
⚠️ 86 passed with 0 failures, 1256 warnings and 340 suggestions 
...
---
Response status code: 200 OK. Responded in 14.922178ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/887"
}
```
...
---
Response status code: 200 OK. Responded in 14.01026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1161"
}
```
...
---
Response status code: 200 OK. Responded in 13.166945ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/540"
}
```
...
---
Response status code: 200 OK. Responded in 12.39193ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/547/facility-use-slots/5466"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F887?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.658199ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/887",
    "startDate": "2022-07-23T10:40:11+00:00",
    "endDate": "2022-07-23T13:15:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F117%2Fevents%2F1161?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.309591ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1161",
    "startDate": "2022-07-30T09:40:11+00:00",
    "endDate": "2022-07-30T11:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F54%2Ffacility-use-slots%2F540?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.959086ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/540#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2022-07-23T07:05:11+00:00",
    "endDate": "2022-07-23T07:41:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F547%2Ffacility-use-slots%2F5466?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.605279ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/547",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/547/facility-use-slots/5466#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 7.44,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT8H19M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-22T14:27:12+00:00",
    "endDate": "2022-07-22T20:12:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4b5f1525-f3a2-4674-b0bc-05009ff8e772
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/887"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1161"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/540#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/540"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/547/facility-use-slots/5466#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/547/facility-use-slots/5466"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 226.6887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4b5f1525-f3a2-4674-b0bc-05009ff8e772",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:37:59+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F887?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 451.567066ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/887",
  "modified": 1658485981611,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F117%2Fevents%2F1161?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 452.225879ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1161",
  "modified": 1658485981612,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F54%2Ffacility-use-slots%2F540?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 215.736197ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/54/facility-use-slots/540",
  "modified": 1658485981376,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F547%2Ffacility-use-slots%2F5466?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 217.636232ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/547/facility-use-slots/5466",
  "modified": 1658485981378,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 51.428853ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/24/events/231"
}
```
...
---
Response status code: 200 OK. Responded in 43.925514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4887"
}
```
...
---
Response status code: 200 OK. Responded in 43.079998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113"
}
```
...
---
Response status code: 200 OK. Responded in 42.352084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F24%2Fevents%2F231?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.0202ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/24/events/231",
    "startDate": "2022-07-22T13:56:11+00:00",
    "endDate": "2022-07-22T18:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/24",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/24#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4887?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.626893ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4887",
    "startDate": "2022-07-31T07:21:11+00:00",
    "endDate": "2022-07-31T12:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F12%2Ffacility-use-slots%2F113?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.861938ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 14.72,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 2,
    "startDate": "2022-07-25T22:14:11+00:00",
    "endDate": "2022-07-25T22:59:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F190%2Ffacility-use-slots%2F1898?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.468131ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 12.68,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 4,
    "startDate": "2022-07-25T20:25:11+00:00",
    "endDate": "2022-07-25T22:28:11+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/24#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/24/events/231"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4887"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 302.152798ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:04+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/24"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F24%2Fevents%2F231?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 385.283239ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/24/events/231",
  "modified": 1658485986372,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F489%2Fevents%2F4887?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 387.962688ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/489/events/4887",
  "modified": 1658485986373,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F12%2Ffacility-use-slots%2F113?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 678.735175ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113",
  "modified": 1658485986671,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F190%2Ffacility-use-slots%2F1898?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 674.010787ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898",
  "modified": 1658485986672,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4b5f1525-f3a2-4674-b0bc-05009ff8e772
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joanne_Heathcote@yahoo.com",
    "telephone": "802-284-9151 x771",
    "givenName": "Halvorson",
    "familyName": "Pearline",
    "identifier": "fa31044f-695b-4e39-aca3-6074ca8ae2ac"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 217.308442ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 54.594616ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 54.083106ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.655398ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.477551ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772
...
---
Response status code: 201 Created. Responded in 223.241252ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/99",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/24#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/100",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/24#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/101",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/102",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/103",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/12/facility-use-slots/113#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4b5f1525-f3a2-4674-b0bc-05009ff8e772#/orderedItems/104",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1898#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 11.320409ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.812299ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.363192ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.992684ms.
```json
{
  "data": {
    "@context": [
