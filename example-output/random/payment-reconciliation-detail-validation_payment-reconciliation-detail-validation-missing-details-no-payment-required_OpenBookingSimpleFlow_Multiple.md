...
---
Response status code: 200 OK. Responded in 48.256451ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/367/events/3662"
}
```
...
---
Response status code: 200 OK. Responded in 46.845026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/107/events/1064"
}
```
...
---
Response status code: 200 OK. Responded in 41.560533ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/497/facility-use-slots/4967"
}
```
...
---
Response status code: 200 OK. Responded in 40.464114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/649/facility-use-slots/6489"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F367%2Fevents%2F3662?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.671853ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/367/events/3662",
    "startDate": "2022-07-23T21:43:11+00:00",
    "endDate": "2022-07-23T23:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F107%2Fevents%2F1064?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.058242ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/107/events/1064",
    "startDate": "2022-07-29T19:45:11+00:00",
    "endDate": "2022-07-29T22:54:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F497%2Ffacility-use-slots%2F4967?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.464331ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/497/facility-use-slots/4967#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT15H19M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-28T10:57:12+00:00",
    "endDate": "2022-07-28T13:28:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F649%2Ffacility-use-slots%2F6489?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.972923ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/649",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/649/facility-use-slots/6489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT19H26M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-08-01T05:43:12+00:00",
    "endDate": "2022-08-01T09:36:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bbc82275-d76a-4d7f-9c37-5dfd3188cc6a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/367/events/3662"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/107/events/1064"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/497/facility-use-slots/4967#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/497/facility-use-slots/4967"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/649/facility-use-slots/6489#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/649/facility-use-slots/6489"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 150.515955ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bbc82275-d76a-4d7f-9c37-5dfd3188cc6a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Idella_Wunsch@yahoo.com",
    "telephone": "1-936-820-2623 x5336",
    "givenName": "McDermott",
    "familyName": "Itzel",
    "identifier": "eab5f600-e0c5-4b6e-bf1e-49a11e06854c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 46.548121ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
