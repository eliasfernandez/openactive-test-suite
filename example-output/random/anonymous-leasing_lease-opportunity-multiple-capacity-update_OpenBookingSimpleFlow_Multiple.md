...
⚠️ 53 passed with 0 failures, 714 warnings and 188 suggestions 
...
---
Response status code: 200 OK. Responded in 16.685738ms.
```json
{
...
---
Response status code: 200 OK. Responded in 15.812314ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785"
}
```
...
---
Response status code: 200 OK. Responded in 5.401241ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188",
    "startDate": "2022-07-27T17:04:11+00:00",
    "endDate": "2022-07-27T18:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F579%2Ffacility-use-slots%2F5785?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 5.024231ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT7H45M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-08-01T04:59:12+00:00",
    "endDate": "2022-08-01T10:10:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2609c333-747b-4f04-8f27-61fdab89eacd
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 187.203308ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2609c333-747b-4f04-8f27-61fdab89eacd",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3188?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 354.482192ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188",
  "modified": 1658486699460,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F579%2Ffacility-use-slots%2F5785?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 1222.904147ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785",
  "modified": 1658486700329,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/148c1ecb-7d15-42c8-9142-3dc7d186ff92
...
---
Response status code: 409 Conflict. Responded in 624.058551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/148c1ecb-7d15-42c8-9142-3dc7d186ff92",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 22.405869ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.27354ms.
```json
{
  "data": {
    "@context": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/218017d5-6ce5-45c1-90db-a4a46530750f
...
---
Response status code: 200 OK. Responded in 500.139503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/218017d5-6ce5-45c1-90db-a4a46530750f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3188?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 160.903687ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188",
  "modified": 1658486705722,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F579%2Ffacility-use-slots%2F5785?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 377.351184ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/579/facility-use-slots/5785",
  "modified": 1658486705939,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/88f4b803-fbd2-4dca-900c-ff0ab0e55678
...
---
Response status code: 409 Conflict. Responded in 958.131836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/88f4b803-fbd2-4dca-900c-ff0ab0e55678",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 7.964002ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 6.854874ms.
```json
{
  "data": {
    "@context": [
