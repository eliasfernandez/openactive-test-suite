...
---
Response status code: 200 OK. Responded in 11.517089ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4755"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F476%2Ffacility-use-slots%2F4755?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.04905ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4755#/offers/0",
        ...
        "price": 12.61,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT8H31M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-26T00:23:12+00:00",
    "endDate": "2022-07-26T04:01:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66cdb725-42d8-4ab2-adbf-caf5e879c808
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4755#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4755"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 102.923084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/66cdb725-42d8-4ab2-adbf-caf5e879c808",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F476%2Ffacility-use-slots%2F4755?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 670.103866ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4755",
  "modified": 1658486212525,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66cdb725-42d8-4ab2-adbf-caf5e879c808
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Collin.OConner@yahoo.com",
    "telephone": "1-453-233-1542 x7819",
    "givenName": "Romaguera",
    "familyName": "Keon",
    "identifier": "a30e04a0-b8e1-4996-905a-18191cf4b1d7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 227.750927ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/66cdb725-42d8-4ab2-adbf-caf5e879c808
...
---
Response status code: 409 Conflict. Responded in 91.170392ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/66cdb725-42d8-4ab2-adbf-caf5e879c808",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
