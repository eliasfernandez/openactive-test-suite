...
---
Response status code: 200 OK. Responded in 10.81549ms.
```json
{
...
---
Response status code: 200 OK. Responded in 706.453122ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2294/facility-use-slots/20294",
  "modified": 1658486386150,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:44+00:00",
    "endDate": "2022-07-23T11:39:44+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3
...
---
Response status code: 200 OK. Responded in 181.849924ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:45+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2294%2Ffacility-use-slots%2F20294?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1316.656937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2294/facility-use-slots/20294",
  "modified": 1658486387844,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shane51@hotmail.com",
    "telephone": "1-410-689-6041",
    "givenName": "Yost",
    "familyName": "Sadie",
    "identifier": "73228d03-7828-4eaf-8843-fa87a3042877"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 269.333157ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:47+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 12.566305ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3
...
---
Response status code: 201 Created. Responded in 81.601884ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3#/orderedItems/1360",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2294/facility-use-slots/20294#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3/versions/bba588c5-d97e-4857-ae82-814143ad2f61",
  "payment": {
    "@type": "Payment",
    "identifier": "pPFdX6eBE",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a3454f31-82c1-4d13-b6c3-37c6bc7a5af3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3


---
Response status code: 200 OK. Responded in 3.971233ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'a3454f31-82c1-4d13-b6c3-37c6bc7a5af3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 170.51213ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a3454f31-82c1-4d13-b6c3-37c6bc7a5af3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3


---
Response status code: 200 OK. Responded in 1971.313025ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "modified": 637940831875964200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
    "identifier": "a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
...
---
Response status code: 200 OK. Responded in 19.708065ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831875964131&afterId=a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "message": "Listening for UUID: 'a3454f31-82c1-4d13-b6c3-37c6bc7a5af3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3
...
---
Response status code: 201 Created. Responded in 185.786157ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "identifier": "a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 849.722593ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a3454f31-82c1-4d13-b6c3-37c6bc7a5af3",
  "modified": 637940831898678000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 3.911933ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/a3454f31-82c1-4d13-b6c3-37c6bc7a5af3
...
---
Response status code: 400 Bad Request. Responded in 28.298436ms.
```json
{
  "@context": "https://openactive.io/",
