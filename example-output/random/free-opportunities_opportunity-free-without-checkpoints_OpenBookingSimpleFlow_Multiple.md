...
⚠️ 19 passed with 0 failures, 352 warnings and 92 suggestions 
...
---
Response status code: 200 OK. Responded in 34.435707ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/790/events/7893"
}
```
...
---
Response status code: 200 OK. Responded in 32.553157ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/309/events/3083"
}
```
...
---
Response status code: 200 OK. Responded in 31.060018ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 30.00309ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1344"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F790%2Fevents%2F7893?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.158157ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/790/events/7893",
    "startDate": "2022-07-23T04:38:11+00:00",
    "endDate": "2022-07-23T06:33:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/790",
      "name": "Fresh Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/790#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT20H26M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F309%2Fevents%2F3083?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 20.458238ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/309/events/3083",
    "startDate": "2022-07-26T00:16:11+00:00",
    "endDate": "2022-07-26T02:14:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/309",
      "name": "Frozen Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/309#/offers/0",
...
---
Response status code: 200 OK. Responded in 19.858123ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT2H11M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-30T07:51:12+00:00",
    "endDate": "2022-07-30T12:15:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F135%2Ffacility-use-slots%2F1344?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.284608ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1344#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 4,
    "startDate": "2022-07-30T20:07:11+00:00",
    "endDate": "2022-07-30T21:17:11+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kaleigh_Lowe@yahoo.com",
    "telephone": "(817) 854-0688 x1783",
    "givenName": "Bauch",
    "familyName": "Pearl",
    "identifier": "6df83625-9c87-48d0-a3f1-5dcfcd1c21cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/790#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/790/events/7893"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/309#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/309/events/3083"
    },
    {
      "@type": "OrderItem",
      "position": 3,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1344#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1344"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 657.986985ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1979",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/790#/offers/0",
        "allowCustomerCancellationFullRefund": false,
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/790"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1980",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/790#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1981",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/309#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1982",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1983",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f31e8989-dd9f-4ee4-bd83-e8482cbbd85f#/orderedItems/1984",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1344#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F790%2Fevents%2F7893?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 33.925465ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F309%2Fevents%2F3083?useCacheIfAvailable=true&expectedCapacity=25


---
Response status code: 200 OK. Responded in 32.514429ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3914?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 31.439601ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F135%2Ffacility-use-slots%2F1344?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 30.833586ms.
```json
{
  "data": {
    "@context": [
