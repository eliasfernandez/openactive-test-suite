...
---
Response status code: 200 OK. Responded in 16.92892ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1493/facility-use-slots/14925"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1493%2Ffacility-use-slots%2F14925?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.527123ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1493",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1493/facility-use-slots/14925#/offers/0",
        ...
        "price": 8.99,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT20H28M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-29T05:45:12+00:00",
    "endDate": "2022-07-29T10:43:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bc0eb5e5-7a7c-4358-8ac3-379bae393c34
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1493/facility-use-slots/14925#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1493/facility-use-slots/14925"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 227.5113ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bc0eb5e5-7a7c-4358-8ac3-379bae393c34",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1493%2Ffacility-use-slots%2F14925?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 724.644395ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1493/facility-use-slots/14925",
  "modified": 1658486987921,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bc0eb5e5-7a7c-4358-8ac3-379bae393c34
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nia_Simonis@gmail.com",
    "telephone": "240.790.7856 x78622",
    "givenName": "Pollich",
    "familyName": "Juwan",
    "identifier": "736c493a-a20a-432a-96f7-194e8c37f4f1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 778.213705ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.062795ms.
```json
{
  "data": {
    "@context": [
