...
---
Response status code: 200 OK. Responded in 11.471813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F642%2Ffacility-use-slots%2F6415?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.265079ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/642",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 15.06,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT10H52M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-27T15:06:12+00:00",
    "endDate": "2022-07-27T18:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 786.13269ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/642"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-27T15:06:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F642%2Ffacility-use-slots%2F6415?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 779.492468ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415",
  "modified": 1658487017347,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kenton.Mayer@hotmail.com",
    "telephone": "802-935-5222",
    "givenName": "Wiza",
    "familyName": "Odie",
    "identifier": "a89218cb-2172-4586-bde8-2aa5c6aace3a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1700.930169ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:17+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 17.828731ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9
...
---
Response status code: 201 Created. Responded in 600.668948ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1e54ebd9-bf4a-4b8c-86b1-77e322a8f1f9#/orderedItems/2893",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/642/facility-use-slots/6415#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 7.402519ms.
```json
{
  "data": {
    "@context": [
