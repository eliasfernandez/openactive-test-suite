...
---
Response status code: 200 OK. Responded in 23.136299ms.
```json
{
...
---
Response status code: 200 OK. Responded in 489.974516ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2347/facility-use-slots/20347",
  "modified": 1658486491770,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:41:30+00:00",
    "endDate": "2022-07-23T11:41:30+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d98b38ca-4be6-427a-9a42-cef9c60f0520
...
---
Response status code: 200 OK. Responded in 229.896279ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d98b38ca-4be6-427a-9a42-cef9c60f0520",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:30+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2347%2Ffacility-use-slots%2F20347?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1081.597407ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2347/facility-use-slots/20347",
  "modified": 1658486493224,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d98b38ca-4be6-427a-9a42-cef9c60f0520
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rollin20@gmail.com",
    "telephone": "1-334-805-2846 x219",
    "givenName": "Bode",
    "familyName": "Stephany",
    "identifier": "faa28932-d6b3-49b6-bd44-7961d357f9fe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 131.105228ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:32+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 8.02507ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d98b38ca-4be6-427a-9a42-cef9c60f0520
...
---
Response status code: 201 Created. Responded in 101.792276ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d98b38ca-4be6-427a-9a42-cef9c60f0520",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d98b38ca-4be6-427a-9a42-cef9c60f0520#/orderedItems/1705",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2347/facility-use-slots/20347#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 15.963437ms.
```json
{
  "data": {
    "@context": [
