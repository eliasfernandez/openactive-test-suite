...
⚠️ 34 passed with 0 failures, 624 warnings and 162 suggestions 
...
---
Response status code: 200 OK. Responded in 27.710341ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/508/events/5073"
}
```
...
---
Response status code: 200 OK. Responded in 26.404921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/22/events/220"
}
```
...
---
Response status code: 200 OK. Responded in 21.225039ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5271"
}
```
...
---
Response status code: 200 OK. Responded in 20.284423ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3131"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F508%2Fevents%2F5073?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.518643ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/508/events/5073",
    "startDate": "2022-07-24T04:40:11+00:00",
    "endDate": "2022-07-24T08:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/508",
      "name": "Steel Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/508#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT16H55M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F22%2Fevents%2F220?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.061635ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/22/events/220",
    "startDate": "2022-07-28T10:53:11+00:00",
    "endDate": "2022-07-28T15:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/22",
      "name": "Wooden Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/22#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F528%2Ffacility-use-slots%2F5271?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.490462ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5271#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ],
        "price": 18.77,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT12H55M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-29T08:26:12+00:00",
    "endDate": "2022-07-29T13:47:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F314%2Ffacility-use-slots%2F3131?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.009955ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3131#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-25T01:10:12+00:00",
    "endDate": "2022-07-25T06:44:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3deb7ade-dcac-4f13-8d41-a15db0c9725b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/508#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/508/events/5073"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/22#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/22/events/220"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5271#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5271"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3131#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3131"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 403.253225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3deb7ade-dcac-4f13-8d41-a15db0c9725b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:57+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/22"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/528"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-29T08:26:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F508%2Fevents%2F5073?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 107.865319ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F22%2Fevents%2F220?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 116.516856ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F528%2Ffacility-use-slots%2F5271?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 181.099086ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5271",
  "modified": 1658486339320,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F314%2Ffacility-use-slots%2F3131?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 185.676959ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3131",
  "modified": 1658486339325,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3deb7ade-dcac-4f13-8d41-a15db0c9725b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alexys.Kirlin@yahoo.com",
    "telephone": "757.491.9126",
    "givenName": "Hilpert",
    "familyName": "Edwin",
    "identifier": "f3536da6-b9ef-4744-8318-5e6d0824f83c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 77.480777ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3deb7ade-dcac-4f13-8d41-a15db0c9725b
...
---
Response status code: 409 Conflict. Responded in 170.251687ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3deb7ade-dcac-4f13-8d41-a15db0c9725b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
