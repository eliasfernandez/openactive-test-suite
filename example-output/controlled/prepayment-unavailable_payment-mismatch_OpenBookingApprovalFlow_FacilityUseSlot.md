[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:47:53 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 62.325064ms.
```json
{
...
---
Response status code: 200 OK. Responded in 507.762793ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516",
  "modified": 1658486891889,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0467f0fb-08e9-4253-a996-71e3adad5391
...
---
Response status code: 200 OK. Responded in 184.476868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0467f0fb-08e9-4253-a996-71e3adad5391",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:10+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2516%2Ffacility-use-slots%2F20516?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 335.187632ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516",
  "modified": 1658486892593,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0467f0fb-08e9-4253-a996-71e3adad5391
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Juvenal_Erdman@hotmail.com",
    "telephone": "(516) 735-4792 x832",
    "givenName": "Zboncak",
    "familyName": "Roberto",
    "identifier": "9a1c144e-0d90-4215-9817-3ee17edc49ba"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 588.631624ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.085446ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0467f0fb-08e9-4253-a996-71e3adad5391
...
---
Response status code: 400 Bad Request. Responded in 290.534127ms.
```json
{
  "@context": "https://openactive.io/",
