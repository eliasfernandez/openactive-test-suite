...
⚠️ 59 passed with 0 failures, 952 warnings and 246 suggestions 
...
---
Response status code: 200 OK. Responded in 29.015983ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13799"
}
```
...
---
Response status code: 200 OK. Responded in 27.221697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1314/events/13134"
}
```
...
---
Response status code: 200 OK. Responded in 25.701724ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175"
}
```
...
---
Response status code: 200 OK. Responded in 24.740179ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1314/facility-use-slots/13136"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1380%2Fevents%2F13799?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.966128ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13799",
    "startDate": "2022-07-22T13:57:11+00:00",
    "endDate": "2022-07-22T14:54:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1380",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1380#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT17H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1314%2Fevents%2F13134?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.286395ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1314/events/13134",
    "startDate": "2022-07-29T04:14:11+00:00",
    "endDate": "2022-07-29T06:17:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1314",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1314#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1018%2Ffacility-use-slots%2F10175?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.93215ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1018",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-22T19:48:12+00:00",
    "endDate": "2022-07-23T00:06:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1314%2Ffacility-use-slots%2F13136?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.324421ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1314",
      "name": "Fresh Swimming Pool Hall",
      "facilityType": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1314/facility-use-slots/13136#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 8,
    "startDate": "2022-08-01T00:00:12+00:00",
    "endDate": "2022-08-01T05:26:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/38a1f621-10fb-4d61-91bf-02c9cd78a66c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1380#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1380/events/13799"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1314#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1314/events/13134"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1314/facility-use-slots/13136#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1314/facility-use-slots/13136"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 377.708386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:04+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1380"
        },
        "maximumAttendeeCapacity": 33,
        "remainingAttendeeCapacity": 33
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1314"
        },
        "maximumAttendeeCapacity": 36,
        "remainingAttendeeCapacity": 36
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1018"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-22T19:48:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1380%2Fevents%2F13799?useCacheIfAvailable=true&expectedCapacity=31


---
Response status code: 200 OK. Responded in 46.547213ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1314%2Fevents%2F13134?useCacheIfAvailable=true&expectedCapacity=35


---
Response status code: 200 OK. Responded in 49.544759ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1018%2Ffacility-use-slots%2F10175?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 48.066636ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1314%2Ffacility-use-slots%2F13136?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 51.56199ms.
```json
{
  "data": {
    "@context": [
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/38a1f621-10fb-4d61-91bf-02c9cd78a66c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Reyes84@yahoo.com",
    "telephone": "1-974-805-7821 x780",
    "givenName": "Cronin",
    "familyName": "Judge",
    "identifier": "0bc526ae-5017-42ed-8892-8706e46fb7aa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1485.689245ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 31.091302ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 29.632078ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.463559ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.786319ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/38a1f621-10fb-4d61-91bf-02c9cd78a66c
...
---
Response status code: 201 Created. Responded in 701.737429ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1781",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1380#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1782",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1380#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1783",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1314#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1784",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1785",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1018/facility-use-slots/10175#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c#/orderedItems/1786",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1314/facility-use-slots/13136#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/38a1f621-10fb-4d61-91bf-02c9cd78a66c/versions/16c4d27c-ba24-48b6-9fa0-34c7f01fb154",
  "payment": {
    "@type": "Payment",
    "identifier": "dQxihhbFJ",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;38a1f621-10fb-4d61-91bf-02c9cd78a66c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/38a1f621-10fb-4d61-91bf-02c9cd78a66c


---
Response status code: 200 OK. Responded in 11.456485ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833871308218&afterId=8e2cd437-8dda-40c9-8f42-167bab104f92",
  "message": "Listening for UUID: '38a1f621-10fb-4d61-91bf-02c9cd78a66c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 20.860437ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;38a1f621-10fb-4d61-91bf-02c9cd78a66c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/38a1f621-10fb-4d61-91bf-02c9cd78a66c


---
Response status code: 200 OK. Responded in 2251.078844ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "modified": 637940833920932000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/38a1f621-10fb-4d61-91bf-02c9cd78a66c",
    "identifier": "38a1f621-10fb-4d61-91bf-02c9cd78a66c",
...
---
Response status code: 200 OK. Responded in 12.619604ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940833920931915&afterId=38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "message": "Listening for UUID: '38a1f621-10fb-4d61-91bf-02c9cd78a66c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c
...
---
Response status code: 201 Created. Responded in 324.983347ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "identifier": "38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 8.074023ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "38a1f621-10fb-4d61-91bf-02c9cd78a66c",
  "modified": 637940833944689700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 25.261195ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.738653ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.613857ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.00244ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/38a1f621-10fb-4d61-91bf-02c9cd78a66c
...
---
Response status code: 400 Bad Request. Responded in 20.923776ms.
```json
{
  "@context": "https://openactive.io/",
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
