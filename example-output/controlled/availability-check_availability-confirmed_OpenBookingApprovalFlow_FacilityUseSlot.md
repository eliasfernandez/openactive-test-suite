...
---
Response status code: 200 OK. Responded in 11.548096ms.
```json
{
...
---
Response status code: 200 OK. Responded in 448.00583ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291",
  "modified": 1658486383638,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:42+00:00",
    "endDate": "2022-07-23T11:39:42+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/26564d5e-c904-4ec3-9b81-a97a9a79db66
...
---
Response status code: 200 OK. Responded in 156.873507ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/26564d5e-c904-4ec3-9b81-a97a9a79db66",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:42+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2291%2Ffacility-use-slots%2F20291?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1076.897127ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291",
  "modified": 1658486385050,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/26564d5e-c904-4ec3-9b81-a97a9a79db66
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amya38@yahoo.com",
    "telephone": "1-650-208-9461 x01572",
    "givenName": "O'Reilly",
    "familyName": "Uriah",
    "identifier": "1857d23b-44ed-4756-81e4-addbf25ab01b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 60.731509ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 17.755749ms.
```json
{
  "data": {
    "@context": [
