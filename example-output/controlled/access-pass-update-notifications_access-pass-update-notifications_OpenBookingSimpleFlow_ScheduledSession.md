...
---
Response status code: 200 OK. Responded in 123.791749ms.
```json
{
...
---
Response status code: 200 OK. Responded in 597.430979ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2207/events/20207",
  "modified": 1658486230797,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2207/events/20207",
    "startDate": "2022-07-23T10:37:09+00:00",
    "endDate": "2022-07-23T11:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d
...
---
Response status code: 200 OK. Responded in 101.063075ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2207%2Fevents%2F20207?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 225.636929ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2207/events/20207",
  "modified": 1658486231650,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dahlia73@gmail.com",
    "telephone": "(496) 846-1359 x413",
    "givenName": "Kovacek",
    "familyName": "Fritz",
    "identifier": "255643dc-365a-47a3-95d6-e4d355be1bf6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 84.440557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.012339ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d
...
---
Response status code: 201 Created. Responded in 73.382772ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d#/orderedItems/888",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2207#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 29.290829ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d


---
Response status code: 200 OK. Responded in 16.892432ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 36.105982ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessPassUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d


---
Response status code: 200 OK. Responded in 2106.188026ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d",
  "modified": 637940830330180400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d",
    "identifier": "907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/907439f5-7ac8-4b90-8f3f-9dbb7ee6f49d#/orderedItems/888",
