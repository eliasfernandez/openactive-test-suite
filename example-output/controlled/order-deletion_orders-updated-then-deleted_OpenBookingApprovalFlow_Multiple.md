[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:23 GMT+0000 (Coordinated Universal Time)
...
⚠️ 64 passed with 0 failures, 953 warnings and 246 suggestions 
...
---
Response status code: 200 OK. Responded in 97.473071ms.
```json
{
...
---
Response status code: 200 OK. Responded in 65.73462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 93.072836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 91.176222ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 533.282819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176",
  "modified": 1658486195302,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176",
    "startDate": "2022-07-23T10:36:33+00:00",
    "endDate": "2022-07-23T11:36:33+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 529.784492ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175",
  "modified": 1658486195300,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 503.714285ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2166/facility-use-slots/20166",
  "modified": 1658486195273,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 502.645177ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c3e3e8e4-289a-4776-81db-b1bf41b7ec84
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2175#/offers/0",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165#/offers/0",
...
---
Response status code: 200 OK. Responded in 240.846706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:34+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2175"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2176%2Fevents%2F20176?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 773.183217ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176",
  "modified": 1658486196918,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2175%2Fevents%2F20175?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 772.395811ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2166%2Ffacility-use-slots%2F20166?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 914.715536ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2166/facility-use-slots/20166",
  "modified": 1658486197057,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2165%2Ffacility-use-slots%2F20165?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 914.381234ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c3e3e8e4-289a-4776-81db-b1bf41b7ec84
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sterling29@hotmail.com",
    "telephone": "(804) 408-9252 x9711",
    "givenName": "Reynolds",
    "familyName": "Bridget",
    "identifier": "49618e9d-9778-404d-a3a4-a10333feb0c0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 219.204434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 27.79072ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.006214ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.389409ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 25.941805ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c3e3e8e4-289a-4776-81db-b1bf41b7ec84
...
---
Response status code: 201 Created. Responded in 501.565168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/799",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2176#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/800",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2176#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/801",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2175#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/802",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2166/facility-use-slots/20166#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/803",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2166/facility-use-slots/20166#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84#/orderedItems/804",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c3e3e8e4-289a-4776-81db-b1bf41b7ec84/versions/412e093b-c71f-4a6a-beb4-6302184f2a6e",
  "payment": {
    "@type": "Payment",
    "identifier": "bIAr6IMf4",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c3e3e8e4-289a-4776-81db-b1bf41b7ec84&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c3e3e8e4-289a-4776-81db-b1bf41b7ec84


---
Response status code: 200 OK. Responded in 8.271662ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829930402112&afterId=91c3c324-40cc-4046-96bb-76e20cd15b88",
  "message": "Listening for UUID: 'c3e3e8e4-289a-4776-81db-b1bf41b7ec84' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 14.513108ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c3e3e8e4-289a-4776-81db-b1bf41b7ec84&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c3e3e8e4-289a-4776-81db-b1bf41b7ec84


---
Response status code: 200 OK. Responded in 2368.642237ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "modified": 637940829983572200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
    "identifier": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
...
---
Response status code: 200 OK. Responded in 35.312073ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829983572199&afterId=c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "message": "Listening for UUID: 'c3e3e8e4-289a-4776-81db-b1bf41b7ec84' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84
...
---
Response status code: 201 Created. Responded in 339.085727ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "identifier": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 20.140551ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "modified": 637940830009504400
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 15.092413ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.094236ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.641433ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 18.462238ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;c3e3e8e4-289a-4776-81db-b1bf41b7ec84&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/c3e3e8e4-289a-4776-81db-b1bf41b7ec84


---
Response status code: 200 OK. Responded in 45.456542ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940829913053931&afterId=86aaf665-6e97-4931-91dc-3a22d49f4bbe",
  "message": "Listening for UUID: 'c3e3e8e4-289a-4776-81db-b1bf41b7ec84' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 660.007854ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;c3e3e8e4-289a-4776-81db-b1bf41b7ec84&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/c3e3e8e4-289a-4776-81db-b1bf41b7ec84


---
Response status code: 200 OK. Responded in 1690.148287ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "modified": 637940830080243700,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
## Orders Feed (after Simulate Seller Cancellation (Test Interface Action)) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action))
### Specs
* ✅ should return 200 on success for request relevant to OrderItem 0
* ✅ should return 200 on success for request relevant to OrderItem 1
* ✅ should return 200 on success for request relevant to OrderItem 2
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Simulate Seller Cancellation (Test Interface Action)) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 11.403207ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940830080243669&afterId=c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "message": "Listening for UUID: 'c3e3e8e4-289a-4776-81db-b1bf41b7ec84' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/c3e3e8e4-289a-4776-81db-b1bf41b7ec84
...
---
Response status code: 204 No Content. Responded in 196.079049ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
...
---
Response status code: 200 OK. Responded in 2111.003386ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c3e3e8e4-289a-4776-81db-b1bf41b7ec84",
  "modified": 637940830156545200
}
```
### Specs
* ✅ should return 200 on success
