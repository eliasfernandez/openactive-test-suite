...
---
Response status code: 200 OK. Responded in 98.320959ms.
```json
{
...
---
Response status code: 200 OK. Responded in 536.218585ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2394/events/20394",
  "modified": 1658486583400,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2394/events/20394",
    "startDate": "2022-07-23T10:43:01+00:00",
    "endDate": "2022-07-23T11:43:01+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0b2782dc-3d00-40c6-a5c2-2c3b8968a5e0
...
---
Response status code: 200 OK. Responded in 204.405786ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0b2782dc-3d00-40c6-a5c2-2c3b8968a5e0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:48:02+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2394%2Fevents%2F20394?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 852.180073ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2394/events/20394",
  "modified": 1658486584806,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0b2782dc-3d00-40c6-a5c2-2c3b8968a5e0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marcos_Waelchi82@hotmail.com",
    "telephone": "956.428.3966 x6531",
    "givenName": "Schimmel",
    "familyName": "Vada",
    "identifier": "de10dd09-577d-464d-ae5c-d6aecbaef355"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 233.8811ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.051232ms.
```json
{
  "data": {
    "@context": [
