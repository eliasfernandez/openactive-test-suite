...
⚠️ 25 passed with 0 failures, 224 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 225.052649ms.
```json
{
...
---
Response status code: 200 OK. Responded in 519.898033ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2002/events/20002",
  "modified": 1658485959264,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/959e4a10-b366-4fa6-8c8b-cc0ea80ac703
...
---
Response status code: 200 OK. Responded in 554.886852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/959e4a10-b366-4fa6-8c8b-cc0ea80ac703",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:37:38+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2002%2Fevents%2F20002?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 218.768792ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2002/events/20002",
  "modified": 1658485960758,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/959e4a10-b366-4fa6-8c8b-cc0ea80ac703
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Terrill.Wyman21@gmail.com",
    "telephone": "343.270.0742 x8409",
    "givenName": "Veum",
    "familyName": "Coy",
    "identifier": "f6bed5c2-b063-43c1-9cb5-8324cc301c1b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 213.504244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 38.331149ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.939855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 322.582937ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2007/events/20007",
  "modified": 1658485961740,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Grant32@hotmail.com",
    "telephone": "750-297-4588 x9857",
    "givenName": "Vandervort",
    "familyName": "Seth",
    "identifier": "e6414ba7-c3c6-4339-b6f5-25c1fa3bc243"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 82.044947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2007%2Fevents%2F20007?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 700.85768ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2007/events/20007",
  "modified": 1658485962835,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/959e4a10-b366-4fa6-8c8b-cc0ea80ac703
...
---
Response status code: 201 Created. Responded in 436.298172ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/959e4a10-b366-4fa6-8c8b-cc0ea80ac703",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/959e4a10-b366-4fa6-8c8b-cc0ea80ac703#/orderedItems/14",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2007#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 23.486414ms.
```json
{
  "data": {
    "@context": [
