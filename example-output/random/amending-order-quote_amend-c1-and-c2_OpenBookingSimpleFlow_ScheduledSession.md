...
⚠️ 25 passed with 0 failures, 299 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 63.935676ms.
```json
{
...
---
Response status code: 200 OK. Responded in 8.310953ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/268/events/2678",
    "startDate": "2022-07-31T05:03:11+00:00",
    "endDate": "2022-07-31T08:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4d25110c-7144-4a0c-bc68-bba6ae43aaf6
...
---
Response status code: 200 OK. Responded in 352.747491ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4d25110c-7144-4a0c-bc68-bba6ae43aaf6",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F268%2Fevents%2F2678?useCacheIfAvailable=true&expectedCapacity=24


---
Response status code: 200 OK. Responded in 74.553172ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/268/events/2678",
  "modified": 1658485967777,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4d25110c-7144-4a0c-bc68-bba6ae43aaf6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Stewart48@gmail.com",
    "telephone": "1-686-313-7529",
    "givenName": "Moen",
    "familyName": "Daryl",
    "identifier": "f5bffcfc-a60a-4c88-812e-d88da080840c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 382.540939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 4.784088ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 5.230496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/87/events/866"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F87%2Fevents%2F866?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.005611ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/87/events/866",
    "startDate": "2022-07-29T15:13:11+00:00",
    "endDate": "2022-07-29T21:10:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/87/events/866"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 269.937167ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F87%2Fevents%2F866?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 154.667446ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/87/events/866",
  "modified": 1658485970390,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
---
Response status code: 200 OK. Responded in 71.728591ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 22.873275ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4d25110c-7144-4a0c-bc68-bba6ae43aaf6
...
---
Response status code: 201 Created. Responded in 184.974244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4d25110c-7144-4a0c-bc68-bba6ae43aaf6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4d25110c-7144-4a0c-bc68-bba6ae43aaf6#/orderedItems/17",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/87#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 7.300052ms.
```json
{
  "data": {
    "@context": [
