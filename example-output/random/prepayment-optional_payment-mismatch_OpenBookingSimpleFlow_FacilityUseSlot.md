...
---
Response status code: 200 OK. Responded in 13.928769ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/11/facility-use-slots/102"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F11%2Ffacility-use-slots%2F102?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.467186ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/11",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/11/facility-use-slots/102#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2022-07-24T08:47:11+00:00",
    "endDate": "2022-07-24T14:16:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c88fc829-bfef-4182-b3d2-43bf186466af
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/11/facility-use-slots/102#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/11/facility-use-slots/102"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 285.375315ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c88fc829-bfef-4182-b3d2-43bf186466af",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F11%2Ffacility-use-slots%2F102?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 287.295252ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/11/facility-use-slots/102",
  "modified": 1658486934564,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c88fc829-bfef-4182-b3d2-43bf186466af
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Henri69@yahoo.com",
    "telephone": "1-206-615-7891 x0379",
    "givenName": "Jenkins",
    "familyName": "Leann",
    "identifier": "dabb6d49-c7c6-439c-9416-f4f264cb03ff"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 722.942472ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.323038ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c88fc829-bfef-4182-b3d2-43bf186466af
...
---
Response status code: 400 Bad Request. Responded in 894.546788ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (19.88) does not match expected value (18.88)"
}
```
### Specs
