[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:35:18 GMT+0000 (Coordinated Universal Time)
...
⚠️ 40 passed with 0 failures, 550 warnings and 144 suggestions 
...
---
Response status code: 200 OK. Responded in 32.278052ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/96/events/954"
}
```
...
---
Response status code: 200 OK. Responded in 31.180033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/307/events/3070"
}
```
...
---
Response status code: 200 OK. Responded in 30.42372ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/853/facility-use-slots/8523"
}
```
...
---
Response status code: 200 OK. Responded in 30.771026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/6"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F96%2Fevents%2F954?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.273559ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/96/events/954",
    "startDate": "2022-07-23T01:07:11+00:00",
    "endDate": "2022-07-23T05:30:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/96",
      "name": "Soft Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/96#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F307%2Fevents%2F3070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.948553ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/307/events/3070",
    "startDate": "2022-07-23T11:52:11+00:00",
    "endDate": "2022-07-23T13:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/307",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/307#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F853%2Ffacility-use-slots%2F8523?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.620447ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/853",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/853/facility-use-slots/8523#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 14.49,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT19H32M"
      }
    ],
    "remainingUses": 0,
    "startDate": "2022-07-29T01:33:12+00:00",
    "endDate": "2022-07-29T03:09:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1%2Ffacility-use-slots%2F6?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.757633ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/6#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 13.6,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-25T11:24:11+00:00",
    "endDate": "2022-07-25T14:22:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/49092e8f-fa73-4274-a342-3935d74dfa04
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/96#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/96/events/954"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/307#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/307/events/3070"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/853/facility-use-slots/8523#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/853/facility-use-slots/8523"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/6#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/6"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 34.581835ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/49092e8f-fa73-4274-a342-3935d74dfa04",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/96"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/307"
        },
        "maximumAttendeeCapacity": 31,
        "remainingAttendeeCapacity": 31
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/853"
        },
        "maximumUses": 0,
        "remainingUses": 0,
        "startDate": "2022-07-29T01:33:12+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/49092e8f-fa73-4274-a342-3935d74dfa04
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Felton.Denesik@yahoo.com",
    "telephone": "868-778-4551 x94406",
    "givenName": "Gislason",
    "familyName": "Jordon",
    "identifier": "491503ba-567f-4098-8e8e-d92d22d54556"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 100.126649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
