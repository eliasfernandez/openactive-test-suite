[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:44:30 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 15.921543ms.
```json
{
...
---
Response status code: 200 OK. Responded in 15.855342ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 729.231045ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444",
  "modified": 1658486690758,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444",
    "startDate": "2022-07-23T10:44:49+00:00",
    "endDate": "2022-07-23T11:44:49+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 756.710492ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2432/facility-use-slots/20432",
  "modified": 1658486690788,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/206df60d-9986-4b28-975d-af97ee73c7fc
...
---
Response status code: 200 OK. Responded in 546.258003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/206df60d-9986-4b28-975d-af97ee73c7fc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:50+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2444%2Fevents%2F20444?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 256.139399ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444",
  "modified": 1658486692074,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2432%2Ffacility-use-slots%2F20432?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 413.738214ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2432/facility-use-slots/20432",
  "modified": 1658486692234,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/206df60d-9986-4b28-975d-af97ee73c7fc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anissa.Wehner@yahoo.com",
    "telephone": "921-415-3798 x3071",
    "givenName": "Senger",
    "familyName": "Tre",
    "identifier": "8a9b90a1-e661-43b6-b57d-8c3f7493be0e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 399.295984ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:49:51+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 14.938734ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.100426ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/206df60d-9986-4b28-975d-af97ee73c7fc
...
---
Response status code: 400 Bad Request. Responded in 355.026486ms.
```json
{
  "@context": "https://openactive.io/",
