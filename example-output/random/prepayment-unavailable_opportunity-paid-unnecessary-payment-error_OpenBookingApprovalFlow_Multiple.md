...
⚠️ 43 passed with 0 failures, 552 warnings and 150 suggestions 
...
---
Response status code: 200 OK. Responded in 28.208895ms.
```json
{
...
---
Response status code: 200 OK. Responded in 27.049475ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12704"
}
```
...
---
Response status code: 200 OK. Responded in 26.382263ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1428/facility-use-slots/14272"
}
```
...
---
Response status code: 200 OK. Responded in 21.561478ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1585/facility-use-slots/15847"
}
```
...
---
Response status code: 200 OK. Responded in 31.546154ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1009/events/10085",
    "startDate": "2022-07-31T23:03:11+00:00",
    "endDate": "2022-07-31T23:40:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1271%2Fevents%2F12704?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.170146ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12704",
    "startDate": "2022-07-23T03:24:11+00:00",
    "endDate": "2022-07-23T04:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1428%2Ffacility-use-slots%2F14272?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.79824ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1428",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1428/facility-use-slots/14272#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        ...
        "price": 8.55,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT20H11M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-30T00:23:12+00:00",
    "endDate": "2022-07-30T06:02:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1585%2Ffacility-use-slots%2F15847?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.404533ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1585/facility-use-slots/15847#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT5H44M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-27T00:28:12+00:00",
    "endDate": "2022-07-27T06:25:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66cb15d2-5d82-4540-ba7a-40fe61e590bd
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12704"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1428/facility-use-slots/14272#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1428/facility-use-slots/14272"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1585/facility-use-slots/15847#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1585/facility-use-slots/15847"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1182.259732ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/66cb15d2-5d82-4540-ba7a-40fe61e590bd",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:31+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1009%2Fevents%2F10085?useCacheIfAvailable=true&expectedCapacity=28


---
Response status code: 200 OK. Responded in 519.770414ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1009/events/10085",
  "modified": 1658487034670,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1271%2Fevents%2F12704?useCacheIfAvailable=true&expectedCapacity=32


---
Response status code: 200 OK. Responded in 519.251206ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1271/events/12704",
  "modified": 1658487034671,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1428%2Ffacility-use-slots%2F14272?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 838.025496ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1428/facility-use-slots/14272",
  "modified": 1658487034990,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1585%2Ffacility-use-slots%2F15847?useCacheIfAvailable=true&expectedCapacity=7


---
Response status code: 200 OK. Responded in 837.738191ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1585/facility-use-slots/15847",
  "modified": 1658487034991,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66cb15d2-5d82-4540-ba7a-40fe61e590bd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Osbaldo_Armstrong@gmail.com",
    "telephone": "(988) 653-9507",
    "givenName": "Klein",
    "familyName": "Elliot",
    "identifier": "1c17a8de-e2a7-4882-a04e-ef4a27f20aef"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1477.541821ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:36+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 23.206896ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.758923ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.495618ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.109811ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/66cb15d2-5d82-4540-ba7a-40fe61e590bd
...
---
Response status code: 400 Bad Request. Responded in 784.756696ms.
```json
{
  "@context": "https://openactive.io/",
