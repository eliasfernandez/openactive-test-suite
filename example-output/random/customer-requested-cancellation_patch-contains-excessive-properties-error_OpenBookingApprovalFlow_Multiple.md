...
⚠️ 59 passed with 0 failures, 930 warnings and 246 suggestions 
...
---
Response status code: 200 OK. Responded in 19.556706ms.
```json
{
...
---
Response status code: 200 OK. Responded in 18.877596ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1259/events/12583"
}
```
...
---
Response status code: 200 OK. Responded in 18.359887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880"
}
```
...
---
Response status code: 200 OK. Responded in 18.484489ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212"
}
```
...
---
Response status code: 200 OK. Responded in 12.390694ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10767",
    "startDate": "2022-07-29T01:05:11+00:00",
    "endDate": "2022-07-29T06:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1259%2Fevents%2F12583?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.126989ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1259/events/12583",
    "startDate": "2022-07-31T03:44:11+00:00",
    "endDate": "2022-07-31T08:38:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1259",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1259#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1088%2Ffacility-use-slots%2F10880?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.513412ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 3,
    "startDate": "2022-07-24T18:13:12+00:00",
    "endDate": "2022-07-24T22:53:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1422%2Ffacility-use-slots%2F14212?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.083821ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1422",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT13H47M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-31T00:02:12+00:00",
    "endDate": "2022-07-31T04:40:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/35081a6b-0bd8-440e-9464-3f36dde8dbd4
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1259#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1259/events/12583"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 456.73975ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:16+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1259"
        },
        "maximumAttendeeCapacity": 18,
        "remainingAttendeeCapacity": 18
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1077%2Fevents%2F10767?useCacheIfAvailable=true&expectedCapacity=10


---
Response status code: 200 OK. Responded in 488.391145ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1077/events/10767",
  "modified": 1658486419019,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1259%2Fevents%2F12583?useCacheIfAvailable=true&expectedCapacity=17


---
Response status code: 200 OK. Responded in 487.335629ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1259/events/12583",
  "modified": 1658486419020,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1088%2Ffacility-use-slots%2F10880?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 765.116778ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880",
  "modified": 1658486419300,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1422%2Ffacility-use-slots%2F14212?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 766.483799ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212",
  "modified": 1658486419302,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/35081a6b-0bd8-440e-9464-3f36dde8dbd4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Imani_Volkman8@gmail.com",
    "telephone": "(968) 335-3754",
    "givenName": "Gleichner",
    "familyName": "Shaun",
    "identifier": "da8ef640-9d66-4bb4-837a-c0dda502a5a6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 599.304557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:19+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 75.768045ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.621333ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.861421ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.545516ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/35081a6b-0bd8-440e-9464-3f36dde8dbd4
...
---
Response status code: 201 Created. Responded in 220.593934ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1250",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1077#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1251",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1077#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1252",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1259#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1253",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1254",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1088/facility-use-slots/10880#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4#/orderedItems/1255",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14212#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/35081a6b-0bd8-440e-9464-3f36dde8dbd4/versions/494cc8c7-c6e8-4aa4-9154-bfe7db644b20",
  "payment": {
    "@type": "Payment",
    "identifier": "5oaNGY5y6",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;35081a6b-0bd8-440e-9464-3f36dde8dbd4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/35081a6b-0bd8-440e-9464-3f36dde8dbd4


---
Response status code: 200 OK. Responded in 14.016612ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832132124253&afterId=84881d76-0e9f-47af-aff9-3242e98e3de6",
  "message": "Listening for UUID: '35081a6b-0bd8-440e-9464-3f36dde8dbd4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.575066ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;35081a6b-0bd8-440e-9464-3f36dde8dbd4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/35081a6b-0bd8-440e-9464-3f36dde8dbd4


---
Response status code: 200 OK. Responded in 2390.804734ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  "modified": 637940832223964000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/35081a6b-0bd8-440e-9464-3f36dde8dbd4",
    "identifier": "35081a6b-0bd8-440e-9464-3f36dde8dbd4",
...
---
Response status code: 200 OK. Responded in 29.08974ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4
...
---
Response status code: 201 Created. Responded in 723.066129ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  "identifier": "35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 41.802145ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "35081a6b-0bd8-440e-9464-3f36dde8dbd4",
  "modified": 637940832249530800
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 22.215943ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.124926ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.339114ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.778605ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/35081a6b-0bd8-440e-9464-3f36dde8dbd4
...
---
Response status code: 400 Bad Request. Responded in 684.408159ms.
```json
{
  "@context": "https://openactive.io/",
