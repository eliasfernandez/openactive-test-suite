...
⚠️ 47 passed with 0 failures, 705 warnings and 192 suggestions 
...
---
Response status code: 200 OK. Responded in 301.83323ms.
```json
{
...
---
Response status code: 200 OK. Responded in 251.492074ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 250.412664ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 272.216762ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 330.805292ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515",
  "modified": 1658486862938,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515",
    "startDate": "2022-07-23T10:47:41+00:00",
    "endDate": "2022-07-23T11:47:41+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 329.099676ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514",
  "modified": 1658486862937,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 582.125765ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500",
  "modified": 1658486863206,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 581.194956ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501",
  "modified": 1658486863207,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7d689724-7e08-4763-9196-ea547265e2a2
...
---
Response status code: 200 OK. Responded in 1227.276825ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7d689724-7e08-4763-9196-ea547265e2a2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:43+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2515%2Fevents%2F20515?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 108.578989ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515",
  "modified": 1658486865284,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2514%2Fevents%2F20514?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 107.59538ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514",
  "modified": 1658486865285,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2500%2Ffacility-use-slots%2F20500?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 549.283104ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500",
  "modified": 1658486865728,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2501%2Ffacility-use-slots%2F20501?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 548.883ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7d689724-7e08-4763-9196-ea547265e2a2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Coralie_Halvorson@gmail.com",
    "telephone": "(864) 736-3558",
    "givenName": "McLaughlin",
    "familyName": "Vilma",
    "identifier": "e995fe39-c3c5-43a3-8109-a766f0736150"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 750.000032ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:52:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 37.593643ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.591525ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.513815ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 33.916209ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2
...
---
Response status code: 201 Created. Responded in 1273.788004ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2771",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2515#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2772",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2515#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2773",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2774",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2775",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d689724-7e08-4763-9196-ea547265e2a2#/orderedItems/2776",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 27.203146ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.243738ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.526895ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.548013ms.
```json
{
  "data": {
    "@context": [
