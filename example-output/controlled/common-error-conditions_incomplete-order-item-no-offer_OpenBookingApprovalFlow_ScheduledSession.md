...
---
Response status code: 200 OK. Responded in 15.355845ms.
```json
{
...
---
Response status code: 200 OK. Responded in 386.958439ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2192/events/20192",
  "modified": 1658486218874,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66d76364-26a6-492a-9140-c3c3892493f0
...
---
Response status code: 409 Conflict. Responded in 52.6364ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/66d76364-26a6-492a-9140-c3c3892493f0",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66d76364-26a6-492a-9140-c3c3892493f0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Beulah.Schmeler78@hotmail.com",
    "telephone": "1-511-371-5747",
    "givenName": "Altenwerth",
    "familyName": "Stacy",
    "identifier": "22318f1d-9801-4f0f-9d1b-63cd8aca1af8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 25.851697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/66d76364-26a6-492a-9140-c3c3892493f0
...
---
Response status code: 409 Conflict. Responded in 162.594835ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/66d76364-26a6-492a-9140-c3c3892493f0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
