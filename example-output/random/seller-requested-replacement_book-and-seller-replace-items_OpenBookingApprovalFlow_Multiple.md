[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:34:14 GMT+0000 (Coordinated Universal Time)

# seller-requested-replacement >> book-and-seller-replace-items (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 54 passed with 0 failures, 838 warnings and 216 suggestions 
...
---
Response status code: 200 OK. Responded in 18.381014ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1286/events/12856"
}
```
...
---
Response status code: 200 OK. Responded in 17.181994ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13699"
}
```
...
---
Response status code: 200 OK. Responded in 12.23471ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721"
}
```
...
---
Response status code: 200 OK. Responded in 11.401495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1286%2Fevents%2F12856?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.946004ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1286/events/12856",
    "startDate": "2022-07-27T22:01:11+00:00",
    "endDate": "2022-07-27T23:02:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1286",
      "name": "Fresh Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1286#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1370%2Fevents%2F13699?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.556097ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13699",
    "startDate": "2022-07-23T01:24:11+00:00",
    "endDate": "2022-07-23T04:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1573%2Ffacility-use-slots%2F15721?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.16239ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT10H18M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2022-07-25T00:27:12+00:00",
    "endDate": "2022-07-25T04:12:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1503%2Ffacility-use-slots%2F15021?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.749984ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 4,
    "startDate": "2022-07-31T13:47:12+00:00",
    "endDate": "2022-07-31T17:05:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1286#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1286/events/12856"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13699"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 513.156268ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:11+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1286%2Fevents%2F12856?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 421.045893ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1286/events/12856",
  "modified": 1658486113498,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1370%2Fevents%2F13699?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 422.081512ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13699",
  "modified": 1658486113500,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1573%2Ffacility-use-slots%2F15721?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 250.274676ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721",
  "modified": 1658486113326,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1503%2Ffacility-use-slots%2F15021?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 253.312828ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021",
  "modified": 1658486113331,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Raul_Schulist44@gmail.com",
    "telephone": "(886) 930-8650 x924",
    "givenName": "Kunde",
    "familyName": "Eulalia",
    "identifier": "47e48f51-6697-4f50-8e71-933a8bb6a3a9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 244.074974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:40:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 21.05576ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.279347ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.652299ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.08489ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718
...
---
Response status code: 201 Created. Responded in 219.026545ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/484",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1286#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/485",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1286#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/486",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1370#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/487",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/488",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1573/facility-use-slots/15721#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718#/orderedItems/489",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1503/facility-use-slots/15021#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718/versions/a1cd6512-d651-421f-82d6-ab7c91898283",
  "payment": {
    "@type": "Payment",
    "identifier": "grXjdmszl",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718


---
Response status code: 200 OK. Responded in 14.255744ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940829127366102&afterId=e5efbce0-e281-4dbd-a8e9-24e0370a530a",
  "message": "Listening for UUID: '4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 15.462064ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718


---
Response status code: 200 OK. Responded in 2385.705197ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "modified": 637940829179475300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
    "identifier": "4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
...
---
Response status code: 200 OK. Responded in 33.36097ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718
...
---
Response status code: 201 Created. Responded in 436.22276ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "identifier": "4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 17.207666ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "modified": 637940829207060100
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 72.670324ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 73.376235ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 74.225148ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 74.234448ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718


---
Response status code: 200 OK. Responded in 11.67658ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 106.969255ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:ReplacementSimulateAction)

### Orders (orders) Feed collect for &#x27;4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718


---
Response status code: 200 OK. Responded in 2330.8139380000002ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4c2faf5f-3e2f-4997-8cd5-c57eb7ec4718",
  "modified": 637940829258661200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "orderedItem": [
      {
        ...
        "acceptedOffer": {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/15021#/offers/0",
          "price": 15.07,
          "priceCurrency": "GBP"
        },
        "accessCode": [
