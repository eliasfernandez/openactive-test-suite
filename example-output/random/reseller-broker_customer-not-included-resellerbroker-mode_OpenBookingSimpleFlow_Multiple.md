...
⚠️ 47 passed with 0 failures, 734 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 39.045794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1369"
}
```
...
---
Response status code: 200 OK. Responded in 37.540756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4084"
}
```
...
---
Response status code: 200 OK. Responded in 20.240015ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223"
}
```
...
---
Response status code: 200 OK. Responded in 22.76038ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F137%2Fevents%2F1369?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 123.929654ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1369",
    "startDate": "2022-08-01T02:36:11+00:00",
    "endDate": "2022-08-01T04:20:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4084?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 123.480043ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4084",
    "startDate": "2022-07-29T20:28:11+00:00",
    "endDate": "2022-07-30T00:19:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F123%2Ffacility-use-slots%2F1223?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 123.003031ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/123",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 7,
    "startDate": "2022-07-27T21:34:11+00:00",
    "endDate": "2022-07-28T02:21:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F314%2Ffacility-use-slots%2F3140?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 122.504718ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 8.23,
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T16:18:12+00:00",
    "endDate": "2022-07-28T20:35:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1369"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4084"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 931.87542ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/314"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2022-07-28T16:18:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F137%2Fevents%2F1369?useCacheIfAvailable=true&expectedCapacity=40


---
Response status code: 200 OK. Responded in 342.341914ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1369",
  "modified": 1658486738591,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F409%2Fevents%2F4084?useCacheIfAvailable=true&expectedCapacity=25


---
Response status code: 200 OK. Responded in 343.510844ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/409/events/4084",
  "modified": 1658486738593,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F123%2Ffacility-use-slots%2F1223?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 1328.914227ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223",
  "modified": 1658486739580,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F314%2Ffacility-use-slots%2F3140?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1331.479392ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140",
  "modified": 1658486739581,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86
...
---
Response status code: 200 OK. Responded in 466.63526ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 18.739479ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 19.829407ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.35842ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 20.986337ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86
...
---
Response status code: 201 Created. Responded in 878.574462ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2147",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/137#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2148",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/137#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2149",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2150",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2151",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/123/facility-use-slots/1223#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa5f10d1-2f31-4ff9-bbcc-5fe1927c3f86#/orderedItems/2152",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/314/facility-use-slots/3140#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 55.756547ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 54.723822ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 53.957704ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.01794ms.
```json
{
  "data": {
    "@context": [
