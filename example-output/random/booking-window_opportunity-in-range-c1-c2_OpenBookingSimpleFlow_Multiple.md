[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:49:24 GMT+0000 (Coordinated Universal Time)
...
⚠️ 40 passed with 0 failures, 542 warnings and 144 suggestions 
...
---
Response status code: 200 OK. Responded in 32.814926ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6443"
}
```
...
---
Response status code: 200 OK. Responded in 31.786106ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/405/events/4041"
}
```
...
---
Response status code: 200 OK. Responded in 30.809088ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/782/facility-use-slots/7819"
}
```
...
---
Response status code: 200 OK. Responded in 31.240996ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/430/facility-use-slots/4297"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F645%2Fevents%2F6443?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.761793ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6443",
    "startDate": "2022-08-01T09:22:11+00:00",
    "endDate": "2022-08-01T13:21:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F405%2Fevents%2F4041?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.442187ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/405/events/4041",
    "startDate": "2022-07-29T10:30:11+00:00",
    "endDate": "2022-07-29T13:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/405",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/405#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT2H54M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F782%2Ffacility-use-slots%2F7819?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.05238ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/782",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/782/facility-use-slots/7819#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT15H51M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-23T01:07:12+00:00",
    "endDate": "2022-07-23T04:04:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F430%2Ffacility-use-slots%2F4297?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 66.643072ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/430",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/430/facility-use-slots/4297#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT11H32M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-07-30T14:37:12+00:00",
    "endDate": "2022-07-30T18:02:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2c4c0bf4-d2dd-4805-a4be-1e60bd65569a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/645/events/6443"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/405#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/405/events/4041"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/782/facility-use-slots/7819#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/782/facility-use-slots/7819"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/430/facility-use-slots/4297#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/430/facility-use-slots/4297"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1357.240003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2c4c0bf4-d2dd-4805-a4be-1e60bd65569a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:36+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/405"
        },
        "maximumAttendeeCapacity": 27,
        "remainingAttendeeCapacity": 27
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/782"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-23T01:07:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/430"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-30T14:37:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F645%2Fevents%2F6443?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 63.997321ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F405%2Fevents%2F4041?useCacheIfAvailable=true&expectedCapacity=26


---
Response status code: 200 OK. Responded in 63.349209ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F782%2Ffacility-use-slots%2F7819?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 133.857155ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/782/facility-use-slots/7819",
  "modified": 1658486979568,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F430%2Ffacility-use-slots%2F4297?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 135.360883ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/430/facility-use-slots/4297",
  "modified": 1658486979570,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2c4c0bf4-d2dd-4805-a4be-1e60bd65569a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dakota_Mohr@gmail.com",
    "telephone": "609.543.8431 x201",
    "givenName": "Jakubowski",
    "familyName": "Theo",
    "identifier": "74c0eb45-38e1-405e-a099-9cc3351bc0a5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 967.92336ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:40+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 9.876268ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.622763ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.40456ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.915886ms.
```json
{
  "data": {
    "@context": [
