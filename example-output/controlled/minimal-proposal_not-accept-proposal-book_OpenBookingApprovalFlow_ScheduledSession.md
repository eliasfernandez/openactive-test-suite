...
⚠️ 16 passed with 0 failures, 136 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 51.639833ms.
```json
{
...
---
Response status code: 200 OK. Responded in 590.931122ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2073/events/20073",
  "modified": 1658486076075,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2073/events/20073",
    "startDate": "2022-07-23T10:34:34+00:00",
    "endDate": "2022-07-23T11:34:34+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2117f9f3-0580-40dc-b4ff-21a0a8bc978a
...
---
Response status code: 200 OK. Responded in 48.769615ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2117f9f3-0580-40dc-b4ff-21a0a8bc978a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2073%2Fevents%2F20073?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1500.351504ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2073/events/20073",
  "modified": 1658486078165,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2117f9f3-0580-40dc-b4ff-21a0a8bc978a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eloy_Hayes@yahoo.com",
    "telephone": "(409) 733-5450 x4267",
    "givenName": "Hermann",
    "familyName": "Zachery",
    "identifier": "8a617cc9-3703-43c8-ba6e-8a89b17bee87"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 67.552337ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 3.603123ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2117f9f3-0580-40dc-b4ff-21a0a8bc978a
...
---
Response status code: 201 Created. Responded in 50.682227ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/2117f9f3-0580-40dc-b4ff-21a0a8bc978a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2117f9f3-0580-40dc-b4ff-21a0a8bc978a#/orderedItems/440",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2073#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/2117f9f3-0580-40dc-b4ff-21a0a8bc978a/versions/dc26fbfe-e6ae-4153-867e-cad01fe89f45",
  "payment": {
    "@type": "Payment",
    "identifier": "xcNm33mfX",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2117f9f3-0580-40dc-b4ff-21a0a8bc978a
...
---
Response status code: 500 Internal Server Error. Responded in 10.72797ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 3.322922ms.
```json
{
  "data": {
    "@context": [
