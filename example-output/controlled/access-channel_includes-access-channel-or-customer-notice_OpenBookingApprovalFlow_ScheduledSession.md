[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:37 GMT+0000 (Coordinated Universal Time)
...
⚠️ 17 passed with 0 failures, 183 warnings and 64 suggestions 
...
---
Response status code: 200 OK. Responded in 16.243632ms.
```json
{
...
---
Response status code: 200 OK. Responded in 696.592246ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2277/events/20277",
  "modified": 1658486333337,
  "data": {
    "@context": [
      "https://openactive.io/",
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2277/events/20277",
    "startDate": "2022-07-23T10:38:51+00:00",
    "endDate": "2022-07-23T11:38:51+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66ee2af1-26d2-4c50-985d-cd27ac8db4ba
...
---
Response status code: 200 OK. Responded in 182.66258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:53+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2277%2Fevents%2F20277?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 419.205698ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2277/events/20277",
  "modified": 1658486334924,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66ee2af1-26d2-4c50-985d-cd27ac8db4ba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emmanuel_Schimmel3@yahoo.com",
    "telephone": "(274) 385-5085 x008",
    "givenName": "Aufderhar",
    "familyName": "Anya",
    "identifier": "56060937-178b-44e4-be16-f3524c127b6d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 82.211966ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:43:54+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 3.637129ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/66ee2af1-26d2-4c50-985d-cd27ac8db4ba
...
---
Response status code: 201 Created. Responded in 104.684457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66ee2af1-26d2-4c50-985d-cd27ac8db4ba#/orderedItems/1174",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2277#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/66ee2af1-26d2-4c50-985d-cd27ac8db4ba/versions/c5914fb7-2e32-47ad-8217-f02294e97b6a",
  "payment": {
    "@type": "Payment",
    "identifier": "s2GWcYPlO",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;66ee2af1-26d2-4c50-985d-cd27ac8db4ba&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/66ee2af1-26d2-4c50-985d-cd27ac8db4ba


---
Response status code: 200 OK. Responded in 43.746758ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '66ee2af1-26d2-4c50-985d-cd27ac8db4ba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 103.995052ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;66ee2af1-26d2-4c50-985d-cd27ac8db4ba&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/66ee2af1-26d2-4c50-985d-cd27ac8db4ba


---
Response status code: 200 OK. Responded in 2252.23714ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "modified": 637940831356998800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
    "identifier": "66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
...
---
Response status code: 200 OK. Responded in 23.18179ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940831356998827&afterId=66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "message": "Listening for UUID: '66ee2af1-26d2-4c50-985d-cd27ac8db4ba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/66ee2af1-26d2-4c50-985d-cd27ac8db4ba
...
---
Response status code: 201 Created. Responded in 145.693993ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "identifier": "66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1465.337798ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "66ee2af1-26d2-4c50-985d-cd27ac8db4ba",
  "modified": 637940831380241700
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.375835ms.
```json
{
  "data": {
    "@context": [
