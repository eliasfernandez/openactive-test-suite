...
---
Response status code: 200 OK. Responded in 30.043364ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/23/events/225"
}
```
...
---
Response status code: 200 OK. Responded in 28.589128ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/259/facility-use-slots/2586"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F23%2Fevents%2F225?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 56.068127ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/23/events/225",
    "startDate": "2022-07-30T01:28:11+00:00",
    "endDate": "2022-07-30T02:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F259%2Ffacility-use-slots%2F2586?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 55.371709ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/259/facility-use-slots/2586#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 1,
    "startDate": "2022-07-23T23:25:12+00:00",
    "endDate": "2022-07-24T02:31:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/273b64a1-3dfe-4ee6-bdb7-88e0ef83bc04
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/23/events/225"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/259/facility-use-slots/2586#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/259/facility-use-slots/2586"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 952.536846ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/273b64a1-3dfe-4ee6-bdb7-88e0ef83bc04",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F23%2Fevents%2F225?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 282.432089ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/23/events/225",
  "modified": 1658486737173,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F259%2Ffacility-use-slots%2F2586?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 454.294163ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/259/facility-use-slots/2586",
  "modified": 1658486737350,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e7580ff9-89ab-4397-8d5f-4d876ea25468
...
---
Response status code: 409 Conflict. Responded in 233.473843ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e7580ff9-89ab-4397-8d5f-4d876ea25468",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 9.045831ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.071905ms.
```json
{
  "data": {
    "@context": [
