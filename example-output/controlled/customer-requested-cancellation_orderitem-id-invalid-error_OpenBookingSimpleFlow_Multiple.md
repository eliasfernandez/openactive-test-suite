[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:39:14 GMT+0000 (Coordinated Universal Time)
...
⚠️ 55 passed with 0 failures, 826 warnings and 222 suggestions 
...
---
Response status code: 200 OK. Responded in 445.650206ms.
```json
{
...
---
Response status code: 200 OK. Responded in 448.285728ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 443.528388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 446.438212ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 185.01558ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296",
  "modified": 1658486366821,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296",
    "startDate": "2022-07-23T10:39:25+00:00",
    "endDate": "2022-07-23T11:39:25+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 184.272074ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297",
  "modified": 1658486366822,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1188.317348ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283",
  "modified": 1658486367827,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1187.946845ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fdd6d22b-909a-4ca0-9ef9-83353da4bd62
...
---
Response status code: 200 OK. Responded in 269.757625ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fdd6d22b-909a-4ca0-9ef9-83353da4bd62",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:27+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2296%2Fevents%2F20296?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 120.351238ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296",
  "modified": 1658486369597,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2297%2Fevents%2F20297?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 120.988442ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297",
  "modified": 1658486369598,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2283%2Ffacility-use-slots%2F20283?useCacheIfAvailable=true&expectedCapacity=8


---
Response status code: 200 OK. Responded in 691.936864ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283",
  "modified": 1658486370170,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2284%2Ffacility-use-slots%2F20284?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 675.449421ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284",
  "modified": 1658486370171,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fdd6d22b-909a-4ca0-9ef9-83353da4bd62
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lorenzo.Crist@gmail.com",
    "telephone": "756-916-4806",
    "givenName": "Kerluke",
    "familyName": "Sebastian",
    "identifier": "1c0c1d18-0102-4b26-bff0-28ded8fc84a7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 562.138445ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:30+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 60.162619ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 59.344311ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 52.908456ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 52.23995ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62
...
---
Response status code: 201 Created. Responded in 307.139547ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1300",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1301",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1302",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2297#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1303",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1304",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1305",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 30.354953ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 28.009533ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.982533ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.307369ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fdd6d22b-909a-4ca0-9ef9-83353da4bd62#/orderedItems/1300-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 11.545096ms.
```json
{
  "@context": "https://openactive.io/",
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using invalid OrderItem @id) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using invalid OrderItem @id) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using invalid OrderItem @id) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using invalid OrderItem @id) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Assert Opportunity Capacity (after Attempt to Cancel OrderItem at Position 0 using invalid OrderItem @id) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
