...
---
Response status code: 200 OK. Responded in 18.703165ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1246/facility-use-slots/12455"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1246%2Ffacility-use-slots%2F12455?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.607006ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1246",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1246/facility-use-slots/12455#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-30T21:50:12+00:00",
    "endDate": "2022-07-31T01:38:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6d52c629-41a2-407c-ba9b-d10134731246
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1246/facility-use-slots/12455#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1246/facility-use-slots/12455"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 414.736882ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6d52c629-41a2-407c-ba9b-d10134731246",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:06+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1246%2Ffacility-use-slots%2F12455?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 1742.034247ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1246/facility-use-slots/12455",
  "modified": 1658486949489,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6d52c629-41a2-407c-ba9b-d10134731246
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Malvina_Sporer@yahoo.com",
    "telephone": "374-948-8161 x9279",
    "givenName": "Leannon",
    "familyName": "Ona",
    "identifier": "4396c2df-6533-4580-915e-599312d2dad8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1498.349578ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:09+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 13.136655ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6d52c629-41a2-407c-ba9b-d10134731246
...
```json
{
  ...
  "totalPaymentDue": {
    "@type": "PriceSpecification",
    "price": 2.6100000000000003,
    "priceCurrency": "GBP"
  },
  "payment": {
    "@type": "Payment",
    "identifier": "f4GwIyG9x",
    "name": "AcmeBroker Points",
    "accountId": "SN1593",
    "paymentProviderId": "STRIPE"
  }
...
---
Response status code: 400 Bad Request. Responded in 436.97978ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (2.61) does not match expected value (1.61)"
}
```
### Specs
