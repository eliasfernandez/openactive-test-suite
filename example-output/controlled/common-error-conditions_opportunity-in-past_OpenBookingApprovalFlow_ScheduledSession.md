...
⚠️ 13 passed with 0 failures, 117 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 41.385245ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1060.260851ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2256/events/20256",
  "modified": 1658486309705,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2256/events/20256",
    "startDate": "2022-07-21T10:38:27+00:00",
    "endDate": "2022-07-21T11:38:27+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79390d87-be34-465e-9a5b-a7a34aefe4ea
...
---
Response status code: 409 Conflict. Responded in 14.964025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79390d87-be34-465e-9a5b-a7a34aefe4ea",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79390d87-be34-465e-9a5b-a7a34aefe4ea
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jannie57@yahoo.com",
    "telephone": "1-969-310-1625 x06265",
    "givenName": "Howe",
    "familyName": "Winston",
    "identifier": "252a8d9c-2a58-430c-ae58-1f58424e1191"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 30.005751ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/79390d87-be34-465e-9a5b-a7a34aefe4ea
...
---
Response status code: 409 Conflict. Responded in 43.004659ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/79390d87-be34-465e-9a5b-a7a34aefe4ea",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
