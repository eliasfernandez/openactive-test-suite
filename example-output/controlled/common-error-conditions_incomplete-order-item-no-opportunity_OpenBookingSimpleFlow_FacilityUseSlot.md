...
---
Response status code: 200 OK. Responded in 19.808751ms.
```json
{
...
---
Response status code: 200 OK. Responded in 559.176648ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2189/facility-use-slots/20189",
  "modified": 1658486222413,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79ab69ac-2724-4179-b37b-b74d03a85aef
...
---
Response status code: 409 Conflict. Responded in 21.05586ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79ab69ac-2724-4179-b37b-b74d03a85aef",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79ab69ac-2724-4179-b37b-b74d03a85aef
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mozell_Stiedemann10@gmail.com",
    "telephone": "1-380-582-5984",
    "givenName": "Waters",
    "familyName": "Arlo",
    "identifier": "fefc4f6d-823a-4437-8995-dd2c9a1e6169"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 114.753972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79ab69ac-2724-4179-b37b-b74d03a85aef
...
---
Response status code: 409 Conflict. Responded in 46.248451ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/79ab69ac-2724-4179-b37b-b74d03a85aef",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
