...
---
Response status code: 200 OK. Responded in 15.102734ms.
```json
{
...
---
Response status code: 200 OK. Responded in 476.496524ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2423/facility-use-slots/20423",
  "modified": 1658486675892,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/33a82b03-6ff9-44c3-bf72-8b2ec23a0252
...
---
Response status code: 200 OK. Responded in 475.838618ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/33a82b03-6ff9-44c3-bf72-8b2ec23a0252",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2423%2Ffacility-use-slots%2F20423?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 589.169422ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2423/facility-use-slots/20423",
  "modified": 1658486677170,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/33a82b03-6ff9-44c3-bf72-8b2ec23a0252
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katheryn.Larkin@gmail.com",
    "telephone": "814-427-1443 x5203",
    "givenName": "Hermiston",
    "familyName": "Doyle",
    "identifier": "5c713f29-41a1-4cb9-9a69-1e4a24b1d886"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 426.183278ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 17.694157ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/33a82b03-6ff9-44c3-bf72-8b2ec23a0252
...
---
Response status code: 400 Bad Request. Responded in 254.93976ms.
```json
{
  "@context": "https://openactive.io/",
