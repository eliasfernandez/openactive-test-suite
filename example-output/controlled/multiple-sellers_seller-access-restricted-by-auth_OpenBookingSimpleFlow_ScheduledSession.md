...
---
Response status code: 200 OK. Responded in 58.345943ms.
```json
{
...
---
Response status code: 200 OK. Responded in 775.453179ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2110/events/20110",
  "modified": 1658486120794,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2110/events/20110",
    "startDate": "2022-07-23T10:35:19+00:00",
    "endDate": "2022-07-23T11:35:19+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/16e9154b-7e73-4f02-aae8-418ca3338bff
...
---
Response status code: 401 Unauthorized. Responded in 209.264987ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/16e9154b-7e73-4f02-aae8-418ca3338bff
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Triston.Abernathy94@yahoo.com",
    "telephone": "(315) 537-0361 x485",
    "givenName": "Mraz",
    "familyName": "Catherine",
    "identifier": "884c230f-be57-43e7-8e47-34f928e8d15e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 17.247231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/16e9154b-7e73-4f02-aae8-418ca3338bff
...
---
Response status code: 401 Unauthorized. Responded in 21.741965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
