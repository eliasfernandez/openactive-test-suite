...
---
Response status code: 200 OK. Responded in 8.014625ms.
```json
{
...
---
Response status code: 200 OK. Responded in 10.32576ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T03:37:12+00:00",
    "endDate": "2022-07-29T08:44:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
---
Response status code: 200 OK. Responded in 109.467699ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1159%2Ffacility-use-slots%2F11585?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 707.150281ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11585",
  "modified": 1658486231102,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Zander.Lemke54@yahoo.com",
    "telephone": "239.869.6446",
    "givenName": "Streich",
    "familyName": "Adah",
    "identifier": "ac23a5fb-b2d6-4c2d-8f70-2687f6279b39"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 230.238676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 9.580549ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
---
Response status code: 201 Created. Responded in 124.121328ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4#/orderedItems/776",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11585#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4/versions/8c144de8-6d6a-4d69-a1bc-4e57b90b53d8",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
```json
{
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830205953510&afterId=833b641c-4994-4496-9626-6fa5bdadde1b",
  "message": "Listening for UUID: 'bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 22.764553ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4


---
Response status code: 200 OK. Responded in 2126.861827ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "modified": 637940830308935200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
    "identifier": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
...
---
Response status code: 200 OK. Responded in 28.34484ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940830308935148&afterId=bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "message": "Listening for UUID: 'bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
---
Response status code: 201 Created. Responded in 74.493356ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "identifier": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1266.550734ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "modified": 637940830331307300
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 7.602023ms.
```json
{
  "data": {
    "@context": [
...
### Orders (orders) Feed listen for &#x27;bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4


---
Response status code: 200 OK. Responded in 10.015263ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940830267371916&afterId=833b641c-4994-4496-9626-6fa5bdadde1b",
  "message": "Listening for UUID: 'bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 53.034859ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation (Test Interface Action))

### Orders (orders) Feed collect for &#x27;bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4


---
Response status code: 200 OK. Responded in 2500.833143ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "modified": 637940830357412900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
---
Response status code: 200 OK. Responded in 4.201968ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637940830357412837&afterId=bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "message": "Listening for UUID: 'bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4
...
---
Response status code: 204 No Content. Responded in 24.999606ms.
### Specs
* ✅ should return 204 on success
* ✅ noop
...
---
Response status code: 200 OK. Responded in 2505.017811ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "bcb64f56-3ec1-4dc2-b498-5fcbebc9f8a4",
  "modified": 637940830394863400
}
```
### Specs
* ✅ should return 200 on success
