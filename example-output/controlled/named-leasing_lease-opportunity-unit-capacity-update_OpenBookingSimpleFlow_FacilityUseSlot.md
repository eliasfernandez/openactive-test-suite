...
---
Response status code: 200 OK. Responded in 1147.594536ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1061.702852ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2473/facility-use-slots/20473",
  "modified": 1658486801526,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 1,
    "startDate": "2022-07-23T10:46:38+00:00",
    "endDate": "2022-07-23T11:46:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/85da0c3b-c338-47b9-b687-e052c635f26e
...
---
Response status code: 200 OK. Responded in 521.307939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/85da0c3b-c338-47b9-b687-e052c635f26e",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/85da0c3b-c338-47b9-b687-e052c635f26e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Colby.Daugherty38@yahoo.com",
    "telephone": "566-238-2211 x984",
    "givenName": "Lowe",
    "familyName": "Frances",
    "identifier": "6477bee8-7c24-49fd-9d51-3aef11180c89"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 830.728953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2473%2Ffacility-use-slots%2F20473?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 84.499068ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2473/facility-use-slots/20473",
  "modified": 1658486803317,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 149.501959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/eacfbe45-fded-4660-be84-9309ddd64262
...
---
Response status code: 409 Conflict. Responded in 236.794153ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/eacfbe45-fded-4660-be84-9309ddd64262",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:42+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/eacfbe45-fded-4660-be84-9309ddd64262
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amina.Miller@hotmail.com",
    "telephone": "987.857.3765",
    "givenName": "Schimmel",
    "familyName": "Camren",
    "identifier": "2ef40302-5a04-472e-8e09-8ccebe17d33b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 246.571241ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 61.501959ms.
```json
{
  "data": {
    "@context": [
