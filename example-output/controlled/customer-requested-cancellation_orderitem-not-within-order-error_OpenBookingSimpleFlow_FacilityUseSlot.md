...
---
Response status code: 200 OK. Responded in 52.864023ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1423.99532ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2239/facility-use-slots/20239",
  "modified": 1658486296593,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:38:14+00:00",
    "endDate": "2022-07-23T11:38:14+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/afeb811a-c4c2-411b-9fdd-68379e5d6fe9
...
---
Response status code: 200 OK. Responded in 116.239435ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/afeb811a-c4c2-411b-9fdd-68379e5d6fe9",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2239%2Ffacility-use-slots%2F20239?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 1520.633128ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2239/facility-use-slots/20239",
  "modified": 1658486298539,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/afeb811a-c4c2-411b-9fdd-68379e5d6fe9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Julie.Mraz@gmail.com",
    "telephone": "939-330-2480 x3973",
    "givenName": "Reichel",
    "familyName": "Carolyne",
    "identifier": "637fcbf6-949c-4f71-96c2-329078dba1fe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 129.041138ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 10.757886ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/afeb811a-c4c2-411b-9fdd-68379e5d6fe9
...
---
Response status code: 201 Created. Responded in 98.34689ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/afeb811a-c4c2-411b-9fdd-68379e5d6fe9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/afeb811a-c4c2-411b-9fdd-68379e5d6fe9#/orderedItems/1059",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2239/facility-use-slots/20239#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 21.553373ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/8f258e88-7fec-4b3c-bdbd-37360e4b3f69
...
---
Response status code: 500 Internal Server Error. Responded in 10.324183ms.
```json
{
  "@context": "https://openactive.io/",
