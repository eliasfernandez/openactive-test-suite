...
---
Response status code: 200 OK. Responded in 767.140694ms.
```json
{
...
---
Response status code: 200 OK. Responded in 664.473158ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586",
  "modified": 1658487005585,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586",
    "startDate": "2022-07-23T10:50:03+00:00",
    "endDate": "2022-07-23T11:50:03+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2aad03e5-d220-4f3c-825b-cbf1f966eeec
...
---
Response status code: 200 OK. Responded in 325.628669ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:04+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2586%2Fevents%2F20586?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 299.418829ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586",
  "modified": 1658487006512,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2aad03e5-d220-4f3c-825b-cbf1f966eeec
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "f4b8a737-0305-4169-b332-ae0ca12332d1",
...
---
Response status code: 200 OK. Responded in 541.141933ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 11.433104ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2aad03e5-d220-4f3c-825b-cbf1f966eeec
...
---
Response status code: 201 Created. Responded in 345.156646ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2aad03e5-d220-4f3c-825b-cbf1f966eeec#/orderedItems/3124",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2586#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/2aad03e5-d220-4f3c-825b-cbf1f966eeec/versions/ee64ede7-b4a3-4f87-b72d-ae2a835a9bf2",
  "payment": {
    "@type": "Payment",
    "identifier": "MZFGxAZwX",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;2aad03e5-d220-4f3c-825b-cbf1f966eeec&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/2aad03e5-d220-4f3c-825b-cbf1f966eeec


---
Response status code: 200 OK. Responded in 16.098047ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838039840345&afterId=78587428-1fd3-4f62-ac39-40498488505b",
  "message": "Listening for UUID: '2aad03e5-d220-4f3c-825b-cbf1f966eeec' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 674.933252ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;2aad03e5-d220-4f3c-825b-cbf1f966eeec&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/2aad03e5-d220-4f3c-825b-cbf1f966eeec


---
Response status code: 200 OK. Responded in 1869.128315ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  "modified": 637940838070494100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/2aad03e5-d220-4f3c-825b-cbf1f966eeec",
    "identifier": "2aad03e5-d220-4f3c-825b-cbf1f966eeec",
...
---
Response status code: 200 OK. Responded in 28.60946ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940838067725068&afterId=78587428-1fd3-4f62-ac39-40498488505b",
  "message": "Listening for UUID: '2aad03e5-d220-4f3c-825b-cbf1f966eeec' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/2aad03e5-d220-4f3c-825b-cbf1f966eeec
...
---
Response status code: 201 Created. Responded in 200.699827ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  "identifier": "2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 985.980875ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "2aad03e5-d220-4f3c-825b-cbf1f966eeec",
  "modified": 637940838096377500
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 6.60416ms.
```json
{
  "data": {
    "@context": [
