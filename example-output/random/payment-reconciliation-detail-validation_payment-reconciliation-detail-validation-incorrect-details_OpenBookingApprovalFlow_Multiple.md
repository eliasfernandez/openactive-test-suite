...
⚠️ 26 passed with 0 failures, 398 warnings and 108 suggestions 
...
---
Response status code: 200 OK. Responded in 62.925662ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12551"
}
```
...
---
Response status code: 200 OK. Responded in 61.973246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12054"
}
```
...
---
Response status code: 200 OK. Responded in 61.070231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1815/facility-use-slots/18147"
}
```
...
---
Response status code: 200 OK. Responded in 60.98593ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13527"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12551?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.798172ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12551",
    "startDate": "2022-08-01T07:21:11+00:00",
    "endDate": "2022-08-01T12:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1206%2Fevents%2F12054?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.404982ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12054",
    "startDate": "2022-07-30T22:41:11+00:00",
    "endDate": "2022-07-31T02:26:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1815%2Ffacility-use-slots%2F18147?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.422398ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1815",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1815/facility-use-slots/18147#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 13.76,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT4H32M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-23T10:28:12+00:00",
    "endDate": "2022-07-23T14:31:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1353%2Ffacility-use-slots%2F13527?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 36.014108ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13527#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 5.23,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT5H56M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-23T18:58:12+00:00",
    "endDate": "2022-07-23T22:03:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d64ca9e9-737b-4da8-9086-de2593a5814d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12551"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1206/events/12054"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1815/facility-use-slots/18147#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1815/facility-use-slots/18147"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13527#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13527"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-nqZ18ylLHo",
    "accountId": "invalid-2T5QFHnP-",
    "paymentProviderId": "invalid-WZ1oUXwNrA"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 75.600176ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d64ca9e9-737b-4da8-9086-de2593a5814d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gudrun_Welch@hotmail.com",
    "telephone": "1-207-839-5409",
    "givenName": "Heathcote",
    "familyName": "Eusebio",
    "identifier": "8be1b7fc-32eb-43a6-a9ef-b8b6eecd0892"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-LfF4dQKmgo",
    "accountId": "invalid-ZQADnrva5",
    "paymentProviderId": "invalid-UwJZx11t_W"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 808.318545ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
