...
⚠️ 10 passed with 0 failures, 97 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 16.60785ms.
```json
{
...
---
Response status code: 200 OK. Responded in 272.779067ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2523/events/20523",
  "modified": 1658486877774,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/44acc999-a5ad-468e-bca6-5cf059bacc59
...
---
Response status code: 200 OK. Responded in 812.831652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/44acc999-a5ad-468e-bca6-5cf059bacc59",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2523%2Fevents%2F20523?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 486.544901ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2523/events/20523",
  "modified": 1658486879383,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/44acc999-a5ad-468e-bca6-5cf059bacc59
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Antonio_Hoppe@yahoo.com",
    "telephone": "767.530.5299",
    "givenName": "Emmerich",
    "familyName": "Eusebio",
    "identifier": "cca31400-7842-426d-a0cf-dd388d2aaefa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 279.447428ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 5.137247ms.
```json
{
  "data": {
    "@context": [
