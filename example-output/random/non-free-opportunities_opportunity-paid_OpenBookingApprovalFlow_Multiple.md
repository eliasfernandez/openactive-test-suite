...
⚠️ 51 passed with 0 failures, 845 warnings and 224 suggestions 
...
---
Response status code: 200 OK. Responded in 24.907582ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1494/events/14938"
}
```
...
---
Response status code: 200 OK. Responded in 23.31385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15824"
}
```
...
---
Response status code: 200 OK. Responded in 22.010626ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083"
}
```
...
---
Response status code: 200 OK. Responded in 22.815741ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1494%2Fevents%2F14938?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.534255ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1494/events/14938",
    "startDate": "2022-07-29T04:21:11+00:00",
    "endDate": "2022-07-29T05:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1583%2Fevents%2F15824?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.854341ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15824",
    "startDate": "2022-07-31T01:20:11+00:00",
    "endDate": "2022-07-31T03:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1009%2Ffacility-use-slots%2F10083?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.426634ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1009",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 2,
    "startDate": "2022-07-22T19:45:12+00:00",
    "endDate": "2022-07-22T20:26:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1353%2Ffacility-use-slots%2F13521?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.947024ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1353",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT18H10M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2022-08-01T02:48:12+00:00",
    "endDate": "2022-08-01T03:31:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1494/events/14938"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15824"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1670.966486ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:59+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1353"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-08-01T02:48:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1494%2Fevents%2F14938?useCacheIfAvailable=true&expectedCapacity=41


---
Response status code: 200 OK. Responded in 815.762303ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1494/events/14938",
  "modified": 1658486942884,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1583%2Fevents%2F15824?useCacheIfAvailable=true&expectedCapacity=18


---
Response status code: 200 OK. Responded in 816.677019ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15824",
  "modified": 1658486942887,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1009%2Ffacility-use-slots%2F10083?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 584.620521ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083",
  "modified": 1658486942654,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1353%2Ffacility-use-slots%2F13521?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 583.962111ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521",
  "modified": 1658486942655,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Schuyler_Ernser21@gmail.com",
    "telephone": "246.967.0663",
    "givenName": "Windler",
    "familyName": "Ernestina",
    "identifier": "179a3fc7-4f03-4aa5-a45b-6447c96070ca"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1254.363811ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 96.717485ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 95.641864ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 87.558306ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 26.797222ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a
...
---
Response status code: 201 Created. Responded in 1269.63144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2715",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1494#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2716",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1494#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2717",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1583#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2718",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2719",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1009/facility-use-slots/10083#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a#/orderedItems/2720",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1353/facility-use-slots/13521#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a/versions/9e21ccd2-b47d-4c65-8622-efe3732b6e1b",
  "payment": {
    "@type": "Payment",
    "identifier": "wkGX6ar9d",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a


---
Response status code: 200 OK. Responded in 6.549927ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940837411268195&afterId=70244c44-6bcb-4149-a1c8-8fdf505ab036",
  "message": "Listening for UUID: '4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 18.594561ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a


---
Response status code: 200 OK. Responded in 2180.658819ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "modified": 637940837497200100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
    "identifier": "4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
...
---
Response status code: 200 OK. Responded in 5.583009ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940837497200174&afterId=4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "message": "Listening for UUID: '4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a
...
---
Response status code: 201 Created. Responded in 1245.025062ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "identifier": "4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 50.514073ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "4cc0490a-7cbd-47e5-b1b6-9021d5a9c61a",
  "modified": 637940837522850000
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 76.663876ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 75.652256ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 63.602325ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 62.84791ms.
```json
{
  "data": {
    "@context": [
