...
---
Response status code: 200 OK. Responded in 100.813822ms.
```json
{
...
---
Response status code: 200 OK. Responded in 830.961298ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2451/events/20451",
  "modified": 1658486707989,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2451/events/20451",
    "startDate": "2022-07-23T10:45:06+00:00",
    "endDate": "2022-07-23T11:45:06+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8f6d9f54-6a3b-490a-a886-04db04211f70
...
---
Response status code: 200 OK. Responded in 433.446563ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8f6d9f54-6a3b-490a-a886-04db04211f70",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2451%2Fevents%2F20451?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 781.439545ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2451/events/20451",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8f6d9f54-6a3b-490a-a886-04db04211f70
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jared94@hotmail.com",
    "telephone": "1-382-415-6621 x40891",
    "givenName": "McCullough",
    "familyName": "Modesto",
    "identifier": "490969cc-463d-4f4e-9543-36ad28f30920"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 161.697079ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 12.844418ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8f6d9f54-6a3b-490a-a886-04db04211f70
...
---
Response status code: 400 Bad Request. Responded in 136.65895ms.
```json
{
  "@context": "https://openactive.io/",
