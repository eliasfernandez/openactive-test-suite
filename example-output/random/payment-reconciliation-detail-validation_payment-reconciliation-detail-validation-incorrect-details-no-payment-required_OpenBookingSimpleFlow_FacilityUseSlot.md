...
---
Response status code: 200 OK. Responded in 16.078184ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3340"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F334%2Ffacility-use-slots%2F3340?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.044983ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3340#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT7H57M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-30T07:06:12+00:00",
    "endDate": "2022-07-30T09:41:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ab76205d-2fc6-4a32-a207-caf7eaa5b541
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3340#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3340"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-7S2RJBu4wW",
    "accountId": "invalid-IKXy3aJqv",
    "paymentProviderId": "invalid-3YvMdAxhVd"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 44.212881ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ab76205d-2fc6-4a32-a207-caf7eaa5b541
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lorna65@hotmail.com",
    "telephone": "285-646-5236",
    "givenName": "Legros",
    "familyName": "Randi",
    "identifier": "55f89093-37d9-42b3-998c-26777a93b969"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-ky6pk8DGzH",
    "accountId": "invalid-rG3voCAI2R",
    "paymentProviderId": "invalid-wj2kbbf_z5"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 56.725402ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
