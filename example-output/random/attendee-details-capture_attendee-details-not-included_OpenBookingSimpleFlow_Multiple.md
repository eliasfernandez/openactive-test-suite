[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:37:16 GMT+0000 (Coordinated Universal Time)
...
⚠️ 34 passed with 0 failures, 664 warnings and 174 suggestions 
...
---
Response status code: 200 OK. Responded in 15.006843ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/65/events/650"
}
```
...
---
Response status code: 200 OK. Responded in 13.324016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/535/events/5349"
}
```
...
---
Response status code: 200 OK. Responded in 11.948494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/7"
}
```
...
---
Response status code: 200 OK. Responded in 10.973678ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/21/facility-use-slots/204"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F65%2Fevents%2F650?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.716457ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/65/events/650",
    "startDate": "2022-07-27T23:48:11+00:00",
    "endDate": "2022-07-28T03:54:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F535%2Fevents%2F5349?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.216249ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/535/events/5349",
    "startDate": "2022-07-25T18:33:11+00:00",
    "endDate": "2022-07-25T20:27:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/535",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/535#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 4.1,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT14H"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1%2Ffacility-use-slots%2F7?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.686341ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/7#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingAttendeeDetails"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2022-07-27T00:29:11+00:00",
    "endDate": "2022-07-27T02:56:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F21%2Ffacility-use-slots%2F204?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.189233ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/21/facility-use-slots/204#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 6,
    "startDate": "2022-07-30T00:27:11+00:00",
    "endDate": "2022-07-30T06:18:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/45bc4e05-8682-40d7-a7b4-c192c60d6ad1
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/65/events/650"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/535#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/535/events/5349"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/7#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/7"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/21/facility-use-slots/204#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/21/facility-use-slots/204"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 401.815331ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/45bc4e05-8682-40d7-a7b4-c192c60d6ad1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:42:22+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/535"
        },
        "maximumAttendeeCapacity": 22,
        "remainingAttendeeCapacity": 22
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/21"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-30T00:27:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F65%2Fevents%2F650?useCacheIfAvailable=true&expectedCapacity=22


---
Response status code: 200 OK. Responded in 57.06445ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F535%2Fevents%2F5349?useCacheIfAvailable=true&expectedCapacity=21


---
Response status code: 200 OK. Responded in 55.932834ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1%2Ffacility-use-slots%2F7?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 687.743743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1/facility-use-slots/7",
  "modified": 1658486244887,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F21%2Ffacility-use-slots%2F204?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 664.217093ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/21/facility-use-slots/204",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/45bc4e05-8682-40d7-a7b4-c192c60d6ad1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Selina3@yahoo.com",
    "telephone": "321-541-2137 x24802",
    "givenName": "Rolfson",
    "familyName": "Elliott",
    "identifier": "a0276266-2f1f-444b-902b-92df837affe9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 96.407436ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/45bc4e05-8682-40d7-a7b4-c192c60d6ad1
...
---
Response status code: 409 Conflict. Responded in 194.231531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/45bc4e05-8682-40d7-a7b4-c192c60d6ad1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
