...
---
Response status code: 200 OK. Responded in 186.067297ms.
```json
{
...
---
Response status code: 200 OK. Responded in 463.021523ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2563/events/20563",
  "modified": 1658486962695,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fd104e52-8812-4f55-971c-dc508e684488
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-47gF8lzdk_",
    "accountId": "invalid-DxXMLRYbu",
    "paymentProviderId": "invalid-v0BIEvWyXR"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 15.883045ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fd104e52-8812-4f55-971c-dc508e684488
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fermin38@yahoo.com",
    "telephone": "918-275-1302 x3247",
    "givenName": "O'Keefe",
    "familyName": "Chadd",
    "identifier": "d2e78753-2ecc-42f7-93f3-5505c639cc7c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-QfpSZYwByx",
    "accountId": "invalid-eNNFAql7sG",
    "paymentProviderId": "invalid-b2Yufh1ouY"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 23.478014ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
