...
---
Response status code: 200 OK. Responded in 206.708977ms.
```json
{
...
---
Response status code: 200 OK. Responded in 881.618204ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2556/events/20556",
  "modified": 1658486957683,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2556/events/20556",
    "startDate": "2022-07-23T10:49:15+00:00",
    "endDate": "2022-07-23T11:49:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cffb72ec-0d14-423f-8370-4c87c4754f86
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-FrB6np2uEm",
    "accountId": "invalid-DqZAaPtPX",
    "paymentProviderId": "invalid-K5q_57Z3hG"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 140.774278ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cffb72ec-0d14-423f-8370-4c87c4754f86
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bart_Lebsack60@hotmail.com",
    "telephone": "730-460-9402",
    "givenName": "Hirthe",
    "familyName": "Noelia",
    "identifier": "2dd8c973-485a-42c6-96d3-74e450c4daaf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-jo3kbIQx5z",
    "accountId": "invalid-Ad8hAWZkT",
    "paymentProviderId": "invalid-CsudHr6YDq"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 33.848608ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
