...
⚠️ 93 passed with 0 failures, 1210 warnings and 326 suggestions 
...
---
Response status code: 200 OK. Responded in 20.252431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/192/events/1917"
}
```
...
---
Response status code: 200 OK. Responded in 18.99121ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1210"
}
```
...
---
Response status code: 200 OK. Responded in 17.488687ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5273"
}
```
...
---
Response status code: 200 OK. Responded in 16.646872ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/403/facility-use-slots/4021"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F192%2Fevents%2F1917?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.356802ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/192/events/1917",
    "startDate": "2022-07-23T02:23:11+00:00",
    "endDate": "2022-07-23T07:59:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/192",
      "name": "Rubber Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/192#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F121%2Fevents%2F1210?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.877295ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1210",
    "startDate": "2022-07-30T12:02:11+00:00",
    "endDate": "2022-07-30T16:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F528%2Ffacility-use-slots%2F5273?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.236058ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/528",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5273#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT16H23M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-24T20:14:12+00:00",
    "endDate": "2022-07-24T23:20:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F403%2Ffacility-use-slots%2F4021?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.892352ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/403",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/403/facility-use-slots/4021#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT14H35M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-27T05:59:12+00:00",
    "endDate": "2022-07-27T07:16:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/682f9e19-12de-4389-b87e-b57b4438148f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/192#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/192/events/1917"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1210"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5273#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/528/facility-use-slots/5273"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/403/facility-use-slots/4021#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/403/facility-use-slots/4021"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 400 Bad Request. Responded in 140.729003ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 54.633894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/399/events/3987"
}
```
...
---
Response status code: 200 OK. Responded in 53.399174ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3851"
}
```
...
---
Response status code: 200 OK. Responded in 52.330556ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/327/facility-use-slots/3261"
}
```
...
---
Response status code: 200 OK. Responded in 43.558413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2851"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F399%2Fevents%2F3987?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.774869ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/399/events/3987",
    "startDate": "2022-07-23T04:18:11+00:00",
    "endDate": "2022-07-23T08:16:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/399",
      "name": "Wooden Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/399#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 5.83,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT1H56M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F386%2Fevents%2F3851?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.365814ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3851",
    "startDate": "2022-08-01T09:20:11+00:00",
    "endDate": "2022-08-01T14:41:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/386",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/386#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT13H52M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F327%2Ffacility-use-slots%2F3261?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.965439ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/327",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/327/facility-use-slots/3261#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 2,
    "startDate": "2022-07-28T18:16:12+00:00",
    "endDate": "2022-07-28T22:13:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F286%2Ffacility-use-slots%2F2851?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.560233ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2851#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 12.65,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 3,
    "startDate": "2022-07-25T21:39:12+00:00",
    "endDate": "2022-07-26T00:13:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/46033a90-b718-44d7-bab6-25f2a698b3c0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/399#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/399/events/3987"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/386#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3851"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/327/facility-use-slots/3261#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/327/facility-use-slots/3261"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2851#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2851"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 232.648007ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/46033a90-b718-44d7-bab6-25f2a698b3c0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:41:57+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/399"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/386"
        },
        "maximumAttendeeCapacity": 48,
        "remainingAttendeeCapacity": 48
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F399%2Fevents%2F3987?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 602.441036ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/399/events/3987",
  "modified": 1658486219794,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F386%2Fevents%2F3851?useCacheIfAvailable=true&expectedCapacity=47


---
Response status code: 200 OK. Responded in 603.008345ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/386/events/3851",
  "modified": 1658486219796,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F327%2Ffacility-use-slots%2F3261?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 457.338201ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/327/facility-use-slots/3261",
  "modified": 1658486219660,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F286%2Ffacility-use-slots%2F2851?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 458.023012ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/286/facility-use-slots/2851",
  "modified": 1658486219661,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/46033a90-b718-44d7-bab6-25f2a698b3c0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Norval_Ankunding88@yahoo.com",
    "telephone": "1-911-980-6035",
    "givenName": "Bergstrom",
    "familyName": "Letha",
    "identifier": "d4d0e789-ac0a-4b55-955a-fb6abd0b2992"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 10.451268ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
---
Response status code: 200 OK. Responded in 26.873532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 21.368743ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/444/events/4433"
}
```
...
---
Response status code: 200 OK. Responded in 20.238225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 19.466413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/231/facility-use-slots/2309"
}
```
...
---
Response status code: 200 OK. Responded in 68.823207ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3044",
    "startDate": "2022-07-27T01:08:11+00:00",
    "endDate": "2022-07-27T05:55:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F444%2Fevents%2F4433?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 68.4291ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/444/events/4433",
    "startDate": "2022-07-28T23:42:11+00:00",
    "endDate": "2022-07-29T05:13:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/444",
      "name": "Steel Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/444#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT4H54M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 67.732889ms.
```json
{
  "data": {
    "@context": [
    ...
    "remainingUses": 8,
    "startDate": "2022-07-28T13:18:11+00:00",
    "endDate": "2022-07-28T16:13:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F231%2Ffacility-use-slots%2F2309?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.247081ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/231",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/231/facility-use-slots/2309#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 18.61,
    ...
    "remainingUses": 7,
    "startDate": "2022-07-24T10:45:12+00:00",
    "endDate": "2022-07-24T11:30:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ec22096f-0627-4b19-8376-a4cac3ebef6d
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/444#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/444/events/4433"
    },
    {
      "@type": "OrderItem",
      "position": 3,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/231/facility-use-slots/2309#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/231/facility-use-slots/2309"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 136.661597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ec22096f-0627-4b19-8376-a4cac3ebef6d",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/231"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2022-07-24T10:45:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3044?useCacheIfAvailable=true&expectedCapacity=22


---
Response status code: 200 OK. Responded in 85.636177ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3044",
  "modified": 1658486222880,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F444%2Fevents%2F4433?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 86.518991ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/444/events/4433",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F74%2Ffacility-use-slots%2F738?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 481.942647ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/74/facility-use-slots/738",
  "modified": 1658486223282,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F231%2Ffacility-use-slots%2F2309?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 483.36747ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/231/facility-use-slots/2309",
  "modified": 1658486223284,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ec22096f-0627-4b19-8376-a4cac3ebef6d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marianna24@gmail.com",
    "telephone": "610.471.8492 x0009",
    "givenName": "Sawayn",
    "familyName": "Tyson",
    "identifier": "ac3329d8-4e02-4d0f-aeef-4b5c21cc81f4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 315.634674ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 36.762891ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.911378ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.215266ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 34.721358ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ec22096f-0627-4b19-8376-a4cac3ebef6d
...
---
Response status code: 400 Bad Request. Responded in 27.165536ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
