...
⚠️ 74 passed with 0 failures, 958 warnings and 258 suggestions 
...
---
Response status code: 200 OK. Responded in 42.336066ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2205"
}
```
...
---
Response status code: 200 OK. Responded in 40.853343ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6312"
}
```
...
---
Response status code: 200 OK. Responded in 39.564722ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5311"
}
```
...
---
Response status code: 200 OK. Responded in 40.490637ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3822"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F221%2Fevents%2F2205?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 59.83744ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2205",
    "startDate": "2022-07-27T05:19:11+00:00",
    "endDate": "2022-07-27T10:04:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F632%2Fevents%2F6312?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 59.077029ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6312",
    "startDate": "2022-07-26T04:44:11+00:00",
    "endDate": "2022-07-26T08:58:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F532%2Ffacility-use-slots%2F5311?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 58.219615ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/532",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5311#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT13H40M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-25T10:52:12+00:00",
    "endDate": "2022-07-25T16:52:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F383%2Ffacility-use-slots%2F3822?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 57.704007ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3822#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT13H45M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-23T23:28:12+00:00",
    "endDate": "2022-07-24T04:28:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/444feba2-3cbd-4614-badf-6a65dca3d43b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/221/events/2205"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/632/events/6312"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5311#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5311"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3822#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3822"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 325.028111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/444feba2-3cbd-4614-badf-6a65dca3d43b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:37+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/532"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-25T10:52:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F221%2Fevents%2F2205?useCacheIfAvailable=true&expectedCapacity=37


---
Response status code: 200 OK. Responded in 62.009692ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F632%2Fevents%2F6312?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 60.836076ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F532%2Ffacility-use-slots%2F5311?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 887.556377ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/532/facility-use-slots/5311",
  "modified": 1658486380511,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F383%2Ffacility-use-slots%2F3822?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 888.608292ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3822",
  "modified": 1658486380519,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/444feba2-3cbd-4614-badf-6a65dca3d43b
...
---
Response status code: 400 Bad Request. Responded in 88.988481ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 41.858002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4075"
}
```
...
---
Response status code: 200 OK. Responded in 40.371381ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4071"
}
```
...
---
Response status code: 200 OK. Responded in 39.000461ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/405/facility-use-slots/4041"
}
```
...
---
Response status code: 200 OK. Responded in 38.081548ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/9/facility-use-slots/83"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F408%2Fevents%2F4075?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.357079ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4075",
    "startDate": "2022-07-26T05:18:11+00:00",
    "endDate": "2022-07-26T10:45:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/408",
      "name": "Wooden Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/408#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 13.8,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT11H36M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F408%2Fevents%2F4071?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.613569ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4071",
    "startDate": "2022-07-22T13:31:11+00:00",
    "endDate": "2022-07-22T17:37:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/408",
      "name": "Wooden Walking",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F405%2Ffacility-use-slots%2F4041?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.94846ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/405",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/405/facility-use-slots/4041#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 12.52,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT3H28M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2022-07-26T18:39:12+00:00",
    "endDate": "2022-07-26T19:47:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F9%2Ffacility-use-slots%2F83?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.437752ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/9",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/9/facility-use-slots/83#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 5,
    "startDate": "2022-07-29T08:54:11+00:00",
    "endDate": "2022-07-29T14:12:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3b7c4826-0633-41bd-99b6-5dfe2a168fe6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/408#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4075"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/408#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/408/events/4071"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/405/facility-use-slots/4041#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/405/facility-use-slots/4041"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/9/facility-use-slots/83#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/9/facility-use-slots/83"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 875.326514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3b7c4826-0633-41bd-99b6-5dfe2a168fe6",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/408"
        },
        "maximumAttendeeCapacity": 22,
        "remainingAttendeeCapacity": 22
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F408%2Fevents%2F4075?useCacheIfAvailable=true&expectedCapacity=20


---
Response status code: 200 OK. Responded in 36.816876ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F408%2Fevents%2F4071?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 35.656358ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F405%2Ffacility-use-slots%2F4041?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 385.828737ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/405/facility-use-slots/4041",
  "modified": 1658486386990,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F9%2Ffacility-use-slots%2F83?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 386.389145ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/9/facility-use-slots/83",
  "modified": 1658486386993,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3b7c4826-0633-41bd-99b6-5dfe2a168fe6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dave.Hamill73@hotmail.com",
    "telephone": "(280) 245-6206 x7481",
    "givenName": "O'Hara",
    "familyName": "Yvette",
    "identifier": "6b1a996f-fd4f-4693-ba62-7c7aa3c17e21"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 378.257806ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.566712ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 12.442895ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 11.493479ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.978271ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3b7c4826-0633-41bd-99b6-5dfe2a168fe6
...
---
Response status code: 400 Bad Request. Responded in 87.348863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
