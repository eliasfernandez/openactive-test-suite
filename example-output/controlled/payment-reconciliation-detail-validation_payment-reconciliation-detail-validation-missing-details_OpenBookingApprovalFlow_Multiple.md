[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:50:12 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 59.158733ms.
```json
{
...
---
Response status code: 200 OK. Responded in 47.078225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 128.689259ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 88.095494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 288.250296ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2597/events/20597",
  "modified": 1658487020764,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2597/events/20597",
    "startDate": "2022-07-23T10:50:19+00:00",
    "endDate": "2022-07-23T11:50:19+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 283.396552ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2596/events/20596",
  "modified": 1658487020760,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 558.37743ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2584/facility-use-slots/20584",
  "modified": 1658487021035,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 557.454121ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2583/facility-use-slots/20583",
  "modified": 1658487021034,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9c409fd5-2c0d-44ad-a13b-5aff529497a6
...
---
Response status code: 400 Bad Request. Responded in 557.334521ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9c409fd5-2c0d-44ad-a13b-5aff529497a6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Darrel78@gmail.com",
    "telephone": "744.362.5662 x40466",
    "givenName": "Anderson",
    "familyName": "Sydnie",
    "identifier": "599975b4-dc9b-45fd-a47b-a2e1619959dd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 52.417572ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
