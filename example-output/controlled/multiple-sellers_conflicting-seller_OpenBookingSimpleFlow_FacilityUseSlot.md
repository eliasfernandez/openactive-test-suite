...
---
Response status code: 200 OK. Responded in 23.161093ms.
```json
{
...
---
Response status code: 200 OK. Responded in 35.128093ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 905.901062ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2248/facility-use-slots/20248",
  "modified": 1658486310301,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:38:28+00:00",
    "endDate": "2022-07-23T11:38:28+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 905.450858ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2249/facility-use-slots/20249",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c967469b-3fb3-4f6f-94d6-6a70bc5203bd
...
---
Response status code: 500 Internal Server Error. Responded in 52.081735ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c967469b-3fb3-4f6f-94d6-6a70bc5203bd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Teagan_Morissette@hotmail.com",
    "telephone": "1-214-259-2244 x4419",
    "givenName": "Nolan",
    "familyName": "Connie",
    "identifier": "3eec8a79-b3a6-4926-abbd-c570716361bf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 54.754257ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c967469b-3fb3-4f6f-94d6-6a70bc5203bd
...
---
Response status code: 500 Internal Server Error. Responded in 49.04251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
