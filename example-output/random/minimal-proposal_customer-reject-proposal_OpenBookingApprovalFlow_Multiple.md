[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:33:57 GMT+0000 (Coordinated Universal Time)

# minimal-proposal >> customer-reject-proposal (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  OrderProposal rejected by the Customer

An OrderProposal that is rejected by the Customer, and the call to B subsequently fails

### Running only this test

```bash
npm start -- --runInBand test/features/approval/minimal-proposal/implemented/customer-reject-proposal-test.js
```

---

⚠️ 56 passed with 0 failures, 754 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 12.258816ms.
```json
{
...
---
Response status code: 200 OK. Responded in 11.225298ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15826"
}
```
...
---
Response status code: 200 OK. Responded in 10.364283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563"
}
```
...
---
Response status code: 200 OK. Responded in 9.524368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366"
}
```
...
---
Response status code: 200 OK. Responded in 8.985858ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262",
    "startDate": "2022-07-23T06:14:11+00:00",
    "endDate": "2022-07-23T08:23:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 17.14,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT16H45M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1583%2Fevents%2F15826?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.601752ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15826",
    "startDate": "2022-07-27T01:26:11+00:00",
    "endDate": "2022-07-27T06:28:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1583",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1583#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT3H29M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1457%2Ffacility-use-slots%2F14563?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.208744ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1457",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT16H51M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-27T18:18:12+00:00",
    "endDate": "2022-07-27T23:49:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1137%2Ffacility-use-slots%2F11366?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.822138ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 2,
    "startDate": "2022-07-26T20:51:12+00:00",
    "endDate": "2022-07-26T21:36:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e0dab98d-1acf-4baf-b4cd-efaef9944e32
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1583#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15826"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 171.607618ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e0dab98d-1acf-4baf-b4cd-efaef9944e32",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:39:11+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1627%2Fevents%2F16262?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 125.206503ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262",
  "modified": 1658486053837,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1583%2Fevents%2F15826?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 125.405306ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1583/events/15826",
  "modified": 1658486053839,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1457%2Ffacility-use-slots%2F14563?useCacheIfAvailable=true&expectedCapacity=5


---
Response status code: 200 OK. Responded in 905.15442ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563",
  "modified": 1658486054619,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1137%2Ffacility-use-slots%2F11366?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 905.034618ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366",
  "modified": 1658486054620,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e0dab98d-1acf-4baf-b4cd-efaef9944e32
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lonzo_Tillman@hotmail.com",
    "telephone": "1-605-408-9542 x3195",
    "givenName": "Greenholt",
    "familyName": "Lane",
    "identifier": "7790dba6-871a-436f-b3f3-30c0e837c6d6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 150.188041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 45.389298ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.897172ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.401964ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.014956ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e0dab98d-1acf-4baf-b4cd-efaef9944e32
...
---
Response status code: 201 Created. Responded in 128.560938ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/e0dab98d-1acf-4baf-b4cd-efaef9944e32",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/332",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1627#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/333",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1627#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/334",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1583#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/335",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/336",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1457/facility-use-slots/14563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32#/orderedItems/337",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1137/facility-use-slots/11366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/e0dab98d-1acf-4baf-b4cd-efaef9944e32/versions/8a3b0131-94cd-4369-bf8e-eb9b961c8d03",
  "payment": {
    "@type": "Payment",
    "identifier": "GDbkY7SLh",
    "name": "AcmeBroker Points",
...
## Customer Reject Order Proposal

### Orders (order-proposals) Feed listen for &#x27;e0dab98d-1acf-4baf-b4cd-efaef9944e32&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/e0dab98d-1acf-4baf-b4cd-efaef9944e32


---
Response status code: 200 OK. Responded in 12.795622ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828485705215&afterId=b2bc5157-7c54-402a-b7f3-cbedf96679a2",
  "message": "Listening for UUID: 'e0dab98d-1acf-4baf-b4cd-efaef9944e32' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Proposal Request
PATCH https://localhost:5001/api/openbooking/order-proposals/e0dab98d-1acf-4baf-b4cd-efaef9944e32
...
---
Response status code: 204 No Content. Responded in 56.551285ms.
### Specs
* ✅ should return 204 on success
* ✅ noop

## OrdersProposal Feed (after OrderProposal Update)

### Orders (order-proposals) Feed collect for &#x27;e0dab98d-1acf-4baf-b4cd-efaef9944e32&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/e0dab98d-1acf-4baf-b4cd-efaef9944e32


---
Response status code: 200 OK. Responded in 2338.618611ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "e0dab98d-1acf-4baf-b4cd-efaef9944e32",
  "modified": 637940828597277000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/e0dab98d-1acf-4baf-b4cd-efaef9944e32",
    "identifier": "e0dab98d-1acf-4baf-b4cd-efaef9944e32",
    "orderProposalStatus": "https://openactive.io/CustomerRejected",
    "orderedItem": [
      {
        "@type": "OrderItem",
...
### Specs
* ✅ should return 200 on success
* ✅ should have orderProposalStatus: CustomerRejected
* ✅ should have orderProposalVersion same as that returned by P (i.e. an amendment hasn't occurred)

## OrdersProposal Feed (after OrderProposal Update) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e0dab98d-1acf-4baf-b4cd-efaef9944e32
...
---
Response status code: 500 Internal Server Error. Responded in 29.352611ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 37.942261ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 37.465752ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 32.025057ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.571149ms.
```json
{
  "data": {
    "@context": [
