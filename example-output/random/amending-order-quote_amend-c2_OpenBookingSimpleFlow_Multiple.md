...
⚠️ 95 passed with 0 failures, 1223 warnings and 322 suggestions 
...
---
Response status code: 200 OK. Responded in 17.382761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/133/events/1322"
}
```
...
---
Response status code: 200 OK. Responded in 16.312239ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2617"
}
```
...
---
Response status code: 200 OK. Responded in 18.544785ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/31/facility-use-slots/302"
}
```
...
---
Response status code: 200 OK. Responded in 11.856046ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F133%2Fevents%2F1322?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.042254ms.
```json
{
  "data": {
    "@context": [
    ...
    "endDate": "2022-07-23T21:35:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F262%2Fevents%2F2617?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.972153ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2617",
    "startDate": "2022-07-25T08:15:11+00:00",
    "endDate": "2022-07-25T12:55:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F31%2Ffacility-use-slots%2F302?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.891951ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/31",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/31/facility-use-slots/302#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 5,
    "startDate": "2022-07-28T04:48:11+00:00",
    "endDate": "2022-07-28T08:19:11+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 16.935452ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 7.37,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT13H20M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2022-07-27T02:53:12+00:00",
    "endDate": "2022-07-27T03:48:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f5921763-c709-44d9-866d-4106742443a7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/133#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/133/events/1322"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2617"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/31/facility-use-slots/302#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/31/facility-use-slots/302"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 93.621346ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f5921763-c709-44d9-866d-4106742443a7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:37:54+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/31"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-28T04:48:11+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F133%2Fevents%2F1322?useCacheIfAvailable=true&expectedCapacity=45


---
Response status code: 200 OK. Responded in 428.618607ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/133/events/1322",
  "modified": 1658485976648,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F262%2Fevents%2F2617?useCacheIfAvailable=true&expectedCapacity=26


---
Response status code: 200 OK. Responded in 422.927088ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2617",
  "modified": 1658485976649,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F31%2Ffacility-use-slots%2F302?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 599.752863ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/31/facility-use-slots/302",
  "modified": 1658485976825,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F600%2Ffacility-use-slots%2F5993?useCacheIfAvailable=true&expectedCapacity=6


---
Response status code: 200 OK. Responded in 621.724319ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/600/facility-use-slots/5993",
  "modified": 1658485976828,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f5921763-c709-44d9-866d-4106742443a7
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "(888) 578-6900 x781",
    "givenName": "Jakubowski",
    "familyName": "Evans",
    "identifier": "906a9749-2bfd-4cd4-9034-64a034b307f8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 416.404346ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.382167ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.342665ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.272564ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.07066ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.03839ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/574/events/5735"
}
```
...
---
Response status code: 200 OK. Responded in 15.375784ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/277/events/2769"
}
```
...
---
Response status code: 200 OK. Responded in 14.55037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292"
}
```
...
---
Response status code: 200 OK. Responded in 13.783755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F574%2Fevents%2F5735?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.062109ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/574/events/5735",
    "startDate": "2022-07-31T16:36:11+00:00",
    "endDate": "2022-07-31T19:44:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/574",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/574#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT7H23M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F277%2Fevents%2F2769?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.944907ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/277/events/2769",
    "startDate": "2022-07-29T23:24:11+00:00",
    "endDate": "2022-07-30T00:32:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/277",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/277#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F530%2Ffacility-use-slots%2F5292?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.850505ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/530",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT22H49M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-25T12:20:12+00:00",
    "endDate": "2022-07-25T13:56:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F717%2Ffacility-use-slots%2F7168?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.336795ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/717",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 10.38,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "PT20H41M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-23T02:47:12+00:00",
    "endDate": "2022-07-23T08:12:12+00:00"
  }
}
```
### Specs
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amos.OHara@gmail.com",
    "telephone": "(967) 618-7306",
    "givenName": "Daniel",
    "familyName": "Gerry",
    "identifier": "8644bf53-ac69-43ea-9517-acb91ad4a4cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/574#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/574/events/5735"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/277#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/277/events/2769"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 87.264416ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/574"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/530"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-25T12:20:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/717"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-23T02:47:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F574%2Fevents%2F5735?useCacheIfAvailable=true&expectedCapacity=13


---
Response status code: 200 OK. Responded in 311.048963ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/574/events/5735",
  "modified": 1658485983205,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F277%2Fevents%2F2769?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 307.817003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/277/events/2769",
  "modified": 1658485983208,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F530%2Ffacility-use-slots%2F5292?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 397.684868ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292",
  "modified": 1658485983298,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F717%2Ffacility-use-slots%2F7168?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 411.427023ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168",
  "modified": 1658485983305,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7
...
---
Response status code: 201 Created. Responded in 357.020815ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/69",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/574#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/70",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/574#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/71",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/277#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/72",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/73",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/530/facility-use-slots/5292#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f5921763-c709-44d9-866d-4106742443a7#/orderedItems/74",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/717/facility-use-slots/7168#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
---
Response status code: 200 OK. Responded in 10.864102ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.285591ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.823383ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 9.453476ms.
```json
{
  "data": {
    "@context": [
