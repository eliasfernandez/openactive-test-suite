...
---
Response status code: 200 OK. Responded in 8.169726ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1620/events/16192"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1620%2Fevents%2F16192?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 7.021708ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1620/events/16192",
    "startDate": "2022-07-31T09:25:11+00:00",
    "endDate": "2022-07-31T14:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT10H35M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1620/events/16192"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 179.943276ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1620%2Fevents%2F16192?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 751.696498ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1620/events/16192",
  "modified": 1658486436265,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Verner.Stanton@hotmail.com",
    "telephone": "618.397.9776",
    "givenName": "Boyle",
    "familyName": "Esta",
    "identifier": "b3fcb432-6df1-4ad3-a588-678751b603ba"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 62.452763ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:36+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 15.304836ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f
...
---
Response status code: 201 Created. Responded in 301.577553ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f#/orderedItems/1288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1620#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f/versions/67dabe9b-6449-480e-a971-942ca0901551",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;19e29d9a-44c8-49ad-aef6-4a03e8d33b8f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f


---
Response status code: 200 OK. Responded in 26.287206ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832330994032&afterId=bf021c87-5ac9-4b89-a6d7-797fe8328239",
  "message": "Listening for UUID: '19e29d9a-44c8-49ad-aef6-4a03e8d33b8f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 34.187427ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;19e29d9a-44c8-49ad-aef6-4a03e8d33b8f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f


---
Response status code: 200 OK. Responded in 2137.036169ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  "modified": 637940832377316700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
    "identifier": "19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
...
---
Response status code: 200 OK. Responded in 9.188541ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940832357391247&afterId=bf021c87-5ac9-4b89-a6d7-797fe8328239",
  "message": "Listening for UUID: '19e29d9a-44c8-49ad-aef6-4a03e8d33b8f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f
...
---
Response status code: 201 Created. Responded in 55.632259ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  "identifier": "19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1930.454283ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "19e29d9a-44c8-49ad-aef6-4a03e8d33b8f",
  "modified": 637940832399383600
}
```
### Specs
* ✅ should return 200 on success
...
---
Response status code: 200 OK. Responded in 4.842875ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/19e29d9a-44c8-49ad-aef6-4a03e8d33b8f
...
---
Response status code: 400 Bad Request. Responded in 34.347216ms.
```json
{
  "@context": "https://openactive.io/",
