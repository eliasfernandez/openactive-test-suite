...
---
Response status code: 200 OK. Responded in 15.700923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/379/facility-use-slots/3788"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F379%2Ffacility-use-slots%2F3788?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.004885ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/379/facility-use-slots/3788#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT12H47M"
      }
    ],
    "remainingUses": 1,
    "startDate": "2022-07-28T09:56:12+00:00",
    "endDate": "2022-07-28T14:52:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/92b78de5-be94-49b2-a59e-86bbb8c3719e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/379/facility-use-slots/3788#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/379/facility-use-slots/3788"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 829.328673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/92b78de5-be94-49b2-a59e-86bbb8c3719e",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/92b78de5-be94-49b2-a59e-86bbb8c3719e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Doyle.Dare@hotmail.com",
    "telephone": "(264) 399-1286 x7312",
    "givenName": "Thiel",
    "familyName": "Judy",
    "identifier": "f027810d-5404-4966-984b-8c95c3b4b508"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 767.052644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F379%2Ffacility-use-slots%2F3788?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 17.979546ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 487.224472ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/222fb373-8997-4523-917d-a370af0fe246
...
---
Response status code: 409 Conflict. Responded in 763.507986ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/222fb373-8997-4523-917d-a370af0fe246",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:21+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/222fb373-8997-4523-917d-a370af0fe246
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alyce_Sauer@yahoo.com",
    "telephone": "1-810-537-1689",
    "givenName": "Hettinger",
    "familyName": "Aida",
    "identifier": "8600ea28-1f5c-4c9b-9892-2bdd1b3b08e9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 392.860557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 64.130033ms.
```json
{
  "data": {
    "@context": [
