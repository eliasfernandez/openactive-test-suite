...
---
Response status code: 200 OK. Responded in 51.919044ms.
```json
{
...
---
Response status code: 200 OK. Responded in 307.592432ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2274/facility-use-slots/20274",
  "modified": 1658486349195,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:39:07+00:00",
    "endDate": "2022-07-23T11:39:07+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec
...
---
Response status code: 200 OK. Responded in 113.438071ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:44:08+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2274%2Ffacility-use-slots%2F20274?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 388.98083ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2274/facility-use-slots/20274",
  "modified": 1658486349825,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bernie_Jacobi@gmail.com",
    "telephone": "315.584.1944 x31129",
    "givenName": "Jerde",
    "familyName": "Dawson",
    "identifier": "a7487667-29a4-408d-a60e-f4ea5d404652"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 89.189263ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 14.783426ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec
...
---
Response status code: 201 Created. Responded in 215.948349ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0f3a5a9d-51b4-46eb-9987-fa5a70f575ec#/orderedItems/1216",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2274/facility-use-slots/20274#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 11.7318ms.
```json
{
  "data": {
    "@context": [
