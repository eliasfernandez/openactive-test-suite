...
---
Response status code: 200 OK. Responded in 1307.533411ms.
```json
{
...
---
Response status code: 200 OK. Responded in 892.197991ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453",
  "modified": 1658486744060,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:45:40+00:00",
    "endDate": "2022-07-23T11:45:40+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2a242034-abea-4cd2-b79a-145841e7a69a
...
---
Response status code: 200 OK. Responded in 368.575622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2a242034-abea-4cd2-b79a-145841e7a69a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2453%2Ffacility-use-slots%2F20453?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 784.581661ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453",
  "modified": 1658486745499,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2a242034-abea-4cd2-b79a-145841e7a69a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Christophe_Erdman45@yahoo.com",
    "telephone": "636.994.3449",
    "givenName": "Schowalter",
    "familyName": "Olaf",
    "identifier": "6bd25309-1120-4bd2-a7bf-34af45e82ea1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1133.707482ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:50:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 45.360232ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2a242034-abea-4cd2-b79a-145841e7a69a
...
---
Response status code: 400 Bad Request. Responded in 1076.74974ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (15.99) does not match expected value (14.99)"
}
```
### Specs
