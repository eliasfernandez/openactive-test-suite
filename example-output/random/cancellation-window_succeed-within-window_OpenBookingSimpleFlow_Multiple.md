...
⚠️ 55 passed with 0 failures, 915 warnings and 242 suggestions 
...
---
Response status code: 200 OK. Responded in 10.061055ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/449/events/4487"
}
```
...
---
Response status code: 200 OK. Responded in 9.954254ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/326/events/3252"
}
```
...
---
Response status code: 200 OK. Responded in 9.816251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918"
}
```
...
---
Response status code: 200 OK. Responded in 9.850551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F449%2Fevents%2F4487?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.80979ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/449/events/4487",
    "startDate": "2022-07-25T08:04:11+00:00",
    "endDate": "2022-07-25T13:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/449",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/449#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT7H11M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F326%2Fevents%2F3252?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.104963ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/326/events/3252",
    "startDate": "2022-07-27T01:21:11+00:00",
    "endDate": "2022-07-27T03:05:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/326",
      "name": "Metal Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/326#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3918?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.695057ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT14H9M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-29T10:19:12+00:00",
    "endDate": "2022-07-29T12:06:12+00:00"
  }
}
```
...
---
Response status code: 200 OK. Responded in 29.28025ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT19H54M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-25T02:35:12+00:00",
    "endDate": "2022-07-25T03:30:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/83b840e6-7594-4f5b-9cb0-fee37def5724
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/449#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/449/events/4487"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/326#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/326/events/3252"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 661.626477ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/83b840e6-7594-4f5b-9cb0-fee37def5724",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:46:20+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/326"
        },
        "maximumAttendeeCapacity": 4,
        "remainingAttendeeCapacity": 4
      },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F449%2Fevents%2F4487?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 416.005099ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/449/events/4487",
  "modified": 1658486482874,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F326%2Fevents%2F3252?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 416.421505ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/326/events/3252",
  "modified": 1658486482876,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3918?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 665.188032ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918",
  "modified": 1658486483125,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F334%2Ffacility-use-slots%2F3336?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 659.372742ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336",
  "modified": 1658486483127,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/83b840e6-7594-4f5b-9cb0-fee37def5724
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Enrico67@hotmail.com",
    "telephone": "1-549-779-2977 x70526",
    "givenName": "Harvey",
    "familyName": "Brittany",
    "identifier": "b0a22ac6-f976-4f55-b226-713633754fb7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 294.63255ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 43.729861ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.948864ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 43.763961ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 35.382134ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724
...
---
Response status code: 201 Created. Responded in 353.158334ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1474",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/449#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1475",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/449#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1476",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/326#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1477",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1478",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3918#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724#/orderedItems/1479",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 14.269719ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 14.431222ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.965915ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 13.714211ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/83b840e6-7594-4f5b-9cb0-fee37def5724
...
---
Response status code: 204 No Content. Responded in 129.627293ms.
### Specs
