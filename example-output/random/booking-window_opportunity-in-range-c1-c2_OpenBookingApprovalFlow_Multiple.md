...
⚠️ 40 passed with 0 failures, 545 warnings and 150 suggestions 
...
---
Response status code: 200 OK. Responded in 30.739475ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1529/events/15290"
}
```
...
---
Response status code: 200 OK. Responded in 29.763756ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1592/events/15914"
}
```
...
---
Response status code: 200 OK. Responded in 30.799676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 31.185283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1368/facility-use-slots/13675"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1529%2Fevents%2F15290?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.825395ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1529/events/15290",
    "startDate": "2022-07-26T02:47:11+00:00",
    "endDate": "2022-07-26T08:47:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1592%2Fevents%2F15914?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.376087ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1592/events/15914",
    "startDate": "2022-07-26T18:42:11+00:00",
    "endDate": "2022-07-26T20:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1592",
      "name": "Rubber Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1592#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
          ...
          "price": 10.07,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT9H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
---
Response status code: 200 OK. Responded in 14.949579ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT23H38M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2022-07-31T04:21:12+00:00",
    "endDate": "2022-07-31T07:57:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1368%2Ffacility-use-slots%2F13675?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.582873ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1368",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1368/facility-use-slots/13675#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT5H40M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2022-07-25T08:50:12+00:00",
    "endDate": "2022-07-25T14:43:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4215732d-a455-4965-8fd7-e7966feaffe1
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1529/events/15290"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1592#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1592/events/15914"
    },
    {
      "@type": "OrderItem",
      "position": 3,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1368/facility-use-slots/13675#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1368/facility-use-slots/13675"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1217.042851ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4215732d-a455-4965-8fd7-e7966feaffe1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:54:49+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1368"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2022-07-25T08:50:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1529%2Fevents%2F15290?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 222.279055ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1529/events/15290",
  "modified": 1658486992324,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1592%2Fevents%2F15914?useCacheIfAvailable=true&expectedCapacity=41


---
Response status code: 200 OK. Responded in 222.52866ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1592/events/15914",
  "modified": 1658486992325,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14440?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 60.805136ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14440",
  "modified": 1658486992166,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1368%2Ffacility-use-slots%2F13675?useCacheIfAvailable=true&expectedCapacity=3


---
Response status code: 200 OK. Responded in 61.272745ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1368/facility-use-slots/13675",
  "modified": 1658486992167,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4215732d-a455-4965-8fd7-e7966feaffe1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marlin.Johns22@gmail.com",
    "telephone": "1-263-563-0671",
    "givenName": "Ruecker",
    "familyName": "Rebekah",
    "identifier": "c9994564-7957-4692-a6f6-7ef7e19cc729"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1250.68398ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 23.628342ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.054831ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.576822ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 31.785494ms.
```json
{
  "data": {
    "@context": [
