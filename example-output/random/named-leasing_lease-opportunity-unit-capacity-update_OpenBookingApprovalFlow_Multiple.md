[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:48:13 GMT+0000 (Coordinated Universal Time)
...
⚠️ 22 passed with 0 failures, 274 warnings and 70 suggestions 
...
---
Response status code: 200 OK. Responded in 26.501869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1558/events/15571"
}
```
...
---
Response status code: 200 OK. Responded in 19.713449ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11082"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1558%2Fevents%2F15571?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.046479ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1558/events/15571",
    "startDate": "2022-07-26T20:49:11+00:00",
    "endDate": "2022-07-26T21:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1558",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1558#/offers/0",
          ...
          "price": 17.8,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT9H47M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11082?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.107062ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11082#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 1,
    "startDate": "2022-07-30T18:59:12+00:00",
    "endDate": "2022-07-30T23:53:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0ea4feb8-8d27-4387-86a4-ea8bb4fbac9d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1558#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1558/events/15571"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11082#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11082"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 692.134585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0ea4feb8-8d27-4387-86a4-ea8bb4fbac9d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:40+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1558"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0ea4feb8-8d27-4387-86a4-ea8bb4fbac9d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Wyatt_Senger@hotmail.com",
    "telephone": "1-380-664-6467 x0614",
    "givenName": "Weimann",
    "familyName": "Garth",
    "identifier": "ef5cd047-a435-4cfa-91af-53874b02ef1f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 407.496734ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C2)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1558%2Fevents%2F15571?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 10.580114ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1109%2Ffacility-use-slots%2F11082?useCacheIfAvailable=true&expectedCapacity=0


---
Response status code: 200 OK. Responded in 193.230005ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1109/facility-use-slots/11082",
  "modified": 1658486922654,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Lease 1 item(s) (success) >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 902.66974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:42+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ac0f4f0d-a1f7-4b29-872a-0f4acbc8fba4
...
---
Response status code: 409 Conflict. Responded in 351.312869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ac0f4f0d-a1f7-4b29-872a-0f4acbc8fba4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:43+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ac0f4f0d-a1f7-4b29-872a-0f4acbc8fba4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kariane.DAmore24@gmail.com",
    "telephone": "1-837-266-6309 x876",
    "givenName": "Denesik",
    "familyName": "Aaliyah",
    "identifier": "d5dd1ce9-b98a-45d3-8255-226681b47870"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 409.332271ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 29.255705ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 27.79668ms.
```json
{
  "data": {
    "@context": [
