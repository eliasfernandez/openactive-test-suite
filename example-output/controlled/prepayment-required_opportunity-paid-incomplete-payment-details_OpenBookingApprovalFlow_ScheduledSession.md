...
---
Response status code: 200 OK. Responded in 24.44922ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1190.671797ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2478/events/20478",
  "modified": 1658486782873,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2478/events/20478",
    "startDate": "2022-07-23T10:46:20+00:00",
    "endDate": "2022-07-23T11:46:20+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9c90a072-a76d-4c50-848f-857eb2b2c5c4
...
---
Response status code: 200 OK. Responded in 394.565845ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9c90a072-a76d-4c50-848f-857eb2b2c5c4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:51:22+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2478%2Fevents%2F20478?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 538.182335ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2478/events/20478",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9c90a072-a76d-4c50-848f-857eb2b2c5c4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Delmer_Stamm85@gmail.com",
    "telephone": "276.879.1285 x7781",
    "givenName": "Hilll",
    "familyName": "Verla",
    "identifier": "8d0e7039-cae3-4c81-bc36-5ce089d54058"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 376.771815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 20.535887ms.
```json
{
  "data": {
    "@context": [
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9c90a072-a76d-4c50-848f-857eb2b2c5c4
...
---
Response status code: 400 Bad Request. Responded in 279.77304ms.
```json
{
  "@context": "https://openactive.io/",
