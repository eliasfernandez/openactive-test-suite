[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:46:03 GMT+0000 (Coordinated Universal Time)
...
#### Callback URL
```json
"/cb?code=85B7B01F424FD257DBF988C66864380FD60441B60E8762E6BE96CBD6F543BD55&scope=openid%20openactive-openbooking%20offline_access%20openactive-identity&session_state=OzJ0aFM336FdQ4WS2PeP5pQrcK-ZnBSqqbH-hnqzvp8.E9B6A202A979456AFD8FBC691F7E5DA2"
```
...
```json
"grant_type=authorization_code&code=85B7B01F424FD257DBF988C66864380FD60441B60E8762E6BE96CBD6F543BD55&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fcb&code_verifier=AbxBniAUOe7CrdjJOv5OAA3B1Iq-d_W1lCxwqUWJ5dw"
```
...
```json
"grant_type=refresh_token&refresh_token=FDC8C9FC3C59CD26D082A4C714B53F365EB5D697EF0C2EEFB495F7F85396B2ED"
```
