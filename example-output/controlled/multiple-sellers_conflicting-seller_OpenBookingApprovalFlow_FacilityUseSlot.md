[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:38:25 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 19.634058ms.
```json
{
...
---
Response status code: 200 OK. Responded in 56.843855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 357.98337ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253",
  "modified": 1658486313248,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 358.920977ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2254/facility-use-slots/20254",
  "modified": 1658486313250,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bd75ab65-70d1-4005-a57a-c5bd0928c43e
...
---
Response status code: 500 Internal Server Error. Responded in 77.256719ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bd75ab65-70d1-4005-a57a-c5bd0928c43e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kelsi.Ritchie@yahoo.com",
    "telephone": "343.454.4747",
    "givenName": "Crooks",
    "familyName": "Demond",
    "identifier": "86f18ff0-61a9-48a0-a436-09c1a845ef04"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 53.320028ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/bd75ab65-70d1-4005-a57a-c5bd0928c43e
...
---
Response status code: 500 Internal Server Error. Responded in 69.529557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
