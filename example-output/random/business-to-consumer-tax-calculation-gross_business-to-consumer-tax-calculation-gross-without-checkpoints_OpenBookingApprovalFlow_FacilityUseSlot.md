...
---
Response status code: 200 OK. Responded in 12.034363ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14218"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1422%2Ffacility-use-slots%2F14218?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.871594ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14218#/offers/0",
        ...
        "price": 2.98,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT1H40M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-31T05:32:12+00:00",
    "endDate": "2022-07-31T10:17:12+00:00"
  }
}
```
### Specs
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c3c0512c-a5cf-4f63-8226-a8feb5dc630a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adele_Schamberger@gmail.com",
    "telephone": "719-282-1653",
    "givenName": "Stanton",
    "familyName": "Barney",
    "identifier": "5237a271-ad41-4a73-a105-053a9759b431"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14218#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14218"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 253.446545ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c3c0512c-a5cf-4f63-8226-a8feb5dc630a#/orderedItems/1860",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1422/facility-use-slots/14218#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c3c0512c-a5cf-4f63-8226-a8feb5dc630a/versions/7ec46699-c788-47b7-a417-19cb971217b1",
  "payment": {
    "@type": "Payment",
    "identifier": "F4f5p_SXI",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c3c0512c-a5cf-4f63-8226-a8feb5dc630a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c3c0512c-a5cf-4f63-8226-a8feb5dc630a


---
Response status code: 200 OK. Responded in 16.367058ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940834226674266&afterId=f619d5df-db43-4f20-b5e1-f723023e5339",
  "message": "Listening for UUID: 'c3c0512c-a5cf-4f63-8226-a8feb5dc630a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 11.761757ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c3c0512c-a5cf-4f63-8226-a8feb5dc630a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c3c0512c-a5cf-4f63-8226-a8feb5dc630a


---
Response status code: 200 OK. Responded in 2232.18223ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
  "modified": 637940834276721700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
    "identifier": "c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
...
---
Response status code: 200 OK. Responded in 15.921348ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c3c0512c-a5cf-4f63-8226-a8feb5dc630a
...
---
Response status code: 201 Created. Responded in 502.886401ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
  "identifier": "c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1080.086355ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c3c0512c-a5cf-4f63-8226-a8feb5dc630a",
  "modified": 637940834301200800
}
```
### Specs
* ✅ should return 200 on success
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1422%2Ffacility-use-slots%2F14218?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 9.598167ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 201 Created. Responded in 37.550945ms.
```json
{
  "@context": [
    "https://openactive.io/",
