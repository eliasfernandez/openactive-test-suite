[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:32:43 GMT+0000 (Coordinated Universal Time)
...
⚠️ 99 passed with 0 failures, 1251 warnings and 330 suggestions 
...
---
Response status code: 200 OK. Responded in 24.18251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15066"
}
```
...
---
Response status code: 200 OK. Responded in 26.56745ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1185/events/11842"
}
```
...
---
Response status code: 200 OK. Responded in 20.898054ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10489"
}
```
...
---
Response status code: 200 OK. Responded in 20.66165ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1599/facility-use-slots/15987"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1507%2Fevents%2F15066?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 9.122655ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15066",
    "startDate": "2022-07-25T18:27:11+00:00",
    "endDate": "2022-07-25T22:52:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1507",
      "name": "Frozen Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1507#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT20H25M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1185%2Fevents%2F11842?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.757049ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1185/events/11842",
    "startDate": "2022-07-29T01:08:11+00:00",
    "endDate": "2022-07-29T04:49:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1185",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1185#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1049%2Ffacility-use-slots%2F10489?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 8.420343ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1049",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10489#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 6,
    "startDate": "2022-07-26T01:30:12+00:00",
    "endDate": "2022-07-26T02:59:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1599%2Ffacility-use-slots%2F15987?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.95892ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1599",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1599/facility-use-slots/15987#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT10H13M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2022-07-26T14:57:12+00:00",
    "endDate": "2022-07-26T16:10:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0be494f4-1fb6-4b50-ac62-83390763eef6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1507#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1507/events/15066"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1185#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1185/events/11842"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10489#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10489"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1599/facility-use-slots/15987#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1599/facility-use-slots/15987"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 154.52452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0be494f4-1fb6-4b50-ac62-83390763eef6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:32+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1507"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1185"
        },
        "maximumAttendeeCapacity": 47,
        "remainingAttendeeCapacity": 47
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1049"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-26T01:30:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1599"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-26T14:57:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1507%2Fevents%2F15066?useCacheIfAvailable=true&expectedCapacity=32


---
Response status code: 200 OK. Responded in 19.960538ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1185%2Fevents%2F11842?useCacheIfAvailable=true&expectedCapacity=46


---
Response status code: 200 OK. Responded in 19.44573ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1049%2Ffacility-use-slots%2F10489?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 463.900266ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10489",
  "modified": 1658486014103,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1599%2Ffacility-use-slots%2F15987?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 464.17057ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1599/facility-use-slots/15987",
  "modified": 1658486014104,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0be494f4-1fb6-4b50-ac62-83390763eef6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Herman.Lesch@gmail.com",
    "telephone": "1-712-287-9692",
    "givenName": "Bogan",
    "familyName": "Mose",
    "identifier": "5c734f70-754d-4145-b85e-5bb62bf3db57"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 134.798486ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:34+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 18.382812ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.762701ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 17.339994ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 16.994189ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 21.526294ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1393/events/13929"
}
```
...
---
Response status code: 200 OK. Responded in 20.516775ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1167/events/11662"
}
```
...
---
Response status code: 200 OK. Responded in 19.70186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151"
}
```
...
---
Response status code: 200 OK. Responded in 10.9238ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1393%2Fevents%2F13929?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.521802ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1393/events/13929",
    "startDate": "2022-07-31T03:31:11+00:00",
    "endDate": "2022-07-31T05:22:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1393",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1393#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
          "price": 12.42,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT3H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1167%2Fevents%2F11662?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 16.129295ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1167/events/11662",
    "startDate": "2022-07-26T06:22:11+00:00",
    "endDate": "2022-07-26T08:40:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1216%2Ffacility-use-slots%2F12151?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.783489ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1216",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2022-07-26T14:33:12+00:00",
    "endDate": "2022-07-26T15:22:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1281%2Ffacility-use-slots%2F12808?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 15.475283ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1281",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 3,
    "startDate": "2022-07-30T03:17:12+00:00",
    "endDate": "2022-07-30T05:56:12+00:00"
  }
}
```
### Specs
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Glen27@gmail.com",
    "telephone": "990-527-4716 x864",
    "givenName": "Zemlak",
    "familyName": "Shyanne",
    "identifier": "136bdddd-e600-48d5-9964-452527d2d452"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1393#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1393/events/13929"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1167/events/11662"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 70.012968ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:38:38+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1167"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1216"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2022-07-26T14:33:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1281"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2022-07-30T03:17:12+00:00",
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2)

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1393%2Fevents%2F13929?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 42.743614ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1167%2Fevents%2F11662?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 42.465109ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1216%2Ffacility-use-slots%2F12151?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 236.691051ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151",
  "modified": 1658486019955,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1281%2Ffacility-use-slots%2F12808?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 213.975571ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808",
  "modified": 1658486019956,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after C2) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0be494f4-1fb6-4b50-ac62-83390763eef6
...
---
Response status code: 201 Created. Responded in 156.628914ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/0be494f4-1fb6-4b50-ac62-83390763eef6",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/200",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1393#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/201",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1393#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/202",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1167#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/203",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/204",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1216/facility-use-slots/12151#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6#/orderedItems/205",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1281/facility-use-slots/12808#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/0be494f4-1fb6-4b50-ac62-83390763eef6/versions/34dab75c-164c-49f9-9cb4-084c0417f5ee",
  "payment": {
    "@type": "Payment",
    "identifier": "Jhxe-lwYh",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;0be494f4-1fb6-4b50-ac62-83390763eef6&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/0be494f4-1fb6-4b50-ac62-83390763eef6


---
Response status code: 200 OK. Responded in 20.199237ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637940828140315641&afterId=a0f1b3b1-3cd3-47fe-820c-11a00418e20c",
  "message": "Listening for UUID: '0be494f4-1fb6-4b50-ac62-83390763eef6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 34.319973ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;0be494f4-1fb6-4b50-ac62-83390763eef6&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/0be494f4-1fb6-4b50-ac62-83390763eef6


---
Response status code: 200 OK. Responded in 2489.602653ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "0be494f4-1fb6-4b50-ac62-83390763eef6",
  "modified": 637940828207503600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/0be494f4-1fb6-4b50-ac62-83390763eef6",
    "identifier": "0be494f4-1fb6-4b50-ac62-83390763eef6",
...
---
Response status code: 200 OK. Responded in 28.73558ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6
...
---
Response status code: 201 Created. Responded in 393.777173ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0be494f4-1fb6-4b50-ac62-83390763eef6",
  "identifier": "0be494f4-1fb6-4b50-ac62-83390763eef6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 18.136923ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "0be494f4-1fb6-4b50-ac62-83390763eef6",
  "modified": 637940828236005600
}
```
### Specs
* ✅ should return 200 on success
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B))
...
---
Response status code: 200 OK. Responded in 9.325367ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 8.853958ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.882294ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 10.507688ms.
```json
{
  "data": {
    "@context": [
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
...
## Second Attempt - C2 -> B >> Assert Opportunity Capacity (after OrderProposal Feed Deletion (after B)) >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
