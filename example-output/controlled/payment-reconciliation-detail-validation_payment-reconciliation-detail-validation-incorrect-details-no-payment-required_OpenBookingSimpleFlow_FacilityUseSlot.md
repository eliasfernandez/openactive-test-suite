...
---
Response status code: 200 OK. Responded in 29.012763ms.
```json
{
...
---
Response status code: 200 OK. Responded in 512.531253ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2543/facility-use-slots/20543",
  "modified": 1658486958863,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:49:17+00:00",
    "endDate": "2022-07-23T11:49:17+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b458f099-696a-4b77-b573-89a5ad9a8964
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-nZPgHsezPn",
    "accountId": "invalid-hu2wwtcr2x",
    "paymentProviderId": "invalid-qBH84zS6Ch"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 37.42834ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b458f099-696a-4b77-b573-89a5ad9a8964
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nyah_Bechtelar39@yahoo.com",
    "telephone": "507.337.8226",
    "givenName": "Boyle",
    "familyName": "Jose",
    "identifier": "883c699c-63fc-4482-a655-3a96cddad858"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-FBra2GPKvo",
    "accountId": "invalid-jlXzzo7y4",
    "paymentProviderId": "invalid-CRPy3W6ajO"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 120.946799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
