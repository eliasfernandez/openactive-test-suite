...
---
Response status code: 200 OK. Responded in 19.501667ms.
```json
{
...
---
Response status code: 200 OK. Responded in 562.949115ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331",
  "modified": 1658486459662,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:40:58+00:00",
    "endDate": "2022-07-23T11:40:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/de1a5213-3655-4afe-bb61-88849c809c8a
...
---
Response status code: 200 OK. Responded in 164.145504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/de1a5213-3655-4afe-bb61-88849c809c8a",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2331%2Ffacility-use-slots%2F20331?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 747.361892ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331",
  "modified": 1658486460750,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/de1a5213-3655-4afe-bb61-88849c809c8a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Valentina_Schaden49@yahoo.com",
    "telephone": "(889) 883-4614 x3365",
    "givenName": "Parisian",
    "familyName": "Julius",
    "identifier": "096c98fe-c287-4e6f-8182-c7cb83f22adb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 143.456827ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:45:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 16.190839ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/de1a5213-3655-4afe-bb61-88849c809c8a
...
---
Response status code: 201 Created. Responded in 375.495311ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/de1a5213-3655-4afe-bb61-88849c809c8a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/de1a5213-3655-4afe-bb61-88849c809c8a#/orderedItems/1613",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 13.593816ms.
```json
{
  "data": {
    "@context": [
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/de1a5213-3655-4afe-bb61-88849c809c8a
...
---
Response status code: 400 Bad Request. Responded in 33.523886ms.
```json
{
  "@context": "https://openactive.io/",
