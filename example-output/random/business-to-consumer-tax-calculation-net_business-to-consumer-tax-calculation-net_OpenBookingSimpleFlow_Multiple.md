[< Return to Summary](summary.md) | File Generated: Fri Jul 22 2022 10:50:37 GMT+0000 (Coordinated Universal Time)
...
⚠️ 50 passed with 0 failures, 734 warnings and 200 suggestions 
...
---
Response status code: 200 OK. Responded in 30.149709ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/418/events/4180"
}
```
...
---
Response status code: 200 OK. Responded in 28.604683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/697"
}
```
...
---
Response status code: 200 OK. Responded in 24.806318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633"
}
```
...
---
Response status code: 200 OK. Responded in 31.237026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F418%2Fevents%2F4180?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.838268ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/418/events/4180",
    "startDate": "2022-07-30T20:30:11+00:00",
    "endDate": "2022-07-31T00:15:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/418",
      "name": "Fresh Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/418#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 0.76,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT9H17M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F70%2Fevents%2F697?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 21.37926ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/697",
    "startDate": "2022-07-28T07:40:11+00:00",
    "endDate": "2022-07-28T12:24:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F64%2Ffacility-use-slots%2F633?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.690033ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/64",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T08:15:11+00:00",
    "endDate": "2022-07-29T10:07:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F284%2Ffacility-use-slots%2F2836?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.264326ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 5,
    "startDate": "2022-07-27T16:50:12+00:00",
    "endDate": "2022-07-27T20:25:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66e0f1ed-c859-469b-bab3-8e1551e78d97

* **Content-Type:** `"application/vnd.openactive.booking+json; version=1"`
* **Authorization:** `"Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IkIwNEY3QjkxREUzQjk0NzhDNjE4MzNGQjI0QUE1Q0RCIiwidHlwIjoiYXQrand0In0..aotJeifkUiR_D107YVCZXQ__aJ9xyGKH9cMk_WByc7MVui9RYfU1FANhLmG9yV7nzIklzOzvysUdAK7IboMha6mY-0x9mGVORIKySkUY_eqgFy4QMc26joPhl616i-LUNu74yNUXoBnbbg80P3Fuu1vrnrnOY_tQBHRDFWloBPpdOfLNAuyTX5ET8W20vJWmK0cL3ckIW5eBT-boOO58oSRp7rjpYiFD1EoA1jC06YjNQOnv98P7Ntfmhc7Oc8iPVGe6Sr_2z9o2NADmu0TFfjJ6xN7v7s32_-2RhjxVnKnft_wLvgpCU_szPf_oA5aJfYFGcnMZcB_bKGyrpOGqAw"`
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/418#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/418/events/4180"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/697"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 962.209628ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/66e0f1ed-c859-469b-bab3-8e1551e78d97",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:49+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/418"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/284"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2022-07-27T16:50:12+00:00",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F418%2Fevents%2F4180?useCacheIfAvailable=true&expectedCapacity=36


---
Response status code: 200 OK. Responded in 28.226505ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F70%2Fevents%2F697?useCacheIfAvailable=true&expectedCapacity=33


---
Response status code: 200 OK. Responded in 23.249516ms.
```json
{
  "data": {
    "@context": [
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F64%2Ffacility-use-slots%2F633?useCacheIfAvailable=true&expectedCapacity=1


---
Response status code: 200 OK. Responded in 585.713871ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633",
  "modified": 1658487052599,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F284%2Ffacility-use-slots%2F2836?useCacheIfAvailable=true&expectedCapacity=4


---
Response status code: 200 OK. Responded in 585.533367ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836",
  "modified": 1658487052600,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66e0f1ed-c859-469b-bab3-8e1551e78d97
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Christopher.Altenwerth8@gmail.com",
    "telephone": "(342) 938-1098 x3114",
    "givenName": "Jast",
    "familyName": "Josiah",
    "identifier": "faa3d910-010a-4cd2-8968-886c0271479b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1824.576503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:55:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 24.306935ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.670123ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.020012ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 22.702106ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97
...
---
Response status code: 201 Created. Responded in 2719.679225ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2991",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/418#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2992",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/418#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2993",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/70#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2994",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2995",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/64/facility-use-slots/633#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/66e0f1ed-c859-469b-bab3-8e1551e78d97#/orderedItems/2996",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/284/facility-use-slots/2836#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
---
Response status code: 200 OK. Responded in 29.979988ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.949505ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 24.039791ms.
```json
{
  "data": {
    "@context": [
...
---
Response status code: 200 OK. Responded in 23.501983ms.
```json
{
  "data": {
    "@context": [
