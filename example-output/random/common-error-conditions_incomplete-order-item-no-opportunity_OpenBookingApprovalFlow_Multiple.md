...
⚠️ 48 passed with 0 failures, 125 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 49.336991ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1049/events/10484"
}
```
...
---
Response status code: 200 OK. Responded in 51.059618ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12539"
}
```
...
---
Response status code: 200 OK. Responded in 43.590798ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1092/facility-use-slots/10920"
}
```
...
---
Response status code: 200 OK. Responded in 54.89988ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1261/facility-use-slots/12602"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1049%2Fevents%2F10484?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.691544ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1049/events/10484",
    "startDate": "2022-07-23T04:49:11+00:00",
    "endDate": "2022-07-23T07:48:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1254%2Fevents%2F12539?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.550425ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12539",
    "startDate": "2022-07-31T20:39:11+00:00",
    "endDate": "2022-07-31T22:51:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1092%2Ffacility-use-slots%2F10920?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.57581ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1092/facility-use-slots/10920#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T07:15:12+00:00",
    "endDate": "2022-07-29T12:10:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1261%2Ffacility-use-slots%2F12602?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.619294ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1261/facility-use-slots/12602#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 3,
    "startDate": "2022-07-29T18:34:12+00:00",
    "endDate": "2022-07-29T20:07:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a795a3de-2375-4a25-aa80-9d93689c3641
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1254/events/12539"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1092/facility-use-slots/10920#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1261/facility-use-slots/12602#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1261/facility-use-slots/12602"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 38.560318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a795a3de-2375-4a25-aa80-9d93689c3641",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a795a3de-2375-4a25-aa80-9d93689c3641
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adriel.Smith29@yahoo.com",
    "telephone": "(703) 912-4542 x8732",
    "givenName": "Von",
    "familyName": "Lenora",
    "identifier": "7d7412b5-ebe5-4d84-9654-0553ff91ccfe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 56.704508ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a795a3de-2375-4a25-aa80-9d93689c3641
...
---
Response status code: 409 Conflict. Responded in 48.129271ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a795a3de-2375-4a25-aa80-9d93689c3641",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
