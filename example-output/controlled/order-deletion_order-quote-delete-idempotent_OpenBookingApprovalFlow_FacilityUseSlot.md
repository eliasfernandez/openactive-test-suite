...
---
Response status code: 200 OK. Responded in 25.976829ms.
```json
{
...
---
Response status code: 200 OK. Responded in 738.893326ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2406/facility-use-slots/20406",
  "modified": 1658486638269,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2022-07-23T10:43:56+00:00",
    "endDate": "2022-07-23T11:43:56+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bfc909da-f622-42b0-a48f-7b58e4597e07
...
---
Response status code: 200 OK. Responded in 502.310537ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bfc909da-f622-42b0-a48f-7b58e4597e07",
  "lease": {
    "@type": "Lease",
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2406%2Ffacility-use-slots%2F20406?useCacheIfAvailable=true&expectedCapacity=9


---
Response status code: 200 OK. Responded in 970.703774ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2406/facility-use-slots/20406",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bfc909da-f622-42b0-a48f-7b58e4597e07
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Carmelo.Armstrong31@hotmail.com",
    "telephone": "(888) 509-6178",
    "givenName": "Ebert",
    "familyName": "Era",
    "identifier": "69561509-4d5a-44c5-89fb-f1dd3a0c8f81"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 244.925569ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 8.835078ms.
```json
{
  "data": {
    "@context": [
...
DELETE https://localhost:5001/api/openbooking/order-quotes/bfc909da-f622-42b0-a48f-7b58e4597e07
...
---
Response status code: 204 No Content. Responded in 235.158496ms.
...
---
Response status code: 204 No Content. Responded in 12.36441ms.
### Specs
