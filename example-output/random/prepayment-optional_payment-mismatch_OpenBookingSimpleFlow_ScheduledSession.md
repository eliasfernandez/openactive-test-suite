...
---
Response status code: 200 OK. Responded in 117.936737ms.
```json
{
...
---
Response status code: 200 OK. Responded in 56.536225ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3620",
    "startDate": "2022-07-24T14:15:11+00:00",
    "endDate": "2022-07-24T18:11:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/da55b9f3-ed7b-408b-8937-7fdef6d28866
...
---
Response status code: 200 OK. Responded in 524.738065ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/da55b9f3-ed7b-408b-8937-7fdef6d28866",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2022-07-22T10:53:50+00:00"
  },
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F362%2Fevents%2F3620?useCacheIfAvailable=true&expectedCapacity=2


---
Response status code: 200 OK. Responded in 220.212392ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3620",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/da55b9f3-ed7b-408b-8937-7fdef6d28866
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Casimir_Franecki86@yahoo.com",
    "telephone": "1-581-945-1661",
    "givenName": "Marks",
    "familyName": "Merl",
    "identifier": "830746e0-fa71-449a-94e7-ad3bf674e93d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 251.822567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 13.348558ms.
```json
{
  "data": {
    "@context": [
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/da55b9f3-ed7b-408b-8937-7fdef6d28866
...
---
Response status code: 400 Bad Request. Responded in 327.772234ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "totalPaymentDue price in the request (14.83) does not match expected value (13.83)"
}
```
### Specs
